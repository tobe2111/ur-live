// 유어딜 매장 사장님 소개서 (.pptx) 생성기 — v3 (2026-09-14): 설득 7장 → 이용 안내 8장 → 시작 1장 (16장)
...
(async () => {
  ...
  // ───────── 01 표지: 우리동네 이용권, 유어딜 ─────────
  {
    ...
    chrome(s, { dark: true });
    T(s, '매장 사장님 소개서 · ' + FACTS.liveMeasuredAt, { x: M, y: 0.98, w: 6, h: 0.25, fontSize: 10, color: C.darkMuted, charSpacing: 0.5 });
