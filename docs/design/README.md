...
| **🗺️ 카카오맵 리뷰 게이미피케이션 — 리뷰 점수·레벨 → 전용 이용권/홍보 자격** | 2026-07-02 | 🟡 플로우 설계 제안 (대표 결정 4건 대기 — 검증주체/레벨축/혜택범위/정책리스크) | [kakao-review-gamification.md](./kakao-review-gamification.md) |
