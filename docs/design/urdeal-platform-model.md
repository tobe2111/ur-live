...
| **매장 영입(소개)** | 매장을 영입해 온 사람 | **2%** (2026-08-27 대표 확정, 1.5%→2%) · **promo 재원(5% 밖, flip)** | 매 결제, **유효기간 1년**(기산 `introduced_at`, 어드민 `referral_bonus_until` 우선), T+7 성숙, 원천징수 | `reverseInfluencerStoreIntroOnRefund` |
