...
- 2026-09-20 승인 대기 병목 해소 — 매장 좌석은 대기·반려도 앉고(정지만 제외) 정산(`payouts-generate`)은 승인 매장만(SSOT `shared/seller-status.ts`, 두 집합이 다른 것이 설계). 노출은 종전대로 승인 매장만. 어드민 승인이 위임 운영자에게도 통보. STAGING P15. 다음 단계 = S-OCR(등록증 OCR 자동 승인, 게이트 OFF).
