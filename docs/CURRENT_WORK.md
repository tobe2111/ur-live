...
- [[E2] 승인 실행기 2회차 — 결재 `2026-09-07-actor-benefit-conflicts` 중 Q2-1 (딜 % 상한 없음) — <PR_Q2>](handoff/2026-09-07-exec-actor-benefit-conflicts-q2.md)
