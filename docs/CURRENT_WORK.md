...
**1단계 완료(2026-06-12)** · **P1/P2/P3 완료(e42b37e7 — 지급 센터 /admin/payout-center, 큐레이터 딜 단일화, 에이전시 영입커미션 정본·수동레일 410 폐기)** · P4 는 NTS_API_KEY 등록 대기(정책 확정: 유통사 자동승인/공급사 표시만). 잔여 = P5~P7 + 다듬기:
