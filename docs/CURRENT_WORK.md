...
## ✅ 2026-06-22~23 — 동네딜 사용처리(redemption) + 선착순 + 흑백/PC 액자 + 도매몰 라벨 (대표 다회 검증, "가장 이상적·안전하게")
...
- **도매몰 어드민 라벨 통일 ✅** — '판매사'→'유통사', '제조사(공급사)'→'제조사' 등 사용자-가시 라벨만(CLAUDE.md 2026-06-21 명칭 SSOT). 코드 식별자/주석 무변경. (`ec3cf17`)
