...
**1단계 완료(2026-06-12)** · **P1/P2/P3 완료(e42b37e7 — 지급 센터 /admin/payout-center, 큐레이터 딜 단일화, 에이전시 영입커미션 정본·수동레일 410 폐기)** · P4 완료(키 등록+배선, 정책: **양쪽 모두 수동 승인** — NTS 결과는 어드민 알림 참고 표기만, 자동승인 없음). 잔여 = P5~P7 + 다듬기:
