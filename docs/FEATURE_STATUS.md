...
| `VOUCHER_CART_UI_ENABLED` | 🔴 꺼짐 | `false` | 이용권 '장바구니에 담기' **진입점** (2026-09-15 신설). |
| `SELLER_COUPONS_HIDDEN` | 🔴 꺼짐 | `true` | 셀러 쿠폰 메뉴 숨김 (2026-09-26 대표 *"쿠폰은 앞으로 필요없을 것 같은데? 확인해줘"* → **라이브 실측으로 확인됨**). |
...
| `SELLER_DORMANT_HIDDEN` | 🔴 꺼짐 | `true` | **한 번도 쓰인 적 없는 셀러 메뉴 셋** 숨김 (2026-09-26 대표 *"나머지도 다 해줘. |

## 🟢 켜진 기능 (8)

| 플래그 | 상태 | 값 | 설명 |
|---|---|---|---|
| `VOUCHER_DEAL_PAYMENT_ENABLED` | 🟢 켜짐 | `true` | **이용권을 딜로도 살 수 있게** (2026-08-31 대표 방향). |
