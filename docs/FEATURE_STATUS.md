...
| `VOUCHER_DEAL_PAYMENT_ENABLED` | 🔴 꺼짐 | `false` | **이용권을 딜로도 살 수 있게** (2026-08-31 대표 방향). |
...
| `AGENCY_DASHBOARD_SUNSET` | 🟢 켜짐 | `true` | 에이전시 대시보드 **일몰**(신규 가입 차단 + 표면 축소) (2026-08-19 대표 확정 "모두 하자" — 에이전시 대시보드 가치 재검토 후). |
