...
// .wrangler/tmp/pages-kQWoIq/bundledWorker-0.5479218649452167.mjs
...
var zr = /* @__PURE__ */ __name2((e, s, r) => s in e ? Jr(e, s, { enumerable: true, configurable: true, writable: true, value: r }) : e[s] = r, "zr");
var b = /* @__PURE__ */ __name2((e, s, r) => zr(e, typeof s != "symbol" ? s + "" : s, r), "b");
var Rs = /* @__PURE__ */ __name2((e, s, r) => s.has(e) || Bs("Cannot " + r), "Rs");
var _ = /* @__PURE__ */ __name2((e, s, r) => (Rs(e, s, "read from private field"), r ? r.call(e) : s.get(e)), "_");
var I = /* @__PURE__ */ __name2((e, s, r) => s.has(e) ? Bs("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(e) : s.set(e, r), "I");
var T = /* @__PURE__ */ __name2((e, s, r, t) => (Rs(e, s, "write to private field"), t ? t.call(e, r) : s.set(e, r), r), "T");
var A = /* @__PURE__ */ __name2((e, s, r) => (Rs(e, s, "access private method"), r), "A");
var Ks = /* @__PURE__ */ __name2((e, s, r, t) => ({ set _(a) {
  T(e, s, a, r);
}, get _() {
  return _(e, s, t);
} }), "Ks");
var Vs = /* @__PURE__ */ __name2((e, s, r) => (t, a) => {
  let n = -1;
  return o(0);
  async function o(i) {
...
var Gr = /* @__PURE__ */ __name2(async (e, s = /* @__PURE__ */ Object.create(null)) => {
...
var ot = /* @__PURE__ */ __name2((e) => Ns(e, decodeURI), "ot");
...
var Ue = /* @__PURE__ */ __name2((e, s, ...r) => (r.length && (s = Ue(s, ...r)), `${(e == null ? void 0 : e[0]) === "/" ? "" : "/"}${e}${s === "/" ? "" : `${(e == null ? void 0 : e.at(-1)) === "/" ? "" : "/"}${(s == null ? void 0 : s[0]) === "/" ? s.slice(1) : s}`}`), "Ue");
...
var Is = /* @__PURE__ */ __name2((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? Ns(e, gr) : e) : e, "Is");
var hr = /* @__PURE__ */ __name2((e, s, r) => {
  let t;
  if (!r && s && !/[%+]/.test(s)) {
    let o = e.indexOf("?", 8);
    if (o === -1) return;
...
var ct = hr;
var ut = /* @__PURE__ */ __name2((e, s) => hr(e, s, true), "ut");
var gr = decodeURIComponent;
var Ys = /* @__PURE__ */ __name2((e) => Ns(e, gr), "Ys");
var qe;
var Z;
var pe;
var wr;
...
var yr = (cr = class {
...
}, qe = /* @__PURE__ */ new WeakMap(), Z = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakSet(), wr = /* @__PURE__ */ __name2(function(e) {
  const s = _(this, Z)[0][this.routeIndex][1][e], r = A(this, pe, js).call(this, s);
  return r && /\%/.test(r) ? Ys(r) : r;
}, "wr"), Sr = /* @__PURE__ */ __name2(function() {
  ...
  return e;
}, "Sr"), js = /* @__PURE__ */ __name2(function(e) {
  return _(this, Z)[1] ? _(this, Z)[1][e] : e;
}, "js"), _e = /* @__PURE__ */ new WeakMap(), cr);
var lt = { Stringify: 1 };
var Tr = /* @__PURE__ */ __name2(async (e, s, r, t, a) => {
...
var vs = /* @__PURE__ */ __name2((e, s) => ({ "Content-Type": e, ...s }), "vs");
var Le = /* @__PURE__ */ __name2((e, s) => new Response(e, s), "Le");
var as;
var ns;
var ce;
var Fe;
...
var pt = (ur = class {
  ...
  constructor(e, s) {
    ...
    b(this, "html", (e2, s2, r) => {
      const t = /* @__PURE__ */ __name2((a) => A(this, ae, Pe).call(this, a, s2, vs("text/html; charset=UTF-8", r)), "t");
    ...
    b(this, "notFound", () => (_(this, We) ?? T(this, We, () => Le()), _(this, We).call(this, this)));
    T(this, as, e), s && (T(this, ue, s.executionCtx), this.env = s.env, T(this, We, s.notFoundHandler), T(this, cs, s.path), T(this, is, s.matchResult));
  }
  get req() {
...
}, "Pe"), Cs = /* @__PURE__ */ __name2(function() {
...
var Et = /* @__PURE__ */ __name2((e) => e.text("404 Not Found", 404), "Et");
var Js = /* @__PURE__ */ __name2((e, s) => {
  if ("getResponse" in e) {
...
var ht = (Be = class {
  ...
  route(s, r) {
    ...
    return r.routes.map((a) => {
      var o;
      let n;
      r.errorHandler === Js ? n = a.handler : (n = /* @__PURE__ */ __name2(async (i, c) => (await Vs([], r.errorHandler)(i, () => a.handler(i, c))).res, "n"), n[ft] = a.handler), A(o = t, V, Se).call(o, a.method, a.path, n);
    }), this;
  }
  basePath(s) {
...
}, se = /* @__PURE__ */ new WeakMap(), V = /* @__PURE__ */ new WeakSet(), Ir = /* @__PURE__ */ __name2(function() {
  const s = new Be({ router: this.router, getPath: this.getPath });
  return s.errorHandler = this.errorHandler, T(s, re, _(this, re)), s.routes = this.routes, s;
}, "Ir"), re = /* @__PURE__ */ new WeakMap(), Se = /* @__PURE__ */ __name2(function(s, r, t) {
...
}, "Se"), fs = /* @__PURE__ */ __name2(function(s, r) {
  if (s instanceof Error) return this.errorHandler(s, r);
  throw s;
}, "fs"), Es = /* @__PURE__ */ __name2(function(s, r, t, a) {
...
}, fe = /* @__PURE__ */ new WeakMap(), Ee = /* @__PURE__ */ new WeakMap(), Ss = /* @__PURE__ */ new WeakSet(), Dr = /* @__PURE__ */ __name2(function(e) {
  const s = [];
  let r = e === K;
...
}, ge = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakSet(), Te = /* @__PURE__ */ __name2(function(s, r, t, a, n) {
...
__name(Us, "Us");
__name2(Us, "Us");
var Pr = Object.freeze(Object.defineProperty({ __proto__: null, blacklistToken: Ur, generateAccessToken: Ae, generateRefreshToken: ls, getJwtSecret: ne, isTokenBlacklisted: Wt, refreshAccessToken: Mr, verifyCachedToken: Us, verifyToken: ds }, Symbol.toStringTag, { value: "Module" }));
var ps = new Ls();
...
function Fs(e) {
  return async (s, r) => {
    var i;
    if (e.skipCache || !Wa(s)) return r();
    const t = Ba(s, e.cacheKey), a = caches.default;
...
__name(Ye, "Ye");
__name2(Ye, "Ye");
var Je = { LIVE_STREAMS: ["streams:live", "streams:all", "streams:scheduled", "live_streams:live:all:20:0", "live_streams:"], PRODUCTS: ["products:", "featured_products"], CART: /* @__PURE__ */ __name2((e) => [`cart:${e}`], "CART"), ORDERS: /* @__PURE__ */ __name2((e) => [`orders:${e}`], "ORDERS"), ALL: ["streams:", "live_streams:", "products:", "cart:", "orders:"] };
function Ja(e) {
...
d.get("/auth/kakao/sync/callback", async (e) => {
  ...
  try {
    ...
    if (console.log("[Kakao Sync] Token response status:", O.status), console.log("[Kakao Sync] Token request details:", { client_id: y, redirect_uri: j, code_length: h.length, code_prefix: h.substring(0, 20) }), !O.ok) {
      ...
      return console.error("[Kakao Sync] Token request failed:", W), e.redirect(`${g}?error=token_request_failed&detail=${encodeURIComponent(W)}`);
    }
    ...
    try {
      const W = await s.prepare(`
        ...
        WHERE kakao_id = ?
      `).bind(P).first();
      console.log("[Kakao Sync] Existing user check:", !!W);
      let H;
      W ? (H = W.id, await s.prepare(`
          UPDATE users 
          SET name = ?, 
              email = ?, 
              profile_image = ?,
      ...
      return console.error("[Kakao Sync] Database error:", W), console.error("[Kakao Sync] DB error details:", { message: W.message, name: W.name }), e.redirect(`${g}?error=database_error&detail=${encodeURIComponent(W.message)}`);
    }
  } catch (h) {
...
d.post("/api/orders", k, async (e) => {
  ...
  try {
    ...
    if (o && o.length > 0) {
      const v = o.map((B) => B.productId), U = v.map(() => "?").join(","), P = await s.prepare(`
        SELECT id, name, price, stock 
        FROM products 
        WHERE id IN (${U})
      `).bind(...v).all(), N = new Map(P.results.map((B) => [B.id, B])), L = [];
      for (const B of o) {
        const Ne = N.get(B.productId);
        ...
        L.push({ product_id: B.productId, option_id: B.optionId || null, quantity: B.quantity, price: B.price, product_name: Ne.name, product_stock: Ne.stock });
      }
      const q = /* @__PURE__ */ new Date(), z = q.getFullYear().toString().slice(-2), R = (q.getMonth() + 1).toString().padStart(2, "0"), we = q.getDate().toString().padStart(2, "0"), W = `${z}${R}${we}`, H = Math.random().toString(36).substring(2, 7).toUpperCase(), ie = f || `ORD-${W}-${H}`, me = c ? `${i} ${c}` : i, Xe = (await s.prepare(`
        INSERT INTO orders (
      ...
      for (const B of L) await s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(Xe, B.product_id, B.option_id, B.quantity, B.price, B.product_name).run();
...
d.post("/api/seller/streams", async (e) => {
  ...
  try {
    ...
    if (o && !E && (E = Wr(o), !E)) if (E = Br(o), h = Kr(o), g = ln(o), E) f = "tiktok";
...
d.put("/api/seller/streams/:id", async (e) => {
  ...
  try {
    ...
    if (n !== void 0 && (f.push("title = ?"), h.push(n)), o !== void 0 && (f.push("description = ?"), h.push(o)), c !== void 0 || i !== void 0) {
      ...
      if (c && (g = Wr(c), !g)) if (g = Br(c), y = Kr(c), g) S = "tiktok";
...
d.post("/api/seller/youtube/end-live/:streamId", async (e) => {
  ...
  try {
    ...
    return o ? (await on22({ accessToken: n }, o), await s.prepare(`
      UPDATE live_streams 
...
d.post("/api/seller/products", async (e) => {
  ...
  try {
    ...
    return await Ws(e.env.CACHE_KV, `seller:${r.sellerId}:products`, `public:seller:${r.sellerId}`), e.json({ success: true, data: f });
  } catch (t) {
    return e.json({ success: false, error: t.message }, 500);
  }
});
...
d.put("/api/seller/products/:id", async (e) => {
  ...
  try {
    ...
    return await Ws(e.env.CACHE_KV, `seller:${r.sellerId}:products`, `public:seller:${r.sellerId}`), e.json({ success: true, data: h });
  } catch (t) {
    return e.json({ success: false, error: t.message }, 500);
  }
});
...
d.post("/api/orders/create", k, async (e) => {
  ...
  try {
    ...
    await s.batch([...q, ...z]);
    try {
      const R = t.map((H) => H.product_id), we = R.map(() => "?").join(","), W = await s.prepare(`
        SELECT id, name, stock, stock_alert_threshold, seller_id 
        FROM products 
        WHERE id IN (${we})
      `).bind(...R).all();
      for (const H of W.results) {
...
// .wrangler/tmp/pages-kQWoIq/kbxq895m2sh.js
...
// .wrangler/tmp/bundle-5Dcvhj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5Dcvhj/middleware-loader.entry.ts
...
//# sourceMappingURL=kbxq895m2sh.js.map
