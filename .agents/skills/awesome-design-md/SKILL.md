...
3. Translate the tokens into this project's conventions rather than pasting hex values inline.
   In this repo that means Tailwind classes and the tokens in `src/index.css` — and the
   brand color SSOT (`docs/design/brand-color-rollout.md`) still wins over anything here.
