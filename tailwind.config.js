...
// 🎨 2026-07-19 브랜드 컬러 전면 적용 (대표 개발지시서 — 웜로즈 #E0526B + 잉크):
...
const INK = {
  ...
  500: '#6E6B68', 600: '#55534F', 700: '#3D3C3A', 800: '#2A2A2B', 900: '#16181C', 950: '#0D0F12',
}
const MONO = INK
...
export default {
  ...
  theme: {
    extend: {
      ...
      // 웜 화이트(#FAF7F5) 바탕에 아무 색조 없는 검정을 얹으면 회색 때처럼 읽혀
