...
## 🤖 AI 팀 운영 모델 — 역할 6 · 결재함 1 · 완료 판정 E1~E5 (2026-09-07 대표 확정, 모든 세션 준수)
...
1. **역할** — `.claude/agents/{ceo-office,planning,marketing,design,dev,finance}.md`. 세션이 어떤 역할로 일하는지는 이 파일의
