...
*지금 설정에서 나오는 값*이다. 07-20~25 의 하강(12,533 → 732)은 **키워드 풀 소진 곡선**으로 보이고,
그렇다면 대표가 물은 *"발굴 가치가 떨어지는 시점"* 은 이미 한 번 왔다 갔다.

⚠️ **최근 3일 상승(4,266 → 5,429)의 원인은 미확정이다.** 원인을 모르면 지속도 장담 못 한다.
⇒ **"하루 N건 영구"라고 대표에게 보고하지 말 것.** 먼저 (a) 최근 상승의 원인 (b) 키워드별 수율
소진 속도를 재야 한다. 그게 없으면 어떤 숫자를 말해도 다음 주에 틀린다.
