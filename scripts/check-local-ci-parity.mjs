...
import { ciStrictGuards, EXCLUDE, localGateGuards } from './local-ci-parity.mjs'
...
console.log(`✅ local-ci-parity: CI strict ${strict.length}개 = 로컬 게이트 ${gate.size}개 + 사유 있는 제외 ${Object.keys(EXCLUDE).length}개`)
