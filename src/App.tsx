        ...
        <div className="mx-auto max-w-3xl space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button size="lg" variant="outline" asChild>
              <a href="/seller-login">판매자 가입하기</a>
            </Button>
          </div>
        </div>
      </section>
        ...
        {loading ? (
          ...
          <div className="py-20 text-center">
            ...
            <Button size="lg" asChild>
              <a href="/seller-login">셀러로 라이브 시작하기</a>
            </Button>
          </div>
        ) : (
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {streams.map((stream) => (
              <Card
                ...
                onClick={() => window.location.href = `/live/${stream.id}`}
              >
        ...
        <div className="container">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex gap-6">
              ...
              <a href="/seller-login" className="text-sm text-muted-foreground hover:text-foreground">
                셀러
              </a>
              <a href="/my-orders" className="text-sm text-muted-foreground hover:text-foreground">
                내 주문
              </a>
            </div>
          </div>
