      ...
      <FrameWrapper>
        ...
        <Suspense fallback={
          ...
          <Routes>
            ...
            {/* 🏬 2026-08-11 — 몰 **상품 상세**. `/:mallSlug` 보다 **먼저** 와야 한다(3세그먼트라
                실제로는 안 겹치지만, 순서를 지켜야 나중에 몰 하위 라우트가 늘 때 조용히 안 죽는다).
                🔴 이 화면이 생기기 전까지 몰 손님은 본진 `/products/:id` 로 나가 유어딜 크롬 + **상시가**를
                   봤다(몰 카드는 공구가). 대표 지시 "유어딜과 철저히 분리". */}
