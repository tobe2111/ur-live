...
### 3. 맛집 이용권이라는 새로운 카테고리

일반 상품뿐 아니라 **맛집 이용권**을 라이브로 판매할 수 있습니다. 인플루언서가 직접 방문한 맛집을 추천하고, 바우처로 판매하는 방식입니다.
...
판매할 상품을 등록합니다. 상품명, 가격, 이미지, 재고를 입력하세요. 이용권 상품은 별도 이용권 등록 페이지에서 맛집 정보와 함께 등록합니다.
...
어렵지 않죠? 지금 바로 시작하세요!`,
    },
    {
      ...
      title: '맛집 이용권 공동구매 — 소상공인과 인플루언서의 만남',
      summary: '인플루언서가 맛집을 추천하고, 소비자가 할인된 가격으로 이용권을 구매하는 새로운 비즈니스 모델.',
      tags: '["맛집", "공동구매", "바우처"]',
...
목표 인원이 모이면 대폭 할인된 가격에 이용권을 구매할 수 있습니다. 맛집 사장님은 마케팅 비용 없이 고객을 확보하고, 소비자는 저렴하게 맛집을 즐깁니다.

### PIN 바우처로 간편 사용

구매한 이용권은 바우처 코드(UR-XXXX-XXXX)로 발급됩니다. 식당에서 코드를 보여주면 끝! POS 연동이 필요 없어 소상공인 부담이 없습니다.
...
좋아하는 셀러를 응원하고 서포터 뱃지를 모아보세요!`,
    },
    {
      ...
      title: '이용권 바우처 사용 방법 — PIN 코드로 간편하게',
      summary: '유어딜에서 구매한 이용권 바우처를 사용하는 방법을 안내합니다. 매장에서 PIN 코드만 보여주세요.',
      tags: '["소비자", "이용권", "바우처"]',
      content: `## 이용권 바우처 사용 가이드

### 구매 후 바우처 확인

이용권을 구매하면 "내 주문" 페이지에서 바우처 코드(UR-XXXX-XXXX)를 확인할 수 있습니다.
...
맛집 탐방 콘텐츠를 만들고 계신다면, 해당 맛집의 이용권을 라이브로 판매할 수 있습니다. 맛집 사장님과 협업하여 공동구매를 진행하세요.
