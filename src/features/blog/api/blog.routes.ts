...
## 카카오맵 후기 보너스 & 동네 리뷰어 레벨

이용권을 매장에서 사용한 뒤에는 **카카오맵 후기 인증**으로 한 번 더 보상을 받을 수 있습니다.

1. 카카오맵에서 방문한 매장을 검색해 후기를 남깁니다.
2. 내 지갑의 사용 완료 이용권에서 후기 URL 또는 스크린샷을 제출합니다.
3. 매장/운영팀이 확인하면 **보너스 딜 + 동네 리뷰어 점수**가 지급됩니다.

점수가 쌓이면 **동네 리뷰어 레벨**(새싹 → 단골 → 열혈 리뷰어 → 동네 전문가 → 동네 앰버서더)이 오르고, 레벨이 높은 유저만 구매할 수 있는 **레벨 전용 이용권** 자격이 열립니다.

> 보너스는 별점·내용과 무관하게 방문 인증에 대해 지급됩니다. 후기는 솔직하게 남겨 주시고, 포인트를 받고 작성했다는 표시를 함께 남기면 좋아요.
