...
딜 포인트는 받은 방법에 따라 두 가지로 나뉩니다.

- **유상 딜**: 직접 충전한 딜입니다.
- **무상 딜**: 가입 환영, 친구 초대, 리뷰 작성, 이벤트 등 리워드로 받은 딜입니다.

둘 다 상품 결제와 후원에 똑같이 쓸 수 있습니다. 다만 두 가지 규칙이 있습니다.

- 결제 시 **무상 딜이 먼저 차감**되고, 그다음 유상 딜이 사용됩니다.
- **무상 딜은 현금 환급(출금) 대상이 아닙니다.** 현금 환급은 유상 딜 잔액 한도 안에서만 가능합니다.
...
아니요. 이벤트·리워드로 받은 무상 딜은 상품 구매와 후원에는 자유롭게 쓸 수 있지만, 현금 환급은 직접 충전한 유상 딜 잔액 한도 안에서만 가능합니다.
