...
유통스타트(utongstart.com) 도매몰의 제조사·유통사 온보딩, 등급/마진, 상품 검수(온라인 최저가 + 가격변경 승인), 주문/배송(합배송·송장), 정산, 세금계산서(바로빌), OEM/ODM 운영 전체는 단일 진실원천(SSOT) 유지를 위해 **전용 도매몰 운영 가이드**로 분리되었습니다.
