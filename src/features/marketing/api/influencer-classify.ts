...
const RULES: { cat: string; re: RegExp }[] = [
   ...
   */
  { cat: '마케팅대행사', re: /(마케팅|광고|홍보|바이럴|퍼포먼스|콘텐츠)\s*(대행사|대행|에이전시|회사|기업)|(광고|마케팅)\s*(대행|기획사)|바이럴\s*마케팅|퍼포먼스\s*마케팅|그로스\s*(해킹|마케팅)|온라인\s*마케팅|디지털\s*마케팅|SNS\s*마케팅|블로그\s*마케팅|체험단\s*(모집|대행|운영)|인플루언서\s*(마케팅|섭외|캐스팅)|브랜디드\s*콘텐츠|매체\s*(대행|집행)|광고\s*(운영|세팅|집행)|마케터/i },
