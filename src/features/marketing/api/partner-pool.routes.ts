...
app.get('/stats', async (c) => {
  ...
  const [naraRun, mxRun, enrichLast, enrichBurst, reclassifyBurst, runAll, registryMatch, lkAll, lkEnrich, lkReclassify, localdataRun, enrichRollup] = await Promise.all([
  ...
  return c.json({
    ...
    nara: { run: naraRun },
    mx: { run: mxRun },
    enrichLast, enrichRollup, enrichBurst, reclassifyBurst, runAll, running,
