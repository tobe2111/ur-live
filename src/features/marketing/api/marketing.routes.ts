...
import { adsLinksRoutes } from './routes/links.routes'
import { adsInfluencersRoutes } from './routes/influencers.routes'
...
marketingRoutes.route('/', adsLinksRoutes)
marketingRoutes.route('/', adsInfluencersRoutes)
