...
const NOISE_RE =/(뉴스|신문사|방송국|아나운서|연합뉴스|ytn|jtbc|kbs|mbc|sbs|체험단\s*모집|서포터즈\s*모집|기자단\s*모집|리뷰어\s*모집|블로그\s*마케팅|바이럴\s*마케팅|마케팅\s*대행|광고\s*대행|대행사(?!\s*(?:아님|아니))|공기업|공단|주민센터|[가-힣]{1,6}(구청|시청|군청|도청)|재단법인|사단법인)/i
