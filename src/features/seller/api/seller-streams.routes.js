...
export const sellerStreamsRoutes = new Hono();
// CORS 설정
...
sellerStreamsRoutes.post('/', async (c) => {
    ...
    `).bind(sellerId, title, description || null, thumbnail || null, stream_url || null, youtube_video_id || null, scheduled_at || null).run();
        if (!result.success) {
