 ...
 *
 * 처리 흐름:
 * 1. auto_settle=1 인 active 벤더사 조회
 * 2. 각 벤더사별로 정산 가능 주문 (DELIVERED/DONE + settlement_status='confirmed' + agency_settled=0) 집계
...
//   seller 전용 withholdAndLog()는 sellers 테이블(tax_type/사업자등록)을 조회하므로 벤더사(별도 agencies 엔티티,
