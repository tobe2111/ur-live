...
export const EXPECTED_CRON_EXPRESSIONS: readonly string[] = [
  ...
  '0 18 * * *',
  '0 19 * * *',
  // 🗄️ 2026-08-25: 주간 백업(`0 20 * * 0`)이 쓰던 슬롯을 **백업 전용 15분 트리거**로 교체했다.
  //   `*/5` 틱 위의 백업 슬롯은 40개 작업과 서브리퀘스트 예산(무료 ~50)을 나눠 써서 굶었다 —
  //   전용 트리거는 자기 인보케이션이라 예산을 통째로 쓴다. 주간 표기는 아래 별칭으로 남긴다
