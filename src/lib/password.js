...
export async function hashPassword(password) {
    ...
    const hashBuffer = await crypto.subtle.deriveBits({ name: 'PBKDF2', salt, iterations: PBKDF2_ITERATIONS, hash: PBKDF2_HASH }, key, PBKDF2_BITS);
 ...
 * 두 가지 모두 시도합니다.
 */
async function verifyLegacyHash(password, storedHash) {
