...
export default function FollowingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0F151D] pb-20">
      ...
      {/* Sticky Header */}
      <div className="sticky top-0 md:top-14 z-40 bg-white/90 dark:bg-[#0F151D]/90 backdrop-blur border-b border-gray-200 dark:border-[#2A3446]">
      ...
      <div className="ur-content-narrow px-5 lg:px-8 py-4">
        {loading ? (
          <div className="space-y-3">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="bg-gray-100 dark:bg-[#1A2334] rounded-xl p-4 animate-pulse border border-gray-200 dark:border-[#2A3446] flex items-center gap-3">
          ...
          <div className="space-y-3">
            ...
            {sellers.map(seller => (
              <button
                ...
                className="w-full flex items-center gap-3 bg-gray-50 dark:bg-[#1A2334] rounded-xl px-4 py-3.5 border border-gray-200 dark:border-[#2A3446] hover:bg-gray-100 dark:hover:bg-[#1A2334] transition-colors text-left"
              >
                <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-[#1A2334] overflow-hidden flex-shrink-0">
