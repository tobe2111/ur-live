    ...
    <div className="mx-4 mb-3 bg-white dark:bg-[#11141C] rounded-xl border border-gray-200 dark:border-[#2C2F35] p-4">
      ...
      {loadingGroups ? (
        <div className="mt-3 space-y-2">
          <div className="h-14 rounded-lg bg-gray-50 dark:bg-[#1D1F29] animate-pulse" />
        </div>
      ) : groups.length > 0 && (
        <div className="mt-4">
              ...
              return (
                ...
                >
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="h-1.5 w-full bg-gray-100 dark:bg-[#1D1F29] rounded-full overflow-hidden">
                      <div
