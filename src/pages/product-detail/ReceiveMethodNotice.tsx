...
export function PickupNotice({ pickup }: { pickup: PickupInfo }) {
  ...
  return (
    <div className="mt-3 rounded-2xl overflow-hidden bg-[#F7F5F6] dark:bg-[#1A2334]">
      ...
      <div className="px-4 py-[15px]">
        ...
        {pickup.storage && (
          <div className="flex items-center gap-[7px] mt-3 pt-3 border-t border-[#EAE5E7] dark:border-[#2A3446]">
