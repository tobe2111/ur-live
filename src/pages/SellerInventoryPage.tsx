...
// 🛡️ 2026-05-02: TD-018 분할 — types/TYPE_LABELS 를 ./seller-inventory/types 로 추출.
import { TYPE_LABELS } from './seller-inventory/types'
import type { Product, StockMovement } from './seller-inventory/types'
