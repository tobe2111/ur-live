    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-100">
        <div className="flex items-center px-4 py-3">
          ...
          <h1 className="text-[16px] font-bold text-gray-900 ml-2">자주 묻는 질문</h1>
        </div>
      </header>
      ...
      <div className="px-4 pt-4 pb-20">
        ...
        <div className="mb-5">
          ...
          <p className="text-[13px] text-gray-500">궁금한 내용을 빠르게 찾아보세요.</p>
        </div>
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-3 bg-gray-100 rounded-xl text-[14px] text-gray-900 placeholder:text-gray-400 focus:bg-white focus:ring-1 focus:ring-gray-900 focus:outline-none transition-all"
          />
        </div>
        ...
        {filteredFAQs.length === 0 ? (
          <div className="py-16 text-center">
            ...
            <p className="text-[14px] text-gray-500">검색 결과가 없습니다.</p>
          </div>
        ) : (
                ...
                <div key={faq.id} className="border-b border-gray-100">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] text-gray-500 font-medium mb-1">{faq.category}</p>
                      <p className="text-[14px] font-medium text-gray-900 leading-snug">{faq.question}</p>
                    </div>
                    <ChevronDown
                      className={`shrink-0 w-4 h-4 text-gray-400 mt-1 transition-transform ${isOpen ? 'rotate-180' : ''}`}
                    />
                  </button>

                  {isOpen && (
                    <div className="pb-4 pl-9 pr-4 -mt-1">
                      <p className="text-[13px] text-gray-600 leading-relaxed whitespace-pre-line">{faq.answer}</p>
                    </div>
                  )}
                </div>
              )
        ...
        <div className="mt-8 bg-gray-50 rounded-2xl p-5">
          <h2 className="text-[14px] font-bold text-gray-900 mb-1">도움이 더 필요하신가요?</h2>
          <p className="text-[12px] text-gray-500 mb-4">궁금한 사항이 해결되지 않았다면 연락주세요.</p>
          <div className="space-y-2.5">
            <div className="flex items-center gap-2.5 text-[13px] text-gray-700">
              <Phone className="w-3.5 h-3.5 text-gray-400" />
              <span className="text-gray-500 w-16">고객센터</span>
              <span className="font-medium text-gray-900">0507-0177-0432</span>
            </div>
            <div className="flex items-center gap-2.5 text-[13px] text-gray-700">
              <Clock className="w-3.5 h-3.5 text-gray-400" />
              <span className="text-gray-500 w-16">운영시간</span>
              <span className="font-medium text-gray-900">평일 09:00 - 18:00</span>
            </div>
            <div className="flex items-center gap-2.5 text-[13px] text-gray-700">
              <Mail className="w-3.5 h-3.5 text-gray-400" />
              <span className="text-gray-500 w-16">이메일</span>
              <span className="font-medium text-gray-900">support@ur-team.com</span>
            </div>
          </div>
        </div>
      </div>
