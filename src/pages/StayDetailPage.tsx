          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
              {amenitiesArr.map((a) => {
                ...
                return (
                  <div key={a} className="flex flex-col items-center gap-1 p-2 bg-white dark:bg-[#0D0F12] rounded-lg border border-gray-200 dark:border-[#2C2F35]">
                    {m.icon}
        ...
        <div className="mb-5">
          ...
          {roomsLoading ? (
            ...
            <div className="space-y-3">
              {rooms.map((r) => (
                <div key={r.room_id} className={`bg-white dark:bg-[#0D0F12] border rounded-xl p-4 shadow-sm ${r.available ? 'border-gray-200 dark:border-[#2C2F35]' : 'border-red-200 dark:border-red-900/30 opacity-60'}`}>
                        ...
                        <div className="mt-2 space-y-1.5">
                          ...
                          <div className="flex items-center justify-end gap-2 text-xs">
                            ...
                            <button
                              ...
                              className="w-6 h-6 rounded-full bg-gray-200 dark:bg-[#1A1C21] text-gray-700 dark:text-white disabled:opacity-30 font-bold"
                            >−</button>
