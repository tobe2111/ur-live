...
export default function CuratorPage() {
  ...
  if (error || !data) {
    return (
      <div className="min-h-[100dvh] bg-warm dark:bg-[#0F151D] text-gray-900 dark:text-white flex flex-col items-center justify-center px-4 text-center">
  ...
  return (
    <>
      ...
      <div className="min-h-[100dvh] bg-warm dark:bg-[#0F151D] text-gray-900 dark:text-white pb-28">
