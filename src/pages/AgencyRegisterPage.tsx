      ...
      <div className="hidden lg:flex lg:w-[420px] xl:w-[480px] flex-col bg-white border-r border-gray-200">
        ...
        <div className="flex-1 flex flex-col justify-center px-10">
          <h1 className="text-3xl font-bold text-gray-900 leading-tight mb-3">
            에이전시 파트너로<br />함께 성장하세요
          </h1>
          <p className="text-gray-500 text-base mb-8">
            유어딜 에이전시로 등록하면 소속 셀러들의 라이브 커머스를 통합 관리하고 수익을 함께 나눌 수 있습니다.
          </p>
          <div className="space-y-4">
            {[
              '소속 셀러 매출·주문·라이브 통합 대시보드',
              '에이전시 전담 고객지원',
              '셀러 퍼포먼스 리포트 제공',
            ].map(text => (
        ...
        <div className="px-10 pb-8">
          <p className="text-xs text-gray-400">© 2026 유어딜. 에이전시 파트너 전용 서비스</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-1">에이전시 가입 신청</h2>
            <p className="text-gray-500 text-sm mb-7">가입 신청 후 관리자 승인 시 이용 가능합니다</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* 에이전시명 */}
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1.5">에이전시명 <span className="text-red-500">*</span></label>
              ...
              {/* 담당자명 */}
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1.5">담당자명 <span className="text-red-500">*</span></label>
                <div className="relative">
              ...
              {/* 비밀번호 */}
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1.5">비밀번호 <span className="text-red-500">*</span></label>
                <div className="relative">
              ...
              {/* 비밀번호 확인 */}
              <div>
                <label className="block text-xs font-medium text-gray-700 mb-1.5">비밀번호 확인 <span className="text-red-500">*</span></label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  <input
