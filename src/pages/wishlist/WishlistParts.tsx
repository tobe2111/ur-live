...
/**
 * 카드 본문 맨 위 한 줄 — 지금은 '가격 내림' 하나다.
 *
 * 🗓️ 2026-09-04 (대표 "마감 개념은 없어"): 'N일 남음' 배지를 뺐다. 마감이 없어지자 그 값은
 *    언제나 null 이라 한 번도 안 떴고, 남겨 두면 없는 마감을 알리는 자리만 지키게 된다.
 */
 ...
 *
 * ⚠️ 큰 숫자는 **0 을 띄우지 않는다.** 인하가 없으면 전체 개수로 내려간다.
 *    텅 빈 화면에 커다란 0 을 세우는 것은 정보가 아니라 실망이다.
 */
