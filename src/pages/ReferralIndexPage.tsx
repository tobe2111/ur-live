    ...
    <div className="min-h-screen bg-white dark:bg-[#0D0F12]">
      ...
      <main className="ur-content-narrow px-4 lg:px-8 pb-20">
        ...
        <section className="mb-8">
          ...
          <div className="bg-white dark:bg-[#0D0F12] rounded-2xl border border-gray-100 dark:border-[#2C2F35] divide-y divide-gray-100 dark:divide-[#2C2F35]">
            {[
              {
                icon: ShoppingBag,
        ...
        <section className="space-y-2">
          ...
          <button
            ...
            className="w-full py-3.5 bg-white dark:bg-[#0D0F12] text-gray-900 dark:text-white border border-gray-200 dark:border-[#2C2F35] text-[14px] font-semibold rounded-full hover:bg-gray-50 dark:hover:bg-[#1A1C21] transition-colors"
          >
