  ...
  return (
      <div className={`ur-content-wide px-4 lg:px-8 mt-3 ${category === 'general' ? 'hidden' : 'flex items-center gap-2'}`}>
        <button
          ...
          className={`shrink-0 inline-flex items-center gap-1.5 px-3 py-2 rounded-full text-[13px] font-semibold border transition-colors ${
            (regionKey || gpsRegion)
              ...
              : 'bg-white dark:bg-[#1A2334] border-gray-200 dark:border-[#2A3446] text-gray-700 dark:text-gray-300'
          }`}
          aria-label="지역 선택"
        >
        ...
        <button
          ...
          className="shrink-0 inline-flex items-center gap-1 px-3 py-2 rounded-full text-[13px] font-semibold border border-gray-200 dark:border-[#2A3446] bg-white dark:bg-[#1A2334] text-gray-700 dark:text-gray-300 disabled:opacity-50"
