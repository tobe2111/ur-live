...
export default function CommunityGroupBuyCard({
  ...
  return (
    <button
      ...
      className="w-full text-left border border-gray-100 dark:border-[#2A3446] rounded-2xl p-4 active:scale-[0.98] transition-transform bg-white dark:bg-[#1A2334] hover:border-gray-200 dark:hover:border-[#3A3A3A]"
    >
      {/* 상단: 아이콘 + 식당명 + 상태 배지 */}
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          <div className="w-9 h-9 rounded-xl bg-gray-100 dark:bg-[#1A2334] flex items-center justify-center flex-shrink-0">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <button
            ...
            className="w-7 h-7 flex items-center justify-center rounded-full border border-gray-200 dark:border-[#2A3446] active:scale-90 transition-transform"
      ...
      {/* 진행률 바 */}
      <div className="mt-3">
        <div className="w-full h-2.5 bg-gray-100 dark:bg-[#1A2334] rounded-full overflow-hidden">
          <div
