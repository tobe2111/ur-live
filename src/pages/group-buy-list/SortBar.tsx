  ...
  return (
      <div className={`ur-content-wide px-4 lg:px-8 ${mainTab === 'seller' ? 'mt-3' : 'mt-4'} flex items-center justify-between`}>
        ...
        <div className="relative" onClick={(e) => e.stopPropagation()}>
          ...
          {showSortDropdown && (
            <div role="menu" className="absolute top-full right-0 mt-1 w-36 bg-white dark:bg-[#1C1C1E] border border-gray-200 dark:border-[#2A3446] rounded-xl shadow-lg z-30 overflow-hidden">
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2.5 text-[13px] ${
                    sortBy === opt
                      ...
                      : 'text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#1A2334]'
                  }`}
                >
                  {SORT_LABELS[opt]}
                </button>
