    ...
    <>
        ...
        {referred.length === 0 ? (
          ...
          <ul className="space-y-2">
            {referred.map(s => {
              ...
              return (
                <li key={s.id} className="flex items-center justify-between border-b border-gray-100 dark:border-[#2C2F35] pb-2 last:border-0 last:pb-0">
      ...
      <div className="bg-white dark:bg-[#11141C] border border-gray-200 dark:border-[#2C2F35] rounded-xl p-5">
        ...
        {deals.length === 0 ? (
          ...
          <ul className="space-y-2">
            {deals.map(d => (
              <li key={d.id} className="flex items-center justify-between border-b border-gray-100 dark:border-[#2C2F35] pb-2 last:border-0 last:pb-0">
                <div className="flex-1 min-w-0">
