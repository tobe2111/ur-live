 ...
 *
 * ⚠️ 위 수치는 **데모 시드 포함**이다. 같은 날 실측에서 활성 딜 329건 중 **328건이 데모**였고
 * 실제 상품은 1건뿐이었다 — 즉 "전국 합계 11건"조차 대부분 가짜다. 재고를 셀 때는 `demo-`
 * 슬러그를 먼저 갈라낼 것(그러지 않아 이 기능의 색인 가치를 10배 넘게 부풀려 보고한 적이 있다).
 */
