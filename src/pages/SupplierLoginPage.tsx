...
export default function SupplierLoginPage() {
  ...
  useEffect(() => {
    ...
    // 🏭 2026-06-29 (교과서적 — off-by-default): 카카오 명시 로그인 직후 1회만 토큰교환 probe.
    if (typeof window !== 'undefined' && localStorage.getItem('user_id') && consumeWholesaleLoginIntent()) {
      (async () => {
        try {
  ...
  return (
    <div className="force-light-theme min-h-[100dvh] flex bg-gray-50">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-sm md:max-w-md">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            ...
            <button type="button" onClick={() => { setWholesaleLoginIntent(); window.location.href = '/auth/kakao/start?redirect=/supplier/login&intent=user' }}
