 ...
 *   브랜드 토큰: brand(#E0526B) / 잉크 #1A2C42 / 웜 #FAF7F5 (지시서 공통).
 */
...
function Faq({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-[#EAE4E0] dark:border-[#2A3446]">
      <button onClick={() => setOpen(v => !v)} className="w-full flex items-center justify-between gap-3 py-4 text-left">
        <span className="text-[14.5px] font-bold text-[#1A2C42] dark:text-[#F5F3F1]">{q}</span>
      ...
      <main className="px-5 pb-32 max-w-xl mx-auto">
        ...
        <section className="pt-8 pb-10">
          ...
          <div className="grid grid-cols-3 gap-2 mt-7">
            {TRUST.map(({ n, d }) => (
              <div key={d} className="rounded-2xl bg-white dark:bg-[#1A2334] px-2 py-4 text-center">
                <p className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1]">{n}</p>
        ...
        <section className="pb-10">
          <h2 className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1] mb-4">사장님이 하실 일은 거의 없습니다</h2>
          <div className="space-y-2.5">
            {STEPS.map(({ icon: Icon, t, d }, i) => (
              <div key={t} className="flex items-start gap-3.5 rounded-2xl bg-white dark:bg-[#1A2334] p-4">
                ...
                <div className="min-w-0">
                  <p className="text-[14.5px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1]"><span className="text-brand mr-1">{i + 1}.</span>{t}</p>
        ...
        {/* ③ 내 몫 계산기 */}
        <section className="pb-10">
          <h2 className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1] mb-1">내 몫 계산기</h2>
          <p className="text-[12.5px] text-gray-500 dark:text-gray-400 mb-4">정가와 할인율만 넣어보세요 — 입금액이 바로 보입니다</p>
          <div className="rounded-2xl bg-white dark:bg-[#1A2334] p-5 space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <label className="block">
                ...
                <input type="number" inputMode="numeric" value={price} min={0} step={1000}
                  ...
                  className="mt-1 w-full h-11 px-3 rounded-xl border border-gray-200 dark:border-[#2A3446] bg-white dark:bg-[#0F151D] text-[15px] font-bold text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand" />
              </label>
              <label className="block">
            ...
            <div className="rounded-xl bg-[#FAF7F5] dark:bg-[#0F151D] p-4 space-y-1.5">
              ...
              <div className="border-t border-dashed border-gray-200 dark:border-[#2A3446] pt-2 flex justify-between items-baseline">
                <span className="text-[13.5px] font-bold text-[#1A2C42] dark:text-[#F5F3F1]">사장님 입금</span>
        ...
        {/* ④ FAQ */}
        <section className="pb-10">
          <h2 className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1] mb-2">자주 묻는 질문</h2>
        ...
        <section id="cta" className="pb-6">
          <div className="rounded-2xl bg-[#1A2C42] dark:bg-[#1A2334] p-6 text-center">
            ...
            <p className="text-[12.5px] text-[#9AA5B5] mt-1.5">가입 5분 · 설치 0 · 선불 비용 0</p>
          </div>
        </section>
      </main>
