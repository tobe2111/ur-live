    ...
    <div className="min-h-screen bg-white text-[#17181C]">
      ...
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur border-b border-[#ECEEF1]">
        <div className="ur-content-wide mx-auto px-4 lg:px-8 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-sm">
            <button onClick={() => navigate('/wholesale/login')} className="px-3 py-2 text-[#4E5560] hover:text-[#17181C] font-medium">유통사 로그인</button>
      ...
      <section className="ur-content-wide mx-auto px-4 lg:px-8 pt-14 pb-16 lg:pt-24 lg:pb-24 text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <button onClick={() => navigate('/supplier/register')}
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-[#17181C] text-white font-bold text-[15px] hover:bg-[#2A2F37] transition-colors">
            <Factory className="w-5 h-5" /> 제조사로 입점하기 <ArrowRight className="w-4 h-4" />
          </button>
        </div>
        <p className="mt-4 text-xs text-[#B6BCC4]">가입 후 바로 카탈로그 열람 · 유통사는 가입 시 C등급 즉시 적용</p>
      </section>
      ...
      <section className="bg-[#F4F5F7] border-y border-[#ECEEF1]">
        <div className="ur-content-wide mx-auto px-4 lg:px-8 py-16 lg:py-20 grid lg:grid-cols-2 gap-6">
          <div className="rounded-2xl bg-white border border-[#ECEEF1] p-7">
            <div className="flex items-center gap-2 mb-4"><Factory className="w-6 h-6 text-[#17181C]" /><h3 className="text-xl font-extrabold">제조사라면</h3></div>
          ...
          <div className="rounded-2xl bg-white border border-[#ECEEF1] p-7">
            <div className="flex items-center gap-2 mb-4"><Store className="w-6 h-6 text-[#17181C]" /><h3 className="text-xl font-extrabold">유통사라면</h3></div>
            <ul className="space-y-3 text-sm text-[#4E5560]">
      ...
      <section className="ur-content-wide mx-auto px-4 lg:px-8 py-16 lg:py-24 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <button onClick={() => navigate('/supplier/register')} className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-[#17181C] text-white font-bold hover:bg-[#2A2F37] transition-colors"><Factory className="w-5 h-5" /> 제조사로 입점</button>
        </div>
      </section>
