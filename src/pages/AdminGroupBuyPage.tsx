    ...
    <AdminLayout title={scope === 'main' ? '이용권 공구 모니터링 (유어딜)' : '몰 상품·공구 모니터링 (공구 서비스)'}>
      <div className="mx-auto max-w-6xl space-y-5 p-4 sm:p-6 lg:p-8">
        <DashboardPageHeader
          ...
          subtitle={
            scope === 'main' ? '유어딜 본진 — 진행 중 / 달성 / 미달성 / 강제 환불 + 카테고리별 analytics'
              : scope === 'mall' ? '공구 서비스 — 운영자 몰(urdeal.kr/{슬러그}) 상품만'
                : '유어딜 + 운영자 몰을 함께 봅니다 — 실적 해석 시 주의'
          }
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500">
                        {p.mall_slug ? (
                          <span className="mr-1 inline-flex items-center gap-0.5 rounded bg-tone-ok-bg px-1.5 py-0.5 text-[10px] font-bold text-tone-ok align-middle">
