  ...
  return (
    <footer className="mt-14 border-t" style={{ background: WT.fill, borderColor: WT.line, color: WT.ink2 }}>
      ...
      <div className="border-b" style={{ borderColor: WT.line }}>
        <div className="ur-content-wide px-5 lg:px-8 py-2.5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <nav className="flex flex-wrap items-center gap-x-3.5 gap-y-1 text-[12px] font-bold" style={{ color: WT.ink }}>
            {INFO_LINKS.map((l) => (
          ...
          <nav className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] font-medium" style={{ color: WT.ink3 }}>
      ...
      {/* 본문 — 사업자정보 + 고객센터 */}
      <div className="ur-content-wide px-5 lg:px-8 py-5">
        <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-5 lg:gap-7">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="text-[11px] leading-relaxed" style={{ color: WT.ink3 }}>
              <p>
                ...
                <span className="mx-1" style={{ color: WT.ink4 }}>|</span>
                {BUSINESS_INFO.corp}
                <span className="mx-1" style={{ color: WT.ink4 }}>|</span>
          ...
          <div className="flex flex-col gap-1">
            <p className="text-[11px] font-bold" style={{ color: WT.ink3 }}>고객센터 및 제휴문의</p>
            <a href={`tel:${BUSINESS_INFO.repPhone}`} className="text-[17px] font-extrabold leading-none" style={{ color: WT.ink }}>
              {BUSINESS_INFO.repPhone}
            </a>
            <a href={`mailto:${BUSINESS_INFO.csEmail}`} className="text-[11px] font-bold hover:underline" style={{ color: WT.brand }}>
            ...
            <a
              ...
              className="mt-1 inline-flex w-fit items-center gap-1 rounded-lg px-2.5 py-1 text-[11px] font-bold text-white"
      ...
      <div className="border-t" style={{ borderColor: WT.line }}>
        <div className="ur-content-wide px-5 lg:px-8 py-3 flex flex-wrap items-center gap-1.5">
          {TRUST_BADGES.map((b) => (
            <span
              key={b}
      ...
      <div style={{ background: WT.ink }}>
        <div className="ur-content-wide px-5 lg:px-8 py-4 flex flex-col gap-1.5">
          <p className="text-[10px] leading-relaxed" style={{ color: '#B6BCC4' }}>
