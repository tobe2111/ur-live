    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10" style={{ background: WT.fill }}>
      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[16px] font-extrabold" style={{ color: WT.ink }}>유통사로 가입</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[12.5px] mt-0.5" style={{ color: WT.ink2 }}>상품을 공급하고 전국 유통사에게 판매해요</p>
            </div>
        ...
        <p className="text-[12.5px] text-center mt-3" style={{ color: WT.ink3 }}>
          이미 회원이신가요?{' '}
          <button onClick={() => navigate('/wholesale/login')} className="font-bold underline" style={{ color: WT.ink2 }}>유통사 로그인</button>
          {' · '}
