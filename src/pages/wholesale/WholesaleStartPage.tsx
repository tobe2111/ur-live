 ...
 *   "제조사 or 판매사(판매사) 먼저 선택하고 가입" — 모든 '회원가입' 진입점이 이 화면을
      ...
      <div className="w-full max-w-md">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[16px] font-extrabold" style={{ color: WT.ink }}>판매사로 가입</p>
              <p className="text-[12.5px] mt-0.5" style={{ color: WT.ink2 }}>상품을 등급 도매가로 사입해 판매해요</p>
            </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[16px] font-extrabold" style={{ color: WT.ink }}>제조사로 가입</p>
              <p className="text-[12.5px] mt-0.5" style={{ color: WT.ink2 }}>상품을 공급하고 전국 판매사에게 판매해요</p>
            </div>
        ...
        <p className="text-[12.5px] text-center mt-3" style={{ color: WT.ink3 }}>
          이미 회원이신가요?{' '}
          <button onClick={() => navigate('/wholesale/login')} className="font-bold underline" style={{ color: WT.ink2 }}>판매사 로그인</button>
          {' · '}
          <button onClick={() => navigate('/supplier/login')} className="font-bold underline" style={{ color: WT.ink2 }}>제조사 로그인</button>
        </p>
      </div>
    </div>
  )
