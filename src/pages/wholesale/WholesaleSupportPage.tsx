...
const FAQS: Faq[] = [
  ...
  { cat: '등급·회원', q: '회원 등급은 어떻게 정해지나요?', a: 'Basic 등급은 가입 승인 시 부여되며, Standard(연 구독)·Premium(매출 기준) 등급으로 올라갈수록 더 낮은 공급가가 적용됩니다. 등급별 마진은 카탈로그 공급가에 자동 반영됩니다.' },
  { cat: '등급·회원', q: '직원 계정을 추가할 수 있나요?', a: '판매사 owner/관리자 계정은 대시보드 > 직원 계정 메뉴에서 직원을 초대할 수 있습니다. 직원은 본인 계정으로 로그인하되 회사의 예치금·주문·카탈로그를 공유합니다.' },
