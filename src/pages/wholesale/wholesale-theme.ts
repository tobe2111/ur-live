...
/** Toss 그레이스케일 + 브랜드 액센트 토큰 (2026-06-15 시안 정렬 — 유통스타트 도매몰.dc.html) */
export const WT = {
  ink: '#15171C',   // 근블랙 (강조 텍스트/주요 면·다크 유틸바) — 시안 정렬
  ink2: '#5E646C',  // 보조 텍스트 — 시안 정렬
  ink3: '#8A929E',  // 캡션
  ink4: '#B6BCC4',  // 흐린 텍스트
  inkPink: '#FF5C7A', // 다크 배경 위 액센트(레드 가독 보정) — 시안 정렬
