...
const SECTIONS: { title: string; body: string[] }[] = [
  {
    title: '제1조 (총칙)',
    body: [
      `${BUSINESS_INFO.company}(이하 "회사")는 회사가 운영하는 B2B 도매 플랫폼 "유통스타트"(이하 "서비스")를 이용하는 회원(제조사·유통사)의 개인정보를 중요하게 생각하며, 「개인정보 보호법」 등 관련 법령을 준수합니다.`,
  ...
  },
  {
    ...
    body: [
      ...
      '② 다만 거래 이행을 위해 필요한 최소한의 범위에서 제공합니다: 직배송을 위해 제조사(공급자)에게 수령인 정보를, 유통사에게 송장·배송 정보를 제공합니다.',
