      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90dvh] overflow-y-auto">
        ...
        <form onSubmit={onSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input type="text" value={formData.name} onChange={e => setFormData({ ...formData, name: e.target.value })} required className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
          </div>

          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1.5">{t('admin.products.k050', { defaultValue: '짧은 설명' })}</label>
            <textarea value={formData.description} onChange={e => setFormData({ ...formData, description: e.target.value })} rows={2} className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
          </div>

          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1.5">{t('admin.products.k051', { defaultValue: '상세 설명' })}</label>
            <textarea value={formData.long_description} onChange={e => setFormData({ ...formData, long_description: e.target.value })} rows={6} className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 font-mono focus:ring-2 focus:ring-blue-500 focus:outline-none" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input type="number" value={formData.price} onChange={e => setFormData({ ...formData, price: e.target.value })} required min="0" placeholder="89000" className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
            <div>
              <label className="block text-xs font-medium text-gray-700 mb-1.5">{t('admin.products.k053', { defaultValue: '정가 (할인 전)' })}</label>
              <input type="number" value={formData.compare_at_price} onChange={e => setFormData({ ...formData, compare_at_price: e.target.value })} min="0" placeholder="149000" className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
            </div>
          </div>
          ...
          <div>
            ...
            <input type="number" value={formData.stock} onChange={e => setFormData({ ...formData, stock: e.target.value })} required min="0" placeholder="50" className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <input type="url" value={formData.image_url} onChange={e => setFormData({ ...formData, image_url: e.target.value })} placeholder={t('admin.products.k058', { defaultValue: '또는 이미지 URL 직접 입력' })} className="w-full px-3 py-2 mt-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {formData.detail_images.map((url, i) => (
                <input key={i} type="url" value={url} onChange={e => { const imgs = [...formData.detail_images]; imgs[i] = e.target.value; setFormData({ ...formData, detail_images: imgs }) }} placeholder={`${t('admin.products.k059', { defaultValue: '상세 이미지' })} ${i + 1} URL`} className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none" />
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select value={formData.category} onChange={e => setFormData({ ...formData, category: e.target.value })} required className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                {[
            ...
            <div>
              ...
              <select value={formData.product_type} onChange={e => setFormData({ ...formData, product_type: e.target.value as 'live' | 'featured' })} required className="w-full px-3 py-2 border border-gray-200 dark:border-[#2C2F35] rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 dark:border-[#2C2F35]">
