                ...
                {req.status === 'PENDING' && (
                  <div className="flex-shrink-0 flex flex-col gap-2 w-48">
                    <textarea
                      ...
                      rows={2}
                      className="w-full px-2 py-1.5 text-xs border border-gray-200 dark:border-[#2C2F35] rounded-lg text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none resize-none"
                    />
