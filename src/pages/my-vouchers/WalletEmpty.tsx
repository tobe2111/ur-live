...
export function WalletSkeleton() {
  return (
    <div className="animate-pulse" aria-hidden>
      ...
      {/* 패스 카드 2장 */}
      {[0, 1].map(i => (
        <div key={i} className="rounded-[18px] bg-white dark:bg-[#1D1F29] shadow-lift p-4 mb-4">
          ...
          <Fragment key={i}>
            ...
            <div className="flex flex-col items-center gap-2 w-[66px] shrink-0">
              <div className="relative w-11 h-11 rounded-2xl flex items-center justify-center bg-brand-tint text-brand-text">
                ...
                <span className="absolute -top-1 -right-1 w-[15px] h-[15px] rounded-full bg-white dark:bg-[#1D1F29] border border-rule-strong text-[9px] font-extrabold text-gray-500 dark:text-gray-400 flex items-center justify-center tabular-nums">{i + 1}</span>
              </div>
