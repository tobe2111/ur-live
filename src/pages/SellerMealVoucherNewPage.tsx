...
export default function SellerMealVoucherNewPage() {
  ...
  const [form, setForm] = useState({
    ...
    region_si: '',
    region_gu: '',
    // 🛡️ 2026-05-30: 즉시판매 단일가 모델 — 동적 tier 입력 제거. 공구가는 price 단일 (design/groupbuy-instant-sale.md).
  })
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-4">
              ...
              {/* 🛡️ 2026-05-30: 즉시판매 단일가 모델 — 동적 tier 제거 (design/groupbuy-instant-sale.md).
                  공구가는 위 '판매가(price)' 단일 가격으로 모든 참여자에게 동일 적용. */}
