...
export default function NearbyEmptyBanner({ loading, userLoc, sortBy, list, onOpenRegion }: {
  ...
  return (
    <div className="mb-3 flex items-center justify-between gap-3 rounded-xl bg-gray-50 dark:bg-[#1A2334] border border-gray-100 dark:border-[#2A3446] px-3.5 py-3">
      ...
      <button
        ...
        className="shrink-0 px-3 py-2 rounded-lg bg-white dark:bg-[#0F151D] border border-gray-200 dark:border-[#2A3446] text-[12px] font-bold text-gray-900 dark:text-white active:scale-95 transition-transform"
      >
