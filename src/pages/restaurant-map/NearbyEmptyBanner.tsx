  ...
  return (
    <div className="mb-3 flex items-center justify-between gap-3 rounded-xl bg-gray-50 dark:bg-[#1D1F29] border border-gray-100 dark:border-[#2C2F35] px-3.5 py-3">
      ...
      <button
        ...
        className="shrink-0 px-3 py-2 rounded-lg bg-surface border border-line text-[12px] font-bold text-gray-900 dark:text-white active:scale-95 transition-transform"
      >
