...
export default function BusinessLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="mailto:jiwon@ur-team.com" className="px-6 py-3.5 border-2 border-gray-200 dark:border-[#2A2A2A] hover:border-gray-300 rounded-full font-bold flex items-center gap-2 text-gray-700 dark:text-gray-200">
          ...
          <div className="hidden lg:flex justify-center">
            <div className="relative w-[300px] aspect-[9/19.5] rounded-[40px] border-[8px] border-gray-900 bg-gray-100 dark:bg-[#1A1A1A] overflow-hidden shadow-2xl">
              <div className="absolute inset-0 p-4 flex flex-col gap-3">
                ...
                <div className="bg-white dark:bg-[#0A0A0A] rounded-2xl p-4 shadow-sm">
                  ...
                  <div className="w-full bg-gray-100 dark:bg-[#1A1A1A] rounded-full h-2 mb-2">
      ...
      {/* 4 핵심 가치 */}
      <section className="bg-gray-50 dark:bg-[#121212] px-6 lg:px-12 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              <div key={i} className="bg-white dark:bg-[#0A0A0A] rounded-2xl p-6 border border-gray-100 dark:border-[#1A1A1A]">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-50 rounded-3xl p-6 lg:p-10 border border-pink-100">
            <div className="space-y-6">
              ...
              <div className="border-t border-pink-200 pt-6 grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-[#0A0A0A] rounded-2xl p-4 text-center">
      ...
      <section className="bg-gradient-to-br from-gray-800 to-gray-800 px-6 lg:px-12 py-16 text-white text-center">
        ...
        <button
          onClick={() => navigate('/seller/register')}
          className="px-8 py-4 bg-white dark:bg-[#0A0A0A] text-pink-600 rounded-full font-extrabold text-lg shadow-xl hover:scale-105 transition-transform"
        >
          무료로 시작하기 →
        </button>
