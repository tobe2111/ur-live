    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onClose} role="presentation">
      <div className="bg-white dark:bg-[#0A0A0A] rounded-2xl w-full max-h-[80dvh] overflow-y-auto" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label={t('orderDetail.title', { defaultValue: '주문 상세' })}>
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Order Items */}
          <div>
            <h4 className="text-[15px] font-semibold text-gray-900 dark:text-white mb-3">{t('orderDetail.sectionItems', { defaultValue: '주문 상품' })}</h4>
          ...
          <div>
            ...
            <div className="space-y-2 text-[14px]">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{t('orderDetail.shippingFeeValue', { defaultValue: '3,000원' })}</span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-white">{order.payment_method || t('orderDetail.mockPayment', { defaultValue: 'Mock 결제' })}</span>
              </div>
            </div>
          </div>
