...
export default function MyStaysPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#11141C] text-gray-900 dark:text-white pb-safe-nav">
      ...
      <div className="ur-content-wide px-4 lg:px-8 py-4">
        {loading ? (
          ...
          <div className="space-y-3">
            {bookings.map((b) => {
              const st = STATUS_LABELS[b.status] || { label: b.status, color: 'bg-gray-100 text-gray-600 dark:bg-[#1D1F29] dark:text-gray-300' }
