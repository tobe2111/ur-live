  ...
  return (
    <>
      ...
      <div className="mt-5 grid gap-3 lg:grid-cols-3">
        ...
        <button onClick={() => onGo('keywords')} className="text-left rounded-2xl p-5 bg-gray-900 dark:bg-white text-white dark:text-[#0F151D] hover:brightness-110 dark:hover:brightness-95 transition">
          <div className="text-[26px]">🔎</div>
          ...
          {DASH_TABS.filter((t) => t.id !== 'home').map((t) => {
            ...
            return (
              <button key={t.id} onClick={() => onGo(t.id)}
                className="flex items-center gap-3 text-left rounded-2xl border border-gray-200 dark:border-[#2A3446] bg-white dark:bg-[#1A2334] p-3.5 hover:border-gray-300 dark:hover:border-[#3A4456] transition-colors">
