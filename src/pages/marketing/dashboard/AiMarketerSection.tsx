  ...
  return (
    <section id="sec-ai" style={{ scrollMarginTop: 76 }} className={`mt-3 ${CARD_CLS}`}>
      ...
      <div className="mt-2 flex gap-2">
        ...
        <button onClick={runAiMarketer} disabled={aiBusy} className="shrink-0 rounded-lg bg-gray-900 dark:bg-white px-4 py-2 text-[12px] font-bold text-white dark:text-[#11141C] disabled:opacity-50">{aiBusy ? '분석 중…' : 'AI 분석 받기'}</button>
      </div>
