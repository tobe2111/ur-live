  ...
  return (
    <div className={`mt-3 ${card}`}>
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-[1fr_150px_auto]">
        ...
        <button onClick={create} disabled={busy} className="h-10 px-4 rounded-lg bg-gray-900 dark:bg-white text-[13px] font-bold text-white dark:text-[#11141C] disabled:opacity-50">{busy ? '생성 중…' : '단축하기'}</button>
      </div>
