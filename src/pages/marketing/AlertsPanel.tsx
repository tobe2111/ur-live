      ...
      {s && (
        <>
          ...
          <div className="mt-3 flex items-center gap-2">
            <button onClick={preview} disabled={previewBusy} className="rounded-lg border border-gray-200 dark:border-[#2C2F35] px-3 py-1.5 text-[12px] font-bold text-gray-700 dark:text-gray-200 disabled:opacity-50">{previewBusy ? '확인 중…' : '지금 확인'}</button>
