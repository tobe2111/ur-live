    ...
    >
      <div className="space-y-2">
            ...
            return (
              <div
                ...
                className={`relative rounded-xl p-4 cursor-pointer transition-all active:scale-[0.99] ${
                  isSelected
                    ? 'bg-gray-50 dark:bg-[#1A2334] ring-1 ring-gray-900'
                    : 'bg-white dark:bg-[#0F151D] border border-gray-100 dark:border-[#2A3446] hover:bg-gray-50 dark:hover:bg-[#1A2334]'
                }`}
                onClick={(e) => {
                  e.stopPropagation()
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-1.5 rounded-xl border border-dashed border-gray-300 dark:border-[#3A3A3A] py-3.5 text-[14px] font-medium text-gray-500 dark:text-gray-400 transition-all hover:bg-gray-50 dark:hover:bg-[#1A2334] cursor-pointer active:scale-[0.98]"
        >
