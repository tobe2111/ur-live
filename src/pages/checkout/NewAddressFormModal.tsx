      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-200 dark:border-[#2A3446] rounded-2xl text-[15px] text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
        ...
        <div>
          ...
          <div className="flex gap-2 w-full min-w-0">
            <input
              ...
              readOnly
              className="flex-1 min-w-0 px-4 py-3 border border-gray-200 dark:border-[#2A3446] rounded-2xl bg-gray-50 dark:bg-[#1A2334] text-[15px] text-gray-600 dark:text-gray-300"
              placeholder={t('checkout.newAddress.postalCode', { defaultValue: '우편번호' })}
            />
            <button
              type="button"
              onClick={() => setShowPostcodePopup(true)}
              className="shrink-0 px-5 py-3 border border-gray-200 dark:border-[#2A3446] rounded-2xl text-[14px] font-semibold text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-[#1A2334] transition-all whitespace-nowrap"
            >
        ...
        <div>
          ...
          <input
            ...
            readOnly
            className="w-full px-4 py-3 border border-gray-200 dark:border-[#2A3446] rounded-2xl bg-gray-50 dark:bg-[#1A2334] text-[15px] text-gray-600 dark:text-gray-300"
        ...
        <div className="flex gap-2 pt-2">
          ...
          <button
            ...
            className="flex-1 py-4 bg-gray-50 dark:bg-[#1A2334] text-gray-500 dark:text-gray-400 rounded-2xl text-[16px] font-bold hover:bg-gray-100 dark:hover:bg-[#1A2334] transition-all active:scale-[0.98] cursor-pointer touch-manipulation"
          >
