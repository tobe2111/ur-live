      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-line rounded-2xl text-[15px] text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
        ...
        <div>
          ...
          <div className="flex gap-2 w-full min-w-0">
            <input
              ...
              readOnly
              className="flex-1 min-w-0 px-4 py-3 border border-line rounded-2xl bg-gray-50 dark:bg-[#1D1F29] text-[15px] text-gray-600 dark:text-gray-300"
        ...
        <div>
          ...
          <input
            ...
            readOnly
            className="w-full px-4 py-3 border border-line rounded-2xl bg-gray-50 dark:bg-[#1D1F29] text-[15px] text-gray-600 dark:text-gray-300"
