    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <header className="border-b border-gray-100">
        <div className="ur-content-narrow mx-auto px-4 lg:px-8 h-14 flex items-center justify-between">
          ...
          <button onClick={() => navigate('/seller/login')} className="text-sm text-gray-600 hover:text-gray-900 font-medium">이미 가입했어요</button>
        </div>
      </header>
      ...
      <main className="ur-content-narrow mx-auto px-4 lg:px-8 py-12 lg:py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">검증된 제조사 상품을 내 등급 공급가로 사입하세요.</p>
        </div>

        <div className="rounded-2xl border border-gray-200 p-6 mb-8">
          <h2 className="font-bold mb-4 text-sm text-gray-500">가입하면 이런 게 가능해요</h2>
