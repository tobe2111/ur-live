    ...
    <div className="min-h-screen bg-white dark:bg-[#0F151D] pb-20">
      ...
      <div className="ur-content-medium px-5 pt-6">
        ...
        <section>
          ...
          <div className="bg-gray-50 dark:bg-[#1A2334] rounded-lg p-4 space-y-1.5">
        ...
        <section className="border-t border-gray-100 dark:border-[#2A3446] pt-6 mt-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="bg-gray-50 dark:bg-[#1A2334] rounded-lg p-3">
                <p className="text-[13px] text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <section className="border-t border-gray-100 dark:border-[#2A3446] pt-6 mt-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {/* 가. 경기 결제 회원 */}
              <div className="bg-gray-50 dark:bg-[#1A2334] rounded-lg p-4 mb-3">
                ...
                <div className="space-y-2 text-[13px] text-gray-600 dark:text-gray-300 leading-relaxed">
                  ...
                  <div className="bg-white dark:bg-[#0F151D] rounded p-3 mt-2">
        ...
        <section className="border-t border-gray-100 dark:border-[#2A3446] pt-6 mt-6">
          ...
          {/* 배송 유의사항 */}
          <div className="mt-4 bg-gray-50 dark:bg-[#1A2334] rounded-lg p-4">
        ...
        <section className="border-t border-gray-100 dark:border-[#2A3446] pt-6 mt-6">
          ...
          <div className="overflow-x-auto rounded-lg border border-gray-100 dark:border-[#2A3446]">
            <table className="w-full text-[13px]">
              <thead>
                <tr className="bg-gray-50 dark:bg-[#1A2334]">
                  <th className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5 text-left font-semibold text-gray-900 dark:text-white">사유</th>
                  <th className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5 text-left font-semibold text-gray-900 dark:text-white">배송비 부담</th>
                </tr>
              </thead>
              <tbody className="text-gray-600 dark:text-gray-300">
                <tr>
                  <td className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5">단순 변심</td>
                  <td className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5">
                    <span className="text-red-500 font-semibold">구매자 부담</span> (왕복 배송비 6,000원)
                  </td>
                </tr>
                <tr>
                  <td className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5">상품 하자</td>
                  <td className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5">
                    <span className="text-green-600 font-semibold">판매자 부담</span>
                  </td>
                </tr>
                <tr>
                  <td className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5">오배송</td>
                  <td className="border-b border-gray-100 dark:border-[#2A3446] px-4 py-2.5">
                    <span className="text-green-600 font-semibold">판매자 부담</span>
                  </td>
                </tr>
        ...
        <section className="border-t border-gray-100 dark:border-[#2A3446] pt-6 mt-6">
          ...
          <div className="bg-gray-50 dark:bg-[#1A2334] rounded-lg p-4 space-y-2">
            <p className="text-[13px] text-gray-600 dark:text-gray-300">
        ...
        {/* Footer */}
        <div className="border-t border-gray-100 dark:border-[#2A3446] pt-6 mt-6 text-center space-y-1">
          <p className="text-[13px] text-gray-600 dark:text-gray-300">
