    ...
    <div className="min-h-[100dvh] bg-[#FAF7F5] dark:bg-[#0F151D]">
      ...
      <main className="px-5 pb-32 max-w-xl mx-auto">
        ...
        <section className="pb-10">
          <h2 className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1] mb-4">수익 구조는 단순합니다</h2>
          <div className="rounded-2xl bg-white dark:bg-[#1A2334] p-5">
            <div className="flex items-center gap-2 text-[14px] font-bold text-[#1A2C42] dark:text-[#F5F3F1]">
        ...
        {/* 시작 3단계 */}
        <section className="pb-10">
          <h2 className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1] mb-4">시작은 3단계</h2>
        ...
        <section className="pb-10">
          <h2 className="text-[19px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1] mb-4">팔리는 순간, 바로 알려드려요</h2>
          <div className="grid grid-cols-2 gap-2.5">
            {/* 📸 잔존 장치 2종(실시간 적립 알림·내 성과 탭) 완성 후 실제 캡처로 교체 */}
            <div className="rounded-2xl bg-white dark:bg-[#1A2334] p-4 aspect-[3/4] flex flex-col items-center justify-center text-center gap-2">
              <Bell className="w-7 h-7 text-brand" />
              <p className="text-[13px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1]">실시간 적립 알림</p>
              <p className="text-[11px] text-gray-400 dark:text-gray-500">"방금 내 링크로 1건 판매!"<br />(화면 준비 중)</p>
            </div>
            <div className="rounded-2xl bg-white dark:bg-[#1A2334] p-4 aspect-[3/4] flex flex-col items-center justify-center text-center gap-2">
              <BarChart3 className="w-7 h-7 text-brand" />
              <p className="text-[13px] font-extrabold text-[#1A2C42] dark:text-[#F5F3F1]">내 성과 탭</p>
