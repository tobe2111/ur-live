 ...
 *   카피는 대표 별도 전달분으로 교체 예정. 브랜드 토큰: brand/#16181C/#F8F7FC.
 */
      ...
      <main className="px-5 pb-32 max-w-xl mx-auto">
        ...
        <section id="apply" className="pb-6">
          ...
          {GOOGLE_FORM_URL ? (
            ...
            <Link to="/creators/apply" className="block rounded-2xl bg-[#16181C] dark:bg-[#1D1F29] p-6 text-center active:scale-[0.99] transition-transform">
              <p className="text-[15px] font-extrabold text-[#F8F7FC]">1기 소개 파트너를 모집하고 있어요</p>
