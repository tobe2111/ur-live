  ...
  const groups: { key: string; label: string; items: Item[] }[] = [
    {
      ...
      items: [
        ...
        { icon: '🎟️', label: t('shopping.voucher', { defaultValue: '내 이용권' }), sub: t('shopping.voucherSub', { defaultValue: '매장에서 QR·코드로 사용' }), count: counts.voucher, path: '/my-vouchers' },
        { icon: '🎁', label: t('shopping.gifticon', { defaultValue: '내 교환권' }), sub: t('shopping.gifticonSub', { defaultValue: '문자로 받은 기프티콘' }), count: counts.gifticon, path: '/my-gifticons' },
