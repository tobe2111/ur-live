      ...
      <div className="bg-gray-50 dark:bg-[#1A1C21] rounded-2xl px-5 py-4 border border-gray-200 dark:border-[#2C2F35]">
        ...
        <div className={`grid ${TOPUP_DISABLED ? 'grid-cols-1' : 'grid-cols-2'} gap-2`}>
          ...
          <button
            ...
            className="py-2 text-xs font-bold text-gray-700 dark:text-gray-200 bg-white dark:bg-white/[0.06] hover:bg-gray-100 dark:hover:bg-white/[0.12] rounded-lg border border-gray-200 dark:border-[#2C2F35] active:scale-[0.98] transition-all"
          >
