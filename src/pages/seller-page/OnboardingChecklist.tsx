/**
 * 🛡️ 2026-05-02: TD-018 분할 — SellerPage 의 셀러 온보딩 체크리스트.
 *   2026-04-23 배치 170 에서 추가됨.
 */
import { useState } from 'react'
import { Link } from 'react-router-dom'
import { useTranslation } from 'react-i18next'
import { Package, CheckCircle2, CreditCard, Radio, ShoppingBag } from 'lucide-react'
...
export default function OnboardingChecklist({ stats, hasBank }: { stats: DashboardStats; hasBank: boolean }) {
  ...
  return (
    <div className="bg-gray-50 border border-blue-200 rounded-2xl p-4 space-y-3">
