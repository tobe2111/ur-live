...
export default function StoreStatsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1D1F29] px-5 py-8">
      ...
      <div className="ur-content-narrow">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          {[
            ...
            <div key={s.label} className="bg-white dark:bg-[#11141C] rounded-xl p-4 border border-line">
        ...
        {/* 사용률 바 */}
        <div className="bg-white dark:bg-[#11141C] rounded-xl p-5 border border-line mb-5">
          <div className="flex items-center justify-between mb-2">
        ...
        {/* 공동구매 현황 */}
        <div className="bg-white dark:bg-[#11141C] rounded-xl p-5 border border-line">
