          ...
          <div className="flex gap-2 mb-4 overflow-x-auto -mx-1 px-1 [&::-webkit-scrollbar]:hidden">
            {([
              ...
              <button
                ...
                className="shrink-0 h-9 px-4 rounded-full border border-gray-200 dark:border-[#2C2F35] bg-white dark:bg-[#1D1F29] text-[13px] font-bold text-gray-700 dark:text-gray-200 active:scale-95"
              >
                {chip.label}
              </button>
            ))}
          ...
          shopProducts.length === 0 ? (
            ...
            <div className="mt-7 rounded-2xl border border-dashed border-gray-300 dark:border-[#2E2E2E] bg-gray-50 dark:bg-[#101010] px-5 py-7 text-center">
              ...
              <button
                ...
                className="ur-btn ur-btn-md ur-btn-primary mt-4 inline-flex items-center gap-1 dark:bg-white dark:text-[#11141C] text-[13px] active:scale-95"
              >
            ...
            <div className="flex items-center gap-2 h-11 px-3.5 mb-4 rounded-xl border border-gray-200 dark:border-[#2C2F35] bg-gray-50 dark:bg-[#1D1F29]">
