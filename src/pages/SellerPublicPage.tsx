    ...
    <div className="min-h-screen bg-[#020202]">
      ...
      <div className="pt-14 px-5 pb-4">
        <div className="flex items-center justify-between">
          {editingField === 'name' ? (
            ...
            <h1 className="text-xl font-extrabold text-white group" onClick={() => startEdit('name')}>
              {seller.name}
        ...
        <div className="flex items-center gap-6 mt-4 py-3 border-y border-[#1A1A1A]">
          ...
          <div className="text-center flex-1">
            ...
            <p className="text-sm font-bold text-white">{streams.length}</p>
          </div>
          <div className="text-center flex-1">
      ...
      <div className="px-4 py-5">
        ...
        {tab === 'home' && (
          <div className="space-y-6">
            ...
            {mealVouchers.length > 0 && (
              <section>
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-base font-bold text-white">🍽️ 추천 식사권</h2>
                  ...
                  {mealVouchers.slice(0, 4).map(p => {
                    ...
                    return (
                      <button key={p.id} onClick={() => navigate(`/products/${p.id}`)} className="shrink-0 w-44 text-left active:scale-[0.97]">
                        ...
                        <div className="mt-2">
                          <p className="text-[12px] font-medium text-white line-clamp-1">{p.name}</p>
            ...
            {shorts.length > 0 && (
              <section>
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-base font-bold text-white">📹 맛집 리뷰 영상</h2>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {shorts.slice(0, 4).map(s => (
                    <div key={s.id} className="rounded-xl overflow-hidden bg-[#1A1A1A]">
                      ...
                      <div className="p-2">
                        <p className="text-[11px] font-medium text-white line-clamp-1">{s.title}</p>
            ...
            {recentStreams.length > 0 && (
              <section>
                <div className="flex items-center justify-between mb-3">
                  <h2 className="text-base font-bold text-white">라이브 <span className="text-pink-500">{streams.length}</span></h2>
                  ...
                  <button key={p.id} onClick={() => navigate(`/products/${p.id}`)} className="w-full flex gap-3 p-3 bg-[#121212] rounded-xl text-left active:scale-[0.98]">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-baseline gap-1.5 mt-1.5">
                        ...
                        <span className="text-sm font-extrabold text-white">{p.price.toLocaleString()}원</span>
            ...
            <div className="grid grid-cols-2 gap-3">
              {shorts.map(s => (
                <div key={s.id} className="rounded-xl overflow-hidden bg-[#1A1A1A]">
                  ...
                  <div className="p-2">
                    <p className="text-[11px] font-medium text-white line-clamp-2">{s.title}</p>
        ...
        {tab === 'info' && (
          <div className="space-y-6">
            <section>
              <h3 className="text-base font-bold text-white mb-2">소개</h3>
            ...
            <section className="bg-[#121212] rounded-xl p-4">
              <h3 className="text-sm font-bold text-white mb-3">판매자 정보</h3>
            ...
            <section>
              <h3 className="text-base font-bold text-white mb-2">식사권 이용안내</h3>
              <div className="text-sm text-gray-400 space-y-2">
