...
import IntroducerAssign from './admin-merchant-commissions/IntroducerAssign'
        ...
        <section className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          {cs && (
            <div className="space-y-3 text-sm">
              ...
              {/* 🤝 2026-08-31: 영입자 지정 — 그전엔 DB 로만 가능했다. */}
              <IntroducerAssign
                sellerId={cs.id}
                current={cs.introduced_by_influencer_id
                  ? { id: String(cs.introduced_by_influencer_id), handle: cs.influencer_handle ?? null }
                  : null}
                onChanged={loadSeller}
              />
              <div className="flex justify-between border-b border-gray-100 pb-2">
