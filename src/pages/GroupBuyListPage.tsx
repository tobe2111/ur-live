              ...
              <div className="space-y-3">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="border border-gray-100 dark:border-[#2C2F35] rounded-2xl p-4 animate-pulse">
                    <div className="h-4 bg-gray-100 dark:bg-[#1D1F29] rounded w-3/4" />
                    <div className="h-3 bg-gray-100 dark:bg-[#1D1F29] rounded w-1/2 mt-2" />
                    <div className="h-8 bg-gray-100 dark:bg-[#1D1F29] rounded mt-3" />
                  </div>
                ))}
              </div>
