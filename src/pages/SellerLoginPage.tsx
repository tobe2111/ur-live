          ...
          <div className="mt-8">
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-[13px]">
                <span className="px-4 bg-[#fbfbfd] text-[#6e6e73]">또는</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-[#e5e5ea] rounded-xl text-[15px] font-medium text-[#1d1d1f] hover:bg-[#f5f5f7] transition-colors"
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24">
                  <path fill="#FEE500" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/>
                  <path fill="#000000" d="M12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-11c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5z"/>
                </svg>
                카카오로 계속하기
              </button>
