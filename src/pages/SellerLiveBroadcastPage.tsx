...
import { ChannelCard } from '@/components/seller/broadcast/ChannelCard'
import { StepInfo } from '@/components/seller/broadcast/StepInfo'
import { StepSetup } from '@/components/seller/broadcast/StepSetup'
import { StepLive } from '@/components/seller/broadcast/StepLive'
import { StreamList } from '@/components/seller/broadcast/StreamList'
import { EndBroadcastModal, ConfirmModal, RecapModal } from '@/components/seller/broadcast/BroadcastModals'
import { getLastUsedMethod, rememberMethod, getRecentProducts, rememberRecentProducts, rememberLastBroadcast } from '@/components/seller/broadcast/broadcast-storage'
import type { YouTubeChannel, Product, LiveStream, WizardStep, StreamMethod, Destination, DestinationPlatform } from '@/components/seller/broadcast/broadcast-types'
...
export default function SellerLiveBroadcastPage() {
  ...
  const lastBroadcast = useRef((() => {
    try {
      const v = localStorage.getItem('seller_live_last_broadcast')
