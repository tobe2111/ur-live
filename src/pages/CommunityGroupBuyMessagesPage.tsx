...
export default function CommunityGroupBuyMessagesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#1A1C21] flex flex-col">
      <SEO
      ...
      <div className="flex-1 ur-content-narrow w-full px-4 lg:px-8 py-4 pb-28 space-y-2">
        {forbidden ? (
          ...
          messages.map((m) => (
            <div key={m.id} className="bg-white dark:bg-[#0D0F12] rounded-2xl p-3 border border-gray-100 dark:border-[#2C2F35]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] px-1.5 py-0.5 rounded-full bg-gray-100 dark:bg-[#1A1C21] text-gray-500 dark:text-gray-400">
        ...
        <div className="fixed bottom-0 left-0 right-0 xl:left-56 app-frame-bar bg-white dark:bg-[#0D0F12] border-t border-gray-100 dark:border-[#2C2F35] px-4 py-3 z-50">
          <div className="ur-content-narrow flex items-center gap-2">
            <input
              ...
              className="flex-1 px-4 py-2.5 rounded-xl border border-gray-200 dark:border-[#2C2F35] bg-gray-50 dark:bg-[#1A1C21] text-[14px] text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 outline-none focus:border-gray-400 dark:focus:border-[#3A3A3A]"
            />
            <button
              onClick={handleSend}
