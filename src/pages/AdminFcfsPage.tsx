/**
 * 🎯 2026-06-20 (대표 — 선착순 응모 상품 관리): 어드민에서 특정 공구 상품에 선착순 설정 + 지원자 조회 + 선정.
    ...
    <AdminLayout title="선착순 응모 관리">
      <div className="max-w-3xl mx-auto p-4 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
          ...
          <p className="text-[12px] text-gray-500 mt-2">기존 공구 상품의 ID를 입력해 선착순으로 지정합니다. (그 상품만 선착순 적용)</p>
        </div>
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5 space-y-4">
              <div className="flex items-center justify-between">
                <p className="text-sm font-bold text-gray-900">선착순 설정 (상품 #{pid})</p>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <p className="text-[12px] font-semibold text-gray-600 mb-1">지원수 시드 (표시 부풀림)</p>
              ...
              <div className="flex items-center justify-between pt-1">
                <p className="text-[13px] text-gray-700">표시: <b className="text-gray-900">선착순 {formatNumber(displayApplied)}/{formatNumber(cfg.spots)}명</b> <span className="text-gray-400">(실제 지원 {realApplied})</span></p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-5">
              <div className="flex items-center justify-between mb-3">
                <p className="text-sm font-bold text-gray-900">지원자 ({applicants.length})</p>
              ...
              {applicants.length === 0 ? (
                <p className="text-sm text-gray-400 py-8 text-center">아직 지원자가 없습니다</p>
              ) : (
                  ...
                  {applicants.map((a) => (
                    <label key={a.id} className="flex items-center gap-3 py-2.5 cursor-pointer">
                      ...
                      {a.status === 'selected'
                        ...
                        : <span className="text-[11px] text-gray-400 shrink-0">지원</span>}
                    </label>
                  ))}
                </div>
              )}
