    ...
    <AdminLayout title={t('admin.pages.sampleRequests')}>
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            {items.map(item => {
              ...
              return (
                <div key={item.id} className="rounded-[var(--dash-radius,16px)] border border-rule bg-white p-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.admin_memo && (
                        <p className="mt-1 text-xs text-tone-info bg-tone-info-bg rounded-lg px-3 py-1.5">
      ...
      {memoModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
          ...
          <div className="relative bg-white rounded-[var(--dash-radius,16px)] shadow-xl w-full max-w-sm p-5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 text-sm text-gray-900 border border-gray-200 dark:border-[#2A2A2A] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-brand resize-none mb-4"
            />
