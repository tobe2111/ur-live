...
//   '공동구매' 는 2026-07-29 신설(대표 지시) — 이미 자기 팔로워에게 파는 층이라 유어샵 전환 1순위.
//   '카페' 도 2026-07-29 추가 — 분류기는 만드는데 여기 없어서 **4,675명(풀의 12%)이 화면에서 안 보였다**
//   (기존 유닛이 *우선 카테고리만* 검사해 놓친 자리 — 이제 분류기 전체 축을 검사한다).
export const POOL_CATEGORIES = ['공동구매', '체험단', '마케팅대행사', '맛집', '카페', '외식창업', '숙소', '네일', '뷰티', '골프', '푸드', '패션', '여행', '육아', '운동', '반려동물', '리빙', 'IT/재테크', '취미', '자동']
