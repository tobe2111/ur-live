...
export default function GroupBuyGuideCard() {
  ...
  return (
    <div className="mx-4 mt-3 mb-1 rounded-2xl bg-gray-50 dark:bg-[#141414] border border-gray-200 dark:border-[#2C2F35] p-3">
      ...
      <ol className="grid grid-cols-3 gap-2 text-center">
        <li className="flex flex-col items-center">
          <div className="w-9 h-9 rounded-full bg-white dark:bg-[#1D1F29] border border-gray-200 dark:border-[#2C2F35] flex items-center justify-center text-base mb-1">
            🛒
          </div>
