...
export default function OptionSelectModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40 backdrop-blur-sm animate-fadeIn" onClick={onClose} role="presentation">
      <div
        ref={dialogRef}
        className="bg-white dark:bg-[#0D0F12] rounded-t-3xl shadow-2xl max-w-md md:max-w-lg w-full max-h-[80dvh] flex flex-col animate-slideUp"
      ...
      >
        {/* Header */}
        <div className="sticky top-0 bg-white dark:bg-[#0D0F12] border-b border-gray-200 dark:border-[#2C2F35] px-6 py-4 rounded-t-3xl">
                      ...
                      return (
                        <button
                          ...
                          className={`
                            ...
                            ${isSelected 
                              ? 'border-gray-900 bg-gray-50 dark:bg-[#1A1C21]' 
                              : isOutOfStock
                                ? 'border-gray-200 dark:border-[#2C2F35] bg-gray-50 dark:bg-[#1A1C21] opacity-40 cursor-not-allowed'
                                : 'border-gray-200 dark:border-[#2C2F35] hover:border-gray-400'
                            }
                          `}
                        >
                          {isSelected && (
        ...
        {/* Footer */}
        {!loading && !error && (
          <div className="sticky bottom-0 bg-white dark:bg-[#0D0F12] border-t border-gray-200 dark:border-[#2C2F35] px-6 py-4">
            <button
