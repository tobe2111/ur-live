  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        aria-haspopup="menu"
        className="relative p-2 text-gray-600 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-[#1A1A1A] rounded-full transition-colors"
      >
      ...
      {/* 드롭다운 */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-[#1A1A1A] rounded-lg shadow-lg border border-gray-200 dark:border-[#2A2A2A] z-50">
          {/* 헤더 */}
            ...
            {loading ? (
              ...
              notifications.slice(0, 10).map((notification) => (
                <button
                  ...
                  className={`
                    w-full text-left px-4 py-3 border-b border-gray-100 dark:border-[#1A1A1A] hover:bg-gray-50 dark:hover:bg-[#121212] transition-colors
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`
                        ...
                        ${!notification.is_read ? 'text-gray-900 dark:text-white' : 'text-gray-600'}
                      `}>
                        {notification.title}
                      </p>
