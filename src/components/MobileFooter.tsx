export default function MobileFooter() {
  return (
    <footer className="bg-gray-50 border-t border-gray-200 py-8 px-4 mt-8">
      {/* Contact */}
      <div className="mb-6">
      ...
      {/* Links */}
      <div className="flex justify-center gap-2 text-xs text-gray-500 mb-6 flex-wrap">
      ...
      {/* Company Info */}
      <div className="space-y-1.5 text-xs text-gray-600 text-center">
