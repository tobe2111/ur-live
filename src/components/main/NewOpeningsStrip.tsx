      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-4 px-4 lg:mx-0 lg:px-0">
        {rows.map((o, i) => (
          <button key={i} onClick={() => navigate('/new-openings')}
            className="shrink-0 w-[150px] text-left rounded-xl border border-gray-200 dark:border-[#2C2F35] bg-white dark:bg-[#1D1F29] p-3 active:scale-[0.98] transition-transform">
