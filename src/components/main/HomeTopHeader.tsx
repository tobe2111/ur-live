...
export default function HomeTopHeader() {
  ...
  return (
    <div className="md:hidden lg:block sticky top-0 inset-x-0 z-30 bg-white/95 dark:bg-[#0D0F12]/95 backdrop-blur-md border-b border-gray-100 dark:border-[#2C2F35]">
      <div className="ur-content-wide px-4 lg:px-8 pt-2 pb-2.5 space-y-2">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            className="flex-1 min-w-0 flex items-center gap-2 h-10 px-3.5 rounded-full bg-gray-100 dark:bg-[#1A1C21] text-left"
            aria-label="검색"
          >
