...
export function RewardAdCard() {
  ...
  return (
    <div className="ur-content-medium px-4 lg:px-8 py-1">
      <div className="bg-gray-50 dark:bg-[#1D1F29] rounded-2xl px-5 py-4 border border-gray-200 dark:border-[#2C2F35]">
        ...
        {/* 진행 바 */}
        <div className="mt-3 bg-white dark:bg-[#11141C]/10 rounded-full h-1.5 overflow-hidden">
          <div
