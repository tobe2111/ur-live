...
export default function AddToHomeHint({ context = 'wallet' }: { context?: 'wallet' | 'purchase' }) {
  ...
  return (
    <div className="mb-3 flex items-start gap-3 rounded-2xl border border-gray-200 dark:border-[#2A2A2A] bg-gray-50 dark:bg-[#141414] px-4 py-3">
      ...
      <button onClick={dismiss} aria-label="닫기" className="-m-1 shrink-0 rounded-full p-1 hover:bg-gray-100 dark:hover:bg-[#1A1A1A]">
