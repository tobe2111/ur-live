...
export function FloatingActionBar({
  ...
  if (variant === 'pickup') {
    return (
      <div
        className="fixed bottom-0 left-1/2 -translate-x-1/2 z-50 w-full max-w-[430px] lg:max-w-screen-md app-frame-bar bg-white dark:bg-[#11141C] border-t border-[#EAE5E7] dark:border-[#2C2F35]"
  ...
  return (
    <div
      className="fixed bottom-0 left-1/2 -translate-x-1/2 z-50 w-full max-w-[430px] lg:max-w-screen-md app-frame-bar bg-white dark:bg-[#11141C] border-t border-gray-100 dark:border-[#2C2F35]"
      style={{
        paddingLeft: 14,
        paddingRight: 14,
        paddingTop: 10,
    ...
    >
      <div className="flex items-center gap-2">
        ...
        {!dealOnly && (
          <button
            className="flex items-center justify-center gap-1 h-12 flex-1 rounded-xl bg-gray-100 dark:bg-[#1D1F29] transition-all active:scale-[0.98] disabled:opacity-40"
            onClick={onAddToCart}
            disabled={disabled}
          >
