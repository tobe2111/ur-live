export function ReturnPolicySection() {
  return (
    <div>
      <h2 className="text-sm font-bold text-gray-900 dark:text-white mb-4">교환 및 반품 안내</h2>
      
      {/* 신청 방법 */}
      <div className="mb-5">
        <h3 className="text-xs font-semibold text-gray-900 dark:text-white mb-2">신청 방법</h3>
      ...
      {/* 배송 비용 */}
      <div className="mb-5">
        <h3 className="text-xs font-semibold text-gray-900 dark:text-white mb-2">배송 비용</h3>
        <p className="text-[11px] text-gray-600 dark:text-gray-300 leading-relaxed">
      ...
      {/* 반품 주소 */}
      <div className="mb-5">
        <h3 className="text-xs font-semibold text-gray-900 dark:text-white mb-2">반품 주소</h3>
        <p className="text-[11px] text-gray-600 dark:text-gray-300 leading-relaxed">
      ...
      {/* 유의 사항 */}
      <div>
        <h3 className="text-xs font-semibold text-gray-900 dark:text-white mb-2">유의 사항</h3>
        <ul className="space-y-1.5">
          <li className="text-[11px] text-gray-600 dark:text-gray-300 leading-relaxed pl-3 relative before:content-['•'] before:absolute before:left-0">
      ...
      {/* 제22조 (환불) */}
      <div className="mt-6 pt-6 border-t border-gray-200 dark:border-[#2C2F35]">
