        ...
        <div className="pointer-events-auto flex flex-col gap-3.5">
          <div className={`${cardCls} p-3.5`}>
            ...
            <div className="flex items-center gap-3">
              <div className="rounded-lg bg-white dark:bg-white p-1.5 shrink-0">
                <Suspense fallback={<div className="w-[84px] h-[84px] rounded bg-gray-100 dark:bg-[#1D1F29] animate-pulse" />}>
          ...
          {isBiz ? (
            (store?.address || store?.phone) ? (
              <div className="pointer-events-auto rounded-2xl p-4 bg-white dark:bg-[#1D1F29] border border-gray-200 dark:border-[#2C2F35] shadow-sm">
