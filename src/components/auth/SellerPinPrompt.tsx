  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={onCancel} role="presentation">
      ...
      >
        ...
        <div className="pt-3 border-t border-gray-100 dark:border-[#2A3446] text-center">
...
export function SellerPinSetup({ linkedToKakao, role = 'seller' }: { linkedToKakao: boolean; role?: 'seller' | 'agency' }) {
  ...
  if (!showForm) {
    return (
      <button onClick={() => setShowForm(true)}
        className="w-full py-3 bg-white border border-gray-200 dark:border-[#2A3446] hover:border-blue-300 rounded-xl flex items-center gap-3 px-4 text-left">
  ...
  return (
    <div className="bg-white border border-gray-200 dark:border-[#2A3446] rounded-xl p-4 space-y-3">
