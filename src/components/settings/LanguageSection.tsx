...
export default function LanguageSection({ className = '' }: { className?: string }) {
  ...
  return (
    <div className={className}>
      <div className="bg-white dark:bg-[#1A2334] rounded-2xl border border-gray-100 dark:border-[#2A3446] p-4">
            ...
            <button
              ...
              className={`py-2 rounded-xl text-[12px] font-semibold border transition-colors ${
                current === l.code
                  ...
                  : 'bg-gray-50 text-gray-600 border-gray-200 dark:bg-[#1A2334] dark:text-gray-300 dark:border-[#2A3446]'
              }`}
            >
              {l.label}
            </button>
