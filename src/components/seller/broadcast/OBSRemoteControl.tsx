...
import { RtmpBlock, RecommendedPresetBlock } from '@/components/seller/broadcast/RtmpBlock'
...
export function OBSRemoteControl({ stream, hasPersistentKey, copiedField, onCopy }: {
