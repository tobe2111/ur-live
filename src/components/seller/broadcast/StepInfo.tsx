...
import {
  ...
  VideoIcon, CheckCircle2,
  Smartphone, Zap,
  Globe, EyeOff, Lock, AlertTriangle,
} from 'lucide-react'
import { Button } from '@/components/ui/button'
import { toast } from '@/hooks/useToast'
import { PromptModal } from '@/components/seller/broadcast/BroadcastModals'
import { getLastBroadcast, getTemplates, saveTemplates } from '@/components/seller/broadcast/broadcast-storage'
import type { Product, StreamMethod, Destination, DestinationPlatform, BroadcastTemplate, YouTubeChannel } from '@/components/seller/broadcast/broadcast-types'
...
export function StepInfo({ title, setTitle, description, setDescription, thumbnailUrl, setThumbnailUrl, privacy, setPrivacy,
