...
import { LiveStatsBar } from '@/components/seller/broadcast/LiveStatsBar'
import { ShareLiveLink } from '@/components/seller/broadcast/ShareLiveLink'
import { AuctionTimeDealControls } from '@/components/seller/broadcast/AuctionTimeDealControls'
import type { LiveStream, Product } from '@/components/seller/broadcast/broadcast-types'

export interface StepLiveProps {
  stream: LiveStream; products: Product[]
  onChangeProduct: (productId: number) => void; onEndStream: () => void
}

export function StepLive({ stream, products, onChangeProduct, onEndStream }: StepLiveProps) {
