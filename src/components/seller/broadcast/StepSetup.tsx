...
import { OBSRemoteControl } from '@/components/seller/broadcast/OBSRemoteControl'
import { YouTubeStudioWaiting } from '@/components/seller/broadcast/YouTubeStudioWaiting'
import { ScheduledBroadcastWaiting } from '@/components/seller/broadcast/ScheduledBroadcastWaiting'
import type { LiveStream, StreamMethod, YouTubeChannel } from '@/components/seller/broadcast/broadcast-types'
...
export function StepSetup({ stream, method, channels, copiedField, onCopy, onGoLive, onBack }: StepSetupProps) {
