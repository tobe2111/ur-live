...
import type { YouTubeChannel } from '@/components/seller/broadcast/broadcast-types'

// ── 채널 카드 (다중 채널 + 해제 + 토큰 만료 재연동) ──────────────
export function ChannelCard({ channels, activeChannelId, onSelectChannel, onDisconnect, onReauthenticate, connectingYouTube }: {
