...
import { Product, ThemeClasses } from '@/components/seller/public/seller-public-types'

interface SellerPublicVouchersTabProps {
  mealVouchers: Product[]
  isOwner: boolean
  T: ThemeClasses
}

export default function SellerPublicVouchersTab({ mealVouchers, isOwner, T }: SellerPublicVouchersTabProps) {
