      ...
      >
        ...
        <div className="relative px-6 pt-6 pb-2">
          <button
            ...
            className="absolute top-4 right-4 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-[#1D1F29]"
          >
        ...
        {/* 안내 박스 */}
        <div className="mx-6 my-3 p-3 bg-warm border border-rule rounded-xl">
