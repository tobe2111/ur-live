...
export const CartHeader = React.memo(function CartHeader({
  ...
  return (
    <>
      ...
      {/* Select-all row */}
      {itemCount > 0 && (
        <div className="bg-gray-50 dark:bg-[#1A1C21] border-b border-gray-100 dark:border-[#2C2F35]">
              ...
              <span
                className={`w-5 h-5 rounded-full flex items-center justify-center border-2 transition-colors ${
                  allSelected
                    ...
                    : 'bg-white dark:bg-[#0D0F12] border-gray-300 dark:border-[#3A3A3A] group-hover:border-gray-400'
                }`}
              >
                {allSelected && (
