  ...
  if (!open) {
    return (
      <button
        ...
        className="w-full bg-gray-50 border border-emerald-200 rounded-xl p-4 flex items-center justify-between hover:from-gray-100 hover:to-gray-100 transition-colors"
      >
