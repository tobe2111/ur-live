  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end" onClick={onClose} role="presentation">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-label={t('chat.dialogAria', { defaultValue: '채팅 입력' })}
      ...
      >
        <input
          ...
          placeholder={isSeller ? t('chat.sellerPlaceholder', { defaultValue: '셀러 메시지를 입력하세요...' }) : t('chat.userPlaceholder', { defaultValue: '메시지를 입력하세요...' })}
          aria-label={isSeller ? t('chat.sellerInputAria', { defaultValue: '셀러 메시지' }) : t('chat.inputAria', { defaultValue: '채팅 메시지' })}
          maxLength={200}
