  ...
  render() {
    if (this.state.hasError) {
      ...
      if (this.state.isChunkError) {
        ...
        return (
          <div className="min-h-[100dvh] flex items-center justify-center bg-gray-50 dark:bg-[#0D0F12] px-4">
      ...
      // 기본 폴백 UI
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#1A1C21] px-4">
          <div className="max-w-md w-full bg-white dark:bg-[#0D0F12] rounded-2xl shadow-lg p-8 text-center">
            ...
            {import.meta.env.DEV && this.state.error && (
              <details className="text-left mb-6">
                ...
                <pre className="mt-2 text-xs bg-gray-100 dark:bg-[#1A1C21] p-3 rounded overflow-auto max-h-60">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-gray-100 dark:bg-[#1A1C21] text-gray-700 dark:text-gray-200 py-3 px-4 rounded-full font-medium hover:bg-gray-200 dark:hover:bg-[#2C2F35] transition-colors"
              >
                홈으로
              </button>
            </div>
