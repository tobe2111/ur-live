...
class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      // 기본 폴백 UI
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#1D1F29] px-4">
          <div className="max-w-md w-full bg-white dark:bg-[#11141C] rounded-2xl shadow-lg p-8 text-center">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-gray-100 dark:bg-[#1D1F29] text-gray-700 dark:text-gray-200 py-3 px-4 rounded-full font-medium hover:bg-gray-200 dark:hover:bg-[#2C2F35] transition-colors"
              >
                홈으로
              </button>
            </div>
