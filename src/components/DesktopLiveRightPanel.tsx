...
export default function DesktopLiveRightPanel() {
  return (
    <aside
      className="hidden 2xl:flex fixed right-0 top-0 bottom-0 w-72 z-40 flex-col py-6 px-4 bg-[#020202] border-l border-white/[0.06] overflow-y-auto"
      aria-label="PC 라이브 안내 패널"
    >
      <h2 className="text-[14px] font-bold text-white/85 mb-4">라이브에서 만나는 다른 즐길거리</h2>

      <div className="flex flex-col gap-3">
        <Link
          to="/browse"
          className="flex items-center gap-3 p-4 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] transition-colors"
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-pink-500/[0.15] text-pink-300 shrink-0">
            <ShoppingBag className="h-5 w-5" />
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-bold text-white">오늘의 핫딜</p>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[13px] font-bold text-white">친구 초대 공동구매</p>
            <p className="text-[11px] text-white/55 mt-0.5 line-clamp-1">
              초대할수록 더 큰 할인
            </p>
          </div>
      ...
      <p className="text-[10px] text-white/30 mt-auto pt-6">
