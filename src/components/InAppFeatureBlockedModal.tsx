...
export default function InAppFeatureBlockedModal({ feature, onClose, onAlternative, alternativeLabel }: Props) {
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-[#0D0F12] w-full max-w-md rounded-t-3xl sm:rounded-3xl p-6 pt-5 max-h-[90dvh] overflow-y-auto"
      ...
      >
        <div className="flex items-start justify-between mb-4">
          ...
          <button onClick={onClose} aria-label={t('common.close')} className="p-1 -m-1 rounded-full hover:bg-gray-100 dark:hover:bg-[#1A1C21] shrink-0">
        ...
        <div className="space-y-2">
          ...
          <button
            onClick={handleCopy}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-100 dark:bg-[#1A1C21] text-gray-700 dark:text-gray-200 rounded-2xl font-semibold text-[13px]"
          >
