...
export default function ProductOptionForm({
  ...
  return (
    <div className="space-y-4">
          ...
          <div className="space-y-2">
            {options.map((option, index) => (
              <div
                ...
                className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200 dark:border-[#2C2F35]"
              >
      ...
      <div className="border-t border-gray-200 dark:border-[#2C2F35] pt-4">
