...
function ItemThumb({ item }: { item: OrderItem }) {
  ...
  if (!src) {
    return (
      <div className="w-16 h-16 shrink-0 rounded-lg bg-gray-100 dark:bg-[#1A2334] flex items-center justify-center">
  ...
  return (
    <img
      ...
      height={64}
      loading="lazy"
      className="w-16 h-16 shrink-0 rounded-lg object-cover bg-gray-100 dark:bg-[#1A2334]"
    />
  )
}
    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-11 pl-10 pr-4 rounded-xl bg-gray-50 dark:bg-[#1A2334] border border-gray-200 dark:border-[#2A3446] text-[14px] text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-900/10 dark:focus:ring-white/10"
        />
      </div>

      {/* 종류 탭 — 텍스트+밑줄 (무신사 스타일) */}
      <div className="flex gap-5 border-b border-gray-100 dark:border-[#2A3446] -mx-4 px-4 overflow-x-auto no-scrollbar">
        {KIND_TABS.map(tab => {
...
function OrderCard({
  ...
  return (
    <article className="bg-white dark:bg-[#0F151D] rounded-2xl border border-gray-100 dark:border-[#2A3446] overflow-hidden">
      {/* 클릭 영역: 상태 + 판매처 + 상품 → 상세 */}
      <div
        role="button"
        tabIndex={0}
      ...
      {/* 배송 송장 (상품만) */}
      {hasTracking && (
        <div className="mx-4 mt-1 mb-3 flex items-center justify-between gap-2 px-3 py-2 bg-gray-50 dark:bg-[#1A2334] rounded-xl">
      ...
      {kind !== 'product' && (
        <Link
          to="/my-vouchers"
          onClick={(e) => e.stopPropagation()}
          className="mx-4 mt-1 mb-3 flex items-center justify-between px-3 py-2 bg-gray-50 dark:bg-[#1A2334] rounded-xl"
        >
      ...
      {/* 푸터: 결제금액 + 액션 */}
      <div className="px-4 pb-3.5 pt-3 flex items-center justify-between border-t border-gray-100 dark:border-[#2A3446]">
        <div>
        ...
        <div className="flex items-center gap-1.5 flex-wrap justify-end">
          ...
          {canReturn && (
            <button
              ...
              className="px-2.5 py-1.5 text-[12px] font-semibold text-gray-700 dark:text-gray-200 bg-white dark:bg-[#0F151D] border border-gray-200 dark:border-[#2A3446] rounded-full hover:bg-gray-50 dark:hover:bg-[#1A2334] transition-colors"
            >
          ...
          {canCancel && (
            <button
              ...
              className="px-2.5 py-1.5 text-[12px] font-semibold text-red-600 bg-white dark:bg-[#0F151D] border border-red-100 dark:border-red-900/40 rounded-full hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
            >
...
function EmptyState({ kindFilter, searching, t }: { kindFilter: KindFilter; searching: boolean; t: TFunction }) {
  ...
  return (
    <div className="bg-white dark:bg-[#0F151D] rounded-2xl border border-gray-100 dark:border-[#2A3446] p-12 text-center">
