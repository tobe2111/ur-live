          ...
          <>
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-[#2C2F35]">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full hover:bg-gray-100 dark:hover:bg-[#2C2F35] flex items-center justify-center transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
              >
