...
// 에러 메시지 포맷팅
// ============================================
function formatValidationError(error, region) {
...
// KR 환경 변수 검증
// ============================================
export function validateKREnv(env = import.meta.env) {
    try {
...
// WORLD 환경 변수 검증
// ============================================
export function validateWorldEnv(env = import.meta.env) {
    try {
...
// Worker 환경 변수 검증
// ============================================
export function validateWorkerEnv(env, region) {
    try {
        // 기본 스키마 검증
...
// ============================================
export function validateEnvForBuild(mode) {
...
// 런타임 검증 (main.tsx용)
// ============================================
export function validateEnvForRuntime(region) {
    try {
        if (region === 'KR') {
            validateKREnv();
        }
...
// ============================================
export function optionalEnv(key, value, defaultValue) {
