import{o as Bc}from"./vendor-DryRFiNV.js";const qc=()=>{};var Ks={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rg(n){Qf(ht),rt(new qe("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return eg(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),Ce(Cr,Sr,n),Ce(Cr,Sr,"esm2020")}pe.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};pe.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};rg();export{zf as a,Uh as b,Dh as c,cd as d,ug as e,hg as f,mg as g,dg as h,ru as i,ag as j,fg as l,pg as o,lg as p,_g as q,cg as r,Oh as s};
//# sourceMappingURL=firebase-DndYYICl.js.map
