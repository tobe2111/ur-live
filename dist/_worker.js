var Nr=Object.defineProperty;var ut=e=>{throw TypeError(e)};var jr=(e,s,t)=>s in e?Nr(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t;var A=(e,s,t)=>jr(e,typeof s!="symbol"?s+"":s,t),$s=(e,s,t)=>s.has(e)||ut("Cannot "+t);var h=(e,s,t)=>($s(e,s,"read from private field"),t?t.call(e):s.get(e)),D=(e,s,t)=>s.has(e)?ut("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,t),I=(e,s,t,r)=>($s(e,s,"write to private field"),r?r.call(e,t):s.set(e,t),t),N=(e,s,t)=>($s(e,s,"access private method"),t);var dt=(e,s,t,r)=>({set _(a){I(e,s,a,t)},get _(){return h(e,s,r)}});var pt=(e,s,t)=>(r,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,l=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&a||void 0,u)try{c=await u(r,()=>o(i+1))}catch(d){if(d instanceof Error&&s)r.error=d,c=await s(d,r),l=!0;else throw d}else r.finalized===!1&&t&&(c=await t(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},Lr=Symbol(),Mr=async(e,s=Object.create(null))=>{const{all:t=!1,dot:r=!1}=s,n=(e instanceof Kt?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?$r(e,{all:t,dot:r}):{}};async function $r(e,s){const t=await e.formData();return t?Fr(t,s):{}}function Fr(e,s){const t=Object.create(null);return e.forEach((r,a)=>{s.all||a.endsWith("[]")?Pr(t,a,r):t[a]=r}),s.dot&&Object.entries(t).forEach(([r,a])=>{r.includes(".")&&(Ur(t,r,a),delete t[r])}),t}var Pr=(e,s,t)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(t):e[s]=[e[s],t]:s.endsWith("[]")?e[s]=[t]:e[s]=t},Ur=(e,s,t)=>{let r=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?r[n]=t:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},Ut=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},xr=e=>{const{groups:s,path:t}=Wr(e),r=Ut(t);return qr(r,s)},Wr=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(t,r)=>{const a=`@${r}`;return s.push([a,t]),a}),{groups:s,path:e}},qr=(e,s)=>{for(let t=s.length-1;t>=0;t--){const[r]=s[t];for(let a=e.length-1;a>=0;a--)if(e[a].includes(r)){e[a]=e[a].replace(r,s[t][1]);break}}return e},bs={},Hr=(e,s)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const r=`${e}#${s}`;return bs[r]||(t[2]?bs[r]=s&&s[0]!==":"&&s[0]!=="*"?[r,t[1],new RegExp(`^${t[2]}(?=/${s})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:bs[r]=[e,t[1],!0]),bs[r]}return null},Gs=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return s(t)}catch{return t}})}},Kr=e=>Gs(e,decodeURI),xt=e=>{const s=e.url,t=s.indexOf("/",s.indexOf(":")+4);let r=t;for(;r<s.length;r++){const a=s.charCodeAt(r);if(a===37){const n=s.indexOf("?",r),o=s.indexOf("#",r),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(t,i);return Kr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(t,r)},Br=e=>{const s=xt(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},He=(e,s,...t)=>(t.length&&(s=He(s,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),Wt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),t=[];let r="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))r+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){t.length===0&&r===""?t.push("/"):t.push(r);const n=a.replace("?","");r+="/"+n,t.push(r)}else r+="/"+a}),t.filter((a,n,o)=>o.indexOf(a)===n)},Fs=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Gs(e,Ht):e):e,qt=(e,s,t)=>{let r;if(!t&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,l=e.indexOf("&",c);return Fs(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(r=/[%+]/.test(e),!r)return}const a={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(r&&(c=Fs(c)),n=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),r&&(l=Fs(l))),t?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(l)):a[c]??(a[c]=l)}return s?a[s]:a},Jr=qt,Vr=(e,s)=>qt(e,s,!0),Ht=decodeURIComponent,mt=e=>Gs(e,Ht),Ve,re,ye,Bt,Jt,Bs,we,Nt,Kt=(Nt=class{constructor(e,s="/",t=[[]]){D(this,ye);A(this,"raw");D(this,Ve);D(this,re);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});D(this,we,e=>{const{bodyCache:s,raw:t}=this,r=s[e];if(r)return r;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=t[e]()});this.raw=e,this.path=s,I(this,re,t),I(this,Ve,{})}param(e){return e?N(this,ye,Bt).call(this,e):N(this,ye,Jt).call(this)}query(e){return Jr(this.url,e)}queries(e){return Vr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((t,r)=>{s[r]=t}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await Mr(this,e))}json(){return h(this,we).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,we).call(this,"text")}arrayBuffer(){return h(this,we).call(this,"arrayBuffer")}blob(){return h(this,we).call(this,"blob")}formData(){return h(this,we).call(this,"formData")}addValidatedData(e,s){h(this,Ve)[e]=s}valid(e){return h(this,Ve)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Lr](){return h(this,re)}get matchedRoutes(){return h(this,re)[0].map(([[,e]])=>e)}get routePath(){return h(this,re)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ve=new WeakMap,re=new WeakMap,ye=new WeakSet,Bt=function(e){const s=h(this,re)[0][this.routeIndex][1][e],t=N(this,ye,Bs).call(this,s);return t&&/\%/.test(t)?mt(t):t},Jt=function(){const e={},s=Object.keys(h(this,re)[0][this.routeIndex][1]);for(const t of s){const r=N(this,ye,Bs).call(this,h(this,re)[0][this.routeIndex][1][t]);r!==void 0&&(e[t]=/\%/.test(r)?mt(r):r)}return e},Bs=function(e){return h(this,re)[1]?h(this,re)[1][e]:e},we=new WeakMap,Nt),Yr={Stringify:1},Vt=async(e,s,t,r,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Vt(c,s,!1,r,a))).then(()=>a[0]))):Promise.resolve(e)},zr="text/plain; charset=UTF-8",Ps=(e,s)=>({"Content-Type":e,...s}),Ue=(e,s)=>new Response(e,s),ps,ms,fe,Ye,he,ee,_s,ze,Ge,De,fs,hs,ue,Ke,Js,jt,Gr=(jt=class{constructor(e,s){D(this,ue);D(this,ps);D(this,ms);A(this,"env",{});D(this,fe);A(this,"finalized",!1);A(this,"error");D(this,Ye);D(this,he);D(this,ee);D(this,_s);D(this,ze);D(this,Ge);D(this,De);D(this,fs);D(this,hs);A(this,"render",(...e)=>(h(this,ze)??I(this,ze,s=>this.html(s)),h(this,ze).call(this,...e)));A(this,"setLayout",e=>I(this,_s,e));A(this,"getLayout",()=>h(this,_s));A(this,"setRenderer",e=>{I(this,ze,e)});A(this,"header",(e,s,t)=>{this.finalized&&I(this,ee,Ue(h(this,ee).body,h(this,ee)));const r=h(this,ee)?h(this,ee).headers:h(this,De)??I(this,De,new Headers);s===void 0?r.delete(e):t!=null&&t.append?r.append(e,s):r.set(e,s)});A(this,"status",e=>{I(this,Ye,e)});A(this,"set",(e,s)=>{h(this,fe)??I(this,fe,new Map),h(this,fe).set(e,s)});A(this,"get",e=>h(this,fe)?h(this,fe).get(e):void 0);A(this,"newResponse",(...e)=>N(this,ue,Ke).call(this,...e));A(this,"body",(e,s,t)=>N(this,ue,Ke).call(this,e,s,t));A(this,"text",(e,s,t)=>N(this,ue,Js).call(this)&&!s&&!t?Ue(e):N(this,ue,Ke).call(this,e,s,Ps(zr,t)));A(this,"json",(e,s,t)=>N(this,ue,Js).call(this)&&!s&&!t?Response.json(e):N(this,ue,Ke).call(this,JSON.stringify(e),s,Ps("application/json",t)));A(this,"html",(e,s,t)=>{const r=a=>N(this,ue,Ke).call(this,a,s,Ps("text/html; charset=UTF-8",t));return typeof e=="object"?Vt(e,Yr.Stringify,!1,{}).then(r):r(e)});A(this,"redirect",(e,s)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,s??302)});A(this,"notFound",()=>(h(this,Ge)??I(this,Ge,()=>Ue()),h(this,Ge).call(this,this)));I(this,ps,e),s&&(I(this,he,s.executionCtx),this.env=s.env,I(this,Ge,s.notFoundHandler),I(this,hs,s.path),I(this,fs,s.matchResult))}get req(){return h(this,ms)??I(this,ms,new Kt(h(this,ps),h(this,hs),h(this,fs))),h(this,ms)}get event(){if(h(this,he)&&"respondWith"in h(this,he))return h(this,he);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,he))return h(this,he);throw Error("This context has no ExecutionContext")}get res(){return h(this,ee)||I(this,ee,Ue(null,{headers:h(this,De)??I(this,De,new Headers)}))}set res(e){if(h(this,ee)&&e){e=Ue(e.body,e);for(const[s,t]of h(this,ee).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const r=h(this,ee).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of r)e.headers.append("set-cookie",a)}else e.headers.set(s,t)}I(this,ee,e),this.finalized=!0}get var(){return h(this,fe)?Object.fromEntries(h(this,fe)):{}}},ps=new WeakMap,ms=new WeakMap,fe=new WeakMap,Ye=new WeakMap,he=new WeakMap,ee=new WeakMap,_s=new WeakMap,ze=new WeakMap,Ge=new WeakMap,De=new WeakMap,fs=new WeakMap,hs=new WeakMap,ue=new WeakSet,Ke=function(e,s,t){const r=h(this,ee)?new Headers(h(this,ee).headers):h(this,De)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(t)for(const[n,o]of Object.entries(t))if(typeof o=="string")r.set(n,o);else{r.delete(n);for(const i of o)r.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??h(this,Ye);return Ue(e,{status:a,headers:r})},Js=function(){return!h(this,De)&&!h(this,Ye)&&!this.finalized},jt),K="ALL",Xr="all",Qr=["get","post","put","delete","options","patch"],Yt="Can not add a route since the matcher is already built.",zt=class extends Error{},Zr="__COMPOSED_HANDLER",ea=e=>e.text("404 Not Found",404),_t=(e,s)=>{if("getResponse"in e){const t=e.getResponse();return s.newResponse(t.body,t)}return console.error(e),s.text("Internal Server Error",500)},ie,B,Gt,ce,Ae,Rs,Is,Xe,sa=(Xe=class{constructor(s={}){D(this,B);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");D(this,ie,"/");A(this,"routes",[]);D(this,ce,ea);A(this,"errorHandler",_t);A(this,"onError",s=>(this.errorHandler=s,this));A(this,"notFound",s=>(I(this,ce,s),this));A(this,"fetch",(s,...t)=>N(this,B,Is).call(this,s,t[1],t[0],s.method));A(this,"request",(s,t,r,a)=>s instanceof Request?this.fetch(t?new Request(s,t):s,r,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${He("/",s)}`,t),r,a)));A(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(N(this,B,Is).call(this,s.request,s,void 0,s.request.method))})});[...Qr,Xr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?I(this,ie,o):N(this,B,Ae).call(this,n,h(this,ie),o),i.forEach(c=>{N(this,B,Ae).call(this,n,h(this,ie),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){I(this,ie,c);for(const l of[n].flat())i.map(u=>{N(this,B,Ae).call(this,l.toUpperCase(),h(this,ie),u)})}return this},this.use=(n,...o)=>(typeof n=="string"?I(this,ie,n):(I(this,ie,"*"),o.unshift(n)),o.forEach(i=>{N(this,B,Ae).call(this,K,h(this,ie),i)}),this);const{strict:r,...a}=s;Object.assign(this,a),this.getPath=r??!0?s.getPath??xt:Br}route(s,t){const r=this.basePath(s);return t.routes.map(a=>{var o;let n;t.errorHandler===_t?n=a.handler:(n=async(i,c)=>(await pt([],t.errorHandler)(i,()=>a.handler(i,c))).res,n[Zr]=a.handler),N(o=r,B,Ae).call(o,a.method,a.path,n)}),this}basePath(s){const t=N(this,B,Gt).call(this);return t._basePath=He(this._basePath,s),t}mount(s,t,r){let a,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?a=c=>c:a=r.replaceRequest));const o=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};a||(a=(()=>{const c=He(this._basePath,s),l=c==="/"?0:c.length;return u=>{const d=new URL(u.url);return d.pathname=d.pathname.slice(l)||"/",new Request(d,u)}})());const i=async(c,l)=>{const u=await t(a(c.req.raw),...o(c));if(u)return u;await l()};return N(this,B,Ae).call(this,K,He(s,"*"),i),this}},ie=new WeakMap,B=new WeakSet,Gt=function(){const s=new Xe({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,I(s,ce,h(this,ce)),s.routes=this.routes,s},ce=new WeakMap,Ae=function(s,t,r){s=s.toUpperCase(),t=He(this._basePath,t);const a={basePath:this._basePath,path:t,method:s,handler:r};this.router.add(s,t,[r,a]),this.routes.push(a)},Rs=function(s,t){if(s instanceof Error)return this.errorHandler(s,t);throw s},Is=function(s,t,r,a){if(a==="HEAD")return(async()=>new Response(null,await N(this,B,Is).call(this,s,t,r,"GET")))();const n=this.getPath(s,{env:r}),o=this.router.match(a,n),i=new Gr(s,{path:n,matchResult:o,env:r,executionCtx:t,notFoundHandler:h(this,ce)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await h(this,ce).call(this,i)})}catch(u){return N(this,B,Rs).call(this,u,i)}return l instanceof Promise?l.then(u=>u||(i.finalized?i.res:h(this,ce).call(this,i))).catch(u=>N(this,B,Rs).call(this,u,i)):l??h(this,ce).call(this,i)}const c=pt(o[0],this.errorHandler,h(this,ce));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return N(this,B,Rs).call(this,l,i)}})()},Xe),Xt=[];function ta(e,s){const t=this.buildAllMatchers(),r=((a,n)=>{const o=t[a]||t[K],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],Xt];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=r,r(e,s)}var As="[^/]+",ls=".*",us="(?:|/.*)",Be=Symbol(),ra=new Set(".\\+*[^]$()");function aa(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===ls||e===us?1:s===ls||s===us?-1:e===As?1:s===As?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var ke,Ce,le,Me,na=(Me=class{constructor(){D(this,ke);D(this,Ce);D(this,le,Object.create(null))}insert(s,t,r,a,n){if(s.length===0){if(h(this,ke)!==void 0)throw Be;if(n)return;I(this,ke,t);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",ls]:["","",As]:o==="/*"?["","",us]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let d=c[2]||As;if(u&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Be;if(l=h(this,le)[d],!l){if(Object.keys(h(this,le)).some(m=>m!==ls&&m!==us))throw Be;if(n)return;l=h(this,le)[d]=new Me,u!==""&&I(l,Ce,a.varIndex++)}!n&&u!==""&&r.push([u,h(l,Ce)])}else if(l=h(this,le)[o],!l){if(Object.keys(h(this,le)).some(u=>u.length>1&&u!==ls&&u!==us))throw Be;if(n)return;l=h(this,le)[o]=new Me}l.insert(i,t,r,a,n)}buildRegExpStr(){const t=Object.keys(h(this,le)).sort(aa).map(r=>{const a=h(this,le)[r];return(typeof h(a,Ce)=="number"?`(${r})@${h(a,Ce)}`:ra.has(r)?`\\${r}`:r)+a.buildRegExpStr()});return typeof h(this,ke)=="number"&&t.unshift(`#${h(this,ke)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},ke=new WeakMap,Ce=new WeakMap,le=new WeakMap,Me),Cs,Es,Lt,oa=(Lt=class{constructor(){D(this,Cs,{varIndex:0});D(this,Es,new na)}insert(e,s,t){const r=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return a[o]=[l,c],o++,i=!0,l}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return h(this,Es).insert(n,s,r,h(this,Cs),t),r}buildRegExp(){let e=h(this,Es).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const t=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(t[++s]=Number(n),"$()"):(o!==void 0&&(r[Number(o)]=++s),"")),[new RegExp(`^${e}`),t,r]}},Cs=new WeakMap,Es=new WeakMap,Lt),ia=[/^$/,[],Object.create(null)],vs=Object.create(null);function Qt(e){return vs[e]??(vs[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function ca(){vs=Object.create(null)}function la(e){var l;const s=new oa,t=[];if(e.length===0)return ia;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,d],[m,_])=>u?1:m?-1:d.length-_.length),a=Object.create(null);for(let u=0,d=-1,m=r.length;u<m;u++){const[_,f,E]=r[u];_?a[f]=[E.map(([w])=>[w,Object.create(null)]),Xt]:d++;let b;try{b=s.insert(f,d,_)}catch(w){throw w===Be?new zt(f):w}_||(t[d]=E.map(([w,g])=>{const T=Object.create(null);for(g-=1;g>=0;g--){const[y,R]=b[g];T[y]=R}return[w,T]}))}const[n,o,i]=s.buildRegExp();for(let u=0,d=t.length;u<d;u++)for(let m=0,_=t[u].length;m<_;m++){const f=(l=t[u][m])==null?void 0:l[1];if(!f)continue;const E=Object.keys(f);for(let b=0,w=E.length;b<w;b++)f[E[b]]=i[f[E[b]]]}const c=[];for(const u in o)c[u]=t[o[u]];return[n,c,a]}function xe(e,s){if(e){for(const t of Object.keys(e).sort((r,a)=>a.length-r.length))if(Qt(t).test(s))return[...e[t]]}}var be,Se,Ns,Zt,Mt,ua=(Mt=class{constructor(){D(this,Ns);A(this,"name","RegExpRouter");D(this,be);D(this,Se);A(this,"match",ta);I(this,be,{[K]:Object.create(null)}),I(this,Se,{[K]:Object.create(null)})}add(e,s,t){var i;const r=h(this,be),a=h(this,Se);if(!r||!a)throw new Error(Yt);r[e]||[r,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[K]).forEach(l=>{c[e][l]=[...c[K][l]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=Qt(s);e===K?Object.keys(r).forEach(l=>{var u;(u=r[l])[s]||(u[s]=xe(r[l],s)||xe(r[K],s)||[])}):(i=r[e])[s]||(i[s]=xe(r[e],s)||xe(r[K],s)||[]),Object.keys(r).forEach(l=>{(e===K||e===l)&&Object.keys(r[l]).forEach(u=>{c.test(u)&&r[l][u].push([t,n])})}),Object.keys(a).forEach(l=>{(e===K||e===l)&&Object.keys(a[l]).forEach(u=>c.test(u)&&a[l][u].push([t,n]))});return}const o=Wt(s)||[s];for(let c=0,l=o.length;c<l;c++){const u=o[c];Object.keys(a).forEach(d=>{var m;(e===K||e===d)&&((m=a[d])[u]||(m[u]=[...xe(r[d],u)||xe(r[K],u)||[]]),a[d][u].push([t,n-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,Se)).concat(Object.keys(h(this,be))).forEach(s=>{e[s]||(e[s]=N(this,Ns,Zt).call(this,s))}),I(this,be,I(this,Se,void 0)),ca(),e}},be=new WeakMap,Se=new WeakMap,Ns=new WeakSet,Zt=function(e){const s=[];let t=e===K;return[h(this,be),h(this,Se)].forEach(r=>{const a=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];a.length!==0?(t||(t=!0),s.push(...a)):e!==K&&s.push(...Object.keys(r[K]).map(n=>[n,r[K][n]]))}),t?la(s):null},Mt),Te,Ee,$t,da=($t=class{constructor(e){A(this,"name","SmartRouter");D(this,Te,[]);D(this,Ee,[]);I(this,Te,e.routers)}add(e,s,t){if(!h(this,Ee))throw new Error(Yt);h(this,Ee).push([e,s,t])}match(e,s){if(!h(this,Ee))throw new Error("Fatal error");const t=h(this,Te),r=h(this,Ee),a=t.length;let n=0,o;for(;n<a;n++){const i=t[n];try{for(let c=0,l=r.length;c<l;c++)i.add(...r[c]);o=i.match(e,s)}catch(c){if(c instanceof zt)continue;throw c}this.match=i.match.bind(i),I(this,Te,[i]),I(this,Ee,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(h(this,Ee)||h(this,Te).length!==1)throw new Error("No active router has been determined yet.");return h(this,Te)[0]}},Te=new WeakMap,Ee=new WeakMap,$t),ns=Object.create(null),pa=e=>{for(const s in e)return!0;return!1},Re,Z,Ne,Qe,G,ge,Oe,Ze,ma=(Ze=class{constructor(s,t,r){D(this,ge);D(this,Re);D(this,Z);D(this,Ne);D(this,Qe,0);D(this,G,ns);if(I(this,Z,r||Object.create(null)),I(this,Re,[]),s&&t){const a=Object.create(null);a[s]={handler:t,possibleKeys:[],score:0},I(this,Re,[a])}I(this,Ne,[])}insert(s,t,r){I(this,Qe,++dt(this,Qe)._);let a=this;const n=xr(t),o=[];for(let i=0,c=n.length;i<c;i++){const l=n[i],u=n[i+1],d=Hr(l,u),m=Array.isArray(d)?d[0]:l;if(m in h(a,Z)){a=h(a,Z)[m],d&&o.push(d[1]);continue}h(a,Z)[m]=new Ze,d&&(h(a,Ne).push(d),o.push(d[1])),a=h(a,Z)[m]}return h(a,Re).push({[s]:{handler:r,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:h(this,Qe)}}),a}search(s,t){var u;const r=[];I(this,G,ns);let n=[this];const o=Ut(t),i=[],c=o.length;let l=null;for(let d=0;d<c;d++){const m=o[d],_=d===c-1,f=[];for(let b=0,w=n.length;b<w;b++){const g=n[b],T=h(g,Z)[m];T&&(I(T,G,h(g,G)),_?(h(T,Z)["*"]&&N(this,ge,Oe).call(this,r,h(T,Z)["*"],s,h(g,G)),N(this,ge,Oe).call(this,r,T,s,h(g,G))):f.push(T));for(let y=0,R=h(g,Ne).length;y<R;y++){const $=h(g,Ne)[y],k=h(g,G)===ns?{}:{...h(g,G)};if($==="*"){const F=h(g,Z)["*"];F&&(N(this,ge,Oe).call(this,r,F,s,h(g,G)),I(F,G,k),f.push(F));continue}const[O,W,P]=$;if(!m&&!(P instanceof RegExp))continue;const L=h(g,Z)[O];if(P instanceof RegExp){if(l===null){l=new Array(c);let Y=t[0]==="/"?1:0;for(let v=0;v<c;v++)l[v]=Y,Y+=o[v].length+1}const F=t.substring(l[d]),Q=P.exec(F);if(Q){if(k[W]=Q[0],N(this,ge,Oe).call(this,r,L,s,h(g,G),k),pa(h(L,Z))){I(L,G,k);const Y=((u=Q[0].match(/\//))==null?void 0:u.length)??0;(i[Y]||(i[Y]=[])).push(L)}continue}}(P===!0||P.test(m))&&(k[W]=m,_?(N(this,ge,Oe).call(this,r,L,s,k,h(g,G)),h(L,Z)["*"]&&N(this,ge,Oe).call(this,r,h(L,Z)["*"],s,k,h(g,G))):(I(L,G,k),f.push(L)))}}const E=i.shift();n=E?f.concat(E):f}return r.length>1&&r.sort((d,m)=>d.score-m.score),[r.map(({handler:d,params:m})=>[d,m])]}},Re=new WeakMap,Z=new WeakMap,Ne=new WeakMap,Qe=new WeakMap,G=new WeakMap,ge=new WeakSet,Oe=function(s,t,r,a,n){for(let o=0,i=h(t,Re).length;o<i;o++){const c=h(t,Re)[o],l=c[r]||c[K],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),a!==ns||n&&n!==ns))for(let d=0,m=l.possibleKeys.length;d<m;d++){const _=l.possibleKeys[d],f=u[l.score];l.params[_]=n!=null&&n[_]&&!f?n[_]:a[_]??(n==null?void 0:n[_]),u[l.score]=!0}}},Ze),je,Ft,_a=(Ft=class{constructor(){A(this,"name","TrieRouter");D(this,je);I(this,je,new ma)}add(e,s,t){const r=Wt(s);if(r){for(let a=0,n=r.length;a<n;a++)h(this,je).insert(e,r[a],t);return}h(this,je).insert(e,s,t)}match(e,s){return h(this,je).search(e,s)}},je=new WeakMap,Ft),er=class extends sa{constructor(e={}){super(e),this.router=e.router??new da({routers:[new ua,new _a]})}},S=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(t.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(t.allowMethods);return async function(o,i){var u;function c(d,m){o.res.headers.set(d,m)}const l=await r(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),t.credentials&&c("Access-Control-Allow-Credentials","true"),(u=t.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&c("Vary","Origin"),t.maxAge!=null&&c("Access-Control-Max-Age",t.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&c("Access-Control-Allow-Methods",d.join(","));let m=t.allowHeaders;if(!(m!=null&&m.length)){const _=o.req.header("Access-Control-Request-Headers");_&&(m=_.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function fa(e){var a;const s=((a=e.split(".").pop())==null?void 0:a.toLowerCase())||"jpg",t=Date.now(),r=crypto.randomUUID().substring(0,8);return`upload_${t}_${r}.${s}`}async function ha(e){const s=new Uint8Array(e);return s[0]===255&&s[1]===216&&s[2]===255?{valid:!0,detectedType:"image/jpeg"}:s[0]===137&&s[1]===80&&s[2]===78&&s[3]===71?{valid:!0,detectedType:"image/png"}:s[0]===71&&s[1]===73&&s[2]===70&&s[3]===56?{valid:!0,detectedType:"image/gif"}:s[0]===82&&s[1]===73&&s[2]===70&&s[3]===70&&s[8]===87&&s[9]===69&&s[10]===66&&s[11]===80?{valid:!0,detectedType:"image/webp"}:{valid:!1}}function Ea(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],t=[];for(const r of s)e[r]||t.push(r);if(t.length>0)throw new Error(`Missing required environment variables: ${t.join(", ")}
...
주문해 주셔서 감사합니다!`,c=await Zs(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:t.buyer_phone,message:i});return c.success?(await Ya(e.DB,t.seller_id,n),await ft(e.DB,{seller_id:t.seller_id,template_code:"order_confirm",recipient_phone:t.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await ft(e.DB,{seller_id:t.seller_id,template_code:"order_confirm",recipient_phone:t.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(t){return console.error(`Error sending order confirmation for order ${s}:`,t),{success:!1,error:t.message}}}function Ga(e,s){let t=e;return Object.entries(s).forEach(([r,a])=>{const n=new RegExp(`#{${r}}`,"g");t=t.replace(n,a)}),t}function Xa(e,s){const r=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:r.length===0,missingVars:r}}async function Qa(e,s,t){const r=await e.prepare(`
  ...
  `).bind(t,r,s).run()}async function sn(e,s,t,r,a,n,o,i,c){try{const l={...i,...o.variables},u=Ga(r,l),d=await Zs(e,{senderKey:a,templateCode:n,to:o.phone,message:u});return d.success?(await Ws(e.DB,{accountId:s,templateId:t,recipientPhone:o.phone,messageContent:u,status:"sent",cost:c,aligoMessageId:d.messageId}),{phone:o.phone,status:"sent",messageId:d.messageId,cost:c}):(await Ws(e.DB,{accountId:s,templateId:t,recipientPhone:o.phone,messageContent:u,status:"failed",cost:0,failedReason:d.error}),await ht(e.DB,s,c),{phone:o.phone,status:"failed",error:d.error,cost:0})}catch(l){return console.error(`Failed to send alimtalk to ${o.phone}:`,l),await Ws(e.DB,{accountId:s,templateId:t,recipientPhone:o.phone,messageContent:"",status:"failed",cost:0,failedReason:l.message}),await ht(e.DB,s,c),{phone:o.phone,status:"failed",error:l.message,cost:0}}}async function et(e,s){const{accountId:t,templateId:r,recipients:a,variables:n}=s;console.log(`[Alimtalk] Starting bulk send: ${a.length} recipients`);try{const o=await e.DB.prepare(`
    ...
    `).bind(r,t).first();if(!i)throw new Error("Template not found");if(i.status!=="approved")throw new Error("Template is not approved");const c=Xa(i.template_content,n);if(!c.valid)throw new Error(`Missing variables: ${c.missingVars.join(", ")}`);const l=15,u=a.length*l,d=await Qa(e.DB,t,u);if(!d.sufficient)throw new Error(`Insufficient balance. Required: ${u}, Current: ${d.currentBalance}`);await Za(e.DB,t,u),console.log(`[Alimtalk] Deducted ${u} points from account ${t}`);const m=[];let _=0,f=0,E=0;for(const b of a){const w=await sn(e,t,r,i.template_content,o.sender_key,i.template_code,b,n,l);m.push(w),w.status==="sent"?_++:(f++,E+=l),m.length%10===0&&await new Promise(g=>setTimeout(g,1e3))}return await en(e.DB,t,_,f),console.log(`[Alimtalk] Completed: ${_} sent, ${f} failed, ${E} refunded`),{success:!0,totalRecipients:a.length,successCount:_,failedCount:f,refundedAmount:E,messages:m}}catch(o){return console.error("[Alimtalk] Bulk send failed:",o),{success:!1,totalRecipients:a.length,successCount:0,failedCount:a.length,refundedAmount:0,messages:[],error:o.message}}}async function tn(e,s,t,r,a){const n=await e.DB.prepare(`
    SELECT 
      o.*,
      u.name as buyer_name,
      u.phone as buyer_phone,
...
`),d=await this.pemToDer(u),m=await crypto.subtle.importKey("pkcs8",d,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),_=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",m,new TextEncoder().encode(l)),E=btoa(String.fromCharCode(...new Uint8Array(_))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),b=`${l}.${E}`;return console.log("[Firebase Custom Token] ✅ Token created successfully"),b}catch(r){throw console.error("[Firebase Custom Token] ❌ Failed to create token:",r),new Error("Failed to create Firebase custom token")}}async pemToDer(s){const a=s.substring("-----BEGIN PRIVATE KEY-----".length,s.length-"-----END PRIVATE KEY-----".length-1).trim(),n=atob(a),o=new Uint8Array(n.length);for(let i=0;i<n.length;i++)o[i]=n.charCodeAt(i);return o.buffer}}function gs(e){return new Tn(e)}const rt=crypto,nr=e=>e instanceof CryptoKey,Ss=new TextEncoder,Ls=new TextDecoder;function Rn(...e){const s=e.reduce((a,{length:n})=>a+n,0),t=new Uint8Array(s);let r=0;for(const a of e)t.set(a,r),r+=a.length;return t}const In=e=>{const s=atob(e),t=new Uint8Array(s.length);for(let r=0;r<s.length;r++)t[r]=s.charCodeAt(r);return t},Le=e=>{let s=e;s instanceof Uint8Array&&(s=Ls.decode(s)),s=s.replace(/-/g,"+").replace(/_/g,"/").replace(/\s/g,"");try{return In(s)}catch{throw new TypeError("The input to be decoded is not correctly encoded.")}};class X extends Error{constructor(s,t){var r;super(s,t),this.code="ERR_JOSE_GENERIC",this.name=this.constructor.name,(r=Error.captureStackTrace)==null||r.call(Error,this,this.constructor)}}X.code="ERR_JOSE_GENERIC";class oe extends X{constructor(s,t,r="unspecified",a="unspecified"){super(s,{cause:{claim:r,reason:a,payload:t}}),this.code="ERR_JWT_CLAIM_VALIDATION_FAILED",this.claim=r,this.reason=a,this.payload=t}}oe.code="ERR_JWT_CLAIM_VALIDATION_FAILED";class Vs extends X{constructor(s,t,r="unspecified",a="unspecified"){super(s,{cause:{claim:r,reason:a,payload:t}}),this.code="ERR_JWT_EXPIRED",this.claim=r,this.reason=a,this.payload=t}}Vs.code="ERR_JWT_EXPIRED";class or extends X{constructor(){super(...arguments),this.code="ERR_JOSE_ALG_NOT_ALLOWED"}}or.code="ERR_JOSE_ALG_NOT_ALLOWED";class me extends X{constructor(){super(...arguments),this.code="ERR_JOSE_NOT_SUPPORTED"}}me.code="ERR_JOSE_NOT_SUPPORTED";class vn extends X{constructor(s="decryption operation failed",t){super(s,t),this.code="ERR_JWE_DECRYPTION_FAILED"}}vn.code="ERR_JWE_DECRYPTION_FAILED";class An extends X{constructor(){super(...arguments),this.code="ERR_JWE_INVALID"}}An.code="ERR_JWE_INVALID";class J extends X{constructor(){super(...arguments),this.code="ERR_JWS_INVALID"}}J.code="ERR_JWS_INVALID";class at extends X{constructor(){super(...arguments),this.code="ERR_JWT_INVALID"}}at.code="ERR_JWT_INVALID";class On extends X{constructor(){super(...arguments),this.code="ERR_JWK_INVALID"}}On.code="ERR_JWK_INVALID";class nt extends X{constructor(){super(...arguments),this.code="ERR_JWKS_INVALID"}}nt.code="ERR_JWKS_INVALID";class ot extends X{constructor(s="no applicable key found in the JSON Web Key Set",t){super(s,t),this.code="ERR_JWKS_NO_MATCHING_KEY"}}ot.code="ERR_JWKS_NO_MATCHING_KEY";class ir extends X{constructor(s="multiple matching keys found in the JSON Web Key Set",t){super(s,t),this.code="ERR_JWKS_MULTIPLE_MATCHING_KEYS"}}ir.code="ERR_JWKS_MULTIPLE_MATCHING_KEYS";class cr extends X{constructor(s="request timed out",t){super(s,t),this.code="ERR_JWKS_TIMEOUT"}}cr.code="ERR_JWKS_TIMEOUT";class lr extends X{constructor(s="signature verification failed",t){super(s,t),this.code="ERR_JWS_SIGNATURE_VERIFICATION_FAILED"}}lr.code="ERR_JWS_SIGNATURE_VERIFICATION_FAILED";function pe(e,s="algorithm.name"){return new TypeError(`CryptoKey does not support this operation, its ${s} must be ${e}`)}function os(e,s){return e.name===s}function qs(e){return parseInt(e.name.slice(4),10)}function Dn(e){switch(e){case"ES256":return"P-256";case"ES384":return"P-384";case"ES512":return"P-521";default:throw new Error("unreachable")}}function kn(e,s){if(s.length&&!s.some(t=>e.usages.includes(t))){let t="CryptoKey does not support this operation, its usages must include ";if(s.length>2){const r=s.pop();t+=`one of ${s.join(", ")}, or ${r}.`}else s.length===2?t+=`one of ${s[0]} or ${s[1]}.`:t+=`${s[0]}.`;throw new TypeError(t)}}function Cn(e,s,...t){switch(s){case"HS256":case"HS384":case"HS512":{if(!os(e.algorithm,"HMAC"))throw pe("HMAC");const r=parseInt(s.slice(2),10);if(qs(e.algorithm.hash)!==r)throw pe(`SHA-${r}`,"algorithm.hash");break}case"RS256":case"RS384":case"RS512":{if(!os(e.algorithm,"RSASSA-PKCS1-v1_5"))throw pe("RSASSA-PKCS1-v1_5");const r=parseInt(s.slice(2),10);if(qs(e.algorithm.hash)!==r)throw pe(`SHA-${r}`,"algorithm.hash");break}case"PS256":case"PS384":case"PS512":{if(!os(e.algorithm,"RSA-PSS"))throw pe("RSA-PSS");const r=parseInt(s.slice(2),10);if(qs(e.algorithm.hash)!==r)throw pe(`SHA-${r}`,"algorithm.hash");break}case"EdDSA":{if(e.algorithm.name!=="Ed25519"&&e.algorithm.name!=="Ed448")throw pe("Ed25519 or Ed448");break}case"Ed25519":{if(!os(e.algorithm,"Ed25519"))throw pe("Ed25519");break}case"ES256":case"ES384":case"ES512":{if(!os(e.algorithm,"ECDSA"))throw pe("ECDSA");const r=Dn(s);if(e.algorithm.namedCurve!==r)throw pe(r,"algorithm.namedCurve");break}default:throw new TypeError("CryptoKey does not support this operation")}kn(e,t)}function ur(e,s,...t){var r;if(t=t.filter(Boolean),t.length>2){const a=t.pop();e+=`one of type ${t.join(", ")}, or ${a}.`}else t.length===2?e+=`one of type ${t[0]} or ${t[1]}.`:e+=`of type ${t[0]}.`;return s==null?e+=` Received ${s}`:typeof s=="function"&&s.name?e+=` Received function ${s.name}`:typeof s=="object"&&s!=null&&(r=s.constructor)!=null&&r.name&&(e+=` Received an instance of ${s.constructor.name}`),e}const Et=(e,...s)=>ur("Key must be ",e,...s);function dr(e,s,...t){return ur(`Key for the ${e} algorithm must be `,s,...t)}const pr=e=>nr(e)?!0:(e==null?void 0:e[Symbol.toStringTag])==="KeyObject",Ds=["CryptoKey"],Nn=(...e)=>{const s=e.filter(Boolean);if(s.length===0||s.length===1)return!0;let t;for(const r of s){const a=Object.keys(r);if(!t||t.size===0){t=new Set(a);continue}for(const n of a){if(t.has(n))return!1;t.add(n)}}return!0};function jn(e){return typeof e=="object"&&e!==null}function Ie(e){if(!jn(e)||Object.prototype.toString.call(e)!=="[object Object]")return!1;if(Object.getPrototypeOf(e)===null)return!0;let s=e;for(;Object.getPrototypeOf(s)!==null;)s=Object.getPrototypeOf(s);return Object.getPrototypeOf(e)===s}const Ln=(e,s)=>{if(e.startsWith("RS")||e.startsWith("PS")){const{modulusLength:t}=s.algorithm;if(typeof t!="number"||t<2048)throw new TypeError(`${e} requires key modulusLength to be 2048 bits or larger`)}};function es(e){return Ie(e)&&typeof e.kty=="string"}function Mn(e){return e.kty!=="oct"&&typeof e.d=="string"}function $n(e){return e.kty!=="oct"&&typeof e.d>"u"}function Fn(e){return es(e)&&e.kty==="oct"&&typeof e.k=="string"}function Pn(e){let s,t;switch(e.kty){case"RSA":{switch(e.alg){case"PS256":case"PS384":case"PS512":s={name:"RSA-PSS",hash:`SHA-${e.alg.slice(-3)}`},t=e.d?["sign"]:["verify"];break;case"RS256":case"RS384":case"RS512":s={name:"RSASSA-PKCS1-v1_5",hash:`SHA-${e.alg.slice(-3)}`},t=e.d?["sign"]:["verify"];break;case"RSA-OAEP":case"RSA-OAEP-256":case"RSA-OAEP-384":case"RSA-OAEP-512":s={name:"RSA-OAEP",hash:`SHA-${parseInt(e.alg.slice(-3),10)||1}`},t=e.d?["decrypt","unwrapKey"]:["encrypt","wrapKey"];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}case"EC":{switch(e.alg){case"ES256":s={name:"ECDSA",namedCurve:"P-256"},t=e.d?["sign"]:["verify"];break;case"ES384":s={name:"ECDSA",namedCurve:"P-384"},t=e.d?["sign"]:["verify"];break;case"ES512":s={name:"ECDSA",namedCurve:"P-521"},t=e.d?["sign"]:["verify"];break;case"ECDH-ES":case"ECDH-ES+A128KW":case"ECDH-ES+A192KW":case"ECDH-ES+A256KW":s={name:"ECDH",namedCurve:e.crv},t=e.d?["deriveBits"]:[];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}case"OKP":{switch(e.alg){case"Ed25519":s={name:"Ed25519"},t=e.d?["sign"]:["verify"];break;case"EdDSA":s={name:e.crv},t=e.d?["sign"]:["verify"];break;case"ECDH-ES":case"ECDH-ES+A128KW":case"ECDH-ES+A192KW":case"ECDH-ES+A256KW":s={name:e.crv},t=e.d?["deriveBits"]:[];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}default:throw new me('Invalid or unsupported JWK "kty" (Key Type) Parameter value')}return{algorithm:s,keyUsages:t}}const mr=async e=>{if(!e.alg)throw new TypeError('"alg" argument is required when "jwk.alg" is not present');const{algorithm:s,keyUsages:t}=Pn(e),r=[s,e.ext??!1,e.key_ops??t],a={...e};return delete a.alg,delete a.use,rt.subtle.importKey("jwk",a,...r)},_r=e=>Le(e);let We,qe;const fr=e=>(e==null?void 0:e[Symbol.toStringTag])==="KeyObject",ks=async(e,s,t,r,a=!1)=>{let n=e.get(s);if(n!=null&&n[r])return n[r];const o=await mr({...t,alg:r});return a&&Object.freeze(s),n?n[r]=o:e.set(s,{[r]:o}),o},Un=(e,s)=>{if(fr(e)){let t=e.export({format:"jwk"});return delete t.d,delete t.dp,delete t.dq,delete t.p,delete t.q,delete t.qi,t.k?_r(t.k):(qe||(qe=new WeakMap),ks(qe,e,t,s))}return es(e)?e.k?Le(e.k):(qe||(qe=new WeakMap),ks(qe,e,e,s,!0)):e},xn=(e,s)=>{if(fr(e)){let t=e.export({format:"jwk"});return t.k?_r(t.k):(We||(We=new WeakMap),ks(We,e,t,s))}return es(e)?e.k?Le(e.k):(We||(We=new WeakMap),ks(We,e,e,s,!0)):e},Wn={normalizePublicKey:Un,normalizePrivateKey:xn};async function hr(e,s){if(!Ie(e))throw new TypeError("JWK must be an object");switch(s||(s=e.alg),e.kty){case"oct":if(typeof e.k!="string"||!e.k)throw new TypeError('missing "k" (Key Value) Parameter value');return Le(e.k);case"RSA":if("oth"in e&&e.oth!==void 0)throw new me('RSA JWK "oth" (Other Primes Info) Parameter value is not supported');case"EC":case"OKP":return mr({...e,alg:s});default:throw new me('Unsupported "kty" (Key Type) Parameter value')}}const Je=e=>e==null?void 0:e[Symbol.toStringTag],Ys=(e,s,t)=>{var r,a;if(s.use!==void 0&&s.use!=="sig")throw new TypeError("Invalid key for this operation, when present its use must be sig");if(s.key_ops!==void 0&&((a=(r=s.key_ops).includes)==null?void 0:a.call(r,t))!==!0)throw new TypeError(`Invalid key for this operation, when present its key_ops must include ${t}`);if(s.alg!==void 0&&s.alg!==e)throw new TypeError(`Invalid key for this operation, when present its alg must be ${e}`);return!0},qn=(e,s,t,r)=>{if(!(s instanceof Uint8Array)){if(r&&es(s)){if(Fn(s)&&Ys(e,s,t))return;throw new TypeError('JSON Web Key for symmetric algorithms must have JWK "kty" (Key Type) equal to "oct" and the JWK "k" (Key Value) present')}if(!pr(s))throw new TypeError(dr(e,s,...Ds,"Uint8Array",r?"JSON Web Key":null));if(s.type!=="secret")throw new TypeError(`${Je(s)} instances for symmetric algorithms must be of type "secret"`)}},Hn=(e,s,t,r)=>{if(r&&es(s))switch(t){case"sign":if(Mn(s)&&Ys(e,s,t))return;throw new TypeError("JSON Web Key for this operation be a private JWK");case"verify":if($n(s)&&Ys(e,s,t))return;throw new TypeError("JSON Web Key for this operation be a public JWK")}if(!pr(s))throw new TypeError(dr(e,s,...Ds,r?"JSON Web Key":null));if(s.type==="secret")throw new TypeError(`${Je(s)} instances for asymmetric algorithms must not be of type "secret"`);if(t==="sign"&&s.type==="public")throw new TypeError(`${Je(s)} instances for asymmetric algorithm signing must be of type "private"`);if(t==="decrypt"&&s.type==="public")throw new TypeError(`${Je(s)} instances for asymmetric algorithm decryption must be of type "private"`);if(s.algorithm&&t==="verify"&&s.type==="private")throw new TypeError(`${Je(s)} instances for asymmetric algorithm verifying must be of type "public"`);if(s.algorithm&&t==="encrypt"&&s.type==="private")throw new TypeError(`${Je(s)} instances for asymmetric algorithm encryption must be of type "public"`)};function Er(e,s,t,r){s.startsWith("HS")||s==="dir"||s.startsWith("PBES2")||/^A\d{3}(?:GCM)?KW$/.test(s)?qn(s,t,r,e):Hn(s,t,r,e)}Er.bind(void 0,!1);const gt=Er.bind(void 0,!0);function Kn(e,s,t,r,a){if(a.crit!==void 0&&(r==null?void 0:r.crit)===void 0)throw new e('"crit" (Critical) Header Parameter MUST be integrity protected');if(!r||r.crit===void 0)return new Set;if(!Array.isArray(r.crit)||r.crit.length===0||r.crit.some(o=>typeof o!="string"||o.length===0))throw new e('"crit" (Critical) Header Parameter MUST be an array of non-empty strings when present');let n;t!==void 0?n=new Map([...Object.entries(t),...s.entries()]):n=s;for(const o of r.crit){if(!n.has(o))throw new me(`Extension Header Parameter "${o}" is not recognized`);if(a[o]===void 0)throw new e(`Extension Header Parameter "${o}" is missing`);if(n.get(o)&&r[o]===void 0)throw new e(`Extension Header Parameter "${o}" MUST be integrity protected`)}return new Set(r.crit)}const Bn=(e,s)=>{if(s!==void 0&&(!Array.isArray(s)||s.some(t=>typeof t!="string")))throw new TypeError(`"${e}" option must be an array of strings`);if(s)return new Set(s)};function Jn(e,s){const t=`SHA-${e.slice(-3)}`;switch(e){case"HS256":case"HS384":case"HS512":return{hash:t,name:"HMAC"};case"PS256":case"PS384":case"PS512":return{hash:t,name:"RSA-PSS",saltLength:e.slice(-3)>>3};case"RS256":case"RS384":case"RS512":return{hash:t,name:"RSASSA-PKCS1-v1_5"};case"ES256":case"ES384":case"ES512":return{hash:t,name:"ECDSA",namedCurve:s.namedCurve};case"Ed25519":return{name:"Ed25519"};case"EdDSA":return{name:s.name};default:throw new me(`alg ${e} is not supported either by JOSE or your javascript runtime`)}}async function Vn(e,s,t){if(s=await Wn.normalizePublicKey(s,e),nr(s))return Cn(s,e,t),s;if(s instanceof Uint8Array){if(!e.startsWith("HS"))throw new TypeError(Et(s,...Ds));return rt.subtle.importKey("raw",s,{hash:`SHA-${e.slice(-3)}`,name:"HMAC"},!1,[t])}throw new TypeError(Et(s,...Ds,"Uint8Array","JSON Web Key"))}const Yn=async(e,s,t,r)=>{const a=await Vn(e,s,"verify");Ln(e,a);const n=Jn(e,a.algorithm);try{return await rt.subtle.verify(n,a,t,r)}catch{return!1}};async function zn(e,s,t){if(!Ie(e))throw new J("Flattened JWS must be an object");if(e.protected===void 0&&e.header===void 0)throw new J('Flattened JWS must have either of the "protected" or "header" members');if(e.protected!==void 0&&typeof e.protected!="string")throw new J("JWS Protected Header incorrect type");if(e.payload===void 0)throw new J("JWS Payload missing");if(typeof e.signature!="string")throw new J("JWS Signature missing or incorrect type");if(e.header!==void 0&&!Ie(e.header))throw new J("JWS Unprotected Header incorrect type");let r={};if(e.protected)try{const E=Le(e.protected);r=JSON.parse(Ls.decode(E))}catch{throw new J("JWS Protected Header is invalid")}if(!Nn(r,e.header))throw new J("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");const a={...r,...e.header},n=Kn(J,new Map([["b64",!0]]),t==null?void 0:t.crit,r,a);let o=!0;if(n.has("b64")&&(o=r.b64,typeof o!="boolean"))throw new J('The "b64" (base64url-encode payload) Header Parameter must be a boolean');const{alg:i}=a;if(typeof i!="string"||!i)throw new J('JWS "alg" (Algorithm) Header Parameter missing or invalid');const c=t&&Bn("algorithms",t.algorithms);if(c&&!c.has(i))throw new or('"alg" (Algorithm) Header Parameter value not allowed');if(o){if(typeof e.payload!="string")throw new J("JWS Payload must be a string")}else if(typeof e.payload!="string"&&!(e.payload instanceof Uint8Array))throw new J("JWS Payload must be a string or an Uint8Array instance");let l=!1;typeof s=="function"?(s=await s(r,e),l=!0,gt(i,s,"verify"),es(s)&&(s=await hr(s,i))):gt(i,s,"verify");const u=Rn(Ss.encode(e.protected??""),Ss.encode("."),typeof e.payload=="string"?Ss.encode(e.payload):e.payload);let d;try{d=Le(e.signature)}catch{throw new J("Failed to base64url decode the signature")}if(!await Yn(i,s,d,u))throw new lr;let _;if(o)try{_=Le(e.payload)}catch{throw new J("Failed to base64url decode the payload")}else typeof e.payload=="string"?_=Ss.encode(e.payload):_=e.payload;const f={payload:_};return e.protected!==void 0&&(f.protectedHeader=r),e.header!==void 0&&(f.unprotectedHeader=e.header),l?{...f,key:s}:f}async function Gn(e,s,t){if(e instanceof Uint8Array&&(e=Ls.decode(e)),typeof e!="string")throw new J("Compact JWS must be a string or Uint8Array");const{0:r,1:a,2:n,length:o}=e.split(".");if(o!==3)throw new J("Invalid Compact JWS");const i=await zn({payload:a,protected:r,signature:n},s,t),c={payload:i.payload,protectedHeader:i.protectedHeader};return typeof s=="function"?{...c,key:i.key}:c}const Xn=e=>Math.floor(e.getTime()/1e3),gr=60,yr=gr*60,it=yr*24,Qn=it*7,Zn=it*365.25,eo=/^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i,yt=e=>{const s=eo.exec(e);if(!s||s[4]&&s[1])throw new TypeError("Invalid time period format");const t=parseFloat(s[2]),r=s[3].toLowerCase();let a;switch(r){case"sec":case"secs":case"second":case"seconds":case"s":a=Math.round(t);break;case"minute":case"minutes":case"min":case"mins":case"m":a=Math.round(t*gr);break;case"hour":case"hours":case"hr":case"hrs":case"h":a=Math.round(t*yr);break;case"day":case"days":case"d":a=Math.round(t*it);break;case"week":case"weeks":case"w":a=Math.round(t*Qn);break;default:a=Math.round(t*Zn);break}return s[1]==="-"||s[4]==="ago"?-a:a},wt=e=>e.toLowerCase().replace(/^application\//,""),so=(e,s)=>typeof e=="string"?s.includes(e):Array.isArray(e)?s.some(Set.prototype.has.bind(new Set(e))):!1,to=(e,s,t={})=>{let r;try{r=JSON.parse(Ls.decode(s))}catch{}if(!Ie(r))throw new at("JWT Claims Set must be a top-level JSON object");const{typ:a}=t;if(a&&(typeof e.typ!="string"||wt(e.typ)!==wt(a)))throw new oe('unexpected "typ" JWT header value',r,"typ","check_failed");const{requiredClaims:n=[],issuer:o,subject:i,audience:c,maxTokenAge:l}=t,u=[...n];l!==void 0&&u.push("iat"),c!==void 0&&u.push("aud"),i!==void 0&&u.push("sub"),o!==void 0&&u.push("iss");for(const f of new Set(u.reverse()))if(!(f in r))throw new oe(`missing required "${f}" claim`,r,f,"missing");if(o&&!(Array.isArray(o)?o:[o]).includes(r.iss))throw new oe('unexpected "iss" claim value',r,"iss","check_failed");if(i&&r.sub!==i)throw new oe('unexpected "sub" claim value',r,"sub","check_failed");if(c&&!so(r.aud,typeof c=="string"?[c]:c))throw new oe('unexpected "aud" claim value',r,"aud","check_failed");let d;switch(typeof t.clockTolerance){case"string":d=yt(t.clockTolerance);break;case"number":d=t.clockTolerance;break;case"undefined":d=0;break;default:throw new TypeError("Invalid clockTolerance option type")}const{currentDate:m}=t,_=Xn(m||new Date);if((r.iat!==void 0||l)&&typeof r.iat!="number")throw new oe('"iat" claim must be a number',r,"iat","invalid");if(r.nbf!==void 0){if(typeof r.nbf!="number")throw new oe('"nbf" claim must be a number',r,"nbf","invalid");if(r.nbf>_+d)throw new oe('"nbf" claim timestamp check failed',r,"nbf","check_failed")}if(r.exp!==void 0){if(typeof r.exp!="number")throw new oe('"exp" claim must be a number',r,"exp","invalid");if(r.exp<=_-d)throw new Vs('"exp" claim timestamp check failed',r,"exp","check_failed")}if(l){const f=_-r.iat,E=typeof l=="number"?l:yt(l);if(f-d>E)throw new Vs('"iat" claim timestamp check failed (too far in the past)',r,"iat","check_failed");if(f<0-d)throw new oe('"iat" claim timestamp check failed (it should be in the past)',r,"iat","check_failed")}return r};async function ro(e,s,t){var o;const r=await Gn(e,s,t);if((o=r.protectedHeader.crit)!=null&&o.includes("b64")&&r.protectedHeader.b64===!1)throw new at("JWTs MUST NOT use unencoded payload");const n={payload:to(r.protectedHeader,r.payload,t),protectedHeader:r.protectedHeader};return typeof s=="function"?{...n,key:r.key}:n}function ao(e){switch(typeof e=="string"&&e.slice(0,2)){case"RS":case"PS":return"RSA";case"ES":return"EC";case"Ed":return"OKP";default:throw new me('Unsupported "alg" value for a JSON Web Key Set')}}function no(e){return e&&typeof e=="object"&&Array.isArray(e.keys)&&e.keys.every(oo)}function oo(e){return Ie(e)}function wr(e){return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}class io{constructor(s){if(this._cached=new WeakMap,!no(s))throw new nt("JSON Web Key Set malformed");this._jwks=wr(s)}async getKey(s,t){const{alg:r,kid:a}={...s,...t==null?void 0:t.header},n=ao(r),o=this._jwks.keys.filter(l=>{let u=n===l.kty;if(u&&typeof a=="string"&&(u=a===l.kid),u&&typeof l.alg=="string"&&(u=r===l.alg),u&&typeof l.use=="string"&&(u=l.use==="sig"),u&&Array.isArray(l.key_ops)&&(u=l.key_ops.includes("verify")),u)switch(r){case"ES256":u=l.crv==="P-256";break;case"ES256K":u=l.crv==="secp256k1";break;case"ES384":u=l.crv==="P-384";break;case"ES512":u=l.crv==="P-521";break;case"Ed25519":u=l.crv==="Ed25519";break;case"EdDSA":u=l.crv==="Ed25519"||l.crv==="Ed448";break}return u}),{0:i,length:c}=o;if(c===0)throw new ot;if(c!==1){const l=new ir,{_cached:u}=this;throw l[Symbol.asyncIterator]=async function*(){for(const d of o)try{yield await bt(u,d,r)}catch{}},l}return bt(this._cached,i,r)}}async function bt(e,s,t){const r=e.get(s)||e.set(s,{}).get(s);if(r[t]===void 0){const a=await hr({...s,ext:!0},t);if(a instanceof Uint8Array||a.type!=="public")throw new nt("JSON Web Key Set members must be public keys");r[t]=a}return r[t]}function St(e){const s=new io(e),t=async(r,a)=>s.getKey(r,a);return Object.defineProperties(t,{jwks:{value:()=>wr(s._jwks),enumerable:!0,configurable:!1,writable:!1}}),t}const co=async(e,s,t)=>{let r,a,n=!1;typeof AbortController=="function"&&(r=new AbortController,a=setTimeout(()=>{n=!0,r.abort()},s));const o=await fetch(e.href,{signal:r?r.signal:void 0,redirect:"manual",headers:t.headers}).catch(i=>{throw n?new cr:i});if(a!==void 0&&clearTimeout(a),o.status!==200)throw new X("Expected 200 OK from the JSON Web Key Set HTTP response");try{return await o.json()}catch{throw new X("Failed to parse the JSON Web Key Set HTTP response as JSON")}};function lo(){return typeof WebSocketPair<"u"||typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"||typeof EdgeRuntime<"u"&&EdgeRuntime==="vercel"}let zs;var Ts,Pt;(typeof navigator>"u"||!((Pt=(Ts=navigator.userAgent)==null?void 0:Ts.startsWith)!=null&&Pt.call(Ts,"Mozilla/5.0 ")))&&(zs="jose/v5.10.0");const Hs=Symbol();function uo(e,s){return!(typeof e!="object"||e===null||!("uat"in e)||typeof e.uat!="number"||Date.now()-e.uat>=s||!("jwks"in e)||!Ie(e.jwks)||!Array.isArray(e.jwks.keys)||!Array.prototype.every.call(e.jwks.keys,Ie))}class po{constructor(s,t){if(!(s instanceof URL))throw new TypeError("url must be an instance of URL");this._url=new URL(s.href),this._options={agent:t==null?void 0:t.agent,headers:t==null?void 0:t.headers},this._timeoutDuration=typeof(t==null?void 0:t.timeoutDuration)=="number"?t==null?void 0:t.timeoutDuration:5e3,this._cooldownDuration=typeof(t==null?void 0:t.cooldownDuration)=="number"?t==null?void 0:t.cooldownDuration:3e4,this._cacheMaxAge=typeof(t==null?void 0:t.cacheMaxAge)=="number"?t==null?void 0:t.cacheMaxAge:6e5,(t==null?void 0:t[Hs])!==void 0&&(this._cache=t==null?void 0:t[Hs],uo(t==null?void 0:t[Hs],this._cacheMaxAge)&&(this._jwksTimestamp=this._cache.uat,this._local=St(this._cache.jwks)))}coolingDown(){return typeof this._jwksTimestamp=="number"?Date.now()<this._jwksTimestamp+this._cooldownDuration:!1}fresh(){return typeof this._jwksTimestamp=="number"?Date.now()<this._jwksTimestamp+this._cacheMaxAge:!1}async getKey(s,t){(!this._local||!this.fresh())&&await this.reload();try{return await this._local(s,t)}catch(r){if(r instanceof ot&&this.coolingDown()===!1)return await this.reload(),this._local(s,t);throw r}}async reload(){this._pendingFetch&&lo()&&(this._pendingFetch=void 0);const s=new Headers(this._options.headers);zs&&!s.has("User-Agent")&&(s.set("User-Agent",zs),this._options.headers=Object.fromEntries(s.entries())),this._pendingFetch||(this._pendingFetch=co(this._url,this._timeoutDuration,this._options).then(t=>{this._local=St(t),this._cache&&(this._cache.uat=Date.now(),this._cache.jwks=t),this._jwksTimestamp=Date.now(),this._pendingFetch=void 0}).catch(t=>{throw this._pendingFetch=void 0,t})),await this._pendingFetch}}function mo(e,s){const t=new po(e,s),r=async(a,n)=>t.getKey(a,n);return Object.defineProperties(r,{coolingDown:{get:()=>t.coolingDown(),enumerable:!0,configurable:!1},fresh:{get:()=>t.fresh(),enumerable:!0,configurable:!1},reload:{value:()=>t.reload(),enumerable:!0,configurable:!1,writable:!1},reloading:{get:()=>!!t._pendingFetch,enumerable:!0,configurable:!1},jwks:{value:()=>{var a;return(a=t._local)==null?void 0:a.jwks()},enumerable:!0,configurable:!1,writable:!1}}),r}const _e=new Map;let V={hits:0,misses:0,writes:0,evictions:0};function ve(e){const s=_e.get(e);return s?s.expires<Date.now()?(_e.delete(e),V.evictions++,V.misses++,null):(V.hits++,s.data):(V.misses++,null)}function se(e,s,t){const r=Date.now()+t*1e3;if(_e.set(e,{data:s,expires:r}),V.writes++,_e.size>1e3){const a=_e.keys().next().value;a&&(_e.delete(a),V.evictions++)}}function _o(e){let s=0;for(const t of _e.keys())t.includes(e)&&(_e.delete(t),s++);return s}async function ss(e,s){const t=Array.isArray(s)?s:[s];for(const r of t){const a=_o(r);a>0&&console.log(`[Cache] 🧹 메모리 캐시 삭제: ${r} (${a}개)`);try{await e.CACHE_KV.delete(r),console.log(`[Cache] 🧹 KV 캐시 삭제: ${r}`)}catch(n){console.error(`[Cache] ❌ KV 캐시 삭제 실패: ${r}`,n)}}}const ts={LIVE_STREAMS:["streams:live","streams:all","streams:scheduled","live_streams:live:all:20:0","live_streams:"],PRODUCTS:["products:","featured_products"],CART:e=>[`cart:${e}`],ORDERS:e=>[`orders:${e}`],ALL:["streams:","live_streams:","products:","cart:","orders:"]};function fo(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function ho(e){return{name:"tosspayments",async confirmPayment(s){try{const t=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),r=await t.json();if(!t.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message||"결제 승인 실패",rawData:r};let a={};r.card&&(a={cardCompany:r.card.company,cardNumber:r.card.number,installmentMonths:r.card.installmentPlanMonths||0});let n={};return r.virtualAccount&&(n={virtualAccountBank:r.virtualAccount.bankCode,virtualAccountNumber:r.virtualAccount.accountNumber,virtualAccountHolder:r.virtualAccount.customerName,virtualAccountDueDate:r.virtualAccount.dueDate}),{success:!0,orderId:r.orderId,paymentKey:r.paymentKey,method:r.method,totalAmount:r.totalAmount,status:r.status,approvedAt:r.approvedAt,transactionId:r.transactionKey,...a,...n,rawData:r}}catch(t){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message,rawData:null}}},async cancelPayment(s){try{const t={cancelReason:s.cancelReason};s.cancelAmount&&(t.cancelAmount=s.cancelAmount);const r=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(t)}),a=await r.json();return r.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(t){return{success:!1,error:t.message}}},async getPayment(s){try{const t=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),r=await t.json();if(!t.ok)throw new Error(r.message);return{success:!0,orderId:r.orderId,paymentKey:r.paymentKey,method:r.method,totalAmount:r.totalAmount,status:r.status,approvedAt:r.approvedAt,rawData:r}}catch(t){throw t}}}}function Eo(e,s){switch(e.toLowerCase()){case"tosspayments":return ho(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const p=new er;p.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{Ea(e.env),ga(e.env)}catch(r){console.error("[ENV] Validation failed:",r)}await s()});async function go(e){try{const s=e.req.header("Authorization"),t=(s==null?void 0:s.replace("Bearer ",""))||"";if(!t)return console.warn("[Firebase Auth] No token provided"),null;try{const{verifyFirebaseIdToken:r}=await Promise.resolve().then(()=>Uo),a=await r(t,e.env.FIREBASE_PROJECT_ID||"urteam-live-commerce-5b284");console.log("[Firebase Auth] ✅ Firebase token verified:",a.uid);const n=await e.env.DB.prepare(`
    ...
    `).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:r.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/auth/kakao/sync/callback",async e=>{var t,r,a,n,o,i,c,l,u,d,m,_,f;const{DB:s}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!s);const E=e.req.query("code"),b=e.req.query("state")||"/",w=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!E,state:b,error:w}),w)return console.error("[Kakao Sync] OAuth error:",w),e.redirect(`${b}?error=kakao_oauth_${w}`);if(!E)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${b}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const g=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",T=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",g.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",T),console.log("[Kakao Sync] Step 1: Fetching access token...");const y=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:g,redirect_uri:T,code:E})});if(console.log("[Kakao Sync] Token response status:",y.status),console.log("[Kakao Sync] Token request details:",{client_id:g,redirect_uri:T,code_length:E.length,code_prefix:E.substring(0,20)}),!y.ok){const q=await y.text();return console.error("[Kakao Sync] Token request failed:",q),e.redirect(`${b}?error=token_request_failed&detail=${encodeURIComponent(q)}`)}const R=await y.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!R.access_token,error:R.error,errorDescription:R.error_description}),!R.access_token)return console.error("[Kakao Sync] Token error:",R),e.redirect(`${b}?error=token_failed&detail=${encodeURIComponent(R.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const $=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${R.access_token}`}});console.log("[Kakao Sync] User response status:",$.status);const k=await $.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!k.id,id:k.id,hasNickname:!!((t=k.properties)!=null&&t.nickname||(a=(r=k.kakao_account)==null?void 0:r.profile)!=null&&a.nickname)}),!k.id)return console.error("[Kakao Sync] Failed to get user info:",k),e.redirect(`${b}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const O=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${R.access_token}`}});console.log("[Kakao Sync] Terms response status:",O.status);let W=null;if(O.ok?(W=await O.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=W.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=W.allowed_service_terms)==null?void 0:o.map(q=>q.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!s)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${b}?error=db_not_available`);const P=k.id.toString(),L=((i=k.properties)==null?void 0:i.nickname)||((l=(c=k.kakao_account)==null?void 0:c.profile)==null?void 0:l.nickname)||"Kakao User",F=((u=k.kakao_account)==null?void 0:u.email)||"",Q=((d=k.properties)==null?void 0:d.profile_image)||((_=(m=k.kakao_account)==null?void 0:m.profile)==null?void 0:_.profile_image_url)||"",Y=R.access_token,v=((f=W==null?void 0:W.allowed_service_terms)==null?void 0:f.map(q=>q.tag))||[],te=JSON.stringify(v);console.log("[Kakao Sync] User data:",{kakaoId:P,nickname:L,email:F?"exists":"none",serviceTerms:v});try{const q=await s.prepare(`
      ...
      `).bind(P).first();console.log("[Kakao Sync] Existing user check:",!!q);let U;q?(U=q.id,await s.prepare(`
        ...
        `).bind(P,L,F||null,Q||null).run()).meta.last_row_id,console.log("[Kakao Sync] Created user:",U)),console.log("[Kakao Sync] User saved successfully, userId:",U),console.log("[Kakao Sync] Step 4: Generating Firebase Custom Token...");const z=gs(e.env),de=`kakao_${P}`,ws=await z.createCustomToken(de,{role:"user",userId:U,email:F||void 0,kakaoId:P});try{await s.prepare(`
          UPDATE users SET firebase_uid = ? WHERE id = ?
        `).bind(de,U).run()}catch(Ms){console.warn("[Kakao Sync] firebase_uid column not found, skipping update:",Ms)}console.log("[Kakao Sync] ✅ Firebase Custom Token 발급 완료 for user:",U),console.log("[Kakao Sync] Step 5: Redirecting with Firebase Custom Token...");const as=b.includes("?")?`${b}&firebase_token=${encodeURIComponent(ws)}&userName=${encodeURIComponent(L)}`:`${b}?firebase_token=${encodeURIComponent(ws)}&userName=${encodeURIComponent(L)}`;return console.log("[Kakao Sync] Redirect URL (Firebase):",as.substring(0,100)+"..."),e.redirect(as)}catch(q){return console.error("[Kakao Sync] Database error:",q),console.error("[Kakao Sync] DB error details:",{message:q.message,name:q.name}),e.redirect(`${b}?error=database_error&detail=${encodeURIComponent(q.message)}`)}}catch(E){console.error("[Kakao Sync] Exception:",E),console.error("[Kakao Sync] Error details:",{message:E.message,stack:E.stack,name:E.name});const b=e.req.query("state")||"/",w=encodeURIComponent(E.message||"unknown");return e.redirect(`${b}?error=kakao_sync_failed&detail=${w}`)}});p.post("/api/auth/kakao/callback",S(),async e=>{const{DB:s}=e.env;try{const{code:t,redirect_uri:r}=await e.req.json();if(!t)return e.json({success:!1,error:"Authorization code is required"},400);if(!e.env.KAKAO_REST_API_KEY)return console.error("[Kakao Callback] KAKAO_REST_API_KEY not configured"),e.json({success:!1,error:"Server configuration error",code:"MISSING_API_KEY"},500);const a=r||"https://live.ur-team.com/auth/kakao/callback";console.log("[Kakao Callback] Starting OAuth flow with Firebase Custom Token");const n=await Ca(t,a,e.env.KAKAO_REST_API_KEY),{user:o}=await tr(s,n),i=gs(e.env),c=`kakao_${o.kakao_id}`,l=await i.createCustomToken(c,{userId:o.id,userType:"user",email:o.email||void 0,kakaoId:o.kakao_id});console.log("[Kakao Callback] ✅ Firebase Custom Token 발급 완료 for user:",o.id);try{await s.prepare(`
        UPDATE users SET firebase_uid = ? WHERE id = ?
      `).bind(c,o.id).run()}catch(u){console.warn("[Kakao Callback] firebase_uid column not found, skipping update:",u)}return e.json({success:!0,data:{customToken:l,user:{id:o.id,name:o.name,email:o.email,profile_image:o.profile_image,firebaseUID:c}}})}catch(t){return console.error("[Kakao Callback] Error:",t),t instanceof ae?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t.message||"Internal server error",code:"UNKNOWN_ERROR"},500)}});p.post("/api/auth/kakao/firebase",S(),async e=>{const{DB:s}=e.env;try{const{accessToken:t}=await e.req.json();if(!t)return e.json({success:!1,error:"Access token is required"},400);console.log("[Kakao Firebase] Processing Kakao OAuth login");const r=Date.now(),{user:a}=await tr(s,t);console.log("[Kakao Firebase] ProcessKakaoLogin completed in",Date.now()-r,"ms");const n=await generateFirebaseCustomToken(a.id.toString(),{role:"user",email:a.email,name:a.name});return console.log("[Kakao Firebase] ✅ Firebase Custom Token 생성 완료 for user:",a.id),console.log("[Kakao Firebase] Total login time:",Date.now()-r,"ms"),e.json({success:!0,customToken:n,user:{id:a.id,name:a.name,email:a.email,profile_image:a.profile_image}})}catch(t){return console.error("[Kakao Firebase] Error:",t),t instanceof ae?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t instanceof Error?t.message:"Login failed",code:"UNKNOWN_ERROR"},500)}});let Ks=null;function ko(e){if(e!=null&&e.FIREBASE_PROJECT_ID)return e.FIREBASE_PROJECT_ID;const s="urteam-live-commerce-5b284";return console.warn("[Firebase] ⚠️ FIREBASE_PROJECT_ID 환경 변수 없음, 폴백 사용:",s),s}async function Co(e,s){var r;const t=ko(s);try{Ks||(Ks=mo(new URL("https://www.googleapis.com/service_accounts/v1/jwk/securetoken@system.gserviceaccount.com")),console.log("[Firebase] ✅ JWK Set initialized for project:",t));const{payload:a}=await ro(e,Ks,{issuer:`https://securetoken.google.com/${t}`,audience:t});return console.log("[Firebase] ✅ Token verified:",{sub:a.sub,email:a.email,iss:a.iss,aud:a.aud,exp:a.exp}),a}catch(a){return console.error("[Firebase] ❌ Token verification failed:",{error:a.message,code:a.code,claim:a.claim,reason:a.reason,expectedProjectId:t}),a.code==="ERR_JWT_EXPIRED"?console.error("[Firebase] Token expired. User needs to re-authenticate."):a.code==="ERR_JWT_CLAIM_VALIDATION_FAILED"?(console.error("[Firebase] Claim validation failed:",a.claim),a.claim==="aud"&&(console.error("[Firebase] ⚠️ Audience mismatch! Check FIREBASE_PROJECT_ID"),console.error("[Firebase] Expected:",t),console.error("[Firebase] Got:",(r=a.payload)==null?void 0:r.aud))):a.code==="ERR_JWS_SIGNATURE_VERIFICATION_FAILED"&&console.error("[Firebase] Invalid signature. Token may be tampered."),null}}p.post("/api/auth/firebase/sync",S(),async e=>{var r,a;const{DB:s,CACHE_KV:t}=e.env;try{const{idToken:n,firebaseUid:o,email:i,displayName:c}=await e.req.json();if(!n||!o)return e.json({success:!1,error:"idToken and firebaseUid are required"},400);const l=`sync_limit:${o}`,u=await t.get(l);if(u){const _=Date.now()-parseInt(u);if(_<6e4)return console.log(`[Firebase Sync] ⏳ Rate limited (${Math.floor((6e4-_)/1e3)}s remaining):`,o),e.json({success:!1,error:"Rate limited",retryAfter:Math.ceil((6e4-_)/1e3)},429)}console.log("[Firebase Sync] Syncing user to D1:",{firebaseUid:o,email:i});const d=await Co(n,e.env);if(console.log("[Firebase Sync] Token decoded:",{hasDecoded:!!d,decodedSub:d==null?void 0:d.sub,firebaseUid:o,match:(d==null?void 0:d.sub)===o}),!d||d.sub!==o)return console.error("[Firebase Sync] ❌ Token validation failed:",{decoded:!!d,expectedUid:o,actualSub:d==null?void 0:d.sub,projectId:((r=e.env)==null?void 0:r.FIREBASE_PROJECT_ID)||"NOT_SET"}),e.json({success:!1,error:"Invalid Firebase token",details:{expectedUid:o,actualSub:(d==null?void 0:d.sub)||null,projectId:((a=e.env)==null?void 0:a.FIREBASE_PROJECT_ID)||"NOT_SET"}},401);console.log("[Firebase Sync] ✅ Token verified successfully");const m=await s.prepare("SELECT id, email, name FROM users WHERE firebase_uid = ?").bind(o).first();if(m)return await s.prepare(`
        UPDATE users 
        SET email = ?, name = ?, updated_at = CURRENT_TIMESTAMP
        WHERE firebase_uid = ?
      `).bind(i||m.email,c||m.name,o).run(),await t.put(l,Date.now().toString(),{expirationTtl:60}),console.log("[Firebase Sync] ✅ 기존 사용자 업데이트 완료:",m.id),e.json({success:!0,user:{id:m.id,email:i||m.email,name:c||m.name}});if(i){const _=await s.prepare("SELECT id, email, name FROM users WHERE email = ?").bind(i).first();if(_)return await s.prepare(`
            UPDATE users 
            SET firebase_uid = ?, name = ?, updated_at = CURRENT_TIMESTAMP
            WHERE email = ?
          `).bind(o,c||_.name,i).run(),await t.put(l,Date.now().toString(),{expirationTtl:60}),console.log("[Firebase Sync] ✅ 기존 이메일 사용자에 firebase_uid 연결:",_.id),e.json({success:!0,user:{id:_.id,email:_.email,name:c||_.name}})}return e.json({success:!1,error:"User not found. Please register first."},404)}catch(n){return console.error("[Firebase Sync] Error:",n),e.json({success:!1,error:n instanceof Error?n.message:"Sync failed"},500)}});p.post("/api/auth/firebase/register",S(),async e=>{const{DB:s}=e.env;try{const{idToken:t,firebaseUid:r,email:a,name:n,userType:o}=await e.req.json();if(!t||!r||!a||!n)return e.json({success:!1,error:"idToken, firebaseUid, email, and name are required"},400);console.log("[Firebase Register] Registering new user:",{firebaseUid:r,email:a,userType:o});const i=await verifyFirebaseToken(t,e.env);if(!i||i.uid!==r)return e.json({success:!1,error:"Invalid Firebase token"},401);const c=await s.prepare(`
  ...
  `).bind(s).first();if(!t)return null;const r=await e.prepare("SELECT id, product_id, option_type, option_value, price_adjustment, stock, created_at FROM product_options WHERE product_id = ?").bind(s).all();return{product:t,options:r.results}}p.get("/api/products/:id/stock",st(tt.microCache),async e=>{const{DB:s}=e.env,t=e.req.param("id");try{const r=await s.prepare("SELECT id, name, stock FROM products WHERE id = ? AND is_active = 1").bind(t).first();return r?e.json({success:!0,data:{productId:r.id,productName:r.name,stock:r.stock,available:r.stock>0}}):e.json({success:!1,error:"Product not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/streams/:streamId/products",async e=>{const{DB:s}=e.env,t=e.req.param("streamId");try{const r=await s.prepare(`
    ...
    `).bind(t).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await s.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,t).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.post("/api/orders",j,async e=>{const{DB:s}=e.env;try{const t=await e.req.json(),{userId:r,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:l,recipientPhone:u,deliveryMemo:d,totalAmount:m,shippingFee:_,orderNumber:f,paymentKey:E,paymentMethod:b}=t;if(o&&o.length>0){const O=o.map(M=>M.productId),W=O.map(()=>"?").join(","),P=await s.prepare(`
      ...
      `).bind(de,r||null,m||0,"pending","pending",ws||null,l||null,u||null,d||null,E||null,as).run()).meta.last_row_id;for(const M of F)await s.prepare(`
    ...
    `).bind(y,r,T,n.address,n.name,n.phone).run()).meta.last_row_id,k=[];for(const O of g.results){let W=!1,P="";for(let L=0;L<3;L++){const F=await s.prepare(`
          SELECT stock, version FROM products WHERE id = ?
        `).bind(O.product_id).first();if(!F){P=`상품을 찾을 수 없습니다: ${O.product_name}`;break}const Q=F.stock,Y=F.version;if(Q<O.quantity){P=`재고 부족: ${O.product_name} (남은 재고: ${Q}개)`;break}if((await s.prepare(`
          UPDATE products 
          SET stock = stock - ?, 
              version = version + 1,
              updated_at = datetime('now')
          WHERE id = ? 
            ...
            AND stock >= ?
            AND is_active = 1
        `).bind(O.quantity,O.product_id,Y,O.quantity).run()).meta.changes>0){W=!0,console.log(`[재고] ✅ 재고 차감 성공: ${O.product_name} (수량: ${O.quantity}, 버전: ${Y} → ${Y+1})`);break}console.warn(`[재고] ⚠️ 버전 충돌 감지 (시도 ${L+1}/3): ${O.product_name}`),L<2?await new Promise(te=>setTimeout(te,50*(L+1))):P="주문 처리 중 오류 발생. 잠시 후 다시 시도해주세요. (동시 주문 처리 중)"}if(!W)return e.json({success:!1,error:P||"주문 처리 중 오류가 발생했습니다."},P.includes("재고 부족")?400:409);k.push(s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind($,O.product_id,O.option_id,O.quantity,O.price_snapshot,O.product_name))}k.push(s.prepare(`DELETE FROM cart_items WHERE id IN (${w})`).bind(...a)),await s.batch(k);try{const O=g.results.map(L=>L.product_id),W=O.map(()=>"?").join(","),P=await s.prepare(`
        SELECT DISTINCT seller_id 
        FROM products 
        WHERE id IN (${W}) AND seller_id IS NOT NULL
      `).bind(...O).all();for(const L of P.results){const F=L.seller_id;await To(s,F,y,buyerName||shippingName||"고객",T)}}catch(O){console.error("[Order] Notification error:",O)}return e.json({success:!0,data:{orderId:$,orderNumber:y,totalAmount:T}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/current-product",async e=>{const{DB:s,LIVE_CACHE:t}=e.env,r=e.req.param("streamId");try{const a=`current-product:${r}`,n=await rr(t,a,3);if(n)return e.json({success:!0,data:n});const o=await s.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(r).first();if(!o||!o.current_product_id)return await Os(t,a,null,3),e.json({success:!0,data:null});const i=await s.prepare(`
      SELECT id, name, description, price, original_price, discount_rate,
             image_url, stock, category, seller_id, is_active
      FROM products 
      WHERE id = ?
    `).bind(o.current_product_id).first(),c=await s.prepare("SELECT id, product_id, option_type, option_value, price_adjustment, stock, created_at FROM product_options WHERE product_id = ?").bind(o.current_product_id).all(),l={product:i,options:c.results};return await Os(t,a,l,3),e.json({success:!0,data:l})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/streams/:streamId/product-wait",async e=>{const{LIVE_CACHE:s}=e.env,t=e.req.param("streamId"),r=e.req.query("lastTimestamp")||"0";try{const a=`product-timestamp:${t}`,n=`current-product:${t}`,o=25e3,i=Date.now();for(;Date.now()-i<o;){const c=await s.get(a)||"0";if(c!==r){const l=await rr(s,n,30);return e.json({success:!0,timestamp:c,data:l,changed:!0})}await new Promise(l=>setTimeout(l,1e3))}return e.json({success:!0,timestamp:r,data:null,changed:!1})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/dashboard/stats",async e=>{const{DB:s}=e.env,t=await C(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const r=t.sellerId,a=e.req.query("period")||"7d";let n=7;a==="30d"?n=30:a==="90d"&&(n=90);const o=await s.prepare(`
      SELECT 
  ...
  `).bind(r==null?void 0:r.bank,r==null?void 0:r.accountNumber,r==null?void 0:r.customerName,r==null?void 0:r.dueDate,JSON.stringify(s),t).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",t)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:s}=e.env;try{const t=e.req.param("paymentKey"),r=await e.req.json(),{cancelReason:a,cancelAmount:n}=r;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:t,cancelReason:a,cancelAmount:n}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const o=await s.prepare(`
      ...
      FROM payments 
      WHERE pg_payment_key = ?
    `).bind(t).first();if(!o)return e.json({success:!1,error:"결제 정보를 찾을 수 없습니다."},404);if(o.status==="CANCELED"||o.status==="cancelled")return e.json({success:!1,error:"이미 취소된 결제입니다."},400);const i=o.pg_provider||"tosspayments",c=e.env.TOSS_SECRET_KEY;if(!c)return e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);const l=Eo(i,c),u=n&&n<o.amount,d=n||o.amount;console.log("[Payment] PG 결제 취소 요청 중...",{pgProvider:i,paymentKey:t,cancelAmount:d,isPartial:u});const m=await l.cancelPayment({paymentKey:t,cancelReason:a,cancelAmount:d});return m.success?(console.log("[Payment] ✅ PG 결제 취소 완료:",{paymentKey:t,cancelAmount:d,canceledAt:m.canceledAt}),await s.prepare(`
      UPDATE payments 
      SET status = ?,
          cancelled_at = ?,
          pg_raw_data = ?,
...
`),_=new Date,f=`orders_${_.toISOString().split("T")[0]}_${_.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(r){return console.error("Export error:",r),e.json({success:!1,error:r.message},500)}});p.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,t=await C(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const r=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(r).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,t.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,r).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${r}, 자동 발행 시작...`);const c=await s.prepare(`
    ...
    `).bind(a,n,r).run();try{const c=await s.prepare("SELECT user_id FROM orders WHERE order_number = ?").bind(r).first();c&&c.user_id&&await br(s,c.user_id,r,"shipping",a,n)}catch(c){console.error("[Tracking] Notification error:",c)}return e.json({success:!0,message:"Tracking information updated"})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/admin/orders",async e=>{const{DB:s}=e.env,t=await x(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const r=await s.prepare(`
      ...
      LEFT JOIN users u ON o.user_id = u.id
      ORDER BY o.created_at DESC
    `).all();return e.json({success:!0,data:r.results})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/sellers",async e=>{const{DB:s}=e.env,{limit:t="20",offset:r="0"}=e.req.query();try{const a=`sellers:list:${t}:${r}`,n=ve(a);if(n)return e.executionCtx.waitUntil((async()=>{try{const i=await Ot(s,parseInt(t),parseInt(r));se(a,i,3600)}catch(i){console.error("[Cache Revalidate] Sellers error:",i)}})()),e.json({success:!0,data:n,cached:!0});const o=await Ot(s,parseInt(t),parseInt(r));return se(a,o,3600),e.json({success:!0,data:o,cached:!1})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});async function Ot(e,s,t){const r=`
...
`});const _="\uFEFF";return new Response(_+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(r){return console.error("CSV 내보내기 실패:",r),e.json({success:!1,error:r.message},500)}});p.post("/api/orders/create",j,async e=>{const{DB:s}=e.env;try{const{userId:t,cartItems:r,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:l,buyerCeoName:u}=await e.req.json();console.log("[DEPRECATED /api/orders/create] 주문 생성 요청:",{userId:t,cartItems:r==null?void 0:r.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const v=await s.prepare(`
    ...
    `).bind(...k).all(),P=new Map(W.results.map(v=>[v.id,v.stock]));for(const v of r){const te=P.get(v.product_id);if(te===void 0)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${v.product_id})`},400);if(te<v.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${v.product_id})`},400)}const F=(await s.prepare(`
      INSERT INTO orders (
    ...
    `).bind($,E,a,"pending",o||null,d,m,_,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,l||null,u||null).run()).meta.last_row_id,Q=r.map(v=>s.prepare(`
      ...
      `).bind(...te).all();await Promise.all(U.results.map(z=>v.updateProductStock(z.id,z.stock,{name:z.name,price:z.price,original_price:z.original_price,discount_rate:z.discount_rate,image_url:z.image_url}))),console.log(`🔥 Firebase: Stock updated for ${U.results.length} products`)}catch(v){console.error("⚠️ Firebase stock sync failed (non-blocking):",v)}try{const v=r.map(U=>U.product_id),te=v.map(()=>"?").join(","),q=await s.prepare(`
        ...
        FROM products 
        WHERE id IN (${te})
      `).bind(...v).all();for(const U of q.results){const z=U.stock_alert_threshold||5,de=U.stock;de<=z&&U.seller_id&&(await Sr(s,U.seller_id,U.name,de,z),console.log(`[Low Stock Alert] ${U.name}: ${de} <= ${z}`))}}catch(v){console.error("[Low Stock Alert] Error:",v)}return console.log("주문 생성 완료:",{orderId:F,orderNumber:$}),e.json({success:!0,orderId:F,orderNumber:$,totalAmount:a})}catch(t){return console.error("주문 생성 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/:orderNumber/refund",S(),j,async e=>{const{DB:s}=e.env;try{const t=e.req.param("orderNumber"),{reason:r}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:t,reason:r});const a=await s.prepare(`
...
`}return new Response(u,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,t=await C(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{order_number:r}=await e.req.json();if(!r)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(t.sellerId).first();if(!n)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const o=await s.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),c=Math.floor(i/1.1),l=i-c,u=new Date().toISOString().split("T")[0],d=`${u}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,m=va(n,a,o.results);let _,f,E;try{_=await Ia(m),f=_.ntsConfirmNumber,E=_.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:f,invoiceKey:E,mockMode:cs()})}catch(g){console.error("바로빌 API 호출 실패:",g),f="FAILED",E=null}const w=(await s.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(r,a,n||null,o||null,i!==!1?1:0,c||0,l||null,u||null).run();return e.json({success:!0,id:d.meta.last_row_id})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/admin/banners/:id",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const r=e.req.param("id"),{title:a,image_url:n,link_url:o,description:i,is_active:c,display_order:l,start_date:u,end_date:d}=await e.req.json();return await s.prepare(`
      ...
      SET title = ?, image_url = ?, link_url = ?, description = ?,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(a,n,o||null,i||null,c?1:0,l||0,u||null,d||null,r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/admin/banners/:id",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const r=e.req.param("id");return await s.prepare("DELETE FROM banners WHERE id = ?").bind(r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/order-complete",e=>e.redirect("/order-complete.html",302));p.notFound(e=>{const s=e.req.path;return s.startsWith("/api/")?e.json({success:!1,error:"Not found",message:`The requested endpoint ${s} was not found.`},404):new Response(null,{status:404})});p.onError((e,s)=>{const t=s.req.path;if(e instanceof wn)return console.error("[AppError]",{path:t,method:s.req.method,code:e.code,message:e.message,statusCode:e.statusCode}),s.json({success:!1,error:{code:e.code,message:e.message,...e.details&&{details:e.details}}},e.statusCode);if(console.error("[Global Error Handler]",{path:t,method:s.req.method,error:e.message,stack:e.stack}),t.startsWith("/api/")){let r=500,a="Internal Server Error";return e.message.includes("Unauthorized")||e.message.includes("로그인")?(r=401,a="인증이 필요합니다. 로그인해주세요."):e.message.includes("Forbidden")||e.message.includes("권한")?(r=403,a="접근 권한이 없습니다."):e.message.includes("Not found")||e.message.includes("찾을 수 없")?(r=404,a="요청하신 리소스를 찾을 수 없습니다."):(e.message.includes("Bad request")||e.message.includes("잘못된"))&&(r=400,a="잘못된 요청입니다."),s.json({success:!1,error:e.message||a},r)}return s.html(`
    <!DOCTYPE html>
    <html lang="ko">
    <head>
      <meta charset="UTF-8">
  ...
  `,500)});p.get("/api/admin/alimtalk/pricing",S(),async e=>{const{env:s}=e;try{const t=await s.DB.prepare(`
    ...
    `).bind(a,c.id).first();if(!l)return e.json({success:!1,error:"Template not found or not approved"},404);const u=Ba(l.template_content,o||{}),d=ar(n),m=await Zs(s,{senderKey:c.sender_key,templateCode:l.template_code,to:d,message:u});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(c.id,a,i||null,d,u,15,m.messageId).run();return await s.DB.prepare(`
      ...
      SET balance = balance - 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(c.id).run(),e.json({success:!0,message_id:_.meta.last_row_id,aligo_message_id:m.messageId,status:"sent",remaining_balance:c.balance-1})}catch(t){return console.error("[Seller Alimtalk Send] Error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/alimtalk/messages",S(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Pe(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{page:a="1",limit:n="20",status:o}=e.req.query(),i=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
