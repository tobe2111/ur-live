var Ys=Object.defineProperty;var is=e=>{throw TypeError(e)};var Vs=(e,t,r)=>t in e?Ys(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;var S=(e,t,r)=>Vs(e,typeof t!="symbol"?t+"":t,r),Xe=(e,t,r)=>t.has(e)||is("Cannot "+r);var m=(e,t,r)=>(Xe(e,t,"read from private field"),r?r.call(e):t.get(e)),I=(e,t,r)=>t.has(e)?is("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,r),T=(e,t,r,s)=>(Xe(e,t,"write to private field"),s?s.call(e,r):t.set(e,r),r),O=(e,t,r)=>(Xe(e,t,"access private method"),r);var cs=(e,t,r,s)=>({set _(a){T(e,t,a,r)},get _(){return m(e,t,s)}});var us=(e,t,r)=>(s,a)=>{let o=-1;return n(0);async function n(i){if(i<=o)throw new Error("next() called multiple times");o=i;let c,u=!1,l;if(e[i]?(l=e[i][0][0],s.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{c=await l(s,()=>n(i+1))}catch(d){if(d instanceof Error&&t)s.error=d,c=await t(d,s),u=!0;else throw d}else s.finalized===!1&&r&&(c=await r(s));return c&&(s.finalized===!1||u)&&(s.res=c),s}},Js=Symbol(),zs=async(e,t=Object.create(null))=>{const{all:r=!1,dot:s=!1}=t,o=(e instanceof Rs?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?Gs(e,{all:r,dot:s}):{}};async function Gs(e,t){const r=await e.formData();return r?Xs(r,t):{}}function Xs(e,t){const r=Object.create(null);return e.forEach((s,a)=>{t.all||a.endsWith("[]")?Qs(r,a,s):r[a]=s}),t.dot&&Object.entries(r).forEach(([s,a])=>{s.includes(".")&&(Zs(r,s,a),delete r[s])}),r}var Qs=(e,t,r)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(r):e[t]=[e[t],r]:t.endsWith("[]")?e[t]=[r]:e[t]=r},Zs=(e,t,r)=>{let s=e;const a=t.split(".");a.forEach((o,n)=>{n===a.length-1?s[o]=r:((!s[o]||typeof s[o]!="object"||Array.isArray(s[o])||s[o]instanceof File)&&(s[o]=Object.create(null)),s=s[o])})},gs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},er=e=>{const{groups:t,path:r}=sr(e),s=gs(r);return rr(s,t)},sr=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(r,s)=>{const a=`@${s}`;return t.push([a,r]),a}),{groups:t,path:e}},rr=(e,t)=>{for(let r=t.length-1;r>=0;r--){const[s]=t[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(s)){e[a]=e[a].replace(s,t[r][1]);break}}return e},We={},tr=(e,t)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const s=`${e}#${t}`;return We[s]||(r[2]?We[s]=t&&t[0]!==":"&&t[0]!=="*"?[s,r[1],new RegExp(`^${r[2]}(?=/${t})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:We[s]=[e,r[1],!0]),We[s]}return null},rs=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return t(r)}catch{return r}})}},ar=e=>rs(e,decodeURI),bs=e=>{const t=e.url,r=t.indexOf("/",t.indexOf(":")+4);let s=r;for(;s<t.length;s++){const a=t.charCodeAt(s);if(a===37){const o=t.indexOf("?",s),n=t.slice(r,o===-1?void 0:o);return ar(n.includes("%25")?n.replace(/%25/g,"%2525"):n)}else if(a===63)break}return t.slice(r,s)},or=e=>{const t=bs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},ge=(e,t,...r)=>(r.length&&(t=ge(t,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ws=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),r=[];let s="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))s+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&s===""?r.push("/"):r.push(s);const o=a.replace("?","");s+="/"+o,r.push(s)}else s+="/"+a}),r.filter((a,o,n)=>n.indexOf(a)===o)},Qe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?rs(e,Ss):e):e,Ts=(e,t,r)=>{let s;if(!r&&t&&!/[%+]/.test(t)){let n=e.indexOf("?",8);if(n===-1)return;for(e.startsWith(t,n+1)||(n=e.indexOf(`&${t}`,n+1));n!==-1;){const i=e.charCodeAt(n+t.length+1);if(i===61){const c=n+t.length+2,u=e.indexOf("&",c);return Qe(e.slice(c,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";n=e.indexOf(`&${t}`,n+1)}if(s=/[%+]/.test(e),!s)return}const a={};s??(s=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const n=e.indexOf("&",o+1);let i=e.indexOf("=",o);i>n&&n!==-1&&(i=-1);let c=e.slice(o+1,i===-1?n===-1?void 0:n:i);if(s&&(c=Qe(c)),o=n,c==="")continue;let u;i===-1?u="":(u=e.slice(i+1,n===-1?void 0:n),s&&(u=Qe(u))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(u)):a[c]??(a[c]=u)}return t?a[t]:a},nr=Ts,ir=(e,t)=>Ts(e,t,!0),Ss=decodeURIComponent,ls=e=>rs(e,Ss),Te,B,re,Is,vs,ss,te,ms,Rs=(ms=class{constructor(e,t="/",r=[[]]){I(this,re);S(this,"raw");I(this,Te);I(this,B);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});I(this,te,e=>{const{bodyCache:t,raw:r}=this,s=t[e];if(s)return s;const a=Object.keys(t)[0];return a?t[a].then(o=>(a==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=r[e]()});this.raw=e,this.path=t,T(this,B,r),T(this,Te,{})}param(e){return e?O(this,re,Is).call(this,e):O(this,re,vs).call(this)}query(e){return nr(this.url,e)}queries(e){return ir(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((r,s)=>{t[s]=r}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await zs(this,e))}json(){return m(this,te).call(this,"text").then(e=>JSON.parse(e))}text(){return m(this,te).call(this,"text")}arrayBuffer(){return m(this,te).call(this,"arrayBuffer")}blob(){return m(this,te).call(this,"blob")}formData(){return m(this,te).call(this,"formData")}addValidatedData(e,t){m(this,Te)[e]=t}valid(e){return m(this,Te)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Js](){return m(this,B)}get matchedRoutes(){return m(this,B)[0].map(([[,e]])=>e)}get routePath(){return m(this,B)[0].map(([[,e]])=>e)[this.routeIndex].path}},Te=new WeakMap,B=new WeakMap,re=new WeakSet,Is=function(e){const t=m(this,B)[0][this.routeIndex][1][e],r=O(this,re,ss).call(this,t);return r&&/\%/.test(r)?ls(r):r},vs=function(){const e={},t=Object.keys(m(this,B)[0][this.routeIndex][1]);for(const r of t){const s=O(this,re,ss).call(this,m(this,B)[0][this.routeIndex][1][r]);s!==void 0&&(e[r]=/\%/.test(s)?ls(s):s)}return e},ss=function(e){return m(this,B)[1]?m(this,B)[1][e]:e},te=new WeakMap,ms),cr={Stringify:1},Os=async(e,t,r,s,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(a?a[0]+=e:a=[e],Promise.all(o.map(i=>i({phase:t,buffer:a,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Os(c,t,!1,s,a))).then(()=>a[0]))):Promise.resolve(e)},ur="text/plain; charset=UTF-8",Ze=(e,t)=>({"Content-Type":e,...t}),Le,Me,Q,Se,Z,q,Pe,Re,Ie,pe,Ue,xe,ae,be,_s,lr=(_s=class{constructor(e,t){I(this,ae);I(this,Le);I(this,Me);S(this,"env",{});I(this,Q);S(this,"finalized",!1);S(this,"error");I(this,Se);I(this,Z);I(this,q);I(this,Pe);I(this,Re);I(this,Ie);I(this,pe);I(this,Ue);I(this,xe);S(this,"render",(...e)=>(m(this,Re)??T(this,Re,t=>this.html(t)),m(this,Re).call(this,...e)));S(this,"setLayout",e=>T(this,Pe,e));S(this,"getLayout",()=>m(this,Pe));S(this,"setRenderer",e=>{T(this,Re,e)});S(this,"header",(e,t,r)=>{this.finalized&&T(this,q,new Response(m(this,q).body,m(this,q)));const s=m(this,q)?m(this,q).headers:m(this,pe)??T(this,pe,new Headers);t===void 0?s.delete(e):r!=null&&r.append?s.append(e,t):s.set(e,t)});S(this,"status",e=>{T(this,Se,e)});S(this,"set",(e,t)=>{m(this,Q)??T(this,Q,new Map),m(this,Q).set(e,t)});S(this,"get",e=>m(this,Q)?m(this,Q).get(e):void 0);S(this,"newResponse",(...e)=>O(this,ae,be).call(this,...e));S(this,"body",(e,t,r)=>O(this,ae,be).call(this,e,t,r));S(this,"text",(e,t,r)=>!m(this,pe)&&!m(this,Se)&&!t&&!r&&!this.finalized?new Response(e):O(this,ae,be).call(this,e,t,Ze(ur,r)));S(this,"json",(e,t,r)=>O(this,ae,be).call(this,JSON.stringify(e),t,Ze("application/json",r)));S(this,"html",(e,t,r)=>{const s=a=>O(this,ae,be).call(this,a,t,Ze("text/html; charset=UTF-8",r));return typeof e=="object"?Os(e,cr.Stringify,!1,{}).then(s):s(e)});S(this,"redirect",(e,t)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,t??302)});S(this,"notFound",()=>(m(this,Ie)??T(this,Ie,()=>new Response),m(this,Ie).call(this,this)));T(this,Le,e),t&&(T(this,Z,t.executionCtx),this.env=t.env,T(this,Ie,t.notFoundHandler),T(this,xe,t.path),T(this,Ue,t.matchResult))}get req(){return m(this,Me)??T(this,Me,new Rs(m(this,Le),m(this,xe),m(this,Ue))),m(this,Me)}get event(){if(m(this,Z)&&"respondWith"in m(this,Z))return m(this,Z);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,Z))return m(this,Z);throw Error("This context has no ExecutionContext")}get res(){return m(this,q)||T(this,q,new Response(null,{headers:m(this,pe)??T(this,pe,new Headers)}))}set res(e){if(m(this,q)&&e){e=new Response(e.body,e);for(const[t,r]of m(this,q).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const s=m(this,q).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of s)e.headers.append("set-cookie",a)}else e.headers.set(t,r)}T(this,q,e),this.finalized=!0}get var(){return m(this,Q)?Object.fromEntries(m(this,Q)):{}}},Le=new WeakMap,Me=new WeakMap,Q=new WeakMap,Se=new WeakMap,Z=new WeakMap,q=new WeakMap,Pe=new WeakMap,Re=new WeakMap,Ie=new WeakMap,pe=new WeakMap,Ue=new WeakMap,xe=new WeakMap,ae=new WeakSet,be=function(e,t,r){const s=m(this,q)?new Headers(m(this,q).headers):m(this,pe)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[n,i]of o)n.toLowerCase()==="set-cookie"?s.append(n,i):s.set(n,i)}if(r)for(const[o,n]of Object.entries(r))if(typeof n=="string")s.set(o,n);else{s.delete(o);for(const i of n)s.append(o,i)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??m(this,Se);return new Response(e,{status:a,headers:s})},_s),M="ALL",dr="all",pr=["get","post","put","delete","options","patch"],js="Can not add a route since the matcher is already built.",Ds=class extends Error{},mr="__COMPOSED_HANDLER",_r=e=>e.text("404 Not Found",404),ds=(e,t)=>{if("getResponse"in e){const r=e.getResponse();return t.newResponse(r.body,r)}return console.error(e),t.text("Internal Server Error",500)},V,P,Ns,J,le,qe,Be,ve,fr=(ve=class{constructor(t={}){I(this,P);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");I(this,V,"/");S(this,"routes",[]);I(this,J,_r);S(this,"errorHandler",ds);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(T(this,J,t),this));S(this,"fetch",(t,...r)=>O(this,P,Be).call(this,t,r[1],r[0],t.method));S(this,"request",(t,r,s,a)=>t instanceof Request?this.fetch(r?new Request(t,r):t,s,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${ge("/",t)}`,r),s,a)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(O(this,P,Be).call(this,t.request,t,void 0,t.request.method))})});[...pr,dr].forEach(o=>{this[o]=(n,...i)=>(typeof n=="string"?T(this,V,n):O(this,P,le).call(this,o,m(this,V),n),i.forEach(c=>{O(this,P,le).call(this,o,m(this,V),c)}),this)}),this.on=(o,n,...i)=>{for(const c of[n].flat()){T(this,V,c);for(const u of[o].flat())i.map(l=>{O(this,P,le).call(this,u.toUpperCase(),m(this,V),l)})}return this},this.use=(o,...n)=>(typeof o=="string"?T(this,V,o):(T(this,V,"*"),n.unshift(o)),n.forEach(i=>{O(this,P,le).call(this,M,m(this,V),i)}),this);const{strict:s,...a}=t;Object.assign(this,a),this.getPath=s??!0?t.getPath??bs:or}route(t,r){const s=this.basePath(t);return r.routes.map(a=>{var n;let o;r.errorHandler===ds?o=a.handler:(o=async(i,c)=>(await us([],r.errorHandler)(i,()=>a.handler(i,c))).res,o[mr]=a.handler),O(n=s,P,le).call(n,a.method,a.path,o)}),this}basePath(t){const r=O(this,P,Ns).call(this);return r._basePath=ge(this._basePath,t),r}mount(t,r,s){let a,o;s&&(typeof s=="function"?o=s:(o=s.optionHandler,s.replaceRequest===!1?a=c=>c:a=s.replaceRequest));const n=o?c=>{const u=o(c);return Array.isArray(u)?u:[u]}:c=>{let u;try{u=c.executionCtx}catch{}return[c.env,u]};a||(a=(()=>{const c=ge(this._basePath,t),u=c==="/"?0:c.length;return l=>{const d=new URL(l.url);return d.pathname=d.pathname.slice(u)||"/",new Request(d,l)}})());const i=async(c,u)=>{const l=await r(a(c.req.raw),...n(c));if(l)return l;await u()};return O(this,P,le).call(this,M,ge(t,"*"),i),this}},V=new WeakMap,P=new WeakSet,Ns=function(){const t=new ve({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,T(t,J,m(this,J)),t.routes=this.routes,t},J=new WeakMap,le=function(t,r,s){t=t.toUpperCase(),r=ge(this._basePath,r);const a={basePath:this._basePath,path:r,method:t,handler:s};this.router.add(t,r,[s,a]),this.routes.push(a)},qe=function(t,r){if(t instanceof Error)return this.errorHandler(t,r);throw t},Be=function(t,r,s,a){if(a==="HEAD")return(async()=>new Response(null,await O(this,P,Be).call(this,t,r,s,"GET")))();const o=this.getPath(t,{env:s}),n=this.router.match(a,o),i=new lr(t,{path:o,matchResult:n,env:s,executionCtx:r,notFoundHandler:m(this,J)});if(n[0].length===1){let u;try{u=n[0][0][0][0](i,async()=>{i.res=await m(this,J).call(this,i)})}catch(l){return O(this,P,qe).call(this,l,i)}return u instanceof Promise?u.then(l=>l||(i.finalized?i.res:m(this,J).call(this,i))).catch(l=>O(this,P,qe).call(this,l,i)):u??m(this,J).call(this,i)}const c=us(n[0],this.errorHandler,m(this,J));return(async()=>{try{const u=await c(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return O(this,P,qe).call(this,u,i)}})()},ve),As=[];function Er(e,t){const r=this.buildAllMatchers(),s=((a,o)=>{const n=r[a]||r[M],i=n[2][o];if(i)return i;const c=o.match(n[0]);if(!c)return[[],As];const u=c.indexOf("",1);return[n[1][u],c]});return this.match=s,s(e,t)}var Ye="[^/]+",ke=".*",Ce="(?:|/.*)",we=Symbol(),hr=new Set(".\\+*[^]$()");function yr(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ke||e===Ce?1:t===ke||t===Ce?-1:e===Ye?1:t===Ye?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var me,_e,z,he,gr=(he=class{constructor(){I(this,me);I(this,_e);I(this,z,Object.create(null))}insert(t,r,s,a,o){if(t.length===0){if(m(this,me)!==void 0)throw we;if(o)return;T(this,me,r);return}const[n,...i]=t,c=n==="*"?i.length===0?["","",ke]:["","",Ye]:n==="/*"?["","",Ce]:n.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(c){const l=c[1];let d=c[2]||Ye;if(l&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw we;if(u=m(this,z)[d],!u){if(Object.keys(m(this,z)).some(_=>_!==ke&&_!==Ce))throw we;if(o)return;u=m(this,z)[d]=new he,l!==""&&T(u,_e,a.varIndex++)}!o&&l!==""&&s.push([l,m(u,_e)])}else if(u=m(this,z)[n],!u){if(Object.keys(m(this,z)).some(l=>l.length>1&&l!==ke&&l!==Ce))throw we;if(o)return;u=m(this,z)[n]=new he}u.insert(i,r,s,a,o)}buildRegExpStr(){const r=Object.keys(m(this,z)).sort(yr).map(s=>{const a=m(this,z)[s];return(typeof m(a,_e)=="number"?`(${s})@${m(a,_e)}`:hr.has(s)?`\\${s}`:s)+a.buildRegExpStr()});return typeof m(this,me)=="number"&&r.unshift(`#${m(this,me)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},me=new WeakMap,_e=new WeakMap,z=new WeakMap,he),Ve,He,fs,br=(fs=class{constructor(){I(this,Ve,{varIndex:0});I(this,He,new gr)}insert(e,t,r){const s=[],a=[];for(let n=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const u=`@\\${n}`;return a[n]=[u,c],n++,i=!0,u}),!i)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let n=a.length-1;n>=0;n--){const[i]=a[n];for(let c=o.length-1;c>=0;c--)if(o[c].indexOf(i)!==-1){o[c]=o[c].replace(i,a[n][1]);break}}return m(this,He).insert(o,t,s,m(this,Ve),r),s}buildRegExp(){let e=m(this,He).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const r=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,o,n)=>o!==void 0?(r[++t]=Number(o),"$()"):(n!==void 0&&(s[Number(n)]=++t),"")),[new RegExp(`^${e}`),r,s]}},Ve=new WeakMap,He=new WeakMap,fs),wr=[/^$/,[],Object.create(null)],Ke=Object.create(null);function ks(e){return Ke[e]??(Ke[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Tr(){Ke=Object.create(null)}function Sr(e){var u;const t=new br,r=[];if(e.length===0)return wr;const s=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,d],[_,f])=>l?1:_?-1:d.length-f.length),a=Object.create(null);for(let l=0,d=-1,_=s.length;l<_;l++){const[f,E,y]=s[l];f?a[E]=[y.map(([b])=>[b,Object.create(null)]),As]:d++;let h;try{h=t.insert(E,d,f)}catch(b){throw b===we?new Ds(E):b}f||(r[d]=y.map(([b,g])=>{const j=Object.create(null);for(g-=1;g>=0;g--){const[D,w]=h[g];j[D]=w}return[b,j]}))}const[o,n,i]=t.buildRegExp();for(let l=0,d=r.length;l<d;l++)for(let _=0,f=r[l].length;_<f;_++){const E=(u=r[l][_])==null?void 0:u[1];if(!E)continue;const y=Object.keys(E);for(let h=0,b=y.length;h<b;h++)E[y[h]]=i[E[y[h]]]}const c=[];for(const l in n)c[l]=r[n[l]];return[o,c,a]}function ye(e,t){if(e){for(const r of Object.keys(e).sort((s,a)=>a.length-s.length))if(ks(r).test(t))return[...e[r]]}}var oe,ne,Je,Cs,Es,Rr=(Es=class{constructor(){I(this,Je);S(this,"name","RegExpRouter");I(this,oe);I(this,ne);S(this,"match",Er);T(this,oe,{[M]:Object.create(null)}),T(this,ne,{[M]:Object.create(null)})}add(e,t,r){var i;const s=m(this,oe),a=m(this,ne);if(!s||!a)throw new Error(js);s[e]||[s,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[M]).forEach(u=>{c[e][u]=[...c[M][u]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const c=ks(t);e===M?Object.keys(s).forEach(u=>{var l;(l=s[u])[t]||(l[t]=ye(s[u],t)||ye(s[M],t)||[])}):(i=s[e])[t]||(i[t]=ye(s[e],t)||ye(s[M],t)||[]),Object.keys(s).forEach(u=>{(e===M||e===u)&&Object.keys(s[u]).forEach(l=>{c.test(l)&&s[u][l].push([r,o])})}),Object.keys(a).forEach(u=>{(e===M||e===u)&&Object.keys(a[u]).forEach(l=>c.test(l)&&a[u][l].push([r,o]))});return}const n=ws(t)||[t];for(let c=0,u=n.length;c<u;c++){const l=n[c];Object.keys(a).forEach(d=>{var _;(e===M||e===d)&&((_=a[d])[l]||(_[l]=[...ye(s[d],l)||ye(s[M],l)||[]]),a[d][l].push([r,o-u+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(m(this,ne)).concat(Object.keys(m(this,oe))).forEach(t=>{e[t]||(e[t]=O(this,Je,Cs).call(this,t))}),T(this,oe,T(this,ne,void 0)),Tr(),e}},oe=new WeakMap,ne=new WeakMap,Je=new WeakSet,Cs=function(e){const t=[];let r=e===M;return[m(this,oe),m(this,ne)].forEach(s=>{const a=s[e]?Object.keys(s[e]).map(o=>[o,s[e][o]]):[];a.length!==0?(r||(r=!0),t.push(...a)):e!==M&&t.push(...Object.keys(s[M]).map(o=>[o,s[M][o]]))}),r?Sr(t):null},Es),ie,ee,hs,Ir=(hs=class{constructor(e){S(this,"name","SmartRouter");I(this,ie,[]);I(this,ee,[]);T(this,ie,e.routers)}add(e,t,r){if(!m(this,ee))throw new Error(js);m(this,ee).push([e,t,r])}match(e,t){if(!m(this,ee))throw new Error("Fatal error");const r=m(this,ie),s=m(this,ee),a=r.length;let o=0,n;for(;o<a;o++){const i=r[o];try{for(let c=0,u=s.length;c<u;c++)i.add(...s[c]);n=i.match(e,t)}catch(c){if(c instanceof Ds)continue;throw c}this.match=i.match.bind(i),T(this,ie,[i]),T(this,ee,void 0);break}if(o===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,n}get activeRouter(){if(m(this,ee)||m(this,ie).length!==1)throw new Error("No active router has been determined yet.");return m(this,ie)[0]}},ie=new WeakMap,ee=new WeakMap,hs),Ne=Object.create(null),ce,$,fe,Oe,H,se,de,je,vr=(je=class{constructor(t,r,s){I(this,se);I(this,ce);I(this,$);I(this,fe);I(this,Oe,0);I(this,H,Ne);if(T(this,$,s||Object.create(null)),T(this,ce,[]),t&&r){const a=Object.create(null);a[t]={handler:r,possibleKeys:[],score:0},T(this,ce,[a])}T(this,fe,[])}insert(t,r,s){T(this,Oe,++cs(this,Oe)._);let a=this;const o=er(r),n=[];for(let i=0,c=o.length;i<c;i++){const u=o[i],l=o[i+1],d=tr(u,l),_=Array.isArray(d)?d[0]:u;if(_ in m(a,$)){a=m(a,$)[_],d&&n.push(d[1]);continue}m(a,$)[_]=new je,d&&(m(a,fe).push(d),n.push(d[1])),a=m(a,$)[_]}return m(a,ce).push({[t]:{handler:s,possibleKeys:n.filter((i,c,u)=>u.indexOf(i)===c),score:m(this,Oe)}}),a}search(t,r){var c;const s=[];T(this,H,Ne);let o=[this];const n=gs(r),i=[];for(let u=0,l=n.length;u<l;u++){const d=n[u],_=u===l-1,f=[];for(let E=0,y=o.length;E<y;E++){const h=o[E],b=m(h,$)[d];b&&(T(b,H,m(h,H)),_?(m(b,$)["*"]&&s.push(...O(this,se,de).call(this,m(b,$)["*"],t,m(h,H))),s.push(...O(this,se,de).call(this,b,t,m(h,H)))):f.push(b));for(let g=0,j=m(h,fe).length;g<j;g++){const D=m(h,fe)[g],w=m(h,H)===Ne?{}:{...m(h,H)};if(D==="*"){const U=m(h,$)["*"];U&&(s.push(...O(this,se,de).call(this,U,t,m(h,H))),T(U,H,w),f.push(U));continue}const[N,C,R]=D;if(!d&&!(R instanceof RegExp))continue;const A=m(h,$)[N],x=n.slice(u).join("/");if(R instanceof RegExp){const U=R.exec(x);if(U){if(w[C]=U[0],s.push(...O(this,se,de).call(this,A,t,m(h,H),w)),Object.keys(m(A,$)).length){T(A,H,w);const G=((c=U[0].match(/\//))==null?void 0:c.length)??0;(i[G]||(i[G]=[])).push(A)}continue}}(R===!0||R.test(d))&&(w[C]=d,_?(s.push(...O(this,se,de).call(this,A,t,w,m(h,H))),m(A,$)["*"]&&s.push(...O(this,se,de).call(this,m(A,$)["*"],t,w,m(h,H)))):(T(A,H,w),f.push(A)))}}o=f.concat(i.shift()??[])}return s.length>1&&s.sort((u,l)=>u.score-l.score),[s.map(({handler:u,params:l})=>[u,l])]}},ce=new WeakMap,$=new WeakMap,fe=new WeakMap,Oe=new WeakMap,H=new WeakMap,se=new WeakSet,de=function(t,r,s,a){const o=[];for(let n=0,i=m(t,ce).length;n<i;n++){const c=m(t,ce)[n],u=c[r]||c[M],l={};if(u!==void 0&&(u.params=Object.create(null),o.push(u),s!==Ne||a&&a!==Ne))for(let d=0,_=u.possibleKeys.length;d<_;d++){const f=u.possibleKeys[d],E=l[u.score];u.params[f]=a!=null&&a[f]&&!E?a[f]:s[f]??(a==null?void 0:a[f]),l[u.score]=!0}}return o},je),Ee,ys,Or=(ys=class{constructor(){S(this,"name","TrieRouter");I(this,Ee);T(this,Ee,new vr)}add(e,t,r){const s=ws(t);if(s){for(let a=0,o=s.length;a<o;a++)m(this,Ee).insert(e,s[a],r);return}m(this,Ee).insert(e,t,r)}match(e,t){return m(this,Ee).search(e,t)}},Ee=new WeakMap,ys),Ls=class extends fr{constructor(e={}){super(e),this.router=e.router??new Ir({routers:[new Rr,new Or]})}},k=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(o=>typeof o=="string"?o==="*"?()=>o:n=>o===n?n:null:typeof o=="function"?o:n=>o.includes(n)?n:null)(r.origin),a=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(r.allowMethods);return async function(n,i){var l;function c(d,_){n.res.headers.set(d,_)}const u=await s(n.req.header("origin")||"",n);if(u&&c("Access-Control-Allow-Origin",u),r.credentials&&c("Access-Control-Allow-Credentials","true"),(l=r.exposeHeaders)!=null&&l.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),n.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const d=await a(n.req.header("origin")||"",n);d.length&&c("Access-Control-Allow-Methods",d.join(","));let _=r.allowHeaders;if(!(_!=null&&_.length)){const f=n.req.header("Access-Control-Request-Headers");f&&(_=f.split(/\s*,\s*/))}return _!=null&&_.length&&(c("Access-Control-Allow-Headers",_.join(",")),n.res.headers.append("Vary","Access-Control-Request-Headers")),n.res.headers.delete("Content-Length"),n.res.headers.delete("Content-Type"),new Response(null,{headers:n.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&n.header("Vary","Origin",{append:!0})}};const es={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function jr(){const e=es.ENV==="production";return{baseUrl:es.TEST_BASE_URL,apiKey:es.TEST_API_KEY,isProduction:e}}async function Ms(e,t){const r=jr(),s=`${r.baseUrl}${e}`;try{const a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r.apiKey}`},body:JSON.stringify(t)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Dr(e){try{const t={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((s,a)=>({SerialNum:a+1,ItemName:s.name,Qty:s.quantity,UnitPrice:s.unitPrice,SupplyCost:s.supplyPrice,Tax:s.taxAmount,Remark:s.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},r=await Ms("/eTaxInvoice/RegistAndIssue",t);if(r.code!==1)throw new Error(`바로빌 발행 실패: ${r.message}`);return{success:!0,ntsConfirmNumber:r.ntsconfirmNum,invoiceKey:r.invoiceKey,message:r.message}}catch(t){throw console.error("바로빌 세금계산서 발행 실패:",t),t}}async function Nr(e,t,r){try{const a=await Ms("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:t,Memo:r});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(s){throw console.error("바로빌 세금계산서 취소 실패:",s),s}}function Ae(){return!1}async function Ar(e){return await Dr(e)}function kr(e,t,r){const s=Number(t.total_amount),a=Math.floor(s/1.1),o=s-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:t.buyer_business_number,buyerBusinessName:t.buyer_business_name||t.user_name,buyerCEO:t.buyer_ceo_name,buyerAddress:t.shipping_address,buyerEmail:t.user_email,buyerTel:t.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:r.map(n=>{const i=Number(n.price)*Number(n.quantity),c=Math.floor(i/1.1),u=i-c;return{name:n.product_name,quantity:Number(n.quantity),unitPrice:Number(n.price),supplyPrice:c,taxAmount:u,description:n.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:o,totalAmount:s,memo:`주문번호: ${t.order_number}`,orderNo:t.order_number}}class K extends Error{constructor(t,r,s){super(t),this.statusCode=r,this.code=s,this.name="AuthError"}}function Cr(e){return`${crypto.randomUUID()}-${e}`}function Lr(e){var o,n,i,c,u,l,d;const t=e.id.toString(),r=((o=e.properties)==null?void 0:o.nickname)||((i=(n=e.kakao_account)==null?void 0:n.profile)==null?void 0:i.nickname)||"Kakao User",s=((c=e.kakao_account)==null?void 0:c.email)||null,a=((u=e.properties)==null?void 0:u.profile_image)||((d=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:t,nickname:r,email:s,profileImage:a}}async function Mr(e,t,r,s,a){try{await e.prepare(`
    ...
    `).bind(r).all();return e.json({success:!0,data:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/cart",Y,async e=>{const{DB:t}=e.env,r=e.get("userId");try{const s=await t.prepare(`
      SELECT 
        ci.*,
    ...
    `).bind(r).all();return e.json({success:!0,data:s.results})}catch(s){return e.json({success:!1,error:`장바구니 조회 실패: ${s.message}`},500)}});p.get("/api/cart/:userId",Y,async e=>{const{DB:t}=e.env,r=e.get("userId"),s=e.req.param("userId");try{let a=await t.prepare("SELECT id FROM users WHERE id = ?").bind(r).first();if(!a)return e.json({success:!1,error:"사용자를 찾을 수 없습니다."},404);const o=a.id;if(s!==String(o))return e.json({success:!1,error:"본인의 장바구니만 조회할 수 있습니다."},403);const n=await t.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
        p.image_url as image_url,
    ...
    `).bind(D,s,j,o.address,o.name,o.phone).run()).meta.last_row_id,C=[];for(const R of g.results){if((await t.prepare(`
        UPDATE products 
        SET stock = stock - ?, 
            version = version + 1,
            updated_at = datetime('now')
    ...
    `).bind(r.sellerId).first();return s?e.json({success:!0,data:s}):e.json({success:!1,error:"등록된 사업자 정보가 없습니다."},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/seller-business/:id/verify",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);const s=e.req.param("id"),{verified:a}=await e.req.json();try{return a?(await t.prepare(`
      ...
      `).bind(s).run(),e.json({success:!0,message:"사업자 정보가 승인되었습니다."})):(await t.prepare(`
        ...
        WHERE id = ?
      `).bind(s).run(),e.json({success:!0,message:"사업자 정보 승인이 취소되었습니다."}))}catch(o){return e.json({success:!1,error:o.message},500)}});p.get("/api/admin/seller-business",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=await t.prepare(`
      SELECT 
        sbi.*,
        s.username,
  ...
  `).bind(s==null?void 0:s.bank,s==null?void 0:s.accountNumber,s==null?void 0:s.customerName,s==null?void 0:s.dueDate,JSON.stringify(t),r).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",r)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:t}=e.env;try{const r=e.req.param("paymentKey"),s=await e.req.json(),{cancelReason:a,cancelAmount:o}=s;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:r,cancelReason:a,cancelAmount:o}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const n=await t.prepare(`
    ...
    `).all();return e.json({success:!0,data:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/sellers",async e=>{const{DB:t}=e.env,{limit:r="20",offset:s="0"}=e.req.query();try{const a=`
      ...
      ORDER BY created_at DESC
      LIMIT ? OFFSET ?
    `,{results:o}=await t.prepare(a).bind(parseInt(r),parseInt(s)).all();return e.json({success:!0,data:o})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});p.get("/api/admin/sellers",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=await t.prepare(`
    ...
    `).bind(s,_,o,n,i||null,c,u||null,r.adminId).run();return e.json({success:!0,data:{id:f.meta.last_row_id,username:s,name:o,email:n,business_name:c}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/sellers/:id",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=e.req.param("id"),{name:a,email:o,phone:n,business_name:i,business_number:c,is_active:u,status:l}=await e.req.json();return await t.prepare("SELECT id FROM sellers WHERE id = ?").bind(s).first()?(await t.prepare(`
      UPDATE sellers 
    ...
    `).bind(s).run(),await t.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(s).run(),e.json({success:!0,message:`판매자 '${a.username}'의 로그인 권한이 삭제되었습니다`})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/admin/sellers/:id/reset-password",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=e.req.param("id"),{new_password:a}=await e.req.json();if(!a||a.length<6)return e.json({success:!1,error:"비밀번호는 6자 이상이어야 합니다"},400);const o=await t.prepare("SELECT id, username FROM sellers WHERE id = ?").bind(s).first();if(!o)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const n=`$2a$10$placeholder_hash_for_${a}`;return await t.prepare(`
      ...
      WHERE id = ?
    `).bind(n,s).run(),await t.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(s).run(),e.json({success:!0,message:`판매자 '${o.username}'의 비밀번호가 재설정되었습니다`})}catch(s){return e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/commission",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=e.req.param("id"),{commission_rate:a}=await e.req.json();if(a==null)return e.json({success:!1,error:"수수료율을 입력해주세요"},400);const o=parseFloat(a);if(isNaN(o)||o<0||o>100)return e.json({success:!1,error:"수수료율은 0에서 100 사이의 값이어야 합니다"},400);const n=await t.prepare("SELECT id, username, commission_rate FROM sellers WHERE id = ?").bind(s).first();if(!n)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const i=n.commission_rate||10;return await t.prepare(`
      UPDATE sellers 
      SET commission_rate = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(o,s).run(),console.log(`수수료율 변경: 판매자 ${n.username} (ID: ${s}), ${i}% → ${o}%`),e.json({success:!0,message:`판매자 '${n.username}'의 수수료율이 ${i}%에서 ${o}%로 변경되었습니다`,data:{seller_id:s,seller_username:n.username,old_commission_rate:i,new_commission_rate:o}})}catch(s){return console.error("수수료율 변경 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/approve",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=e.req.param("id"),a=await t.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(s).first();return a?a.status==="approved"?e.json({success:!1,error:"이미 승인된 판매자입니다"},400):(await t.prepare(`
      UPDATE sellers 
      SET status = 'approved', 
          is_active = 1,
          approved_by = ?,
    ...
    `).bind(r.adminId,s).run(),console.log(`셀러 승인: ${a.username} (ID: ${s}) by Admin ID: ${r.adminId}`),e.json({success:!0,message:`판매자 '${a.name}'님이 승인되었습니다`,data:{seller_id:s,seller_username:a.username,seller_name:a.name,status:"approved",approved_at:new Date().toISOString()}})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return console.error("셀러 승인 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/reject",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=e.req.param("id"),{reason:a}=await e.req.json();if(!a)return e.json({success:!1,error:"거부 사유를 입력해주세요"},400);const o=await t.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(s).first();return o?o.status==="rejected"?e.json({success:!1,error:"이미 거부된 판매자입니다"},400):(await t.prepare(`
      ...
      SET status = 'rejected', 
          ...
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(a,r.adminId,s).run(),console.log(`셀러 거부: ${o.username} (ID: ${s}), 사유: ${a}`),e.json({success:!0,message:`판매자 '${o.name}'님의 승인이 거부되었습니다`,data:{seller_id:s,seller_username:o.username,seller_name:o.name,status:"rejected",rejection_reason:a,rejected_at:new Date().toISOString()}})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return console.error("셀러 거부 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/sellers/pending",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const s=await t.prepare(`
      SELECT id, username, name, email, phone, business_name, business_number, 
             status, created_at
      FROM sellers
    ...
    `).bind(r).first();return s?e.json({success:!0,data:{seller_id:s.id}}):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(r){return console.error("셀러 조회 실패:",r),e.json({success:!1,error:r.message},500)}});p.get("/api/admin/settlement/stats",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{period:s}=e.req.query();let a="";const o=new Date;switch(s){case"today":a=`AND DATE(o.created_at) = '${o.toISOString().split("T")[0]}'`;break;case"week":a=`AND DATE(o.created_at) >= '${new Date(o.getTime()-10080*60*1e3).toISOString().split("T")[0]}'`;break;case"month":a=`AND DATE(o.created_at) >= '${new Date(o.getTime()-720*60*60*1e3).toISOString().split("T")[0]}'`;break;default:a=""}const n=await t.prepare(`
      SELECT 
    ...
    `).bind(s).first();return o?(await t.prepare(`
      ...
      WHERE id = ?
    `).bind(a,s).run(),console.log(`정산 상태 변경: 주문 ${o.order_number}, ${o.settlement_status} → ${a}`),e.json({success:!0,message:`정산 상태가 '${a}'로 변경되었습니다`,data:{order_id:s,order_number:o.order_number,old_status:o.settlement_status,new_status:a}})):e.json({success:!1,error:"주문을 찾을 수 없습니다"},404)}catch(s){return console.error("정산 상태 변경 실패:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/admin/settlement/batch-complete",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_ids:s}=await e.req.json();if(!Array.isArray(s)||s.length===0)return e.json({success:!1,error:"주문 ID 배열이 필요합니다"},400);let a=0,o=0;for(const n of s)try{await t.prepare(`
          UPDATE orders 
        ...
        `).bind(n).run(),a++}catch(i){o++,console.error(`주문 ${n} 정산 처리 실패:`,i)}return e.json({success:!0,message:`${a}건 정산 완료, ${o}건 실패`,data:{total:s.length,success:a,failed:o}})}catch(s){return console.error("일괄 정산 처리 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlement/export-csv",async e=>{const{DB:t}=e.env,r=await L(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{seller_id:s,period:a}=e.req.query();let o=["payment_status = 'completed'","is_cancelled = 0"];const n=[];s&&(o.push("o.seller_id = ?"),n.push(s));const i=new Date;switch(a){case"today":const E=i.toISOString().split("T")[0];o.push(`DATE(o.created_at) = '${E}'`);break;case"week":const y=new Date(i.getTime()-10080*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${y}'`);break;case"month":const h=new Date(i.getTime()-720*60*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${h}'`);break}const c=o.length>0?`WHERE ${o.join(" AND ")}`:"",l=(await t.prepare(`
      SELECT 
...
`});const f="\uFEFF";return new Response(f+_,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(s){return console.error("CSV 내보내기 실패:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/orders/create",async e=>{const{DB:t}=e.env;try{const{userId:r,cartItems:s,totalAmount:a,shippingAddressId:o,sellerId:n,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:u,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:r,cartItems:s==null?void 0:s.length,totalAmount:a,shippingAddressId:o,sellerId:n,issueTaxInvoice:i});let d=10;if(n){const w=await t.prepare(`
      ...
      `).bind(o,r).first();if(!w)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);E=w}if(!r)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const y=r,h=Date.now(),b=Math.random().toString(36).substring(2,8).toUpperCase(),g=`ORDER_${h}_${b}`;for(const w of s){const N=await t.prepare(`
        SELECT stock FROM products WHERE id = ?
    ...
    `).bind(g,y,a,"pending",n||null,d,_,f,o||null,(E==null?void 0:E.recipient_name)||null,(E==null?void 0:E.phone)||null,E!=null&&E.address?`${E.address} ${E.address_detail}`:null,(E==null?void 0:E.postal_code)||null,i?1:0,c||null,u||null,l||null).run()).meta.last_row_id;for(const w of s){await t.prepare(`
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(t){return console.error("CSV download error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:t}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_number:s}=await e.req.json();if(!s)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await t.prepare(`
    ...
    `).bind(r.sellerId).first();if(!o)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const n=await t.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),c=Math.floor(i/1.1),u=i-c,l=new Date().toISOString().split("T")[0],d=`${l}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,_=kr(o,a,n.results);let f,E,y;try{f=await Ar(_),E=f.ntsConfirmNumber,y=f.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:E,invoiceKey:y,mockMode:Ae()})}catch(g){console.error("바로빌 API 호출 실패:",g),E="FAILED",y=null}const b=(await t.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(r.sellerId,s,"tax",d,l,o.business_number,o.business_name,o.ceo_name,o.address,o.business_type,o.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,c,u,i,E==="FAILED"?"failed":"issued",Ae()?"mock":"barobill",y,E).run()).meta.last_row_id;for(const g of n.results){const j=Math.floor(Number(g.price)*Number(g.quantity)/1.1),D=Number(g.price)*Number(g.quantity)-j;await t.prepare(`
        INSERT INTO tax_invoice_items (
