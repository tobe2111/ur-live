var lr=Object.defineProperty;var Ss=e=>{throw TypeError(e)};var dr=(e,s,r)=>s in e?lr(e,s,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[s]=r;var T=(e,s,r)=>dr(e,typeof s!="symbol"?s+"":s,r),as=(e,s,r)=>s.has(e)||Ss("Cannot "+r);var _=(e,s,r)=>(as(e,s,"read from private field"),r?r.call(e):s.get(e)),I=(e,s,r)=>s.has(e)?Ss("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,r),S=(e,s,r,t)=>(as(e,s,"write to private field"),t?t.call(e,r):s.set(e,r),r),A=(e,s,r)=>(as(e,s,"access private method"),r);var Ts=(e,s,r,t)=>({set _(a){S(e,s,a,r)},get _(){return _(e,s,t)}});var Rs=(e,s,r)=>(t,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,u=!1,l;if(e[i]?(l=e[i][0][0],t.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{c=await l(t,()=>o(i+1))}catch(p){if(p instanceof Error&&s)t.error=p,c=await s(p,t),u=!0;else throw p}else t.finalized===!1&&r&&(c=await r(t));return c&&(t.finalized===!1||u)&&(t.res=c),t}},pr=Symbol(),mr=async(e,s=Object.create(null))=>{const{all:r=!1,dot:t=!1}=s,n=(e instanceof Fs?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?_r(e,{all:r,dot:t}):{}};async function _r(e,s){const r=await e.formData();return r?fr(r,s):{}}function fr(e,s){const r=Object.create(null);return e.forEach((t,a)=>{s.all||a.endsWith("[]")?Er(r,a,t):r[a]=t}),s.dot&&Object.entries(r).forEach(([t,a])=>{t.includes(".")&&(hr(r,t,a),delete r[t])}),r}var Er=(e,s,r)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(r):e[s]=[e[s],r]:s.endsWith("[]")?e[s]=[r]:e[s]=r},hr=(e,s,r)=>{let t=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?t[n]=r:((!t[n]||typeof t[n]!="object"||Array.isArray(t[n])||t[n]instanceof File)&&(t[n]=Object.create(null)),t=t[n])})},Us=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},gr=e=>{const{groups:s,path:r}=yr(e),t=Us(r);return wr(t,s)},yr=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(r,t)=>{const a=`@${t}`;return s.push([a,r]),a}),{groups:s,path:e}},wr=(e,s)=>{for(let r=s.length-1;r>=0;r--){const[t]=s[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(t)){e[a]=e[a].replace(t,s[r][1]);break}}return e},ze={},br=(e,s)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const t=`${e}#${s}`;return ze[t]||(r[2]?ze[t]=s&&s[0]!==":"&&s[0]!=="*"?[t,r[1],new RegExp(`^${r[2]}(?=/${s})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:ze[t]=[e,r[1],!0]),ze[t]}return null},ps=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return s(r)}catch{return r}})}},Sr=e=>ps(e,decodeURI),Ps=e=>{const s=e.url,r=s.indexOf("/",s.indexOf(":")+4);let t=r;for(;t<s.length;t++){const a=s.charCodeAt(t);if(a===37){const n=s.indexOf("?",t),o=s.indexOf("#",t),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(r,i);return Sr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(r,t)},Tr=e=>{const s=Ps(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},Ie=(e,s,...r)=>(r.length&&(s=Ie(s,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),$s=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),r=[];let t="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))t+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&t===""?r.push("/"):r.push(t);const n=a.replace("?","");t+="/"+n,r.push(t)}else t+="/"+a}),r.filter((a,n,o)=>o.indexOf(a)===n)},ns=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ps(e,qs):e):e,Hs=(e,s,r)=>{let t;if(!r&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,u=e.indexOf("&",c);return ns(e.slice(c,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(t=/[%+]/.test(e),!t)return}const a={};t??(t=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(t&&(c=ns(c)),n=o,c==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),t&&(u=ns(u))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(u)):a[c]??(a[c]=u)}return s?a[s]:a},Rr=Hs,Ir=(e,s)=>Hs(e,s,!0),qs=decodeURIComponent,Is=e=>ps(e,qs),De,z,ue,Bs,xs,ls,le,As,Fs=(As=class{constructor(e,s="/",r=[[]]){I(this,ue);T(this,"raw");I(this,De);I(this,z);T(this,"routeIndex",0);T(this,"path");T(this,"bodyCache",{});I(this,le,e=>{const{bodyCache:s,raw:r}=this,t=s[e];if(t)return t;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=r[e]()});this.raw=e,this.path=s,S(this,z,r),S(this,De,{})}param(e){return e?A(this,ue,Bs).call(this,e):A(this,ue,xs).call(this)}query(e){return Rr(this.url,e)}queries(e){return Ir(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((r,t)=>{s[t]=r}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await mr(this,e))}json(){return _(this,le).call(this,"text").then(e=>JSON.parse(e))}text(){return _(this,le).call(this,"text")}arrayBuffer(){return _(this,le).call(this,"arrayBuffer")}blob(){return _(this,le).call(this,"blob")}formData(){return _(this,le).call(this,"formData")}addValidatedData(e,s){_(this,De)[e]=s}valid(e){return _(this,De)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[pr](){return _(this,z)}get matchedRoutes(){return _(this,z)[0].map(([[,e]])=>e)}get routePath(){return _(this,z)[0].map(([[,e]])=>e)[this.routeIndex].path}},De=new WeakMap,z=new WeakMap,ue=new WeakSet,Bs=function(e){const s=_(this,z)[0][this.routeIndex][1][e],r=A(this,ue,ls).call(this,s);return r&&/\%/.test(r)?Is(r):r},xs=function(){const e={},s=Object.keys(_(this,z)[0][this.routeIndex][1]);for(const r of s){const t=A(this,ue,ls).call(this,_(this,z)[0][this.routeIndex][1][r]);t!==void 0&&(e[r]=/\%/.test(t)?Is(t):t)}return e},ls=function(e){return _(this,z)[1]?_(this,z)[1][e]:e},le=new WeakMap,As),Or={Stringify:1},Ws=async(e,s,r,t,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:t}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Ws(c,s,!1,t,a))).then(()=>a[0]))):Promise.resolve(e)},vr="text/plain; charset=UTF-8",os=(e,s)=>({"Content-Type":e,...s}),Te=(e,s)=>new Response(e,s),qe,Fe,ne,Ne,oe,V,Be,Ae,ke,he,xe,We,re,Oe,ds,ks,Dr=(ks=class{constructor(e,s){I(this,re);I(this,qe);I(this,Fe);T(this,"env",{});I(this,ne);T(this,"finalized",!1);T(this,"error");I(this,Ne);I(this,oe);I(this,V);I(this,Be);I(this,Ae);I(this,ke);I(this,he);I(this,xe);I(this,We);T(this,"render",(...e)=>(_(this,Ae)??S(this,Ae,s=>this.html(s)),_(this,Ae).call(this,...e)));T(this,"setLayout",e=>S(this,Be,e));T(this,"getLayout",()=>_(this,Be));T(this,"setRenderer",e=>{S(this,Ae,e)});T(this,"header",(e,s,r)=>{this.finalized&&S(this,V,Te(_(this,V).body,_(this,V)));const t=_(this,V)?_(this,V).headers:_(this,he)??S(this,he,new Headers);s===void 0?t.delete(e):r!=null&&r.append?t.append(e,s):t.set(e,s)});T(this,"status",e=>{S(this,Ne,e)});T(this,"set",(e,s)=>{_(this,ne)??S(this,ne,new Map),_(this,ne).set(e,s)});T(this,"get",e=>_(this,ne)?_(this,ne).get(e):void 0);T(this,"newResponse",(...e)=>A(this,re,Oe).call(this,...e));T(this,"body",(e,s,r)=>A(this,re,Oe).call(this,e,s,r));T(this,"text",(e,s,r)=>A(this,re,ds).call(this)&&!s&&!r?Te(e):A(this,re,Oe).call(this,e,s,os(vr,r)));T(this,"json",(e,s,r)=>A(this,re,ds).call(this)&&!s&&!r?Response.json(e):A(this,re,Oe).call(this,JSON.stringify(e),s,os("application/json",r)));T(this,"html",(e,s,r)=>{const t=a=>A(this,re,Oe).call(this,a,s,os("text/html; charset=UTF-8",r));return typeof e=="object"?Ws(e,Or.Stringify,!1,{}).then(t):t(e)});T(this,"redirect",(e,s)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,s??302)});T(this,"notFound",()=>(_(this,ke)??S(this,ke,()=>Te()),_(this,ke).call(this,this)));S(this,qe,e),s&&(S(this,oe,s.executionCtx),this.env=s.env,S(this,ke,s.notFoundHandler),S(this,We,s.path),S(this,xe,s.matchResult))}get req(){return _(this,Fe)??S(this,Fe,new Fs(_(this,qe),_(this,We),_(this,xe))),_(this,Fe)}get event(){if(_(this,oe)&&"respondWith"in _(this,oe))return _(this,oe);throw Error("This context has no FetchEvent")}get executionCtx(){if(_(this,oe))return _(this,oe);throw Error("This context has no ExecutionContext")}get res(){return _(this,V)||S(this,V,Te(null,{headers:_(this,he)??S(this,he,new Headers)}))}set res(e){if(_(this,V)&&e){e=Te(e.body,e);for(const[s,r]of _(this,V).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const t=_(this,V).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of t)e.headers.append("set-cookie",a)}else e.headers.set(s,r)}S(this,V,e),this.finalized=!0}get var(){return _(this,ne)?Object.fromEntries(_(this,ne)):{}}},qe=new WeakMap,Fe=new WeakMap,ne=new WeakMap,Ne=new WeakMap,oe=new WeakMap,V=new WeakMap,Be=new WeakMap,Ae=new WeakMap,ke=new WeakMap,he=new WeakMap,xe=new WeakMap,We=new WeakMap,re=new WeakSet,Oe=function(e,s,r){const t=_(this,V)?new Headers(_(this,V).headers):_(this,he)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?t.append(o,i):t.set(o,i)}if(r)for(const[n,o]of Object.entries(r))if(typeof o=="string")t.set(n,o);else{t.delete(n);for(const i of o)t.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??_(this,Ne);return Te(e,{status:a,headers:t})},ds=function(){return!_(this,he)&&!_(this,Ne)&&!this.finalized},ks),P="ALL",Nr="all",Ar=["get","post","put","delete","options","patch"],Ks="Can not add a route since the matcher is already built.",Vs=class extends Error{},kr="__COMPOSED_HANDLER",jr=e=>e.text("404 Not Found",404),Os=(e,s)=>{if("getResponse"in e){const r=e.getResponse();return s.newResponse(r.body,r)}return console.error(e),s.text("Internal Server Error",500)},Z,$,Ys,ee,fe,Ge,Xe,je,Cr=(je=class{constructor(s={}){I(this,$);T(this,"get");T(this,"post");T(this,"put");T(this,"delete");T(this,"options");T(this,"patch");T(this,"all");T(this,"on");T(this,"use");T(this,"router");T(this,"getPath");T(this,"_basePath","/");I(this,Z,"/");T(this,"routes",[]);I(this,ee,jr);T(this,"errorHandler",Os);T(this,"onError",s=>(this.errorHandler=s,this));T(this,"notFound",s=>(S(this,ee,s),this));T(this,"fetch",(s,...r)=>A(this,$,Xe).call(this,s,r[1],r[0],s.method));T(this,"request",(s,r,t,a)=>s instanceof Request?this.fetch(r?new Request(s,r):s,t,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${Ie("/",s)}`,r),t,a)));T(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(A(this,$,Xe).call(this,s.request,s,void 0,s.request.method))})});[...Ar,Nr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?S(this,Z,o):A(this,$,fe).call(this,n,_(this,Z),o),i.forEach(c=>{A(this,$,fe).call(this,n,_(this,Z),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){S(this,Z,c);for(const u of[n].flat())i.map(l=>{A(this,$,fe).call(this,u.toUpperCase(),_(this,Z),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?S(this,Z,n):(S(this,Z,"*"),o.unshift(n)),o.forEach(i=>{A(this,$,fe).call(this,P,_(this,Z),i)}),this);const{strict:t,...a}=s;Object.assign(this,a),this.getPath=t??!0?s.getPath??Ps:Tr}route(s,r){const t=this.basePath(s);return r.routes.map(a=>{var o;let n;r.errorHandler===Os?n=a.handler:(n=async(i,c)=>(await Rs([],r.errorHandler)(i,()=>a.handler(i,c))).res,n[kr]=a.handler),A(o=t,$,fe).call(o,a.method,a.path,n)}),this}basePath(s){const r=A(this,$,Ys).call(this);return r._basePath=Ie(this._basePath,s),r}mount(s,r,t){let a,n;t&&(typeof t=="function"?n=t:(n=t.optionHandler,t.replaceRequest===!1?a=c=>c:a=t.replaceRequest));const o=n?c=>{const u=n(c);return Array.isArray(u)?u:[u]}:c=>{let u;try{u=c.executionCtx}catch{}return[c.env,u]};a||(a=(()=>{const c=Ie(this._basePath,s),u=c==="/"?0:c.length;return l=>{const p=new URL(l.url);return p.pathname=p.pathname.slice(u)||"/",new Request(p,l)}})());const i=async(c,u)=>{const l=await r(a(c.req.raw),...o(c));if(l)return l;await u()};return A(this,$,fe).call(this,P,Ie(s,"*"),i),this}},Z=new WeakMap,$=new WeakSet,Ys=function(){const s=new je({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,S(s,ee,_(this,ee)),s.routes=this.routes,s},ee=new WeakMap,fe=function(s,r,t){s=s.toUpperCase(),r=Ie(this._basePath,r);const a={basePath:this._basePath,path:r,method:s,handler:t};this.router.add(s,r,[t,a]),this.routes.push(a)},Ge=function(s,r){if(s instanceof Error)return this.errorHandler(s,r);throw s},Xe=function(s,r,t,a){if(a==="HEAD")return(async()=>new Response(null,await A(this,$,Xe).call(this,s,r,t,"GET")))();const n=this.getPath(s,{env:t}),o=this.router.match(a,n),i=new Dr(s,{path:n,matchResult:o,env:t,executionCtx:r,notFoundHandler:_(this,ee)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await _(this,ee).call(this,i)})}catch(l){return A(this,$,Ge).call(this,l,i)}return u instanceof Promise?u.then(l=>l||(i.finalized?i.res:_(this,ee).call(this,i))).catch(l=>A(this,$,Ge).call(this,l,i)):u??_(this,ee).call(this,i)}const c=Rs(o[0],this.errorHandler,_(this,ee));return(async()=>{try{const u=await c(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return A(this,$,Ge).call(this,u,i)}})()},je),Js=[];function Lr(e,s){const r=this.buildAllMatchers(),t=((a,n)=>{const o=r[a]||r[P],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],Js];const u=c.indexOf("",1);return[o[1][u],c]});return this.match=t,t(e,s)}var Ze="[^/]+",$e=".*",He="(?:|/.*)",ve=Symbol(),Mr=new Set(".\\+*[^]$()");function Ur(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===$e||e===He?1:s===$e||s===He?-1:e===Ze?1:s===Ze?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var ge,ye,se,Se,Pr=(Se=class{constructor(){I(this,ge);I(this,ye);I(this,se,Object.create(null))}insert(s,r,t,a,n){if(s.length===0){if(_(this,ge)!==void 0)throw ve;if(n)return;S(this,ge,r);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",$e]:["","",Ze]:o==="/*"?["","",He]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(c){const l=c[1];let p=c[2]||Ze;if(l&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ve;if(u=_(this,se)[p],!u){if(Object.keys(_(this,se)).some(m=>m!==$e&&m!==He))throw ve;if(n)return;u=_(this,se)[p]=new Se,l!==""&&S(u,ye,a.varIndex++)}!n&&l!==""&&t.push([l,_(u,ye)])}else if(u=_(this,se)[o],!u){if(Object.keys(_(this,se)).some(l=>l.length>1&&l!==$e&&l!==He))throw ve;if(n)return;u=_(this,se)[o]=new Se}u.insert(i,r,t,a,n)}buildRegExpStr(){const r=Object.keys(_(this,se)).sort(Ur).map(t=>{const a=_(this,se)[t];return(typeof _(a,ye)=="number"?`(${t})@${_(a,ye)}`:Mr.has(t)?`\\${t}`:t)+a.buildRegExpStr()});return typeof _(this,ge)=="number"&&r.unshift(`#${_(this,ge)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},ge=new WeakMap,ye=new WeakMap,se=new WeakMap,Se),ss,Ke,js,$r=(js=class{constructor(){I(this,ss,{varIndex:0});I(this,Ke,new Pr)}insert(e,s,r){const t=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const u=`@\\${o}`;return a[o]=[u,c],o++,i=!0,u}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return _(this,Ke).insert(n,s,t,_(this,ss),r),t}buildRegExp(){let e=_(this,Ke).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const r=[],t=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(r[++s]=Number(n),"$()"):(o!==void 0&&(t[Number(o)]=++s),"")),[new RegExp(`^${e}`),r,t]}},ss=new WeakMap,Ke=new WeakMap,js),Hr=[/^$/,[],Object.create(null)],Qe=Object.create(null);function zs(e){return Qe[e]??(Qe[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function qr(){Qe=Object.create(null)}function Fr(e){var u;const s=new $r,r=[];if(e.length===0)return Hr;const t=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,p],[m,E])=>l?1:m?-1:p.length-E.length),a=Object.create(null);for(let l=0,p=-1,m=t.length;l<m;l++){const[E,f,h]=t[l];E?a[f]=[h.map(([w])=>[w,Object.create(null)]),Js]:p++;let y;try{y=s.insert(f,p,E)}catch(w){throw w===ve?new Vs(f):w}E||(r[p]=h.map(([w,g])=>{const v=Object.create(null);for(g-=1;g>=0;g--){const[k,L]=y[g];v[k]=L}return[w,v]}))}const[n,o,i]=s.buildRegExp();for(let l=0,p=r.length;l<p;l++)for(let m=0,E=r[l].length;m<E;m++){const f=(u=r[l][m])==null?void 0:u[1];if(!f)continue;const h=Object.keys(f);for(let y=0,w=h.length;y<w;y++)f[h[y]]=i[f[h[y]]]}const c=[];for(const l in o)c[l]=r[o[l]];return[n,c,a]}function Re(e,s){if(e){for(const r of Object.keys(e).sort((t,a)=>a.length-t.length))if(zs(r).test(s))return[...e[r]]}}var de,pe,rs,Gs,Cs,Br=(Cs=class{constructor(){I(this,rs);T(this,"name","RegExpRouter");I(this,de);I(this,pe);T(this,"match",Lr);S(this,de,{[P]:Object.create(null)}),S(this,pe,{[P]:Object.create(null)})}add(e,s,r){var i;const t=_(this,de),a=_(this,pe);if(!t||!a)throw new Error(Ks);t[e]||[t,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[P]).forEach(u=>{c[e][u]=[...c[P][u]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=zs(s);e===P?Object.keys(t).forEach(u=>{var l;(l=t[u])[s]||(l[s]=Re(t[u],s)||Re(t[P],s)||[])}):(i=t[e])[s]||(i[s]=Re(t[e],s)||Re(t[P],s)||[]),Object.keys(t).forEach(u=>{(e===P||e===u)&&Object.keys(t[u]).forEach(l=>{c.test(l)&&t[u][l].push([r,n])})}),Object.keys(a).forEach(u=>{(e===P||e===u)&&Object.keys(a[u]).forEach(l=>c.test(l)&&a[u][l].push([r,n]))});return}const o=$s(s)||[s];for(let c=0,u=o.length;c<u;c++){const l=o[c];Object.keys(a).forEach(p=>{var m;(e===P||e===p)&&((m=a[p])[l]||(m[l]=[...Re(t[p],l)||Re(t[P],l)||[]]),a[p][l].push([r,n-u+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(_(this,pe)).concat(Object.keys(_(this,de))).forEach(s=>{e[s]||(e[s]=A(this,rs,Gs).call(this,s))}),S(this,de,S(this,pe,void 0)),qr(),e}},de=new WeakMap,pe=new WeakMap,rs=new WeakSet,Gs=function(e){const s=[];let r=e===P;return[_(this,de),_(this,pe)].forEach(t=>{const a=t[e]?Object.keys(t[e]).map(n=>[n,t[e][n]]):[];a.length!==0?(r||(r=!0),s.push(...a)):e!==P&&s.push(...Object.keys(t[P]).map(n=>[n,t[P][n]]))}),r?Fr(s):null},Cs),me,ie,Ls,xr=(Ls=class{constructor(e){T(this,"name","SmartRouter");I(this,me,[]);I(this,ie,[]);S(this,me,e.routers)}add(e,s,r){if(!_(this,ie))throw new Error(Ks);_(this,ie).push([e,s,r])}match(e,s){if(!_(this,ie))throw new Error("Fatal error");const r=_(this,me),t=_(this,ie),a=r.length;let n=0,o;for(;n<a;n++){const i=r[n];try{for(let c=0,u=t.length;c<u;c++)i.add(...t[c]);o=i.match(e,s)}catch(c){if(c instanceof Vs)continue;throw c}this.match=i.match.bind(i),S(this,me,[i]),S(this,ie,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(_(this,ie)||_(this,me).length!==1)throw new Error("No active router has been determined yet.");return _(this,me)[0]}},me=new WeakMap,ie=new WeakMap,Ls),Ue=Object.create(null),Wr=e=>{for(const s in e)return!0;return!1},_e,x,we,Ce,F,ce,Ee,Le,Kr=(Le=class{constructor(s,r,t){I(this,ce);I(this,_e);I(this,x);I(this,we);I(this,Ce,0);I(this,F,Ue);if(S(this,x,t||Object.create(null)),S(this,_e,[]),s&&r){const a=Object.create(null);a[s]={handler:r,possibleKeys:[],score:0},S(this,_e,[a])}S(this,we,[])}insert(s,r,t){S(this,Ce,++Ts(this,Ce)._);let a=this;const n=gr(r),o=[];for(let i=0,c=n.length;i<c;i++){const u=n[i],l=n[i+1],p=br(u,l),m=Array.isArray(p)?p[0]:u;if(m in _(a,x)){a=_(a,x)[m],p&&o.push(p[1]);continue}_(a,x)[m]=new Le,p&&(_(a,we).push(p),o.push(p[1])),a=_(a,x)[m]}return _(a,_e).push({[s]:{handler:t,possibleKeys:o.filter((i,c,u)=>u.indexOf(i)===c),score:_(this,Ce)}}),a}search(s,r){var l;const t=[];S(this,F,Ue);let n=[this];const o=Us(r),i=[],c=o.length;let u=null;for(let p=0;p<c;p++){const m=o[p],E=p===c-1,f=[];for(let y=0,w=n.length;y<w;y++){const g=n[y],v=_(g,x)[m];v&&(S(v,F,_(g,F)),E?(_(v,x)["*"]&&A(this,ce,Ee).call(this,t,_(v,x)["*"],s,_(g,F)),A(this,ce,Ee).call(this,t,v,s,_(g,F))):f.push(v));for(let k=0,L=_(g,we).length;k<L;k++){const H=_(g,we)[k],j=_(g,F)===Ue?{}:{..._(g,F)};if(H==="*"){const q=_(g,x)["*"];q&&(A(this,ce,Ee).call(this,t,q,s,_(g,F)),S(q,F,j),f.push(q));continue}const[D,R,N]=H;if(!m&&!(N instanceof RegExp))continue;const C=_(g,x)[D];if(N instanceof RegExp){if(u===null){u=new Array(c);let X=r[0]==="/"?1:0;for(let Q=0;Q<c;Q++)u[Q]=X,X+=o[Q].length+1}const q=r.substring(u[p]),Y=N.exec(q);if(Y){if(j[R]=Y[0],A(this,ce,Ee).call(this,t,C,s,_(g,F),j),Wr(_(C,x))){S(C,F,j);const X=((l=Y[0].match(/\//))==null?void 0:l.length)??0;(i[X]||(i[X]=[])).push(C)}continue}}(N===!0||N.test(m))&&(j[R]=m,E?(A(this,ce,Ee).call(this,t,C,s,j,_(g,F)),_(C,x)["*"]&&A(this,ce,Ee).call(this,t,_(C,x)["*"],s,j,_(g,F))):(S(C,F,j),f.push(C)))}}const h=i.shift();n=h?f.concat(h):f}return t.length>1&&t.sort((p,m)=>p.score-m.score),[t.map(({handler:p,params:m})=>[p,m])]}},_e=new WeakMap,x=new WeakMap,we=new WeakMap,Ce=new WeakMap,F=new WeakMap,ce=new WeakSet,Ee=function(s,r,t,a,n){for(let o=0,i=_(r,_e).length;o<i;o++){const c=_(r,_e)[o],u=c[t]||c[P],l={};if(u!==void 0&&(u.params=Object.create(null),s.push(u),a!==Ue||n&&n!==Ue))for(let p=0,m=u.possibleKeys.length;p<m;p++){const E=u.possibleKeys[p],f=l[u.score];u.params[E]=n!=null&&n[E]&&!f?n[E]:a[E]??(n==null?void 0:n[E]),l[u.score]=!0}}},Le),be,Ms,Vr=(Ms=class{constructor(){T(this,"name","TrieRouter");I(this,be);S(this,be,new Kr)}add(e,s,r){const t=$s(s);if(t){for(let a=0,n=t.length;a<n;a++)_(this,be).insert(e,t[a],r);return}_(this,be).insert(e,s,r)}match(e,s){return _(this,be).search(e,s)}},be=new WeakMap,Ms),Xs=class extends Cr{constructor(e={}){super(e),this.router=e.router??new xr({routers:[new Br,new Vr]})}},b=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},t=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(r.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(r.allowMethods);return async function(o,i){var l;function c(p,m){o.res.headers.set(p,m)}const u=await t(o.req.header("origin")||"",o);if(u&&c("Access-Control-Allow-Origin",u),r.credentials&&c("Access-Control-Allow-Credentials","true"),(l=r.exposeHeaders)!=null&&l.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const p=await a(o.req.header("origin")||"",o);p.length&&c("Access-Control-Allow-Methods",p.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(m=E.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Yr(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],r=[];for(const t of s)e[t]||r.push(t);if(r.length>0)throw new Error(`Missing required environment variables: ${r.join(", ")}
...
`)}async function Xr(e){const s=await zr(e),r=s.filter(n=>n.status==="pass").length,t=s.filter(n=>n.status==="warn").length,a=s.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:s.length,pass:r,warn:t,fail:a},results:s,formatted:Gr(s)}}const is={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function Qr(){const e=is.ENV==="production";return{baseUrl:is.TEST_BASE_URL,apiKey:is.TEST_API_KEY,isProduction:e}}async function Qs(e,s){const r=Qr(),t=`${r.baseUrl}${e}`;try{const a=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r.apiKey}`},body:JSON.stringify(s)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Zr(e){try{const s={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((t,a)=>({SerialNum:a+1,ItemName:t.name,Qty:t.quantity,UnitPrice:t.unitPrice,SupplyCost:t.supplyPrice,Tax:t.taxAmount,Remark:t.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},r=await Qs("/eTaxInvoice/RegistAndIssue",s);if(r.code!==1)throw new Error(`바로빌 발행 실패: ${r.message}`);return{success:!0,ntsConfirmNumber:r.ntsconfirmNum,invoiceKey:r.invoiceKey,message:r.message}}catch(s){throw console.error("바로빌 세금계산서 발행 실패:",s),s}}async function et(e,s,r){try{const a=await Qs("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:s,Memo:r});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(t){throw console.error("바로빌 세금계산서 취소 실패:",t),t}}function Pe(){return!1}async function st(e){return await Zr(e)}function rt(e,s,r){const t=Number(s.total_amount),a=Math.floor(t/1.1),n=t-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:s.buyer_business_number,buyerBusinessName:s.buyer_business_name||s.user_name,buyerCEO:s.buyer_ceo_name,buyerAddress:s.shipping_address,buyerEmail:s.user_email,buyerTel:s.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:r.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),u=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:u,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:t,memo:`주문번호: ${s.order_number}`,orderNo:s.order_number}}class G extends Error{constructor(s,r,t){super(s),this.statusCode=r,this.code=t,this.name="AuthError"}}function tt(e){return`${crypto.randomUUID()}-${e}`}function at(e){var n,o,i,c,u,l,p;const s=e.id.toString(),r=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",t=((c=e.kakao_account)==null?void 0:c.email)||null,a=((u=e.properties)==null?void 0:u.profile_image)||((p=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:p.profile_image_url)||null;return{kakaoId:s,nickname:r,email:t,profileImage:a}}async function nt(e,s,r,t,a){try{const n=await e.prepare(`
  ...
  `).bind(s).first();return r||(console.warn(`No active alimtalk account for seller ${s}`),null)}async function vs(e,s){await e.prepare(`
...
주문해 주셔서 감사합니다!`,c=await fs(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:r.buyer_phone,message:i});return c.success?(await Rt(e.DB,r.seller_id,n),await vs(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await vs(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(r){return console.error(`Error sending order confirmation for order ${s}:`,r),{success:!1,error:r.message}}}function Ot(e,s){let r=e;return Object.entries(s).forEach(([t,a])=>{const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}),r}function vt(e,s){const t=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:t.length===0,missingVars:t}}async function Dt(e,s,r){const t=await e.prepare(`
  ...
  `).bind(r,s,r).run();if(!t.success||t.meta.changes===0)throw new Error("Insufficient balance or account not found")}async function Ds(e,s,r){await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance + ?,
        updated_at = datetime('now')
    WHERE id = ?
  ...
  `).bind(s.accountId,s.templateId,s.orderId||null,s.recipientPhone,s.messageContent,s.status,s.cost,s.aligoMessageId||null,s.failedReason||null).run()}async function At(e,s,r,t){await e.prepare(`
    ...
    SET total_sent = total_sent + ?,
        ...
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,t,s).run()}async function kt(e,s,r,t,a,n,o,i,c){try{const u={...i,...o.variables},l=Ot(t,u),p=await fs(e,{senderKey:a,templateCode:n,to:o.phone,message:l});return p.success?(await us(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:l,status:"sent",cost:c,aligoMessageId:p.messageId}),{phone:o.phone,status:"sent",messageId:p.messageId,cost:c}):(await us(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:l,status:"failed",cost:0,failedReason:p.error}),await Ds(e.DB,s,c),{phone:o.phone,status:"failed",error:p.error,cost:0})}catch(u){return console.error(`Failed to send alimtalk to ${o.phone}:`,u),await us(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:"",status:"failed",cost:0,failedReason:u.message}),await Ds(e.DB,s,c),{phone:o.phone,status:"failed",error:u.message,cost:0}}}async function Es(e,s){const{accountId:r,templateId:t,recipients:a,variables:n}=s;console.log(`[Alimtalk] Starting bulk send: ${a.length} recipients`);try{const o=await e.DB.prepare(`
      SELECT 
        id,
        sender_key,
        balance,
  ...
  `).bind(s).run(),console.log(`[Push] Subscription deleted: ${s}`)}function Vt(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function Yt(e){return{name:"tosspayments",async confirmPayment(s){try{const r=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),t=await r.json();if(!r.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message||"결제 승인 실패",rawData:t};let a={};t.card&&(a={cardCompany:t.card.company,cardNumber:t.card.number,installmentMonths:t.card.installmentPlanMonths||0});let n={};return t.virtualAccount&&(n={virtualAccountBank:t.virtualAccount.bankCode,virtualAccountNumber:t.virtualAccount.accountNumber,virtualAccountHolder:t.virtualAccount.customerName,virtualAccountDueDate:t.virtualAccount.dueDate}),{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,transactionId:t.transactionKey,...a,...n,rawData:t}}catch(r){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message,rawData:null}}},async cancelPayment(s){try{const r={cancelReason:s.cancelReason};s.cancelAmount&&(r.cancelAmount=s.cancelAmount);const t=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(r)}),a=await t.json();return t.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(r){return{success:!1,error:r.message}}},async getPayment(s){try{const r=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),t=await r.json();if(!r.ok)throw new Error(t.message);return{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,rawData:t}}catch(r){throw r}}}}function Jt(e,s){switch(e.toLowerCase()){case"tosspayments":return Yt(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const d=new Xs;d.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{Yr(e.env),Jr(e.env)}catch(t){console.error("[ENV] Validation failed:",t)}await s()});async function ae(e,s){if(!s)return null;try{const r=await e.get(`session:${s}`);if(!r)return null;const t=JSON.parse(r);return t.expires_at&&Date.now()>t.expires_at?(await e.delete(`session:${s}`),null):{user_id:t.user_id,user_type:t.user_type||"user"}}catch(r){return console.error("[Auth] Session lookup error:",r),null}}async function W(e,s){var n;const{SESSION_KV:r}=e.env;let t=e.req.header("X-Session-Token");if(t||(t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","")),!t){const o=e.req.header("Cookie");if(o){const i=o.match(/session=([^;]+)/);t=i?i[1]:void 0}}const a=await ae(r,t);if(!a)return e.json({success:!1,error:"인증이 필요합니다. 로그인 해주세요."},401);try{if(t){const o=await r.get(`session:${t}`);if(o){const i=JSON.parse(o),c=i.expires_at-Date.now(),u=10080*60*1e3;if(c<u){const l=Date.now()+2592e6;await r.put(`session:${t}`,JSON.stringify({...i,expires_at:l}),{expirationTtl:720*60*60}),console.log("[Auth] ✅ Session auto-renewed for user:",a.user_id,"- New expiration:",new Date(l).toISOString())}}}}catch(o){console.error("[Auth] Session renewal error:",o)}e.set("userId",a.user_id),e.set("userType",a.user_type),await s()}async function hs(e,s){try{const r=await e.get(s);return r?JSON.parse(r):null}catch(r){return console.error("[Cache] Read error:",r),null}}async function gs(e,s,r,t=60){try{await e.put(s,JSON.stringify(r),{expirationTtl:t})}catch(a){console.error("[Cache] Write error:",a)}}async function ys(e,...s){try{await Promise.all(s.map(r=>e.delete(r)))}catch(r){console.error("[Cache] Delete error:",r)}}async function Je(e,s,r,t,a,n,o){try{await e.prepare(`
    ...
    `).bind(s,r,t,a,n,o||null).run(),console.log(`[Notification] Created for ${r} ${s}: ${a}`)}catch(i){console.error("[Notification] Create error:",i)}}async function zt(e,s,r,t,a){await Je(e,s,"seller","new_order","🛒 신규 주문이 접수되었습니다",`${t}님의 주문 (${r}) - ${Xt(a)}`,"/seller/orders")}async function rr(e,s,r,t,a,n){let o="",i="";switch(t){case"preparing":o="📦 상품 준비 중",i=`주문번호 ${r}의 상품을 준비하고 있습니다`;break;case"shipping":o="🚚 배송이 시작되었습니다",i=`주문번호 ${r}가 배송 중입니다`,a&&n&&(i+=` (${a}: ${n})`);break;case"delivered":o="✅ 배송 완료",i=`주문번호 ${r}가 배송 완료되었습니다`;break;default:return}await Je(e,s,"user","shipping_status",o,i,"/my-orders")}async function Gt(e,s,r,t,a){await Je(e,s,"seller","low_stock","⚠️ 재고 부족 알림",`${r}의 재고가 ${t}개로 부족합니다 (기준: ${a}개)`,"/seller/products")}function Xt(e){return new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW"}).format(e)}async function Qt(e,s,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const t=await fetch("https://www.googleapis.com/youtube/v3/liveBroadcasts?part=snippet,status,contentDetails",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:s,description:r,scheduledStartTime:new Date().toISOString()},status:{privacyStatus:"public",selfDeclaredMadeForKids:!1},contentDetails:{enableAutoStart:!0,enableAutoStop:!0}})});if(!t.ok){const p=await t.text();throw new Error(`YouTube Broadcast 생성 실패: ${p}`)}const n=(await t.json()).id,o=await fetch("https://www.googleapis.com/youtube/v3/liveStreams?part=snippet,cdn",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:`${s} - Stream`},cdn:{frameRate:"variable",ingestionType:"rtmp",resolution:"variable"}})});if(!o.ok){const p=await o.text();throw new Error(`YouTube Stream 생성 실패: ${p}`)}const i=await o.json(),c=i.id,u=i.cdn.ingestionInfo.streamName,l=i.cdn.ingestionInfo.ingestionAddress;return await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/bind?id=${n}&streamId=${c}&part=snippet`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}}),{broadcastId:n,streamId:c,streamKey:u,streamUrl:l}}catch(t){throw console.error("[YouTube API] Live broadcast creation failed:",t),t}}async function Zt(e,s){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const r=await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/transition?broadcastStatus=complete&id=${s}&part=status`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}});if(!r.ok){const t=await r.text();throw new Error(`YouTube 방송 종료 실패: ${t}`)}}catch(r){throw console.error("[YouTube API] Live broadcast end failed:",r),r}}async function ea(e,s,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{let t=`https://www.googleapis.com/youtube/v3/liveChat/messages?liveChatId=${s}&part=snippet,authorDetails`;r&&(t+=`&pageToken=${r}`);const a=await fetch(t,{headers:{Authorization:`Bearer ${e.accessToken}`}});if(!a.ok){const o=await a.text();throw new Error(`YouTube 채팅 메시지 가져오기 실패: ${o}`)}const n=await a.json();return{messages:n.items||[],nextPageToken:n.nextPageToken,pollingIntervalMillis:n.pollingIntervalMillis||5e3}}catch(t){throw console.error("[YouTube API] Get chat messages failed:",t),t}}async function sa(e,s){if(!e.apiKey&&!e.accessToken)throw new Error("YouTube API Key 또는 Access Token이 필요합니다");try{const r=e.accessToken?{Authorization:`Bearer ${e.accessToken}`}:{},t=e.accessToken?`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}`:`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}&key=${e.apiKey}`,a=await fetch(t,{headers:r});if(!a.ok){const u=await a.text();throw new Error(`YouTube 통계 가져오기 실패: ${u}`)}const n=await a.json();if(!n.items||n.items.length===0)throw new Error("Video not found");const o=n.items[0],i=o.statistics,c=o.liveStreamingDetails;return{viewCount:parseInt(i.viewCount||"0"),likeCount:parseInt(i.likeCount||"0"),commentCount:parseInt(i.commentCount||"0"),concurrentViewers:c!=null&&c.concurrentViewers?parseInt(c.concurrentViewers):void 0}}catch(r){throw console.error("[YouTube API] Get live stats failed:",r),r}}function tr(e){try{if(!/^https?:\/\//.test(e)&&/^[\w-]{11}$/.test(e))return e;const s=new URL(e);if(s.hostname.includes("youtube.com")){const r=s.searchParams.get("v");if(r)return r;const t=s.pathname.match(/\/(embed|live|shorts)\/([a-zA-Z0-9_-]{11})/);if(t)return t[2]}if(s.hostname==="youtu.be"){const r=s.pathname.slice(1).split("?")[0];if(r&&r.length===11)return r}return null}catch{return null}}function ar(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const r=s.pathname.match(/\/video\/(\d+)/);if(r)return r[1];const t=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(t)return t[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}function ra(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){if(s.pathname.includes("/live"))return"live";if(s.pathname.includes("/video/"))return"video"}return null}catch{return null}}function nr(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const r=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(r)return r[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}d.use("*",async(e,s)=>{await s(),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://t1.kakaocdn.net https://developers.kakao.com https://js.tosspayments.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net; img-src 'self' data: https: blob:; font-src 'self' data: https://cdn.jsdelivr.net; connect-src 'self' https://api.tosspayments.com https://kauth.kakao.com https://kapi.kakao.com https://www.youtube.com; frame-src 'self' https://www.youtube.com https://youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';");const r=new URL(e.req.url);r.hostname!=="localhost"&&r.protocol==="https:"&&e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("X-Frame-Options","SAMEORIGIN"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});d.use("/api/*",b());d.use(Ve(Ye.auth));d.use(Ve(Ye.alimtalk));d.use(Ve(Ye.order));d.use(Ve(Ye.upload));d.use("/api/*",Ve(Ye.api));d.use("/api/*",async(e,s)=>{const r=Date.now(),t=e.req.method,a=e.req.path;await s();const n=Date.now()-r,o=e.res.status,i={method:t,path:a,status:o,duration:n},c=e.get("userId");c&&(i.userId=c),Vt(i)});d.use("/static/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});d.use("/images/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});async function or(e,s,r,t){const a=crypto.randomUUID(),n=Date.now()+1440*60*1e3,o={user_id:s,user_type:r,userData:t,expires_at:n};return await e.put(`session:${a}`,JSON.stringify(o),{expirationTtl:86400}),console.log(`[createSession] ✅ Session created for ${r} user ${s}`),a}async function Me(e,s){const r=await e.get(`session:${s}`);if(!r)return null;const t=JSON.parse(r);return t.expires_at&&Date.now()>t.expires_at?(await e.delete(`session:${s}`),null):{session_token:s,[`${t.user_type}_id`]:t.user_id,user_type:t.user_type,...t.userData}}d.post("/api/auth/user/register",b(),mt(gt),async e=>{const{DB:s}=e.env;try{const{email:r,password:t,name:a,phone:n}=e.get("validatedData"),o=`placeholder_hash_for_${t}`;try{const c=(await s.prepare(`
      ...
      `).bind(c,r,u,a,n,o||null,i||null).run();return e.json({success:!0,data:{sellerId:l.meta.last_row_id,message:"회원가입이 완료되었습니다. 관리자 승인 후 로그인할 수 있습니다."}})}catch(l){const p=l.message||"";if(p.includes("UNIQUE")||p.includes("unique"))return e.json({success:!1,error:"이미 가입된 이메일입니다"},400);throw l}}catch(r){return console.error("Seller registration error:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/admin/login",b(),async e=>{const{DB:s}=e.env;try{const{email:r,password:t}=await e.req.json();if(!r||!t)return e.json({success:!1,error:"이메일과 비밀번호를 입력해주세요"},400);const a=await s.prepare("SELECT * FROM admins WHERE email = ?").bind(r).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(r==="admin@example.com"&&t==="admin123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${t}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);const i=await or(e.env.SESSION_KV,a.id,"admin",{username:a.username,email:a.email,name:a.name,role:a.role});return await s.prepare('UPDATE admins SET last_login_at = datetime("now") WHERE id = ?').bind(a.id).run(),e.json({success:!0,data:{token:i,admin:{id:a.id,username:a.username,email:a.email,name:a.name,role:a.role}}})}catch(r){return console.error("Admin login error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/auth/verify",b(),async e=>{const{DB:s}=e.env;try{const r=e.req.header("X-Session-Token");if(!r)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const t=await Me(e.env.SESSION_KV,r);if(!t)return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=t.user_type==="admin"?"admins":"sellers",n=t.user_type==="admin"?t.admin_id:t.seller_id,o=await s.prepare(`SELECT * FROM ${a} WHERE id = ?`).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:t.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name,role:o.role}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/auth/kakao/sync/callback",async e=>{var r,t,a,n,o,i,c,u,l,p,m,E,f;const{DB:s}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!s);const h=e.req.query("code"),y=e.req.query("state")||"/",w=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!h,state:y,error:w}),w)return console.error("[Kakao Sync] OAuth error:",w),e.redirect(`${y}?error=kakao_oauth_${w}`);if(!h)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${y}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const g=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",v=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",g.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",v),console.log("[Kakao Sync] Step 1: Fetching access token...");const k=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:g,redirect_uri:v,code:h})});if(console.log("[Kakao Sync] Token response status:",k.status),console.log("[Kakao Sync] Token request details:",{client_id:g,redirect_uri:v,code_length:h.length,code_prefix:h.substring(0,20)}),!k.ok){const B=await k.text();return console.error("[Kakao Sync] Token request failed:",B),e.redirect(`${y}?error=token_request_failed&detail=${encodeURIComponent(B)}`)}const L=await k.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!L.access_token,error:L.error,errorDescription:L.error_description}),!L.access_token)return console.error("[Kakao Sync] Token error:",L),e.redirect(`${y}?error=token_failed&detail=${encodeURIComponent(L.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const H=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${L.access_token}`}});console.log("[Kakao Sync] User response status:",H.status);const j=await H.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!j.id,id:j.id,hasNickname:!!((r=j.properties)!=null&&r.nickname||(a=(t=j.kakao_account)==null?void 0:t.profile)!=null&&a.nickname)}),!j.id)return console.error("[Kakao Sync] Failed to get user info:",j),e.redirect(`${y}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const D=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${L.access_token}`}});console.log("[Kakao Sync] Terms response status:",D.status);let R=null;if(D.ok?(R=await D.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=R.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=R.allowed_service_terms)==null?void 0:o.map(B=>B.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!s)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${y}?error=db_not_available`);const N=j.id.toString(),C=((i=j.properties)==null?void 0:i.nickname)||((u=(c=j.kakao_account)==null?void 0:c.profile)==null?void 0:u.nickname)||"Kakao User",q=((l=j.kakao_account)==null?void 0:l.email)||"",Y=((p=j.properties)==null?void 0:p.profile_image)||((E=(m=j.kakao_account)==null?void 0:m.profile)==null?void 0:E.profile_image_url)||"",X=L.access_token,Q=((f=R==null?void 0:R.allowed_service_terms)==null?void 0:f.map(B=>B.tag))||[],ws=JSON.stringify(Q);console.log("[Kakao Sync] User data:",{kakaoId:N,nickname:C,email:q?"exists":"none",serviceTerms:Q});try{const B=await s.prepare("SELECT * FROM users WHERE kakao_id = ?").bind(N).first();console.log("[Kakao Sync] Existing user check:",!!B);let J;B?(J=B.id,await s.prepare(`
          ...
          WHERE id = ?
        `).bind(C,q,Y,J).run(),console.log("[Kakao Sync] Updated user:",J)):(J=(await s.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/cart",W,async e=>{const{DB:s}=e.env,r=e.get("userId");try{const t=await s.prepare(`
      SELECT 
        ci.*,
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:`장바구니 조회 실패: ${t.message}`},500)}});d.get("/api/cart/:userId",W,async e=>{const{DB:s}=e.env,r=e.get("userId"),t=e.req.param("userId");try{let a=await s.prepare("SELECT id FROM users WHERE id = ?").bind(r).first();if(!a)return e.json({success:!1,error:"사용자를 찾을 수 없습니다."},404);const n=a.id;if(t!==String(n))return e.json({success:!1,error:"본인의 장바구니만 조회할 수 있습니다."},403);const o=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
        p.image_url as image_url,
    ...
    `).bind(r).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await s.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,r).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});d.post("/api/orders",async e=>{const{DB:s}=e.env;try{const r=await e.req.json(),{userId:t,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:u,recipientPhone:l,deliveryMemo:p,totalAmount:m,shippingFee:E,orderNumber:f,paymentKey:h,paymentMethod:y}=r;if(o&&o.length>0){const D=[];for(const K of o){const te=await s.prepare(`
      ...
      `).bind(Q,t||null,m||0,"pending","pending",ws||null,u||null,l||null,p||null,h||null).run()).meta.last_row_id;for(const K of D)await s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(J,K.product_id,K.option_id,K.quantity,K.price,K.product_name).run();return e.json({success:!0,data:{orderId:J,orderNumber:Q,totalAmount:m}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const w=a.map(()=>"?").join(","),g=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${w})
    `).bind(...a).all();if(g.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const D of g.results)if(D.product_stock<D.quantity)return e.json({success:!1,error:`Insufficient stock for ${D.product_name}`},400);const v=g.results.reduce((D,R)=>D+R.price_snapshot*R.quantity,0),k=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,H=(await s.prepare(`
      INSERT INTO orders (
        order_number, user_id, total_amount,
        shipping_address, shipping_name, shipping_phone
      ) VALUES (?, ?, ?, ?, ?, ?)
    `).bind(k,t,v,n.address,n.name,n.phone).run()).meta.last_row_id,j=[];for(const D of g.results){let R=!1,N="";for(let C=0;C<3;C++){if((await s.prepare(`
          UPDATE products 
          SET stock = stock - ?, 
              version = version + 1,
              updated_at = datetime('now')
          WHERE id = ? 
            AND stock >= ?
            AND is_active = 1
        `).bind(D.quantity,D.product_id,D.quantity).run()).meta.changes>0){R=!0;break}const Y=await s.prepare(`
          SELECT stock FROM products WHERE id = ?
        `).bind(D.product_id).first();if(!Y||Y.stock<D.quantity){N=`재고 부족: ${D.product_name} (남은 재고: ${(Y==null?void 0:Y.stock)||0}개)`;break}C<2?await new Promise(X=>setTimeout(X,50*C)):N="주문 처리 중 오류 발생. 다시 시도해주세요. (동시성 충돌)"}if(!R)return e.json({success:!1,error:N||"주문 처리 중 오류가 발생했습니다."},N.includes("재고 부족")?400:409);j.push(s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(H,D.product_id,D.option_id,D.quantity,D.price_snapshot,D.product_name))}j.push(s.prepare(`DELETE FROM cart_items WHERE id IN (${w})`).bind(...a)),await s.batch(j);try{const D=new Set;for(const R of g.results){const N=await s.prepare("SELECT seller_id FROM products WHERE id = ?").bind(R.product_id).first();N&&N.seller_id&&D.add(N.seller_id)}for(const R of D)await zt(s,R,k,buyerName||shippingName||"고객",v)}catch(D){console.error("[Order] Notification error:",D)}return e.json({success:!0,data:{orderId:H,orderNumber:k,totalAmount:v}})}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/api/streams/:streamId/current-product",async e=>{const{DB:s,LIVE_CACHE:r}=e.env,t=e.req.param("streamId");try{const a=`current-product:${t}`,n=await er(r,a,3);if(n)return e.json({success:!0,data:n});const o=await s.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(t).first();if(!o||!o.current_product_id)return await es(r,a,null,3),e.json({success:!0,data:null});const i=await s.prepare("SELECT * FROM products WHERE id = ?").bind(o.current_product_id).first(),c=await s.prepare("SELECT * FROM product_options WHERE product_id = ?").bind(o.current_product_id).all(),u={product:i,options:c.results};return await es(r,a,u,3),e.json({success:!0,data:u})}catch(a){return e.json({success:!1,error:a.message},500)}});d.get("/api/streams/:streamId/product-wait",async e=>{const{LIVE_CACHE:s}=e.env,r=e.req.param("streamId"),t=e.req.query("lastTimestamp")||"0";try{const a=`product-timestamp:${r}`,n=`current-product:${r}`,o=25e3,i=Date.now();for(;Date.now()-i<o;){const c=await s.get(a)||"0";if(c!==t){const u=await er(s,n,30);return e.json({success:!0,timestamp:c,data:u,changed:!0})}await new Promise(u=>setTimeout(u,1e3))}return e.json({success:!0,timestamp:t,data:null,changed:!1})}catch(a){return e.json({success:!1,error:a.message},500)}});d.get("/api/seller/dashboard/stats",async e=>{const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=r.sellerId,a=e.req.query("period")||"7d";let n=7;a==="30d"?n=30:a==="90d"&&(n=90);const o=await s.prepare(`
      SELECT 
    ...
    `).bind(t).all();return e.json({success:!0,data:a.results||[]})}catch(t){return console.error("Error loading seller streams:",t),e.json({success:!1,error:t.message},500)}});d.post("/api/seller/streams",async e=>{const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{title:t,description:a,youtube_video_id:n,youtube_url:o,thumbnail_url:i,scheduled_at:c,status:u,seller_instagram:l,seller_youtube:p,seller_facebook:m}=await e.req.json();let E=n,f="youtube",h=null,y=null,w=i;if(o&&!E&&(E=tr(o),!E))if(E=ar(o),h=nr(o),y=ra(o),E)f="tiktok";else return e.json({success:!1,error:"Invalid URL. Please provide a valid YouTube or TikTok live stream URL."},400);if(!w&&E&&f==="youtube"&&(w=`https://img.youtube.com/vi/${E}/maxresdefault.jpg`),!t||!E)return e.json({success:!1,error:"Title and live stream URL are required"},400);const g=await s.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, datetime('now'), datetime('now'))
    `).bind(t,a||null,E,u||"scheduled",c||null,r.sellerId,l||null,p||null,m||null,f,h,y,w||null).run(),v=await s.prepare("SELECT * FROM live_streams WHERE id = ?").bind(g.meta.last_row_id).first(),k=await s.prepare("SELECT display_name, username FROM sellers WHERE id = ?").bind(r.sellerId).first();try{const{sendLiveStreamCreatedEmail:L}=await Promise.resolve().then(()=>ia);L({streamId:g.meta.last_row_id,title:t,sellerName:(k==null?void 0:k.display_name)||(k==null?void 0:k.username)||"알 수 없음",platform:f,scheduledAt:c,status:u||"scheduled"}).then(H=>{H.success?console.log(`[Email] Live stream notification sent for stream #${H.meta.last_row_id}`):console.error("[Email] Failed to send notification:",H.error)}).catch(H=>{console.error("[Email] Exception while sending notification:",H)})}catch(L){console.error("[Email] Failed to send live stream notification:",L)}return e.json({success:!0,data:v})}catch(t){return e.json({success:!1,error:t.message},500)}});d.put("/api/seller/streams/:id",async e=>{const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id");if(!await s.prepare("SELECT id FROM live_streams WHERE id = ? AND seller_id = ?").bind(t,r.sellerId).first())return e.json({success:!1,error:"Stream not found or unauthorized"},404);const{title:n,description:o,youtube_video_id:i,youtube_url:c,scheduled_at:u,status:l,seller_instagram:p,seller_youtube:m,seller_facebook:E}=await e.req.json(),f=[],h=[];if(n!==void 0&&(f.push("title = ?"),h.push(n)),o!==void 0&&(f.push("description = ?"),h.push(o)),c!==void 0||i!==void 0){let y=i,w="youtube",g=null;if(c&&(y=tr(c),!y))if(y=ar(c),g=nr(c),y)w="tiktok";else return e.json({success:!1,error:"Invalid URL. Please provide a valid YouTube or TikTok video URL."},400);y!==void 0&&(f.push("youtube_video_id = ?"),h.push(y),f.push("platform = ?"),h.push(w),w==="tiktok"&&g&&(f.push("tiktok_username = ?"),h.push(g)))}return l!==void 0&&(f.push("status = ?"),h.push(l)),u!==void 0&&(f.push("scheduled_at = ?"),h.push(u)),p!==void 0&&(f.push("seller_instagram = ?"),h.push(p)),m!==void 0&&(f.push("seller_youtube = ?"),h.push(m)),E!==void 0&&(f.push("seller_facebook = ?"),h.push(E)),f.length===0?e.json({success:!1,error:"No fields to update"},400):(f.push("updated_at = datetime('now')"),await s.prepare(`
    ...
    `).all();return e.json({success:!0,data:t.results||[]})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/orders",W,async e=>{const{DB:s}=e.env,r=e.get("userId");try{const t=await s.prepare("SELECT * FROM orders WHERE user_id = ? ORDER BY created_at DESC").bind(r).all(),a=await Promise.all(t.results.map(async n=>{const o=await s.prepare(`
          SELECT oi.*, p.name as product_name, p.image_url
          FROM order_items oi
          LEFT JOIN products p ON oi.product_id = p.id
          WHERE oi.order_id = ?
        `).bind(n.id).all();return{...n,items:o.results}}));return e.json({success:!0,data:a})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/orders/user/:userId",W,async e=>{const{DB:s}=e.env,r=e.get("userId"),t=parseInt(e.req.param("userId"));try{if(t!==r)return e.json({success:!1,error:"본인의 주문 내역만 조회할 수 있습니다."},403);const a=await s.prepare("SELECT * FROM orders WHERE user_id = ? ORDER BY created_at DESC").bind(r).all(),n=await Promise.all(a.results.map(async o=>{const i=await s.prepare(`
          SELECT oi.*, p.name as product_name, p.image_url
          FROM order_items oi
          LEFT JOIN products p ON oi.product_id = p.id
          WHERE oi.order_id = ?
...
`),E=new Date,f=`orders_${E.toISOString().split("T")[0]}_${E.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(t){return console.error("Export error:",t),e.json({success:!1,error:t.message},500)}});d.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(t).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,r.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,t).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${t}, 자동 발행 시작...`);const c=await s.prepare(`
        ...
        `).bind(t).first();if(c!=null&&c.buyer_business_number&&(c!=null&&c.buyer_business_name)){console.log(`[AUTO TAX INVOICE] 사업자 구매 확인: ${c.buyer_business_number}`);const u=await s.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(r.sellerId).first();if(!u)console.warn(`[AUTO TAX INVOICE] 판매자 사업자 정보 미승인: seller_id=${r.sellerId}`),await s.prepare(`
            ...
            `).bind(r.sellerId,t,y,u.business_number,u.business_name,u.ceo_name,u.address||"",u.business_type||"",u.business_category||"",u.email||"",u.phone||"",c.buyer_business_number,c.buyer_business_name,c.buyer_ceo_name||"",c.buyer_business_address||"",c.buyer_business_type||"",c.buyer_business_category||"",c.buyer_email||"",c.buyer_phone||"",m,E,p,`AUTO-${Date.now()}-${h}`).run()).meta.last_row_id;for(const v of l.results){const k=Math.floor(Number(v.price)*Number(v.quantity)/1.1),L=Number(v.price)*Number(v.quantity)-k;await s.prepare(`
                INSERT INTO tax_invoice_items (
                  tax_invoice_id, product_name, quantity, unit_price,
                  supply_price, tax_amount, description, created_at
                ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
              `).bind(g,v.product_name||"상품명 없음",v.quantity,v.price,k,L,v.option_name||"").run()}await s.prepare(`
...
`});const E="\uFEFF";return new Response(E+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(t){return console.error("CSV 내보내기 실패:",t),e.json({success:!1,error:t.message},500)}});d.post("/api/orders/create",async e=>{const{DB:s}=e.env;try{const{userId:r,cartItems:t,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:u,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:r,cartItems:t==null?void 0:t.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let p=10;if(o){const R=await s.prepare(`
      ...
      `).bind(n,r).first();if(!R)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);f=R}if(!r)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const h=r,y=new Date,w=y.getFullYear().toString().slice(-2),g=(y.getMonth()+1).toString().padStart(2,"0"),v=y.getDate().toString().padStart(2,"0"),k=`${w}${g}${v}`,L=Math.random().toString(36).substring(2,7).toUpperCase(),H=`ORD-${k}-${L}`;for(const R of t){const N=await s.prepare(`
        SELECT stock FROM products WHERE id = ?
    ...
    `).bind(H,h,a,"pending",o||null,p,m,E,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,u||null,l||null).run()).meta.last_row_id;for(const R of t){await s.prepare(`
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_number:t}=await e.req.json();if(!t)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(r.sellerId,t,"tax",p,l,n.business_number,n.business_name,n.ceo_name,n.address,n.business_type,n.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,c,u,i,f==="FAILED"?"failed":"issued",Pe()?"mock":"barobill",h,f).run()).meta.last_row_id;for(const g of o.results){const v=Math.floor(Number(g.price)*Number(g.quantity)/1.1),k=Number(g.price)*Number(g.quantity)-v;await s.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, order_item_id, product_name, quantity,
          unit_price, supply_price, tax_amount, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
      `).bind(w,g.id,g.product_name,g.quantity,g.price,v,k).run()}return e.json({success:!0,data:{invoice_id:w,invoice_number:p,issue_date:l,total_amount:i,supply_price:c,tax_amount:u,status:f==="FAILED"?"failed":"issued",nts_confirm_number:f,api_invoice_key:h,mock_mode:Pe(),message:f==="FAILED"?"바로빌 API 호출 실패. 나중에 다시 시도해주세요.":Pe()?"세금계산서가 발행되었습니다. (Mock Mode - 실제 발행 아님)":"세금계산서가 발행되었습니다."}})}catch(t){return console.error("세금계산서 발행 오류:",t),e.json({success:!1,error:t.message},500)}});d.get("/api/seller/tax-invoices",async e=>{var t;const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{start_date:a,end_date:n,status:o}=e.req.query();let i=`
    ...
    `).bind(t).all();return e.json({success:!0,data:{...a,items:n.results||[]}})}catch(t){return e.json({success:!1,error:t.message},500)}});d.post("/api/seller/tax-invoices/:id/cancel",async e=>{const{DB:s}=e.env,r=await O(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id"),{reason:a}=await e.req.json(),n=await s.prepare(`
      SELECT * FROM tax_invoices WHERE id = ? AND seller_id = ?
    `).bind(t,r.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!Pe()){const u=await s.prepare(`
    ...
    `).bind(r.sellerId,t,f,i.business_number,i.business_name,i.ceo_name,i.address||"",i.business_type||"",i.business_category||"",i.email||"",i.phone||"",o.buyer_business_number,o.buyer_business_name,o.buyer_ceo_name||"",o.buyer_business_address||"",o.buyer_business_type||"",o.buyer_business_category||"",o.buyer_email||"",o.buyer_phone||"",l,p,u,`RETRY-${Date.now()}-${E}`).run()).meta.last_row_id;for(const w of c.results){const g=Math.floor(Number(w.price)*Number(w.quantity)/1.1),v=Number(w.price)*Number(w.quantity)-g;await s.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, product_name, quantity, unit_price,
          supply_price, tax_amount, description, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
      `).bind(y,w.product_name||"상품명 없음",w.quantity,w.price,g,v,w.option_name||"").run()}return await s.prepare(`
  ...
  `,500)});d.get("/api/admin/alimtalk/pricing",b(),async e=>{const{env:s}=e;try{const r=await s.DB.prepare(`
    ...
    `).bind(r||"2000-01-01",t||"2100-01-01").first(),n=await s.DB.prepare(`
      ...
      LIMIT 10
    `).bind(r||"2000-01-01",t||"2100-01-01").all();return e.json({success:!0,statistics:{total:a,by_seller:n.results}})}catch(r){return console.error("[Admin Alimtalk Statistics] Error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/seller/alimtalk/account",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const a=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts
      WHERE seller_id = ?
    `).bind(t.user_id).first();return e.json({success:!0,account:a})}catch(r){return console.error("[Seller Alimtalk Account] Error:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/seller/alimtalk/register",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{channel_id:a,phone_number:n}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Missing required fields"},400);const o=sr(n),i=await yt(s,{channelId:a,phoneNumber:o});if(!i.success)return e.json({success:!1,error:"Failed to register Kakao channel"},500);const c=await s.DB.prepare(`
      INSERT INTO alimtalk_accounts 
      (seller_id, kakao_channel_id, channel_name, sender_key, phone_number, status)
      VALUES (?, ?, ?, ?, ?, 'active')
    `).bind(t.user_id,a,a,i.senderKey,o).run();return e.json({success:!0,account_id:c.meta.last_row_id,sender_key:i.senderKey,message:"Kakao channel registered successfully"})}catch(r){return console.error("[Seller Alimtalk Register] Error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/seller/alimtalk/templates",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const a=await s.DB.prepare(`
    ...
    `).bind(t.user_id).first();if(!a)return e.json({success:!1,error:"Alimtalk account not found"},404);const n=await s.DB.prepare(`
      ...
      WHERE account_id = ?
      ORDER BY created_at DESC
    `).bind(a.id).all();return e.json({success:!0,templates:n.results})}catch(r){return console.error("[Seller Alimtalk Templates] Error:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/seller/alimtalk/templates",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{template_code:a,template_name:n,template_content:o,template_type:i}=await e.req.json();if(!a||!n||!o)return e.json({success:!1,error:"Missing required fields"},400);const c=await s.DB.prepare(`
    ...
    `).bind(c.id,a,n,o,i||"basic").run();return e.json({success:!0,template_id:l.meta.last_row_id,message:"Template registered successfully. Approval pending (1-2 days)"})}catch(r){return console.error("[Seller Alimtalk Template Register] Error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/seller/alimtalk/pricing",b(),async e=>{const{env:s}=e;try{const r=await s.DB.prepare(`
      ...
      ORDER BY min_quantity ASC
    `).all();return e.json({success:!0,pricing:r.results})}catch(r){return console.error("[Seller Alimtalk Pricing] Error:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/seller/alimtalk/charge",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{amount:a,pricing_id:n}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Missing required fields"},400);const o=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
    ...
    `).bind(a,c.id).first();if(!u)return e.json({success:!1,error:"Template not found or not approved"},404);const l=bt(u.template_content,o||{}),p=sr(n),m=await fs(s,{senderKey:c.sender_key,templateCode:u.template_code,to:p,message:l});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(c.id,a,i||null,p,l,15,m.messageId).run();return await s.DB.prepare(`
      ...
      SET balance = balance - 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(c.id).run(),e.json({success:!0,message_id:E.meta.last_row_id,aligo_message_id:m.messageId,status:"sent",remaining_balance:c.balance-1})}catch(r){return console.error("[Seller Alimtalk Send] Error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/seller/alimtalk/messages",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{page:a="1",limit:n="20",status:o}=e.req.query(),i=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
    ...
    `).bind(i.id).first();return e.json({success:!0,messages:p.results,pagination:{total:m.total,page:parseInt(a),limit:parseInt(n)}})}catch(r){return console.error("[Seller Alimtalk Messages] Error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/seller/alimtalk/statistics",b(),async e=>{const{env:s}=e;try{const r=e.req.header("X-Session-Token"),t=await ae(s,r);if(!t||t.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{start_date:a,end_date:n}=e.req.query(),o=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
    `).bind(t.user_id).first();if(!o)return e.json({success:!1,error:"Alimtalk account not found"},404);const i=await s.DB.prepare(`
      SELECT 
        COUNT(*) as total_sent,
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return cr({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${r}`,htmlContent:u,textContent:l})}const ia=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:cr,sendLiveStreamCreatedEmail:oa},Symbol.toStringTag,{value:"Module"}));export{Ns as default};
