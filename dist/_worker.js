var Zt=Object.defineProperty;var Ks=e=>{throw TypeError(e)};var er=(e,s,t)=>s in e?Zt(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t;var v=(e,s,t)=>er(e,typeof s!="symbol"?s+"":s,t),Rs=(e,s,t)=>s.has(e)||Ks("Cannot "+t);var h=(e,s,t)=>(Rs(e,s,"read from private field"),t?t.call(e):s.get(e)),k=(e,s,t)=>s.has(e)?Ks("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,t),I=(e,s,t,r)=>(Rs(e,s,"write to private field"),r?r.call(e,t):s.set(e,t),t),j=(e,s,t)=>(Rs(e,s,"access private method"),t);var Vs=(e,s,t,r)=>({set _(a){I(e,s,a,t)},get _(){return h(e,s,r)}});var Ys=(e,s,t)=>(r,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,l=!1,u;if(e[i]?(u=e[i][0][0],r.req.routeIndex=i):u=i===e.length&&a||void 0,u)try{c=await u(r,()=>o(i+1))}catch(d){if(d instanceof Error&&s)r.error=d,c=await s(d,r),l=!0;else throw d}else r.finalized===!1&&t&&(c=await t(r));return c&&(r.finalized===!1||l)&&(r.res=c),r}},sr=Symbol(),tr=async(e,s=Object.create(null))=>{const{all:t=!1,dot:r=!1}=s,n=(e instanceof wt?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?rr(e,{all:t,dot:r}):{}};async function rr(e,s){const t=await e.formData();return t?ar(t,s):{}}function ar(e,s){const t=Object.create(null);return e.forEach((r,a)=>{s.all||a.endsWith("[]")?nr(t,a,r):t[a]=r}),s.dot&&Object.entries(t).forEach(([r,a])=>{r.includes(".")&&(or(t,r,a),delete t[r])}),t}var nr=(e,s,t)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(t):e[s]=[e[s],t]:s.endsWith("[]")?e[s]=[t]:e[s]=t},or=(e,s,t)=>{let r=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?r[n]=t:((!r[n]||typeof r[n]!="object"||Array.isArray(r[n])||r[n]instanceof File)&&(r[n]=Object.create(null)),r=r[n])})},ft=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},ir=e=>{const{groups:s,path:t}=cr(e),r=ft(t);return lr(r,s)},cr=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(t,r)=>{const a=`@${r}`;return s.push([a,t]),a}),{groups:s,path:e}},lr=(e,s)=>{for(let t=s.length-1;t>=0;t--){const[r]=s[t];for(let a=e.length-1;a>=0;a--)if(e[a].includes(r)){e[a]=e[a].replace(r,s[t][1]);break}}return e},fs={},ur=(e,s)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const r=`${e}#${s}`;return fs[r]||(t[2]?fs[r]=s&&s[0]!==":"&&s[0]!=="*"?[r,t[1],new RegExp(`^${t[2]}(?=/${s})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:fs[r]=[e,t[1],!0]),fs[r]}return null},Cs=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return s(t)}catch{return t}})}},dr=e=>Cs(e,decodeURI),ht=e=>{const s=e.url,t=s.indexOf("/",s.indexOf(":")+4);let r=t;for(;r<s.length;r++){const a=s.charCodeAt(r);if(a===37){const n=s.indexOf("?",r),o=s.indexOf("#",r),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(t,i);return dr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(t,r)},pr=e=>{const s=ht(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},$e=(e,s,...t)=>(t.length&&(s=$e(s,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),Et=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),t=[];let r="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))r+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){t.length===0&&r===""?t.push("/"):t.push(r);const n=a.replace("?","");r+="/"+n,t.push(r)}else r+="/"+a}),t.filter((a,n,o)=>o.indexOf(a)===n)},Is=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Cs(e,yt):e):e,gt=(e,s,t)=>{let r;if(!t&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,l=e.indexOf("&",c);return Is(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(r=/[%+]/.test(e),!r)return}const a={};r??(r=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(r&&(c=Is(c)),n=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),r&&(l=Is(l))),t?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(l)):a[c]??(a[c]=l)}return s?a[s]:a},mr=gt,_r=(e,s)=>gt(e,s,!0),yt=decodeURIComponent,Js=e=>Cs(e,yt),xe,Z,_e,St,bt,Ns,he,lt,wt=(lt=class{constructor(e,s="/",t=[[]]){k(this,_e);v(this,"raw");k(this,xe);k(this,Z);v(this,"routeIndex",0);v(this,"path");v(this,"bodyCache",{});k(this,he,e=>{const{bodyCache:s,raw:t}=this,r=s[e];if(r)return r;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=t[e]()});this.raw=e,this.path=s,I(this,Z,t),I(this,xe,{})}param(e){return e?j(this,_e,St).call(this,e):j(this,_e,bt).call(this)}query(e){return mr(this.url,e)}queries(e){return _r(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((t,r)=>{s[r]=t}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await tr(this,e))}json(){return h(this,he).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,he).call(this,"text")}arrayBuffer(){return h(this,he).call(this,"arrayBuffer")}blob(){return h(this,he).call(this,"blob")}formData(){return h(this,he).call(this,"formData")}addValidatedData(e,s){h(this,xe)[e]=s}valid(e){return h(this,xe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[sr](){return h(this,Z)}get matchedRoutes(){return h(this,Z)[0].map(([[,e]])=>e)}get routePath(){return h(this,Z)[0].map(([[,e]])=>e)[this.routeIndex].path}},xe=new WeakMap,Z=new WeakMap,_e=new WeakSet,St=function(e){const s=h(this,Z)[0][this.routeIndex][1][e],t=j(this,_e,Ns).call(this,s);return t&&/\%/.test(t)?Js(t):t},bt=function(){const e={},s=Object.keys(h(this,Z)[0][this.routeIndex][1]);for(const t of s){const r=j(this,_e,Ns).call(this,h(this,Z)[0][this.routeIndex][1][t]);r!==void 0&&(e[t]=/\%/.test(r)?Js(r):r)}return e},Ns=function(e){return h(this,Z)[1]?h(this,Z)[1][e]:e},he=new WeakMap,lt),fr={Stringify:1},Tt=async(e,s,t,r,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Tt(c,s,!1,r,a))).then(()=>a[0]))):Promise.resolve(e)},hr="text/plain; charset=UTF-8",vs=(e,s)=>({"Content-Type":e,...s}),Le=(e,s)=>new Response(e,s),as,ns,ue,He,de,X,os,Fe,Be,Re,is,cs,ne,Ue,js,ut,Er=(ut=class{constructor(e,s){k(this,ne);k(this,as);k(this,ns);v(this,"env",{});k(this,ue);v(this,"finalized",!1);v(this,"error");k(this,He);k(this,de);k(this,X);k(this,os);k(this,Fe);k(this,Be);k(this,Re);k(this,is);k(this,cs);v(this,"render",(...e)=>(h(this,Fe)??I(this,Fe,s=>this.html(s)),h(this,Fe).call(this,...e)));v(this,"setLayout",e=>I(this,os,e));v(this,"getLayout",()=>h(this,os));v(this,"setRenderer",e=>{I(this,Fe,e)});v(this,"header",(e,s,t)=>{this.finalized&&I(this,X,Le(h(this,X).body,h(this,X)));const r=h(this,X)?h(this,X).headers:h(this,Re)??I(this,Re,new Headers);s===void 0?r.delete(e):t!=null&&t.append?r.append(e,s):r.set(e,s)});v(this,"status",e=>{I(this,He,e)});v(this,"set",(e,s)=>{h(this,ue)??I(this,ue,new Map),h(this,ue).set(e,s)});v(this,"get",e=>h(this,ue)?h(this,ue).get(e):void 0);v(this,"newResponse",(...e)=>j(this,ne,Ue).call(this,...e));v(this,"body",(e,s,t)=>j(this,ne,Ue).call(this,e,s,t));v(this,"text",(e,s,t)=>j(this,ne,js).call(this)&&!s&&!t?Le(e):j(this,ne,Ue).call(this,e,s,vs(hr,t)));v(this,"json",(e,s,t)=>j(this,ne,js).call(this)&&!s&&!t?Response.json(e):j(this,ne,Ue).call(this,JSON.stringify(e),s,vs("application/json",t)));v(this,"html",(e,s,t)=>{const r=a=>j(this,ne,Ue).call(this,a,s,vs("text/html; charset=UTF-8",t));return typeof e=="object"?Tt(e,fr.Stringify,!1,{}).then(r):r(e)});v(this,"redirect",(e,s)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,s??302)});v(this,"notFound",()=>(h(this,Be)??I(this,Be,()=>Le()),h(this,Be).call(this,this)));I(this,as,e),s&&(I(this,de,s.executionCtx),this.env=s.env,I(this,Be,s.notFoundHandler),I(this,cs,s.path),I(this,is,s.matchResult))}get req(){return h(this,ns)??I(this,ns,new wt(h(this,as),h(this,cs),h(this,is))),h(this,ns)}get event(){if(h(this,de)&&"respondWith"in h(this,de))return h(this,de);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,de))return h(this,de);throw Error("This context has no ExecutionContext")}get res(){return h(this,X)||I(this,X,Le(null,{headers:h(this,Re)??I(this,Re,new Headers)}))}set res(e){if(h(this,X)&&e){e=Le(e.body,e);for(const[s,t]of h(this,X).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const r=h(this,X).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of r)e.headers.append("set-cookie",a)}else e.headers.set(s,t)}I(this,X,e),this.finalized=!0}get var(){return h(this,ue)?Object.fromEntries(h(this,ue)):{}}},as=new WeakMap,ns=new WeakMap,ue=new WeakMap,He=new WeakMap,de=new WeakMap,X=new WeakMap,os=new WeakMap,Fe=new WeakMap,Be=new WeakMap,Re=new WeakMap,is=new WeakMap,cs=new WeakMap,ne=new WeakSet,Ue=function(e,s,t){const r=h(this,X)?new Headers(h(this,X).headers):h(this,Re)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?r.append(o,i):r.set(o,i)}if(t)for(const[n,o]of Object.entries(t))if(typeof o=="string")r.set(n,o);else{r.delete(n);for(const i of o)r.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??h(this,He);return Le(e,{status:a,headers:r})},js=function(){return!h(this,Re)&&!h(this,He)&&!this.finalized},ut),V="ALL",gr="all",yr=["get","post","put","delete","options","patch"],Rt="Can not add a route since the matcher is already built.",It=class extends Error{},wr="__COMPOSED_HANDLER",Sr=e=>e.text("404 Not Found",404),zs=(e,s)=>{if("getResponse"in e){const t=e.getResponse();return s.newResponse(t.body,t)}return console.error(e),s.text("Internal Server Error",500)},te,Y,vt,re,be,hs,Es,We,br=(We=class{constructor(s={}){k(this,Y);v(this,"get");v(this,"post");v(this,"put");v(this,"delete");v(this,"options");v(this,"patch");v(this,"all");v(this,"on");v(this,"use");v(this,"router");v(this,"getPath");v(this,"_basePath","/");k(this,te,"/");v(this,"routes",[]);k(this,re,Sr);v(this,"errorHandler",zs);v(this,"onError",s=>(this.errorHandler=s,this));v(this,"notFound",s=>(I(this,re,s),this));v(this,"fetch",(s,...t)=>j(this,Y,Es).call(this,s,t[1],t[0],s.method));v(this,"request",(s,t,r,a)=>s instanceof Request?this.fetch(t?new Request(s,t):s,r,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${$e("/",s)}`,t),r,a)));v(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(j(this,Y,Es).call(this,s.request,s,void 0,s.request.method))})});[...yr,gr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?I(this,te,o):j(this,Y,be).call(this,n,h(this,te),o),i.forEach(c=>{j(this,Y,be).call(this,n,h(this,te),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){I(this,te,c);for(const l of[n].flat())i.map(u=>{j(this,Y,be).call(this,l.toUpperCase(),h(this,te),u)})}return this},this.use=(n,...o)=>(typeof n=="string"?I(this,te,n):(I(this,te,"*"),o.unshift(n)),o.forEach(i=>{j(this,Y,be).call(this,V,h(this,te),i)}),this);const{strict:r,...a}=s;Object.assign(this,a),this.getPath=r??!0?s.getPath??ht:pr}route(s,t){const r=this.basePath(s);return t.routes.map(a=>{var o;let n;t.errorHandler===zs?n=a.handler:(n=async(i,c)=>(await Ys([],t.errorHandler)(i,()=>a.handler(i,c))).res,n[wr]=a.handler),j(o=r,Y,be).call(o,a.method,a.path,n)}),this}basePath(s){const t=j(this,Y,vt).call(this);return t._basePath=$e(this._basePath,s),t}mount(s,t,r){let a,n;r&&(typeof r=="function"?n=r:(n=r.optionHandler,r.replaceRequest===!1?a=c=>c:a=r.replaceRequest));const o=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};a||(a=(()=>{const c=$e(this._basePath,s),l=c==="/"?0:c.length;return u=>{const d=new URL(u.url);return d.pathname=d.pathname.slice(l)||"/",new Request(d,u)}})());const i=async(c,l)=>{const u=await t(a(c.req.raw),...o(c));if(u)return u;await l()};return j(this,Y,be).call(this,V,$e(s,"*"),i),this}},te=new WeakMap,Y=new WeakSet,vt=function(){const s=new We({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,I(s,re,h(this,re)),s.routes=this.routes,s},re=new WeakMap,be=function(s,t,r){s=s.toUpperCase(),t=$e(this._basePath,t);const a={basePath:this._basePath,path:t,method:s,handler:r};this.router.add(s,t,[r,a]),this.routes.push(a)},hs=function(s,t){if(s instanceof Error)return this.errorHandler(s,t);throw s},Es=function(s,t,r,a){if(a==="HEAD")return(async()=>new Response(null,await j(this,Y,Es).call(this,s,t,r,"GET")))();const n=this.getPath(s,{env:r}),o=this.router.match(a,n),i=new Er(s,{path:n,matchResult:o,env:r,executionCtx:t,notFoundHandler:h(this,re)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await h(this,re).call(this,i)})}catch(u){return j(this,Y,hs).call(this,u,i)}return l instanceof Promise?l.then(u=>u||(i.finalized?i.res:h(this,re).call(this,i))).catch(u=>j(this,Y,hs).call(this,u,i)):l??h(this,re).call(this,i)}const c=Ys(o[0],this.errorHandler,h(this,re));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return j(this,Y,hs).call(this,l,i)}})()},We),Dt=[];function Tr(e,s){const t=this.buildAllMatchers(),r=((a,n)=>{const o=t[a]||t[V],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],Dt];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=r,r(e,s)}var ys="[^/]+",es=".*",ss="(?:|/.*)",qe=Symbol(),Rr=new Set(".\\+*[^]$()");function Ir(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===es||e===ss?1:s===es||s===ss?-1:e===ys?1:s===ys?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var Ie,ve,ae,Ae,vr=(Ae=class{constructor(){k(this,Ie);k(this,ve);k(this,ae,Object.create(null))}insert(s,t,r,a,n){if(s.length===0){if(h(this,Ie)!==void 0)throw qe;if(n)return;I(this,Ie,t);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",es]:["","",ys]:o==="/*"?["","",ss]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let d=c[2]||ys;if(u&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw qe;if(l=h(this,ae)[d],!l){if(Object.keys(h(this,ae)).some(m=>m!==es&&m!==ss))throw qe;if(n)return;l=h(this,ae)[d]=new Ae,u!==""&&I(l,ve,a.varIndex++)}!n&&u!==""&&r.push([u,h(l,ve)])}else if(l=h(this,ae)[o],!l){if(Object.keys(h(this,ae)).some(u=>u.length>1&&u!==es&&u!==ss))throw qe;if(n)return;l=h(this,ae)[o]=new Ae}l.insert(i,t,r,a,n)}buildRegExpStr(){const t=Object.keys(h(this,ae)).sort(Ir).map(r=>{const a=h(this,ae)[r];return(typeof h(a,ve)=="number"?`(${r})@${h(a,ve)}`:Rr.has(r)?`\\${r}`:r)+a.buildRegExpStr()});return typeof h(this,Ie)=="number"&&t.unshift(`#${h(this,Ie)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},Ie=new WeakMap,ve=new WeakMap,ae=new WeakMap,Ae),Ss,ls,dt,Dr=(dt=class{constructor(){k(this,Ss,{varIndex:0});k(this,ls,new vr)}insert(e,s,t){const r=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return a[o]=[l,c],o++,i=!0,l}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return h(this,ls).insert(n,s,r,h(this,Ss),t),r}buildRegExp(){let e=h(this,ls).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const t=[],r=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(t[++s]=Number(n),"$()"):(o!==void 0&&(r[Number(o)]=++s),"")),[new RegExp(`^${e}`),t,r]}},Ss=new WeakMap,ls=new WeakMap,dt),Or=[/^$/,[],Object.create(null)],gs=Object.create(null);function Ot(e){return gs[e]??(gs[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function Ar(){gs=Object.create(null)}function kr(e){var l;const s=new Dr,t=[];if(e.length===0)return Or;const r=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,d],[m,_])=>u?1:m?-1:d.length-_.length),a=Object.create(null);for(let u=0,d=-1,m=r.length;u<m;u++){const[_,f,g]=r[u];_?a[f]=[g.map(([w])=>[w,Object.create(null)]),Dt]:d++;let S;try{S=s.insert(f,d,_)}catch(w){throw w===qe?new It(f):w}_||(t[d]=g.map(([w,E])=>{const T=Object.create(null);for(E-=1;E>=0;E--){const[y,R]=S[E];T[y]=R}return[w,T]}))}const[n,o,i]=s.buildRegExp();for(let u=0,d=t.length;u<d;u++)for(let m=0,_=t[u].length;m<_;m++){const f=(l=t[u][m])==null?void 0:l[1];if(!f)continue;const g=Object.keys(f);for(let S=0,w=g.length;S<w;S++)f[g[S]]=i[f[g[S]]]}const c=[];for(const u in o)c[u]=t[o[u]];return[n,c,a]}function Me(e,s){if(e){for(const t of Object.keys(e).sort((r,a)=>a.length-r.length))if(Ot(t).test(s))return[...e[t]]}}var Ee,ge,bs,At,pt,Nr=(pt=class{constructor(){k(this,bs);v(this,"name","RegExpRouter");k(this,Ee);k(this,ge);v(this,"match",Tr);I(this,Ee,{[V]:Object.create(null)}),I(this,ge,{[V]:Object.create(null)})}add(e,s,t){var i;const r=h(this,Ee),a=h(this,ge);if(!r||!a)throw new Error(Rt);r[e]||[r,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[V]).forEach(l=>{c[e][l]=[...c[V][l]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=Ot(s);e===V?Object.keys(r).forEach(l=>{var u;(u=r[l])[s]||(u[s]=Me(r[l],s)||Me(r[V],s)||[])}):(i=r[e])[s]||(i[s]=Me(r[e],s)||Me(r[V],s)||[]),Object.keys(r).forEach(l=>{(e===V||e===l)&&Object.keys(r[l]).forEach(u=>{c.test(u)&&r[l][u].push([t,n])})}),Object.keys(a).forEach(l=>{(e===V||e===l)&&Object.keys(a[l]).forEach(u=>c.test(u)&&a[l][u].push([t,n]))});return}const o=Et(s)||[s];for(let c=0,l=o.length;c<l;c++){const u=o[c];Object.keys(a).forEach(d=>{var m;(e===V||e===d)&&((m=a[d])[u]||(m[u]=[...Me(r[d],u)||Me(r[V],u)||[]]),a[d][u].push([t,n-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,ge)).concat(Object.keys(h(this,Ee))).forEach(s=>{e[s]||(e[s]=j(this,bs,At).call(this,s))}),I(this,Ee,I(this,ge,void 0)),Ar(),e}},Ee=new WeakMap,ge=new WeakMap,bs=new WeakSet,At=function(e){const s=[];let t=e===V;return[h(this,Ee),h(this,ge)].forEach(r=>{const a=r[e]?Object.keys(r[e]).map(n=>[n,r[e][n]]):[];a.length!==0?(t||(t=!0),s.push(...a)):e!==V&&s.push(...Object.keys(r[V]).map(n=>[n,r[V][n]]))}),t?kr(s):null},pt),ye,pe,mt,jr=(mt=class{constructor(e){v(this,"name","SmartRouter");k(this,ye,[]);k(this,pe,[]);I(this,ye,e.routers)}add(e,s,t){if(!h(this,pe))throw new Error(Rt);h(this,pe).push([e,s,t])}match(e,s){if(!h(this,pe))throw new Error("Fatal error");const t=h(this,ye),r=h(this,pe),a=t.length;let n=0,o;for(;n<a;n++){const i=t[n];try{for(let c=0,l=r.length;c<l;c++)i.add(...r[c]);o=i.match(e,s)}catch(c){if(c instanceof It)continue;throw c}this.match=i.match.bind(i),I(this,ye,[i]),I(this,pe,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(h(this,pe)||h(this,ye).length!==1)throw new Error("No active router has been determined yet.");return h(this,ye)[0]}},ye=new WeakMap,pe=new WeakMap,mt),Xe=Object.create(null),Cr=e=>{for(const s in e)return!0;return!1},we,G,De,Ke,z,me,Te,Ve,Lr=(Ve=class{constructor(s,t,r){k(this,me);k(this,we);k(this,G);k(this,De);k(this,Ke,0);k(this,z,Xe);if(I(this,G,r||Object.create(null)),I(this,we,[]),s&&t){const a=Object.create(null);a[s]={handler:t,possibleKeys:[],score:0},I(this,we,[a])}I(this,De,[])}insert(s,t,r){I(this,Ke,++Vs(this,Ke)._);let a=this;const n=ir(t),o=[];for(let i=0,c=n.length;i<c;i++){const l=n[i],u=n[i+1],d=ur(l,u),m=Array.isArray(d)?d[0]:l;if(m in h(a,G)){a=h(a,G)[m],d&&o.push(d[1]);continue}h(a,G)[m]=new Ve,d&&(h(a,De).push(d),o.push(d[1])),a=h(a,G)[m]}return h(a,we).push({[s]:{handler:r,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:h(this,Ke)}}),a}search(s,t){var u;const r=[];I(this,z,Xe);let n=[this];const o=ft(t),i=[],c=o.length;let l=null;for(let d=0;d<c;d++){const m=o[d],_=d===c-1,f=[];for(let S=0,w=n.length;S<w;S++){const E=n[S],T=h(E,G)[m];T&&(I(T,z,h(E,z)),_?(h(T,G)["*"]&&j(this,me,Te).call(this,r,h(T,G)["*"],s,h(E,z)),j(this,me,Te).call(this,r,T,s,h(E,z))):f.push(T));for(let y=0,R=h(E,De).length;y<R;y++){const U=h(E,De)[y],A=h(E,z)===Xe?{}:{...h(E,z)};if(U==="*"){const M=h(E,G)["*"];M&&(j(this,me,Te).call(this,r,M,s,h(E,z)),I(M,z,A),f.push(M));continue}const[D,q,P]=U;if(!m&&!(P instanceof RegExp))continue;const L=h(E,G)[D];if(P instanceof RegExp){if(l===null){l=new Array(c);let F=t[0]==="/"?1:0;for(let O=0;O<c;O++)l[O]=F,F+=o[O].length+1}const M=t.substring(l[d]),W=P.exec(M);if(W){if(A[q]=W[0],j(this,me,Te).call(this,r,L,s,h(E,z),A),Cr(h(L,G))){I(L,z,A);const F=((u=W[0].match(/\//))==null?void 0:u.length)??0;(i[F]||(i[F]=[])).push(L)}continue}}(P===!0||P.test(m))&&(A[q]=m,_?(j(this,me,Te).call(this,r,L,s,A,h(E,z)),h(L,G)["*"]&&j(this,me,Te).call(this,r,h(L,G)["*"],s,A,h(E,z))):(I(L,z,A),f.push(L)))}}const g=i.shift();n=g?f.concat(g):f}return r.length>1&&r.sort((d,m)=>d.score-m.score),[r.map(({handler:d,params:m})=>[d,m])]}},we=new WeakMap,G=new WeakMap,De=new WeakMap,Ke=new WeakMap,z=new WeakMap,me=new WeakSet,Te=function(s,t,r,a,n){for(let o=0,i=h(t,we).length;o<i;o++){const c=h(t,we)[o],l=c[r]||c[V],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),a!==Xe||n&&n!==Xe))for(let d=0,m=l.possibleKeys.length;d<m;d++){const _=l.possibleKeys[d],f=u[l.score];l.params[_]=n!=null&&n[_]&&!f?n[_]:a[_]??(n==null?void 0:n[_]),u[l.score]=!0}}},Ve),Oe,_t,Mr=(_t=class{constructor(){v(this,"name","TrieRouter");k(this,Oe);I(this,Oe,new Lr)}add(e,s,t){const r=Et(s);if(r){for(let a=0,n=r.length;a<n;a++)h(this,Oe).insert(e,r[a],t);return}h(this,Oe).insert(e,s,t)}match(e,s){return h(this,Oe).search(e,s)}},Oe=new WeakMap,_t),Ls=class extends br{constructor(e={}){super(e),this.router=e.router??new jr({routers:[new Nr,new Mr]})}},b=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},r=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(t.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(t.allowMethods);return async function(o,i){var u;function c(d,m){o.res.headers.set(d,m)}const l=await r(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),t.credentials&&c("Access-Control-Allow-Credentials","true"),(u=t.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&c("Vary","Origin"),t.maxAge!=null&&c("Access-Control-Max-Age",t.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&c("Access-Control-Allow-Methods",d.join(","));let m=t.allowHeaders;if(!(m!=null&&m.length)){const _=o.req.header("Access-Control-Request-Headers");_&&(m=_.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function $r(e){var a;const s=((a=e.split(".").pop())==null?void 0:a.toLowerCase())||"jpg",t=Date.now(),r=crypto.randomUUID().substring(0,8);return`upload_${t}_${r}.${s}`}async function Ur(e){const s=new Uint8Array(e);return s[0]===255&&s[1]===216&&s[2]===255?{valid:!0,detectedType:"image/jpeg"}:s[0]===137&&s[1]===80&&s[2]===78&&s[3]===71?{valid:!0,detectedType:"image/png"}:s[0]===71&&s[1]===73&&s[2]===70&&s[3]===56?{valid:!0,detectedType:"image/gif"}:s[0]===82&&s[1]===73&&s[2]===70&&s[3]===70&&s[8]===87&&s[9]===69&&s[10]===66&&s[11]===80?{valid:!0,detectedType:"image/webp"}:{valid:!1}}function qr(e){let s="";for(let t=0;t<e.byteLength;t++)s+=String.fromCharCode(e[t]);return s}function kt(e){let s=new Uint8Array(e.length);for(let t=0;t<e.length;t++)s[t]=e.charCodeAt(t);return s}function Pr(e){return btoa(qr(new Uint8Array(e)))}function Nt(e){return kt(atob(e))}function Ms(e){return kt(e)}function xr(e){return Pr(e).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function Hr(e){return Nt(e.replace(/-/g,"+").replace(/_/g,"/").replace(/\s/g,""))}function Gs(e){const t=new TextEncoder().encode(e),r=String.fromCharCode(...t);return btoa(r).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function jt(e){return Nt(e.replace(/-+(BEGIN|END).*/g,"").replace(/\s/g,""))}async function Fr(e,s,t){return await crypto.subtle.importKey("raw",Ms(e),s,!0,t)}async function Br(e,s,t){return await crypto.subtle.importKey("jwk",e,s,!0,t)}async function Wr(e,s,t){return await crypto.subtle.importKey("spki",jt(e),s,!0,t)}async function Kr(e,s,t){return await crypto.subtle.importKey("pkcs8",jt(e),s,!0,t)}async function Ct(e,s,t){if(typeof e=="object")return Br(e,s,t);if(typeof e!="string")throw new Error("Unsupported key type!");return e.includes("PUBLIC")?Wr(e,s,t):e.includes("PRIVATE")?Kr(e,s,t):Fr(e,s,t)}function Xs(e){const s=Array.from(atob(e),r=>r.charCodeAt(0)),t=new TextDecoder("utf-8").decode(new Uint8Array(s));return JSON.parse(t)}if(typeof crypto>"u"||!crypto.subtle)throw new Error("SubtleCrypto not supported!");var Lt={none:{name:"none"},ES256:{name:"ECDSA",namedCurve:"P-256",hash:{name:"SHA-256"}},ES384:{name:"ECDSA",namedCurve:"P-384",hash:{name:"SHA-384"}},ES512:{name:"ECDSA",namedCurve:"P-521",hash:{name:"SHA-512"}},HS256:{name:"HMAC",hash:{name:"SHA-256"}},HS384:{name:"HMAC",hash:{name:"SHA-384"}},HS512:{name:"HMAC",hash:{name:"SHA-512"}},RS256:{name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-256"}},RS384:{name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-384"}},RS512:{name:"RSASSA-PKCS1-v1_5",hash:{name:"SHA-512"}}};async function Vr(e,s,t="HS256"){if(typeof t=="string"&&(t={algorithm:t}),t={algorithm:"HS256",header:{typ:"JWT",...t.header??{}},...t},!e||typeof e!="object")throw new Error("payload must be an object");if(t.algorithm!=="none"&&(!s||typeof s!="string"&&typeof s!="object"))throw new Error("secret must be a string, a JWK object or a CryptoKey object");if(typeof t.algorithm!="string")throw new Error("options.algorithm must be a string");const r=Lt[t.algorithm];if(!r)throw new Error("algorithm not found");e.iat||(e.iat=Math.floor(Date.now()/1e3));const a=`${Gs(JSON.stringify({...t.header,alg:t.algorithm}))}.${Gs(JSON.stringify(e))}`;if(t.algorithm==="none")return a;const n=s instanceof CryptoKey?s:await Ct(s,r,["sign"]),o=await crypto.subtle.sign(r,n,Ms(a));return`${a}.${xr(o)}`}async function Yr(e,s,t="HS256"){var l;if(typeof t=="string"&&(t={algorithm:t}),t={algorithm:"HS256",clockTolerance:0,throwError:!1,...t},typeof e!="string")throw new Error("token must be a string");if(t.algorithm!=="none"&&typeof s!="string"&&typeof s!="object")throw new Error("secret must be a string, a JWK object or a CryptoKey object");if(typeof t.algorithm!="string")throw new Error("options.algorithm must be a string");const r=e.split(".",3);if(r.length<2)throw new Error("token must consist of 2 or more parts");const[a,n,o]=r,i=Lt[t.algorithm];if(!i)throw new Error("algorithm not found");const c=Mt(e);try{if(((l=c.header)==null?void 0:l.alg)!==t.algorithm)throw new Error("INVALID_SIGNATURE");if(c.payload){const d=Math.floor(Date.now()/1e3);if(c.payload.nbf&&c.payload.nbf>d&&c.payload.nbf-d>(t.clockTolerance??0))throw new Error("NOT_YET_VALID");if(c.payload.exp&&c.payload.exp<=d&&d-c.payload.exp>(t.clockTolerance??0))throw new Error("EXPIRED")}if(i.name==="none")return c;const u=s instanceof CryptoKey?s:await Ct(s,i,["verify"]);if(!await crypto.subtle.verify(i,u,Hr(o),Ms(`${a}.${n}`)))throw new Error("INVALID_SIGNATURE");return c}catch(u){if(t.throwError)throw u;return}}function Mt(e){return{header:Xs(e.split(".")[0].replace(/-/g,"+").replace(/_/g,"/")),payload:Xs(e.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"))}}var ts={sign:Vr,verify:Yr,decode:Mt};function oe(e){return(e==null?void 0:e.JWT_SECRET)||"ur-live-commerce-jwt-secret-2026-CHANGE-THIS-IN-PRODUCTION"}async function ke(e,s){return await ts.sign({userId:e.userId,userType:e.userType,email:e.email,exp:Math.floor(Date.now()/1e3)+3600,type:"access"},s)}async function us(e,s){return await ts.sign({userId:e.userId,userType:e.userType,email:e.email,exp:Math.floor(Date.now()/1e3)+720*60*60,type:"refresh"},s)}async function ds(e,s){try{return await ts.verify(e,s)?ts.decode(e).payload:null}catch{return null}}async function $t(e,s){const t=await ds(e,s);return!t||t.type!=="refresh"?null:await ke({userId:t.userId,userType:t.userType,email:t.email},s)}async function Ut(e,s,t){try{const n=ts.decode(e).payload.exp-Math.floor(Date.now()/1e3);n>0&&await s.put(`blacklist:token:${e}`,"1",{expirationTtl:n})}catch(r){console.error("Failed to blacklist token:",r)}}async function Jr(e,s){try{return await s.get(`blacklist:token:${e}`)!==null}catch{return!1}}const Qe=new Map;async function $s(e,s){const t=Math.floor(Date.now()/1e3),r=Qe.get(e);if(r&&r.exp>t)return r.payload;const a=await ds(e,s);if(a&&a.exp&&(Qe.set(e,{payload:a,exp:a.exp}),Qe.size>1e3)){const n=Qe.keys().next().value;Qe.delete(n)}return a}const qt=Object.freeze(Object.defineProperty({__proto__:null,blacklistToken:Ut,generateAccessToken:ke,generateRefreshToken:us,getJwtSecret:oe,isTokenBlacklisted:Jr,refreshAccessToken:$t,verifyCachedToken:$s,verifyToken:ds},Symbol.toStringTag,{value:"Module"})),ps=new Ls;ps.post("/api/auth/refresh",b(),async e=>{try{const{refresh_token:s}=await e.req.json();if(!s)return e.json({success:!1,error:"Refresh token이 필요합니다."},400);const t=oe(e.env),r=await ds(s,t);if(!r||r.type!=="refresh")return e.json({success:!1,error:"유효하지 않은 refresh token입니다."},401);if(e.env.SESSION_KV&&await e.env.SESSION_KV.get(`blacklist:token:${s}`))return e.json({success:!1,error:"로그아웃된 refresh token입니다."},401);const a=await ke({userId:r.userId,userType:r.userType,email:r.email},t);return e.json({success:!0,access_token:a,expires_in:900})}catch(s){return console.error("[JWT] Refresh token error:",s),e.json({success:!1,error:"Refresh token 처리 중 오류가 발생했습니다."},500)}});ps.post("/api/auth/logout",b(),async e=>{try{const s=e.req.header("Authorization"),t=s==null?void 0:s.replace("Bearer ","");if(!t)return e.json({success:!1,error:"로그아웃할 토큰이 없습니다."},400);if(!e.env.SESSION_KV)return e.json({success:!1,error:"KV가 설정되지 않았습니다."},500);const r=oe(e.env);return await Ut(t,e.env.SESSION_KV,r),e.json({success:!0,message:"로그아웃되었습니다."})}catch(s){return console.error("[JWT] Logout error:",s),e.json({success:!1,error:"로그아웃 처리 중 오류가 발생했습니다."},500)}});ps.post("/api/auth/login-jwt",b(),async e=>{try{const{email:s,password:t,user_type:r}=await e.req.json();if(!s||!t)return e.json({success:!1,error:"이메일과 비밀번호를 입력하세요."},400);if(!e.env.DB)return e.json({success:!1,error:"Database가 설정되지 않았습니다."},500);const a=await e.env.DB.prepare(`SELECT id, email, password_hash, name, phone, profile_image 
       FROM users 
       WHERE email = ?`).bind(s).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다."},401);if(!a.password_hash)return e.json({success:!1,error:"비밀번호가 설정되지 않았습니다."},401);const{verifyPassword:n}=await Promise.resolve().then(()=>Sn);if(!await n(t,a.password_hash))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다."},401);await e.env.DB.prepare("UPDATE users SET last_login_at = CURRENT_TIMESTAMP WHERE id = ?").bind(a.id).run();const i={userId:a.id,userType:r||"user",email:a.email},c=oe(e.env),l=await ke(i,c),u=await us(i,c);return e.json({success:!0,access_token:l,refresh_token:u,expires_in:900,token_type:"Bearer",user:{id:i.userId,email:i.email,name:a.name,user_type:i.userType}})}catch(s){return console.error("[JWT] Login error:",s),e.json({success:!1,error:"로그인 처리 중 오류가 발생했습니다."},500)}});ps.get("/api/auth/verify",b(),async e=>{try{const s=e.req.header("Authorization"),t=s==null?void 0:s.replace("Bearer ","");if(!t)return e.json({success:!1,error:"토큰이 제공되지 않았습니다."},400);const r=oe(e.env),a=await ds(t,r);return a?e.json({success:!0,payload:a}):e.json({success:!1,error:"유효하지 않은 토큰입니다."},401)}catch{return e.json({success:!1,error:"토큰 검증 중 오류가 발생했습니다."},500)}});function zr(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],t=[];for(const r of s)e[r]||t.push(r);if(t.length>0)throw new Error(`Missing required environment variables: ${t.join(", ")}
...
`)}async function Zr(e){const s=await Xr(e),t=s.filter(n=>n.status==="pass").length,r=s.filter(n=>n.status==="warn").length,a=s.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:s.length,pass:t,warn:r,fail:a},results:s,formatted:Qr(s)}}const Ds={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function ea(){const e=Ds.ENV==="production";return{baseUrl:Ds.TEST_BASE_URL,apiKey:Ds.TEST_API_KEY,isProduction:e}}async function Pt(e,s){const t=ea(),r=`${t.baseUrl}${e}`;try{const a=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify(s)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function sa(e){try{const s={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((r,a)=>({SerialNum:a+1,ItemName:r.name,Qty:r.quantity,UnitPrice:r.unitPrice,SupplyCost:r.supplyPrice,Tax:r.taxAmount,Remark:r.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},t=await Pt("/eTaxInvoice/RegistAndIssue",s);if(t.code!==1)throw new Error(`바로빌 발행 실패: ${t.message}`);return{success:!0,ntsConfirmNumber:t.ntsconfirmNum,invoiceKey:t.invoiceKey,message:t.message}}catch(s){throw console.error("바로빌 세금계산서 발행 실패:",s),s}}async function ta(e,s,t){try{const a=await Pt("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:s,Memo:t});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(r){throw console.error("바로빌 세금계산서 취소 실패:",r),r}}function Ze(){return!1}async function ra(e){return await sa(e)}function aa(e,s,t){const r=Number(s.total_amount),a=Math.floor(r/1.1),n=r-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:s.buyer_business_number,buyerBusinessName:s.buyer_business_name||s.user_name,buyerCEO:s.buyer_ceo_name,buyerAddress:s.shipping_address,buyerEmail:s.user_email,buyerTel:s.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:t.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),l=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:l,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:r,memo:`주문번호: ${s.order_number}`,orderNo:s.order_number}}class ee extends Error{constructor(s,t,r){super(s),this.statusCode=t,this.code=r,this.name="AuthError"}}function na(e){return`${crypto.randomUUID()}-${e}`}function oa(e){var n,o,i,c,l,u,d;const s=e.id.toString(),t=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",r=((c=e.kakao_account)==null?void 0:c.email)||null,a=((l=e.properties)==null?void 0:l.profile_image)||((d=(u=e.kakao_account)==null?void 0:u.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:s,nickname:t,email:r,profileImage:a}}async function ia(e,s,t,r,a){try{const n=await e.prepare(`
    ...
    `).bind(s,t,r,a).first();if(!n)throw new ee("Failed to upsert user",500,"UPSERT_FAILED");return console.log("[Auth] ⚡ User upserted successfully (optimized):",n.id),n}catch(n){throw n instanceof ee?n:(console.error("[Auth] Database error during upsert:",n),new ee("Database error",500,"DB_ERROR"))}}async function ca(e){try{const s=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"}});if(!s.ok){const r=await s.text();throw console.error("[Kakao API] Failed to get user info:",r),new ee("Failed to get user info from Kakao",401,"KAKAO_USER_INFO_FAILED")}const t=await s.json();if(!t.id)throw new ee("Invalid user data from Kakao",500,"INVALID_KAKAO_DATA");return t}catch(s){throw s instanceof ee?s:(console.error("[Kakao API] Network error:",s),new ee("Failed to communicate with Kakao API",503,"KAKAO_API_ERROR"))}}async function la(e,s,t){try{const r=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"},body:new URLSearchParams({grant_type:"authorization_code",client_id:t,redirect_uri:s,code:e}).toString()});if(!r.ok){const n=await r.json();throw console.error("[Kakao OAuth] Token exchange failed:",n),new ee(`Failed to exchange code: ${n.error_description||n.error}`,401,n.error||"TOKEN_EXCHANGE_FAILED")}return(await r.json()).access_token}catch(r){throw r instanceof ee?r:(console.error("[Kakao OAuth] Network error:",r),new ee("Failed to communicate with Kakao OAuth server",503,"OAUTH_NETWORK_ERROR"))}}async function xt(e,s){const t=await ca(s),{kakaoId:r,nickname:a,email:n,profileImage:o}=oa(t);console.log("[Auth] Processing login for Kakao user:",r);const i=await ia(e,r,a,n,o),c=na(i.id);return{user:i,sessionToken:c}}async function Ht(e,s,t=30){try{const r=await e.get(s,"json");if(!r)return console.log(`[Cache MISS] ${s}`),null;const a=Date.now()-r.timestamp;return a>t*1e3?(console.log(`[Cache EXPIRED] ${s} (age: ${Math.round(a/1e3)}s)`),null):(console.log(`[Cache HIT] ${s} (age: ${Math.round(a/1e3)}s)`),r.data)}catch(r){return console.error(`[Cache] Get error for key "${s}":`,r),null}}async function ws(e,s,t,r=30){try{const a={data:t,timestamp:Date.now()};await e.put(s,JSON.stringify(a),{expirationTtl:r}),console.log(`[Cache SET] ${s} (TTL: ${r}s)`)}catch(a){console.error(`[Cache] Set error for key "${s}":`,a)}}function ua(e){const s=e.req.header("CF-Connecting-IP");if(s)return s;const t=e.req.header("X-Forwarded-For");if(t)return t.split(",")[0].trim();const r=e.req.header("X-Real-IP");return r||"unknown"}function da(e,s){return`ratelimit:${e}:${s}`}const Os=new Map;async function pa(e,s,t){var m;const r=new URL(e.req.url).pathname,a=da(s,r),n=Date.now(),o=t.windowMs*1e3,c=e.get("user")&&t.authenticatedMultiplier?t.maxRequests*t.authenticatedMultiplier:t.maxRequests;try{const _=(m=e.env)==null?void 0:m.RATE_LIMIT_KV;if(_){const f=await _.get(a);let g;f?(g=JSON.parse(f),n>g.resetTime?g={count:1,resetTime:n+o}:g.count++):g={count:1,resetTime:n+o};const S=Math.ceil(o/1e3);await _.put(a,JSON.stringify(g),{expirationTtl:S});const w=g.count<=c,E=Math.max(0,c-g.count);return{allowed:w,remaining:E,resetTime:g.resetTime}}}catch(_){console.error("KV Rate Limit Error:",_)}let l=Os.get(a);l&&n>l.resetTime&&(Os.delete(a),l=void 0),l?l.count++:l={count:1,resetTime:n+o},Os.set(a,l);const u=l.count<=c,d=Math.max(0,c-l.count);return{allowed:u,remaining:d,resetTime:l.resetTime}}function Ne(e){return async(s,t)=>{const r=ua(s);if(e.skipIps&&e.skipIps.includes(r))return t();if(e.pathPattern){const n=new URL(s.req.url).pathname;if(!e.pathPattern.test(n))return t()}const a=await pa(s,r,e);if(s.header("X-RateLimit-Limit",e.maxRequests.toString()),s.header("X-RateLimit-Remaining",a.remaining.toString()),s.header("X-RateLimit-Reset",new Date(a.resetTime).toISOString()),!a.allowed){const n=Math.ceil((a.resetTime-Date.now())/1e3);return s.header("Retry-After",n.toString()),s.json({success:!1,error:e.message||"Too many requests. Please try again later.",retryAfter:n,resetTime:new Date(a.resetTime).toISOString()},429)}return t()}}const je={api:{windowMs:60,maxRequests:60,message:"API 요청 제한을 초과했습니다. 잠시 후 다시 시도해주세요.",authenticatedMultiplier:2},auth:{windowMs:60,maxRequests:5,message:"로그인 시도 횟수를 초과했습니다. 1분 후 다시 시도해주세요.",pathPattern:/^\/api\/auth\//},order:{windowMs:60,maxRequests:10,message:"주문 요청이 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/orders/,authenticatedMultiplier:2},cart:{windowMs:60,maxRequests:20,message:"장바구니 요청이 너무 많습니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/cart/,authenticatedMultiplier:2},refund:{windowMs:3600,maxRequests:3,message:"환불 요청 횟수를 초과했습니다. 1시간 후 다시 시도해주세요.",pathPattern:/^\/api\/orders\/.*\/refund/},alimtalk:{windowMs:60,maxRequests:10,message:"알림톡 발송 요청이 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/seller\/alimtalk\/send/},upload:{windowMs:60,maxRequests:5,message:"파일 업로드가 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/.*\/upload/}};class B extends Error{constructor(s,t,r="VALIDATION_ERROR"){super(t),this.field=s,this.code=r,this.name="ValidationError"}}function ma(e,s){const{field:t,required:r,type:a,min:n,max:o,pattern:i,enum:c,custom:l,message:u}=s;if(r&&(e==null||e===""))throw new B(t,u||`${t}은(는) 필수 항목입니다.`,"REQUIRED");if(!(e==null||e==="")){if(a)switch(a){case"string":if(typeof e!="string")throw new B(t,u||`${t}은(는) 문자열이어야 합니다.`,"INVALID_TYPE");break;case"number":const d=typeof e=="string"?Number(e):e;if(typeof d!="number"||isNaN(d))throw new B(t,u||`${t}은(는) 숫자여야 합니다.`,"INVALID_TYPE");break;case"boolean":if(typeof e!="boolean")throw new B(t,u||`${t}은(는) true/false 값이어야 합니다.`,"INVALID_TYPE");break;case"email":if(typeof e!="string"||!ha(e))throw new B(t,u||`${t}은(는) 유효한 이메일 주소여야 합니다.`,"INVALID_EMAIL");break;case"url":if(typeof e!="string"||!Ea(e))throw new B(t,u||`${t}은(는) 유효한 URL이어야 합니다.`,"INVALID_URL");break;case"phone":if(typeof e!="string"||!ga(e))throw new B(t,u||`${t}은(는) 유효한 전화번호여야 합니다.`,"INVALID_PHONE");break;case"date":if(!(e instanceof Date)&&!ya(e))throw new B(t,u||`${t}은(는) 유효한 날짜여야 합니다.`,"INVALID_DATE");break;case"array":if(!Array.isArray(e))throw new B(t,u||`${t}은(는) 배열이어야 합니다.`,"INVALID_TYPE");break;case"object":if(typeof e!="object"||e===null||Array.isArray(e))throw new B(t,u||`${t}은(는) 객체여야 합니다.`,"INVALID_TYPE");break}if(typeof e=="string"){if(n!==void 0&&e.length<n)throw new B(t,u||`${t}은(는) 최소 ${n}자 이상이어야 합니다.`,"TOO_SHORT");if(o!==void 0&&e.length>o)throw new B(t,u||`${t}은(는) 최대 ${o}자 이하여야 합니다.`,"TOO_LONG")}if(typeof e=="number"){if(n!==void 0&&e<n)throw new B(t,u||`${t}은(는) 최소 ${n} 이상이어야 합니다.`,"TOO_SMALL");if(o!==void 0&&e>o)throw new B(t,u||`${t}은(는) 최대 ${o} 이하여야 합니다.`,"TOO_LARGE")}if(Array.isArray(e)){if(n!==void 0&&e.length<n)throw new B(t,u||`${t}은(는) 최소 ${n}개 이상이어야 합니다.`,"TOO_FEW");if(o!==void 0&&e.length>o)throw new B(t,u||`${t}은(는) 최대 ${o}개 이하여야 합니다.`,"TOO_MANY")}if(i&&typeof e=="string"&&!i.test(e))throw new B(t,u||`${t}의 형식이 올바르지 않습니다.`,"INVALID_FORMAT");if(c&&!c.includes(e))throw new B(t,u||`${t}은(는) 다음 중 하나여야 합니다: ${c.join(", ")}`,"INVALID_ENUM");if(l&&l(e)===!1)throw new B(t,u||`${t}의 값이 유효하지 않습니다.`,"CUSTOM_VALIDATION_FAILED")}}function _a(e,s){for(const t of s){const r=e[t.field];ma(r,t)}}function fa(e){return async(s,t)=>{try{let r={};const a=s.req.header("content-type")||"";a.includes("application/json")?r=await s.req.json().catch(()=>({})):(a.includes("application/x-www-form-urlencoded")||a.includes("multipart/form-data"))&&(r=await s.req.parseBody().catch(()=>({})));const n=new URL(s.req.url);for(const[o,i]of n.searchParams.entries())o in r||(r[o]=i);_a(r,e),s.set("validatedData",r),await t()}catch(r){if(r instanceof B)return s.json({success:!1,error:r.message,field:r.field,code:r.code},400);throw r}}}function ha(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)&&e.length<=255}function Ea(e){try{const s=new URL(e);return s.protocol==="http:"||s.protocol==="https:"}catch{return!1}}function ga(e){return/^01([0|1|6|7|8|9])-?([0-9]{3,4})-?([0-9]{4})$/.test(e)}function ya(e){if(typeof e!="string")return!1;const s=new Date(e);return!isNaN(s.getTime())}const wa=[{field:"email",required:!0,type:"email",max:255,message:"유효한 이메일 주소를 입력해주세요."},{field:"password",required:!0,type:"string",min:8,max:100,pattern:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/,message:"비밀번호는 최소 8자 이상, 대소문자와 숫자를 포함해야 합니다."},{field:"name",required:!0,type:"string",min:2,max:50,message:"이름은 2-50자 사이여야 합니다."},{field:"phone",required:!1,type:"phone",message:"유효한 전화번호를 입력해주세요. (예: 010-1234-5678)"}];function Ts(e){const s=new URLSearchParams;for(const[t,r]of Object.entries(e))r!=null&&s.append(t,String(r));return s}function Us(e,s){if(e.result_code!=="1")throw new Error(`[Aligo ${s}] ${e.message} (code: ${e.result_code})`)}async function qs(e){console.log("[Aligo] 토큰 생성 시작");const t=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/token/create/30/s/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ts({apikey:e.ALIGO_API_KEY,userid:e.ALIGO_USER_ID})})).json();return Us(t,"Token Create"),console.log("[Aligo] ✅ 토큰 생성 성공:",t.token.substring(0,20)+"..."),{token:t.token,urtime:t.urtime}}async function Sa(e,s){console.log("[Aligo] 카카오 채널 등록:",s.channelId);const{token:t}=await qs(e),a=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/plus/add/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ts({token:t,userid:e.ALIGO_USER_ID,plusid:s.channelId,phonenumber:s.phoneNumber})})).json();return Us(a,"Channel Register"),console.log("[Aligo] ✅ 카카오 채널 등록 성공, senderKey:",a.senderkey),{success:!0,senderKey:a.senderkey}}async function ba(e,s,t){console.log("[Aligo] 템플릿 등록:",t.templateCode);const{token:r}=await qs(e),n=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/template/add/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ts({token:r,userid:e.ALIGO_USER_ID,senderkey:s,tpl_name:t.name,tpl_content:t.content,tpl_code:t.templateCode})})).json();return Us(n,"Template Register"),console.log("[Aligo] ✅ 템플릿 등록 성공:",n.tpl_code),{success:!0,templateCode:n.tpl_code}}async function Ps(e,s){console.log("[Aligo] 알림톡 발송:",s.to);try{const{token:t}=await qs(e),r=s.buttons?JSON.stringify({button:s.buttons}):void 0,n=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/alimtalk/send/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ts({token:t,userid:e.ALIGO_USER_ID,senderkey:s.senderKey,tpl_code:s.templateCode,receiver_1:s.to,subject_1:"알림톡",message_1:s.message,button_1:r})})).json();return n.result_code!=="1"?(console.error("[Aligo] ❌ 알림톡 발송 실패:",n.message),{success:!1,error:n.message}):(console.log("[Aligo] ✅ 알림톡 발송 성공, messageId:",n.msg_id),{success:!0,messageId:n.msg_id})}catch(t){return console.error("[Aligo] ❌ 알림톡 발송 에러:",t.message),{success:!1,error:t.message}}}function Ta(e,s){let t=e;for(const[r,a]of Object.entries(s)){const n=new RegExp(`#{${r}}`,"g");t=t.replace(n,a)}return t}function Ft(e){let s=e.replace(/-/g,"");if(!s.startsWith("010"))throw new Error("Invalid phone number format. Must start with 010");if(s.length!==11)throw new Error("Invalid phone number length. Must be 11 digits");return s}async function Ra(e,s){const t=await e.prepare(`
    SELECT 
      o.*,
  ...
  `).bind(s).first();if(!t)throw new Error(`Order not found: ${s}`);const r=await e.prepare(`
    ...
    WHERE oi.order_id = ?
  `).bind(s).all();return{order:t,products:r.results}}async function Ia(e,s){const t=await e.prepare(`
    SELECT 
...
주문해 주셔서 감사합니다!`,c=await Ps(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:t.buyer_phone,message:i});return c.success?(await va(e.DB,t.seller_id,n),await Qs(e.DB,{seller_id:t.seller_id,template_code:"order_confirm",recipient_phone:t.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await Qs(e.DB,{seller_id:t.seller_id,template_code:"order_confirm",recipient_phone:t.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(t){return console.error(`Error sending order confirmation for order ${s}:`,t),{success:!1,error:t.message}}}function Oa(e,s){let t=e;return Object.entries(s).forEach(([r,a])=>{const n=new RegExp(`#{${r}}`,"g");t=t.replace(n,a)}),t}function Aa(e,s){const r=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:r.length===0,missingVars:r}}async function ka(e,s,t){const r=await e.prepare(`
    SELECT balance FROM alimtalk_accounts WHERE id = ?
  `).bind(s).first();if(!r)throw new Error(`Account not found: ${s}`);return{sufficient:r.balance>=t,currentBalance:r.balance}}async function Na(e,s,t){const r=await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?,
        updated_at = datetime('now')
  ...
  `).bind(s.accountId,s.templateId,s.orderId||null,s.recipientPhone,s.messageContent,s.status,s.cost,s.aligoMessageId||null,s.failedReason||null).run()}async function ja(e,s,t,r){await e.prepare(`
    ...
    SET total_sent = total_sent + ?,
        ...
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(t,r,s).run()}async function Ca(e,s,t,r,a,n,o,i,c){try{const l={...i,...o.variables},u=Oa(r,l),d=await Ps(e,{senderKey:a,templateCode:n,to:o.phone,message:u});return d.success?(await As(e.DB,{accountId:s,templateId:t,recipientPhone:o.phone,messageContent:u,status:"sent",cost:c,aligoMessageId:d.messageId}),{phone:o.phone,status:"sent",messageId:d.messageId,cost:c}):(await As(e.DB,{accountId:s,templateId:t,recipientPhone:o.phone,messageContent:u,status:"failed",cost:0,failedReason:d.error}),await Zs(e.DB,s,c),{phone:o.phone,status:"failed",error:d.error,cost:0})}catch(l){return console.error(`Failed to send alimtalk to ${o.phone}:`,l),await As(e.DB,{accountId:s,templateId:t,recipientPhone:o.phone,messageContent:"",status:"failed",cost:0,failedReason:l.message}),await Zs(e.DB,s,c),{phone:o.phone,status:"failed",error:l.message,cost:0}}}async function xs(e,s){const{accountId:t,templateId:r,recipients:a,variables:n}=s;console.log(`[Alimtalk] Starting bulk send: ${a.length} recipients`);try{const o=await e.DB.prepare(`
      SELECT 
        id,
        sender_key,
        balance,
    ...
    `).bind(r,t).first();if(!i)throw new Error("Template not found");if(i.status!=="approved")throw new Error("Template is not approved");const c=Aa(i.template_content,n);if(!c.valid)throw new Error(`Missing variables: ${c.missingVars.join(", ")}`);const l=15,u=a.length*l,d=await ka(e.DB,t,u);if(!d.sufficient)throw new Error(`Insufficient balance. Required: ${u}, Current: ${d.currentBalance}`);await Na(e.DB,t,u),console.log(`[Alimtalk] Deducted ${u} points from account ${t}`);const m=[];let _=0,f=0,g=0;for(const S of a){const w=await Ca(e,t,r,i.template_content,o.sender_key,i.template_code,S,n,l);m.push(w),w.status==="sent"?_++:(f++,g+=l),m.length%10===0&&await new Promise(E=>setTimeout(E,1e3))}return await ja(e.DB,t,_,f),console.log(`[Alimtalk] Completed: ${_} sent, ${f} failed, ${g} refunded`),{success:!0,totalRecipients:a.length,successCount:_,failedCount:f,refundedAmount:g,messages:m}}catch(o){return console.error("[Alimtalk] Bulk send failed:",o),{success:!1,totalRecipients:a.length,successCount:0,failedCount:a.length,refundedAmount:0,messages:[],error:o.message}}}async function La(e,s,t,r,a){const n=await e.DB.prepare(`
    SELECT 
      o.*,
      u.name as buyer_name,
      u.phone as buyer_phone,
...
`),c={orderNumber:n.order_number,orderDate:new Date(n.created_at).toLocaleString("ko-KR"),productList:i,totalAmount:n.total_amount.toLocaleString(),shippingAddress:n.shipping_address,shippingName:n.shipping_name,shippingPhone:n.shipping_phone,buyerName:n.buyer_name,customMessage:a||"감사합니다!"},l=[{phone:n.buyer_phone,name:n.buyer_name}];return xs(e,{accountId:s,templateId:t,recipients:l,variables:c})}async function Ma(e,s,t,r,a={}){const n=r.map(o=>({phone:o.phone,name:o.name,variables:Object.entries(o).filter(([i])=>i!=="phone"&&i!=="name").reduce((i,[c,l])=>({...i,[c]:l}),{})}));return xs(e,{accountId:s,templateId:t,recipients:n,variables:a})}function $a(e,s=.1){return Math.floor(e*s)}function Ua(){const e=new Date,s=new Date(e.getFullYear(),e.getMonth()-1,1),t=s.getFullYear(),r=String(s.getMonth()+1).padStart(2,"0"),a=new Date(t,s.getMonth()+1,0).getDate();return{startDate:`${t}-${r}-01`,endDate:`${t}-${r}-${a}`}}async function qa(e,s,t){try{const r=await e.prepare(`
  ...
  `).bind(s.period.startDate,s.period.endDate,s.total_sales,s.total_platform_fee,s.total_settlement,s.generated_at).run()).meta.last_row_id;for(const a of s.sellers)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(r,a.seller_id,a.total_sales,a.total_orders,a.platform_fee,a.shipping_fee,a.refund_amount,a.settlement_amount).run();console.log(`[Settlement] Report saved: ID ${r}`)}async function Ha(e,s){const t=await e.prepare(`
...
`))}catch(i){console.error("[SSE Chat] Polling failed:",i)}},5e3)},cancel(){console.log(`[SSE Chat] Client disconnected from stream ${e}`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function Wa(e,s){const t=new TextEncoder;let r=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Orders] Seller ${e} connected`);try{const i=await s.DB.prepare(`
...
`))}catch(i){console.error("[SSE Orders] Polling failed:",i)}},1e4)},cancel(){console.log(`[SSE Orders] Seller ${e} disconnected`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function Ka(e,s){const t=new TextEncoder;let r;const a=new ReadableStream({async start(n){console.log(`[SSE Stock] Seller ${e} connected`),r=setInterval(async()=>{try{const o=await s.DB.prepare(`
            SELECT 
              id,
              name,
              stock,
...
`))}catch(o){console.error("[SSE Stock] Polling failed:",o)}},6e4)},cancel(){console.log(`[SSE Stock] Seller ${e} disconnected`),r&&clearInterval(r)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function Va(e,s,t,r){await e.prepare(`
    INSERT OR REPLACE INTO push_subscriptions 
    (user_id, user_type, endpoint, p256dh, auth, created_at, updated_at)
    VALUES (?, ?, ?, ?, ?, datetime('now'), datetime('now'))
  `).bind(s,t,r.endpoint,r.keys.p256dh,r.keys.auth).run(),console.log(`[Push] Subscription saved for ${t} ${s}`)}async function Ya(e,s){await e.prepare(`
    DELETE FROM push_subscriptions WHERE endpoint = ?
  `).bind(s).run(),console.log(`[Push] Subscription deleted: ${s}`)}function Ja(e){if(e.req.method!=="GET")return!1;const s=e.req.header("Authorization"),t=e.req.header("X-Session-Token");if(s||t)return!1;const a=new URL(e.req.url).pathname;return!(a.includes("/api/products/")&&a.includes("/stock")||a.includes("/api/streams/")&&a.includes("/status")||a.includes("/current-product")||a.includes("/api/chat")||a.includes("/api/sse")||a.includes("/api/orders")||a.includes("/api/payment"))}function za(e,s){return s||new URL(e.req.url).toString()}function Ga(e){const s=[];return s.push("public"),s.push(`max-age=${e.ttl}`),e.sMaxAge!==void 0?s.push(`s-maxage=${e.sMaxAge}`):s.push(`s-maxage=${e.ttl}`),e.staleWhileRevalidate&&s.push(`stale-while-revalidate=${e.staleWhileRevalidate}`),s.join(", ")}function Hs(e){return async(s,t)=>{var i;if(e.skipCache||!Ja(s))return t();const r=za(s,e.cacheKey),a=caches.default;let n=await a.match(r);if(n){console.log(`[Cache HIT] ${r}`);const c=new Headers(n.headers);return c.set("X-Cache","HIT"),c.set("X-Cache-Key",r),new Response(n.body,{status:n.status,statusText:n.statusText,headers:c})}console.log(`[Cache MISS] ${r}`),await t();const o=s.res;if(o.status>=200&&o.status<300){const c=Ga(e);o.headers.set("Cache-Control",c),o.headers.set("X-Cache","MISS"),o.headers.set("X-Cache-Key",r);const l=e.varyBy||["Accept-Encoding"];o.headers.set("Vary",l.join(", "));const u=o.clone();(i=s.executionCtx)==null||i.waitUntil(a.put(r,u))}}}const Fs={products:{ttl:10,sMaxAge:60,staleWhileRevalidate:120},liveStreams:{ttl:5,sMaxAge:10,staleWhileRevalidate:30},microCache:{ttl:10,sMaxAge:10,staleWhileRevalidate:30}};class Xa extends Error{constructor(s,t,r,a){super(r),this.statusCode=s,this.code=t,this.details=a,this.name="AppError",Error.captureStackTrace(this,this.constructor)}}const ce=new Map;let J={hits:0,misses:0,writes:0,evictions:0};function Se(e){const s=ce.get(e);return s?s.expires<Date.now()?(ce.delete(e),J.evictions++,J.misses++,null):(J.hits++,s.data):(J.misses++,null)}function Q(e,s,t){const r=Date.now()+t*1e3;if(ce.set(e,{data:s,expires:r}),J.writes++,ce.size>1e3){const a=ce.keys().next().value;a&&(ce.delete(a),J.evictions++)}}function Qa(e){let s=0;for(const t of ce.keys())t.includes(e)&&(ce.delete(t),s++);return s}async function Ye(e,s){const t=Array.isArray(s)?s:[s];for(const r of t){const a=Qa(r);a>0&&console.log(`[Cache] 🧹 메모리 캐시 삭제: ${r} (${a}개)`);try{await e.CACHE_KV.delete(r),console.log(`[Cache] 🧹 KV 캐시 삭제: ${r}`)}catch(n){console.error(`[Cache] ❌ KV 캐시 삭제 실패: ${r}`,n)}}}const Je={LIVE_STREAMS:["streams:live","streams:all","streams:scheduled","live_streams:live:all:20:0","live_streams:"],PRODUCTS:["products:","featured_products"],CART:e=>[`cart:${e}`],ORDERS:e=>[`orders:${e}`],ALL:["streams:","live_streams:","products:","cart:","orders:"]};function Za(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function en(e){return{name:"tosspayments",async confirmPayment(s){try{const t=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),r=await t.json();if(!t.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message||"결제 승인 실패",rawData:r};let a={};r.card&&(a={cardCompany:r.card.company,cardNumber:r.card.number,installmentMonths:r.card.installmentPlanMonths||0});let n={};return r.virtualAccount&&(n={virtualAccountBank:r.virtualAccount.bankCode,virtualAccountNumber:r.virtualAccount.accountNumber,virtualAccountHolder:r.virtualAccount.customerName,virtualAccountDueDate:r.virtualAccount.dueDate}),{success:!0,orderId:r.orderId,paymentKey:r.paymentKey,method:r.method,totalAmount:r.totalAmount,status:r.status,approvedAt:r.approvedAt,transactionId:r.transactionKey,...a,...n,rawData:r}}catch(t){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message,rawData:null}}},async cancelPayment(s){try{const t={cancelReason:s.cancelReason};s.cancelAmount&&(t.cancelAmount=s.cancelAmount);const r=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(t)}),a=await r.json();return r.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(t){return{success:!1,error:t.message}}},async getPayment(s){try{const t=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),r=await t.json();if(!t.ok)throw new Error(r.message);return{success:!0,orderId:r.orderId,paymentKey:r.paymentKey,method:r.method,totalAmount:r.totalAmount,status:r.status,approvedAt:r.approvedAt,rawData:r}}catch(t){throw t}}}}function sn(e,s){switch(e.toLowerCase()){case"tosspayments":return en(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const p=new Ls;p.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{zr(e.env),Gr(e.env)}catch(r){console.error("[ENV] Validation failed:",r)}await s()});async function tn(e){try{const s=e.req.header("Authorization"),t=(s==null?void 0:s.replace("Bearer ",""))||"";if(!t)return console.warn("[JWT Auth] No token provided"),null;const r=oe(e.env),a=await $s(t,r);return a?{userId:a.userId,userType:a.userType,email:a.email}:(console.warn("[JWT Auth] Invalid or expired token"),null)}catch(s){return console.error("[JWT Auth Error]",s),null}}async function Ce(e,s,t){if(!s)return null;const r=`session:${s}`;try{const a=Se(r);if(a)return a;const n=await e.get(r);if(!n)return null;const o=JSON.parse(n);if(o.expires_at&&Date.now()>o.expires_at)return t!=null&&t.executionCtx||await e.delete(r),null;const i={user_id:o.user_id,user_type:o.user_type||"user",created_at:o.created_at};return Q(r,i,900),i}catch(a){return console.error("[Auth] Session lookup error:",a),null}}async function C(e,s){const t=await tn(e);if(!t)return e.json({success:!1,error:"Authentication required",code:"AUTH_REQUIRED"},401);e.set("user",{userId:t.userId,userType:t.userType,email:t.email}),e.set("userId",t.userId),e.set("userType",t.userType),e.set("email",t.email),await s()}async function rn(e,s){const t=e.get("userType"),r=e.get("userId");if(t!=="admin")return console.warn("[Security] Unauthorized admin access attempt:",{userId:r,userType:t}),e.json({success:!1,error:"관리자 권한이 필요합니다."},403);await s()}async function an(e,s){const t=e.get("userType"),r=e.get("userId");if(t!=="seller")return console.warn("[Security] Unauthorized seller access attempt:",{userId:r,userType:t}),e.json({success:!1,error:"판매자 권한이 필요합니다."},403);await s()}async function nn(e){return async(s,t)=>{const r=s.get("userId");if(s.get("userType")==="admin"){await t();return}const n=s.req.param("userId");if(n&&n!==String(r))return console.warn("[Security] Unauthorized resource access attempt:",{resourceType:e,requestedUserId:n,actualUserId:r}),s.json({success:!1,error:"본인의 정보만 조회할 수 있습니다."},403);await t()}}async function on(e,s){try{const t=Se(s);if(t!==null)return t;const r=await e.get(s);if(r){const a=JSON.parse(r);return Q(s,a,300),a}return null}catch(t){return console.error("[Cache] Read error:",t),null}}async function rs(e,s,t,r=60,a=!1){try{Q(s,t,r),a?(await e.put(s,JSON.stringify(t),{expirationTtl:r}),console.log(`[Cache] ✅ Saved to both Memory + KV: ${s}`)):console.log(`[Cache] ✅ Saved to Memory only (KV Write skipped): ${s}`)}catch(n){console.error("[Cache] Write error:",n)}}async function Bs(e,...s){try{await Promise.all(s.map(t=>e.delete(t)))}catch(t){console.error("[Cache] Delete error:",t)}}async function ms(e,s,t,r,a,n,o){try{await e.prepare(`
      INSERT INTO notifications (user_id, user_type, type, title, message, link)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(s,t,r,a,n,o||null).run(),console.log(`[Notification] Created for ${t} ${s}: ${a}`)}catch(i){console.error("[Notification] Create error:",i)}}async function cn(e,s,t,r,a){await ms(e,s,"seller","new_order","🛒 신규 주문이 접수되었습니다",`${r}님의 주문 (${t}) - ${ln(a)}`,"/seller/orders")}async function Bt(e,s,t,r,a,n){let o="",i="";switch(r){case"preparing":o="📦 상품 준비 중",i=`주문번호 ${t}의 상품을 준비하고 있습니다`;break;case"shipping":o="🚚 배송이 시작되었습니다",i=`주문번호 ${t}가 배송 중입니다`,a&&n&&(i+=` (${a}: ${n})`);break;case"delivered":o="✅ 배송 완료",i=`주문번호 ${t}가 배송 완료되었습니다`;break;default:return}await ms(e,s,"user","shipping_status",o,i,"/my-orders")}async function Wt(e,s,t,r,a){await ms(e,s,"seller","low_stock","⚠️ 재고 부족 알림",`${t}의 재고가 ${r}개로 부족합니다 (기준: ${a}개)`,"/seller/products")}function ln(e){return new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW"}).format(e)}async function un(e,s,t){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const r=await fetch("https://www.googleapis.com/youtube/v3/liveBroadcasts?part=snippet,status,contentDetails",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:s,description:t,scheduledStartTime:new Date().toISOString()},status:{privacyStatus:"public",selfDeclaredMadeForKids:!1},contentDetails:{enableAutoStart:!0,enableAutoStop:!0}})});if(!r.ok){const d=await r.text();throw new Error(`YouTube Broadcast 생성 실패: ${d}`)}const n=(await r.json()).id,o=await fetch("https://www.googleapis.com/youtube/v3/liveStreams?part=snippet,cdn",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:`${s} - Stream`},cdn:{frameRate:"variable",ingestionType:"rtmp",resolution:"variable"}})});if(!o.ok){const d=await o.text();throw new Error(`YouTube Stream 생성 실패: ${d}`)}const i=await o.json(),c=i.id,l=i.cdn.ingestionInfo.streamName,u=i.cdn.ingestionInfo.ingestionAddress;return await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/bind?id=${n}&streamId=${c}&part=snippet`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}}),{broadcastId:n,streamId:c,streamKey:l,streamUrl:u}}catch(r){throw console.error("[YouTube API] Live broadcast creation failed:",r),r}}async function dn(e,s){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const t=await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/transition?broadcastStatus=complete&id=${s}&part=status`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}});if(!t.ok){const r=await t.text();throw new Error(`YouTube 방송 종료 실패: ${r}`)}}catch(t){throw console.error("[YouTube API] Live broadcast end failed:",t),t}}async function pn(e,s,t){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{let r=`https://www.googleapis.com/youtube/v3/liveChat/messages?liveChatId=${s}&part=snippet,authorDetails`;t&&(r+=`&pageToken=${t}`);const a=await fetch(r,{headers:{Authorization:`Bearer ${e.accessToken}`}});if(!a.ok){const o=await a.text();throw new Error(`YouTube 채팅 메시지 가져오기 실패: ${o}`)}const n=await a.json();return{messages:n.items||[],nextPageToken:n.nextPageToken,pollingIntervalMillis:n.pollingIntervalMillis||5e3}}catch(r){throw console.error("[YouTube API] Get chat messages failed:",r),r}}async function mn(e,s){if(!e.apiKey&&!e.accessToken)throw new Error("YouTube API Key 또는 Access Token이 필요합니다");try{const t=e.accessToken?{Authorization:`Bearer ${e.accessToken}`}:{},r=e.accessToken?`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}`:`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}&key=${e.apiKey}`,a=await fetch(r,{headers:t});if(!a.ok){const l=await a.text();throw new Error(`YouTube 통계 가져오기 실패: ${l}`)}const n=await a.json();if(!n.items||n.items.length===0)throw new Error("Video not found");const o=n.items[0],i=o.statistics,c=o.liveStreamingDetails;return{viewCount:parseInt(i.viewCount||"0"),likeCount:parseInt(i.likeCount||"0"),commentCount:parseInt(i.commentCount||"0"),concurrentViewers:c!=null&&c.concurrentViewers?parseInt(c.concurrentViewers):void 0}}catch(t){throw console.error("[YouTube API] Get live stats failed:",t),t}}function Kt(e){try{if(!/^https?:\/\//.test(e)&&/^[\w-]{11}$/.test(e))return e;const s=new URL(e);if(s.hostname.includes("youtube.com")){const t=s.searchParams.get("v");if(t)return t;const r=s.pathname.match(/\/(embed|live|shorts)\/([a-zA-Z0-9_-]{11})/);if(r)return r[2]}if(s.hostname==="youtu.be"){const t=s.pathname.slice(1).split("?")[0];if(t&&t.length===11)return t}return null}catch{return null}}function Vt(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const t=s.pathname.match(/\/video\/(\d+)/);if(t)return t[1];const r=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(r)return r[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}function _n(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){if(s.pathname.includes("/live"))return"live";if(s.pathname.includes("/video/"))return"video"}return null}catch{return null}}function Yt(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const t=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(t)return t[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}p.use("*",async(e,s)=>{await s(),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://t1.kakaocdn.net https://developers.kakao.com https://js.tosspayments.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net; img-src 'self' data: https: blob:; font-src 'self' data: https://cdn.jsdelivr.net; connect-src 'self' https://api.tosspayments.com https://kauth.kakao.com https://kapi.kakao.com https://www.youtube.com; frame-src 'self' https://www.youtube.com https://youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';");const t=new URL(e.req.url);t.hostname!=="localhost"&&t.protocol==="https:"&&e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("X-Frame-Options","SAMEORIGIN"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});p.use("/api/*",b());p.use(Ne(je.auth));p.use(Ne(je.alimtalk));p.use(Ne(je.order));p.use(Ne(je.refund));p.use(Ne(je.cart));p.use(Ne(je.upload));p.use("/api/*",Ne(je.api));p.use("*",async(e,s)=>{await s(),e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://www.youtube.com https://s.ytimg.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' https://cdn.jsdelivr.net https://fonts.gstatic.com; connect-src 'self' https:; frame-src 'self' https://www.youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';"),e.header("X-Frame-Options","DENY"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});p.use("/api/*",async(e,s)=>{const t=Date.now(),r=e.req.method,a=e.req.path;await s();const n=Date.now()-t,o=e.res.status,i={method:r,path:a,status:o,duration:n},c=e.get("userId");c&&(i.userId=c),Za(i)});p.use("/static/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});p.use("/images/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});p.use("/api/admin*",async(e,s)=>{if(e.req.path==="/api/admin/login")return s();const t=await C(e,()=>Promise.resolve());if(t)return t;const r=await rn(e,()=>Promise.resolve());return r||s()});p.use("/api/seller*",async(e,s)=>{if(e.req.path==="/api/seller/register")return s();const t=await C(e,()=>Promise.resolve());if(t)return t;const r=await an(e,()=>Promise.resolve());return r||s()});async function ze(e,s){const t=await e.get(`session:${s}`);if(!t)return null;const r=JSON.parse(t);return r.expires_at&&Date.now()>r.expires_at?(await e.delete(`session:${s}`),null):{session_token:s,[`${r.user_type}_id`]:r.user_id,user_type:r.user_type,...r.userData}}p.post("/api/auth/user/register",b(),fa(wa),async e=>{const{DB:s}=e.env;try{const{email:t,password:r,name:a,phone:n}=e.get("validatedData"),o=`placeholder_hash_for_${r}`;try{const c=(await s.prepare(`
    ...
    `).bind(r).first();if(!n)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(n.password_hash&&n.password_hash.includes(`placeholder_hash_for_${a}`)||n.password&&n.password===a))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);await s.prepare("UPDATE users SET last_login_at = datetime('now') WHERE id = ?").bind(n.id).run();const i=crypto.randomUUID(),c=Date.now()+720*60*60*1e3;return await t.put(`session:${i}`,JSON.stringify({user_id:n.id,user_type:"user",expires_at:c,created_at:Date.now()}),{expirationTtl:720*60*60}),console.log("[User Login] Session created in SESSION_KV for user:",n.id),e.json({success:!0,data:{session_token:i,user:{id:n.id,email:n.email,name:n.name,phone:n.phone,profile_image:n.profile_image}}})}catch(r){return console.error("[User Login] Error:",r),e.json({success:!1,error:r.message||"로그인 중 오류가 발생했습니다"},500)}});p.post("/api/auth/login",b(),async e=>{const{DB:s}=e.env;try{const{username:t,password:r,userType:a}=await e.req.json(),n=e.req.header("CF-Connecting-IP")||e.req.header("X-Forwarded-For")||"Unknown",o=e.req.header("User-Agent")||"Unknown";if(!t||!r||!a)return e.json({success:!1,error:"아이디와 비밀번호를 입력해주세요"},400);let i,c=a==="admin"?"admins":"sellers";if(a==="admin"?i=await s.prepare(`
      ...
      `).bind(t,t).first():i=await s.prepare(`
        ...
        FROM ${c} 
        WHERE username = ? OR email = ?
      `).bind(t,t).first(),!i){const{sendDiscordAlert:q,addLoginHistory:P}=await Promise.resolve().then(()=>ks);return P(n,!1),await q({type:"login_failure",username:t,userType:a,ip:n,userAgent:o,timestamp:new Date().toISOString(),details:"존재하지 않는 계정"},e.env.DISCORD_WEBHOOK_URL),e.json({success:!1,error:"아이디 또는 비밀번호가 일치하지 않습니다"},401)}const l=a==="admin"&&(t==="admin"||t==="admin@example.com")&&r==="admin123",u=a==="seller"&&(t==="seller1"&&r==="seller123"||t==="seller2"&&r==="seller123"),d=i.password_hash&&i.password_hash.includes(`placeholder_hash_for_${r}`);if(!(l||u||d)){const{sendDiscordAlert:q,addLoginHistory:P,detectSuspiciousLogin:L,getLoginHistory:M}=await Promise.resolve().then(()=>ks);P(n,!1);const W=M(n),F=L(n,o,a,W);return await q({type:F?"suspicious_login":"login_failure",userId:i.id,username:i.username,userType:a,ip:n,userAgent:o,timestamp:new Date().toISOString(),details:F?"⚠️ 5분 내 3회 이상 실패 또는 의심스러운 패턴":"비밀번호 불일치",metadata:{"최근 실패 횟수":W.filter(O=>!O.success).length.toString()}},e.env.DISCORD_WEBHOOK_URL),e.json({success:!1,error:"아이디 또는 비밀번호가 일치하지 않습니다"},401)}if(!i.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);if(a==="seller"&&i.status!=="approved")return e.json({success:!1,error:"승인 대기 중인 계정입니다"},403);const{generateAccessToken:_,generateRefreshToken:f,getJwtSecret:g}=await Promise.resolve().then(()=>qt),S=g(e.env),w=await _({userId:i.id,userType:a,email:i.email},S),E=await f({userId:i.id,userType:a,email:i.email},S);await s.prepare(`UPDATE ${c} SET last_login_at = datetime('now') WHERE id = ?`).bind(i.id).run();const{sendDiscordAlert:T,addLoginHistory:y,detectSuspiciousLogin:R,getLoginHistory:U}=await Promise.resolve().then(()=>ks);y(n,!0);const A=U(n),D=R(n,o,a,A);return(a==="admin"||D)&&await T({type:D?"suspicious_login":"login_success",userId:i.id,username:i.username,userType:a,ip:n,userAgent:o,timestamp:new Date().toISOString(),details:D?"⚠️ 의심스러운 패턴 감지 (관리자 로그인 또는 비정상 User Agent)":void 0},e.env.DISCORD_WEBHOOK_URL),console.log(`[JWT Login] ✅ ${a} ${i.username} logged in with JWT (KV Write: 0)`),e.json({success:!0,data:{accessToken:w,refreshToken:E,user:{id:i.id,username:i.username,name:i.name,email:i.email,type:a,businessName:i.business_name}}})}catch(t){return console.error("Login error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/auth/logout",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.header("X-Session-Token");return t&&await e.env.SESSION_KV.delete(`session:${t}`),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/seller/register",b(),async e=>{const{DB:s}=e.env;try{const{email:t,password:r,name:a,phone:n,business_number:o,company_name:i}=await e.req.json();if(!t||!r||!a||!n)return e.json({success:!1,error:"필수 항목을 모두 입력해주세요"},400);if(r.length<6)return e.json({success:!1,error:"비밀번호는 6자 이상이어야 합니다"},400);const c=t.split("@")[0],l=`placeholder_hash_for_${r}`;try{const u=await s.prepare(`
        INSERT INTO sellers (
    ...
    `).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:r.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/auth/kakao/sync/callback",async e=>{var t,r,a,n,o,i,c,l,u,d,m,_,f;const{DB:s}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!s);const g=e.req.query("code"),S=e.req.query("state")||"/",w=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!g,state:S,error:w}),w)return console.error("[Kakao Sync] OAuth error:",w),e.redirect(`${S}?error=kakao_oauth_${w}`);if(!g)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${S}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const E=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",T=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",E.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",T),console.log("[Kakao Sync] Step 1: Fetching access token...");const y=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:E,redirect_uri:T,code:g})});if(console.log("[Kakao Sync] Token response status:",y.status),console.log("[Kakao Sync] Token request details:",{client_id:E,redirect_uri:T,code_length:g.length,code_prefix:g.substring(0,20)}),!y.ok){const K=await y.text();return console.error("[Kakao Sync] Token request failed:",K),e.redirect(`${S}?error=token_request_failed&detail=${encodeURIComponent(K)}`)}const R=await y.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!R.access_token,error:R.error,errorDescription:R.error_description}),!R.access_token)return console.error("[Kakao Sync] Token error:",R),e.redirect(`${S}?error=token_failed&detail=${encodeURIComponent(R.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const U=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${R.access_token}`}});console.log("[Kakao Sync] User response status:",U.status);const A=await U.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!A.id,id:A.id,hasNickname:!!((t=A.properties)!=null&&t.nickname||(a=(r=A.kakao_account)==null?void 0:r.profile)!=null&&a.nickname)}),!A.id)return console.error("[Kakao Sync] Failed to get user info:",A),e.redirect(`${S}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const D=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${R.access_token}`}});console.log("[Kakao Sync] Terms response status:",D.status);let q=null;if(D.ok?(q=await D.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=q.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=q.allowed_service_terms)==null?void 0:o.map(K=>K.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!s)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${S}?error=db_not_available`);const P=A.id.toString(),L=((i=A.properties)==null?void 0:i.nickname)||((l=(c=A.kakao_account)==null?void 0:c.profile)==null?void 0:l.nickname)||"Kakao User",M=((u=A.kakao_account)==null?void 0:u.email)||"",W=((d=A.properties)==null?void 0:d.profile_image)||((_=(m=A.kakao_account)==null?void 0:m.profile)==null?void 0:_.profile_image_url)||"",F=R.access_token,O=((f=q==null?void 0:q.allowed_service_terms)==null?void 0:f.map(K=>K.tag))||[],le=JSON.stringify(O);console.log("[Kakao Sync] User data:",{kakaoId:P,nickname:L,email:M?"exists":"none",serviceTerms:O});try{const K=await s.prepare(`
      ...
      `).bind(P).first();console.log("[Kakao Sync] Existing user check:",!!K);let x;K?(x=K.id,await s.prepare(`
          ...
          WHERE id = ?
        `).bind(L,M,W,x).run(),console.log("[Kakao Sync] Updated user:",x)):(x=(await s.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
        ...
        `).bind(P,L,M||null,W||null).run()).meta.last_row_id,console.log("[Kakao Sync] Created user:",x)),console.log("[Kakao Sync] User saved successfully, userId:",x),console.log("[Kakao Sync] Step 4: Generating JWT tokens...");const fe=oe(e.env),ie=await ke({userId:x,userType:"user",email:M||void 0},fe),_s=await us({userId:x,userType:"user",email:M||void 0},fe);console.log("[Kakao Sync] ✅ JWT 토큰 발급 완료 for user:",x),console.log("[Kakao Sync] Step 5: Redirecting with JWT...");const Ge=S.includes("?")?`${S}&access_token=${encodeURIComponent(ie)}&refresh_token=${encodeURIComponent(_s)}&userId=${x}&userName=${encodeURIComponent(L)}&userEmail=${encodeURIComponent(M||"")}`:`${S}?access_token=${encodeURIComponent(ie)}&refresh_token=${encodeURIComponent(_s)}&userId=${x}&userName=${encodeURIComponent(L)}&userEmail=${encodeURIComponent(M||"")}`;return console.log("[Kakao Sync] Redirect URL (JWT):",Ge.substring(0,100)+"..."),e.redirect(Ge)}catch(K){return console.error("[Kakao Sync] Database error:",K),console.error("[Kakao Sync] DB error details:",{message:K.message,name:K.name}),e.redirect(`${S}?error=database_error&detail=${encodeURIComponent(K.message)}`)}}catch(g){console.error("[Kakao Sync] Exception:",g),console.error("[Kakao Sync] Error details:",{message:g.message,stack:g.stack,name:g.name});const S=e.req.query("state")||"/",w=encodeURIComponent(g.message||"unknown");return e.redirect(`${S}?error=kakao_sync_failed&detail=${w}`)}});p.post("/api/auth/kakao/callback",b(),async e=>{const{DB:s}=e.env;try{const{code:t,redirect_uri:r}=await e.req.json();if(!t)return e.json({success:!1,error:"Authorization code is required"},400);if(!e.env.KAKAO_REST_API_KEY)return console.error("[Kakao Callback] KAKAO_REST_API_KEY not configured"),e.json({success:!1,error:"Server configuration error",code:"MISSING_API_KEY"},500);const a=r||"https://live.ur-team.com/auth/kakao/callback";console.log("[Kakao Callback] Starting OAuth flow");const n=await la(t,a,e.env.KAKAO_REST_API_KEY),{user:o}=await xt(s,n),i=oe(e.env),c=await ke({userId:o.id,userType:"user",email:o.email||void 0},i),l=await us({userId:o.id,userType:"user",email:o.email||void 0},i);return console.log("[Kakao Callback] ✅ JWT 토큰 발급 완료 for user:",o.id),e.json({success:!0,data:{accessToken:c,refreshToken:l,user:{id:o.id,name:o.name,email:o.email,profile_image:o.profile_image}}})}catch(t){return console.error("[Kakao Callback] Error:",t),t instanceof ee?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t.message||"Internal server error",code:"UNKNOWN_ERROR"},500)}});p.post("/api/auth/kakao/sync",b(),async e=>{const{DB:s}=e.env;try{const{accessToken:t}=await e.req.json();if(!t)return e.json({success:!1,error:"Access token is required"},400);console.log("[Kakao Sync] Verifying access token");const r=Date.now(),{user:a}=await xt(s,t);console.log("[Kakao Sync] ProcessKakaoLogin completed in",Date.now()-r,"ms");const n=oe(e.env),o=await ke({userId:a.id,userType:"user",email:a.email||void 0},n),i=await us({userId:a.id,userType:"user",email:a.email||void 0},n);return console.log("[Kakao Sync] ✅ JWT 토큰 발급 완료 for user:",a.id),console.log("[Kakao Sync] Total login time:",Date.now()-r,"ms"),e.json({success:!0,data:{accessToken:o,refreshToken:i,user:{id:a.id,name:a.name,email:a.email,profile_image:a.profile_image}}})}catch(t){return console.error("[Kakao Sync] Error:",t),t instanceof ee?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t instanceof Error?t.message:"Login failed",code:"UNKNOWN_ERROR"},500)}});p.get("/api/auth/validate",b(),async e=>{try{const s=e.req.header("Authorization"),t=(s==null?void 0:s.replace("Bearer ",""))||"";if(!t)return e.json({success:!1,valid:!1,error:"No JWT token provided",code:"NO_TOKEN"},401);const r=oe(e.env);console.log("[JWT Validate] Secret (first 20 chars):",r.substring(0,20)),console.log("[JWT Validate] Token (first 50 chars):",t.substring(0,50));const a=await $s(t,r);return console.log("[JWT Validate] Payload:",a?"Valid":"Invalid/Expired"),a?e.json({success:!0,valid:!0,data:{user_id:a.userId,user_type:a.userType,email:a.email,session_valid:!0},user:{userId:a.userId,userType:a.userType,email:a.email}}):e.json({success:!1,valid:!1,error:"JWT token expired or invalid",code:"TOKEN_EXPIRED"},401)}catch(s){return console.error("[JWT Validate Error]",s),e.json({success:!1,valid:!1,error:"Internal server error",code:"INTERNAL_ERROR"},500)}});p.post("/api/auth/refresh",b(),async e=>{try{const s=await e.req.json(),{refreshToken:t}=s;if(!t)return e.json({success:!1,error:"No refresh token provided",code:"NO_REFRESH_TOKEN"},400);const r=oe(e.env),a=await $t(t,r);return a?e.json({success:!0,data:{accessToken:a}}):e.json({success:!1,error:"Refresh token expired or invalid",code:"REFRESH_TOKEN_EXPIRED"},401)}catch(s){return console.error("[JWT Refresh Error]",s),e.json({success:!1,error:"Internal server error",code:"INTERNAL_ERROR"},500)}});p.post("/api/auth/kakao/logout",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.header("X-Session-Token")||"";return t&&(await s.prepare("DELETE FROM admin_sessions WHERE session_token = ?").bind(t).run(),console.log("[Kakao Sync] Session deleted")),e.json({success:!0})}catch(t){return console.error("[Kakao Sync] Logout error:",t),e.json({success:!1,error:"Logout failed"},500)}});p.post("/api/auth/kakao/unlink",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증이 필요합니다"},401);if(console.log("[Kakao Unlink] Starting unlink process..."),!await s.prepare(`
    ...
    `).run(),await s.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(n.id).run(),await s.prepare("DELETE FROM users WHERE id = ?").bind(n.id).run(),console.log("[Kakao Webhook] User data deleted successfully"),e.json({success:!0})):(console.log("[Kakao Webhook] User not found:",r),e.json({success:!0}))}catch(t){return console.error("[Kakao Webhook] Error:",t),e.json({success:!1,error:"Webhook processing failed"},500)}});p.get("/api/auth/user/verify",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const r=await ze(e.env.SESSION_KV,t);if(!r||r.user_type!=="user")return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=await s.prepare(`
      ...
      FROM users 
      WHERE id = ?
    `).bind(userId).first();return a?e.json({success:!0,data:{user:{id:a.id,name:a.name,email:a.email,profileImage:a.profile_image,phone:a.phone}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/shipping-addresses",b(),C,async e=>{const{DB:s}=e.env,t=e.get("userId");try{const r=await s.prepare(`
      SELECT 
        id, 
        user_id, 
        recipient_name, 
    ...
    `).bind(t).all();return e.json({success:!0,data:r.results||[]})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/shipping-addresses/:userId",b(),C,async e=>{const{DB:s}=e.env,t=e.get("userId"),r=parseInt(e.req.param("userId"));try{if(r!==t)return e.json({success:!1,error:"본인의 배송지만 조회할 수 있습니다."},403);const a=await s.prepare(`
      SELECT 
        id, 
        user_id, 
        recipient_name, 
    ...
    `).bind(t).all();return e.json({success:!0,data:a.results||[]})}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/shipping-addresses",b(),C,async e=>{const{DB:s}=e.env;try{const t=await e.req.json(),r=t.user_id,a=t.recipient_name,n=t.phone,o=t.postal_code,i=t.address,c=t.address_detail,l=t.is_default;if(console.log("[POST /api/shipping-addresses] Received:",JSON.stringify(t)),!r||!a||!n||!i)return console.error("[POST /api/shipping-addresses] Missing required fields:",{userId:r,recipientName:a,phone:n,address:i}),e.json({success:!1,error:"필수 정보를 입력해주세요"},400);l&&await s.prepare("UPDATE shipping_addresses SET is_default = 0 WHERE user_id = ?").bind(r).run();const u=await s.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'), datetime('now'))
    `).bind(r,a,n,o||"",i,c||"",l?1:0).run();return console.log("[POST /api/shipping-addresses] Success:",{id:u.meta.last_row_id}),e.json({success:!0,data:{id:u.meta.last_row_id}})}catch(t){return console.error("[POST /api/shipping-addresses] Error:",t),e.json({success:!1,error:t.message},500)}});p.put("/api/shipping-addresses/:id",b(),C,async e=>{const{DB:s}=e.env;try{const t=e.req.param("id"),r=await e.req.json(),a=r.user_id,n=r.recipient_name,o=r.phone,i=r.postal_code,c=r.address,l=r.address_detail,u=r.is_default;return u&&await s.prepare("UPDATE shipping_addresses SET is_default = 0 WHERE user_id = ?").bind(a).run(),await s.prepare(`
  ...
  `;const o=[];s&&(n+=" AND ls.status = ?",o.push(s)),t&&(n+=" AND ls.seller_id = ?",o.push(t)),n+=' ORDER BY CASE ls.status WHEN "active" THEN 1 WHEN "scheduled" THEN 2 ELSE 3 END, ls.created_at DESC',n+=" LIMIT ? OFFSET ?",o.push(parseInt(r),parseInt(a));const{results:i}=await e.prepare(n).bind(...o).all();return i}p.get("/api/live-streams/:id",async e=>{const{DB:s}=e.env,t=e.req.param("id");try{const r=`live_stream:${t}`,a=30,n=Se(r);if(n)return console.log("[LiveStream] ⚡ 메모리 캐시 히트:",r),e.executionCtx.waitUntil((async()=>{try{console.log("[LiveStream] 🔄 백그라운드 갱신 시작:",r);const i=await st(s,t);i&&(Q(r,i,a),console.log("[LiveStream] ✅ 백그라운드 갱신 완료:",r))}catch(i){console.error("[LiveStream] ❌ 백그라운드 갱신 실패:",i)}})()),e.json({success:!0,data:n});console.log("[LiveStream] 💾 DB 조회:",r);const o=await st(s,t);return o?(Q(r,o,a),e.json({success:!0,data:o})):e.json({success:!1,error:"Stream not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});async function st(e,s){return await e.prepare(`
    ...
    LEFT JOIN products p ON ls.current_product_id = p.id
    WHERE ls.id = ?
  `).bind(s).first()}p.get("/api/products",Hs(Fs.products),async e=>{const{DB:s,CACHE_KV:t}=e.env;try{const r=e.req.query("featured"),a=parseInt(e.req.query("limit")||"20"),n=parseInt(e.req.query("offset")||"0"),o=`products:list:${r||"all"}:${a}:${n}`,i=Se(o);if(i)return e.executionCtx.waitUntil((async()=>{try{const l=await tt(s,r,a,n);Q(o,l,3600),await rs(t,o,l,300,!1)}catch(l){console.error("[Cache Revalidate] Products error:",l)}})()),e.json({success:!0,data:i,cached:!0});const c=await tt(s,r,a,n);return Q(o,c,3600),await rs(t,o,c,300,!1),e.json({success:!0,data:c,cached:!1})}catch(r){return console.error("Products list error:",r),e.json({success:!1,error:r.message},500)}});async function tt(e,s,t,r){let a;return s==="true"?a=`
      SELECT 
        p.id,
        p.name,
        p.description,
    ...
    `:a=`
      ...
      ORDER BY sold_count DESC, p.created_at DESC
      LIMIT ? OFFSET ?
    `,(await e.prepare(a).bind(t,r).all()).results||[]}p.get("/api/products/popular",async e=>{const{DB:s,CACHE_KV:t}=e.env;try{const r="products:popular",a=Se(r);if(a)return e.executionCtx.waitUntil((async()=>{try{const o=await rt(s);Q(r,o,3600),await rs(t,r,o,600,!1)}catch(o){console.error("[Cache Revalidate] Popular products error:",o)}})()),e.json({success:!0,data:a,cached:!0});const n=await rt(s);return Q(r,n,3600),await rs(t,r,n,600,!1),e.json({success:!0,data:n,cached:!1})}catch(r){return console.error("Popular products error:",r),e.json({success:!1,error:r.message},500)}});async function rt(e){return(await e.prepare(`
    SELECT 
      p.id,
      p.name,
      p.description,
    ...
    `).bind(r,r).all(),o=[...(a.results||[]).map(i=>({type:"product",text:i.name})),...(n.results||[]).map(i=>({type:"seller",text:i.display_name}))];return e.json({success:!0,data:{suggestions:o}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/products/search",async e=>{const{DB:s}=e.env;try{const t=e.req.query("q")||"",r=parseInt(e.req.query("limit")||"20"),a=parseInt(e.req.query("offset")||"0");if(!t.trim())return e.json({success:!1,error:"Search query is required"},400);const n=t.trim(),o=`${n}*`;try{if(await s.prepare(`
      ...
      `).bind(c,c,c,c,c,r,a).all(),u=await s.prepare(`
        ...
        WHERE (p.name LIKE ? OR p.description LIKE ? OR p.category LIKE ?
               OR s.display_name LIKE ? OR s.username LIKE ?)
          AND p.is_active = 1
      `).bind(c,c,c,c,c).first();return e.json({success:!0,data:{products:l.results||[],total:(u==null?void 0:u.total)||0,query:t,limit:r,offset:a,searchMethod:"like"}})}}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/products/:id",async e=>{const{DB:s}=e.env,t=e.req.param("id");try{const r=`product:detail:${t}`,a=Se(r);if(a)return e.executionCtx.waitUntil((async()=>{try{const o=await at(s,t);Q(r,o,1800)}catch(o){console.error("[Cache Revalidate] Product detail error:",o)}})()),e.json({success:!0,data:a,cached:!0});const n=await at(s,t);return n?(Q(r,n,1800),e.json({success:!0,data:n,cached:!1})):e.json({success:!1,error:"Product not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});async function at(e,s){const t=await e.prepare(`
    SELECT 
      p.*,
  ...
  `).bind(s).first();if(!t)return null;const r=await e.prepare("SELECT id, product_id, option_type, option_value, price_adjustment, stock, created_at FROM product_options WHERE product_id = ?").bind(s).all();return{product:t,options:r.results}}p.get("/api/products/:id/stock",Hs(Fs.microCache),async e=>{const{DB:s}=e.env,t=e.req.param("id");try{const r=await s.prepare("SELECT id, name, stock FROM products WHERE id = ? AND is_active = 1").bind(t).first();return r?e.json({success:!0,data:{productId:r.id,productName:r.name,stock:r.stock,available:r.stock>0}}):e.json({success:!1,error:"Product not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/streams/:streamId/products",async e=>{const{DB:s}=e.env,t=e.req.param("streamId");try{const r=await s.prepare(`
    ...
    `).bind(t).all();return e.json({success:!0,data:r.results})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/cart",C,async e=>{const{DB:s}=e.env,t=e.get("userId");try{const r=await s.prepare(`
      SELECT 
        ci.*,
    ...
    `).bind(t).all();return e.json({success:!0,data:r.results})}catch(r){return e.json({success:!1,error:`장바구니 조회 실패: ${r.message}`},500)}});p.get("/api/cart/:userId",C,async e=>{const{DB:s}=e.env,t=e.get("userId"),r=e.req.param("userId");try{let a=await s.prepare("SELECT id FROM users WHERE id = ?").bind(t).first();if(!a)return e.json({success:!1,error:"사용자를 찾을 수 없습니다."},404);const n=a.id;if(r!==String(n))return e.json({success:!1,error:"본인의 장바구니만 조회할 수 있습니다."},403);const o=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
        p.image_url as image_url,
    ...
    `).bind(l,a,n||null,n||null).first();let m;if(d){const _=d.quantity+o;await s.prepare(`
      ...
      `).bind(_,i,d.id).run(),m=d.id}else m=(await s.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(l,a,n||null,o,i,c||null).run()).meta.last_row_id;return e.json({success:!0,data:{id:m,isUpdate:!!d}})}catch(t){return console.error("[API /api/cart POST] Error:",t),console.error("[API /api/cart POST] Error message:",t.message),console.error("[API /api/cart POST] Error stack:",t.stack),e.json({success:!1,error:"Failed to add to cart: "+(t.message||"Unknown error")},500)}});p.delete("/api/cart/:cartItemId",C,async e=>{const{DB:s}=e.env,t=e.req.param("cartItemId");try{return await s.prepare("DELETE FROM cart_items WHERE id = ?").bind(t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.delete("/api/cart/clear/:userId",C,nn("cart"),async e=>{const{DB:s}=e.env,t=e.req.param("userId");try{return await s.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(t).run(),e.json({success:!0,message:"장바구니가 비워졌습니다."})}catch(r){return e.json({success:!1,error:r.message},500)}});p.put("/api/cart/:cartItemId",C,async e=>{const{DB:s}=e.env,t=e.req.param("cartItemId");try{const r=await e.req.json(),{quantity:a}=r;if(!a||a<1)return e.json({success:!1,error:"Invalid quantity"},400);const n=await s.prepare(`
      SELECT ci.product_id, p.stock
      FROM cart_items ci
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id = ?
    `).bind(t).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await s.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,t).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.post("/api/orders",C,async e=>{const{DB:s}=e.env;try{const t=await e.req.json(),{userId:r,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:l,recipientPhone:u,deliveryMemo:d,totalAmount:m,shippingFee:_,orderNumber:f,paymentKey:g,paymentMethod:S}=t;if(o&&o.length>0){const D=o.map($=>$.productId),q=D.map(()=>"?").join(","),P=await s.prepare(`
        SELECT id, name, price, stock 
        FROM products 
        WHERE id IN (${q})
      `).bind(...D).all(),L=new Map(P.results.map($=>[$.id,$])),M=[],W=[];try{for(const $ of o){const se=L.get($.productId);if(!se)throw new Error(`상품을 찾을 수 없습니다 (ID: ${$.productId})`);if(se.stock-(se.reserved_stock||0)<$.quantity)throw new Error(`죄송합니다. 방금 상품이 모두 판매되었습니다. (${se.name})`);if((await s.prepare(`
            UPDATE products 
            SET reserved_stock = reserved_stock + ?
            WHERE id = ? AND (stock - reserved_stock) >= ?
          `).bind($.quantity,$.productId,$.quantity).run()).meta.changes===0)throw new Error(`죄송합니다. 방금 상품이 모두 판매되었습니다. (${se.name})`);console.log(`[Stock] ✅ 재고 예약 성공: ${se.name} (${$.quantity}개)`),W.push({product_id:$.productId,quantity:$.quantity}),M.push({product_id:$.productId,option_id:$.optionId||null,quantity:$.quantity,price:$.price,product_name:se.name,product_stock:se.stock})}}catch($){if(console.error("[Stock] ❌ 재고 예약 실패:",$.message),W.length>0){console.log(`[Stock] 🔄 ${W.length}개 상품 예약 롤백 시작...`);for(const se of W)await s.prepare(`
              UPDATE products 
              SET reserved_stock = reserved_stock - ?
              WHERE id = ?
            `).bind(se.quantity,se.product_id).run();console.log("[Stock] ✅ 예약 롤백 완료")}return e.json({success:!1,error:$.message},400)}const F=new Date,O=F.getFullYear().toString().slice(-2),le=(F.getMonth()+1).toString().padStart(2,"0"),K=F.getDate().toString().padStart(2,"0"),x=`${O}${le}${K}`,fe=Math.random().toString(36).substring(2,7).toUpperCase(),ie=f||`ORD-${x}-${fe}`,_s=c?`${i} ${c}`:i,Ge=new Date(Date.now()+600*1e3).toISOString(),Ws=(await s.prepare(`
        INSERT INTO orders (
      ...
      `).bind(ie,r||null,m||0,"pending","pending",_s||null,l||null,u||null,d||null,g||null,Ge).run()).meta.last_row_id;for(const $ of M)await s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(Ws,$.product_id,$.option_id,$.quantity,$.price,$.product_name).run();return console.log(`[Order] ✅ 주문 생성 완료: ${ie} (예약 만료: ${Ge})`),e.json({success:!0,data:{orderId:Ws,orderNumber:ie,totalAmount:m}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const w=a.map(()=>"?").join(","),E=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${w})
    `).bind(...a).all();if(E.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const D of E.results)if(D.product_stock<D.quantity)return e.json({success:!1,error:`Insufficient stock for ${D.product_name}`},400);const T=E.results.reduce((D,q)=>D+q.price_snapshot*q.quantity,0),y=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,U=(await s.prepare(`
      INSERT INTO orders (
        order_number, user_id, total_amount,
        shipping_address, shipping_name, shipping_phone
      ) VALUES (?, ?, ?, ?, ?, ?)
    `).bind(y,r,T,n.address,n.name,n.phone).run()).meta.last_row_id,A=[];for(const D of E.results){let q=!1,P="";for(let L=0;L<3;L++){const M=await s.prepare(`
          SELECT stock, version FROM products WHERE id = ?
        `).bind(D.product_id).first();if(!M){P=`상품을 찾을 수 없습니다: ${D.product_name}`;break}const W=M.stock,F=M.version;if(W<D.quantity){P=`재고 부족: ${D.product_name} (남은 재고: ${W}개)`;break}if((await s.prepare(`
          UPDATE products 
          SET stock = stock - ?, 
              version = version + 1,
              updated_at = datetime('now')
          WHERE id = ? 
            ...
            AND stock >= ?
            AND is_active = 1
        `).bind(D.quantity,D.product_id,F,D.quantity).run()).meta.changes>0){q=!0,console.log(`[재고] ✅ 재고 차감 성공: ${D.product_name} (수량: ${D.quantity}, 버전: ${F} → ${F+1})`);break}console.warn(`[재고] ⚠️ 버전 충돌 감지 (시도 ${L+1}/3): ${D.product_name}`),L<2?await new Promise(le=>setTimeout(le,50*(L+1))):P="주문 처리 중 오류 발생. 잠시 후 다시 시도해주세요. (동시 주문 처리 중)"}if(!q)return e.json({success:!1,error:P||"주문 처리 중 오류가 발생했습니다."},P.includes("재고 부족")?400:409);A.push(s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(U,D.product_id,D.option_id,D.quantity,D.price_snapshot,D.product_name))}A.push(s.prepare(`DELETE FROM cart_items WHERE id IN (${w})`).bind(...a)),await s.batch(A);try{const D=E.results.map(L=>L.product_id),q=D.map(()=>"?").join(","),P=await s.prepare(`
        SELECT DISTINCT seller_id 
        FROM products 
        WHERE id IN (${q}) AND seller_id IS NOT NULL
      `).bind(...D).all();for(const L of P.results){const M=L.seller_id;await cn(s,M,y,buyerName||shippingName||"고객",T)}}catch(D){console.error("[Order] Notification error:",D)}return e.json({success:!0,data:{orderId:U,orderNumber:y,totalAmount:T}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/current-product",async e=>{const{DB:s,LIVE_CACHE:t}=e.env,r=e.req.param("streamId");try{const a=`current-product:${r}`,n=await Ht(t,a,3);if(n)return e.json({success:!0,data:n});const o=await s.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(r).first();if(!o||!o.current_product_id)return await ws(t,a,null,3),e.json({success:!0,data:null});const i=await s.prepare(`
    ...
    `).bind(t,r).run();return e.json({success:!0,data:{id:i.meta.last_row_id,userId:t,productId:r,productName:n.name}})}catch(t){return console.error("[Wishlist] Add error:",t),e.json({success:!1,error:t.message},500)}});p.delete("/api/wishlists/:id",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.param("id"),{userId:r}=e.req.query();return r?await s.prepare("SELECT id FROM wishlists WHERE id = ? AND user_id = ?").bind(t,r).first()?(await s.prepare("DELETE FROM wishlists WHERE id = ? AND user_id = ?").bind(t,r).run(),e.json({success:!0,message:"찜 목록에서 삭제되었습니다."})):e.json({success:!1,error:"찜 목록에서 찾을 수 없습니다."},404):e.json({success:!1,error:"사용자 ID가 필요합니다."},400)}catch(t){return console.error("[Wishlist] Delete error:",t),e.json({success:!1,error:t.message},500)}});p.delete("/api/wishlists/product/:productId",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.param("productId"),{userId:r}=e.req.query();return r?(await s.prepare("DELETE FROM wishlists WHERE user_id = ? AND product_id = ?").bind(r,t).run()).meta.changes===0?e.json({success:!1,error:"찜 목록에서 찾을 수 없습니다."},404):e.json({success:!0,message:"찜 목록에서 삭제되었습니다."}):e.json({success:!1,error:"사용자 ID가 필요합니다."},400)}catch(t){return console.error("[Wishlist] Delete by product error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/wishlists/:userId",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.param("userId"),r=parseInt(e.req.query("limit")||"20"),a=parseInt(e.req.query("offset")||"0"),{results:n}=await s.prepare(`
      ...
      LIMIT ? OFFSET ?
    `).bind(t,r,a).all(),o=await s.prepare("SELECT COUNT(*) as count FROM wishlists WHERE user_id = ?").bind(t).first();return e.json({success:!0,data:{items:n,total:(o==null?void 0:o.count)||0,limit:r,offset:a}})}catch(t){return console.error("[Wishlist] Get error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/wishlists/check/:userId/:productId",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.param("userId"),r=e.req.param("productId"),a=await s.prepare("SELECT id FROM wishlists WHERE user_id = ? AND product_id = ?").bind(t,r).first();return e.json({success:!0,data:{isWishlisted:!!a,wishlistId:(a==null?void 0:a.id)||null}})}catch(t){return console.error("[Wishlist] Check error:",t),e.json({success:!1,error:t.message},500)}});p.delete("/api/shipping-addresses/:id",C,async e=>{const{DB:s}=e.env,t=e.req.param("id");e.get("userId");try{return await s.prepare(`
      DELETE FROM shipping_addresses WHERE id = ? AND user_id = ?
    ...
    `).all();return e.json({success:!0,data:r.results||[]})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/orders",C,async e=>{const{DB:s}=e.env,t=e.get("userId");try{const r=await s.prepare(`
      SELECT 
        o.*,
        oi.id as item_id,
        oi.product_id,
    ...
    `).bind(t,a,n,o||null,c).run(),e.json({success:!0,message:"User banned successfully"})}catch(r){return console.error("Error banning user:",r),e.json({success:!1,error:r.message},500)}});p.delete("/api/chat/:liveStreamId/ban/:userId",b(),async e=>{const{DB:s}=e.env,t=e.req.param("liveStreamId"),r=e.req.param("userId");try{return await s.prepare(`
      ...
      WHERE live_stream_id = ? AND user_id = ?
    `).bind(t,r).run(),e.json({success:!0,message:"Ban removed successfully"})}catch(a){return console.error("Error removing ban:",a),e.json({success:!1,error:a.message},500)}});async function fn(e,s,t){try{const r=new TextEncoder,a=r.encode(t),n=r.encode(e),o=await crypto.subtle.importKey("raw",a,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("HMAC",o,n),c=Array.from(new Uint8Array(i)),l=btoa(String.fromCharCode(...c));return s===l}catch(r){return console.error("[Webhook] 서명 검증 오류:",r),!1}}p.post("/api/payments/webhook",async e=>{const{DB:s}=e.env;try{const t=e.req.header("toss-signature"),r=await e.req.text();if(t&&e.env.TOSS_SECRET_KEY){if(!await fn(r,t,e.env.TOSS_SECRET_KEY))return console.error("[Webhook] ❌ 서명 검증 실패 - 위조된 웹훅 요청"),e.json({success:!1,error:"Invalid signature"},401);console.log("[Webhook] ✅ 서명 검증 성공")}else console.warn("[Webhook] ⚠️ 서명 검증 건너뜀 (개발 환경 또는 서명 없음)");const a=JSON.parse(r);switch(console.log("[Webhook] 토스페이먼츠 웹훅 수신:",{eventType:a.eventType,orderId:a.orderId,status:a.status,timestamp:new Date().toISOString()}),a.eventType){case"PAYMENT_STATUS_CHANGED":await hn(s,a);break;case"VIRTUAL_ACCOUNT_ISSUED":await En(s,a);break;default:console.log("[Webhook] 처리하지 않는 이벤트 타입:",a.eventType)}return e.json({success:!0})}catch(t){return console.error("[Webhook] ❌ 웹훅 처리 실패:",t.message),e.json({success:!1,error:t.message},500)}});async function hn(e,s){const{orderId:t,status:r,paymentKey:a}=s;console.log("[Webhook] 결제 상태 변경:",{orderId:t,status:r}),await e.prepare(`
    UPDATE payments 
    SET status = ?, 
        updated_at = CURRENT_TIMESTAMP,
        pg_raw_data = ?
  ...
  `).bind(r,JSON.stringify(s),a).run(),(r==="DONE"||r==="completed")&&(await e.prepare(`
      ...
      SET payment_status = 'approved',
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE order_number = ?
    `).bind(t).run(),console.log("[Webhook] ✅ 가상계좌 입금 완료 처리:",t))}async function En(e,s){const{orderId:t,virtualAccount:r}=s;console.log("[Webhook] 가상계좌 발급:",{orderId:t,bank:r==null?void 0:r.bank,accountNumber:r==null?void 0:r.accountNumber}),await e.prepare(`
    UPDATE payments 
  ...
  `).bind(r==null?void 0:r.bank,r==null?void 0:r.accountNumber,r==null?void 0:r.customerName,r==null?void 0:r.dueDate,JSON.stringify(s),t).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",t)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:s}=e.env;try{const t=e.req.param("paymentKey"),r=await e.req.json(),{cancelReason:a,cancelAmount:n}=r;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:t,cancelReason:a,cancelAmount:n}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const o=await s.prepare(`
      ...
      FROM payments 
      WHERE pg_payment_key = ?
    `).bind(t).first();if(!o)return e.json({success:!1,error:"결제 정보를 찾을 수 없습니다."},404);if(o.status==="CANCELED"||o.status==="cancelled")return e.json({success:!1,error:"이미 취소된 결제입니다."},400);const i=o.pg_provider||"tosspayments",c=e.env.TOSS_SECRET_KEY;if(!c)return e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);const l=sn(i,c),u=n&&n<o.amount,d=n||o.amount;console.log("[Payment] PG 결제 취소 요청 중...",{pgProvider:i,paymentKey:t,cancelAmount:d,isPartial:u});const m=await l.cancelPayment({paymentKey:t,cancelReason:a,cancelAmount:d});return m.success?(console.log("[Payment] ✅ PG 결제 취소 완료:",{paymentKey:t,cancelAmount:d,canceledAt:m.canceledAt}),await s.prepare(`
      UPDATE payments 
      SET status = ?,
          cancelled_at = ?,
          pg_raw_data = ?,
...
`),_=new Date,f=`orders_${_.toISOString().split("T")[0]}_${_.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(r){return console.error("Export error:",r),e.json({success:!1,error:r.message},500)}});p.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const r=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(r).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,t.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,r).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${r}, 자동 발행 시작...`);const c=await s.prepare(`
      ...
      SET courier = ?, 
          ...
          updated_at = CURRENT_TIMESTAMP 
      WHERE order_number = ?
    `).bind(a,n,r).run();try{const c=await s.prepare("SELECT user_id FROM orders WHERE order_number = ?").bind(r).first();c&&c.user_id&&await Bt(s,c.user_id,r,"shipping",a,n)}catch(c){console.error("[Tracking] Notification error:",c)}return e.json({success:!0,message:"Tracking information updated"})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/admin/orders",async e=>{const{DB:s}=e.env,t=await H(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const r=await s.prepare(`
      SELECT o.*, u.name as user_name, u.email as user_email
      FROM orders o
      LEFT JOIN users u ON o.user_id = u.id
      ORDER BY o.created_at DESC
    `).all();return e.json({success:!0,data:r.results})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/sellers",async e=>{const{DB:s}=e.env,{limit:t="20",offset:r="0"}=e.req.query();try{const a=`sellers:list:${t}:${r}`,n=Se(a);if(n)return e.executionCtx.waitUntil((async()=>{try{const i=await nt(s,parseInt(t),parseInt(r));Q(a,i,3600)}catch(i){console.error("[Cache Revalidate] Sellers error:",i)}})()),e.json({success:!0,data:n,cached:!0});const o=await nt(s,parseInt(t),parseInt(r));return Q(a,o,3600),e.json({success:!0,data:o,cached:!1})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});async function nt(e,s,t){const r=`
...
`});const _="\uFEFF";return new Response(_+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(r){return console.error("CSV 내보내기 실패:",r),e.json({success:!1,error:r.message},500)}});p.post("/api/orders/create",C,async e=>{const{DB:s}=e.env;try{const{userId:t,cartItems:r,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:l,buyerCeoName:u}=await e.req.json();console.log("[DEPRECATED /api/orders/create] 주문 생성 요청:",{userId:t,cartItems:r==null?void 0:r.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const O=await s.prepare(`
        SELECT commission_rate FROM sellers WHERE id = ?
      `).bind(o).first();O&&O.commission_rate!==null&&(d=O.commission_rate)}console.log("수수료율:",{sellerId:o,commissionRate:d});const m=Math.floor(a*(d/100)),_=a-m;let f=null;if(n){const O=await s.prepare(`
        SELECT 
          id, 
          user_id, 
          recipient_name, 
        ...
        FROM shipping_addresses 
        WHERE id = ? AND user_id = ?
      `).bind(n,t).first();if(!O)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);f=O}if(!t)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const g=t,S=new Date,w=S.getFullYear().toString().slice(-2),E=(S.getMonth()+1).toString().padStart(2,"0"),T=S.getDate().toString().padStart(2,"0"),y=`${w}${E}${T}`,R=Math.random().toString(36).substring(2,7).toUpperCase(),U=`ORD-${y}-${R}`,A=r.map(O=>O.product_id),D=A.map(()=>"?").join(","),q=await s.prepare(`
      SELECT id, stock FROM products WHERE id IN (${D})
    `).bind(...A).all(),P=new Map(q.results.map(O=>[O.id,O.stock]));for(const O of r){const le=P.get(O.product_id);if(le===void 0)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${O.product_id})`},400);if(le<O.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${O.product_id})`},400)}const M=(await s.prepare(`
      INSERT INTO orders (
    ...
    `).bind(U,g,a,"pending",o||null,d,m,_,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,l||null,u||null).run()).meta.last_row_id,W=r.map(O=>s.prepare(`
        INSERT INTO order_items (order_id, product_id, option_id, quantity, price)
        VALUES (?, ?, ?, ?, ?)
      `).bind(M,O.product_id,O.option_id||null,O.quantity,O.price_snapshot||O.price)),F=r.map(O=>s.prepare(`
        UPDATE products SET stock = stock - ? WHERE id = ?
      `).bind(O.quantity,O.product_id));await s.batch([...W,...F]);try{const O=r.map(x=>x.product_id),le=O.map(()=>"?").join(","),K=await s.prepare(`
        SELECT id, name, stock, stock_alert_threshold, seller_id 
        FROM products 
        WHERE id IN (${le})
      `).bind(...O).all();for(const x of K.results){const fe=x.stock_alert_threshold||5,ie=x.stock;ie<=fe&&x.seller_id&&(await Wt(s,x.seller_id,x.name,ie,fe),console.log(`[Low Stock Alert] ${x.name}: ${ie} <= ${fe}`))}}catch(O){console.error("[Low Stock Alert] Error:",O)}return console.log("주문 생성 완료:",{orderId:M,orderNumber:U}),e.json({success:!0,orderId:M,orderNumber:U,totalAmount:a})}catch(t){return console.error("주문 생성 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/:orderNumber/refund",b(),C,async e=>{const{DB:s}=e.env;try{const t=e.req.param("orderNumber"),{reason:r}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:t,reason:r});const a=await s.prepare(`
    ...
    `).bind(a.id).all();if(n.results.length>0){const o=n.results.map(i=>s.prepare(`
          ...
          SET stock = stock + ?,
              ...
              updated_at = datetime('now')
          WHERE id = ?
        `).bind(i.quantity,i.product_id));await s.batch(o),console.log("[Order Refund] 재고 복구 완료:",{items:n.results.length})}return console.log("[Order Refund] ✅ 환불 완료:",{orderNumber:t,reason:r}),e.json({success:!0,message:"주문이 취소되었습니다",data:{orderNumber:t,cancelDate:new Date().toISOString()}})}catch(t){return console.error("[Order Refund] Error:",t),e.json({success:!1,error:t.message||"주문 취소 중 오류가 발생했습니다"},500)}});p.use("/api/seller/*",C);p.get("/api/seller/sales",b(),async e=>{try{const{DB:s}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const r=await ze(e.env.SESSION_KV,t);if(!r)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(r.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=r.seller_id||r.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],c=o||new Date().toISOString().split("T")[0],l=await s.prepare(`
...
`}return new Response(u,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{order_number:r}=await e.req.json();if(!r)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(t.sellerId).first();if(!n)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const o=await s.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),c=Math.floor(i/1.1),l=i-c,u=new Date().toISOString().split("T")[0],d=`${u}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,m=aa(n,a,o.results);let _,f,g;try{_=await ra(m),f=_.ntsConfirmNumber,g=_.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:f,invoiceKey:g,mockMode:Ze()})}catch(E){console.error("바로빌 API 호출 실패:",E),f="FAILED",g=null}const w=(await s.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(t).all();return e.json({success:!0,data:r.results})}catch(r){return console.error("라이브 목록 조회 실패:",r),e.json({success:!1,error:r.message},500)}});p.get("/api/seller/:sellerId/products-public",async e=>{const{DB:s}=e.env,t=e.req.param("sellerId");try{const r=await s.prepare(`
      ...
      ORDER BY created_at DESC
      LIMIT 100
    `).bind(t).all();return e.json({success:!0,data:r.results})}catch(r){return console.error("상품 목록 조회 실패:",r),e.json({success:!1,error:r.message},500)}});p.get("/api/notifications",C,async e=>{const{DB:s}=e.env;try{const t=e.get("userId"),r=e.get("userType"),a=parseInt(e.req.query("limit")||"50"),n=e.req.query("unread_only")==="true";let o=`
      SELECT * FROM notifications
      WHERE user_id = ? AND user_type = ?
    `;n&&(o+=" AND is_read = 0"),o+=" ORDER BY created_at DESC LIMIT ?";const i=await s.prepare(o).bind(t,r,a).all();return e.json({success:!0,data:i.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/notifications/unread-count",C,async e=>{const{DB:s}=e.env;try{const t=e.get("userId"),r=e.get("userType"),a=await s.prepare(`
      SELECT COUNT(*) as count
      FROM notifications
      WHERE user_id = ? AND user_type = ? AND is_read = 0
    `).bind(t,r).first();return e.json({success:!0,count:(a==null?void 0:a.count)||0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/notifications/:id/read",C,async e=>{const{DB:s}=e.env;try{const t=e.req.param("id"),r=e.get("userId"),a=e.get("userType");return await s.prepare("SELECT user_id, user_type FROM notifications WHERE id = ? AND user_id = ? AND user_type = ?").bind(t,r,a).first()?(await s.prepare("UPDATE notifications SET is_read = 1 WHERE id = ?").bind(t).run(),e.json({success:!0})):e.json({success:!1,error:"Notification not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/notifications/read-all",C,async e=>{const{DB:s}=e.env;try{const t=e.get("userId"),r=e.get("userType");return await s.prepare(`
      UPDATE notifications 
      SET is_read = 1 
      WHERE user_id = ? AND user_type = ? AND is_read = 0
    `).bind(t,r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/notifications/:id",C,async e=>{const{DB:s}=e.env;try{const t=e.req.param("id"),r=e.get("userId"),a=e.get("userType");return await s.prepare("SELECT user_id, user_type FROM notifications WHERE id = ? AND user_id = ? AND user_type = ?").bind(t,r,a).first()?(await s.prepare("DELETE FROM notifications WHERE id = ?").bind(t).run(),e.json({success:!0})):e.json({success:!1,error:"Notification not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/banners",async e=>{const{DB:s}=e.env;try{const t=new Date().toISOString(),r=await s.prepare(`
      SELECT * FROM banners
      WHERE is_active = 1
        AND (start_date IS NULL OR start_date <= ?)
        AND (end_date IS NULL OR end_date >= ?)
      ORDER BY display_order ASC, created_at DESC
    `).bind(t,t).all();return e.json({success:!0,data:r.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/admin/banners",C,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const r=await s.prepare(`
      SELECT * FROM banners
      ORDER BY display_order ASC, created_at DESC
    `).all();return e.json({success:!0,data:r.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/admin/banners",C,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const{title:r,image_url:a,link_url:n,description:o,is_active:i,display_order:c,start_date:l,end_date:u}=await e.req.json();if(!r||!a)return e.json({success:!1,error:"제목과 이미지는 필수입니다."},400);const d=await s.prepare(`
      INSERT INTO banners (title, image_url, link_url, description, is_active, display_order, start_date, end_date)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(r,a,n||null,o||null,i!==!1?1:0,c||0,l||null,u||null).run();return e.json({success:!0,id:d.meta.last_row_id})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/admin/banners/:id",C,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const r=e.req.param("id"),{title:a,image_url:n,link_url:o,description:i,is_active:c,display_order:l,start_date:u,end_date:d}=await e.req.json();return await s.prepare(`
      UPDATE banners
      SET title = ?, image_url = ?, link_url = ?, description = ?,
          is_active = ?, display_order = ?, start_date = ?, end_date = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(a,n,o||null,i||null,c?1:0,l||0,u||null,d||null,r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/admin/banners/:id",C,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const r=e.req.param("id");return await s.prepare("DELETE FROM banners WHERE id = ?").bind(r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/order-complete",e=>e.redirect("/order-complete.html",302));p.notFound(e=>{const s=e.req.path;return s.startsWith("/api/")?e.json({success:!1,error:"Not found",message:`The requested endpoint ${s} was not found.`},404):new Response(null,{status:404})});p.onError((e,s)=>{const t=s.req.path;if(e instanceof Xa)return console.error("[AppError]",{path:t,method:s.req.method,code:e.code,message:e.message,statusCode:e.statusCode}),s.json({success:!1,error:{code:e.code,message:e.message,...e.details&&{details:e.details}}},e.statusCode);if(console.error("[Global Error Handler]",{path:t,method:s.req.method,error:e.message,stack:e.stack}),t.startsWith("/api/")){let r=500,a="Internal Server Error";return e.message.includes("Unauthorized")||e.message.includes("로그인")?(r=401,a="인증이 필요합니다. 로그인해주세요."):e.message.includes("Forbidden")||e.message.includes("권한")?(r=403,a="접근 권한이 없습니다."):e.message.includes("Not found")||e.message.includes("찾을 수 없")?(r=404,a="요청하신 리소스를 찾을 수 없습니다."):(e.message.includes("Bad request")||e.message.includes("잘못된"))&&(r=400,a="잘못된 요청입니다."),s.json({success:!1,error:e.message||a},r)}return s.html(`
    <!DOCTYPE html>
    <html lang="ko">
    <head>
      <meta charset="UTF-8">
  ...
  `,500)});p.get("/api/admin/alimtalk/pricing",b(),async e=>{const{env:s}=e;try{const t=await s.DB.prepare(`
    ...
    `).bind(t||"2000-01-01",r||"2100-01-01").first(),n=await s.DB.prepare(`
      ...
      LIMIT 10
    `).bind(t||"2000-01-01",r||"2100-01-01").all();return e.json({success:!0,statistics:{total:a,by_seller:n.results}})}catch(t){return console.error("[Admin Alimtalk Statistics] Error:",t),e.json({success:!1,error:t.message},500)}});p.use("/api/seller/alimtalk/*",C);p.get("/api/seller/alimtalk/account",b(),async e=>{const{env:s}=e;try{const t=e.get("user");if(!t||t.userType!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const r=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts
      WHERE seller_id = ?
    `).bind(t.userId).first();return e.json({success:!0,account:r})}catch(t){return console.error("[Seller Alimtalk Account] Error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/alimtalk/register",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{channel_id:a,phone_number:n}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Missing required fields"},400);const o=Ft(n),i=await Sa(s,{channelId:a,phoneNumber:o});if(!i.success)return e.json({success:!1,error:"Failed to register Kakao channel"},500);const c=await s.DB.prepare(`
      INSERT INTO alimtalk_accounts 
      (seller_id, kakao_channel_id, channel_name, sender_key, phone_number, status)
      VALUES (?, ?, ?, ?, ?, 'active')
    `).bind(r.user_id,a,a,i.senderKey,o).run();return e.json({success:!0,account_id:c.meta.last_row_id,sender_key:i.senderKey,message:"Kakao channel registered successfully"})}catch(t){return console.error("[Seller Alimtalk Register] Error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/alimtalk/templates",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const a=await s.DB.prepare(`
    ...
    `).bind(r.user_id).first();if(!a)return e.json({success:!1,error:"Alimtalk account not found"},404);const n=await s.DB.prepare(`
      ...
      WHERE account_id = ?
      ORDER BY created_at DESC
    `).bind(a.id).all();return e.json({success:!0,templates:n.results})}catch(t){return console.error("[Seller Alimtalk Templates] Error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/alimtalk/templates",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{template_code:a,template_name:n,template_content:o,template_type:i}=await e.req.json();if(!a||!n||!o)return e.json({success:!1,error:"Missing required fields"},400);const c=await s.DB.prepare(`
    ...
    `).bind(c.id,a,n,o,i||"basic").run();return e.json({success:!0,template_id:u.meta.last_row_id,message:"Template registered successfully. Approval pending (1-2 days)"})}catch(t){return console.error("[Seller Alimtalk Template Register] Error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/alimtalk/pricing",b(),async e=>{const{env:s}=e;try{const t=await s.DB.prepare(`
      ...
      ORDER BY min_quantity ASC
    `).all();return e.json({success:!0,pricing:t.results})}catch(t){return console.error("[Seller Alimtalk Pricing] Error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/alimtalk/charge",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{amount:a,pricing_id:n}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Missing required fields"},400);const o=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
    ...
    `).bind(r||null,a.id).run(),await s.DB.prepare(`
      ...
      SET balance = balance + ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(a.amount,a.account_id).run(),e.json({success:!0,message:"Charge completed successfully",charged_amount:a.amount})):e.json({success:!1,error:"Charge not found or already completed"},404)}catch(t){return console.error("[Seller Alimtalk Charge Complete] Error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/alimtalk/send",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{template_id:a,recipient_phone:n,variables:o,order_id:i}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Missing required fields"},400);const c=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ? AND status = 'active'
    ...
    `).bind(a,c.id).first();if(!l)return e.json({success:!1,error:"Template not found or not approved"},404);const u=Ta(l.template_content,o||{}),d=Ft(n),m=await Ps(s,{senderKey:c.sender_key,templateCode:l.template_code,to:d,message:u});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(c.id,a,i||null,d,u,15,m.messageId).run();return await s.DB.prepare(`
      ...
      SET balance = balance - 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(c.id).run(),e.json({success:!0,message_id:_.meta.last_row_id,aligo_message_id:m.messageId,status:"sent",remaining_balance:c.balance-1})}catch(t){return console.error("[Seller Alimtalk Send] Error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/alimtalk/messages",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{page:a="1",limit:n="20",status:o}=e.req.query(),i=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
    ...
    `).bind(i.id).first();return e.json({success:!0,messages:d.results,pagination:{total:m.total,page:parseInt(a),limit:parseInt(n)}})}catch(t){return console.error("[Seller Alimtalk Messages] Error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/alimtalk/statistics",b(),async e=>{const{env:s}=e;try{const t=e.req.header("X-Session-Token"),r=await Ce(s,t);if(!r||r.user_type!=="seller")return e.json({success:!1,error:"Unauthorized"},401);const{start_date:a,end_date:n}=e.req.query(),o=await s.DB.prepare(`
      SELECT * FROM alimtalk_accounts WHERE seller_id = ?
    `).bind(r.user_id).first();if(!o)return e.json({success:!1,error:"Alimtalk account not found"},404);const i=await s.DB.prepare(`
      SELECT 
        COUNT(*) as total_sent,
    ...
    `).bind(parseInt(t),parseInt(s)).first();if(!n)return e.json({success:!1,error:"Template not found"},404);let o=n.template_content;return a&&Object.entries(a).forEach(([i,c])=>{const l=new RegExp(`#{${i}}`,"g");o=o.replace(l,c)}),e.json({success:!0,data:{template_name:n.template_name,original:n.template_content,preview:o,required_variables:Array.from(n.template_content.matchAll(/#{(\w+)}/g),i=>i[1])}})}catch(s){return console.error("[Alimtalk Preview] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlements",b(),async e=>{try{const s=await e.env.DB.prepare(`
      ...
      LIMIT 50
    `).all();return e.json({success:!0,data:s.results})}catch(s){return console.error("[Admin Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlements/:id",b(),async e=>{try{const s=parseInt(e.req.param("id")),t=await Ha(e.env.DB,s);return t?e.json({success:!0,data:t}):e.json({success:!1,error:"Settlement not found"},404)}catch(s){return console.error("[Admin Settlement Detail] Error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/admin/settlements/generate",b(),async e=>{try{const s=await e.req.json(),{startDate:t,endDate:r}=s,a=t&&r?{startDate:t,endDate:r}:Ua(),n=await Pa(e.env.DB,a);return await xa(e.env.DB,n),e.json({success:!0,data:n})}catch(s){return console.error("[Admin Generate Settlement] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/seller/settlements",b(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const t=await e.env.DB.prepare(`
      SELECT 
        s.id,
        s.period_start,
        s.period_end,
...
`),U=`my_settlement_${c}_${l}.csv`;return e.text(R,200,{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${U}"`})}return e.json({success:!0,data:T})}catch(n){return console.error("[My Settlement] Error:",n),e.json({success:!1,error:n.message},500)}});p.get("/api/seller/settlements",b(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const t=await e.env.DB.prepare(`
      ...
      ORDER BY s.period_start DESC
      LIMIT 50
    `).bind(parseInt(s)).all();return e.json({success:!0,data:t.results})}catch(s){return console.error("[Seller Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/live/:streamId/sse",async e=>{const s=e.req.param("streamId");return Fa(s,e.env)});p.get("/api/live/:streamId/chat/sse",async e=>{const s=e.req.param("streamId");return Ba(s,e.env)});p.get("/api/seller/orders/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?Wa(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});p.get("/api/seller/stock/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?Ka(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});p.post("/api/push/subscribe",b(),async e=>{try{const s=e.req.header("X-User-ID"),t=e.req.header("X-User-Type");if(!s||!t)return e.json({success:!1,error:"Unauthorized"},401);const r=await e.req.json();return await Va(e.env.DB,parseInt(s),t,r),e.json({success:!0})}catch(s){return console.error("[Push Subscribe] Error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/push/unsubscribe",b(),async e=>{try{const{endpoint:s}=await e.req.json();return s?(await Ya(e.env.DB,s),e.json({success:!0})):e.json({success:!1,error:"Endpoint required"},400)}catch(s){return console.error("[Push Unsubscribe] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/push/vapid-public-key",b(),async e=>{try{const s=e.env.VAPID_PUBLIC_KEY||"";return e.json({success:!0,publicKey:s})}catch(s){return console.error("[Push VAPID Key] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/cache/stats",async e=>{const s=e.req.query("token"),t=e.env.STATS_SECRET_TOKEN||"your-secret-token-here";if(s!==t)return e.json({success:!1,error:"접근 권한이 없습니다. 올바른 token을 제공해주세요."},403);const r=J.hits+J.misses>0?(J.hits/(J.hits+J.misses)*100).toFixed(2):"0.00";return e.json({success:!0,data:{cache:{...J,hitRate:`${r}%`,cacheSize:ce.size,maxSize:1e3,memoryUsage:`${(ce.size/1e3*100).toFixed(1)}%`},description:{hits:"Memory cache로 처리된 요청 (KV 읽기 0회)",misses:"Memory cache 미스로 KV 조회한 요청",writes:"Memory cache에 저장된 항목 수",evictions:"Memory cache에서 삭제된 항목 수 (만료 또는 크기 제한)",hitRate:"Cache hit 비율 (높을수록 KV 사용량 감소)",cacheSize:"현재 Memory cache에 저장된 항목 수",maxSize:"Memory cache 최대 크기",memoryUsage:"Memory cache 사용률 (cacheSize / maxSize)"},kvUsageGuide:{currentHitRate:`${r}%`,recommendation:parseFloat(r)>=90?"✅ 캐시가 매우 효과적으로 작동하고 있습니다.":parseFloat(r)>=70?"⚠️ 캐시 히트율이 낮습니다. TTL 조정을 고려하세요.":"❌ 캐시 히트율이 매우 낮습니다. 캐시 설정을 확인하세요.",kvDailyReadsLimit:"100,000 reads/day (free tier)",kvDailyWritesLimit:"1,000 writes/day (free tier)",estimatedDailyReads:Math.round(J.misses/(J.hits+J.misses||1)*1e4),estimatedDailyWrites:Math.round(J.writes/(J.hits+J.misses||1)*1e3)}}})});p.route("/",ps);let ot={},it={};p.get("/api/debug/kv-usage",b(),async e=>{try{const s=Object.entries(ot).sort((n,o)=>o[1]-n[1]).slice(0,20),t=Object.entries(it).sort((n,o)=>o[1]-n[1]).slice(0,20),r=Object.values(ot).reduce((n,o)=>n+o,0),a=Object.values(it).reduce((n,o)=>n+o,0);return e.json({success:!0,stats:{total_writes:r,total_reads:a,daily_write_limit:1e3,daily_read_limit:1e5,write_usage_percent:(r/1e3*100).toFixed(2)+"%",read_usage_percent:(a/1e5*100).toFixed(2)+"%",top_writes:s,top_reads:t},recommendations:r>500?["⚠️ KV Write 사용량이 높습니다!","1. 세션 갱신 주기를 늘리세요 (현재 29일)","2. 캐시를 메모리에만 저장하세요 (forceKvWrite: false)","3. JWT 인증으로 전환하세요 (KV 사용량 90% 감소)"]:["✅ KV 사용량이 정상 범위입니다."]})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/notifications",b(),async e=>{var t;const{DB:s}=e.env;try{const r=e.req.query("userId"),a=parseInt(e.req.query("limit")||"20"),n=parseInt(e.req.query("offset")||"0");if(!r)return e.json({success:!1,error:"userId is required"},400);const o=await s.prepare(`
    ...
    `).bind(t).run(),e.json({success:!0,message:"All notifications marked as read"})):e.json({success:!1,error:"userId is required"},400)}catch(t){return console.error("[Notifications] Mark all read error:",t),e.json({success:!1,error:t.message},500)}});p.delete("/api/notifications/:id",b(),async e=>{const{DB:s}=e.env;try{const t=e.req.param("id"),r=e.req.query("userId");return r?(await s.prepare(`
      ...
      WHERE id = ? AND user_id = ?
    `).bind(t,r).run()).meta.changes===0?e.json({success:!1,error:"Notification not found"},404):e.json({success:!0,message:"Notification deleted"}):e.json({success:!1,error:"userId is required"},400)}catch(t){return console.error("[Notifications] Delete error:",t),e.json({success:!1,error:t.message},500)}});const ct=new Ls,gn=Object.assign({"/src/index.tsx":p});let Jt=!1;for(const[,e]of Object.entries(gn))e&&(ct.route("/",e),ct.notFound(e.notFoundHandler),Jt=!0);if(!Jt)throw new Error("Can't import modules from ['/src/index.tsx']");async function yn(e){const s=crypto.getRandomValues(new Uint8Array(16)),t=new TextEncoder().encode(e),r=await crypto.subtle.importKey("raw",t,{name:"PBKDF2"},!1,["deriveBits"]),a=await crypto.subtle.deriveBits({name:"PBKDF2",salt:s,iterations:1e5,hash:"SHA-256"},r,256),n=btoa(String.fromCharCode(...s)),o=btoa(String.fromCharCode(...new Uint8Array(a)));return`${n}$${o}`}async function wn(e,s){const[t,r]=s.split("$");if(!t||!r)return!1;const a=Uint8Array.from(atob(t),l=>l.charCodeAt(0)),n=new TextEncoder().encode(e),o=await crypto.subtle.importKey("raw",n,{name:"PBKDF2"},!1,["deriveBits"]),i=await crypto.subtle.deriveBits({name:"PBKDF2",salt:a,iterations:1e5,hash:"SHA-256"},o,256),c=btoa(String.fromCharCode(...new Uint8Array(i)));return r===c}const Sn=Object.freeze(Object.defineProperty({__proto__:null,hashPassword:yn,verifyPassword:wn},Symbol.toStringTag,{value:"Module"}));async function bn(e,s){var t;if(!s){console.log("[Discord Alert - Mock]",e);return}try{const r=Tn(e.type),a={title:Rn(e.type),description:e.details||In(e),color:r,fields:[{name:"사용자",value:e.username||((t=e.userId)==null?void 0:t.toString())||"Unknown",inline:!0},{name:"사용자 타입",value:e.userType||"N/A",inline:!0},{name:"IP 주소",value:e.ip||"Unknown",inline:!0},{name:"User Agent",value:e.userAgent?vn(e.userAgent,100):"Unknown",inline:!1},{name:"시간",value:e.timestamp,inline:!1}],footer:{text:"리스터코퍼레이션 Security Monitoring"},timestamp:new Date().toISOString()};if(e.metadata)for(const[n,o]of Object.entries(e.metadata))a.fields.push({name:n,value:String(o),inline:!0});await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({embeds:[a]})}),console.log("[Discord Alert] Sent:",e.type)}catch(r){console.error("[Discord Alert Error]",r)}}function Tn(e){return{login_success:65280,login_failure:16750848,suspicious_login:16711680,jwt_validation_failure:16737792,rate_limit_exceeded:16711680}[e]||8421504}function Rn(e){return{login_success:"✅ 로그인 성공",login_failure:"⚠️ 로그인 실패",suspicious_login:"🚨 의심스러운 로그인 감지",jwt_validation_failure:"❌ JWT 검증 실패",rate_limit_exceeded:"🚫 Rate Limit 초과"}[e]||"📊 보안 이벤트"}function In(e){return{login_success:"사용자가 성공적으로 로그인했습니다.",login_failure:"로그인 시도가 실패했습니다. 비밀번호 오류 또는 존재하지 않는 계정입니다.",suspicious_login:"비정상적인 로그인 패턴이 감지되었습니다. 즉시 확인이 필요합니다.",jwt_validation_failure:"JWT 토큰 검증에 실패했습니다. 만료되었거나 유효하지 않은 토큰입니다.",rate_limit_exceeded:"API Rate Limit을 초과했습니다. DDoS 공격 가능성이 있습니다."}[e.type]||"보안 관련 이벤트가 발생했습니다."}function vn(e,s){return e.length<=s?e:e.substring(0,s)+"..."}function Dn(e,s,t,r){const a=Date.now()-3e5;if(r.filter(c=>c.ip===e&&!c.success&&c.timestamp>a).length>=3||t==="admin")return!0;const o=["python","curl","wget","postman","insomnia","bot","crawler","spider","scraper"],i=s.toLowerCase();return!!o.some(c=>i.includes(c))}const Pe=new Map;function On(e,s){const t=Pe.get(e)||[];t.push({timestamp:Date.now(),success:s});const r=Date.now()-3600*1e3,a=t.filter(n=>n.timestamp>r);if(Pe.set(e,a),Pe.size>1e3){const n=Pe.keys().next().value;Pe.delete(n)}}function An(e){return(Pe.get(e)||[]).map(s=>({...s,ip:e}))}const ks=Object.freeze(Object.defineProperty({__proto__:null,addLoginHistory:On,detectSuspiciousLogin:Dn,getLoginHistory:An,sendDiscordAlert:bn},Symbol.toStringTag,{value:"Module"}));async function zt(e){try{const{to:s,subject:t,htmlContent:r,textContent:a}=e,n=await fetch("https://api.mailchannels.net/tx/v1/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({personalizations:[{to:[{email:s}]}],from:{email:"noreply@live.ur-team.com",name:"유어 라이브"},subject:t,content:[{type:"text/html",value:r},...a?[{type:"text/plain",value:a}]:[]]})});if(!n.ok){const o=await n.text();return console.error("[Email] Failed to send:",n.status,o),{success:!1,error:`Email send failed: ${n.status}`}}return console.log("[Email] Successfully sent to:",s),{success:!0}}catch(s){return console.error("[Email] Exception:",s),{success:!1,error:s.message}}}async function kn(e){const{streamId:s,title:t,sellerName:r,platform:a,scheduledAt:n,status:o}=e,i=`https://live.ur-team.com/live/${s}`,c=o==="live"?"🔴 라이브 중":o==="scheduled"?"📅 예약됨":"⏸️ 대기 중",l=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
