var Vs=Object.defineProperty;var is=e=>{throw TypeError(e)};var Js=(e,r,t)=>r in e?Vs(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var S=(e,r,t)=>Js(e,typeof r!="symbol"?r+"":r,t),Xe=(e,r,t)=>r.has(e)||is("Cannot "+t);var m=(e,r,t)=>(Xe(e,r,"read from private field"),t?t.call(e):r.get(e)),R=(e,r,t)=>r.has(e)?is("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,s)=>(Xe(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),O=(e,r,t)=>(Xe(e,r,"access private method"),t);var us=(e,r,t,s)=>({set _(a){T(e,r,a,t)},get _(){return m(e,r,s)}});var cs=(e,r,t)=>(s,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let u,c=!1,l;if(e[i]?(l=e[i][0][0],s.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{u=await l(s,()=>o(i+1))}catch(d){if(d instanceof Error&&r)s.error=d,u=await r(d,s),c=!0;else throw d}else s.finalized===!1&&t&&(u=await t(s));return u&&(s.finalized===!1||c)&&(s.res=u),s}},zs=Symbol(),Gs=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,n=(e instanceof Is?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Xs(e,{all:t,dot:s}):{}};async function Xs(e,r){const t=await e.formData();return t?Qs(t,r):{}}function Qs(e,r){const t=Object.create(null);return e.forEach((s,a)=>{r.all||a.endsWith("[]")?Zs(t,a,s):t[a]=s}),r.dot&&Object.entries(t).forEach(([s,a])=>{s.includes(".")&&(er(t,s,a),delete t[s])}),t}var Zs=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},er=(e,r,t)=>{let s=e;const a=r.split(".");a.forEach((n,o)=>{o===a.length-1?s[n]=t:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},gs=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},sr=e=>{const{groups:r,path:t}=rr(e),s=gs(t);return tr(s,r)},rr=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const a=`@${s}`;return r.push([a,t]),a}),{groups:r,path:e}},tr=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let a=e.length-1;a>=0;a--)if(e[a].includes(s)){e[a]=e[a].replace(s,r[t][1]);break}}return e},qe={},ar=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return qe[s]||(t[2]?qe[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:qe[s]=[e,t[1],!0]),qe[s]}return null},rs=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},nr=e=>rs(e,decodeURI),bs=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const a=r.charCodeAt(s);if(a===37){const n=r.indexOf("?",s),o=r.slice(t,n===-1?void 0:n);return nr(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return r.slice(t,s)},or=e=>{const r=bs(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},be=(e,r,...t)=>(t.length&&(r=be(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),ws=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))s+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){t.length===0&&s===""?t.push("/"):t.push(s);const n=a.replace("?","");s+="/"+n,t.push(s)}else s+="/"+a}),t.filter((a,n,o)=>o.indexOf(a)===n)},Qe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?rs(e,Ss):e):e,Ts=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const u=o+r.length+2,c=e.indexOf("&",u);return Qe(e.slice(u,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const a={};s??(s=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let u=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(s&&(u=Qe(u)),n=o,u==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),s&&(c=Qe(c))),t?(a[u]&&Array.isArray(a[u])||(a[u]=[]),a[u].push(c)):a[u]??(a[u]=c)}return r?a[r]:a},ir=Ts,ur=(e,r)=>Ts(e,r,!0),Ss=decodeURIComponent,ls=e=>rs(e,Ss),Se,W,te,Rs,vs,ss,ae,ms,Is=(ms=class{constructor(e,r="/",t=[[]]){R(this,te);S(this,"raw");R(this,Se);R(this,W);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});R(this,ae,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,T(this,W,t),T(this,Se,{})}param(e){return e?O(this,te,Rs).call(this,e):O(this,te,vs).call(this)}query(e){return ir(this.url,e)}queries(e){return ur(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await Gs(this,e))}json(){return m(this,ae).call(this,"text").then(e=>JSON.parse(e))}text(){return m(this,ae).call(this,"text")}arrayBuffer(){return m(this,ae).call(this,"arrayBuffer")}blob(){return m(this,ae).call(this,"blob")}formData(){return m(this,ae).call(this,"formData")}addValidatedData(e,r){m(this,Se)[e]=r}valid(e){return m(this,Se)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[zs](){return m(this,W)}get matchedRoutes(){return m(this,W)[0].map(([[,e]])=>e)}get routePath(){return m(this,W)[0].map(([[,e]])=>e)[this.routeIndex].path}},Se=new WeakMap,W=new WeakMap,te=new WeakSet,Rs=function(e){const r=m(this,W)[0][this.routeIndex][1][e],t=O(this,te,ss).call(this,r);return t&&/\%/.test(t)?ls(t):t},vs=function(){const e={},r=Object.keys(m(this,W)[0][this.routeIndex][1]);for(const t of r){const s=O(this,te,ss).call(this,m(this,W)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?ls(s):s)}return e},ss=function(e){return m(this,W)[1]?m(this,W)[1][e]:e},ae=new WeakMap,ms),cr={Stringify:1},Os=async(e,r,t,s,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:r,buffer:a,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(u=>Os(u,r,!1,s,a))).then(()=>a[0]))):Promise.resolve(e)},lr="text/plain; charset=UTF-8",Ze=(e,r)=>({"Content-Type":e,...r}),Pe,Ue,Z,Ie,ee,B,xe,Re,ve,me,He,$e,ne,we,_s,dr=(_s=class{constructor(e,r){R(this,ne);R(this,Pe);R(this,Ue);S(this,"env",{});R(this,Z);S(this,"finalized",!1);S(this,"error");R(this,Ie);R(this,ee);R(this,B);R(this,xe);R(this,Re);R(this,ve);R(this,me);R(this,He);R(this,$e);S(this,"render",(...e)=>(m(this,Re)??T(this,Re,r=>this.html(r)),m(this,Re).call(this,...e)));S(this,"setLayout",e=>T(this,xe,e));S(this,"getLayout",()=>m(this,xe));S(this,"setRenderer",e=>{T(this,Re,e)});S(this,"header",(e,r,t)=>{this.finalized&&T(this,B,new Response(m(this,B).body,m(this,B)));const s=m(this,B)?m(this,B).headers:m(this,me)??T(this,me,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});S(this,"status",e=>{T(this,Ie,e)});S(this,"set",(e,r)=>{m(this,Z)??T(this,Z,new Map),m(this,Z).set(e,r)});S(this,"get",e=>m(this,Z)?m(this,Z).get(e):void 0);S(this,"newResponse",(...e)=>O(this,ne,we).call(this,...e));S(this,"body",(e,r,t)=>O(this,ne,we).call(this,e,r,t));S(this,"text",(e,r,t)=>!m(this,me)&&!m(this,Ie)&&!r&&!t&&!this.finalized?new Response(e):O(this,ne,we).call(this,e,r,Ze(lr,t)));S(this,"json",(e,r,t)=>O(this,ne,we).call(this,JSON.stringify(e),r,Ze("application/json",t)));S(this,"html",(e,r,t)=>{const s=a=>O(this,ne,we).call(this,a,r,Ze("text/html; charset=UTF-8",t));return typeof e=="object"?Os(e,cr.Stringify,!1,{}).then(s):s(e)});S(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});S(this,"notFound",()=>(m(this,ve)??T(this,ve,()=>new Response),m(this,ve).call(this,this)));T(this,Pe,e),r&&(T(this,ee,r.executionCtx),this.env=r.env,T(this,ve,r.notFoundHandler),T(this,$e,r.path),T(this,He,r.matchResult))}get req(){return m(this,Ue)??T(this,Ue,new Is(m(this,Pe),m(this,$e),m(this,He))),m(this,Ue)}get event(){if(m(this,ee)&&"respondWith"in m(this,ee))return m(this,ee);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,ee))return m(this,ee);throw Error("This context has no ExecutionContext")}get res(){return m(this,B)||T(this,B,new Response(null,{headers:m(this,me)??T(this,me,new Headers)}))}set res(e){if(m(this,B)&&e){e=new Response(e.body,e);for(const[r,t]of m(this,B).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=m(this,B).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of s)e.headers.append("set-cookie",a)}else e.headers.set(r,t)}T(this,B,e),this.finalized=!0}get var(){return m(this,Z)?Object.fromEntries(m(this,Z)):{}}},Pe=new WeakMap,Ue=new WeakMap,Z=new WeakMap,Ie=new WeakMap,ee=new WeakMap,B=new WeakMap,xe=new WeakMap,Re=new WeakMap,ve=new WeakMap,me=new WeakMap,He=new WeakMap,$e=new WeakMap,ne=new WeakSet,we=function(e,r,t){const s=m(this,B)?new Headers(m(this,B).headers):m(this,me)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[n,o]of Object.entries(t))if(typeof o=="string")s.set(n,o);else{s.delete(n);for(const i of o)s.append(n,i)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,Ie);return new Response(e,{status:a,headers:s})},_s),P="ALL",pr="all",mr=["get","post","put","delete","options","patch"],js="Can not add a route since the matcher is already built.",Ns=class extends Error{},_r="__COMPOSED_HANDLER",fr=e=>e.text("404 Not Found",404),ds=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},V,U,Ds,J,de,Be,We,Oe,Er=(Oe=class{constructor(r={}){R(this,U);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");R(this,V,"/");S(this,"routes",[]);R(this,J,fr);S(this,"errorHandler",ds);S(this,"onError",r=>(this.errorHandler=r,this));S(this,"notFound",r=>(T(this,J,r),this));S(this,"fetch",(r,...t)=>O(this,U,We).call(this,r,t[1],t[0],r.method));S(this,"request",(r,t,s,a)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${be("/",r)}`,t),s,a)));S(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(O(this,U,We).call(this,r.request,r,void 0,r.request.method))})});[...mr,pr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?T(this,V,o):O(this,U,de).call(this,n,m(this,V),o),i.forEach(u=>{O(this,U,de).call(this,n,m(this,V),u)}),this)}),this.on=(n,o,...i)=>{for(const u of[o].flat()){T(this,V,u);for(const c of[n].flat())i.map(l=>{O(this,U,de).call(this,c.toUpperCase(),m(this,V),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?T(this,V,n):(T(this,V,"*"),o.unshift(n)),o.forEach(i=>{O(this,U,de).call(this,P,m(this,V),i)}),this);const{strict:s,...a}=r;Object.assign(this,a),this.getPath=s??!0?r.getPath??bs:or}route(r,t){const s=this.basePath(r);return t.routes.map(a=>{var o;let n;t.errorHandler===ds?n=a.handler:(n=async(i,u)=>(await cs([],t.errorHandler)(i,()=>a.handler(i,u))).res,n[_r]=a.handler),O(o=s,U,de).call(o,a.method,a.path,n)}),this}basePath(r){const t=O(this,U,Ds).call(this);return t._basePath=be(this._basePath,r),t}mount(r,t,s){let a,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?a=u=>u:a=s.replaceRequest));const o=n?u=>{const c=n(u);return Array.isArray(c)?c:[c]}:u=>{let c;try{c=u.executionCtx}catch{}return[u.env,c]};a||(a=(()=>{const u=be(this._basePath,r),c=u==="/"?0:u.length;return l=>{const d=new URL(l.url);return d.pathname=d.pathname.slice(c)||"/",new Request(d,l)}})());const i=async(u,c)=>{const l=await t(a(u.req.raw),...o(u));if(l)return l;await c()};return O(this,U,de).call(this,P,be(r,"*"),i),this}},V=new WeakMap,U=new WeakSet,Ds=function(){const r=new Oe({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,T(r,J,m(this,J)),r.routes=this.routes,r},J=new WeakMap,de=function(r,t,s){r=r.toUpperCase(),t=be(this._basePath,t);const a={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,a]),this.routes.push(a)},Be=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},We=function(r,t,s,a){if(a==="HEAD")return(async()=>new Response(null,await O(this,U,We).call(this,r,t,s,"GET")))();const n=this.getPath(r,{env:s}),o=this.router.match(a,n),i=new dr(r,{path:n,matchResult:o,env:s,executionCtx:t,notFoundHandler:m(this,J)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await m(this,J).call(this,i)})}catch(l){return O(this,U,Be).call(this,l,i)}return c instanceof Promise?c.then(l=>l||(i.finalized?i.res:m(this,J).call(this,i))).catch(l=>O(this,U,Be).call(this,l,i)):c??m(this,J).call(this,i)}const u=cs(o[0],this.errorHandler,m(this,J));return(async()=>{try{const c=await u(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return O(this,U,Be).call(this,c,i)}})()},Oe),As=[];function hr(e,r){const t=this.buildAllMatchers(),s=((a,n)=>{const o=t[a]||t[P],i=o[2][n];if(i)return i;const u=n.match(o[0]);if(!u)return[[],As];const c=u.indexOf("",1);return[o[1][c],u]});return this.match=s,s(e,r)}var Ve="[^/]+",Le=".*",Me="(?:|/.*)",Te=Symbol(),yr=new Set(".\\+*[^]$()");function gr(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===Le||e===Me?1:r===Le||r===Me?-1:e===Ve?1:r===Ve?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var _e,fe,z,ye,br=(ye=class{constructor(){R(this,_e);R(this,fe);R(this,z,Object.create(null))}insert(r,t,s,a,n){if(r.length===0){if(m(this,_e)!==void 0)throw Te;if(n)return;T(this,_e,t);return}const[o,...i]=r,u=o==="*"?i.length===0?["","",Le]:["","",Ve]:o==="/*"?["","",Me]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(u){const l=u[1];let d=u[2]||Ve;if(l&&u[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Te;if(c=m(this,z)[d],!c){if(Object.keys(m(this,z)).some(_=>_!==Le&&_!==Me))throw Te;if(n)return;c=m(this,z)[d]=new ye,l!==""&&T(c,fe,a.varIndex++)}!n&&l!==""&&s.push([l,m(c,fe)])}else if(c=m(this,z)[o],!c){if(Object.keys(m(this,z)).some(l=>l.length>1&&l!==Le&&l!==Me))throw Te;if(n)return;c=m(this,z)[o]=new ye}c.insert(i,t,s,a,n)}buildRegExpStr(){const t=Object.keys(m(this,z)).sort(gr).map(s=>{const a=m(this,z)[s];return(typeof m(a,fe)=="number"?`(${s})@${m(a,fe)}`:yr.has(s)?`\\${s}`:s)+a.buildRegExpStr()});return typeof m(this,_e)=="number"&&t.unshift(`#${m(this,_e)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},_e=new WeakMap,fe=new WeakMap,z=new WeakMap,ye),Je,Fe,fs,wr=(fs=class{constructor(){R(this,Je,{varIndex:0});R(this,Fe,new br)}insert(e,r,t){const s=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,u=>{const c=`@\\${o}`;return a[o]=[c,u],o++,i=!0,c}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let u=n.length-1;u>=0;u--)if(n[u].indexOf(i)!==-1){n[u]=n[u].replace(i,a[o][1]);break}}return m(this,Fe).insert(n,r,s,m(this,Je),t),s}buildRegExp(){let e=m(this,Fe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(t[++r]=Number(n),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},Je=new WeakMap,Fe=new WeakMap,fs),Tr=[/^$/,[],Object.create(null)],Ye=Object.create(null);function ks(e){return Ye[e]??(Ye[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function Sr(){Ye=Object.create(null)}function Ir(e){var c;const r=new wr,t=[];if(e.length===0)return Tr;const s=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,d],[_,E])=>l?1:_?-1:d.length-E.length),a=Object.create(null);for(let l=0,d=-1,_=s.length;l<_;l++){const[E,f,y]=s[l];E?a[f]=[y.map(([b])=>[b,Object.create(null)]),As]:d++;let h;try{h=r.insert(f,d,E)}catch(b){throw b===Te?new Ns(f):b}E||(t[d]=y.map(([b,g])=>{const j=Object.create(null);for(g-=1;g>=0;g--){const[N,w]=h[g];j[N]=w}return[b,j]}))}const[n,o,i]=r.buildRegExp();for(let l=0,d=t.length;l<d;l++)for(let _=0,E=t[l].length;_<E;_++){const f=(c=t[l][_])==null?void 0:c[1];if(!f)continue;const y=Object.keys(f);for(let h=0,b=y.length;h<b;h++)f[y[h]]=i[f[y[h]]]}const u=[];for(const l in o)u[l]=t[o[l]];return[n,u,a]}function ge(e,r){if(e){for(const t of Object.keys(e).sort((s,a)=>a.length-s.length))if(ks(t).test(r))return[...e[t]]}}var oe,ie,ze,Cs,Es,Rr=(Es=class{constructor(){R(this,ze);S(this,"name","RegExpRouter");R(this,oe);R(this,ie);S(this,"match",hr);T(this,oe,{[P]:Object.create(null)}),T(this,ie,{[P]:Object.create(null)})}add(e,r,t){var i;const s=m(this,oe),a=m(this,ie);if(!s||!a)throw new Error(js);s[e]||[s,a].forEach(u=>{u[e]=Object.create(null),Object.keys(u[P]).forEach(c=>{u[e][c]=[...u[P][c]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const u=ks(r);e===P?Object.keys(s).forEach(c=>{var l;(l=s[c])[r]||(l[r]=ge(s[c],r)||ge(s[P],r)||[])}):(i=s[e])[r]||(i[r]=ge(s[e],r)||ge(s[P],r)||[]),Object.keys(s).forEach(c=>{(e===P||e===c)&&Object.keys(s[c]).forEach(l=>{u.test(l)&&s[c][l].push([t,n])})}),Object.keys(a).forEach(c=>{(e===P||e===c)&&Object.keys(a[c]).forEach(l=>u.test(l)&&a[c][l].push([t,n]))});return}const o=ws(r)||[r];for(let u=0,c=o.length;u<c;u++){const l=o[u];Object.keys(a).forEach(d=>{var _;(e===P||e===d)&&((_=a[d])[l]||(_[l]=[...ge(s[d],l)||ge(s[P],l)||[]]),a[d][l].push([t,n-c+u+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(m(this,ie)).concat(Object.keys(m(this,oe))).forEach(r=>{e[r]||(e[r]=O(this,ze,Cs).call(this,r))}),T(this,oe,T(this,ie,void 0)),Sr(),e}},oe=new WeakMap,ie=new WeakMap,ze=new WeakSet,Cs=function(e){const r=[];let t=e===P;return[m(this,oe),m(this,ie)].forEach(s=>{const a=s[e]?Object.keys(s[e]).map(n=>[n,s[e][n]]):[];a.length!==0?(t||(t=!0),r.push(...a)):e!==P&&r.push(...Object.keys(s[P]).map(n=>[n,s[P][n]]))}),t?Ir(r):null},Es),ue,se,hs,vr=(hs=class{constructor(e){S(this,"name","SmartRouter");R(this,ue,[]);R(this,se,[]);T(this,ue,e.routers)}add(e,r,t){if(!m(this,se))throw new Error(js);m(this,se).push([e,r,t])}match(e,r){if(!m(this,se))throw new Error("Fatal error");const t=m(this,ue),s=m(this,se),a=t.length;let n=0,o;for(;n<a;n++){const i=t[n];try{for(let u=0,c=s.length;u<c;u++)i.add(...s[u]);o=i.match(e,r)}catch(u){if(u instanceof Ns)continue;throw u}this.match=i.match.bind(i),T(this,ue,[i]),T(this,se,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(m(this,se)||m(this,ue).length!==1)throw new Error("No active router has been determined yet.");return m(this,ue)[0]}},ue=new WeakMap,se=new WeakMap,hs),ke=Object.create(null),ce,F,Ee,je,x,re,pe,Ne,Or=(Ne=class{constructor(r,t,s){R(this,re);R(this,ce);R(this,F);R(this,Ee);R(this,je,0);R(this,x,ke);if(T(this,F,s||Object.create(null)),T(this,ce,[]),r&&t){const a=Object.create(null);a[r]={handler:t,possibleKeys:[],score:0},T(this,ce,[a])}T(this,Ee,[])}insert(r,t,s){T(this,je,++us(this,je)._);let a=this;const n=sr(t),o=[];for(let i=0,u=n.length;i<u;i++){const c=n[i],l=n[i+1],d=ar(c,l),_=Array.isArray(d)?d[0]:c;if(_ in m(a,F)){a=m(a,F)[_],d&&o.push(d[1]);continue}m(a,F)[_]=new Ne,d&&(m(a,Ee).push(d),o.push(d[1])),a=m(a,F)[_]}return m(a,ce).push({[r]:{handler:s,possibleKeys:o.filter((i,u,c)=>c.indexOf(i)===u),score:m(this,je)}}),a}search(r,t){var u;const s=[];T(this,x,ke);let n=[this];const o=gs(t),i=[];for(let c=0,l=o.length;c<l;c++){const d=o[c],_=c===l-1,E=[];for(let f=0,y=n.length;f<y;f++){const h=n[f],b=m(h,F)[d];b&&(T(b,x,m(h,x)),_?(m(b,F)["*"]&&s.push(...O(this,re,pe).call(this,m(b,F)["*"],r,m(h,x))),s.push(...O(this,re,pe).call(this,b,r,m(h,x)))):E.push(b));for(let g=0,j=m(h,Ee).length;g<j;g++){const N=m(h,Ee)[g],w=m(h,x)===ke?{}:{...m(h,x)};if(N==="*"){const L=m(h,F)["*"];L&&(s.push(...O(this,re,pe).call(this,L,r,m(h,x))),T(L,x,w),E.push(L));continue}const[k,C,I]=N;if(!d&&!(I instanceof RegExp))continue;const D=m(h,F)[k],H=o.slice(c).join("/");if(I instanceof RegExp){const L=I.exec(H);if(L){if(w[C]=L[0],s.push(...O(this,re,pe).call(this,D,r,m(h,x),w)),Object.keys(m(D,F)).length){T(D,x,w);const G=((u=L[0].match(/\//))==null?void 0:u.length)??0;(i[G]||(i[G]=[])).push(D)}continue}}(I===!0||I.test(d))&&(w[C]=d,_?(s.push(...O(this,re,pe).call(this,D,r,w,m(h,x))),m(D,F)["*"]&&s.push(...O(this,re,pe).call(this,m(D,F)["*"],r,w,m(h,x)))):(T(D,x,w),E.push(D)))}}n=E.concat(i.shift()??[])}return s.length>1&&s.sort((c,l)=>c.score-l.score),[s.map(({handler:c,params:l})=>[c,l])]}},ce=new WeakMap,F=new WeakMap,Ee=new WeakMap,je=new WeakMap,x=new WeakMap,re=new WeakSet,pe=function(r,t,s,a){const n=[];for(let o=0,i=m(r,ce).length;o<i;o++){const u=m(r,ce)[o],c=u[t]||u[P],l={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),s!==ke||a&&a!==ke))for(let d=0,_=c.possibleKeys.length;d<_;d++){const E=c.possibleKeys[d],f=l[c.score];c.params[E]=a!=null&&a[E]&&!f?a[E]:s[E]??(a==null?void 0:a[E]),l[c.score]=!0}}return n},Ne),he,ys,jr=(ys=class{constructor(){S(this,"name","TrieRouter");R(this,he);T(this,he,new Or)}add(e,r,t){const s=ws(r);if(s){for(let a=0,n=s.length;a<n;a++)m(this,he).insert(e,s[a],t);return}m(this,he).insert(e,r,t)}match(e,r){return m(this,he).search(e,r)}},he=new WeakMap,ys),Ls=class extends Er{constructor(e={}){super(e),this.router=e.router??new vr({routers:[new Rr,new jr]})}},A=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(t.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(t.allowMethods);return async function(o,i){var l;function u(d,_){o.res.headers.set(d,_)}const c=await s(o.req.header("origin")||"",o);if(c&&u("Access-Control-Allow-Origin",c),t.credentials&&u("Access-Control-Allow-Credentials","true"),(l=t.exposeHeaders)!=null&&l.length&&u("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&u("Vary","Origin"),t.maxAge!=null&&u("Access-Control-Max-Age",t.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&u("Access-Control-Allow-Methods",d.join(","));let _=t.allowHeaders;if(!(_!=null&&_.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(_=E.split(/\s*,\s*/))}return _!=null&&_.length&&(u("Access-Control-Allow-Headers",_.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Nr(e){const r=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],t=[];for(const s of r)e[s]||t.push(s);if(t.length>0)throw new Error(`Missing required environment variables: ${t.join(", ")}
...
`)}async function Cr(e){const r=await Ar(e),t=r.filter(n=>n.status==="pass").length,s=r.filter(n=>n.status==="warn").length,a=r.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:r.length,pass:t,warn:s,fail:a},results:r,formatted:kr(r)}}const es={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function Lr(){const e=es.ENV==="production";return{baseUrl:es.TEST_BASE_URL,apiKey:es.TEST_API_KEY,isProduction:e}}async function Ms(e,r){const t=Lr(),s=`${t.baseUrl}${e}`;try{const a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify(r)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Mr(e){try{const r={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((s,a)=>({SerialNum:a+1,ItemName:s.name,Qty:s.quantity,UnitPrice:s.unitPrice,SupplyCost:s.supplyPrice,Tax:s.taxAmount,Remark:s.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},t=await Ms("/eTaxInvoice/RegistAndIssue",r);if(t.code!==1)throw new Error(`바로빌 발행 실패: ${t.message}`);return{success:!0,ntsConfirmNumber:t.ntsconfirmNum,invoiceKey:t.invoiceKey,message:t.message}}catch(r){throw console.error("바로빌 세금계산서 발행 실패:",r),r}}async function Pr(e,r,t){try{const a=await Ms("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:r,Memo:t});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(s){throw console.error("바로빌 세금계산서 취소 실패:",s),s}}function Ce(){return!1}async function Ur(e){return await Mr(e)}function xr(e,r,t){const s=Number(r.total_amount),a=Math.floor(s/1.1),n=s-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:r.buyer_business_number,buyerBusinessName:r.buyer_business_name||r.user_name,buyerCEO:r.buyer_ceo_name,buyerAddress:r.shipping_address,buyerEmail:r.user_email,buyerTel:r.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:t.map(o=>{const i=Number(o.price)*Number(o.quantity),u=Math.floor(i/1.1),c=i-u;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:u,taxAmount:c,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:s,memo:`주문번호: ${r.order_number}`,orderNo:r.order_number}}class Y extends Error{constructor(r,t,s){super(r),this.statusCode=t,this.code=s,this.name="AuthError"}}function Hr(e){return`${crypto.randomUUID()}-${e}`}function $r(e){var n,o,i,u,c,l,d;const r=e.id.toString(),t=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",s=((u=e.kakao_account)==null?void 0:u.email)||null,a=((c=e.properties)==null?void 0:c.profile_image)||((d=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:r,nickname:t,email:s,profileImage:a}}async function Fr(e,r,t,s,a){try{const n=await e.prepare(`
    ...
    `).bind(t).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await r.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,t).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders",async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),{userId:s,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:u,recipientName:c,recipientPhone:l,deliveryMemo:d,totalAmount:_,shippingFee:E,orderNumber:f,paymentKey:y,paymentMethod:h}=t;if(o&&o.length>0){const I=[];for(const $ of o){const le=await r.prepare(`
      ...
      `).bind(L,s||null,_||0,"pending","pending",G||null,c||null,l||null,d||null,y||null).run()).meta.last_row_id;for(const $ of I)await r.prepare(`
    ...
    `).bind(t).run(),e.json({success:!0,message:"Message deleted successfully"})}catch(s){return console.error("Error deleting chat message:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/chat/:liveStreamId/ban",A(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId");try{const s=await e.req.json(),{userId:a,bannedBy:n,reason:o,duration:i}=s;if(!a||!n)return e.json({success:!1,error:"userId and bannedBy are required"},400);let u=null;if(i){const c=new Date;c.setMinutes(c.getMinutes()+i),u=c.toISOString()}return await r.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?)
    `).bind(t,a,n,o||null,u).run(),e.json({success:!0,message:"User banned successfully"})}catch(s){return console.error("Error banning user:",s),e.json({success:!1,error:s.message},500)}});p.delete("/api/chat/:liveStreamId/ban/:userId",A(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.param("userId");try{return await r.prepare(`
  ...
  `).bind(s==null?void 0:s.bank,s==null?void 0:s.accountNumber,s==null?void 0:s.customerName,s==null?void 0:s.dueDate,JSON.stringify(r),t).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",t)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:r}=e.env;try{const t=e.req.param("paymentKey"),s=await e.req.json(),{cancelReason:a,cancelAmount:n}=s;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:t,cancelReason:a,cancelAmount:n}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const o=await r.prepare(`
    ...
    `).bind(t).first();if(!o)return e.json({success:!1,error:"결제 정보를 찾을 수 없습니다."},404);if(o.status==="CANCELED"||o.status==="cancelled")return e.json({success:!1,error:"이미 취소된 결제입니다."},400);const i=o.pg_provider||"tosspayments",u=e.env.TOSS_SECRET_KEY;if(!u)return e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);const c=Yr(i,u),l=n&&n<o.amount,d=n||o.amount;console.log("[Payment] PG 결제 취소 요청 중...",{pgProvider:i,paymentKey:t,cancelAmount:d,isPartial:l});const _=await c.cancelPayment({paymentKey:t,cancelReason:a,cancelAmount:d});return _.success?(console.log("[Payment] ✅ PG 결제 취소 완료:",{paymentKey:t,cancelAmount:d,canceledAt:_.canceledAt}),await r.prepare(`
      UPDATE payments 
      SET status = ?,
          cancelled_at = ?,
          pg_raw_data = ?,
    ...
    `).bind(s,_,n,o,i||null,u,c||null,t.adminId).run();return e.json({success:!0,data:{id:E.meta.last_row_id,username:s,name:n,email:o,business_name:u}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/sellers/:id",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{name:a,email:n,phone:o,business_name:i,business_number:u,is_active:c,status:l}=await e.req.json();return await r.prepare("SELECT id FROM sellers WHERE id = ?").bind(s).first()?(await r.prepare(`
      UPDATE sellers 
    ...
    `).all();return e.json({success:!0,data:{overview:o,sellers:i.results,period:s||"all"}})}catch(s){return console.error("정산 통계 조회 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlement/records",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{seller_id:s,period:a,status:n}=e.req.query();let o=["payment_status = 'completed'","is_cancelled = 0"];const i=[];s&&(o.push("o.seller_id = ?"),i.push(s)),n&&(o.push("o.settlement_status = ?"),i.push(n));const u=new Date;switch(a){case"today":const d=u.toISOString().split("T")[0];o.push(`DATE(o.created_at) = '${d}'`);break;case"week":const _=new Date(u.getTime()-10080*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${_}'`);break;case"month":const E=new Date(u.getTime()-720*60*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${E}'`);break}const c=o.length>0?`WHERE ${o.join(" AND ")}`:"",l=await r.prepare(`
      SELECT 
        o.id,
        o.order_number,
        o.seller_id,
...
`});const E="\uFEFF";return new Response(E+_,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(s){return console.error("CSV 내보내기 실패:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/orders/create",async e=>{const{DB:r}=e.env;try{const{userId:t,cartItems:s,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:u,buyerBusinessName:c,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:t,cartItems:s==null?void 0:s.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const w=await r.prepare(`
    ...
    `).bind(g,y,a,"pending",o||null,d,_,E,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,u||null,c||null,l||null).run()).meta.last_row_id;for(const w of s){await r.prepare(`
      ...
      `).bind(w.quantity,w.product_id).run();try{const k=await r.prepare(`
          ...
          FROM products 
          WHERE id = ?
        `).bind(w.product_id).first();if(k){const C=k.stock_alert_threshold||5,I=k.stock;I<=C&&k.seller_id&&(await Jr(r,k.seller_id,k.name,I,C),console.log(`[Low Stock Alert] ${k.name}: ${I} <= ${C}`))}}catch(k){console.error("[Low Stock Alert] Error:",k)}}return console.log("주문 생성 완료:",{orderId:N,orderNumber:g}),e.json({success:!0,orderId:N,orderNumber:g,totalAmount:a})}catch(t){return console.error("주문 생성 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/:orderNumber/refund",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.param("orderNumber"),{reason:s}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:t,reason:s});const a=await r.prepare(`
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${u}.csv"`}})}catch(r){return console.error("CSV download error:",r),e.json({success:!1,error:r.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{order_number:s}=await e.req.json();if(!s)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await r.prepare(`
    ...
    `).bind(t.sellerId).first();if(!n)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const o=await r.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),u=Math.floor(i/1.1),c=i-u,l=new Date().toISOString().split("T")[0],d=`${l}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,_=xr(n,a,o.results);let E,f,y;try{E=await Ur(_),f=E.ntsConfirmNumber,y=E.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:f,invoiceKey:y,mockMode:Ce()})}catch(g){console.error("바로빌 API 호출 실패:",g),f="FAILED",y=null}const b=(await r.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(t.sellerId,s,"tax",d,l,n.business_number,n.business_name,n.ceo_name,n.address,n.business_type,n.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,u,c,i,f==="FAILED"?"failed":"issued",Ce()?"mock":"barobill",y,f).run()).meta.last_row_id;for(const g of o.results){const j=Math.floor(Number(g.price)*Number(g.quantity)/1.1),N=Number(g.price)*Number(g.quantity)-j;await r.prepare(`
        INSERT INTO tax_invoice_items (
    ...
    `).bind(s).all();return e.json({success:!0,data:{...a,items:n.results||[]}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/:id/cancel",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{reason:a}=await e.req.json(),n=await r.prepare(`
      SELECT * FROM tax_invoices WHERE id = ? AND seller_id = ?
    `).bind(s,t.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!Ce()){const c=await r.prepare(`
          SELECT business_number FROM seller_business_info WHERE seller_id = ?
        `).bind(t.sellerId).first();c&&c.business_number&&await Pr(c.business_number,n.api_invoice_key,a||"판매자 요청")}}catch(c){console.error("바로빌 취소 API 호출 실패:",c)}return await r.prepare(`
      UPDATE tax_invoices
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return Bs({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${t}`,htmlContent:c,textContent:l})}const nt=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:Bs,sendLiveStreamCreatedEmail:at},Symbol.toStringTag,{value:"Module"}));export{ps as default};
