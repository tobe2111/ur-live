var gr=Object.defineProperty;var Ns=e=>{throw TypeError(e)};var yr=(e,s,r)=>s in e?gr(e,s,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[s]=r;var T=(e,s,r)=>yr(e,typeof s!="symbol"?s+"":s,r),ps=(e,s,r)=>s.has(e)||Ns("Cannot "+r);var _=(e,s,r)=>(ps(e,s,"read from private field"),r?r.call(e):s.get(e)),I=(e,s,r)=>s.has(e)?Ns("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,r),S=(e,s,r,t)=>(ps(e,s,"write to private field"),t?t.call(e,r):s.set(e,r),r),N=(e,s,r)=>(ps(e,s,"access private method"),r);var As=(e,s,r,t)=>({set _(a){S(e,s,a,r)},get _(){return _(e,s,t)}});var ks=(e,s,r)=>(t,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,u=!1,l;if(e[i]?(l=e[i][0][0],t.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{c=await l(t,()=>o(i+1))}catch(p){if(p instanceof Error&&s)t.error=p,c=await s(p,t),u=!0;else throw p}else t.finalized===!1&&r&&(c=await r(t));return c&&(t.finalized===!1||u)&&(t.res=c),t}},wr=Symbol(),br=async(e,s=Object.create(null))=>{const{all:r=!1,dot:t=!1}=s,n=(e instanceof Gs?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Sr(e,{all:r,dot:t}):{}};async function Sr(e,s){const r=await e.formData();return r?Tr(r,s):{}}function Tr(e,s){const r=Object.create(null);return e.forEach((t,a)=>{s.all||a.endsWith("[]")?Rr(r,a,t):r[a]=t}),s.dot&&Object.entries(r).forEach(([t,a])=>{t.includes(".")&&(Ir(r,t,a),delete r[t])}),r}var Rr=(e,s,r)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(r):e[s]=[e[s],r]:s.endsWith("[]")?e[s]=[r]:e[s]=r},Ir=(e,s,r)=>{let t=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?t[n]=r:((!t[n]||typeof t[n]!="object"||Array.isArray(t[n])||t[n]instanceof File)&&(t[n]=Object.create(null)),t=t[n])})},Ks=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},vr=e=>{const{groups:s,path:r}=Or(e),t=Ks(r);return Dr(t,s)},Or=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(r,t)=>{const a=`@${t}`;return s.push([a,r]),a}),{groups:s,path:e}},Dr=(e,s)=>{for(let r=s.length-1;r>=0;r--){const[t]=s[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(t)){e[a]=e[a].replace(t,s[r][1]);break}}return e},rs={},Nr=(e,s)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const t=`${e}#${s}`;return rs[t]||(r[2]?rs[t]=s&&s[0]!==":"&&s[0]!=="*"?[t,r[1],new RegExp(`^${r[2]}(?=/${s})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:rs[t]=[e,r[1],!0]),rs[t]}return null},ws=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return s(r)}catch{return r}})}},Ar=e=>ws(e,decodeURI),Vs=e=>{const s=e.url,r=s.indexOf("/",s.indexOf(":")+4);let t=r;for(;t<s.length;t++){const a=s.charCodeAt(t);if(a===37){const n=s.indexOf("?",t),o=s.indexOf("#",t),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(r,i);return Ar(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(r,t)},kr=e=>{const s=Vs(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},ke=(e,s,...r)=>(r.length&&(s=ke(s,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),Ys=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),r=[];let t="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))t+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&t===""?r.push("/"):r.push(t);const n=a.replace("?","");t+="/"+n,r.push(t)}else t+="/"+a}),r.filter((a,n,o)=>o.indexOf(a)===n)},ms=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ws(e,zs):e):e,Js=(e,s,r)=>{let t;if(!r&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,u=e.indexOf("&",c);return ms(e.slice(c,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(t=/[%+]/.test(e),!t)return}const a={};t??(t=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(t&&(c=ms(c)),n=o,c==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),t&&(u=ms(u))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(u)):a[c]??(a[c]=u)}return s?a[s]:a},jr=Js,Cr=(e,s)=>Js(e,s,!0),zs=decodeURIComponent,js=e=>ws(e,zs),Le,Q,de,Xs,Qs,gs,me,qs,Gs=(qs=class{constructor(e,s="/",r=[[]]){I(this,de);T(this,"raw");I(this,Le);I(this,Q);T(this,"routeIndex",0);T(this,"path");T(this,"bodyCache",{});I(this,me,e=>{const{bodyCache:s,raw:r}=this,t=s[e];if(t)return t;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=r[e]()});this.raw=e,this.path=s,S(this,Q,r),S(this,Le,{})}param(e){return e?N(this,de,Xs).call(this,e):N(this,de,Qs).call(this)}query(e){return jr(this.url,e)}queries(e){return Cr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((r,t)=>{s[t]=r}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await br(this,e))}json(){return _(this,me).call(this,"text").then(e=>JSON.parse(e))}text(){return _(this,me).call(this,"text")}arrayBuffer(){return _(this,me).call(this,"arrayBuffer")}blob(){return _(this,me).call(this,"blob")}formData(){return _(this,me).call(this,"formData")}addValidatedData(e,s){_(this,Le)[e]=s}valid(e){return _(this,Le)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[wr](){return _(this,Q)}get matchedRoutes(){return _(this,Q)[0].map(([[,e]])=>e)}get routePath(){return _(this,Q)[0].map(([[,e]])=>e)[this.routeIndex].path}},Le=new WeakMap,Q=new WeakMap,de=new WeakSet,Xs=function(e){const s=_(this,Q)[0][this.routeIndex][1][e],r=N(this,de,gs).call(this,s);return r&&/\%/.test(r)?js(r):r},Qs=function(){const e={},s=Object.keys(_(this,Q)[0][this.routeIndex][1]);for(const r of s){const t=N(this,de,gs).call(this,_(this,Q)[0][this.routeIndex][1][r]);t!==void 0&&(e[r]=/\%/.test(t)?js(t):t)}return e},gs=function(e){return _(this,Q)[1]?_(this,Q)[1][e]:e},me=new WeakMap,qs),Lr={Stringify:1},Zs=async(e,s,r,t,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:t}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Zs(c,s,!1,t,a))).then(()=>a[0]))):Promise.resolve(e)},Mr="text/plain; charset=UTF-8",_s=(e,s)=>({"Content-Type":e,...s}),Ne=(e,s)=>new Response(e,s),Ye,Je,oe,Me,ie,G,ze,Ue,$e,Se,Ge,Xe,te,je,ys,Fs,Ur=(Fs=class{constructor(e,s){I(this,te);I(this,Ye);I(this,Je);T(this,"env",{});I(this,oe);T(this,"finalized",!1);T(this,"error");I(this,Me);I(this,ie);I(this,G);I(this,ze);I(this,Ue);I(this,$e);I(this,Se);I(this,Ge);I(this,Xe);T(this,"render",(...e)=>(_(this,Ue)??S(this,Ue,s=>this.html(s)),_(this,Ue).call(this,...e)));T(this,"setLayout",e=>S(this,ze,e));T(this,"getLayout",()=>_(this,ze));T(this,"setRenderer",e=>{S(this,Ue,e)});T(this,"header",(e,s,r)=>{this.finalized&&S(this,G,Ne(_(this,G).body,_(this,G)));const t=_(this,G)?_(this,G).headers:_(this,Se)??S(this,Se,new Headers);s===void 0?t.delete(e):r!=null&&r.append?t.append(e,s):t.set(e,s)});T(this,"status",e=>{S(this,Me,e)});T(this,"set",(e,s)=>{_(this,oe)??S(this,oe,new Map),_(this,oe).set(e,s)});T(this,"get",e=>_(this,oe)?_(this,oe).get(e):void 0);T(this,"newResponse",(...e)=>N(this,te,je).call(this,...e));T(this,"body",(e,s,r)=>N(this,te,je).call(this,e,s,r));T(this,"text",(e,s,r)=>N(this,te,ys).call(this)&&!s&&!r?Ne(e):N(this,te,je).call(this,e,s,_s(Mr,r)));T(this,"json",(e,s,r)=>N(this,te,ys).call(this)&&!s&&!r?Response.json(e):N(this,te,je).call(this,JSON.stringify(e),s,_s("application/json",r)));T(this,"html",(e,s,r)=>{const t=a=>N(this,te,je).call(this,a,s,_s("text/html; charset=UTF-8",r));return typeof e=="object"?Zs(e,Lr.Stringify,!1,{}).then(t):t(e)});T(this,"redirect",(e,s)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,s??302)});T(this,"notFound",()=>(_(this,$e)??S(this,$e,()=>Ne()),_(this,$e).call(this,this)));S(this,Ye,e),s&&(S(this,ie,s.executionCtx),this.env=s.env,S(this,$e,s.notFoundHandler),S(this,Xe,s.path),S(this,Ge,s.matchResult))}get req(){return _(this,Je)??S(this,Je,new Gs(_(this,Ye),_(this,Xe),_(this,Ge))),_(this,Je)}get event(){if(_(this,ie)&&"respondWith"in _(this,ie))return _(this,ie);throw Error("This context has no FetchEvent")}get executionCtx(){if(_(this,ie))return _(this,ie);throw Error("This context has no ExecutionContext")}get res(){return _(this,G)||S(this,G,Ne(null,{headers:_(this,Se)??S(this,Se,new Headers)}))}set res(e){if(_(this,G)&&e){e=Ne(e.body,e);for(const[s,r]of _(this,G).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const t=_(this,G).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of t)e.headers.append("set-cookie",a)}else e.headers.set(s,r)}S(this,G,e),this.finalized=!0}get var(){return _(this,oe)?Object.fromEntries(_(this,oe)):{}}},Ye=new WeakMap,Je=new WeakMap,oe=new WeakMap,Me=new WeakMap,ie=new WeakMap,G=new WeakMap,ze=new WeakMap,Ue=new WeakMap,$e=new WeakMap,Se=new WeakMap,Ge=new WeakMap,Xe=new WeakMap,te=new WeakSet,je=function(e,s,r){const t=_(this,G)?new Headers(_(this,G).headers):_(this,Se)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?t.append(o,i):t.set(o,i)}if(r)for(const[n,o]of Object.entries(r))if(typeof o=="string")t.set(n,o);else{t.delete(n);for(const i of o)t.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??_(this,Me);return Ne(e,{status:a,headers:t})},ys=function(){return!_(this,Se)&&!_(this,Me)&&!this.finalized},Fs),B="ALL",$r="all",Pr=["get","post","put","delete","options","patch"],er="Can not add a route since the matcher is already built.",sr=class extends Error{},qr="__COMPOSED_HANDLER",Fr=e=>e.text("404 Not Found",404),Cs=(e,s)=>{if("getResponse"in e){const r=e.getResponse();return s.newResponse(r.body,r)}return console.error(e),s.text("Internal Server Error",500)},ee,W,rr,se,we,ts,as,Pe,Hr=(Pe=class{constructor(s={}){I(this,W);T(this,"get");T(this,"post");T(this,"put");T(this,"delete");T(this,"options");T(this,"patch");T(this,"all");T(this,"on");T(this,"use");T(this,"router");T(this,"getPath");T(this,"_basePath","/");I(this,ee,"/");T(this,"routes",[]);I(this,se,Fr);T(this,"errorHandler",Cs);T(this,"onError",s=>(this.errorHandler=s,this));T(this,"notFound",s=>(S(this,se,s),this));T(this,"fetch",(s,...r)=>N(this,W,as).call(this,s,r[1],r[0],s.method));T(this,"request",(s,r,t,a)=>s instanceof Request?this.fetch(r?new Request(s,r):s,t,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${ke("/",s)}`,r),t,a)));T(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(N(this,W,as).call(this,s.request,s,void 0,s.request.method))})});[...Pr,$r].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?S(this,ee,o):N(this,W,we).call(this,n,_(this,ee),o),i.forEach(c=>{N(this,W,we).call(this,n,_(this,ee),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){S(this,ee,c);for(const u of[n].flat())i.map(l=>{N(this,W,we).call(this,u.toUpperCase(),_(this,ee),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?S(this,ee,n):(S(this,ee,"*"),o.unshift(n)),o.forEach(i=>{N(this,W,we).call(this,B,_(this,ee),i)}),this);const{strict:t,...a}=s;Object.assign(this,a),this.getPath=t??!0?s.getPath??Vs:kr}route(s,r){const t=this.basePath(s);return r.routes.map(a=>{var o;let n;r.errorHandler===Cs?n=a.handler:(n=async(i,c)=>(await ks([],r.errorHandler)(i,()=>a.handler(i,c))).res,n[qr]=a.handler),N(o=t,W,we).call(o,a.method,a.path,n)}),this}basePath(s){const r=N(this,W,rr).call(this);return r._basePath=ke(this._basePath,s),r}mount(s,r,t){let a,n;t&&(typeof t=="function"?n=t:(n=t.optionHandler,t.replaceRequest===!1?a=c=>c:a=t.replaceRequest));const o=n?c=>{const u=n(c);return Array.isArray(u)?u:[u]}:c=>{let u;try{u=c.executionCtx}catch{}return[c.env,u]};a||(a=(()=>{const c=ke(this._basePath,s),u=c==="/"?0:c.length;return l=>{const p=new URL(l.url);return p.pathname=p.pathname.slice(u)||"/",new Request(p,l)}})());const i=async(c,u)=>{const l=await r(a(c.req.raw),...o(c));if(l)return l;await u()};return N(this,W,we).call(this,B,ke(s,"*"),i),this}},ee=new WeakMap,W=new WeakSet,rr=function(){const s=new Pe({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,S(s,se,_(this,se)),s.routes=this.routes,s},se=new WeakMap,we=function(s,r,t){s=s.toUpperCase(),r=ke(this._basePath,r);const a={basePath:this._basePath,path:r,method:s,handler:t};this.router.add(s,r,[t,a]),this.routes.push(a)},ts=function(s,r){if(s instanceof Error)return this.errorHandler(s,r);throw s},as=function(s,r,t,a){if(a==="HEAD")return(async()=>new Response(null,await N(this,W,as).call(this,s,r,t,"GET")))();const n=this.getPath(s,{env:t}),o=this.router.match(a,n),i=new Ur(s,{path:n,matchResult:o,env:t,executionCtx:r,notFoundHandler:_(this,se)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await _(this,se).call(this,i)})}catch(l){return N(this,W,ts).call(this,l,i)}return u instanceof Promise?u.then(l=>l||(i.finalized?i.res:_(this,se).call(this,i))).catch(l=>N(this,W,ts).call(this,l,i)):u??_(this,se).call(this,i)}const c=ks(o[0],this.errorHandler,_(this,se));return(async()=>{try{const u=await c(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return N(this,W,ts).call(this,u,i)}})()},Pe),tr=[];function xr(e,s){const r=this.buildAllMatchers(),t=((a,n)=>{const o=r[a]||r[B],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],tr];const u=c.indexOf("",1);return[o[1][u],c]});return this.match=t,t(e,s)}var os="[^/]+",Ke=".*",Ve="(?:|/.*)",Ce=Symbol(),Br=new Set(".\\+*[^]$()");function Wr(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===Ke||e===Ve?1:s===Ke||s===Ve?-1:e===os?1:s===os?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var Te,Re,re,Oe,Kr=(Oe=class{constructor(){I(this,Te);I(this,Re);I(this,re,Object.create(null))}insert(s,r,t,a,n){if(s.length===0){if(_(this,Te)!==void 0)throw Ce;if(n)return;S(this,Te,r);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",Ke]:["","",os]:o==="/*"?["","",Ve]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(c){const l=c[1];let p=c[2]||os;if(l&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Ce;if(u=_(this,re)[p],!u){if(Object.keys(_(this,re)).some(m=>m!==Ke&&m!==Ve))throw Ce;if(n)return;u=_(this,re)[p]=new Oe,l!==""&&S(u,Re,a.varIndex++)}!n&&l!==""&&t.push([l,_(u,Re)])}else if(u=_(this,re)[o],!u){if(Object.keys(_(this,re)).some(l=>l.length>1&&l!==Ke&&l!==Ve))throw Ce;if(n)return;u=_(this,re)[o]=new Oe}u.insert(i,r,t,a,n)}buildRegExpStr(){const r=Object.keys(_(this,re)).sort(Wr).map(t=>{const a=_(this,re)[t];return(typeof _(a,Re)=="number"?`(${t})@${_(a,Re)}`:Br.has(t)?`\\${t}`:t)+a.buildRegExpStr()});return typeof _(this,Te)=="number"&&r.unshift(`#${_(this,Te)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Te=new WeakMap,Re=new WeakMap,re=new WeakMap,Oe),cs,Qe,Hs,Vr=(Hs=class{constructor(){I(this,cs,{varIndex:0});I(this,Qe,new Kr)}insert(e,s,r){const t=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const u=`@\\${o}`;return a[o]=[u,c],o++,i=!0,u}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return _(this,Qe).insert(n,s,t,_(this,cs),r),t}buildRegExp(){let e=_(this,Qe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const r=[],t=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(r[++s]=Number(n),"$()"):(o!==void 0&&(t[Number(o)]=++s),"")),[new RegExp(`^${e}`),r,t]}},cs=new WeakMap,Qe=new WeakMap,Hs),Yr=[/^$/,[],Object.create(null)],ns=Object.create(null);function ar(e){return ns[e]??(ns[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Jr(){ns=Object.create(null)}function zr(e){var u;const s=new Vr,r=[];if(e.length===0)return Yr;const t=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,p],[m,E])=>l?1:m?-1:p.length-E.length),a=Object.create(null);for(let l=0,p=-1,m=t.length;l<m;l++){const[E,f,h]=t[l];E?a[f]=[h.map(([w])=>[w,Object.create(null)]),tr]:p++;let g;try{g=s.insert(f,p,E)}catch(w){throw w===Ce?new sr(f):w}E||(r[p]=h.map(([w,y])=>{const A=Object.create(null);for(y-=1;y>=0;y--){const[O,C]=g[y];A[O]=C}return[w,A]}))}const[n,o,i]=s.buildRegExp();for(let l=0,p=r.length;l<p;l++)for(let m=0,E=r[l].length;m<E;m++){const f=(u=r[l][m])==null?void 0:u[1];if(!f)continue;const h=Object.keys(f);for(let g=0,w=h.length;g<w;g++)f[h[g]]=i[f[h[g]]]}const c=[];for(const l in o)c[l]=r[o[l]];return[n,c,a]}function Ae(e,s){if(e){for(const r of Object.keys(e).sort((t,a)=>a.length-t.length))if(ar(r).test(s))return[...e[r]]}}var _e,fe,us,nr,xs,Gr=(xs=class{constructor(){I(this,us);T(this,"name","RegExpRouter");I(this,_e);I(this,fe);T(this,"match",xr);S(this,_e,{[B]:Object.create(null)}),S(this,fe,{[B]:Object.create(null)})}add(e,s,r){var i;const t=_(this,_e),a=_(this,fe);if(!t||!a)throw new Error(er);t[e]||[t,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[B]).forEach(u=>{c[e][u]=[...c[B][u]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=ar(s);e===B?Object.keys(t).forEach(u=>{var l;(l=t[u])[s]||(l[s]=Ae(t[u],s)||Ae(t[B],s)||[])}):(i=t[e])[s]||(i[s]=Ae(t[e],s)||Ae(t[B],s)||[]),Object.keys(t).forEach(u=>{(e===B||e===u)&&Object.keys(t[u]).forEach(l=>{c.test(l)&&t[u][l].push([r,n])})}),Object.keys(a).forEach(u=>{(e===B||e===u)&&Object.keys(a[u]).forEach(l=>c.test(l)&&a[u][l].push([r,n]))});return}const o=Ys(s)||[s];for(let c=0,u=o.length;c<u;c++){const l=o[c];Object.keys(a).forEach(p=>{var m;(e===B||e===p)&&((m=a[p])[l]||(m[l]=[...Ae(t[p],l)||Ae(t[B],l)||[]]),a[p][l].push([r,n-u+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(_(this,fe)).concat(Object.keys(_(this,_e))).forEach(s=>{e[s]||(e[s]=N(this,us,nr).call(this,s))}),S(this,_e,S(this,fe,void 0)),Jr(),e}},_e=new WeakMap,fe=new WeakMap,us=new WeakSet,nr=function(e){const s=[];let r=e===B;return[_(this,_e),_(this,fe)].forEach(t=>{const a=t[e]?Object.keys(t[e]).map(n=>[n,t[e][n]]):[];a.length!==0?(r||(r=!0),s.push(...a)):e!==B&&s.push(...Object.keys(t[B]).map(n=>[n,t[B][n]]))}),r?zr(s):null},xs),Ee,ce,Bs,Xr=(Bs=class{constructor(e){T(this,"name","SmartRouter");I(this,Ee,[]);I(this,ce,[]);S(this,Ee,e.routers)}add(e,s,r){if(!_(this,ce))throw new Error(er);_(this,ce).push([e,s,r])}match(e,s){if(!_(this,ce))throw new Error("Fatal error");const r=_(this,Ee),t=_(this,ce),a=r.length;let n=0,o;for(;n<a;n++){const i=r[n];try{for(let c=0,u=t.length;c<u;c++)i.add(...t[c]);o=i.match(e,s)}catch(c){if(c instanceof sr)continue;throw c}this.match=i.match.bind(i),S(this,Ee,[i]),S(this,ce,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(_(this,ce)||_(this,Ee).length!==1)throw new Error("No active router has been determined yet.");return _(this,Ee)[0]}},Ee=new WeakMap,ce=new WeakMap,Bs),Be=Object.create(null),Qr=e=>{for(const s in e)return!0;return!1},he,J,Ie,qe,Y,ue,be,Fe,Zr=(Fe=class{constructor(s,r,t){I(this,ue);I(this,he);I(this,J);I(this,Ie);I(this,qe,0);I(this,Y,Be);if(S(this,J,t||Object.create(null)),S(this,he,[]),s&&r){const a=Object.create(null);a[s]={handler:r,possibleKeys:[],score:0},S(this,he,[a])}S(this,Ie,[])}insert(s,r,t){S(this,qe,++As(this,qe)._);let a=this;const n=vr(r),o=[];for(let i=0,c=n.length;i<c;i++){const u=n[i],l=n[i+1],p=Nr(u,l),m=Array.isArray(p)?p[0]:u;if(m in _(a,J)){a=_(a,J)[m],p&&o.push(p[1]);continue}_(a,J)[m]=new Fe,p&&(_(a,Ie).push(p),o.push(p[1])),a=_(a,J)[m]}return _(a,he).push({[s]:{handler:t,possibleKeys:o.filter((i,c,u)=>u.indexOf(i)===c),score:_(this,qe)}}),a}search(s,r){var l;const t=[];S(this,Y,Be);let n=[this];const o=Ks(r),i=[],c=o.length;let u=null;for(let p=0;p<c;p++){const m=o[p],E=p===c-1,f=[];for(let g=0,w=n.length;g<w;g++){const y=n[g],A=_(y,J)[m];A&&(S(A,Y,_(y,Y)),E?(_(A,J)["*"]&&N(this,ue,be).call(this,t,_(A,J)["*"],s,_(y,Y)),N(this,ue,be).call(this,t,A,s,_(y,Y))):f.push(A));for(let O=0,C=_(y,Ie).length;O<C;O++){const U=_(y,Ie)[O],k=_(y,Y)===Be?{}:{..._(y,Y)};if(U==="*"){const P=_(y,J)["*"];P&&(N(this,ue,be).call(this,t,P,s,_(y,Y)),S(P,Y,k),f.push(P));continue}const[D,L,$]=U;if(!m&&!($ instanceof RegExp))continue;const j=_(y,J)[D];if($ instanceof RegExp){if(u===null){u=new Array(c);let X=r[0]==="/"?1:0;for(let R=0;R<c;R++)u[R]=X,X+=o[R].length+1}const P=r.substring(u[p]),K=$.exec(P);if(K){if(k[L]=K[0],N(this,ue,be).call(this,t,j,s,_(y,Y),k),Qr(_(j,J))){S(j,Y,k);const X=((l=K[0].match(/\//))==null?void 0:l.length)??0;(i[X]||(i[X]=[])).push(j)}continue}}($===!0||$.test(m))&&(k[L]=m,E?(N(this,ue,be).call(this,t,j,s,k,_(y,Y)),_(j,J)["*"]&&N(this,ue,be).call(this,t,_(j,J)["*"],s,k,_(y,Y))):(S(j,Y,k),f.push(j)))}}const h=i.shift();n=h?f.concat(h):f}return t.length>1&&t.sort((p,m)=>p.score-m.score),[t.map(({handler:p,params:m})=>[p,m])]}},he=new WeakMap,J=new WeakMap,Ie=new WeakMap,qe=new WeakMap,Y=new WeakMap,ue=new WeakSet,be=function(s,r,t,a,n){for(let o=0,i=_(r,he).length;o<i;o++){const c=_(r,he)[o],u=c[t]||c[B],l={};if(u!==void 0&&(u.params=Object.create(null),s.push(u),a!==Be||n&&n!==Be))for(let p=0,m=u.possibleKeys.length;p<m;p++){const E=u.possibleKeys[p],f=l[u.score];u.params[E]=n!=null&&n[E]&&!f?n[E]:a[E]??(n==null?void 0:n[E]),l[u.score]=!0}}},Fe),ve,Ws,et=(Ws=class{constructor(){T(this,"name","TrieRouter");I(this,ve);S(this,ve,new Zr)}add(e,s,r){const t=Ys(s);if(t){for(let a=0,n=t.length;a<n;a++)_(this,ve).insert(e,t[a],r);return}_(this,ve).insert(e,s,r)}match(e,s){return _(this,ve).search(e,s)}},ve=new WeakMap,Ws),or=class extends Hr{constructor(e={}){super(e),this.router=e.router??new Xr({routers:[new Gr,new et]})}},b=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},t=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(r.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(r.allowMethods);return async function(o,i){var l;function c(p,m){o.res.headers.set(p,m)}const u=await t(o.req.header("origin")||"",o);if(u&&c("Access-Control-Allow-Origin",u),r.credentials&&c("Access-Control-Allow-Credentials","true"),(l=r.exposeHeaders)!=null&&l.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const p=await a(o.req.header("origin")||"",o);p.length&&c("Access-Control-Allow-Methods",p.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(m=E.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}},st=/^\s*(?:text\/(?!event-stream(?:[;\s]|$))[^;\s]+|application\/(?:javascript|json|xml|xml-dtd|ecmascript|dart|postscript|rtf|tar|toml|vnd\.dart|vnd\.ms-fontobject|vnd\.ms-opentype|wasm|x-httpd-php|x-javascript|x-ns-proxy-autoconfig|x-sh|x-tar|x-virtualbox-hdd|x-virtualbox-ova|x-virtualbox-ovf|x-virtualbox-vbox|x-virtualbox-vdi|x-virtualbox-vhd|x-virtualbox-vmdk|x-www-form-urlencoded)|font\/(?:otf|ttf)|image\/(?:bmp|vnd\.adobe\.photoshop|vnd\.microsoft\.icon|vnd\.ms-dds|x-icon|x-ms-bmp)|message\/rfc822|model\/gltf-binary|x-shader\/x-fragment|x-shader\/x-vertex|[^;\s]+?\+(?:json|text|xml|yaml))(?:[;\s]|$)/i,rt=/(?:^|,)\s*?no-transform\s*?(?:,|$)/i,tt=e=>{const s=e==null?void 0:e.threshold;return async function(t,a){await a();const n=t.res.headers.get("Content-Length");if(t.res.headers.has("Content-Encoding")||t.res.headers.has("Transfer-Encoding")||t.req.method==="HEAD"||n&&Number(n)<s||!at(t.res)||!nt(t.res))return;t.req.header("Accept-Encoding");const o=e==null?void 0:e.encoding;if(!t.res.body)return;const i=new CompressionStream(o);t.res=new Response(t.res.body.pipeThrough(i),t.res),t.res.headers.delete("Content-Length"),t.res.headers.set("Content-Encoding",o)}},at=e=>{const s=e.headers.get("Content-Type");return s&&st.test(s)},nt=e=>{const s=e.headers.get("Cache-Control");return!s||!rt.test(s)};function ot(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],r=[];for(const t of s)e[t]||r.push(t);if(r.length>0)throw new Error(`Missing required environment variables: ${r.join(", ")}
...
`)}async function lt(e){const s=await ct(e),r=s.filter(n=>n.status==="pass").length,t=s.filter(n=>n.status==="warn").length,a=s.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:s.length,pass:r,warn:t,fail:a},results:s,formatted:ut(s)}}const fs={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function dt(){const e=fs.ENV==="production";return{baseUrl:fs.TEST_BASE_URL,apiKey:fs.TEST_API_KEY,isProduction:e}}async function ir(e,s){const r=dt(),t=`${r.baseUrl}${e}`;try{const a=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r.apiKey}`},body:JSON.stringify(s)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function pt(e){try{const s={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((t,a)=>({SerialNum:a+1,ItemName:t.name,Qty:t.quantity,UnitPrice:t.unitPrice,SupplyCost:t.supplyPrice,Tax:t.taxAmount,Remark:t.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},r=await ir("/eTaxInvoice/RegistAndIssue",s);if(r.code!==1)throw new Error(`바로빌 발행 실패: ${r.message}`);return{success:!0,ntsConfirmNumber:r.ntsconfirmNum,invoiceKey:r.invoiceKey,message:r.message}}catch(s){throw console.error("바로빌 세금계산서 발행 실패:",s),s}}async function mt(e,s,r){try{const a=await ir("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:s,Memo:r});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(t){throw console.error("바로빌 세금계산서 취소 실패:",t),t}}function We(){return!1}async function _t(e){return await pt(e)}function ft(e,s,r){const t=Number(s.total_amount),a=Math.floor(t/1.1),n=t-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:s.buyer_business_number,buyerBusinessName:s.buyer_business_name||s.user_name,buyerCEO:s.buyer_ceo_name,buyerAddress:s.shipping_address,buyerEmail:s.user_email,buyerTel:s.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:r.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),u=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:u,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:t,memo:`주문번호: ${s.order_number}`,orderNo:s.order_number}}class Z extends Error{constructor(s,r,t){super(s),this.statusCode=r,this.code=t,this.name="AuthError"}}function Et(e){return`${crypto.randomUUID()}-${e}`}function ht(e){var n,o,i,c,u,l,p;const s=e.id.toString(),r=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",t=((c=e.kakao_account)==null?void 0:c.email)||null,a=((u=e.properties)==null?void 0:u.profile_image)||((p=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:p.profile_image_url)||null;return{kakaoId:s,nickname:r,email:t,profileImage:a}}async function gt(e,s,r,t,a){try{const n=await e.prepare(`
    ...
    `).bind(s,r,t,a).first();if(!n)throw new Z("Failed to upsert user",500,"UPSERT_FAILED");return console.log("[Auth] ⚡ User upserted successfully (optimized):",n.id),n}catch(n){throw n instanceof Z?n:(console.error("[Auth] Database error during upsert:",n),new Z("Database error",500,"DB_ERROR"))}}async function yt(e){try{const s=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"}});if(!s.ok){const t=await s.text();throw console.error("[Kakao API] Failed to get user info:",t),new Z("Failed to get user info from Kakao",401,"KAKAO_USER_INFO_FAILED")}const r=await s.json();if(!r.id)throw new Z("Invalid user data from Kakao",500,"INVALID_KAKAO_DATA");return r}catch(s){throw s instanceof Z?s:(console.error("[Kakao API] Network error:",s),new Z("Failed to communicate with Kakao API",503,"KAKAO_API_ERROR"))}}async function wt(e,s,r){try{const t=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"},body:new URLSearchParams({grant_type:"authorization_code",client_id:r,redirect_uri:s,code:e}).toString()});if(!t.ok){const n=await t.json();throw console.error("[Kakao OAuth] Token exchange failed:",n),new Z(`Failed to exchange code: ${n.error_description||n.error}`,401,n.error||"TOKEN_EXCHANGE_FAILED")}return(await t.json()).access_token}catch(t){throw t instanceof Z?t:(console.error("[Kakao OAuth] Network error:",t),new Z("Failed to communicate with Kakao OAuth server",503,"OAUTH_NETWORK_ERROR"))}}async function cr(e,s){const r=await yt(s),{kakaoId:t,nickname:a,email:n,profileImage:o}=ht(r);console.log("[Auth] Processing login for Kakao user:",t);const i=await gt(e,t,a,n,o),c=Et(i.id);return{user:i,sessionToken:c}}async function ur(e,s,r=30){try{const t=await e.get(s,"json");if(!t)return console.log(`[Cache MISS] ${s}`),null;const a=Date.now()-t.timestamp;return a>r*1e3?(console.log(`[Cache EXPIRED] ${s} (age: ${Math.round(a/1e3)}s)`),null):(console.log(`[Cache HIT] ${s} (age: ${Math.round(a/1e3)}s)`),t.data)}catch(t){return console.error(`[Cache] Get error for key "${s}":`,t),null}}async function is(e,s,r,t=30){try{const a={data:r,timestamp:Date.now()};await e.put(s,JSON.stringify(a),{expirationTtl:t}),console.log(`[Cache SET] ${s} (TTL: ${t}s)`)}catch(a){console.error(`[Cache] Set error for key "${s}":`,a)}}function bt(e){const s=e.req.header("CF-Connecting-IP");if(s)return s;const r=e.req.header("X-Forwarded-For");if(r)return r.split(",")[0].trim();const t=e.req.header("X-Real-IP");return t||"unknown"}function St(e,s){return`ratelimit:${e}:${s}`}const Es=new Map;async function Tt(e,s,r){var m;const t=new URL(e.req.url).pathname,a=St(s,t),n=Date.now(),o=r.windowMs*1e3,c=e.get("user")&&r.authenticatedMultiplier?r.maxRequests*r.authenticatedMultiplier:r.maxRequests;try{const E=(m=e.env)==null?void 0:m.RATE_LIMIT_KV;if(E){const f=await E.get(a);let h;f?(h=JSON.parse(f),n>h.resetTime?h={count:1,resetTime:n+o}:h.count++):h={count:1,resetTime:n+o};const g=Math.ceil(o/1e3);await E.put(a,JSON.stringify(h),{expirationTtl:g});const w=h.count<=c,y=Math.max(0,c-h.count);return{allowed:w,remaining:y,resetTime:h.resetTime}}}catch(E){console.error("KV Rate Limit Error:",E)}let u=Es.get(a);u&&n>u.resetTime&&(Es.delete(a),u=void 0),u?u.count++:u={count:1,resetTime:n+o},Es.set(a,u);const l=u.count<=c,p=Math.max(0,c-u.count);return{allowed:l,remaining:p,resetTime:u.resetTime}}function Ze(e){return async(s,r)=>{const t=bt(s);if(e.skipIps&&e.skipIps.includes(t))return r();if(e.pathPattern){const n=new URL(s.req.url).pathname;if(!e.pathPattern.test(n))return r()}const a=await Tt(s,t,e);if(s.header("X-RateLimit-Limit",e.maxRequests.toString()),s.header("X-RateLimit-Remaining",a.remaining.toString()),s.header("X-RateLimit-Reset",new Date(a.resetTime).toISOString()),!a.allowed){const n=Math.ceil((a.resetTime-Date.now())/1e3);return s.header("Retry-After",n.toString()),s.json({success:!1,error:e.message||"Too many requests. Please try again later.",retryAfter:n,resetTime:new Date(a.resetTime).toISOString()},429)}return r()}}const es={api:{windowMs:60,maxRequests:60,message:"API 요청 제한을 초과했습니다. 잠시 후 다시 시도해주세요.",authenticatedMultiplier:2},auth:{windowMs:60,maxRequests:5,message:"로그인 시도 횟수를 초과했습니다. 1분 후 다시 시도해주세요.",pathPattern:/^\/api\/auth\//},order:{windowMs:60,maxRequests:10,message:"주문 요청이 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/orders/,authenticatedMultiplier:2},alimtalk:{windowMs:60,maxRequests:10,message:"알림톡 발송 요청이 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/seller\/alimtalk\/send/},upload:{windowMs:60,maxRequests:5,message:"파일 업로드가 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/.*\/upload/}};class F extends Error{constructor(s,r,t="VALIDATION_ERROR"){super(r),this.field=s,this.code=t,this.name="ValidationError"}}function Rt(e,s){const{field:r,required:t,type:a,min:n,max:o,pattern:i,enum:c,custom:u,message:l}=s;if(t&&(e==null||e===""))throw new F(r,l||`${r}은(는) 필수 항목입니다.`,"REQUIRED");if(!(e==null||e==="")){if(a)switch(a){case"string":if(typeof e!="string")throw new F(r,l||`${r}은(는) 문자열이어야 합니다.`,"INVALID_TYPE");break;case"number":const p=typeof e=="string"?Number(e):e;if(typeof p!="number"||isNaN(p))throw new F(r,l||`${r}은(는) 숫자여야 합니다.`,"INVALID_TYPE");break;case"boolean":if(typeof e!="boolean")throw new F(r,l||`${r}은(는) true/false 값이어야 합니다.`,"INVALID_TYPE");break;case"email":if(typeof e!="string"||!Ot(e))throw new F(r,l||`${r}은(는) 유효한 이메일 주소여야 합니다.`,"INVALID_EMAIL");break;case"url":if(typeof e!="string"||!Dt(e))throw new F(r,l||`${r}은(는) 유효한 URL이어야 합니다.`,"INVALID_URL");break;case"phone":if(typeof e!="string"||!Nt(e))throw new F(r,l||`${r}은(는) 유효한 전화번호여야 합니다.`,"INVALID_PHONE");break;case"date":if(!(e instanceof Date)&&!At(e))throw new F(r,l||`${r}은(는) 유효한 날짜여야 합니다.`,"INVALID_DATE");break;case"array":if(!Array.isArray(e))throw new F(r,l||`${r}은(는) 배열이어야 합니다.`,"INVALID_TYPE");break;case"object":if(typeof e!="object"||e===null||Array.isArray(e))throw new F(r,l||`${r}은(는) 객체여야 합니다.`,"INVALID_TYPE");break}if(typeof e=="string"){if(n!==void 0&&e.length<n)throw new F(r,l||`${r}은(는) 최소 ${n}자 이상이어야 합니다.`,"TOO_SHORT");if(o!==void 0&&e.length>o)throw new F(r,l||`${r}은(는) 최대 ${o}자 이하여야 합니다.`,"TOO_LONG")}if(typeof e=="number"){if(n!==void 0&&e<n)throw new F(r,l||`${r}은(는) 최소 ${n} 이상이어야 합니다.`,"TOO_SMALL");if(o!==void 0&&e>o)throw new F(r,l||`${r}은(는) 최대 ${o} 이하여야 합니다.`,"TOO_LARGE")}if(Array.isArray(e)){if(n!==void 0&&e.length<n)throw new F(r,l||`${r}은(는) 최소 ${n}개 이상이어야 합니다.`,"TOO_FEW");if(o!==void 0&&e.length>o)throw new F(r,l||`${r}은(는) 최대 ${o}개 이하여야 합니다.`,"TOO_MANY")}if(i&&typeof e=="string"&&!i.test(e))throw new F(r,l||`${r}의 형식이 올바르지 않습니다.`,"INVALID_FORMAT");if(c&&!c.includes(e))throw new F(r,l||`${r}은(는) 다음 중 하나여야 합니다: ${c.join(", ")}`,"INVALID_ENUM");if(u&&u(e)===!1)throw new F(r,l||`${r}의 값이 유효하지 않습니다.`,"CUSTOM_VALIDATION_FAILED")}}function It(e,s){for(const r of s){const t=e[r.field];Rt(t,r)}}function vt(e){return async(s,r)=>{try{let t={};const a=s.req.header("content-type")||"";a.includes("application/json")?t=await s.req.json().catch(()=>({})):(a.includes("application/x-www-form-urlencoded")||a.includes("multipart/form-data"))&&(t=await s.req.parseBody().catch(()=>({})));const n=new URL(s.req.url);for(const[o,i]of n.searchParams.entries())o in t||(t[o]=i);It(t,e),s.set("validatedData",t),await r()}catch(t){if(t instanceof F)return s.json({success:!1,error:t.message,field:t.field,code:t.code},400);throw t}}}function Ot(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)&&e.length<=255}function Dt(e){try{const s=new URL(e);return s.protocol==="http:"||s.protocol==="https:"}catch{return!1}}function Nt(e){return/^01([0|1|6|7|8|9])-?([0-9]{3,4})-?([0-9]{4})$/.test(e)}function At(e){if(typeof e!="string")return!1;const s=new Date(e);return!isNaN(s.getTime())}const kt=[{field:"email",required:!0,type:"email",max:255,message:"유효한 이메일 주소를 입력해주세요."},{field:"password",required:!0,type:"string",min:8,max:100,pattern:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/,message:"비밀번호는 최소 8자 이상, 대소문자와 숫자를 포함해야 합니다."},{field:"name",required:!0,type:"string",min:2,max:50,message:"이름은 2-50자 사이여야 합니다."},{field:"phone",required:!1,type:"phone",message:"유효한 전화번호를 입력해주세요. (예: 010-1234-5678)"}];function ls(e){const s=new URLSearchParams;for(const[r,t]of Object.entries(e))t!=null&&s.append(r,String(t));return s}function bs(e,s){if(e.result_code!=="1")throw new Error(`[Aligo ${s}] ${e.message} (code: ${e.result_code})`)}async function Ss(e){console.log("[Aligo] 토큰 생성 시작");const r=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/token/create/30/s/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:ls({apikey:e.ALIGO_API_KEY,userid:e.ALIGO_USER_ID})})).json();return bs(r,"Token Create"),console.log("[Aligo] ✅ 토큰 생성 성공:",r.token.substring(0,20)+"..."),{token:r.token,urtime:r.urtime}}async function jt(e,s){console.log("[Aligo] 카카오 채널 등록:",s.channelId);const{token:r}=await Ss(e),a=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/plus/add/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:ls({token:r,userid:e.ALIGO_USER_ID,plusid:s.channelId,phonenumber:s.phoneNumber})})).json();return bs(a,"Channel Register"),console.log("[Aligo] ✅ 카카오 채널 등록 성공, senderKey:",a.senderkey),{success:!0,senderKey:a.senderkey}}async function Ct(e,s,r){console.log("[Aligo] 템플릿 등록:",r.templateCode);const{token:t}=await Ss(e),n=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/template/add/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:ls({token:t,userid:e.ALIGO_USER_ID,senderkey:s,tpl_name:r.name,tpl_content:r.content,tpl_code:r.templateCode})})).json();return bs(n,"Template Register"),console.log("[Aligo] ✅ 템플릿 등록 성공:",n.tpl_code),{success:!0,templateCode:n.tpl_code}}async function Ts(e,s){console.log("[Aligo] 알림톡 발송:",s.to);try{const{token:r}=await Ss(e),t=s.buttons?JSON.stringify({button:s.buttons}):void 0,n=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/alimtalk/send/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:ls({token:r,userid:e.ALIGO_USER_ID,senderkey:s.senderKey,tpl_code:s.templateCode,receiver_1:s.to,subject_1:"알림톡",message_1:s.message,button_1:t})})).json();return n.result_code!=="1"?(console.error("[Aligo] ❌ 알림톡 발송 실패:",n.message),{success:!1,error:n.message}):(console.log("[Aligo] ✅ 알림톡 발송 성공, messageId:",n.msg_id),{success:!0,messageId:n.msg_id})}catch(r){return console.error("[Aligo] ❌ 알림톡 발송 에러:",r.message),{success:!1,error:r.message}}}function Lt(e,s){let r=e;for(const[t,a]of Object.entries(s)){const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}return r}function lr(e){let s=e.replace(/-/g,"");if(!s.startsWith("010"))throw new Error("Invalid phone number format. Must start with 010");if(s.length!==11)throw new Error("Invalid phone number length. Must be 11 digits");return s}async function Mt(e,s){const r=await e.prepare(`
    SELECT 
      o.*,
  ...
  `).bind(s).first();if(!r)throw new Error(`Order not found: ${s}`);const t=await e.prepare(`
    ...
    WHERE oi.order_id = ?
  `).bind(s).all();return{order:r,products:t.results}}async function Ut(e,s){const r=await e.prepare(`
    SELECT 
  ...
  `).bind(s).first();return r||(console.warn(`No active alimtalk account for seller ${s}`),null)}async function Ls(e,s){await e.prepare(`
    INSERT INTO alimtalk_messages 
    (seller_id, template_code, recipient_phone, message, cost, status, order_id, sent_at)
    VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
  `).bind(s.seller_id,s.template_code,s.recipient_phone,s.message,s.cost,s.status,s.order_id||null).run()}async function $t(e,s,r){await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?
    WHERE seller_id = ?
  `).bind(r,s).run()}async function Pt(e,s){try{const{order:r,products:t}=await Mt(e.DB,s),a=await Ut(e.DB,r.seller_id);if(!a)return console.warn(`Skipping alimtalk for order ${s}: no active account`),{success:!1,reason:"no_account"};const n=15;if(a.balance<n)return console.warn(`Skipping alimtalk for order ${s}: insufficient balance`),{success:!1,reason:"insufficient_balance"};const o=t.map(u=>`${u.name} ${u.quantity}개 (${u.price.toLocaleString()}원)`).join(`
`),i=`[주문 확인]
...
주문해 주셔서 감사합니다!`,c=await Ts(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:r.buyer_phone,message:i});return c.success?(await $t(e.DB,r.seller_id,n),await Ls(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await Ls(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(r){return console.error(`Error sending order confirmation for order ${s}:`,r),{success:!1,error:r.message}}}function qt(e,s){let r=e;return Object.entries(s).forEach(([t,a])=>{const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}),r}function Ft(e,s){const t=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:t.length===0,missingVars:t}}async function Ht(e,s,r){const t=await e.prepare(`
    SELECT balance FROM alimtalk_accounts WHERE id = ?
  `).bind(s).first();if(!t)throw new Error(`Account not found: ${s}`);return{sufficient:t.balance>=r,currentBalance:t.balance}}async function xt(e,s,r){const t=await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?,
        updated_at = datetime('now')
    WHERE id = ? AND balance >= ?
  `).bind(r,s,r).run();if(!t.success||t.meta.changes===0)throw new Error("Insufficient balance or account not found")}async function Ms(e,s,r){await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance + ?,
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,s).run()}async function hs(e,s){await e.prepare(`
    INSERT INTO alimtalk_messages 
  ...
  `).bind(s.accountId,s.templateId,s.orderId||null,s.recipientPhone,s.messageContent,s.status,s.cost,s.aligoMessageId||null,s.failedReason||null).run()}async function Bt(e,s,r,t){await e.prepare(`
    UPDATE alimtalk_accounts
    SET total_sent = total_sent + ?,
        total_failed = total_failed + ?,
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,t,s).run()}async function Wt(e,s,r,t,a,n,o,i,c){try{const u={...i,...o.variables},l=qt(t,u),p=await Ts(e,{senderKey:a,templateCode:n,to:o.phone,message:l});return p.success?(await hs(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:l,status:"sent",cost:c,aligoMessageId:p.messageId}),{phone:o.phone,status:"sent",messageId:p.messageId,cost:c}):(await hs(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:l,status:"failed",cost:0,failedReason:p.error}),await Ms(e.DB,s,c),{phone:o.phone,status:"failed",error:p.error,cost:0})}catch(u){return console.error(`Failed to send alimtalk to ${o.phone}:`,u),await hs(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:"",status:"failed",cost:0,failedReason:u.message}),await Ms(e.DB,s,c),{phone:o.phone,status:"failed",error:u.message,cost:0}}}async function Rs(e,s){const{accountId:r,templateId:t,recipients:a,variables:n}=s;console.log(`[Alimtalk] Starting bulk send: ${a.length} recipients`);try{const o=await e.DB.prepare(`
      SELECT 
        id,
        sender_key,
        balance,
    ...
    `).bind(t,r).first();if(!i)throw new Error("Template not found");if(i.status!=="approved")throw new Error("Template is not approved");const c=Ft(i.template_content,n);if(!c.valid)throw new Error(`Missing variables: ${c.missingVars.join(", ")}`);const u=15,l=a.length*u,p=await Ht(e.DB,r,l);if(!p.sufficient)throw new Error(`Insufficient balance. Required: ${l}, Current: ${p.currentBalance}`);await xt(e.DB,r,l),console.log(`[Alimtalk] Deducted ${l} points from account ${r}`);const m=[];let E=0,f=0,h=0;for(const g of a){const w=await Wt(e,r,t,i.template_content,o.sender_key,i.template_code,g,n,u);m.push(w),w.status==="sent"?E++:(f++,h+=u),m.length%10===0&&await new Promise(y=>setTimeout(y,1e3))}return await Bt(e.DB,r,E,f),console.log(`[Alimtalk] Completed: ${E} sent, ${f} failed, ${h} refunded`),{success:!0,totalRecipients:a.length,successCount:E,failedCount:f,refundedAmount:h,messages:m}}catch(o){return console.error("[Alimtalk] Bulk send failed:",o),{success:!1,totalRecipients:a.length,successCount:0,failedCount:a.length,refundedAmount:0,messages:[],error:o.message}}}async function Kt(e,s,r,t,a){const n=await e.DB.prepare(`
    SELECT 
      o.*,
      u.name as buyer_name,
      u.phone as buyer_phone,
...
`),c={orderNumber:n.order_number,orderDate:new Date(n.created_at).toLocaleString("ko-KR"),productList:i,totalAmount:n.total_amount.toLocaleString(),shippingAddress:n.shipping_address,shippingName:n.shipping_name,shippingPhone:n.shipping_phone,buyerName:n.buyer_name,customMessage:a||"감사합니다!"},u=[{phone:n.buyer_phone,name:n.buyer_name}];return Rs(e,{accountId:s,templateId:r,recipients:u,variables:c})}async function Vt(e,s,r,t,a={}){const n=t.map(o=>({phone:o.phone,name:o.name,variables:Object.entries(o).filter(([i])=>i!=="phone"&&i!=="name").reduce((i,[c,u])=>({...i,[c]:u}),{})}));return Rs(e,{accountId:s,templateId:r,recipients:n,variables:a})}function Yt(e,s=.1){return Math.floor(e*s)}function Jt(){const e=new Date,s=new Date(e.getFullYear(),e.getMonth()-1,1),r=s.getFullYear(),t=String(s.getMonth()+1).padStart(2,"0"),a=new Date(r,s.getMonth()+1,0).getDate();return{startDate:`${r}-${t}-01`,endDate:`${r}-${t}-${a}`}}async function zt(e,s,r){try{const t=await e.prepare(`
    ...
    `).bind(s,r.startDate,r.endDate).all();if(!a.results||a.results.length===0)return{seller_id:s,seller_name:t.business_name,total_sales:0,total_orders:0,platform_fee:0,shipping_fee:0,refund_amount:0,settlement_amount:0,orders:[]};const n=[];let o=0,i=0,c=0;for(const m of a.results){const E=m.total_amount-m.shipping_fee,f=Yt(E);n.push({order_id:m.id,order_number:m.order_number,order_date:m.created_at,product_name:m.product_names||"",quantity:m.total_quantity||1,price:E,shipping_fee:m.shipping_fee||0,platform_fee:f,status:m.status}),o+=E,i+=m.shipping_fee||0,c+=f}const u=await e.prepare(`
      SELECT COALESCE(SUM(total_amount), 0) as refund_amount
      FROM orders
      WHERE seller_id = ?
        AND DATE(created_at) BETWEEN ? AND ?
        AND status = 'refunded'
    `).bind(s,r.startDate,r.endDate).first(),l=(u==null?void 0:u.refund_amount)||0,p=o-c-l+i;return{seller_id:s,seller_name:t.business_name,total_sales:o,total_orders:n.length,platform_fee:c,shipping_fee:i,refund_amount:l,settlement_amount:p,orders:n}}catch(t){return console.error(`Failed to calculate settlement for seller ${s}:`,t),null}}async function Gt(e,s){console.log(`[Settlement] Generating report for ${s.startDate} ~ ${s.endDate}`);const r=await e.prepare(`
    SELECT DISTINCT s.id
    FROM sellers s
    JOIN orders o ON s.id = o.seller_id
    WHERE DATE(o.created_at) BETWEEN ? AND ?
      AND o.status IN ('delivered', 'confirmed', 'refunded')
  `).bind(s.startDate,s.endDate).all(),t=[];let a=0,n=0,o=0;for(const c of r.results){const u=await zt(e,c.id,s);u&&(t.push(u),a+=u.total_sales,n+=u.platform_fee,o+=u.settlement_amount)}const i={period:s,generated_at:new Date().toISOString(),total_sales:a,total_platform_fee:n,total_settlement:o,sellers:t};return console.log(`[Settlement] Report generated: ${t.length} sellers, ${a.toLocaleString()}원`),i}async function Xt(e,s){const t=(await e.prepare(`
  ...
  `).bind(s.period.startDate,s.period.endDate,s.total_sales,s.total_platform_fee,s.total_settlement,s.generated_at).run()).meta.last_row_id;for(const a of s.sellers)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a.seller_id,a.total_sales,a.total_orders,a.platform_fee,a.shipping_fee,a.refund_amount,a.settlement_amount).run();console.log(`[Settlement] Report saved: ID ${t}`)}async function Qt(e,s){const r=await e.prepare(`
...
`))}catch(o){console.error("[SSE] Update failed:",o)}},3e4)},cancel(){console.log(`[SSE] Client disconnected from stream ${e}`),t&&clearInterval(t)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function ea(e,s){const r=new TextEncoder;let t=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Chat] Client connected to stream ${e}`);try{const i=await s.DB.prepare(`
          SELECT 
            id,
            user_id,
            user_name,
...
`))}catch(i){console.error("[SSE Chat] Polling failed:",i)}},5e3)},cancel(){console.log(`[SSE Chat] Client disconnected from stream ${e}`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function sa(e,s){const r=new TextEncoder;let t=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Orders] Seller ${e} connected`);try{const i=await s.DB.prepare(`
...
`))}catch(i){console.error("[SSE Orders] Polling failed:",i)}},1e4)},cancel(){console.log(`[SSE Orders] Seller ${e} disconnected`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function ra(e,s){const r=new TextEncoder;let t;const a=new ReadableStream({async start(n){console.log(`[SSE Stock] Seller ${e} connected`),t=setInterval(async()=>{try{const o=await s.DB.prepare(`
            SELECT 
              id,
              name,
              stock,
  ...
  `).bind(s).run(),console.log(`[Push] Subscription deleted: ${s}`)}const ge=new Map;let V={hits:0,misses:0,writes:0,evictions:0};function ds(e){const s=ge.get(e);return s?s.expires<Date.now()?(ge.delete(e),V.evictions++,V.misses++,null):(V.hits++,s.data):(V.misses++,null)}function le(e,s,r){const t=Date.now()+r*1e3;if(ge.set(e,{data:s,expires:t}),V.writes++,ge.size>1e3){const a=ge.keys().next().value;a&&(ge.delete(a),V.evictions++)}}function na(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function oa(e){return{name:"tosspayments",async confirmPayment(s){try{const r=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),t=await r.json();if(!r.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message||"결제 승인 실패",rawData:t};let a={};t.card&&(a={cardCompany:t.card.company,cardNumber:t.card.number,installmentMonths:t.card.installmentPlanMonths||0});let n={};return t.virtualAccount&&(n={virtualAccountBank:t.virtualAccount.bankCode,virtualAccountNumber:t.virtualAccount.accountNumber,virtualAccountHolder:t.virtualAccount.customerName,virtualAccountDueDate:t.virtualAccount.dueDate}),{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,transactionId:t.transactionKey,...a,...n,rawData:t}}catch(r){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message,rawData:null}}},async cancelPayment(s){try{const r={cancelReason:s.cancelReason};s.cancelAmount&&(r.cancelAmount=s.cancelAmount);const t=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(r)}),a=await t.json();return t.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(r){return{success:!1,error:r.message}}},async getPayment(s){try{const r=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),t=await r.json();if(!r.ok)throw new Error(t.message);return{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,rawData:t}}catch(r){throw r}}}}function ia(e,s){switch(e.toLowerCase()){case"tosspayments":return oa(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const d=new or;d.use("/api/*",tt({encoding:"gzip",threshold:1024}));d.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{ot(e.env),it(e.env)}catch(t){console.error("[ENV] Validation failed:",t)}await s()});async function ae(e,s,r){if(!s)return null;const t=`session:${s}`;try{if(r){const c=r.get("user_session");if(c)return c}const a=ds(t);if(a)return r&&r.set("user_session",a),a;const n=await e.get(t);if(!n)return null;const o=JSON.parse(n);if(o.expires_at&&Date.now()>o.expires_at)return r!=null&&r.executionCtx?r.executionCtx.waitUntil(e.delete(t)):await e.delete(t),null;const i={user_id:o.user_id,user_type:o.user_type||"user",created_at:o.created_at};return le(t,i,60),r&&r.set("user_session",i),i}catch(a){return console.error("[Auth] Session lookup error:",a),null}}async function z(e,s){var n;const{SESSION_KV:r}=e.env;let t=e.req.header("X-Session-Token");if(t||(t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","")),!t){const o=e.req.header("Cookie");if(o){const i=o.match(/session=([^;]+)/);t=i?i[1]:void 0}}const a=await ae(r,t,e);if(!a)return e.json({success:!1,error:"인증이 필요합니다. 로그인 해주세요."},401);try{if(t&&a.created_at){const o=Date.now()-a.created_at,i=552*60*60*1e3;if(o>i){const c=`session:${t}`,u=await r.get(c);if(u){const l=JSON.parse(u),p=Date.now()+720*60*60*1e3,m=Date.now();e.executionCtx?e.executionCtx.waitUntil(r.put(c,JSON.stringify({...l,expires_at:p,created_at:m}),{expirationTtl:720*60*60}).then(()=>{le(c,{user_id:l.user_id,user_type:l.user_type||"user",created_at:m},60),console.log("[Auth] ✅ Session auto-renewed (23+ days old) for user:",a.user_id)})):(await r.put(c,JSON.stringify({...l,expires_at:p,created_at:m}),{expirationTtl:720*60*60}),le(c,{user_id:l.user_id,user_type:l.user_type||"user",created_at:m},60))}}}}catch(o){console.error("[Auth] Session renewal error:",o)}e.set("userId",a.user_id),e.set("userType",a.user_type),await s()}async function Is(e,s){try{const r=ds(s);if(r!==null)return r;const t=await e.get(s);if(t){const a=JSON.parse(t);return le(s,a,300),a}return null}catch(r){return console.error("[Cache] Read error:",r),null}}async function vs(e,s,r,t=60){try{le(s,r,t),await e.put(s,JSON.stringify(r),{expirationTtl:t})}catch(a){console.error("[Cache] Write error:",a)}}async function Os(e,...s){try{await Promise.all(s.map(r=>e.delete(r)))}catch(r){console.error("[Cache] Delete error:",r)}}async function ss(e,s,r,t,a,n,o){try{await e.prepare(`
    ...
    `).bind(s,r,t,a,n,o||null).run(),console.log(`[Notification] Created for ${r} ${s}: ${a}`)}catch(i){console.error("[Notification] Create error:",i)}}async function ca(e,s,r,t,a){await ss(e,s,"seller","new_order","🛒 신규 주문이 접수되었습니다",`${t}님의 주문 (${r}) - ${la(a)}`,"/seller/orders")}async function dr(e,s,r,t,a,n){let o="",i="";switch(t){case"preparing":o="📦 상품 준비 중",i=`주문번호 ${r}의 상품을 준비하고 있습니다`;break;case"shipping":o="🚚 배송이 시작되었습니다",i=`주문번호 ${r}가 배송 중입니다`,a&&n&&(i+=` (${a}: ${n})`);break;case"delivered":o="✅ 배송 완료",i=`주문번호 ${r}가 배송 완료되었습니다`;break;default:return}await ss(e,s,"user","shipping_status",o,i,"/my-orders")}async function ua(e,s,r,t,a){await ss(e,s,"seller","low_stock","⚠️ 재고 부족 알림",`${r}의 재고가 ${t}개로 부족합니다 (기준: ${a}개)`,"/seller/products")}function la(e){return new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW"}).format(e)}async function da(e,s,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const t=await fetch("https://www.googleapis.com/youtube/v3/liveBroadcasts?part=snippet,status,contentDetails",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:s,description:r,scheduledStartTime:new Date().toISOString()},status:{privacyStatus:"public",selfDeclaredMadeForKids:!1},contentDetails:{enableAutoStart:!0,enableAutoStop:!0}})});if(!t.ok){const p=await t.text();throw new Error(`YouTube Broadcast 생성 실패: ${p}`)}const n=(await t.json()).id,o=await fetch("https://www.googleapis.com/youtube/v3/liveStreams?part=snippet,cdn",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:`${s} - Stream`},cdn:{frameRate:"variable",ingestionType:"rtmp",resolution:"variable"}})});if(!o.ok){const p=await o.text();throw new Error(`YouTube Stream 생성 실패: ${p}`)}const i=await o.json(),c=i.id,u=i.cdn.ingestionInfo.streamName,l=i.cdn.ingestionInfo.ingestionAddress;return await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/bind?id=${n}&streamId=${c}&part=snippet`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}}),{broadcastId:n,streamId:c,streamKey:u,streamUrl:l}}catch(t){throw console.error("[YouTube API] Live broadcast creation failed:",t),t}}async function pa(e,s){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const r=await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/transition?broadcastStatus=complete&id=${s}&part=status`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}});if(!r.ok){const t=await r.text();throw new Error(`YouTube 방송 종료 실패: ${t}`)}}catch(r){throw console.error("[YouTube API] Live broadcast end failed:",r),r}}async function ma(e,s,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{let t=`https://www.googleapis.com/youtube/v3/liveChat/messages?liveChatId=${s}&part=snippet,authorDetails`;r&&(t+=`&pageToken=${r}`);const a=await fetch(t,{headers:{Authorization:`Bearer ${e.accessToken}`}});if(!a.ok){const o=await a.text();throw new Error(`YouTube 채팅 메시지 가져오기 실패: ${o}`)}const n=await a.json();return{messages:n.items||[],nextPageToken:n.nextPageToken,pollingIntervalMillis:n.pollingIntervalMillis||5e3}}catch(t){throw console.error("[YouTube API] Get chat messages failed:",t),t}}async function _a(e,s){if(!e.apiKey&&!e.accessToken)throw new Error("YouTube API Key 또는 Access Token이 필요합니다");try{const r=e.accessToken?{Authorization:`Bearer ${e.accessToken}`}:{},t=e.accessToken?`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}`:`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}&key=${e.apiKey}`,a=await fetch(t,{headers:r});if(!a.ok){const u=await a.text();throw new Error(`YouTube 통계 가져오기 실패: ${u}`)}const n=await a.json();if(!n.items||n.items.length===0)throw new Error("Video not found");const o=n.items[0],i=o.statistics,c=o.liveStreamingDetails;return{viewCount:parseInt(i.viewCount||"0"),likeCount:parseInt(i.likeCount||"0"),commentCount:parseInt(i.commentCount||"0"),concurrentViewers:c!=null&&c.concurrentViewers?parseInt(c.concurrentViewers):void 0}}catch(r){throw console.error("[YouTube API] Get live stats failed:",r),r}}function pr(e){try{if(!/^https?:\/\//.test(e)&&/^[\w-]{11}$/.test(e))return e;const s=new URL(e);if(s.hostname.includes("youtube.com")){const r=s.searchParams.get("v");if(r)return r;const t=s.pathname.match(/\/(embed|live|shorts)\/([a-zA-Z0-9_-]{11})/);if(t)return t[2]}if(s.hostname==="youtu.be"){const r=s.pathname.slice(1).split("?")[0];if(r&&r.length===11)return r}return null}catch{return null}}function mr(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const r=s.pathname.match(/\/video\/(\d+)/);if(r)return r[1];const t=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(t)return t[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}function fa(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){if(s.pathname.includes("/live"))return"live";if(s.pathname.includes("/video/"))return"video"}return null}catch{return null}}function _r(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const r=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(r)return r[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}d.use("*",async(e,s)=>{await s(),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://t1.kakaocdn.net https://developers.kakao.com https://js.tosspayments.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net; img-src 'self' data: https: blob:; font-src 'self' data: https://cdn.jsdelivr.net; connect-src 'self' https://api.tosspayments.com https://kauth.kakao.com https://kapi.kakao.com https://www.youtube.com; frame-src 'self' https://www.youtube.com https://youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';");const r=new URL(e.req.url);r.hostname!=="localhost"&&r.protocol==="https:"&&e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("X-Frame-Options","SAMEORIGIN"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});d.use("/api/*",b());d.use(Ze(es.auth));d.use(Ze(es.alimtalk));d.use(Ze(es.order));d.use(Ze(es.upload));d.use("/api/*",Ze(es.api));d.use("/api/*",async(e,s)=>{const r=Date.now(),t=e.req.method,a=e.req.path;await s();const n=Date.now()-r,o=e.res.status,i={method:t,path:a,status:o,duration:n},c=e.get("userId");c&&(i.userId=c),na(i)});d.use("/static/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});d.use("/images/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});async function fr(e,s,r,t){const a=crypto.randomUUID(),n=Date.now()+720*60*60*1e3,o={user_id:s,user_type:r,userData:t,expires_at:n,created_at:Date.now()};return await e.put(`session:${a}`,JSON.stringify(o),{expirationTtl:720*60*60}),console.log(`[createSession] ✅ Session created for ${r} user ${s}`),a}async function He(e,s){const r=await e.get(`session:${s}`);if(!r)return null;const t=JSON.parse(r);return t.expires_at&&Date.now()>t.expires_at?(await e.delete(`session:${s}`),null):{session_token:s,[`${t.user_type}_id`]:t.user_id,user_type:t.user_type,...t.userData}}d.post("/api/auth/user/register",b(),vt(kt),async e=>{const{DB:s}=e.env;try{const{email:r,password:t,name:a,phone:n}=e.get("validatedData"),o=`placeholder_hash_for_${t}`;try{const c=(await s.prepare(`
      ...
      `).bind(c,r,u,a,n,o||null,i||null).run();return e.json({success:!0,data:{sellerId:l.meta.last_row_id,message:"회원가입이 완료되었습니다. 관리자 승인 후 로그인할 수 있습니다."}})}catch(l){const p=l.message||"";if(p.includes("UNIQUE")||p.includes("unique"))return e.json({success:!1,error:"이미 가입된 이메일입니다"},400);throw l}}catch(r){return console.error("Seller registration error:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/admin/login",b(),async e=>{const{DB:s}=e.env;try{const{email:r,password:t}=await e.req.json();if(!r||!t)return e.json({success:!1,error:"이메일과 비밀번호를 입력해주세요"},400);const a=await s.prepare("SELECT * FROM admins WHERE email = ?").bind(r).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(r==="admin@example.com"&&t==="admin123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${t}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);const i=await fr(e.env.SESSION_KV,a.id,"admin",{username:a.username,email:a.email,name:a.name,role:a.role});return await s.prepare('UPDATE admins SET last_login_at = datetime("now") WHERE id = ?').bind(a.id).run(),e.json({success:!0,data:{token:i,admin:{id:a.id,username:a.username,email:a.email,name:a.name,role:a.role}}})}catch(r){return console.error("Admin login error:",r),e.json({success:!1,error:r.message},500)}});d.get("/api/auth/verify",b(),async e=>{const{DB:s}=e.env;try{const r=e.req.header("X-Session-Token");if(!r)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const t=await He(e.env.SESSION_KV,r);if(!t)return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=t.user_type==="admin"?"admins":"sellers",n=t.user_type==="admin"?t.admin_id:t.seller_id,o=await s.prepare(`SELECT * FROM ${a} WHERE id = ?`).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:t.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name,role:o.role}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/auth/kakao/sync/callback",async e=>{var r,t,a,n,o,i,c,u,l,p,m,E,f;const{DB:s}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!s);const h=e.req.query("code"),g=e.req.query("state")||"/",w=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!h,state:g,error:w}),w)return console.error("[Kakao Sync] OAuth error:",w),e.redirect(`${g}?error=kakao_oauth_${w}`);if(!h)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${g}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const y=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",A=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",y.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",A),console.log("[Kakao Sync] Step 1: Fetching access token...");const O=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:y,redirect_uri:A,code:h})});if(console.log("[Kakao Sync] Token response status:",O.status),console.log("[Kakao Sync] Token request details:",{client_id:y,redirect_uri:A,code_length:h.length,code_prefix:h.substring(0,20)}),!O.ok){const H=await O.text();return console.error("[Kakao Sync] Token request failed:",H),e.redirect(`${g}?error=token_request_failed&detail=${encodeURIComponent(H)}`)}const C=await O.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!C.access_token,error:C.error,errorDescription:C.error_description}),!C.access_token)return console.error("[Kakao Sync] Token error:",C),e.redirect(`${g}?error=token_failed&detail=${encodeURIComponent(C.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const U=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${C.access_token}`}});console.log("[Kakao Sync] User response status:",U.status);const k=await U.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!k.id,id:k.id,hasNickname:!!((r=k.properties)!=null&&r.nickname||(a=(t=k.kakao_account)==null?void 0:t.profile)!=null&&a.nickname)}),!k.id)return console.error("[Kakao Sync] Failed to get user info:",k),e.redirect(`${g}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const D=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${C.access_token}`}});console.log("[Kakao Sync] Terms response status:",D.status);let L=null;if(D.ok?(L=await D.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=L.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=L.allowed_service_terms)==null?void 0:o.map(H=>H.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!s)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${g}?error=db_not_available`);const $=k.id.toString(),j=((i=k.properties)==null?void 0:i.nickname)||((u=(c=k.kakao_account)==null?void 0:c.profile)==null?void 0:u.nickname)||"Kakao User",P=((l=k.kakao_account)==null?void 0:l.email)||"",K=((p=k.properties)==null?void 0:p.profile_image)||((E=(m=k.kakao_account)==null?void 0:m.profile)==null?void 0:E.profile_image_url)||"",X=C.access_token,R=((f=L==null?void 0:L.allowed_service_terms)==null?void 0:f.map(H=>H.tag))||[],ye=JSON.stringify(R);console.log("[Kakao Sync] User data:",{kakaoId:$,nickname:j,email:P?"exists":"none",serviceTerms:R});try{const H=await s.prepare("SELECT * FROM users WHERE kakao_id = ?").bind($).first();console.log("[Kakao Sync] Existing user check:",!!H);let q;H?(q=H.id,await s.prepare(`
          ...
          WHERE id = ?
        `).bind(j,P,K,q).run(),console.log("[Kakao Sync] Updated user:",q)):(q=(await s.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
        ...
        `).bind($,j,P||null,K||null).run()).meta.last_row_id,console.log("[Kakao Sync] Created user:",q)),console.log("[Kakao Sync] User saved successfully, userId:",q),console.log("[Kakao Sync] Step 4: Creating session...");const{SESSION_KV:pe}=e.env,ne=crypto.randomUUID(),Ds=Date.now()+720*60*60*1e3;await pe.put(`session:${ne}`,JSON.stringify({user_id:q,user_type:"user",expires_at:Ds,created_at:Date.now()}),{expirationTtl:720*60*60}),console.log("[Kakao Sync] Session created successfully in SESSION_KV"),console.log("[Kakao Sync] Step 5: Redirecting...");const xe=g.includes("?")?`${g}&login=success&session=${ne}&userId=${q}&userName=${encodeURIComponent(j)}`:`${g}?login=success&session=${ne}&userId=${q}&userName=${encodeURIComponent(j)}`;return console.log("[Kakao Sync] Redirect URL:",xe),e.redirect(xe)}catch(H){return console.error("[Kakao Sync] Database error:",H),console.error("[Kakao Sync] DB error details:",{message:H.message,name:H.name}),e.redirect(`${g}?error=database_error&detail=${encodeURIComponent(H.message)}`)}}catch(h){console.error("[Kakao Sync] Exception:",h),console.error("[Kakao Sync] Error details:",{message:h.message,stack:h.stack,name:h.name});const g=e.req.query("state")||"/",w=encodeURIComponent(h.message||"unknown");return e.redirect(`${g}?error=kakao_sync_failed&detail=${w}`)}});d.post("/api/auth/kakao/callback",b(),async e=>{const{DB:s}=e.env;try{const{code:r,redirect_uri:t}=await e.req.json();if(!r)return e.json({success:!1,error:"Authorization code is required"},400);if(!e.env.KAKAO_REST_API_KEY)return console.error("[Kakao Callback] KAKAO_REST_API_KEY not configured"),e.json({success:!1,error:"Server configuration error",code:"MISSING_API_KEY"},500);const a=t||"https://live.ur-team.com/auth/kakao/callback";console.log("[Kakao Callback] Starting OAuth flow");const n=await wt(r,a,e.env.KAKAO_REST_API_KEY),{user:o,sessionToken:i}=await cr(s,n),c=Date.now()+720*60*60*1e3;return await e.env.SESSION_KV.put(`session:${i}`,JSON.stringify({user_id:o.id,user_type:"user",expires_at:c}),{expirationTtl:720*60*60}),console.log("[Kakao Callback] ✅ Session saved to SESSION_KV for user:",o.id,"- Expires:",new Date(c).toISOString()),e.json({success:!0,data:{session_token:i,user:{id:o.id,name:o.name,email:o.email,profile_image:o.profile_image}}})}catch(r){return console.error("[Kakao Callback] Error:",r),r instanceof Z?e.json({success:!1,error:r.message,code:r.code},r.statusCode):e.json({success:!1,error:r.message||"Internal server error",code:"UNKNOWN_ERROR"},500)}});d.post("/api/auth/kakao/sync",b(),async e=>{const{DB:s}=e.env;try{const{accessToken:r}=await e.req.json();if(!r)return e.json({success:!1,error:"Access token is required"},400);console.log("[Kakao Sync] Verifying access token");const t=Date.now(),{user:a,sessionToken:n}=await cr(s,r);console.log("[Kakao Sync] ProcessKakaoLogin completed in",Date.now()-t,"ms");const o=Date.now()+720*60*60*1e3,i=Date.now();return await e.env.SESSION_KV.put(`session:${n}`,JSON.stringify({user_id:a.id,user_type:"user",expires_at:o}),{expirationTtl:720*60*60}),console.log("[Kakao Sync] ✅ Session saved to SESSION_KV in",Date.now()-i,"ms"),console.log("[Kakao Sync] Total login time:",Date.now()-t,"ms"),e.json({success:!0,data:{session_token:n,user:{id:a.id,name:a.name,email:a.email,profile_image:a.profile_image}}})}catch(r){return console.error("[Kakao Sync] Error:",r),r instanceof Z?e.json({success:!1,error:r.message,code:r.code},r.statusCode):e.json({success:!1,error:r instanceof Error?r.message:"Login failed",code:"UNKNOWN_ERROR"},500)}});d.get("/api/auth/validate",b(),async e=>{var r;const{SESSION_KV:s}=e.env;try{const t=e.req.header("X-Session-Token")||((r=e.req.header("Authorization"))==null?void 0:r.replace("Bearer ",""))||"";if(!t)return e.json({success:!1,error:"No session token provided",code:"NO_TOKEN"},401);const a=await ae(s,t);return a?e.json({success:!0,data:{user_id:a.user_id,user_type:a.user_type,session_valid:!0}}):e.json({success:!1,error:"Session expired or invalid",code:"SESSION_EXPIRED"},401)}catch(t){return console.error("[Auth Validate] Error:",t),e.json({success:!1,error:"Validation failed",code:"VALIDATION_ERROR"},500)}});d.post("/api/auth/kakao/logout",b(),async e=>{const{DB:s}=e.env;try{const r=e.req.header("X-Session-Token")||"";return r&&(await s.prepare("DELETE FROM admin_sessions WHERE session_token = ?").bind(r).run(),console.log("[Kakao Sync] Session deleted")),e.json({success:!0})}catch(r){return console.error("[Kakao Sync] Logout error:",r),e.json({success:!1,error:"Logout failed"},500)}});d.post("/api/auth/kakao/unlink",b(),async e=>{const{DB:s}=e.env;try{const r=e.req.header("X-Session-Token");if(!r)return e.json({success:!1,error:"인증이 필요합니다"},401);if(console.log("[Kakao Unlink] Starting unlink process..."),!await s.prepare(`
    ...
    `).bind(r,t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});async function M(e){const s=e.req.header("X-Session-Token");if(!s)return{success:!1,error:"인증 토큰이 없습니다"};const r=await He(e.env.SESSION_KV,s);return!r||r.user_type!=="admin"?{success:!1,error:"관리자 권한이 필요합니다"}:{success:!0,adminId:r.admin_id,userData:r}}async function v(e){const s=e.req.header("X-Session-Token");if(!s)return{success:!1,error:"인증 토큰이 없습니다"};const r=await He(e.env.SESSION_KV,s);return!r||r.user_type!=="seller"?{success:!1,error:"판매자 권한이 필요합니다"}:{success:!0,sellerId:r.seller_id,userData:r}}d.get("/api/health",e=>e.json({success:!0,status:"healthy",timestamp:new Date().toISOString(),env:{hasDB:!!e.env.DB,hasSessionKV:!!e.env.SESSION_KV,hasCacheKV:!!e.env.CACHE_KV}}));d.get("/api/test/env",async e=>{try{const s=await lt(e.env);return e.json(s)}catch(s){return e.json({success:!1,error:"환경 변수 테스트 실행 중 오류 발생",details:s instanceof Error?s.message:String(s)},500)}});d.get("/api/streams",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t="streams:live",a=await r.get(t,"json");if(a)return e.json({success:!0,data:a,cached:!0});const n=await s.prepare("SELECT * FROM live_streams WHERE status = ? ORDER BY created_at DESC").bind("live").all();return await r.put(t,JSON.stringify(n.results),{expirationTtl:600}),e.json({success:!0,data:n.results})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/streams/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=await s.prepare(`
      SELECT ls.*, 
      ...
      WHERE ls.id = ?
    `).bind(r).first();return t?e.json({success:!0,data:t}):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/live-streams",async e=>{const{DB:s}=e.env,{status:r,seller_id:t,limit:a="20",offset:n="0"}=e.req.query();try{const o=`live_streams:${r||"all"}:${t||"all"}:${a}:${n}`,i=60,c=ds(o);if(c)return console.log("[LiveStreams] ⚡ 메모리 캐시 히트:",o),e.executionCtx.waitUntil((async()=>{try{console.log("[LiveStreams] 🔄 백그라운드 갱신 시작:",o);const l=await Us(s,r,t,a,n);le(o,l,i),console.log("[LiveStreams] ✅ 백그라운드 갱신 완료:",o)}catch(l){console.error("[LiveStreams] ❌ 백그라운드 갱신 실패:",l)}})()),e.json({success:!0,data:c});console.log("[LiveStreams] 💾 DB 조회:",o);const u=await Us(s,r,t,a,n);return le(o,u,i),e.json({success:!0,data:u})}catch(o){return console.error("[API] Live streams list error:",o),e.json({success:!1,error:`라이브 스트림 목록 조회 실패: ${o.message}`},500)}});async function Us(e,s,r,t,a){let n=`
    SELECT ls.*, 
           s.display_name as seller_name
    FROM live_streams ls
    LEFT JOIN sellers s ON ls.seller_id = s.id
    WHERE 1=1
  `;const o=[];s&&(n+=" AND ls.status = ?",o.push(s)),r&&(n+=" AND ls.seller_id = ?",o.push(r)),n+=' ORDER BY CASE ls.status WHEN "active" THEN 1 WHEN "scheduled" THEN 2 ELSE 3 END, ls.created_at DESC',n+=" LIMIT ? OFFSET ?",o.push(parseInt(t),parseInt(a));const{results:i}=await e.prepare(n).bind(...o).all();return i}d.get("/api/live-streams/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=`live_stream:${r}`,a=30,n=ds(t);if(n)return console.log("[LiveStream] ⚡ 메모리 캐시 히트:",t),e.executionCtx.waitUntil((async()=>{try{console.log("[LiveStream] 🔄 백그라운드 갱신 시작:",t);const i=await $s(s,r);i&&(le(t,i,a),console.log("[LiveStream] ✅ 백그라운드 갱신 완료:",t))}catch(i){console.error("[LiveStream] ❌ 백그라운드 갱신 실패:",i)}})()),e.json({success:!0,data:n});console.log("[LiveStream] 💾 DB 조회:",t);const o=await $s(s,r);return o?(le(t,o,a),e.json({success:!0,data:o})):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});async function $s(e,s){return await e.prepare(`
    SELECT ls.*, 
           p.id as current_product_id, p.name as product_name, p.price, p.original_price, 
           p.discount_rate, p.image_url, p.stock, p.category, p.description as product_description
    FROM live_streams ls
    LEFT JOIN products p ON ls.current_product_id = p.id
    WHERE ls.id = ?
  `).bind(s).first()}d.get("/api/products",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.query("featured"),a=parseInt(e.req.query("limit")||"20"),n=parseInt(e.req.query("offset")||"0"),o=`products:list:${t||"all"}:${a}:${n}`,i=await Is(r,o);if(i)return e.json({success:!0,data:i,cached:!0});let c;t==="true"?c=`
        SELECT 
          p.id,
          p.name,
          p.description,
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/cart",z,async e=>{const{DB:s}=e.env,r=e.get("userId");try{const t=await s.prepare(`
      SELECT 
        ci.*,
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:`장바구니 조회 실패: ${t.message}`},500)}});d.get("/api/cart/:userId",z,async e=>{const{DB:s}=e.env,r=e.get("userId"),t=e.req.param("userId");try{let a=await s.prepare("SELECT id FROM users WHERE id = ?").bind(r).first();if(!a)return e.json({success:!1,error:"사용자를 찾을 수 없습니다."},404);const n=a.id;if(t!==String(n))return e.json({success:!1,error:"본인의 장바구니만 조회할 수 있습니다."},403);const o=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
        p.image_url as image_url,
    ...
    `).bind(m,n,o||null,o||null).first();let h;if(f){const g=f.quantity+i;await s.prepare(`
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id = ?
    `).bind(r).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await s.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,r).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});d.post("/api/orders",async e=>{const{DB:s}=e.env;try{const r=await e.req.json(),{userId:t,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:u,recipientPhone:l,deliveryMemo:p,totalAmount:m,shippingFee:E,orderNumber:f,paymentKey:h,paymentMethod:g}=r;if(o&&o.length>0){const D=o.map(x=>x.productId),L=D.map(()=>"?").join(","),$=await s.prepare(`
        SELECT id, name, price, stock 
        FROM products 
        WHERE id IN (${L})
      `).bind(...D).all(),j=new Map($.results.map(x=>[x.id,x])),P=[];for(const x of o){const De=j.get(x.productId);if(!De)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${x.productId})`},400);if(De.stock<x.quantity)return e.json({success:!1,error:`재고 부족: ${De.name} (남은 재고: ${De.stock}개)`},400);P.push({product_id:x.productId,option_id:x.optionId||null,quantity:x.quantity,price:x.price,product_name:De.name,product_stock:De.stock})}const K=new Date,X=K.getFullYear().toString().slice(-2),R=(K.getMonth()+1).toString().padStart(2,"0"),ye=K.getDate().toString().padStart(2,"0"),H=`${X}${R}${ye}`,q=Math.random().toString(36).substring(2,7).toUpperCase(),pe=f||`ORD-${H}-${q}`,ne=c?`${i} ${c}`:i,xe=(await s.prepare(`
        INSERT INTO orders (
      ...
      `).bind(pe,t||null,m||0,"pending","pending",ne||null,u||null,l||null,p||null,h||null).run()).meta.last_row_id;for(const x of P)await s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(xe,x.product_id,x.option_id,x.quantity,x.price,x.product_name).run();return e.json({success:!0,data:{orderId:xe,orderNumber:pe,totalAmount:m}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const w=a.map(()=>"?").join(","),y=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${w})
    `).bind(...a).all();if(y.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const D of y.results)if(D.product_stock<D.quantity)return e.json({success:!1,error:`Insufficient stock for ${D.product_name}`},400);const A=y.results.reduce((D,L)=>D+L.price_snapshot*L.quantity,0),O=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,U=(await s.prepare(`
      INSERT INTO orders (
        order_number, user_id, total_amount,
        shipping_address, shipping_name, shipping_phone
      ) VALUES (?, ?, ?, ?, ?, ?)
    `).bind(O,t,A,n.address,n.name,n.phone).run()).meta.last_row_id,k=[];for(const D of y.results){let L=!1,$="";for(let j=0;j<3;j++){if((await s.prepare(`
          UPDATE products 
          SET stock = stock - ?, 
              version = version + 1,
              updated_at = datetime('now')
        ...
        `).bind(D.product_id).first();if(!K||K.stock<D.quantity){$=`재고 부족: ${D.product_name} (남은 재고: ${(K==null?void 0:K.stock)||0}개)`;break}j<2?await new Promise(X=>setTimeout(X,50*j)):$="주문 처리 중 오류 발생. 다시 시도해주세요. (동시성 충돌)"}if(!L)return e.json({success:!1,error:$||"주문 처리 중 오류가 발생했습니다."},$.includes("재고 부족")?400:409);k.push(s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(U,D.product_id,D.option_id,D.quantity,D.price_snapshot,D.product_name))}k.push(s.prepare(`DELETE FROM cart_items WHERE id IN (${w})`).bind(...a)),await s.batch(k);try{const D=y.results.map(j=>j.product_id),L=D.map(()=>"?").join(","),$=await s.prepare(`
        SELECT DISTINCT seller_id 
        FROM products 
        WHERE id IN (${L}) AND seller_id IS NOT NULL
      `).bind(...D).all();for(const j of $.results){const P=j.seller_id;await ca(s,P,O,buyerName||shippingName||"고객",A)}}catch(D){console.error("[Order] Notification error:",D)}return e.json({success:!0,data:{orderId:U,orderNumber:O,totalAmount:A}})}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/api/streams/:streamId/current-product",async e=>{const{DB:s,LIVE_CACHE:r}=e.env,t=e.req.param("streamId");try{const a=`current-product:${t}`,n=await ur(r,a,3);if(n)return e.json({success:!0,data:n});const o=await s.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(t).first();if(!o||!o.current_product_id)return await is(r,a,null,3),e.json({success:!0,data:null});const i=await s.prepare("SELECT * FROM products WHERE id = ?").bind(o.current_product_id).first(),c=await s.prepare("SELECT * FROM product_options WHERE product_id = ?").bind(o.current_product_id).all(),u={product:i,options:c.results};return await is(r,a,u,3),e.json({success:!0,data:u})}catch(a){return e.json({success:!1,error:a.message},500)}});d.get("/api/streams/:streamId/product-wait",async e=>{const{LIVE_CACHE:s}=e.env,r=e.req.param("streamId"),t=e.req.query("lastTimestamp")||"0";try{const a=`product-timestamp:${r}`,n=`current-product:${r}`,o=25e3,i=Date.now();for(;Date.now()-i<o;){const c=await s.get(a)||"0";if(c!==t){const u=await ur(s,n,30);return e.json({success:!0,timestamp:c,data:u,changed:!0})}await new Promise(u=>setTimeout(u,1e3))}return e.json({success:!0,timestamp:t,data:null,changed:!1})}catch(a){return e.json({success:!1,error:a.message},500)}});d.get("/api/seller/dashboard/stats",async e=>{const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=r.sellerId,a=e.req.query("period")||"7d";let n=7;a==="30d"?n=30:a==="90d"&&(n=90);const o=await s.prepare(`
      SELECT 
    ...
    `).all();return e.json({success:!0,data:t.results||[]})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/orders",z,async e=>{const{DB:s}=e.env,r=e.get("userId");try{const t=await s.prepare(`
      SELECT 
        o.*,
        oi.id as item_id,
        oi.product_id,
...
`),E=new Date,f=`orders_${E.toISOString().split("T")[0]}_${E.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(t){return console.error("Export error:",t),e.json({success:!1,error:t.message},500)}});d.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(t).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,r.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,t).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${t}, 자동 발행 시작...`);const c=await s.prepare(`
        ...
        `).bind(t).first();if(c!=null&&c.buyer_business_number&&(c!=null&&c.buyer_business_name)){console.log(`[AUTO TAX INVOICE] 사업자 구매 확인: ${c.buyer_business_number}`);const u=await s.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(r.sellerId).first();if(!u)console.warn(`[AUTO TAX INVOICE] 판매자 사업자 정보 미승인: seller_id=${r.sellerId}`),await s.prepare(`
            ...
            `).bind(r.sellerId,t,g,u.business_number,u.business_name,u.ceo_name,u.address||"",u.business_type||"",u.business_category||"",u.email||"",u.phone||"",c.buyer_business_number,c.buyer_business_name,c.buyer_ceo_name||"",c.buyer_business_address||"",c.buyer_business_type||"",c.buyer_business_category||"",c.buyer_email||"",c.buyer_phone||"",m,E,p,`AUTO-${Date.now()}-${h}`).run()).meta.last_row_id;if(l.results.length>0){const A=l.results.map(O=>{const C=Math.floor(Number(O.price)*Number(O.quantity)/1.1),U=Number(O.price)*Number(O.quantity)-C;return s.prepare(`
                  INSERT INTO tax_invoice_items (
                    tax_invoice_id, product_name, quantity, unit_price,
                    supply_price, tax_amount, description, created_at
                  ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
                `).bind(y,O.product_name||"상품명 없음",O.quantity,O.price,C,U,O.option_name||"")});await s.batch(A)}await s.prepare(`
    ...
    `).all();return e.json({success:!0,data:t.results,count:t.results.length})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/public/seller/:sellerId",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.param("sellerId"),a=`public:seller:${t}`,n=await Is(r,a);if(n)return e.json({success:!0,data:n,cached:!0});const o=await s.prepare(`
      SELECT 
    ...
    `).bind(t).all(),l=await s.prepare(`
      ...
      WHERE s.id = ?
    `).bind(t).first(),p={profile:o,live_streams:i.results,scheduled_streams:c.results,products:u.results,stats:l};return await vs(r,a,p,60),e.json({success:!0,data:p})}catch(t){return console.error("셀러 프로필 조회 실패:",t),e.json({success:!1,error:t.message},500)}});d.get("/api/public/seller/username/:username",async e=>{const{DB:s}=e.env;try{const r=e.req.param("username"),t=await s.prepare(`
...
`});const E="\uFEFF";return new Response(E+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(t){return console.error("CSV 내보내기 실패:",t),e.json({success:!1,error:t.message},500)}});d.post("/api/orders/create",async e=>{const{DB:s}=e.env;try{const{userId:r,cartItems:t,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:u,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:r,cartItems:t==null?void 0:t.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let p=10;if(o){const R=await s.prepare(`
      ...
      `).bind(n,r).first();if(!R)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);f=R}if(!r)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const h=r,g=new Date,w=g.getFullYear().toString().slice(-2),y=(g.getMonth()+1).toString().padStart(2,"0"),A=g.getDate().toString().padStart(2,"0"),O=`${w}${y}${A}`,C=Math.random().toString(36).substring(2,7).toUpperCase(),U=`ORD-${O}-${C}`,k=t.map(R=>R.product_id),D=k.map(()=>"?").join(","),L=await s.prepare(`
      SELECT id, stock FROM products WHERE id IN (${D})
    `).bind(...k).all(),$=new Map(L.results.map(R=>[R.id,R.stock]));for(const R of t){const ye=$.get(R.product_id);if(ye===void 0)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${R.product_id})`},400);if(ye<R.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${R.product_id})`},400)}const P=(await s.prepare(`
      INSERT INTO orders (
    ...
    `).bind(U,h,a,"pending",o||null,p,m,E,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,u||null,l||null).run()).meta.last_row_id,K=t.map(R=>s.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?)
      `).bind(P,R.product_id,R.option_id||null,R.quantity,R.price_snapshot||R.price)),X=t.map(R=>s.prepare(`
        UPDATE products SET stock = stock - ? WHERE id = ?
      `).bind(R.quantity,R.product_id));await s.batch([...K,...X]);try{const R=t.map(q=>q.product_id),ye=R.map(()=>"?").join(","),H=await s.prepare(`
        SELECT id, name, stock, stock_alert_threshold, seller_id 
        FROM products 
        WHERE id IN (${ye})
      `).bind(...R).all();for(const q of H.results){const pe=q.stock_alert_threshold||5,ne=q.stock;ne<=pe&&q.seller_id&&(await ua(s,q.seller_id,q.name,ne,pe),console.log(`[Low Stock Alert] ${q.name}: ${ne} <= ${pe}`))}}catch(R){console.error("[Low Stock Alert] Error:",R)}return console.log("주문 생성 완료:",{orderId:P,orderNumber:U}),e.json({success:!0,orderId:P,orderNumber:U,totalAmount:a})}catch(r){return console.error("주문 생성 실패:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/orders/:orderNumber/refund",b(),async e=>{const{DB:s}=e.env;try{const r=e.req.param("orderNumber"),{reason:t}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:r,reason:t});const a=await s.prepare(`
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_number:t}=await e.req.json();if(!t)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(r.sellerId,t,"tax",p,l,n.business_number,n.business_name,n.ceo_name,n.address,n.business_type,n.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,c,u,i,f==="FAILED"?"failed":"issued",We()?"mock":"barobill",h,f).run()).meta.last_row_id;for(const y of o.results){const A=Math.floor(Number(y.price)*Number(y.quantity)/1.1),O=Number(y.price)*Number(y.quantity)-A;await s.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, order_item_id, product_name, quantity,
          unit_price, supply_price, tax_amount, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
      `).bind(w,y.id,y.product_name,y.quantity,y.price,A,O).run()}return e.json({success:!0,data:{invoice_id:w,invoice_number:p,issue_date:l,total_amount:i,supply_price:c,tax_amount:u,status:f==="FAILED"?"failed":"issued",nts_confirm_number:f,api_invoice_key:h,mock_mode:We(),message:f==="FAILED"?"바로빌 API 호출 실패. 나중에 다시 시도해주세요.":We()?"세금계산서가 발행되었습니다. (Mock Mode - 실제 발행 아님)":"세금계산서가 발행되었습니다."}})}catch(t){return console.error("세금계산서 발행 오류:",t),e.json({success:!1,error:t.message},500)}});d.get("/api/seller/tax-invoices",async e=>{var t;const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{start_date:a,end_date:n,status:o}=e.req.query();let i=`
    ...
    `).bind(t).all();return e.json({success:!0,data:{...a,items:n.results||[]}})}catch(t){return e.json({success:!1,error:t.message},500)}});d.post("/api/seller/tax-invoices/:id/cancel",async e=>{const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id"),{reason:a}=await e.req.json(),n=await s.prepare(`
      SELECT * FROM tax_invoices WHERE id = ? AND seller_id = ?
    `).bind(t,r.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!We()){const u=await s.prepare(`
          SELECT business_number FROM seller_business_info WHERE seller_id = ?
        `).bind(r.sellerId).first();u&&u.business_number&&await mt(u.business_number,n.api_invoice_key,a||"판매자 요청")}}catch(u){console.error("바로빌 취소 API 호출 실패:",u)}return await s.prepare(`
      UPDATE tax_invoices
    ...
    `).bind(r.sellerId,t,f,i.business_number,i.business_name,i.ceo_name,i.address||"",i.business_type||"",i.business_category||"",i.email||"",i.phone||"",o.buyer_business_number,o.buyer_business_name,o.buyer_ceo_name||"",o.buyer_business_address||"",o.buyer_business_type||"",o.buyer_business_category||"",o.buyer_email||"",o.buyer_phone||"",l,p,u,`RETRY-${Date.now()}-${E}`).run()).meta.last_row_id;for(const w of c.results){const y=Math.floor(Number(w.price)*Number(w.quantity)/1.1),A=Number(w.price)*Number(w.quantity)-y;await s.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, product_name, quantity, unit_price,
          supply_price, tax_amount, description, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
      `).bind(g,w.product_name||"상품명 없음",w.quantity,w.price,y,A,w.option_name||"").run()}return await s.prepare(`
  ...
  `,500)});d.get("/api/admin/alimtalk/pricing",b(),async e=>{const{env:s}=e;try{const r=await s.DB.prepare(`
    ...
    `).bind(t.user_id).first();if(!c)return e.json({success:!1,error:"Active alimtalk account not found"},404);if(!(await Ct(s,c.sender_key,{name:n,content:o,templateCode:a})).success)return e.json({success:!1,error:"Failed to register template"},500);const l=await s.DB.prepare(`
    ...
    `).bind(a,c.id).first();if(!u)return e.json({success:!1,error:"Template not found or not approved"},404);const l=Lt(u.template_content,o||{}),p=lr(n),m=await Ts(s,{senderKey:c.sender_key,templateCode:u.template_code,to:p,message:l});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(parseInt(r),parseInt(s)).first();if(!n)return e.json({success:!1,error:"Template not found"},404);let o=n.template_content;return a&&Object.entries(a).forEach(([i,c])=>{const u=new RegExp(`#{${i}}`,"g");o=o.replace(u,c)}),e.json({success:!0,data:{template_name:n.template_name,original:n.template_content,preview:o,required_variables:Array.from(n.template_content.matchAll(/#{(\w+)}/g),i=>i[1])}})}catch(s){return console.error("[Alimtalk Preview] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/admin/settlements",b(),async e=>{try{const s=await e.env.DB.prepare(`
      ...
      LIMIT 50
    `).all();return e.json({success:!0,data:s.results})}catch(s){return console.error("[Admin Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/admin/settlements/:id",b(),async e=>{try{const s=parseInt(e.req.param("id")),r=await Qt(e.env.DB,s);return r?e.json({success:!0,data:r}):e.json({success:!1,error:"Settlement not found"},404)}catch(s){return console.error("[Admin Settlement Detail] Error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/admin/settlements/generate",b(),async e=>{try{const s=await e.req.json(),{startDate:r,endDate:t}=s,a=r&&t?{startDate:r,endDate:t}:Jt(),n=await Gt(e.env.DB,a);return await Xt(e.env.DB,n),e.json({success:!0,data:n})}catch(s){return console.error("[Admin Generate Settlement] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/seller/settlements",b(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const r=await e.env.DB.prepare(`
      SELECT 
        s.id,
        s.period_start,
        s.period_end,
      ...
      LIMIT 50
    `).bind(parseInt(s)).all();return e.json({success:!0,data:r.results})}catch(s){return console.error("[Seller Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/live/:streamId/sse",async e=>{const s=e.req.param("streamId");return Zt(s,e.env)});d.get("/api/live/:streamId/chat/sse",async e=>{const s=e.req.param("streamId");return ea(s,e.env)});d.get("/api/seller/orders/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?sa(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});d.get("/api/seller/stock/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?ra(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});d.post("/api/push/subscribe",b(),async e=>{try{const s=e.req.header("X-User-ID"),r=e.req.header("X-User-Type");if(!s||!r)return e.json({success:!1,error:"Unauthorized"},401);const t=await e.req.json();return await ta(e.env.DB,parseInt(s),r,t),e.json({success:!0})}catch(s){return console.error("[Push Subscribe] Error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/push/unsubscribe",b(),async e=>{try{const{endpoint:s}=await e.req.json();return s?(await aa(e.env.DB,s),e.json({success:!0})):e.json({success:!1,error:"Endpoint required"},400)}catch(s){return console.error("[Push Unsubscribe] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/push/vapid-public-key",b(),async e=>{try{const s=e.env.VAPID_PUBLIC_KEY||"";return e.json({success:!0,publicKey:s})}catch(s){return console.error("[Push VAPID Key] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/cache/stats",async e=>{const s=e.req.query("token"),r=e.env.STATS_SECRET_TOKEN||"your-secret-token-here";if(s!==r)return e.json({success:!1,error:"접근 권한이 없습니다. 올바른 token을 제공해주세요."},403);const t=V.hits+V.misses>0?(V.hits/(V.hits+V.misses)*100).toFixed(2):"0.00";return e.json({success:!0,data:{cache:{...V,hitRate:`${t}%`,cacheSize:ge.size,maxSize:1e3,memoryUsage:`${(ge.size/1e3*100).toFixed(1)}%`},description:{hits:"Memory cache로 처리된 요청 (KV 읽기 0회)",misses:"Memory cache 미스로 KV 조회한 요청",writes:"Memory cache에 저장된 항목 수",evictions:"Memory cache에서 삭제된 항목 수 (만료 또는 크기 제한)",hitRate:"Cache hit 비율 (높을수록 KV 사용량 감소)",cacheSize:"현재 Memory cache에 저장된 항목 수",maxSize:"Memory cache 최대 크기",memoryUsage:"Memory cache 사용률 (cacheSize / maxSize)"},kvUsageGuide:{currentHitRate:`${t}%`,recommendation:parseFloat(t)>=90?"✅ 캐시가 매우 효과적으로 작동하고 있습니다.":parseFloat(t)>=70?"⚠️ 캐시 히트율이 낮습니다. TTL 조정을 고려하세요.":"❌ 캐시 히트율이 매우 낮습니다. 캐시 설정을 확인하세요.",kvDailyReadsLimit:"100,000 reads/day (free tier)",kvDailyWritesLimit:"1,000 writes/day (free tier)",estimatedDailyReads:Math.round(V.misses/(V.hits+V.misses||1)*1e4),estimatedDailyWrites:Math.round(V.writes/(V.hits+V.misses||1)*1e3)}}})});const Ps=new or,ga=Object.assign({"/src/index.tsx":d});let Er=!1;for(const[,e]of Object.entries(ga))e&&(Ps.route("/",e),Ps.notFound(e.notFoundHandler),Er=!0);if(!Er)throw new Error("Can't import modules from ['/src/index.tsx']");async function hr(e){try{const{to:s,subject:r,htmlContent:t,textContent:a}=e,n=await fetch("https://api.mailchannels.net/tx/v1/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({personalizations:[{to:[{email:s}]}],from:{email:"noreply@live.ur-team.com",name:"유어 라이브"},subject:r,content:[{type:"text/html",value:t},...a?[{type:"text/plain",value:a}]:[]]})});if(!n.ok){const o=await n.text();return console.error("[Email] Failed to send:",n.status,o),{success:!1,error:`Email send failed: ${n.status}`}}return console.log("[Email] Successfully sent to:",s),{success:!0}}catch(s){return console.error("[Email] Exception:",s),{success:!1,error:s.message}}}async function ya(e){const{streamId:s,title:r,sellerName:t,platform:a,scheduledAt:n,status:o}=e,i=`https://live.ur-team.com/live/${s}`,c=o==="live"?"🔴 라이브 중":o==="scheduled"?"📅 예약됨":"⏸️ 대기 중",u=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return hr({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${r}`,htmlContent:u,textContent:l})}const wa=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:hr,sendLiveStreamCreatedEmail:ya},Symbol.toStringTag,{value:"Module"}));export{Ps as default};
