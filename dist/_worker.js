var Nt=Object.defineProperty;var lr=e=>{throw TypeError(e)};var jt=(e,s,r)=>s in e?Nt(e,s,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[s]=r;var A=(e,s,r)=>jt(e,typeof s!="symbol"?s+"":s,r),Ps=(e,s,r)=>s.has(e)||lr("Cannot "+r);var E=(e,s,r)=>(Ps(e,s,"read from private field"),r?r.call(e):s.get(e)),O=(e,s,r)=>s.has(e)?lr("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,r),I=(e,s,r,t)=>(Ps(e,s,"write to private field"),t?t.call(e,r):s.set(e,r),r),N=(e,s,r)=>(Ps(e,s,"access private method"),r);var ur=(e,s,r,t)=>({set _(a){I(e,s,a,r)},get _(){return E(e,s,t)}});var dr=(e,s,r)=>(t,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,l=!1,u;if(e[i]?(u=e[i][0][0],t.req.routeIndex=i):u=i===e.length&&a||void 0,u)try{c=await u(t,()=>o(i+1))}catch(d){if(d instanceof Error&&s)t.error=d,c=await s(d,t),l=!0;else throw d}else t.finalized===!1&&r&&(c=await r(t));return c&&(t.finalized===!1||l)&&(t.res=c),t}},Lt=Symbol(),Mt=async(e,s=Object.create(null))=>{const{all:r=!1,dot:t=!1}=s,n=(e instanceof Kr?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Ft(e,{all:r,dot:t}):{}};async function Ft(e,s){const r=await e.formData();return r?$t(r,s):{}}function $t(e,s){const r=Object.create(null);return e.forEach((t,a)=>{s.all||a.endsWith("[]")?Ut(r,a,t):r[a]=t}),s.dot&&Object.entries(r).forEach(([t,a])=>{t.includes(".")&&(Pt(r,t,a),delete r[t])}),r}var Ut=(e,s,r)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(r):e[s]=[e[s],r]:s.endsWith("[]")?e[s]=[r]:e[s]=r},Pt=(e,s,r)=>{let t=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?t[n]=r:((!t[n]||typeof t[n]!="object"||Array.isArray(t[n])||t[n]instanceof File)&&(t[n]=Object.create(null)),t=t[n])})},Pr=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},xt=e=>{const{groups:s,path:r}=Wt(e),t=Pr(r);return qt(t,s)},Wt=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(r,t)=>{const a=`@${t}`;return s.push([a,r]),a}),{groups:s,path:e}},qt=(e,s)=>{for(let r=s.length-1;r>=0;r--){const[t]=s[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(t)){e[a]=e[a].replace(t,s[r][1]);break}}return e},Ss={},Ht=(e,s)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const t=`${e}#${s}`;return Ss[t]||(r[2]?Ss[t]=s&&s[0]!==":"&&s[0]!=="*"?[t,r[1],new RegExp(`^${r[2]}(?=/${s})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Ss[t]=[e,r[1],!0]),Ss[t]}return null},Xs=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return s(r)}catch{return r}})}},Kt=e=>Xs(e,decodeURI),xr=e=>{const s=e.url,r=s.indexOf("/",s.indexOf(":")+4);let t=r;for(;t<s.length;t++){const a=s.charCodeAt(t);if(a===37){const n=s.indexOf("?",t),o=s.indexOf("#",t),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(r,i);return Kt(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(r,t)},Bt=e=>{const s=xr(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},Be=(e,s,...r)=>(r.length&&(s=Be(s,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),Wr=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),r=[];let t="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))t+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&t===""?r.push("/"):r.push(t);const n=a.replace("?","");t+="/"+n,r.push(t)}else t+="/"+a}),r.filter((a,n,o)=>o.indexOf(a)===n)},xs=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Xs(e,Hr):e):e,qr=(e,s,r)=>{let t;if(!r&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,l=e.indexOf("&",c);return xs(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(t=/[%+]/.test(e),!t)return}const a={};t??(t=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(t&&(c=xs(c)),n=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),t&&(l=xs(l))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(l)):a[c]??(a[c]=l)}return s?a[s]:a},Jt=qr,Vt=(e,s)=>qr(e,s,!0),Hr=decodeURIComponent,pr=e=>Xs(e,Hr),ze,ae,ye,Br,Jr,Vs,we,Nr,Kr=(Nr=class{constructor(e,s="/",r=[[]]){O(this,ye);A(this,"raw");O(this,ze);O(this,ae);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});O(this,we,e=>{const{bodyCache:s,raw:r}=this,t=s[e];if(t)return t;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=r[e]()});this.raw=e,this.path=s,I(this,ae,r),I(this,ze,{})}param(e){return e?N(this,ye,Br).call(this,e):N(this,ye,Jr).call(this)}query(e){return Jt(this.url,e)}queries(e){return Vt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((r,t)=>{s[t]=r}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await Mt(this,e))}json(){return E(this,we).call(this,"text").then(e=>JSON.parse(e))}text(){return E(this,we).call(this,"text")}arrayBuffer(){return E(this,we).call(this,"arrayBuffer")}blob(){return E(this,we).call(this,"blob")}formData(){return E(this,we).call(this,"formData")}addValidatedData(e,s){E(this,ze)[e]=s}valid(e){return E(this,ze)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Lt](){return E(this,ae)}get matchedRoutes(){return E(this,ae)[0].map(([[,e]])=>e)}get routePath(){return E(this,ae)[0].map(([[,e]])=>e)[this.routeIndex].path}},ze=new WeakMap,ae=new WeakMap,ye=new WeakSet,Br=function(e){const s=E(this,ae)[0][this.routeIndex][1][e],r=N(this,ye,Vs).call(this,s);return r&&/\%/.test(r)?pr(r):r},Jr=function(){const e={},s=Object.keys(E(this,ae)[0][this.routeIndex][1]);for(const r of s){const t=N(this,ye,Vs).call(this,E(this,ae)[0][this.routeIndex][1][r]);t!==void 0&&(e[r]=/\%/.test(t)?pr(t):t)}return e},Vs=function(e){return E(this,ae)[1]?E(this,ae)[1][e]:e},we=new WeakMap,Nr),Yt={Stringify:1},Vr=async(e,s,r,t,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:t}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Vr(c,s,!1,t,a))).then(()=>a[0]))):Promise.resolve(e)},zt="text/plain; charset=UTF-8",Ws=(e,s)=>({"Content-Type":e,...s}),We=(e,s)=>new Response(e,s),ms,_s,fe,Ge,Ee,se,fs,Xe,Qe,ke,Es,hs,de,Je,Ys,jr,Gt=(jr=class{constructor(e,s){O(this,de);O(this,ms);O(this,_s);A(this,"env",{});O(this,fe);A(this,"finalized",!1);A(this,"error");O(this,Ge);O(this,Ee);O(this,se);O(this,fs);O(this,Xe);O(this,Qe);O(this,ke);O(this,Es);O(this,hs);A(this,"render",(...e)=>(E(this,Xe)??I(this,Xe,s=>this.html(s)),E(this,Xe).call(this,...e)));A(this,"setLayout",e=>I(this,fs,e));A(this,"getLayout",()=>E(this,fs));A(this,"setRenderer",e=>{I(this,Xe,e)});A(this,"header",(e,s,r)=>{this.finalized&&I(this,se,We(E(this,se).body,E(this,se)));const t=E(this,se)?E(this,se).headers:E(this,ke)??I(this,ke,new Headers);s===void 0?t.delete(e):r!=null&&r.append?t.append(e,s):t.set(e,s)});A(this,"status",e=>{I(this,Ge,e)});A(this,"set",(e,s)=>{E(this,fe)??I(this,fe,new Map),E(this,fe).set(e,s)});A(this,"get",e=>E(this,fe)?E(this,fe).get(e):void 0);A(this,"newResponse",(...e)=>N(this,de,Je).call(this,...e));A(this,"body",(e,s,r)=>N(this,de,Je).call(this,e,s,r));A(this,"text",(e,s,r)=>N(this,de,Ys).call(this)&&!s&&!r?We(e):N(this,de,Je).call(this,e,s,Ws(zt,r)));A(this,"json",(e,s,r)=>N(this,de,Ys).call(this)&&!s&&!r?Response.json(e):N(this,de,Je).call(this,JSON.stringify(e),s,Ws("application/json",r)));A(this,"html",(e,s,r)=>{const t=a=>N(this,de,Je).call(this,a,s,Ws("text/html; charset=UTF-8",r));return typeof e=="object"?Vr(e,Yt.Stringify,!1,{}).then(t):t(e)});A(this,"redirect",(e,s)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,s??302)});A(this,"notFound",()=>(E(this,Qe)??I(this,Qe,()=>We()),E(this,Qe).call(this,this)));I(this,ms,e),s&&(I(this,Ee,s.executionCtx),this.env=s.env,I(this,Qe,s.notFoundHandler),I(this,hs,s.path),I(this,Es,s.matchResult))}get req(){return E(this,_s)??I(this,_s,new Kr(E(this,ms),E(this,hs),E(this,Es))),E(this,_s)}get event(){if(E(this,Ee)&&"respondWith"in E(this,Ee))return E(this,Ee);throw Error("This context has no FetchEvent")}get executionCtx(){if(E(this,Ee))return E(this,Ee);throw Error("This context has no ExecutionContext")}get res(){return E(this,se)||I(this,se,We(null,{headers:E(this,ke)??I(this,ke,new Headers)}))}set res(e){if(E(this,se)&&e){e=We(e.body,e);for(const[s,r]of E(this,se).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const t=E(this,se).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of t)e.headers.append("set-cookie",a)}else e.headers.set(s,r)}I(this,se,e),this.finalized=!0}get var(){return E(this,fe)?Object.fromEntries(E(this,fe)):{}}},ms=new WeakMap,_s=new WeakMap,fe=new WeakMap,Ge=new WeakMap,Ee=new WeakMap,se=new WeakMap,fs=new WeakMap,Xe=new WeakMap,Qe=new WeakMap,ke=new WeakMap,Es=new WeakMap,hs=new WeakMap,de=new WeakSet,Je=function(e,s,r){const t=E(this,se)?new Headers(E(this,se).headers):E(this,ke)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?t.append(o,i):t.set(o,i)}if(r)for(const[n,o]of Object.entries(r))if(typeof o=="string")t.set(n,o);else{t.delete(n);for(const i of o)t.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??E(this,Ge);return We(e,{status:a,headers:t})},Ys=function(){return!E(this,ke)&&!E(this,Ge)&&!this.finalized},jr),B="ALL",Xt="all",Qt=["get","post","put","delete","options","patch"],Yr="Can not add a route since the matcher is already built.",zr=class extends Error{},Zt="__COMPOSED_HANDLER",ea=e=>e.text("404 Not Found",404),mr=(e,s)=>{if("getResponse"in e){const r=e.getResponse();return s.newResponse(r.body,r)}return console.error(e),s.text("Internal Server Error",500)},ce,J,Gr,le,De,Is,vs,Ze,sa=(Ze=class{constructor(s={}){O(this,J);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");O(this,ce,"/");A(this,"routes",[]);O(this,le,ea);A(this,"errorHandler",mr);A(this,"onError",s=>(this.errorHandler=s,this));A(this,"notFound",s=>(I(this,le,s),this));A(this,"fetch",(s,...r)=>N(this,J,vs).call(this,s,r[1],r[0],s.method));A(this,"request",(s,r,t,a)=>s instanceof Request?this.fetch(r?new Request(s,r):s,t,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${Be("/",s)}`,r),t,a)));A(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(N(this,J,vs).call(this,s.request,s,void 0,s.request.method))})});[...Qt,Xt].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?I(this,ce,o):N(this,J,De).call(this,n,E(this,ce),o),i.forEach(c=>{N(this,J,De).call(this,n,E(this,ce),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){I(this,ce,c);for(const l of[n].flat())i.map(u=>{N(this,J,De).call(this,l.toUpperCase(),E(this,ce),u)})}return this},this.use=(n,...o)=>(typeof n=="string"?I(this,ce,n):(I(this,ce,"*"),o.unshift(n)),o.forEach(i=>{N(this,J,De).call(this,B,E(this,ce),i)}),this);const{strict:t,...a}=s;Object.assign(this,a),this.getPath=t??!0?s.getPath??xr:Bt}route(s,r){const t=this.basePath(s);return r.routes.map(a=>{var o;let n;r.errorHandler===mr?n=a.handler:(n=async(i,c)=>(await dr([],r.errorHandler)(i,()=>a.handler(i,c))).res,n[Zt]=a.handler),N(o=t,J,De).call(o,a.method,a.path,n)}),this}basePath(s){const r=N(this,J,Gr).call(this);return r._basePath=Be(this._basePath,s),r}mount(s,r,t){let a,n;t&&(typeof t=="function"?n=t:(n=t.optionHandler,t.replaceRequest===!1?a=c=>c:a=t.replaceRequest));const o=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};a||(a=(()=>{const c=Be(this._basePath,s),l=c==="/"?0:c.length;return u=>{const d=new URL(u.url);return d.pathname=d.pathname.slice(l)||"/",new Request(d,u)}})());const i=async(c,l)=>{const u=await r(a(c.req.raw),...o(c));if(u)return u;await l()};return N(this,J,De).call(this,B,Be(s,"*"),i),this}},ce=new WeakMap,J=new WeakSet,Gr=function(){const s=new Ze({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,I(s,le,E(this,le)),s.routes=this.routes,s},le=new WeakMap,De=function(s,r,t){s=s.toUpperCase(),r=Be(this._basePath,r);const a={basePath:this._basePath,path:r,method:s,handler:t};this.router.add(s,r,[t,a]),this.routes.push(a)},Is=function(s,r){if(s instanceof Error)return this.errorHandler(s,r);throw s},vs=function(s,r,t,a){if(a==="HEAD")return(async()=>new Response(null,await N(this,J,vs).call(this,s,r,t,"GET")))();const n=this.getPath(s,{env:t}),o=this.router.match(a,n),i=new Gt(s,{path:n,matchResult:o,env:t,executionCtx:r,notFoundHandler:E(this,le)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await E(this,le).call(this,i)})}catch(u){return N(this,J,Is).call(this,u,i)}return l instanceof Promise?l.then(u=>u||(i.finalized?i.res:E(this,le).call(this,i))).catch(u=>N(this,J,Is).call(this,u,i)):l??E(this,le).call(this,i)}const c=dr(o[0],this.errorHandler,E(this,le));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return N(this,J,Is).call(this,l,i)}})()},Ze),Xr=[];function ra(e,s){const r=this.buildAllMatchers(),t=((a,n)=>{const o=r[a]||r[B],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],Xr];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=t,t(e,s)}var Os="[^/]+",ls=".*",us="(?:|/.*)",Ve=Symbol(),ta=new Set(".\\+*[^]$()");function aa(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===ls||e===us?1:s===ls||s===us?-1:e===Os?1:s===Os?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var Ce,Ne,ue,Fe,na=(Fe=class{constructor(){O(this,Ce);O(this,Ne);O(this,ue,Object.create(null))}insert(s,r,t,a,n){if(s.length===0){if(E(this,Ce)!==void 0)throw Ve;if(n)return;I(this,Ce,r);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",ls]:["","",Os]:o==="/*"?["","",us]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let d=c[2]||Os;if(u&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Ve;if(l=E(this,ue)[d],!l){if(Object.keys(E(this,ue)).some(m=>m!==ls&&m!==us))throw Ve;if(n)return;l=E(this,ue)[d]=new Fe,u!==""&&I(l,Ne,a.varIndex++)}!n&&u!==""&&t.push([u,E(l,Ne)])}else if(l=E(this,ue)[o],!l){if(Object.keys(E(this,ue)).some(u=>u.length>1&&u!==ls&&u!==us))throw Ve;if(n)return;l=E(this,ue)[o]=new Fe}l.insert(i,r,t,a,n)}buildRegExpStr(){const r=Object.keys(E(this,ue)).sort(aa).map(t=>{const a=E(this,ue)[t];return(typeof E(a,Ne)=="number"?`(${t})@${E(a,Ne)}`:ta.has(t)?`\\${t}`:t)+a.buildRegExpStr()});return typeof E(this,Ce)=="number"&&r.unshift(`#${E(this,Ce)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Ce=new WeakMap,Ne=new WeakMap,ue=new WeakMap,Fe),js,gs,Lr,oa=(Lr=class{constructor(){O(this,js,{varIndex:0});O(this,gs,new na)}insert(e,s,r){const t=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return a[o]=[l,c],o++,i=!0,l}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return E(this,gs).insert(n,s,t,E(this,js),r),t}buildRegExp(){let e=E(this,gs).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const r=[],t=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(r[++s]=Number(n),"$()"):(o!==void 0&&(t[Number(o)]=++s),"")),[new RegExp(`^${e}`),r,t]}},js=new WeakMap,gs=new WeakMap,Lr),ia=[/^$/,[],Object.create(null)],As=Object.create(null);function Qr(e){return As[e]??(As[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ca(){As=Object.create(null)}function la(e){var l;const s=new oa,r=[];if(e.length===0)return ia;const t=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,d],[m,_])=>u?1:m?-1:d.length-_.length),a=Object.create(null);for(let u=0,d=-1,m=t.length;u<m;u++){const[_,f,h]=t[u];_?a[f]=[h.map(([b])=>[b,Object.create(null)]),Xr]:d++;let w;try{w=s.insert(f,d,_)}catch(b){throw b===Ve?new zr(f):b}_||(r[d]=h.map(([b,g])=>{const T=Object.create(null);for(g-=1;g>=0;g--){const[y,R]=w[g];T[y]=R}return[b,T]}))}const[n,o,i]=s.buildRegExp();for(let u=0,d=r.length;u<d;u++)for(let m=0,_=r[u].length;m<_;m++){const f=(l=r[u][m])==null?void 0:l[1];if(!f)continue;const h=Object.keys(f);for(let w=0,b=h.length;w<b;w++)f[h[w]]=i[f[h[w]]]}const c=[];for(const u in o)c[u]=r[o[u]];return[n,c,a]}function qe(e,s){if(e){for(const r of Object.keys(e).sort((t,a)=>a.length-t.length))if(Qr(r).test(s))return[...e[r]]}}var Se,Te,Ls,Zr,Mr,ua=(Mr=class{constructor(){O(this,Ls);A(this,"name","RegExpRouter");O(this,Se);O(this,Te);A(this,"match",ra);I(this,Se,{[B]:Object.create(null)}),I(this,Te,{[B]:Object.create(null)})}add(e,s,r){var i;const t=E(this,Se),a=E(this,Te);if(!t||!a)throw new Error(Yr);t[e]||[t,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[B]).forEach(l=>{c[e][l]=[...c[B][l]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=Qr(s);e===B?Object.keys(t).forEach(l=>{var u;(u=t[l])[s]||(u[s]=qe(t[l],s)||qe(t[B],s)||[])}):(i=t[e])[s]||(i[s]=qe(t[e],s)||qe(t[B],s)||[]),Object.keys(t).forEach(l=>{(e===B||e===l)&&Object.keys(t[l]).forEach(u=>{c.test(u)&&t[l][u].push([r,n])})}),Object.keys(a).forEach(l=>{(e===B||e===l)&&Object.keys(a[l]).forEach(u=>c.test(u)&&a[l][u].push([r,n]))});return}const o=Wr(s)||[s];for(let c=0,l=o.length;c<l;c++){const u=o[c];Object.keys(a).forEach(d=>{var m;(e===B||e===d)&&((m=a[d])[u]||(m[u]=[...qe(t[d],u)||qe(t[B],u)||[]]),a[d][u].push([r,n-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(E(this,Te)).concat(Object.keys(E(this,Se))).forEach(s=>{e[s]||(e[s]=N(this,Ls,Zr).call(this,s))}),I(this,Se,I(this,Te,void 0)),ca(),e}},Se=new WeakMap,Te=new WeakMap,Ls=new WeakSet,Zr=function(e){const s=[];let r=e===B;return[E(this,Se),E(this,Te)].forEach(t=>{const a=t[e]?Object.keys(t[e]).map(n=>[n,t[e][n]]):[];a.length!==0?(r||(r=!0),s.push(...a)):e!==B&&s.push(...Object.keys(t[B]).map(n=>[n,t[B][n]]))}),r?la(s):null},Mr),Re,he,Fr,da=(Fr=class{constructor(e){A(this,"name","SmartRouter");O(this,Re,[]);O(this,he,[]);I(this,Re,e.routers)}add(e,s,r){if(!E(this,he))throw new Error(Yr);E(this,he).push([e,s,r])}match(e,s){if(!E(this,he))throw new Error("Fatal error");const r=E(this,Re),t=E(this,he),a=r.length;let n=0,o;for(;n<a;n++){const i=r[n];try{for(let c=0,l=t.length;c<l;c++)i.add(...t[c]);o=i.match(e,s)}catch(c){if(c instanceof zr)continue;throw c}this.match=i.match.bind(i),I(this,Re,[i]),I(this,he,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(E(this,he)||E(this,Re).length!==1)throw new Error("No active router has been determined yet.");return E(this,Re)[0]}},Re=new WeakMap,he=new WeakMap,Fr),os=Object.create(null),pa=e=>{for(const s in e)return!0;return!1},Ie,ee,je,es,G,ge,Oe,ss,ma=(ss=class{constructor(s,r,t){O(this,ge);O(this,Ie);O(this,ee);O(this,je);O(this,es,0);O(this,G,os);if(I(this,ee,t||Object.create(null)),I(this,Ie,[]),s&&r){const a=Object.create(null);a[s]={handler:r,possibleKeys:[],score:0},I(this,Ie,[a])}I(this,je,[])}insert(s,r,t){I(this,es,++ur(this,es)._);let a=this;const n=xt(r),o=[];for(let i=0,c=n.length;i<c;i++){const l=n[i],u=n[i+1],d=Ht(l,u),m=Array.isArray(d)?d[0]:l;if(m in E(a,ee)){a=E(a,ee)[m],d&&o.push(d[1]);continue}E(a,ee)[m]=new ss,d&&(E(a,je).push(d),o.push(d[1])),a=E(a,ee)[m]}return E(a,Ie).push({[s]:{handler:t,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:E(this,es)}}),a}search(s,r){var u;const t=[];I(this,G,os);let n=[this];const o=Pr(r),i=[],c=o.length;let l=null;for(let d=0;d<c;d++){const m=o[d],_=d===c-1,f=[];for(let w=0,b=n.length;w<b;w++){const g=n[w],T=E(g,ee)[m];T&&(I(T,G,E(g,G)),_?(E(T,ee)["*"]&&N(this,ge,Oe).call(this,t,E(T,ee)["*"],s,E(g,G)),N(this,ge,Oe).call(this,t,T,s,E(g,G))):f.push(T));for(let y=0,R=E(g,je).length;y<R;y++){const L=E(g,je)[y],k=E(g,G)===os?{}:{...E(g,G)};if(L==="*"){const $=E(g,ee)["*"];$&&(N(this,ge,Oe).call(this,t,$,s,E(g,G)),I($,G,k),f.push($));continue}const[D,W,U]=L;if(!m&&!(U instanceof RegExp))continue;const M=E(g,ee)[D];if(U instanceof RegExp){if(l===null){l=new Array(c);let z=r[0]==="/"?1:0;for(let v=0;v<c;v++)l[v]=z,z+=o[v].length+1}const $=r.substring(l[d]),Z=U.exec($);if(Z){if(k[W]=Z[0],N(this,ge,Oe).call(this,t,M,s,E(g,G),k),pa(E(M,ee))){I(M,G,k);const z=((u=Z[0].match(/\//))==null?void 0:u.length)??0;(i[z]||(i[z]=[])).push(M)}continue}}(U===!0||U.test(m))&&(k[W]=m,_?(N(this,ge,Oe).call(this,t,M,s,k,E(g,G)),E(M,ee)["*"]&&N(this,ge,Oe).call(this,t,E(M,ee)["*"],s,k,E(g,G))):(I(M,G,k),f.push(M)))}}const h=i.shift();n=h?f.concat(h):f}return t.length>1&&t.sort((d,m)=>d.score-m.score),[t.map(({handler:d,params:m})=>[d,m])]}},Ie=new WeakMap,ee=new WeakMap,je=new WeakMap,es=new WeakMap,G=new WeakMap,ge=new WeakSet,Oe=function(s,r,t,a,n){for(let o=0,i=E(r,Ie).length;o<i;o++){const c=E(r,Ie)[o],l=c[t]||c[B],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),a!==os||n&&n!==os))for(let d=0,m=l.possibleKeys.length;d<m;d++){const _=l.possibleKeys[d],f=u[l.score];l.params[_]=n!=null&&n[_]&&!f?n[_]:a[_]??(n==null?void 0:n[_]),u[l.score]=!0}}},ss),Le,$r,_a=($r=class{constructor(){A(this,"name","TrieRouter");O(this,Le);I(this,Le,new ma)}add(e,s,r){const t=Wr(s);if(t){for(let a=0,n=t.length;a<n;a++)E(this,Le).insert(e,t[a],r);return}E(this,Le).insert(e,s,r)}match(e,s){return E(this,Le).search(e,s)}},Le=new WeakMap,$r),et=class extends sa{constructor(e={}){super(e),this.router=e.router??new da({routers:[new ua,new _a]})}},S=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},t=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(r.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(r.allowMethods);return async function(o,i){var u;function c(d,m){o.res.headers.set(d,m)}const l=await t(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),r.credentials&&c("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&c("Access-Control-Allow-Methods",d.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const _=o.req.header("Access-Control-Request-Headers");_&&(m=_.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function fa(e){var a;const s=((a=e.split(".").pop())==null?void 0:a.toLowerCase())||"jpg",r=Date.now(),t=crypto.randomUUID().substring(0,8);return`upload_${r}_${t}.${s}`}async function Ea(e){const s=new Uint8Array(e);return s[0]===255&&s[1]===216&&s[2]===255?{valid:!0,detectedType:"image/jpeg"}:s[0]===137&&s[1]===80&&s[2]===78&&s[3]===71?{valid:!0,detectedType:"image/png"}:s[0]===71&&s[1]===73&&s[2]===70&&s[3]===56?{valid:!0,detectedType:"image/gif"}:s[0]===82&&s[1]===73&&s[2]===70&&s[3]===70&&s[8]===87&&s[9]===69&&s[10]===66&&s[11]===80?{valid:!0,detectedType:"image/webp"}:{valid:!1}}function ha(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],r=[];for(const t of s)e[t]||r.push(t);if(r.length>0)throw new Error(`Missing required environment variables: ${r.join(", ")}
...
`)}async function wa(e){const s=await ya(e),r=s.filter(n=>n.status==="pass").length,t=s.filter(n=>n.status==="warn").length,a=s.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:s.length,pass:r,warn:t,fail:a},results:s,formatted:ba(s)}}const qs={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function Sa(){const e=qs.ENV==="production";return{baseUrl:qs.TEST_BASE_URL,apiKey:qs.TEST_API_KEY,isProduction:e}}async function st(e,s){const r=Sa(),t=`${r.baseUrl}${e}`;try{const a=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r.apiKey}`},body:JSON.stringify(s)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Ta(e){try{const s={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((t,a)=>({SerialNum:a+1,ItemName:t.name,Qty:t.quantity,UnitPrice:t.unitPrice,SupplyCost:t.supplyPrice,Tax:t.taxAmount,Remark:t.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},r=await st("/eTaxInvoice/RegistAndIssue",s);if(r.code!==1)throw new Error(`바로빌 발행 실패: ${r.message}`);return{success:!0,ntsConfirmNumber:r.ntsconfirmNum,invoiceKey:r.invoiceKey,message:r.message}}catch(s){throw console.error("바로빌 세금계산서 발행 실패:",s),s}}async function Ra(e,s,r){try{const a=await st("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:s,Memo:r});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(t){throw console.error("바로빌 세금계산서 취소 실패:",t),t}}function cs(){return!1}async function Ia(e){return await Ta(e)}function va(e,s,r){const t=Number(s.total_amount),a=Math.floor(t/1.1),n=t-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:s.buyer_business_number,buyerBusinessName:s.buyer_business_name||s.user_name,buyerCEO:s.buyer_ceo_name,buyerAddress:s.shipping_address,buyerEmail:s.user_email,buyerTel:s.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:r.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),l=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:l,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:t,memo:`주문번호: ${s.order_number}`,orderNo:s.order_number}}class ne extends Error{constructor(s,r,t){super(s),this.statusCode=r,this.code=t,this.name="AuthError"}}function Aa(e){return`${crypto.randomUUID()}-${e}`}function Da(e){var n,o,i,c,l,u,d;const s=e.id.toString(),r=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",t=((c=e.kakao_account)==null?void 0:c.email)||null,a=((l=e.properties)==null?void 0:l.profile_image)||((d=(u=e.kakao_account)==null?void 0:u.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:s,nickname:r,email:t,profileImage:a}}async function Oa(e,s,r,t,a){try{const n=await e.prepare(`
      INSERT INTO users (
  ...
  `).bind(s).first();if(!r)throw new Error(`Order not found: ${s}`);const t=await e.prepare(`
    ...
    WHERE oi.order_id = ?
  `).bind(s).all();return{order:r,products:t.results}}async function Va(e,s){const r=await e.prepare(`
    SELECT 
  ...
  `).bind(s).first();return r||(console.warn(`No active alimtalk account for seller ${s}`),null)}async function _r(e,s){await e.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
  `).bind(s.seller_id,s.template_code,s.recipient_phone,s.message,s.cost,s.status,s.order_id||null).run()}async function Ya(e,s,r){await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?
    WHERE seller_id = ?
  `).bind(r,s).run()}async function za(e,s){try{const{order:r,products:t}=await Ja(e.DB,s),a=await Va(e.DB,r.seller_id);if(!a)return console.warn(`Skipping alimtalk for order ${s}: no active account`),{success:!1,reason:"no_account"};const n=15;if(a.balance<n)return console.warn(`Skipping alimtalk for order ${s}: insufficient balance`),{success:!1,reason:"insufficient_balance"};const o=t.map(l=>`${l.name} ${l.quantity}개 (${l.price.toLocaleString()}원)`).join(`
`),i=`[주문 확인]
...
주문해 주셔서 감사합니다!`,c=await er(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:r.buyer_phone,message:i});return c.success?(await Ya(e.DB,r.seller_id,n),await _r(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await _r(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(r){return console.error(`Error sending order confirmation for order ${s}:`,r),{success:!1,error:r.message}}}function Ga(e,s){let r=e;return Object.entries(s).forEach(([t,a])=>{const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}),r}function Xa(e,s){const t=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:t.length===0,missingVars:t}}async function Qa(e,s,r){const t=await e.prepare(`
    SELECT balance FROM alimtalk_accounts WHERE id = ?
  `).bind(s).first();if(!t)throw new Error(`Account not found: ${s}`);return{sufficient:t.balance>=r,currentBalance:t.balance}}async function Za(e,s,r){const t=await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?,
        updated_at = datetime('now')
  ...
  `).bind(r,s,r).run();if(!t.success||t.meta.changes===0)throw new Error("Insufficient balance or account not found")}async function fr(e,s,r){await e.prepare(`
    ...
    SET balance = balance + ?,
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,s).run()}async function Ks(e,s){await e.prepare(`
    INSERT INTO alimtalk_messages 
  ...
  `).bind(s.accountId,s.templateId,s.orderId||null,s.recipientPhone,s.messageContent,s.status,s.cost,s.aligoMessageId||null,s.failedReason||null).run()}async function en(e,s,r,t){await e.prepare(`
    UPDATE alimtalk_accounts
    SET total_sent = total_sent + ?,
        total_failed = total_failed + ?,
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,t,s).run()}async function sn(e,s,r,t,a,n,o,i,c){try{const l={...i,...o.variables},u=Ga(t,l),d=await er(e,{senderKey:a,templateCode:n,to:o.phone,message:u});return d.success?(await Ks(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:u,status:"sent",cost:c,aligoMessageId:d.messageId}),{phone:o.phone,status:"sent",messageId:d.messageId,cost:c}):(await Ks(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:u,status:"failed",cost:0,failedReason:d.error}),await fr(e.DB,s,c),{phone:o.phone,status:"failed",error:d.error,cost:0})}catch(l){return console.error(`Failed to send alimtalk to ${o.phone}:`,l),await Ks(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:"",status:"failed",cost:0,failedReason:l.message}),await fr(e.DB,s,c),{phone:o.phone,status:"failed",error:l.message,cost:0}}}async function sr(e,s){const{accountId:r,templateId:t,recipients:a,variables:n}=s;console.log(`[Alimtalk] Starting bulk send: ${a.length} recipients`);try{const o=await e.DB.prepare(`
      SELECT 
        id,
        sender_key,
        balance,
    ...
    `).bind(t,r).first();if(!i)throw new Error("Template not found");if(i.status!=="approved")throw new Error("Template is not approved");const c=Xa(i.template_content,n);if(!c.valid)throw new Error(`Missing variables: ${c.missingVars.join(", ")}`);const l=15,u=a.length*l,d=await Qa(e.DB,r,u);if(!d.sufficient)throw new Error(`Insufficient balance. Required: ${u}, Current: ${d.currentBalance}`);await Za(e.DB,r,u),console.log(`[Alimtalk] Deducted ${u} points from account ${r}`);const m=[];let _=0,f=0,h=0;for(const w of a){const b=await sn(e,r,t,i.template_content,o.sender_key,i.template_code,w,n,l);m.push(b),b.status==="sent"?_++:(f++,h+=l),m.length%10===0&&await new Promise(g=>setTimeout(g,1e3))}return await en(e.DB,r,_,f),console.log(`[Alimtalk] Completed: ${_} sent, ${f} failed, ${h} refunded`),{success:!0,totalRecipients:a.length,successCount:_,failedCount:f,refundedAmount:h,messages:m}}catch(o){return console.error("[Alimtalk] Bulk send failed:",o),{success:!1,totalRecipients:a.length,successCount:0,failedCount:a.length,refundedAmount:0,messages:[],error:o.message}}}async function rn(e,s,r,t,a){const n=await e.DB.prepare(`
    SELECT 
      o.*,
      u.name as buyer_name,
      u.phone as buyer_phone,
...
`),c={orderNumber:n.order_number,orderDate:new Date(n.created_at).toLocaleString("ko-KR"),productList:i,totalAmount:n.total_amount.toLocaleString(),shippingAddress:n.shipping_address,shippingName:n.shipping_name,shippingPhone:n.shipping_phone,buyerName:n.buyer_name,customMessage:a||"감사합니다!"},l=[{phone:n.buyer_phone,name:n.buyer_name}];return sr(e,{accountId:s,templateId:r,recipients:l,variables:c})}async function tn(e,s,r,t,a={}){const n=t.map(o=>({phone:o.phone,name:o.name,variables:Object.entries(o).filter(([i])=>i!=="phone"&&i!=="name").reduce((i,[c,l])=>({...i,[c]:l}),{})}));return sr(e,{accountId:s,templateId:r,recipients:n,variables:a})}function an(e,s=.1){return Math.floor(e*s)}function nn(){const e=new Date,s=new Date(e.getFullYear(),e.getMonth()-1,1),r=s.getFullYear(),t=String(s.getMonth()+1).padStart(2,"0"),a=new Date(r,s.getMonth()+1,0).getDate();return{startDate:`${r}-${t}-01`,endDate:`${r}-${t}-${a}`}}async function on(e,s,r){try{const t=await e.prepare(`
    ...
    `).bind(s,r.startDate,r.endDate).all();if(!a.results||a.results.length===0)return{seller_id:s,seller_name:t.business_name,total_sales:0,total_orders:0,platform_fee:0,shipping_fee:0,refund_amount:0,settlement_amount:0,orders:[]};const n=[];let o=0,i=0,c=0;for(const m of a.results){const _=m.total_amount-m.shipping_fee,f=an(_);n.push({order_id:m.id,order_number:m.order_number,order_date:m.created_at,product_name:m.product_names||"",quantity:m.total_quantity||1,price:_,shipping_fee:m.shipping_fee||0,platform_fee:f,status:m.status}),o+=_,i+=m.shipping_fee||0,c+=f}const l=await e.prepare(`
      SELECT COALESCE(SUM(total_amount), 0) as refund_amount
      FROM orders
      WHERE seller_id = ?
        AND DATE(created_at) BETWEEN ? AND ?
        AND status = 'refunded'
    `).bind(s,r.startDate,r.endDate).first(),u=(l==null?void 0:l.refund_amount)||0,d=o-c-u+i;return{seller_id:s,seller_name:t.business_name,total_sales:o,total_orders:n.length,platform_fee:c,shipping_fee:i,refund_amount:u,settlement_amount:d,orders:n}}catch(t){return console.error(`Failed to calculate settlement for seller ${s}:`,t),null}}async function cn(e,s){console.log(`[Settlement] Generating report for ${s.startDate} ~ ${s.endDate}`);const r=await e.prepare(`
    SELECT DISTINCT s.id
    FROM sellers s
    JOIN orders o ON s.id = o.seller_id
    WHERE DATE(o.created_at) BETWEEN ? AND ?
      AND o.status IN ('delivered', 'confirmed', 'refunded')
  `).bind(s.startDate,s.endDate).all(),t=[];let a=0,n=0,o=0;for(const c of r.results){const l=await on(e,c.id,s);l&&(t.push(l),a+=l.total_sales,n+=l.platform_fee,o+=l.settlement_amount)}const i={period:s,generated_at:new Date().toISOString(),total_sales:a,total_platform_fee:n,total_settlement:o,sellers:t};return console.log(`[Settlement] Report generated: ${t.length} sellers, ${a.toLocaleString()}원`),i}async function ln(e,s){const t=(await e.prepare(`
  ...
  `).bind(s.period.startDate,s.period.endDate,s.total_sales,s.total_platform_fee,s.total_settlement,s.generated_at).run()).meta.last_row_id;for(const a of s.sellers)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a.seller_id,a.total_sales,a.total_orders,a.platform_fee,a.shipping_fee,a.refund_amount,a.settlement_amount).run();console.log(`[Settlement] Report saved: ID ${t}`)}async function un(e,s){const r=await e.prepare(`
...
`))}catch(o){console.error("[SSE] Update failed:",o)}},3e4)},cancel(){console.log(`[SSE] Client disconnected from stream ${e}`),t&&clearInterval(t)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function pn(e,s){const r=new TextEncoder;let t=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Chat] Client connected to stream ${e}`);try{const i=await s.DB.prepare(`
          SELECT 
            id,
            user_id,
            user_name,
...
`))}catch(i){console.error("[SSE Chat] Polling failed:",i)}},5e3)},cancel(){console.log(`[SSE Chat] Client disconnected from stream ${e}`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function mn(e,s){const r=new TextEncoder;let t=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Orders] Seller ${e} connected`);try{const i=await s.DB.prepare(`
...
`))}catch(i){console.error("[SSE Orders] Polling failed:",i)}},1e4)},cancel(){console.log(`[SSE Orders] Seller ${e} disconnected`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function _n(e,s){const r=new TextEncoder;let t;const a=new ReadableStream({async start(n){console.log(`[SSE Stock] Seller ${e} connected`),t=setInterval(async()=>{try{const o=await s.DB.prepare(`
            SELECT 
              id,
              name,
              stock,
...
`))}catch(o){console.error("[SSE Stock] Polling failed:",o)}},6e4)},cancel(){console.log(`[SSE Stock] Seller ${e} disconnected`),t&&clearInterval(t)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function fn(e,s,r,t){await e.prepare(`
    INSERT OR REPLACE INTO push_subscriptions 
    (user_id, user_type, endpoint, p256dh, auth, created_at, updated_at)
    VALUES (?, ?, ?, ?, ?, datetime('now'), datetime('now'))
  `).bind(s,r,t.endpoint,t.keys.p256dh,t.keys.auth).run(),console.log(`[Push] Subscription saved for ${r} ${s}`)}async function En(e,s){await e.prepare(`
    DELETE FROM push_subscriptions WHERE endpoint = ?
  `).bind(s).run(),console.log(`[Push] Subscription deleted: ${s}`)}function hn(e){if(e.req.method!=="GET")return!1;const s=e.req.header("Authorization"),r=e.req.header("X-Session-Token");if(s||r)return!1;const a=new URL(e.req.url).pathname;return!(a.includes("/api/products/")&&a.includes("/stock")||a.includes("/api/streams/")&&a.includes("/status")||a.includes("/current-product")||a.includes("/api/chat")||a.includes("/api/sse")||a.includes("/api/orders")||a.includes("/api/payment"))}function gn(e,s){return s||new URL(e.req.url).toString()}function yn(e){const s=[];return s.push("public"),s.push(`max-age=${e.ttl}`),e.sMaxAge!==void 0?s.push(`s-maxage=${e.sMaxAge}`):s.push(`s-maxage=${e.ttl}`),e.staleWhileRevalidate&&s.push(`stale-while-revalidate=${e.staleWhileRevalidate}`),s.join(", ")}function rr(e){return async(s,r)=>{var i;if(e.skipCache||!hn(s))return r();const t=gn(s,e.cacheKey),a=caches.default;let n=await a.match(t);if(n){console.log(`[Cache HIT] ${t}`);const c=new Headers(n.headers);return c.set("X-Cache","HIT"),c.set("X-Cache-Key",t),new Response(n.body,{status:n.status,statusText:n.statusText,headers:c})}console.log(`[Cache MISS] ${t}`),await r();const o=s.res;if(o.status>=200&&o.status<300){const c=yn(e);o.headers.set("Cache-Control",c),o.headers.set("X-Cache","MISS"),o.headers.set("X-Cache-Key",t);const l=e.varyBy||["Accept-Encoding"];o.headers.set("Vary",l.join(", "));const u=o.clone();(i=s.executionCtx)==null||i.waitUntil(a.put(t,u))}}}const tr={products:{ttl:10,sMaxAge:60,staleWhileRevalidate:120},liveStreams:{ttl:5,sMaxAge:10,staleWhileRevalidate:30},microCache:{ttl:10,sMaxAge:10,staleWhileRevalidate:30}};class bn extends Error{constructor(s,r,t,a){super(t),this.statusCode=s,this.code=r,this.details=a,this.name="AppError",Error.captureStackTrace(this,this.constructor)}}async function wn(e,s,r,t){if(e)try{const a={title:`✅ ${s}`,description:r,color:3066993,fields:[],timestamp:new Date().toISOString(),footer:{text:"UR LIVE Monitor"}};if(t)for(const[n,o]of Object.entries(t))a.fields.push({name:n,value:String(o),inline:!0});await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({embeds:[a]})})}catch(a){console.error("[Discord] Failed to send success alert:",a)}}async function Sn(e,s,r){if(e)try{const t=["📊 **KV 사용량 경고**","","현재 사용량:",`• 읽기: ${s.toFixed(1)}%`,`• 쓰기: ${r.toFixed(1)}%`,"","50% 이상 사용 중입니다. 유료 플랜 업그레이드를 고려하세요.","https://dash.cloudflare.com"].join(`
`);await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:t})})}catch(t){console.error("[Discord] Failed to send KV warning:",t)}}class Tn{constructor(s){this.accessToken=null,this.tokenExpiry=0,this.databaseURL=s.FIREBASE_DATABASE_URL,this.projectId=s.FIREBASE_PROJECT_ID,this.privateKey=s.FIREBASE_PRIVATE_KEY,this.clientEmail=s.FIREBASE_CLIENT_EMAIL,(!this.databaseURL||!this.projectId||!this.privateKey||!this.clientEmail)&&console.warn("⚠️ Firebase Admin credentials not configured, using unauthenticated mode")}async set(s,r){const t=`${this.databaseURL}/${s}.json`,a=await fetch(t,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const n=await a.text();throw console.error(`❌ Firebase set failed for ${s}:`,n),new Error(`Firebase set failed: ${a.statusText}`)}console.log(`✅ Firebase: Set data at ${s}`)}async update(s,r){const t=`${this.databaseURL}/${s}.json`,a=await fetch(t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const n=await a.text();throw console.error(`❌ Firebase update failed for ${s}:`,n),new Error(`Firebase update failed: ${a.statusText}`)}console.log(`✅ Firebase: Updated data at ${s}`)}async get(s){const r=`${this.databaseURL}/${s}.json`,t=await fetch(r,{method:"GET"});if(!t.ok)throw new Error(`Firebase get failed: ${t.statusText}`);return await t.json()}async delete(s){const r=`${this.databaseURL}/${s}.json`,t=await fetch(r,{method:"DELETE"});if(!t.ok)throw new Error(`Firebase delete failed: ${t.statusText}`);console.log(`✅ Firebase: Deleted data at ${s}`)}async updateStreamStatus(s,r){try{await this.update(`streams/stream${s}`,{...r,updated_at:Date.now()}),console.log(`✅ Firebase: Stream ${s} updated`,r)}catch(t){console.error(`❌ Firebase: Failed to update stream ${s}`,t)}}async updateProductStock(s,r,t){try{await this.update(`products/product${s}`,{id:s,stock:r,...t,updated_at:Date.now()}),console.log(`✅ Firebase: Product ${s} stock updated to ${r}`)}catch(a){console.error(`❌ Firebase: Failed to update product ${s}`,a)}}async changeCurrentProduct(s,r){try{await this.updateStreamStatus(s,{current_product_id:r}),console.log(`✅ Firebase: Stream ${s} current product changed to ${r}`)}catch(t){console.error(`❌ Firebase: Failed to change product for stream ${s}`,t)}}async sendLowStockAlert(s,r,t){try{const a=`chats/stream${s}`,n=Date.now();await this.set(`${a}/alert_${n}`,{username:"시스템",text:`⚠️ ${r}의 재고가 ${t}개 남았습니다!`,timestamp:n,isSystem:!0}),console.log(`✅ Firebase: Low stock alert sent for stream ${s}`)}catch(a){console.error("❌ Firebase: Failed to send low stock alert",a)}}async sendSoldOutAlert(s,r){try{const t=`chats/stream${s}`,a=Date.now();await this.set(`${t}/soldout_${a}`,{username:"시스템",text:`🔴 ${r}이(가) 품절되었습니다!`,timestamp:a,isSystem:!0}),console.log(`✅ Firebase: Sold out alert sent for stream ${s}`)}catch(t){console.error("❌ Firebase: Failed to send sold out alert",t)}}async createCustomToken(s,r){try{if(console.log(`[Firebase Custom Token] Creating for UID: ${s}`),console.log("[Firebase Custom Token] Claims:",JSON.stringify(r)),!this.privateKey||!this.clientEmail||!this.projectId){const b=[];throw this.privateKey||b.push("FIREBASE_PRIVATE_KEY"),this.clientEmail||b.push("FIREBASE_CLIENT_EMAIL"),this.projectId||b.push("FIREBASE_PROJECT_ID"),new Error(`Firebase credentials not configured: missing ${b.join(", ")}`)}console.log(`[Firebase Custom Token] Using project: ${this.projectId}`),console.log(`[Firebase Custom Token] Using service account: ${this.clientEmail}`);const t={alg:"RS256",typ:"JWT"},a=Math.floor(Date.now()/1e3),n={iss:this.clientEmail,sub:this.clientEmail,aud:"https://identitytoolkit.googleapis.com/google.identity.identitytoolkit.v1.IdentityToolkit",iat:a,exp:a+3600,uid:s,claims:r||{}},o=b=>{const g=JSON.stringify(b),T=new TextEncoder().encode(g);let y="";for(let L=0;L<T.length;L++)y+=String.fromCharCode(T[L]);return btoa(y).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")};console.log("[Firebase Custom Token] Encoding header and payload...");const i=o(t),c=o(n),l=`${i}.${c}`;console.log("[Firebase Custom Token] Parsing private key...");const u=this.privateKey.replace(/\\n/g,`
`);if(!u.includes("-----BEGIN PRIVATE KEY-----"))throw new Error("Invalid private key format: missing PEM header");if(!u.includes("-----END PRIVATE KEY-----"))throw new Error("Invalid private key format: missing PEM footer");console.log("[Firebase Custom Token] Converting PEM to DER...");const d=await this.pemToDer(u);console.log("[Firebase Custom Token] Importing crypto key...");const m=await crypto.subtle.importKey("pkcs8",d,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]);console.log("[Firebase Custom Token] Signing token...");const _=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",m,new TextEncoder().encode(l)),h=btoa(String.fromCharCode(...new Uint8Array(_))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),w=`${l}.${h}`;return console.log("[Firebase Custom Token] ✅ Token created successfully"),w}catch(t){throw console.error("[Firebase Custom Token] ❌ Failed to create token:",t),console.error("[Firebase Custom Token] Error name:",t.name),console.error("[Firebase Custom Token] Error message:",t.message),console.error("[Firebase Custom Token] Error stack:",t.stack),new Error(`Failed to create Firebase custom token: ${t.message}`)}}async pemToDer(s){const a=s.substring("-----BEGIN PRIVATE KEY-----".length,s.length-"-----END PRIVATE KEY-----".length-1).trim(),n=atob(a),o=new Uint8Array(n.length);for(let i=0;i<n.length;i++)o[i]=n.charCodeAt(i);return o.buffer}}function Pe(e){return new Tn(e)}const ar=crypto,nt=e=>e instanceof CryptoKey,Ts=new TextEncoder,Fs=new TextDecoder;function Rn(...e){const s=e.reduce((a,{length:n})=>a+n,0),r=new Uint8Array(s);let t=0;for(const a of e)r.set(a,t),t+=a.length;return r}const In=e=>{const s=atob(e),r=new Uint8Array(s.length);for(let t=0;t<s.length;t++)r[t]=s.charCodeAt(t);return r},Me=e=>{let s=e;s instanceof Uint8Array&&(s=Fs.decode(s)),s=s.replace(/-/g,"+").replace(/_/g,"/").replace(/\s/g,"");try{return In(s)}catch{throw new TypeError("The input to be decoded is not correctly encoded.")}};class X extends Error{constructor(s,r){var t;super(s,r),this.code="ERR_JOSE_GENERIC",this.name=this.constructor.name,(t=Error.captureStackTrace)==null||t.call(Error,this,this.constructor)}}X.code="ERR_JOSE_GENERIC";class ie extends X{constructor(s,r,t="unspecified",a="unspecified"){super(s,{cause:{claim:t,reason:a,payload:r}}),this.code="ERR_JWT_CLAIM_VALIDATION_FAILED",this.claim=t,this.reason=a,this.payload=r}}ie.code="ERR_JWT_CLAIM_VALIDATION_FAILED";class ds extends X{constructor(s,r,t="unspecified",a="unspecified"){super(s,{cause:{claim:t,reason:a,payload:r}}),this.code="ERR_JWT_EXPIRED",this.claim=t,this.reason=a,this.payload=r}}ds.code="ERR_JWT_EXPIRED";class ot extends X{constructor(){super(...arguments),this.code="ERR_JOSE_ALG_NOT_ALLOWED"}}ot.code="ERR_JOSE_ALG_NOT_ALLOWED";class me extends X{constructor(){super(...arguments),this.code="ERR_JOSE_NOT_SUPPORTED"}}me.code="ERR_JOSE_NOT_SUPPORTED";class vn extends X{constructor(s="decryption operation failed",r){super(s,r),this.code="ERR_JWE_DECRYPTION_FAILED"}}vn.code="ERR_JWE_DECRYPTION_FAILED";class An extends X{constructor(){super(...arguments),this.code="ERR_JWE_INVALID"}}An.code="ERR_JWE_INVALID";class V extends X{constructor(){super(...arguments),this.code="ERR_JWS_INVALID"}}V.code="ERR_JWS_INVALID";class ys extends X{constructor(){super(...arguments),this.code="ERR_JWT_INVALID"}}ys.code="ERR_JWT_INVALID";class Dn extends X{constructor(){super(...arguments),this.code="ERR_JWK_INVALID"}}Dn.code="ERR_JWK_INVALID";class nr extends X{constructor(){super(...arguments),this.code="ERR_JWKS_INVALID"}}nr.code="ERR_JWKS_INVALID";class or extends X{constructor(s="no applicable key found in the JSON Web Key Set",r){super(s,r),this.code="ERR_JWKS_NO_MATCHING_KEY"}}or.code="ERR_JWKS_NO_MATCHING_KEY";class it extends X{constructor(s="multiple matching keys found in the JSON Web Key Set",r){super(s,r),this.code="ERR_JWKS_MULTIPLE_MATCHING_KEYS"}}it.code="ERR_JWKS_MULTIPLE_MATCHING_KEYS";class ct extends X{constructor(s="request timed out",r){super(s,r),this.code="ERR_JWKS_TIMEOUT"}}ct.code="ERR_JWKS_TIMEOUT";class lt extends X{constructor(s="signature verification failed",r){super(s,r),this.code="ERR_JWS_SIGNATURE_VERIFICATION_FAILED"}}lt.code="ERR_JWS_SIGNATURE_VERIFICATION_FAILED";function pe(e,s="algorithm.name"){return new TypeError(`CryptoKey does not support this operation, its ${s} must be ${e}`)}function is(e,s){return e.name===s}function Bs(e){return parseInt(e.name.slice(4),10)}function On(e){switch(e){case"ES256":return"P-256";case"ES384":return"P-384";case"ES512":return"P-521";default:throw new Error("unreachable")}}function kn(e,s){if(s.length&&!s.some(r=>e.usages.includes(r))){let r="CryptoKey does not support this operation, its usages must include ";if(s.length>2){const t=s.pop();r+=`one of ${s.join(", ")}, or ${t}.`}else s.length===2?r+=`one of ${s[0]} or ${s[1]}.`:r+=`${s[0]}.`;throw new TypeError(r)}}function Cn(e,s,...r){switch(s){case"HS256":case"HS384":case"HS512":{if(!is(e.algorithm,"HMAC"))throw pe("HMAC");const t=parseInt(s.slice(2),10);if(Bs(e.algorithm.hash)!==t)throw pe(`SHA-${t}`,"algorithm.hash");break}case"RS256":case"RS384":case"RS512":{if(!is(e.algorithm,"RSASSA-PKCS1-v1_5"))throw pe("RSASSA-PKCS1-v1_5");const t=parseInt(s.slice(2),10);if(Bs(e.algorithm.hash)!==t)throw pe(`SHA-${t}`,"algorithm.hash");break}case"PS256":case"PS384":case"PS512":{if(!is(e.algorithm,"RSA-PSS"))throw pe("RSA-PSS");const t=parseInt(s.slice(2),10);if(Bs(e.algorithm.hash)!==t)throw pe(`SHA-${t}`,"algorithm.hash");break}case"EdDSA":{if(e.algorithm.name!=="Ed25519"&&e.algorithm.name!=="Ed448")throw pe("Ed25519 or Ed448");break}case"Ed25519":{if(!is(e.algorithm,"Ed25519"))throw pe("Ed25519");break}case"ES256":case"ES384":case"ES512":{if(!is(e.algorithm,"ECDSA"))throw pe("ECDSA");const t=On(s);if(e.algorithm.namedCurve!==t)throw pe(t,"algorithm.namedCurve");break}default:throw new TypeError("CryptoKey does not support this operation")}kn(e,r)}function ut(e,s,...r){var t;if(r=r.filter(Boolean),r.length>2){const a=r.pop();e+=`one of type ${r.join(", ")}, or ${a}.`}else r.length===2?e+=`one of type ${r[0]} or ${r[1]}.`:e+=`of type ${r[0]}.`;return s==null?e+=` Received ${s}`:typeof s=="function"&&s.name?e+=` Received function ${s.name}`:typeof s=="object"&&s!=null&&(t=s.constructor)!=null&&t.name&&(e+=` Received an instance of ${s.constructor.name}`),e}const Er=(e,...s)=>ut("Key must be ",e,...s);function dt(e,s,...r){return ut(`Key for the ${e} algorithm must be `,s,...r)}const pt=e=>nt(e)?!0:(e==null?void 0:e[Symbol.toStringTag])==="KeyObject",Cs=["CryptoKey"],Nn=(...e)=>{const s=e.filter(Boolean);if(s.length===0||s.length===1)return!0;let r;for(const t of s){const a=Object.keys(t);if(!r||r.size===0){r=new Set(a);continue}for(const n of a){if(r.has(n))return!1;r.add(n)}}return!0};function jn(e){return typeof e=="object"&&e!==null}function ve(e){if(!jn(e)||Object.prototype.toString.call(e)!=="[object Object]")return!1;if(Object.getPrototypeOf(e)===null)return!0;let s=e;for(;Object.getPrototypeOf(s)!==null;)s=Object.getPrototypeOf(s);return Object.getPrototypeOf(e)===s}const Ln=(e,s)=>{if(e.startsWith("RS")||e.startsWith("PS")){const{modulusLength:r}=s.algorithm;if(typeof r!="number"||r<2048)throw new TypeError(`${e} requires key modulusLength to be 2048 bits or larger`)}};function rs(e){return ve(e)&&typeof e.kty=="string"}function Mn(e){return e.kty!=="oct"&&typeof e.d=="string"}function Fn(e){return e.kty!=="oct"&&typeof e.d>"u"}function $n(e){return rs(e)&&e.kty==="oct"&&typeof e.k=="string"}function Un(e){let s,r;switch(e.kty){case"RSA":{switch(e.alg){case"PS256":case"PS384":case"PS512":s={name:"RSA-PSS",hash:`SHA-${e.alg.slice(-3)}`},r=e.d?["sign"]:["verify"];break;case"RS256":case"RS384":case"RS512":s={name:"RSASSA-PKCS1-v1_5",hash:`SHA-${e.alg.slice(-3)}`},r=e.d?["sign"]:["verify"];break;case"RSA-OAEP":case"RSA-OAEP-256":case"RSA-OAEP-384":case"RSA-OAEP-512":s={name:"RSA-OAEP",hash:`SHA-${parseInt(e.alg.slice(-3),10)||1}`},r=e.d?["decrypt","unwrapKey"]:["encrypt","wrapKey"];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}case"EC":{switch(e.alg){case"ES256":s={name:"ECDSA",namedCurve:"P-256"},r=e.d?["sign"]:["verify"];break;case"ES384":s={name:"ECDSA",namedCurve:"P-384"},r=e.d?["sign"]:["verify"];break;case"ES512":s={name:"ECDSA",namedCurve:"P-521"},r=e.d?["sign"]:["verify"];break;case"ECDH-ES":case"ECDH-ES+A128KW":case"ECDH-ES+A192KW":case"ECDH-ES+A256KW":s={name:"ECDH",namedCurve:e.crv},r=e.d?["deriveBits"]:[];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}case"OKP":{switch(e.alg){case"Ed25519":s={name:"Ed25519"},r=e.d?["sign"]:["verify"];break;case"EdDSA":s={name:e.crv},r=e.d?["sign"]:["verify"];break;case"ECDH-ES":case"ECDH-ES+A128KW":case"ECDH-ES+A192KW":case"ECDH-ES+A256KW":s={name:e.crv},r=e.d?["deriveBits"]:[];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}default:throw new me('Invalid or unsupported JWK "kty" (Key Type) Parameter value')}return{algorithm:s,keyUsages:r}}const mt=async e=>{if(!e.alg)throw new TypeError('"alg" argument is required when "jwk.alg" is not present');const{algorithm:s,keyUsages:r}=Un(e),t=[s,e.ext??!1,e.key_ops??r],a={...e};return delete a.alg,delete a.use,ar.subtle.importKey("jwk",a,...t)},_t=e=>Me(e);let He,Ke;const ft=e=>(e==null?void 0:e[Symbol.toStringTag])==="KeyObject",Ns=async(e,s,r,t,a=!1)=>{let n=e.get(s);if(n!=null&&n[t])return n[t];const o=await mt({...r,alg:t});return a&&Object.freeze(s),n?n[t]=o:e.set(s,{[t]:o}),o},Pn=(e,s)=>{if(ft(e)){let r=e.export({format:"jwk"});return delete r.d,delete r.dp,delete r.dq,delete r.p,delete r.q,delete r.qi,r.k?_t(r.k):(Ke||(Ke=new WeakMap),Ns(Ke,e,r,s))}return rs(e)?e.k?Me(e.k):(Ke||(Ke=new WeakMap),Ns(Ke,e,e,s,!0)):e},xn=(e,s)=>{if(ft(e)){let r=e.export({format:"jwk"});return r.k?_t(r.k):(He||(He=new WeakMap),Ns(He,e,r,s))}return rs(e)?e.k?Me(e.k):(He||(He=new WeakMap),Ns(He,e,e,s,!0)):e},Wn={normalizePublicKey:Pn,normalizePrivateKey:xn};async function Et(e,s){if(!ve(e))throw new TypeError("JWK must be an object");switch(s||(s=e.alg),e.kty){case"oct":if(typeof e.k!="string"||!e.k)throw new TypeError('missing "k" (Key Value) Parameter value');return Me(e.k);case"RSA":if("oth"in e&&e.oth!==void 0)throw new me('RSA JWK "oth" (Other Primes Info) Parameter value is not supported');case"EC":case"OKP":return mt({...e,alg:s});default:throw new me('Unsupported "kty" (Key Type) Parameter value')}}const Ye=e=>e==null?void 0:e[Symbol.toStringTag],zs=(e,s,r)=>{var t,a;if(s.use!==void 0&&s.use!=="sig")throw new TypeError("Invalid key for this operation, when present its use must be sig");if(s.key_ops!==void 0&&((a=(t=s.key_ops).includes)==null?void 0:a.call(t,r))!==!0)throw new TypeError(`Invalid key for this operation, when present its key_ops must include ${r}`);if(s.alg!==void 0&&s.alg!==e)throw new TypeError(`Invalid key for this operation, when present its alg must be ${e}`);return!0},qn=(e,s,r,t)=>{if(!(s instanceof Uint8Array)){if(t&&rs(s)){if($n(s)&&zs(e,s,r))return;throw new TypeError('JSON Web Key for symmetric algorithms must have JWK "kty" (Key Type) equal to "oct" and the JWK "k" (Key Value) present')}if(!pt(s))throw new TypeError(dt(e,s,...Cs,"Uint8Array",t?"JSON Web Key":null));if(s.type!=="secret")throw new TypeError(`${Ye(s)} instances for symmetric algorithms must be of type "secret"`)}},Hn=(e,s,r,t)=>{if(t&&rs(s))switch(r){case"sign":if(Mn(s)&&zs(e,s,r))return;throw new TypeError("JSON Web Key for this operation be a private JWK");case"verify":if(Fn(s)&&zs(e,s,r))return;throw new TypeError("JSON Web Key for this operation be a public JWK")}if(!pt(s))throw new TypeError(dt(e,s,...Cs,t?"JSON Web Key":null));if(s.type==="secret")throw new TypeError(`${Ye(s)} instances for asymmetric algorithms must not be of type "secret"`);if(r==="sign"&&s.type==="public")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm signing must be of type "private"`);if(r==="decrypt"&&s.type==="public")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm decryption must be of type "private"`);if(s.algorithm&&r==="verify"&&s.type==="private")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm verifying must be of type "public"`);if(s.algorithm&&r==="encrypt"&&s.type==="private")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm encryption must be of type "public"`)};function ht(e,s,r,t){s.startsWith("HS")||s==="dir"||s.startsWith("PBES2")||/^A\d{3}(?:GCM)?KW$/.test(s)?qn(s,r,t,e):Hn(s,r,t,e)}ht.bind(void 0,!1);const hr=ht.bind(void 0,!0);function Kn(e,s,r,t,a){if(a.crit!==void 0&&(t==null?void 0:t.crit)===void 0)throw new e('"crit" (Critical) Header Parameter MUST be integrity protected');if(!t||t.crit===void 0)return new Set;if(!Array.isArray(t.crit)||t.crit.length===0||t.crit.some(o=>typeof o!="string"||o.length===0))throw new e('"crit" (Critical) Header Parameter MUST be an array of non-empty strings when present');let n;r!==void 0?n=new Map([...Object.entries(r),...s.entries()]):n=s;for(const o of t.crit){if(!n.has(o))throw new me(`Extension Header Parameter "${o}" is not recognized`);if(a[o]===void 0)throw new e(`Extension Header Parameter "${o}" is missing`);if(n.get(o)&&t[o]===void 0)throw new e(`Extension Header Parameter "${o}" MUST be integrity protected`)}return new Set(t.crit)}const Bn=(e,s)=>{if(s!==void 0&&(!Array.isArray(s)||s.some(r=>typeof r!="string")))throw new TypeError(`"${e}" option must be an array of strings`);if(s)return new Set(s)};function Jn(e,s){const r=`SHA-${e.slice(-3)}`;switch(e){case"HS256":case"HS384":case"HS512":return{hash:r,name:"HMAC"};case"PS256":case"PS384":case"PS512":return{hash:r,name:"RSA-PSS",saltLength:e.slice(-3)>>3};case"RS256":case"RS384":case"RS512":return{hash:r,name:"RSASSA-PKCS1-v1_5"};case"ES256":case"ES384":case"ES512":return{hash:r,name:"ECDSA",namedCurve:s.namedCurve};case"Ed25519":return{name:"Ed25519"};case"EdDSA":return{name:s.name};default:throw new me(`alg ${e} is not supported either by JOSE or your javascript runtime`)}}async function Vn(e,s,r){if(s=await Wn.normalizePublicKey(s,e),nt(s))return Cn(s,e,r),s;if(s instanceof Uint8Array){if(!e.startsWith("HS"))throw new TypeError(Er(s,...Cs));return ar.subtle.importKey("raw",s,{hash:`SHA-${e.slice(-3)}`,name:"HMAC"},!1,[r])}throw new TypeError(Er(s,...Cs,"Uint8Array","JSON Web Key"))}const Yn=async(e,s,r,t)=>{const a=await Vn(e,s,"verify");Ln(e,a);const n=Jn(e,a.algorithm);try{return await ar.subtle.verify(n,a,r,t)}catch{return!1}};async function zn(e,s,r){if(!ve(e))throw new V("Flattened JWS must be an object");if(e.protected===void 0&&e.header===void 0)throw new V('Flattened JWS must have either of the "protected" or "header" members');if(e.protected!==void 0&&typeof e.protected!="string")throw new V("JWS Protected Header incorrect type");if(e.payload===void 0)throw new V("JWS Payload missing");if(typeof e.signature!="string")throw new V("JWS Signature missing or incorrect type");if(e.header!==void 0&&!ve(e.header))throw new V("JWS Unprotected Header incorrect type");let t={};if(e.protected)try{const h=Me(e.protected);t=JSON.parse(Fs.decode(h))}catch{throw new V("JWS Protected Header is invalid")}if(!Nn(t,e.header))throw new V("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");const a={...t,...e.header},n=Kn(V,new Map([["b64",!0]]),r==null?void 0:r.crit,t,a);let o=!0;if(n.has("b64")&&(o=t.b64,typeof o!="boolean"))throw new V('The "b64" (base64url-encode payload) Header Parameter must be a boolean');const{alg:i}=a;if(typeof i!="string"||!i)throw new V('JWS "alg" (Algorithm) Header Parameter missing or invalid');const c=r&&Bn("algorithms",r.algorithms);if(c&&!c.has(i))throw new ot('"alg" (Algorithm) Header Parameter value not allowed');if(o){if(typeof e.payload!="string")throw new V("JWS Payload must be a string")}else if(typeof e.payload!="string"&&!(e.payload instanceof Uint8Array))throw new V("JWS Payload must be a string or an Uint8Array instance");let l=!1;typeof s=="function"?(s=await s(t,e),l=!0,hr(i,s,"verify"),rs(s)&&(s=await Et(s,i))):hr(i,s,"verify");const u=Rn(Ts.encode(e.protected??""),Ts.encode("."),typeof e.payload=="string"?Ts.encode(e.payload):e.payload);let d;try{d=Me(e.signature)}catch{throw new V("Failed to base64url decode the signature")}if(!await Yn(i,s,d,u))throw new lt;let _;if(o)try{_=Me(e.payload)}catch{throw new V("Failed to base64url decode the payload")}else typeof e.payload=="string"?_=Ts.encode(e.payload):_=e.payload;const f={payload:_};return e.protected!==void 0&&(f.protectedHeader=t),e.header!==void 0&&(f.unprotectedHeader=e.header),l?{...f,key:s}:f}async function Gn(e,s,r){if(e instanceof Uint8Array&&(e=Fs.decode(e)),typeof e!="string")throw new V("Compact JWS must be a string or Uint8Array");const{0:t,1:a,2:n,length:o}=e.split(".");if(o!==3)throw new V("Invalid Compact JWS");const i=await zn({payload:a,protected:t,signature:n},s,r),c={payload:i.payload,protectedHeader:i.protectedHeader};return typeof s=="function"?{...c,key:i.key}:c}const Xn=e=>Math.floor(e.getTime()/1e3),gt=60,yt=gt*60,ir=yt*24,Qn=ir*7,Zn=ir*365.25,eo=/^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i,gr=e=>{const s=eo.exec(e);if(!s||s[4]&&s[1])throw new TypeError("Invalid time period format");const r=parseFloat(s[2]),t=s[3].toLowerCase();let a;switch(t){case"sec":case"secs":case"second":case"seconds":case"s":a=Math.round(r);break;case"minute":case"minutes":case"min":case"mins":case"m":a=Math.round(r*gt);break;case"hour":case"hours":case"hr":case"hrs":case"h":a=Math.round(r*yt);break;case"day":case"days":case"d":a=Math.round(r*ir);break;case"week":case"weeks":case"w":a=Math.round(r*Qn);break;default:a=Math.round(r*Zn);break}return s[1]==="-"||s[4]==="ago"?-a:a},yr=e=>e.toLowerCase().replace(/^application\//,""),so=(e,s)=>typeof e=="string"?s.includes(e):Array.isArray(e)?s.some(Set.prototype.has.bind(new Set(e))):!1,ro=(e,s,r={})=>{let t;try{t=JSON.parse(Fs.decode(s))}catch{}if(!ve(t))throw new ys("JWT Claims Set must be a top-level JSON object");const{typ:a}=r;if(a&&(typeof e.typ!="string"||yr(e.typ)!==yr(a)))throw new ie('unexpected "typ" JWT header value',t,"typ","check_failed");const{requiredClaims:n=[],issuer:o,subject:i,audience:c,maxTokenAge:l}=r,u=[...n];l!==void 0&&u.push("iat"),c!==void 0&&u.push("aud"),i!==void 0&&u.push("sub"),o!==void 0&&u.push("iss");for(const f of new Set(u.reverse()))if(!(f in t))throw new ie(`missing required "${f}" claim`,t,f,"missing");if(o&&!(Array.isArray(o)?o:[o]).includes(t.iss))throw new ie('unexpected "iss" claim value',t,"iss","check_failed");if(i&&t.sub!==i)throw new ie('unexpected "sub" claim value',t,"sub","check_failed");if(c&&!so(t.aud,typeof c=="string"?[c]:c))throw new ie('unexpected "aud" claim value',t,"aud","check_failed");let d;switch(typeof r.clockTolerance){case"string":d=gr(r.clockTolerance);break;case"number":d=r.clockTolerance;break;case"undefined":d=0;break;default:throw new TypeError("Invalid clockTolerance option type")}const{currentDate:m}=r,_=Xn(m||new Date);if((t.iat!==void 0||l)&&typeof t.iat!="number")throw new ie('"iat" claim must be a number',t,"iat","invalid");if(t.nbf!==void 0){if(typeof t.nbf!="number")throw new ie('"nbf" claim must be a number',t,"nbf","invalid");if(t.nbf>_+d)throw new ie('"nbf" claim timestamp check failed',t,"nbf","check_failed")}if(t.exp!==void 0){if(typeof t.exp!="number")throw new ie('"exp" claim must be a number',t,"exp","invalid");if(t.exp<=_-d)throw new ds('"exp" claim timestamp check failed',t,"exp","check_failed")}if(l){const f=_-t.iat,h=typeof l=="number"?l:gr(l);if(f-d>h)throw new ds('"iat" claim timestamp check failed (too far in the past)',t,"iat","check_failed");if(f<0-d)throw new ie('"iat" claim timestamp check failed (it should be in the past)',t,"iat","check_failed")}return t};async function to(e,s,r){var o;const t=await Gn(e,s,r);if((o=t.protectedHeader.crit)!=null&&o.includes("b64")&&t.protectedHeader.b64===!1)throw new ys("JWTs MUST NOT use unencoded payload");const n={payload:ro(t.protectedHeader,t.payload,r),protectedHeader:t.protectedHeader};return typeof s=="function"?{...n,key:t.key}:n}function ao(e){switch(typeof e=="string"&&e.slice(0,2)){case"RS":case"PS":return"RSA";case"ES":return"EC";case"Ed":return"OKP";default:throw new me('Unsupported "alg" value for a JSON Web Key Set')}}function no(e){return e&&typeof e=="object"&&Array.isArray(e.keys)&&e.keys.every(oo)}function oo(e){return ve(e)}function bt(e){return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}class io{constructor(s){if(this._cached=new WeakMap,!no(s))throw new nr("JSON Web Key Set malformed");this._jwks=bt(s)}async getKey(s,r){const{alg:t,kid:a}={...s,...r==null?void 0:r.header},n=ao(t),o=this._jwks.keys.filter(l=>{let u=n===l.kty;if(u&&typeof a=="string"&&(u=a===l.kid),u&&typeof l.alg=="string"&&(u=t===l.alg),u&&typeof l.use=="string"&&(u=l.use==="sig"),u&&Array.isArray(l.key_ops)&&(u=l.key_ops.includes("verify")),u)switch(t){case"ES256":u=l.crv==="P-256";break;case"ES256K":u=l.crv==="secp256k1";break;case"ES384":u=l.crv==="P-384";break;case"ES512":u=l.crv==="P-521";break;case"Ed25519":u=l.crv==="Ed25519";break;case"EdDSA":u=l.crv==="Ed25519"||l.crv==="Ed448";break}return u}),{0:i,length:c}=o;if(c===0)throw new or;if(c!==1){const l=new it,{_cached:u}=this;throw l[Symbol.asyncIterator]=async function*(){for(const d of o)try{yield await br(u,d,t)}catch{}},l}return br(this._cached,i,t)}}async function br(e,s,r){const t=e.get(s)||e.set(s,{}).get(s);if(t[r]===void 0){const a=await Et({...s,ext:!0},r);if(a instanceof Uint8Array||a.type!=="public")throw new nr("JSON Web Key Set members must be public keys");t[r]=a}return t[r]}function wr(e){const s=new io(e),r=async(t,a)=>s.getKey(t,a);return Object.defineProperties(r,{jwks:{value:()=>bt(s._jwks),enumerable:!0,configurable:!1,writable:!1}}),r}const co=async(e,s,r)=>{let t,a,n=!1;typeof AbortController=="function"&&(t=new AbortController,a=setTimeout(()=>{n=!0,t.abort()},s));const o=await fetch(e.href,{signal:t?t.signal:void 0,redirect:"manual",headers:r.headers}).catch(i=>{throw n?new ct:i});if(a!==void 0&&clearTimeout(a),o.status!==200)throw new X("Expected 200 OK from the JSON Web Key Set HTTP response");try{return await o.json()}catch{throw new X("Failed to parse the JSON Web Key Set HTTP response as JSON")}};function lo(){return typeof WebSocketPair<"u"||typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"||typeof EdgeRuntime<"u"&&EdgeRuntime==="vercel"}let Gs;var Rs,Ur;(typeof navigator>"u"||!((Ur=(Rs=navigator.userAgent)==null?void 0:Rs.startsWith)!=null&&Ur.call(Rs,"Mozilla/5.0 ")))&&(Gs="jose/v5.10.0");const Js=Symbol();function uo(e,s){return!(typeof e!="object"||e===null||!("uat"in e)||typeof e.uat!="number"||Date.now()-e.uat>=s||!("jwks"in e)||!ve(e.jwks)||!Array.isArray(e.jwks.keys)||!Array.prototype.every.call(e.jwks.keys,ve))}class po{constructor(s,r){if(!(s instanceof URL))throw new TypeError("url must be an instance of URL");this._url=new URL(s.href),this._options={agent:r==null?void 0:r.agent,headers:r==null?void 0:r.headers},this._timeoutDuration=typeof(r==null?void 0:r.timeoutDuration)=="number"?r==null?void 0:r.timeoutDuration:5e3,this._cooldownDuration=typeof(r==null?void 0:r.cooldownDuration)=="number"?r==null?void 0:r.cooldownDuration:3e4,this._cacheMaxAge=typeof(r==null?void 0:r.cacheMaxAge)=="number"?r==null?void 0:r.cacheMaxAge:6e5,(r==null?void 0:r[Js])!==void 0&&(this._cache=r==null?void 0:r[Js],uo(r==null?void 0:r[Js],this._cacheMaxAge)&&(this._jwksTimestamp=this._cache.uat,this._local=wr(this._cache.jwks)))}coolingDown(){return typeof this._jwksTimestamp=="number"?Date.now()<this._jwksTimestamp+this._cooldownDuration:!1}fresh(){return typeof this._jwksTimestamp=="number"?Date.now()<this._jwksTimestamp+this._cacheMaxAge:!1}async getKey(s,r){(!this._local||!this.fresh())&&await this.reload();try{return await this._local(s,r)}catch(t){if(t instanceof or&&this.coolingDown()===!1)return await this.reload(),this._local(s,r);throw t}}async reload(){this._pendingFetch&&lo()&&(this._pendingFetch=void 0);const s=new Headers(this._options.headers);Gs&&!s.has("User-Agent")&&(s.set("User-Agent",Gs),this._options.headers=Object.fromEntries(s.entries())),this._pendingFetch||(this._pendingFetch=co(this._url,this._timeoutDuration,this._options).then(r=>{this._local=wr(r),this._cache&&(this._cache.uat=Date.now(),this._cache.jwks=r),this._jwksTimestamp=Date.now(),this._pendingFetch=void 0}).catch(r=>{throw this._pendingFetch=void 0,r})),await this._pendingFetch}}function mo(e,s){const r=new po(e,s),t=async(a,n)=>r.getKey(a,n);return Object.defineProperties(t,{coolingDown:{get:()=>r.coolingDown(),enumerable:!0,configurable:!1},fresh:{get:()=>r.fresh(),enumerable:!0,configurable:!1},reload:{value:()=>r.reload(),enumerable:!0,configurable:!1,writable:!1},reloading:{get:()=>!!r._pendingFetch,enumerable:!0,configurable:!1},jwks:{value:()=>{var a;return(a=r._local)==null?void 0:a.jwks()},enumerable:!0,configurable:!1,writable:!1}}),t}const _o="https://www.googleapis.com/service_accounts/v1/jwk/securetoken@system.gserviceaccount.com";let Ds=null;function fo(){return Ds||(Ds=mo(new URL(_o)),console.log("[Firebase Token] ✅ JWKS cache initialized")),Ds}function Eo(){Ds=null,console.warn("[Firebase Token] 🔄 JWKS cache invalidated")}async function wt(e,s){try{console.log("[Firebase Token] 🔍 Starting verification"),console.log("[Firebase Token] 📊 Token length:",e.length),console.log("[Firebase Token] 🏢 Project ID:",s);const r=fo(),{payload:t}=await to(e,r,{issuer:`https://securetoken.google.com/${s}`,audience:s,algorithms:["RS256"]});if(console.log("[Firebase Token] ✅ JWT signature verified"),!t.sub)throw new Error("Token missing subject (uid)");const a=Math.floor(Date.now()/1e3);if(t.exp&&t.exp<a)throw console.error("[Firebase Token] ❌ Token expired:",{exp:t.exp,now:a,expiredBy:a-t.exp}),new ds("Token has expired");if(t.iat&&t.iat>a+300)throw console.error("[Firebase Token] ❌ Token issued in future:",{iat:t.iat,now:a,diff:t.iat-a}),new Error("Token not yet valid (issued in future)");console.log("[Firebase Token] ✅ Time validation passed:",{iat:t.iat,exp:t.exp,now:a});const n=t.sub,o=typeof t.role=="string"?t.role:void 0,i=typeof t.userId=="number"?t.userId:void 0,c=typeof t.userName=="string"?t.userName:void 0,l=typeof t.email=="string"?t.email:void 0;return console.log("[Firebase Token] ✅ Token verified successfully"),console.log("[Firebase Token] 👤 User:",{uid:n,role:o,userId:i,userName:c,email:l?"exists":"none"}),{...t,uid:n,role:o,userId:i,userName:c,email:l}}catch(r){throw console.error("[Firebase Token] ❌ Verification failed:",{error:r instanceof Error?r.message:"Unknown",name:r instanceof Error?r.name:void 0,tokenPreview:e.substring(0,30)+"..."}),r instanceof ys&&r.message.includes("kid")&&(Eo(),console.warn("[Firebase Token] 🔄 JWKS cache invalidated → retry possible")),r}}function St(e){if(e instanceof ds)return{code:"TOKEN_EXPIRED",message:"Token has expired. Please login again."};if(e instanceof ys){if(e.message.includes("issuer"))return{code:"INVALID_ISSUER",message:"Token issuer mismatch"};if(e.message.includes("audience"))return{code:"INVALID_AUDIENCE",message:"Token audience mismatch"};if(e.message.includes("signature"))return{code:"INVALID_SIGNATURE",message:"Invalid token signature"};if(e.message.includes("kid"))return{code:"INVALID_KID",message:"Public key not found for token"}}return e instanceof Error&&e.message.includes("not yet valid")?{code:"TOKEN_NOT_YET_VALID",message:"Token issued in the future"}:{code:"VERIFICATION_FAILED",message:e instanceof Error?e.message:"Token verification failed"}}const _e=new Map;let Y={hits:0,misses:0,writes:0,evictions:0};function be(e){const s=_e.get(e);return s?s.expires<Date.now()?(_e.delete(e),Y.evictions++,Y.misses++,null):(Y.hits++,s.data):(Y.misses++,null)}function Q(e,s,r){const t=Date.now()+r*1e3;if(_e.set(e,{data:s,expires:t}),Y.writes++,_e.size>1e3){const a=_e.keys().next().value;a&&(_e.delete(a),Y.evictions++)}}function ho(e){let s=0;for(const r of _e.keys())r.includes(e)&&(_e.delete(r),s++);return s}async function ts(e,s){const r=Array.isArray(s)?s:[s];for(const t of r){const a=ho(t);a>0&&console.log(`[Cache] 🧹 메모리 캐시 삭제: ${t} (${a}개)`);try{await e.CACHE_KV.delete(t),console.log(`[Cache] 🧹 KV 캐시 삭제: ${t}`)}catch(n){console.error(`[Cache] ❌ KV 캐시 삭제 실패: ${t}`,n)}}}const as={LIVE_STREAMS:["streams:live","streams:all","streams:scheduled","live_streams:live:all:20:0","live_streams:"],PRODUCTS:["products:","featured_products"],CART:e=>[`cart:${e}`],ORDERS:e=>[`orders:${e}`],ALL:["streams:","live_streams:","products:","cart:","orders:"]};function go(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function yo(e){return{name:"tosspayments",async confirmPayment(s){try{const r=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),t=await r.json();if(!r.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message||"결제 승인 실패",rawData:t};let a={};t.card&&(a={cardCompany:t.card.company,cardNumber:t.card.number,installmentMonths:t.card.installmentPlanMonths||0});let n={};return t.virtualAccount&&(n={virtualAccountBank:t.virtualAccount.bankCode,virtualAccountNumber:t.virtualAccount.accountNumber,virtualAccountHolder:t.virtualAccount.customerName,virtualAccountDueDate:t.virtualAccount.dueDate}),{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,transactionId:t.transactionKey,...a,...n,rawData:t}}catch(r){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message,rawData:null}}},async cancelPayment(s){try{const r={cancelReason:s.cancelReason};s.cancelAmount&&(r.cancelAmount=s.cancelAmount);const t=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(r)}),a=await t.json();return t.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(r){return{success:!1,error:r.message}}},async getPayment(s){try{const r=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),t=await r.json();if(!r.ok)throw new Error(t.message);return{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,rawData:t}}catch(r){throw r}}}}function bo(e,s){switch(e.toLowerCase()){case"tosspayments":return yo(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const p=new et;p.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{ha(e.env),ga(e.env)}catch(t){console.error("[ENV] Validation failed:",t)}await s()});async function wo(e){try{const s=e.req.header("Authorization");console.log("[Firebase Auth] 🔍 Authorization header:",s?`Bearer ${s.substring(7,50)}...`:"MISSING");const r=(s==null?void 0:s.replace("Bearer ",""))||"";if(!r)return console.warn("[Firebase Auth] ❌ No token provided"),null;console.log("[Firebase Auth] 🔑 Token length:",r.length),console.log("[Firebase Auth] 🔑 Token preview:",r.substring(0,50)+"...");try{const t=r.split(".");if(t.length===3){const a=t[1],n=atob(a.replace(/-/g,"+").replace(/_/g,"/")),o=JSON.parse(n);if(console.log("[Firebase Auth] 🔍 Token Payload (BEFORE verification):",{iss:o.iss,aud:o.aud,sub:o.sub,exp:o.exp,iat:o.iat}),o.iss&&o.iss.includes("iam.gserviceaccount.com"))return console.error("[Firebase Auth] 🚨🚨🚨 CUSTOM TOKEN DETECTED! 🚨🚨🚨"),console.error("[Firebase Auth] ❌ This is a Custom Token, not an ID Token!"),console.error("[Firebase Auth] ❌ Custom Token should be exchanged for ID Token on client!"),{userId:0,userType:"",errorDetails:{code:"CUSTOM_TOKEN_DETECTED",message:"Custom Token should be exchanged for ID Token on client",tokenInfo:{iss:o.iss,aud:o.aud,sub:o.sub}}}}}catch(t){console.warn("[Firebase Auth] ⚠️ Could not decode token payload (might be corrupted):",t)}try{console.log("[Firebase Auth] 🔐 Verifying token with project:",e.env.FIREBASE_PROJECT_ID||"urteam-live-commerce-5b284");const t=await wt(r,e.env.FIREBASE_PROJECT_ID||"urteam-live-commerce-5b284");if(console.log("[Firebase Auth] ✅ Firebase token verified!"),console.log("[Firebase Auth] 📋 Token payload:",{uid:t.uid,iss:t.iss,aud:t.aud,exp:t.exp,iat:t.iat}),t.userId){console.log("[Firebase Auth] 🎯 Using userId from Custom Claims:",t.userId);const o=await e.env.DB.prepare(`
  ...
  `).bind(s).first();if(!r)return null;const t=await e.prepare("SELECT id, product_id, option_type, option_value, price_adjustment, stock, created_at FROM product_options WHERE product_id = ?").bind(s).all();return{product:r,options:t.results}}p.get("/api/products/:id/stock",rr(tr.microCache),async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=await s.prepare("SELECT id, name, stock FROM products WHERE id = ? AND is_active = 1").bind(r).first();return t?e.json({success:!0,data:{productId:t.id,productName:t.name,stock:t.stock,available:t.stock>0}}):e.json({success:!1,error:"Product not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/products",async e=>{const{DB:s}=e.env,r=e.req.param("streamId");try{const t=await s.prepare(`
    ...
    `).bind(l,a,n||null,n||null).first();let m;if(d){const _=d.quantity+o;await s.prepare(`
      ...
      `).bind(_,i,d.id).run(),m=d.id}else m=(await s.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(l,a,n||null,o,i,c||null).run()).meta.last_row_id;return e.json({success:!0,data:{id:m,isUpdate:!!d}})}catch(r){return console.error("[API /api/cart POST] Error:",r),console.error("[API /api/cart POST] Error message:",r.message),console.error("[API /api/cart POST] Error stack:",r.stack),e.json({success:!1,error:"Failed to add to cart: "+(r.message||"Unknown error")},500)}});p.delete("/api/cart/:cartItemId",j,async e=>{const{DB:s}=e.env,r=e.req.param("cartItemId");try{return await s.prepare("DELETE FROM cart_items WHERE id = ?").bind(r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/cart/clear/:userId",j,Ro("cart"),async e=>{const{DB:s}=e.env,r=e.req.param("userId");try{return await s.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(r).run(),e.json({success:!0,message:"장바구니가 비워졌습니다."})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/cart/:cartItemId",j,async e=>{const{DB:s}=e.env,r=e.req.param("cartItemId");try{const t=await e.req.json(),{quantity:a}=t;if(!a||a<1)return e.json({success:!1,error:"Invalid quantity"},400);const n=await s.prepare(`
    ...
    `).bind(r,a,n,o||null,c).run(),e.json({success:!0,message:"User banned successfully"})}catch(t){return console.error("Error banning user:",t),e.json({success:!1,error:t.message},500)}});p.delete("/api/chat/:liveStreamId/ban/:userId",S(),async e=>{const{DB:s}=e.env,r=e.req.param("liveStreamId"),t=e.req.param("userId");try{return await s.prepare(`
      ...
      WHERE live_stream_id = ? AND user_id = ?
    `).bind(r,t).run(),e.json({success:!0,message:"Ban removed successfully"})}catch(a){return console.error("Error removing ban:",a),e.json({success:!1,error:a.message},500)}});async function jo(e,s,r){try{const t=new TextEncoder,a=t.encode(r),n=t.encode(e),o=await crypto.subtle.importKey("raw",a,{name:"HMAC",hash:"SHA-256"},!1,["sign"]),i=await crypto.subtle.sign("HMAC",o,n),c=Array.from(new Uint8Array(i)),l=btoa(String.fromCharCode(...c));return s===l}catch(t){return console.error("[Webhook] 서명 검증 오류:",t),!1}}p.post("/api/payments/webhook",async e=>{const{DB:s}=e.env;try{const r=e.req.header("toss-signature"),t=await e.req.text();if(r&&e.env.TOSS_SECRET_KEY){if(!await jo(t,r,e.env.TOSS_SECRET_KEY))return console.error("[Webhook] ❌ 서명 검증 실패 - 위조된 웹훅 요청"),e.json({success:!1,error:"Invalid signature"},401);console.log("[Webhook] ✅ 서명 검증 성공")}else console.warn("[Webhook] ⚠️ 서명 검증 건너뜀 (개발 환경 또는 서명 없음)");const a=JSON.parse(t);switch(console.log("[Webhook] 토스페이먼츠 웹훅 수신:",{eventType:a.eventType,orderId:a.orderId,status:a.status,timestamp:new Date().toISOString()}),a.eventType){case"PAYMENT_STATUS_CHANGED":await Lo(s,a);break;case"VIRTUAL_ACCOUNT_ISSUED":await Mo(s,a);break;default:console.log("[Webhook] 처리하지 않는 이벤트 타입:",a.eventType)}return e.json({success:!0})}catch(r){return console.error("[Webhook] ❌ 웹훅 처리 실패:",r.message),e.json({success:!1,error:r.message},500)}});async function Lo(e,s){const{orderId:r,status:t,paymentKey:a}=s;console.log("[Webhook] 결제 상태 변경:",{orderId:r,status:t}),await e.prepare(`
    UPDATE payments 
    SET status = ?, 
        updated_at = CURRENT_TIMESTAMP,
        pg_raw_data = ?
  ...
  `).bind(t,JSON.stringify(s),a).run(),(t==="DONE"||t==="completed")&&(await e.prepare(`
      ...
      SET payment_status = 'approved',
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE order_number = ?
    `).bind(r).run(),console.log("[Webhook] ✅ 가상계좌 입금 완료 처리:",r))}async function Mo(e,s){const{orderId:r,virtualAccount:t}=s;console.log("[Webhook] 가상계좌 발급:",{orderId:r,bank:t==null?void 0:t.bank,accountNumber:t==null?void 0:t.accountNumber}),await e.prepare(`
    UPDATE payments 
...
`),_=new Date,f=`orders_${_.toISOString().split("T")[0]}_${_.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(t){return console.error("Export error:",t),e.json({success:!1,error:t.message},500)}});p.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(t).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,r.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,t).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${t}, 자동 발행 시작...`);const c=await s.prepare(`
      ...
      SET courier = ?, 
          ...
          updated_at = CURRENT_TIMESTAMP 
      WHERE order_number = ?
    `).bind(a,n,t).run();try{const c=await s.prepare("SELECT user_id FROM orders WHERE order_number = ?").bind(t).first();c&&c.user_id&&await Tt(s,c.user_id,t,"shipping",a,n)}catch(c){console.error("[Tracking] Notification error:",c)}return e.json({success:!0,message:"Tracking information updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/admin/orders",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
  ...
  `,{results:a}=await e.prepare(t).bind(s,r).all();return a}p.get("/api/admin/sellers",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
    ...
    `).bind(l).first(),d=(u==null?void 0:u.count)||0,m=await s.prepare(`
      ...
      FROM live_streams
      WHERE status = 'live'
    `).first(),_=(m==null?void 0:m.count)||0;return e.json({success:!0,stats:{todaySales:o,todayOrders:c,currentVisitors:d,liveStreams:_},timestamp:new Date().toISOString()})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/public/seller/:sellerId",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.param("sellerId"),a=`public:seller:${t}`,n=await Io(r,a);if(n)return e.json({success:!0,data:n,cached:!0});const o=await s.prepare(`
      SELECT 
...
`});const _="\uFEFF";return new Response(_+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(t){return console.error("CSV 내보내기 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/create",j,async e=>{const{DB:s}=e.env;try{const{userId:r,cartItems:t,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:l,buyerCeoName:u}=await e.req.json();console.log("[DEPRECATED /api/orders/create] 주문 생성 요청:",{userId:r,cartItems:t==null?void 0:t.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const v=await s.prepare(`
    ...
    `).bind(L,h,a,"pending",o||null,d,m,_,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,l||null,u||null).run()).meta.last_row_id,Z=t.map(v=>s.prepare(`
      ...
      `).bind(v.quantity,v.product_id));await s.batch([...Z,...z]);try{const v=Pe(e.env),re=t.map(H=>H.product_id),q=re.map(()=>"?").join(","),P=await s.prepare(`
...
`}return new Response(u,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_number:t}=await e.req.json();if(!t)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(r.sellerId).first();if(!n)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const o=await s.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),c=Math.floor(i/1.1),l=i-c,u=new Date().toISOString().split("T")[0],d=`${u}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,m=va(n,a,o.results);let _,f,h;try{_=await Ia(m),f=_.ntsConfirmNumber,h=_.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:f,invoiceKey:h,mockMode:cs()})}catch(g){console.error("바로빌 API 호출 실패:",g),f="FAILED",h=null}const b=(await s.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(t,r.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!cs()){const l=await s.prepare(`
        ...
        `).bind(r.sellerId).first();l&&l.business_number&&await Ra(l.business_number,n.api_invoice_key,a||"판매자 요청")}}catch(l){console.error("바로빌 취소 API 호출 실패:",l)}return await s.prepare(`
      UPDATE tax_invoices
    ...
    `).bind(t,a,n||null,o||null,i!==!1?1:0,c||0,l||null,u||null).run();return e.json({success:!0,id:d.meta.last_row_id})}catch(r){return e.json({success:!1,error:r.message},500)}});p.put("/api/admin/banners/:id",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=e.req.param("id"),{title:a,image_url:n,link_url:o,description:i,is_active:c,display_order:l,start_date:u,end_date:d}=await e.req.json();return await s.prepare(`
      ...
      SET title = ?, image_url = ?, link_url = ?, description = ?,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(a,n,o||null,i||null,c?1:0,l||0,u||null,d||null,t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.delete("/api/admin/banners/:id",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=e.req.param("id");return await s.prepare("DELETE FROM banners WHERE id = ?").bind(t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/order-complete",e=>e.redirect("/order-complete.html",302));p.notFound(e=>{const s=e.req.path;return s.startsWith("/api/")?e.json({success:!1,error:"Not found",message:`The requested endpoint ${s} was not found.`},404):new Response(null,{status:404})});p.onError((e,s)=>{const r=s.req.path;if(e instanceof bn)return console.error("[AppError]",{path:r,method:s.req.method,code:e.code,message:e.message,statusCode:e.statusCode}),s.json({success:!1,error:{code:e.code,message:e.message,...e.details&&{details:e.details}}},e.statusCode);if(console.error("[Global Error Handler]",{path:r,method:s.req.method,error:e.message,stack:e.stack}),r.startsWith("/api/")){let t=500,a="Internal Server Error";return e.message.includes("Unauthorized")||e.message.includes("로그인")?(t=401,a="인증이 필요합니다. 로그인해주세요."):e.message.includes("Forbidden")||e.message.includes("권한")?(t=403,a="접근 권한이 없습니다."):e.message.includes("Not found")||e.message.includes("찾을 수 없")?(t=404,a="요청하신 리소스를 찾을 수 없습니다."):(e.message.includes("Bad request")||e.message.includes("잘못된"))&&(t=400,a="잘못된 요청입니다."),s.json({success:!1,error:e.message||a},t)}return s.html(`
    <!DOCTYPE html>
    <html lang="ko">
    <head>
      <meta charset="UTF-8">
  ...
  `,500)});p.get("/api/admin/alimtalk/pricing",S(),async e=>{const{env:s}=e;try{const r=await s.DB.prepare(`
    ...
    `).bind(t.user_id).first();if(!c)return e.json({success:!1,error:"Active alimtalk account not found"},404);if(!(await Ka(s,c.sender_key,{name:n,content:o,templateCode:a})).success)return e.json({success:!1,error:"Failed to register template"},500);const u=await s.DB.prepare(`
    ...
    `).bind(a,c.id).first();if(!l)return e.json({success:!1,error:"Template not found or not approved"},404);const u=Ba(l.template_content,o||{}),d=at(n),m=await er(s,{senderKey:c.sender_key,templateCode:l.template_code,to:d,message:u});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(parseInt(r),parseInt(s)).first();if(!n)return e.json({success:!1,error:"Template not found"},404);let o=n.template_content;return a&&Object.entries(a).forEach(([i,c])=>{const l=new RegExp(`#{${i}}`,"g");o=o.replace(l,c)}),e.json({success:!0,data:{template_name:n.template_name,original:n.template_content,preview:o,required_variables:Array.from(n.template_content.matchAll(/#{(\w+)}/g),i=>i[1])}})}catch(s){return console.error("[Alimtalk Preview] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlements",S(),async e=>{try{const s=await e.env.DB.prepare(`
      ...
      LIMIT 50
    `).all();return e.json({success:!0,data:s.results})}catch(s){return console.error("[Admin Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlements/:id",S(),async e=>{try{const s=parseInt(e.req.param("id")),r=await un(e.env.DB,s);return r?e.json({success:!0,data:r}):e.json({success:!1,error:"Settlement not found"},404)}catch(s){return console.error("[Admin Settlement Detail] Error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/admin/settlements/generate",S(),async e=>{try{const s=await e.req.json(),{startDate:r,endDate:t}=s,a=r&&t?{startDate:r,endDate:t}:nn(),n=await cn(e.env.DB,a);return await ln(e.env.DB,n),e.json({success:!0,data:n})}catch(s){return console.error("[Admin Generate Settlement] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/seller/settlements",S(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const r=await e.env.DB.prepare(`
      SELECT 
        s.id,
        s.period_start,
        s.period_end,
