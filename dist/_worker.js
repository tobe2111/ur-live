var Bs=Object.defineProperty;var os=e=>{throw TypeError(e)};var Ks=(e,r,t)=>r in e?Bs(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var R=(e,r,t)=>Ks(e,typeof r!="symbol"?r+"":r,t),Xe=(e,r,t)=>r.has(e)||os("Cannot "+t);var m=(e,r,t)=>(Xe(e,r,"read from private field"),t?t.call(e):r.get(e)),S=(e,r,t)=>r.has(e)?os("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,s)=>(Xe(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),v=(e,r,t)=>(Xe(e,r,"access private method"),t);var is=(e,r,t,s)=>({set _(a){T(e,r,a,t)},get _(){return m(e,r,s)}});var cs=(e,r,t)=>(s,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,u=!1,l;if(e[i]?(l=e[i][0][0],s.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{c=await l(s,()=>o(i+1))}catch(d){if(d instanceof Error&&r)s.error=d,c=await r(d,s),u=!0;else throw d}else s.finalized===!1&&t&&(c=await t(s));return c&&(s.finalized===!1||u)&&(s.res=c),s}},Vs=Symbol(),Ys=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,n=(e instanceof Rs?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Js(e,{all:t,dot:s}):{}};async function Js(e,r){const t=await e.formData();return t?zs(t,r):{}}function zs(e,r){const t=Object.create(null);return e.forEach((s,a)=>{r.all||a.endsWith("[]")?Xs(t,a,s):t[a]=s}),r.dot&&Object.entries(t).forEach(([s,a])=>{s.includes(".")&&(Gs(t,s,a),delete t[s])}),t}var Xs=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},Gs=(e,r,t)=>{let s=e;const a=r.split(".");a.forEach((n,o)=>{o===a.length-1?s[n]=t:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},ys=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},Qs=e=>{const{groups:r,path:t}=Zs(e),s=ys(t);return er(s,r)},Zs=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const a=`@${s}`;return r.push([a,t]),a}),{groups:r,path:e}},er=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let a=e.length-1;a>=0;a--)if(e[a].includes(s)){e[a]=e[a].replace(s,r[t][1]);break}}return e},We={},sr=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return We[s]||(t[2]?We[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:We[s]=[e,t[1],!0]),We[s]}return null},ss=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},rr=e=>ss(e,decodeURI),gs=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const a=r.charCodeAt(s);if(a===37){const n=r.indexOf("?",s),o=r.slice(t,n===-1?void 0:n);return rr(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return r.slice(t,s)},tr=e=>{const r=gs(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},ge=(e,r,...t)=>(t.length&&(r=ge(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),bs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))s+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){t.length===0&&s===""?t.push("/"):t.push(s);const n=a.replace("?","");s+="/"+n,t.push(s)}else s+="/"+a}),t.filter((a,n,o)=>o.indexOf(a)===n)},Ge=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ss(e,Ts):e):e,ws=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const c=o+r.length+2,u=e.indexOf("&",c);return Ge(e.slice(c,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const a={};s??(s=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(s&&(c=Ge(c)),n=o,c==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),s&&(u=Ge(u))),t?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(u)):a[c]??(a[c]=u)}return r?a[r]:a},ar=ws,nr=(e,r)=>ws(e,r,!0),Ts=decodeURIComponent,us=e=>ss(e,Ts),Te,B,se,Ss,Is,es,re,ps,Rs=(ps=class{constructor(e,r="/",t=[[]]){S(this,se);R(this,"raw");S(this,Te);S(this,B);R(this,"routeIndex",0);R(this,"path");R(this,"bodyCache",{});S(this,re,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,T(this,B,t),T(this,Te,{})}param(e){return e?v(this,se,Ss).call(this,e):v(this,se,Is).call(this)}query(e){return ar(this.url,e)}queries(e){return nr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await Ys(this,e))}json(){return m(this,re).call(this,"text").then(e=>JSON.parse(e))}text(){return m(this,re).call(this,"text")}arrayBuffer(){return m(this,re).call(this,"arrayBuffer")}blob(){return m(this,re).call(this,"blob")}formData(){return m(this,re).call(this,"formData")}addValidatedData(e,r){m(this,Te)[e]=r}valid(e){return m(this,Te)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Vs](){return m(this,B)}get matchedRoutes(){return m(this,B)[0].map(([[,e]])=>e)}get routePath(){return m(this,B)[0].map(([[,e]])=>e)[this.routeIndex].path}},Te=new WeakMap,B=new WeakMap,se=new WeakSet,Ss=function(e){const r=m(this,B)[0][this.routeIndex][1][e],t=v(this,se,es).call(this,r);return t&&/\%/.test(t)?us(t):t},Is=function(){const e={},r=Object.keys(m(this,B)[0][this.routeIndex][1]);for(const t of r){const s=v(this,se,es).call(this,m(this,B)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?us(s):s)}return e},es=function(e){return m(this,B)[1]?m(this,B)[1][e]:e},re=new WeakMap,ps),or={Stringify:1},vs=async(e,r,t,s,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:r,buffer:a,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(c=>vs(c,r,!1,s,a))).then(()=>a[0]))):Promise.resolve(e)},ir="text/plain; charset=UTF-8",Qe=(e,r)=>({"Content-Type":e,...r}),Le,Me,G,Re,Q,q,Pe,Se,Ie,de,He,xe,te,be,ms,cr=(ms=class{constructor(e,r){S(this,te);S(this,Le);S(this,Me);R(this,"env",{});S(this,G);R(this,"finalized",!1);R(this,"error");S(this,Re);S(this,Q);S(this,q);S(this,Pe);S(this,Se);S(this,Ie);S(this,de);S(this,He);S(this,xe);R(this,"render",(...e)=>(m(this,Se)??T(this,Se,r=>this.html(r)),m(this,Se).call(this,...e)));R(this,"setLayout",e=>T(this,Pe,e));R(this,"getLayout",()=>m(this,Pe));R(this,"setRenderer",e=>{T(this,Se,e)});R(this,"header",(e,r,t)=>{this.finalized&&T(this,q,new Response(m(this,q).body,m(this,q)));const s=m(this,q)?m(this,q).headers:m(this,de)??T(this,de,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});R(this,"status",e=>{T(this,Re,e)});R(this,"set",(e,r)=>{m(this,G)??T(this,G,new Map),m(this,G).set(e,r)});R(this,"get",e=>m(this,G)?m(this,G).get(e):void 0);R(this,"newResponse",(...e)=>v(this,te,be).call(this,...e));R(this,"body",(e,r,t)=>v(this,te,be).call(this,e,r,t));R(this,"text",(e,r,t)=>!m(this,de)&&!m(this,Re)&&!r&&!t&&!this.finalized?new Response(e):v(this,te,be).call(this,e,r,Qe(ir,t)));R(this,"json",(e,r,t)=>v(this,te,be).call(this,JSON.stringify(e),r,Qe("application/json",t)));R(this,"html",(e,r,t)=>{const s=a=>v(this,te,be).call(this,a,r,Qe("text/html; charset=UTF-8",t));return typeof e=="object"?vs(e,or.Stringify,!1,{}).then(s):s(e)});R(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});R(this,"notFound",()=>(m(this,Ie)??T(this,Ie,()=>new Response),m(this,Ie).call(this,this)));T(this,Le,e),r&&(T(this,Q,r.executionCtx),this.env=r.env,T(this,Ie,r.notFoundHandler),T(this,xe,r.path),T(this,He,r.matchResult))}get req(){return m(this,Me)??T(this,Me,new Rs(m(this,Le),m(this,xe),m(this,He))),m(this,Me)}get event(){if(m(this,Q)&&"respondWith"in m(this,Q))return m(this,Q);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,Q))return m(this,Q);throw Error("This context has no ExecutionContext")}get res(){return m(this,q)||T(this,q,new Response(null,{headers:m(this,de)??T(this,de,new Headers)}))}set res(e){if(m(this,q)&&e){e=new Response(e.body,e);for(const[r,t]of m(this,q).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=m(this,q).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of s)e.headers.append("set-cookie",a)}else e.headers.set(r,t)}T(this,q,e),this.finalized=!0}get var(){return m(this,G)?Object.fromEntries(m(this,G)):{}}},Le=new WeakMap,Me=new WeakMap,G=new WeakMap,Re=new WeakMap,Q=new WeakMap,q=new WeakMap,Pe=new WeakMap,Se=new WeakMap,Ie=new WeakMap,de=new WeakMap,He=new WeakMap,xe=new WeakMap,te=new WeakSet,be=function(e,r,t){const s=m(this,q)?new Headers(m(this,q).headers):m(this,de)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[n,o]of Object.entries(t))if(typeof o=="string")s.set(n,o);else{s.delete(n);for(const i of o)s.append(n,i)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,Re);return new Response(e,{status:a,headers:s})},ms),L="ALL",ur="all",lr=["get","post","put","delete","options","patch"],Os="Can not add a route since the matcher is already built.",js=class extends Error{},dr="__COMPOSED_HANDLER",pr=e=>e.text("404 Not Found",404),ls=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},V,M,Ds,Y,ue,qe,$e,ve,mr=(ve=class{constructor(r={}){S(this,M);R(this,"get");R(this,"post");R(this,"put");R(this,"delete");R(this,"options");R(this,"patch");R(this,"all");R(this,"on");R(this,"use");R(this,"router");R(this,"getPath");R(this,"_basePath","/");S(this,V,"/");R(this,"routes",[]);S(this,Y,pr);R(this,"errorHandler",ls);R(this,"onError",r=>(this.errorHandler=r,this));R(this,"notFound",r=>(T(this,Y,r),this));R(this,"fetch",(r,...t)=>v(this,M,$e).call(this,r,t[1],t[0],r.method));R(this,"request",(r,t,s,a)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${ge("/",r)}`,t),s,a)));R(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(v(this,M,$e).call(this,r.request,r,void 0,r.request.method))})});[...lr,ur].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?T(this,V,o):v(this,M,ue).call(this,n,m(this,V),o),i.forEach(c=>{v(this,M,ue).call(this,n,m(this,V),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){T(this,V,c);for(const u of[n].flat())i.map(l=>{v(this,M,ue).call(this,u.toUpperCase(),m(this,V),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?T(this,V,n):(T(this,V,"*"),o.unshift(n)),o.forEach(i=>{v(this,M,ue).call(this,L,m(this,V),i)}),this);const{strict:s,...a}=r;Object.assign(this,a),this.getPath=s??!0?r.getPath??gs:tr}route(r,t){const s=this.basePath(r);return t.routes.map(a=>{var o;let n;t.errorHandler===ls?n=a.handler:(n=async(i,c)=>(await cs([],t.errorHandler)(i,()=>a.handler(i,c))).res,n[dr]=a.handler),v(o=s,M,ue).call(o,a.method,a.path,n)}),this}basePath(r){const t=v(this,M,Ds).call(this);return t._basePath=ge(this._basePath,r),t}mount(r,t,s){let a,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?a=c=>c:a=s.replaceRequest));const o=n?c=>{const u=n(c);return Array.isArray(u)?u:[u]}:c=>{let u;try{u=c.executionCtx}catch{}return[c.env,u]};a||(a=(()=>{const c=ge(this._basePath,r),u=c==="/"?0:c.length;return l=>{const d=new URL(l.url);return d.pathname=d.pathname.slice(u)||"/",new Request(d,l)}})());const i=async(c,u)=>{const l=await t(a(c.req.raw),...o(c));if(l)return l;await u()};return v(this,M,ue).call(this,L,ge(r,"*"),i),this}},V=new WeakMap,M=new WeakSet,Ds=function(){const r=new ve({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,T(r,Y,m(this,Y)),r.routes=this.routes,r},Y=new WeakMap,ue=function(r,t,s){r=r.toUpperCase(),t=ge(this._basePath,t);const a={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,a]),this.routes.push(a)},qe=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},$e=function(r,t,s,a){if(a==="HEAD")return(async()=>new Response(null,await v(this,M,$e).call(this,r,t,s,"GET")))();const n=this.getPath(r,{env:s}),o=this.router.match(a,n),i=new cr(r,{path:n,matchResult:o,env:s,executionCtx:t,notFoundHandler:m(this,Y)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await m(this,Y).call(this,i)})}catch(l){return v(this,M,qe).call(this,l,i)}return u instanceof Promise?u.then(l=>l||(i.finalized?i.res:m(this,Y).call(this,i))).catch(l=>v(this,M,qe).call(this,l,i)):u??m(this,Y).call(this,i)}const c=cs(o[0],this.errorHandler,m(this,Y));return(async()=>{try{const u=await c(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return v(this,M,qe).call(this,u,i)}})()},ve),Ns=[];function _r(e,r){const t=this.buildAllMatchers(),s=((a,n)=>{const o=t[a]||t[L],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],Ns];const u=c.indexOf("",1);return[o[1][u],c]});return this.match=s,s(e,r)}var Ke="[^/]+",Ae=".*",Ce="(?:|/.*)",we=Symbol(),fr=new Set(".\\+*[^]$()");function Er(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===Ae||e===Ce?1:r===Ae||r===Ce?-1:e===Ke?1:r===Ke?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var pe,me,J,Ee,hr=(Ee=class{constructor(){S(this,pe);S(this,me);S(this,J,Object.create(null))}insert(r,t,s,a,n){if(r.length===0){if(m(this,pe)!==void 0)throw we;if(n)return;T(this,pe,t);return}const[o,...i]=r,c=o==="*"?i.length===0?["","",Ae]:["","",Ke]:o==="/*"?["","",Ce]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(c){const l=c[1];let d=c[2]||Ke;if(l&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw we;if(u=m(this,J)[d],!u){if(Object.keys(m(this,J)).some(_=>_!==Ae&&_!==Ce))throw we;if(n)return;u=m(this,J)[d]=new Ee,l!==""&&T(u,me,a.varIndex++)}!n&&l!==""&&s.push([l,m(u,me)])}else if(u=m(this,J)[o],!u){if(Object.keys(m(this,J)).some(l=>l.length>1&&l!==Ae&&l!==Ce))throw we;if(n)return;u=m(this,J)[o]=new Ee}u.insert(i,t,s,a,n)}buildRegExpStr(){const t=Object.keys(m(this,J)).sort(Er).map(s=>{const a=m(this,J)[s];return(typeof m(a,me)=="number"?`(${s})@${m(a,me)}`:fr.has(s)?`\\${s}`:s)+a.buildRegExpStr()});return typeof m(this,pe)=="number"&&t.unshift(`#${m(this,pe)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},pe=new WeakMap,me=new WeakMap,J=new WeakMap,Ee),Ve,Ue,_s,yr=(_s=class{constructor(){S(this,Ve,{varIndex:0});S(this,Ue,new hr)}insert(e,r,t){const s=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const u=`@\\${o}`;return a[o]=[u,c],o++,i=!0,u}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return m(this,Ue).insert(n,r,s,m(this,Ve),t),s}buildRegExp(){let e=m(this,Ue).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(t[++r]=Number(n),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},Ve=new WeakMap,Ue=new WeakMap,_s),gr=[/^$/,[],Object.create(null)],Be=Object.create(null);function ks(e){return Be[e]??(Be[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function br(){Be=Object.create(null)}function wr(e){var u;const r=new yr,t=[];if(e.length===0)return gr;const s=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,d],[_,f])=>l?1:_?-1:d.length-f.length),a=Object.create(null);for(let l=0,d=-1,_=s.length;l<_;l++){const[f,E,y]=s[l];f?a[E]=[y.map(([g])=>[g,Object.create(null)]),Ns]:d++;let h;try{h=r.insert(E,d,f)}catch(g){throw g===we?new js(E):g}f||(t[d]=y.map(([g,b])=>{const j=Object.create(null);for(b-=1;b>=0;b--){const[D,w]=h[b];j[D]=w}return[g,j]}))}const[n,o,i]=r.buildRegExp();for(let l=0,d=t.length;l<d;l++)for(let _=0,f=t[l].length;_<f;_++){const E=(u=t[l][_])==null?void 0:u[1];if(!E)continue;const y=Object.keys(E);for(let h=0,g=y.length;h<g;h++)E[y[h]]=i[E[y[h]]]}const c=[];for(const l in o)c[l]=t[o[l]];return[n,c,a]}function ye(e,r){if(e){for(const t of Object.keys(e).sort((s,a)=>a.length-s.length))if(ks(t).test(r))return[...e[t]]}}var ae,ne,Ye,As,fs,Tr=(fs=class{constructor(){S(this,Ye);R(this,"name","RegExpRouter");S(this,ae);S(this,ne);R(this,"match",_r);T(this,ae,{[L]:Object.create(null)}),T(this,ne,{[L]:Object.create(null)})}add(e,r,t){var i;const s=m(this,ae),a=m(this,ne);if(!s||!a)throw new Error(Os);s[e]||[s,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[L]).forEach(u=>{c[e][u]=[...c[L][u]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=ks(r);e===L?Object.keys(s).forEach(u=>{var l;(l=s[u])[r]||(l[r]=ye(s[u],r)||ye(s[L],r)||[])}):(i=s[e])[r]||(i[r]=ye(s[e],r)||ye(s[L],r)||[]),Object.keys(s).forEach(u=>{(e===L||e===u)&&Object.keys(s[u]).forEach(l=>{c.test(l)&&s[u][l].push([t,n])})}),Object.keys(a).forEach(u=>{(e===L||e===u)&&Object.keys(a[u]).forEach(l=>c.test(l)&&a[u][l].push([t,n]))});return}const o=bs(r)||[r];for(let c=0,u=o.length;c<u;c++){const l=o[c];Object.keys(a).forEach(d=>{var _;(e===L||e===d)&&((_=a[d])[l]||(_[l]=[...ye(s[d],l)||ye(s[L],l)||[]]),a[d][l].push([t,n-u+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(m(this,ne)).concat(Object.keys(m(this,ae))).forEach(r=>{e[r]||(e[r]=v(this,Ye,As).call(this,r))}),T(this,ae,T(this,ne,void 0)),br(),e}},ae=new WeakMap,ne=new WeakMap,Ye=new WeakSet,As=function(e){const r=[];let t=e===L;return[m(this,ae),m(this,ne)].forEach(s=>{const a=s[e]?Object.keys(s[e]).map(n=>[n,s[e][n]]):[];a.length!==0?(t||(t=!0),r.push(...a)):e!==L&&r.push(...Object.keys(s[L]).map(n=>[n,s[L][n]]))}),t?wr(r):null},fs),oe,Z,Es,Rr=(Es=class{constructor(e){R(this,"name","SmartRouter");S(this,oe,[]);S(this,Z,[]);T(this,oe,e.routers)}add(e,r,t){if(!m(this,Z))throw new Error(Os);m(this,Z).push([e,r,t])}match(e,r){if(!m(this,Z))throw new Error("Fatal error");const t=m(this,oe),s=m(this,Z),a=t.length;let n=0,o;for(;n<a;n++){const i=t[n];try{for(let c=0,u=s.length;c<u;c++)i.add(...s[c]);o=i.match(e,r)}catch(c){if(c instanceof js)continue;throw c}this.match=i.match.bind(i),T(this,oe,[i]),T(this,Z,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(m(this,Z)||m(this,oe).length!==1)throw new Error("No active router has been determined yet.");return m(this,oe)[0]}},oe=new WeakMap,Z=new WeakMap,Es),Ne=Object.create(null),ie,F,_e,Oe,H,ee,le,je,Sr=(je=class{constructor(r,t,s){S(this,ee);S(this,ie);S(this,F);S(this,_e);S(this,Oe,0);S(this,H,Ne);if(T(this,F,s||Object.create(null)),T(this,ie,[]),r&&t){const a=Object.create(null);a[r]={handler:t,possibleKeys:[],score:0},T(this,ie,[a])}T(this,_e,[])}insert(r,t,s){T(this,Oe,++is(this,Oe)._);let a=this;const n=Qs(t),o=[];for(let i=0,c=n.length;i<c;i++){const u=n[i],l=n[i+1],d=sr(u,l),_=Array.isArray(d)?d[0]:u;if(_ in m(a,F)){a=m(a,F)[_],d&&o.push(d[1]);continue}m(a,F)[_]=new je,d&&(m(a,_e).push(d),o.push(d[1])),a=m(a,F)[_]}return m(a,ie).push({[r]:{handler:s,possibleKeys:o.filter((i,c,u)=>u.indexOf(i)===c),score:m(this,Oe)}}),a}search(r,t){var c;const s=[];T(this,H,Ne);let n=[this];const o=ys(t),i=[];for(let u=0,l=o.length;u<l;u++){const d=o[u],_=u===l-1,f=[];for(let E=0,y=n.length;E<y;E++){const h=n[E],g=m(h,F)[d];g&&(T(g,H,m(h,H)),_?(m(g,F)["*"]&&s.push(...v(this,ee,le).call(this,m(g,F)["*"],r,m(h,H))),s.push(...v(this,ee,le).call(this,g,r,m(h,H)))):f.push(g));for(let b=0,j=m(h,_e).length;b<j;b++){const D=m(h,_e)[b],w=m(h,H)===Ne?{}:{...m(h,H)};if(D==="*"){const P=m(h,F)["*"];P&&(s.push(...v(this,ee,le).call(this,P,r,m(h,H))),T(P,H,w),f.push(P));continue}const[x,C,I]=D;if(!d&&!(I instanceof RegExp))continue;const k=m(h,F)[x],$=o.slice(u).join("/");if(I instanceof RegExp){const P=I.exec($);if(P){if(w[C]=P[0],s.push(...v(this,ee,le).call(this,k,r,m(h,H),w)),Object.keys(m(k,F)).length){T(k,H,w);const z=((c=P[0].match(/\//))==null?void 0:c.length)??0;(i[z]||(i[z]=[])).push(k)}continue}}(I===!0||I.test(d))&&(w[C]=d,_?(s.push(...v(this,ee,le).call(this,k,r,w,m(h,H))),m(k,F)["*"]&&s.push(...v(this,ee,le).call(this,m(k,F)["*"],r,w,m(h,H)))):(T(k,H,w),f.push(k)))}}n=f.concat(i.shift()??[])}return s.length>1&&s.sort((u,l)=>u.score-l.score),[s.map(({handler:u,params:l})=>[u,l])]}},ie=new WeakMap,F=new WeakMap,_e=new WeakMap,Oe=new WeakMap,H=new WeakMap,ee=new WeakSet,le=function(r,t,s,a){const n=[];for(let o=0,i=m(r,ie).length;o<i;o++){const c=m(r,ie)[o],u=c[t]||c[L],l={};if(u!==void 0&&(u.params=Object.create(null),n.push(u),s!==Ne||a&&a!==Ne))for(let d=0,_=u.possibleKeys.length;d<_;d++){const f=u.possibleKeys[d],E=l[u.score];u.params[f]=a!=null&&a[f]&&!E?a[f]:s[f]??(a==null?void 0:a[f]),l[u.score]=!0}}return n},je),fe,hs,Ir=(hs=class{constructor(){R(this,"name","TrieRouter");S(this,fe);T(this,fe,new Sr)}add(e,r,t){const s=bs(r);if(s){for(let a=0,n=s.length;a<n;a++)m(this,fe).insert(e,s[a],t);return}m(this,fe).insert(e,r,t)}match(e,r){return m(this,fe).search(e,r)}},fe=new WeakMap,hs),Cs=class extends mr{constructor(e={}){super(e),this.router=e.router??new Rr({routers:[new Tr,new Ir]})}},O=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(t.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(t.allowMethods);return async function(o,i){var l;function c(d,_){o.res.headers.set(d,_)}const u=await s(o.req.header("origin")||"",o);if(u&&c("Access-Control-Allow-Origin",u),t.credentials&&c("Access-Control-Allow-Credentials","true"),(l=t.exposeHeaders)!=null&&l.length&&c("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&c("Vary","Origin"),t.maxAge!=null&&c("Access-Control-Max-Age",t.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&c("Access-Control-Allow-Methods",d.join(","));let _=t.allowHeaders;if(!(_!=null&&_.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(_=f.split(/\s*,\s*/))}return _!=null&&_.length&&(c("Access-Control-Allow-Headers",_.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};const Ze={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function vr(){const e=Ze.ENV==="production";return{baseUrl:Ze.TEST_BASE_URL,apiKey:Ze.TEST_API_KEY,isProduction:e}}async function Ls(e,r){const t=vr(),s=`${t.baseUrl}${e}`;try{const a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify(r)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Or(e){try{const r={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((s,a)=>({SerialNum:a+1,ItemName:s.name,Qty:s.quantity,UnitPrice:s.unitPrice,SupplyCost:s.supplyPrice,Tax:s.taxAmount,Remark:s.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},t=await Ls("/eTaxInvoice/RegistAndIssue",r);if(t.code!==1)throw new Error(`바로빌 발행 실패: ${t.message}`);return{success:!0,ntsConfirmNumber:t.ntsconfirmNum,invoiceKey:t.invoiceKey,message:t.message}}catch(r){throw console.error("바로빌 세금계산서 발행 실패:",r),r}}async function jr(e,r,t){try{const a=await Ls("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:r,Memo:t});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(s){throw console.error("바로빌 세금계산서 취소 실패:",s),s}}function ke(){return!1}async function Dr(e){return await Or(e)}function Nr(e,r,t){const s=Number(r.total_amount),a=Math.floor(s/1.1),n=s-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:r.buyer_business_number,buyerBusinessName:r.buyer_business_name||r.user_name,buyerCEO:r.buyer_ceo_name,buyerAddress:r.shipping_address,buyerEmail:r.user_email,buyerTel:r.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:t.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),u=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:u,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:s,memo:`주문번호: ${r.order_number}`,orderNo:r.order_number}}class K extends Error{constructor(r,t,s){super(r),this.statusCode=t,this.code=s,this.name="AuthError"}}function kr(e){return`${crypto.randomUUID()}-${e}`}function Ar(e){var n,o,i,c,u,l,d;const r=e.id.toString(),t=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",s=((c=e.kakao_account)==null?void 0:c.email)||null,a=((u=e.properties)==null?void 0:u.profile_image)||((d=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:r,nickname:t,email:s,profileImage:a}}async function Cr(e,r,t,s,a){try{await e.prepare(`
    ...
    `).bind(u,t,l,a,n,o||null,i||null).run();return e.json({success:!0,data:{sellerId:d.meta.last_row_id,message:"회원가입이 완료되었습니다. 관리자 승인 후 로그인할 수 있습니다."}})}catch(t){return console.error("Seller registration error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/admin/login",O(),async e=>{const{DB:r}=e.env;try{const{email:t,password:s}=await e.req.json();if(!t||!s)return e.json({success:!1,error:"이메일과 비밀번호를 입력해주세요"},400);const a=await r.prepare("SELECT * FROM admins WHERE email = ?").bind(t).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(t==="admin@example.com"&&s==="admin123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${s}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);const i=await Us(e.env.SESSION_KV,a.id,"admin",{username:a.username,email:a.email,name:a.name,role:a.role});return await r.prepare('UPDATE admins SET last_login_at = datetime("now") WHERE id = ?').bind(a.id).run(),e.json({success:!0,data:{token:i,admin:{id:a.id,username:a.username,email:a.email,name:a.name,role:a.role}}})}catch(t){return console.error("Admin login error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/auth/verify",O(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const s=await De(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=s.user_type==="admin"?"admins":"sellers",n=s.user_type==="admin"?s.admin_id:s.seller_id,o=await r.prepare(`SELECT * FROM ${a} WHERE id = ?`).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:s.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name,role:o.role}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/auth/kakao/sync/callback",async e=>{var t,s,a,n,o,i,c,u,l,d,_,f,E;const{DB:r}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!r);const y=e.req.query("code"),h=e.req.query("state")||"/",g=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!y,state:h,error:g}),g)return console.error("[Kakao Sync] OAuth error:",g),e.redirect(`${h}?error=kakao_oauth_${g}`);if(!y)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${h}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const b=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",j=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",b.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",j),console.log("[Kakao Sync] Step 1: Fetching access token...");const D=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:b,redirect_uri:j,code:y})});if(console.log("[Kakao Sync] Token response status:",D.status),console.log("[Kakao Sync] Token request details:",{client_id:b,redirect_uri:j,code_length:y.length,code_prefix:y.substring(0,20)}),!D.ok){const W=await D.text();return console.error("[Kakao Sync] Token request failed:",W),e.redirect(`${h}?error=token_request_failed&detail=${encodeURIComponent(W)}`)}const w=await D.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!w.access_token,error:w.error,errorDescription:w.error_description}),!w.access_token)return console.error("[Kakao Sync] Token error:",w),e.redirect(`${h}?error=token_failed&detail=${encodeURIComponent(w.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const x=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${w.access_token}`}});console.log("[Kakao Sync] User response status:",x.status);const C=await x.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!C.id,id:C.id,hasNickname:!!((t=C.properties)!=null&&t.nickname||(a=(s=C.kakao_account)==null?void 0:s.profile)!=null&&a.nickname)}),!C.id)return console.error("[Kakao Sync] Failed to get user info:",C),e.redirect(`${h}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const I=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${w.access_token}`}});console.log("[Kakao Sync] Terms response status:",I.status);let k=null;if(I.ok?(k=await I.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=k.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=k.allowed_service_terms)==null?void 0:o.map(W=>W.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!r)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${h}?error=db_not_available`);const $=C.id.toString(),P=((i=C.properties)==null?void 0:i.nickname)||((u=(c=C.kakao_account)==null?void 0:c.profile)==null?void 0:u.nickname)||"Kakao User",z=((l=C.kakao_account)==null?void 0:l.email)||"",Fe=((d=C.properties)==null?void 0:d.profile_image)||((f=(_=C.kakao_account)==null?void 0:_.profile)==null?void 0:f.profile_image_url)||"",Je=w.access_token,U=((E=k==null?void 0:k.allowed_service_terms)==null?void 0:E.map(W=>W.tag))||[],ce=JSON.stringify(U);console.log("[Kakao Sync] User data:",{kakaoId:$,nickname:P,email:z?"exists":"none",serviceTerms:U});try{const W=await r.prepare("SELECT * FROM users WHERE kakao_id = ?").bind($).first();console.log("[Kakao Sync] Existing user check:",!!W);let X;W?(X=W.id,await r.prepare(`
          UPDATE users 
          SET name = ?, 
              email = ?, 
              profile_image = ?,
          ...
          WHERE id = ?
        `).bind(P,z,Fe,X).run(),console.log("[Kakao Sync] Updated user:",X)):(X=(await r.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
        ...
        `).bind($,P,z||null,Fe||null).run()).meta.last_row_id,console.log("[Kakao Sync] Created user:",X)),console.log("[Kakao Sync] User saved successfully, userId:",X),console.log("[Kakao Sync] Step 4: Creating session...");const{SESSION_KV:qs}=e.env,ze=crypto.randomUUID(),$s=Date.now()+1440*60*1e3;await qs.put(`session:${ze}`,JSON.stringify({user_id:X,user_type:"user",expires_at:$s}),{expirationTtl:1440*60}),console.log("[Kakao Sync] Session created successfully in SESSION_KV"),console.log("[Kakao Sync] Step 5: Redirecting...");const ns=h.includes("?")?`${h}&login=success&session=${ze}&userId=${X}&userName=${encodeURIComponent(P)}`:`${h}?login=success&session=${ze}&userId=${X}&userName=${encodeURIComponent(P)}`;return console.log("[Kakao Sync] Redirect URL:",ns),e.redirect(ns)}catch(W){return console.error("[Kakao Sync] Database error:",W),console.error("[Kakao Sync] DB error details:",{message:W.message,name:W.name}),e.redirect(`${h}?error=database_error&detail=${encodeURIComponent(W.message)}`)}}catch(y){console.error("[Kakao Sync] Exception:",y),console.error("[Kakao Sync] Error details:",{message:y.message,stack:y.stack,name:y.name});const h=e.req.query("state")||"/",g=encodeURIComponent(y.message||"unknown");return e.redirect(`${h}?error=kakao_sync_failed&detail=${g}`)}});p.post("/api/auth/kakao/callback",O(),async e=>{const{DB:r}=e.env;try{const{code:t,redirect_uri:s}=await e.req.json();if(!t)return e.json({success:!1,error:"Authorization code is required"},400);if(!e.env.KAKAO_REST_API_KEY)return console.error("[Kakao Callback] KAKAO_REST_API_KEY not configured"),e.json({success:!1,error:"Server configuration error",code:"MISSING_API_KEY"},500);const a=s||"https://live.ur-team.com/auth/kakao/callback";console.log("[Kakao Callback] Starting OAuth flow");const n=await Mr(t,a,e.env.KAKAO_REST_API_KEY),{user:o,sessionToken:i}=await Ms(r,n);return e.json({success:!0,data:{session_token:i,user:{id:o.id,name:o.name,email:o.email,profile_image:o.profile_image}}})}catch(t){return console.error("[Kakao Callback] Error:",t),t instanceof K?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t.message||"Internal server error",code:"UNKNOWN_ERROR"},500)}});p.post("/api/auth/kakao/sync",O(),async e=>{const{DB:r}=e.env;try{const{accessToken:t}=await e.req.json();if(!t)return e.json({success:!1,error:"Access token is required"},400);console.log("[Kakao Sync] Verifying access token");const{user:s,sessionToken:a}=await Ms(r,t);return console.log("[Kakao Sync] Login successful"),e.json({success:!0,data:{session_token:a,user:{id:s.id,name:s.name,email:s.email,profile_image:s.profile_image}}})}catch(t){return console.error("[Kakao Sync] Error:",t),t instanceof K?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t instanceof Error?t.message:"Login failed",code:"UNKNOWN_ERROR"},500)}});p.post("/api/auth/kakao/logout",O(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token")||"";return t&&(await r.prepare("DELETE FROM admin_sessions WHERE session_token = ?").bind(t).run(),console.log("[Kakao Sync] Session deleted")),e.json({success:!0})}catch(t){return console.error("[Kakao Sync] Logout error:",t),e.json({success:!1,error:"Logout failed"},500)}});p.post("/api/auth/kakao/unlink",O(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증이 필요합니다"},401);if(console.log("[Kakao Unlink] Starting unlink process..."),!await r.prepare(`
    ...
    `).run(),await r.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(n.id).run(),await r.prepare("DELETE FROM users WHERE id = ?").bind(n.id).run(),console.log("[Kakao Webhook] User data deleted successfully"),e.json({success:!0})):(console.log("[Kakao Webhook] User not found:",s),e.json({success:!0}))}catch(t){return console.error("[Kakao Webhook] Error:",t),e.json({success:!1,error:"Webhook processing failed"},500)}});p.get("/api/auth/user/verify",O(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const s=await De(e.env.SESSION_KV,t);if(!s||s.user_type!=="user")return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=parseInt(t.split("_")[1]),n=await r.prepare("SELECT * FROM users WHERE id = ?").bind(a).first();return n?e.json({success:!0,data:{user:{id:n.id,name:n.name,email:n.email,profileImage:n.profile_image,phone:n.phone}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/shipping-addresses",O(),he,async e=>{const{DB:r}=e.env,t=e.get("userId");try{const s=await r.prepare(`
      SELECT * FROM shipping_addresses WHERE user_id = ? ORDER BY is_default DESC, created_at DESC
    `).bind(t).all();return e.json({success:!0,data:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/shipping-addresses/:userId",O(),he,async e=>{const{DB:r}=e.env,t=e.get("userId"),s=parseInt(e.req.param("userId"));try{if(s!==t)return e.json({success:!1,error:"본인의 배송지만 조회할 수 있습니다."},403);const a=await r.prepare(`
      SELECT * FROM shipping_addresses WHERE user_id = ? ORDER BY is_default DESC, created_at DESC
    `).bind(t).all();return e.json({success:!0,data:a.results||[]})}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/shipping-addresses",O(),async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),s=t.user_id,a=t.recipient_name,n=t.phone,o=t.postal_code,i=t.address,c=t.address_detail,u=t.is_default;if(console.log("[POST /api/shipping-addresses] Received:",JSON.stringify(t)),!s||!a||!n||!i)return console.error("[POST /api/shipping-addresses] Missing required fields:",{userId:s,recipientName:a,phone:n,address:i}),e.json({success:!1,error:"필수 정보를 입력해주세요"},400);u&&await r.prepare("UPDATE shipping_addresses SET is_default = 0 WHERE user_id = ?").bind(s).run();const l=await r.prepare(`
    ...
    `).bind(t).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await r.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,t).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders",async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),{userId:s,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:u,recipientPhone:l,deliveryMemo:d,totalAmount:_,shippingFee:f,orderNumber:E,paymentKey:y,paymentMethod:h}=t;if(o&&o.length>0){const I=[];for(const U of o){const ce=await r.prepare(`
      ...
      `).bind(P,s||null,_||0,"pending","pending",z||null,u||null,l||null,d||null,y||null).run()).meta.last_row_id;for(const U of I)await r.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(Je,U.product_id,U.option_id,U.quantity,U.price,U.product_name).run();return e.json({success:!0,data:{orderId:Je,orderNumber:P,totalAmount:_}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const g=a.map(()=>"?").join(","),b=await r.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${g})
    `).bind(...a).all();if(b.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const I of b.results)if(I.product_stock<I.quantity)return e.json({success:!1,error:`Insufficient stock for ${I.product_name}`},400);const j=b.results.reduce((I,k)=>I+k.price_snapshot*k.quantity,0),D=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,x=(await r.prepare(`
      INSERT INTO orders (
        order_number, user_id, total_amount,
        shipping_address, shipping_name, shipping_phone
      ) VALUES (?, ?, ?, ?, ?, ?)
    `).bind(D,s,j,n.address,n.name,n.phone).run()).meta.last_row_id,C=[];for(const I of b.results){if((await r.prepare(`
        UPDATE products 
        SET stock = stock - ?, 
            version = version + 1,
            updated_at = datetime('now')
        WHERE id = ? 
          AND stock >= ?
          AND is_active = 1
      `).bind(I.quantity,I.product_id,I.quantity).run()).meta.changes===0){const $=await r.prepare(`
          SELECT stock FROM products WHERE id = ?
        `).bind(I.product_id).first();if(!$||$.stock<I.quantity)return e.json({success:!1,error:`재고 부족: ${I.product_name} (남은 재고: ${($==null?void 0:$.stock)||0}개)`},400);if((await r.prepare(`
            UPDATE products 
            SET stock = stock - ?, 
                version = version + 1,
                updated_at = datetime('now')
            WHERE id = ? 
              AND stock >= ?
          `).bind(I.quantity,I.product_id,I.quantity).run()).meta.changes===0)return e.json({success:!1,error:"주문 처리 중 오류 발생. 다시 시도해주세요."},409)}C.push(r.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(x,I.product_id,I.option_id,I.quantity,I.price_snapshot,I.product_name))}return C.push(r.prepare(`DELETE FROM cart_items WHERE id IN (${g})`).bind(...a)),await r.batch(C),e.json({success:!0,data:{orderId:x,orderNumber:D,totalAmount:j}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/current-product",async e=>{const{DB:r}=e.env,t=e.req.param("streamId");try{const s=await r.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(t).first();if(!s||!s.current_product_id)return e.json({success:!0,data:null});const a=await r.prepare("SELECT * FROM products WHERE id = ?").bind(s.current_product_id).first(),n=await r.prepare("SELECT * FROM product_options WHERE product_id = ?").bind(s.current_product_id).all();return e.json({success:!0,data:{product:a,options:n.results}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/seller/streams",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=t.sellerId,a=await r.prepare(`
      SELECT * FROM live_streams 
      WHERE seller_id = ?
      ORDER BY created_at DESC
    `).bind(s).all();return e.json({success:!0,data:a.results||[]})}catch(s){return console.error("Error loading seller streams:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/seller/streams",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{title:s,description:a,youtube_video_id:n,youtube_url:o,thumbnail_url:i,scheduled_at:c,status:u,seller_instagram:l,seller_youtube:d,seller_facebook:_}=await e.req.json();let f=n,E="youtube",y=null,h=null,g=i;if(o&&!f&&(f=Ps(o),!f))if(f=Hs(o),y=xs(o),h=Fr(o),f)E="tiktok";else return e.json({success:!1,error:"Invalid URL. Please provide a valid YouTube or TikTok live stream URL."},400);if(!g&&f&&E==="youtube"&&(g=`https://img.youtube.com/vi/${f}/maxresdefault.jpg`),!s||!f)return e.json({success:!1,error:"Title and live stream URL are required"},400);const b=await r.prepare(`
    ...
    `).bind(s.sellerId).first(),_={totalProducts:o.count||0,activeProducts:i.count||0,totalStock:c.total||0,totalOrders:u.count||0,totalRevenue:u.total||0,activeStreams:l.count||0,totalViewers:0};return await t.put(a,JSON.stringify(_),{expirationTtl:60}),e.json({success:!0,data:_})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/stats/sales",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.query("period")||"daily";let a,n,o;switch(s){case"weekly":a="%Y-W%W",n="week",o=28;break;case"monthly":a="%Y-%m",n="month",o=180;break;default:a="%Y-%m-%d",n="day",o=30}const i=await r.prepare(`
      SELECT 
      ...
      GROUP BY period
      ORDER BY period ASC
    `).bind(t.sellerId).all();return e.json({success:!0,data:{period:s,sales:i.results}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/seller/stats/products",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=parseInt(e.req.query("limit")||"10"),a=parseInt(e.req.query("days")||"30"),n=await r.prepare(`
      SELECT 
        p.id,
        p.name,
        p.price,
      ...
      LIMIT ?
    `).bind(t.sellerId,s).all();return e.json({success:!0,data:{products:n.results,period_days:a}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/seller/business-info",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{business_number:s,business_name:a,ceo_name:n,business_type:o,business_category:i,postal_code:c,address:u,phone:l,email:d}=await e.req.json();if(!s||!a||!n)return e.json({success:!1,error:"사업자등록번호, 상호명, 대표자명은 필수입니다."},400);const _=await r.prepare(`
    ...
    `).bind(t.sellerId).first();let f;return _?f=await r.prepare(`
      ...
      `).bind(t.sellerId,s,a,n,o,i,c,u,l,d).run(),e.json({success:!0,data:{id:_?_.id:f.meta.last_row_id,seller_id:t.sellerId,business_number:s,is_verified:!1,message:"사업자 정보가 등록되었습니다. 관리자 승인 대기 중입니다."}})}catch(s){return console.error("사업자 정보 등록 오류:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/seller/business-info",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
      SELECT * FROM seller_business_info WHERE seller_id = ?
    `).bind(t.sellerId).first();return s?e.json({success:!0,data:s}):e.json({success:!1,error:"등록된 사업자 정보가 없습니다."},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/seller-business/:id/verify",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);const s=e.req.param("id"),{verified:a}=await e.req.json();try{return a?(await r.prepare(`
        UPDATE seller_business_info
      ...
      `).bind(s).run(),e.json({success:!0,message:"사업자 정보가 승인되었습니다."})):(await r.prepare(`
        ...
        WHERE id = ?
      `).bind(s).run(),e.json({success:!0,message:"사업자 정보 승인이 취소되었습니다."}))}catch(n){return e.json({success:!1,error:n.message},500)}});p.get("/api/admin/seller-business",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
      SELECT 
        sbi.*,
        s.username,
    ...
    `).bind(s.id).all();return e.json({success:!0,data:{...s,items:a.results}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders/:orderId/cancel",async e=>{const{DB:r}=e.env,t=e.req.param("orderId");try{const a=(await e.req.json()).reason||"사유 없음",n=await r.prepare("SELECT * FROM orders WHERE id = ?").bind(t).first();if(!n)return e.json({success:!1,error:"Order not found"},404);if(n.status!=="pending")return e.json({success:!1,error:"결제 대기 중인 주문만 취소할 수 있습니다. 결제가 완료된 주문은 환불을 신청해주세요."},400);const o=await r.prepare("SELECT product_id, quantity FROM order_items WHERE order_id = ?").bind(t).all();for(const i of o.results)await r.prepare("UPDATE products SET stock = stock + ? WHERE id = ?").bind(i.quantity,i.product_id).run();return await r.prepare("UPDATE orders SET status = ?, cancellation_reason = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind("cancelled",a,t).run(),e.json({success:!0,message:"Order cancelled successfully",data:{orderId:t,reason:a,itemsRestored:o.results.length}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/streams/:streamId/viewer-count",async e=>{const{DB:r}=e.env;try{const t=e.req.param("streamId"),s=await r.prepare("SELECT viewer_count FROM live_streams WHERE id = ?").bind(t).first();return s?e.json({success:!0,data:{viewer_count:s.viewer_count||0}}):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/streams/:streamId/viewer-count",async e=>{const{DB:r}=e.env,t=await A(e),s=t.success?{success:!1}:await N(e);if(!t.success&&!s.success)return e.json({success:!1,error:"Unauthorized"},401);try{const a=e.req.param("streamId"),{viewer_count:n}=await e.req.json();return typeof n!="number"||n<0?e.json({success:!1,error:"Invalid viewer count"},400):s.success&&!await r.prepare("SELECT id FROM live_streams WHERE id = ? AND seller_id = ?").bind(a,s.sellerId).first()?e.json({success:!1,error:"Stream not found or unauthorized"},404):(await r.prepare("UPDATE live_streams SET viewer_count = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,a).run(),e.json({success:!0,data:{viewer_count:n}}))}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/streams/:streamId/view",async e=>{const{DB:r}=e.env;try{const t=e.req.param("streamId");await r.prepare("UPDATE live_streams SET viewer_count = viewer_count + 1, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(t).run();const s=await r.prepare("SELECT viewer_count FROM live_streams WHERE id = ?").bind(t).first();return e.json({success:!0,data:{viewer_count:(s==null?void 0:s.viewer_count)||0}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/payments/confirm",async e=>{var s;const{DB:r}=e.env;let t=null;try{t=await e.req.json();const{paymentKey:a,orderId:n,amount:o}=t;if(console.log("========================================"),console.log("[Payment] 🚀 결제 승인 API 호출됨"),console.log("========================================"),console.log("[Payment] 📋 요청 파라미터:"),console.log("  - orderId:",n),console.log("  - paymentKey:",a),console.log("  - amount:",o),console.log("  - timestamp:",new Date().toISOString()),!a||!n||!o)return console.error("[Payment] ❌ 필수 파라미터 누락!"),console.error("[Payment] paymentKey:",!!a),console.error("[Payment] orderId:",!!n),console.error("[Payment] amount:",!!o),e.json({success:!1,error:"필수 파라미터가 누락되었습니다."},400);console.log("[Payment] ✅ 필수 파라미터 검증 통과");const i=e.env.TOSS_SECRET_KEY;if(!i)return console.error("[Payment] ❌ TOSS_SECRET_KEY 환경 변수 없음"),console.error("[Payment] c.env:",Object.keys(e.env||{})),e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);console.log("[Payment] ✅ TOSS_SECRET_KEY 확인됨:",i.substring(0,20)+"..."),console.log("[Payment] 🌐 토스페이먼츠 API 호출 시작..."),console.log("[Payment] API URL: https://api.tosspayments.com/v1/payments/confirm"),console.log("[Payment] API 버전: 2022-11-16 (결제위젯 고정 버전)");const c="Basic "+btoa(i+":");console.log("[Payment] Authorization 헤더 생성 완료");const u={orderId:n,amount:Number(o),paymentKey:a};console.log("[Payment] 요청 본문:",JSON.stringify(u,null,2)),console.log("[Payment] 📊 amount 타입:",typeof u.amount),console.log("[Payment] 📊 amount 값:",u.amount);const l=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:c,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(u)}),d=await l.json();if(console.log("[Payment] 📡 토스페이먼츠 API 응답:"),console.log("  - HTTP 상태:",l.status),console.log("  - 응답 OK?:",l.ok),console.log("  - 응답 데이터 (일부):",JSON.stringify(d).substring(0,300)),!l.ok)return console.error("[Payment] ❌❌❌ 토스페이먼츠 승인 실패!"),console.error("[Payment] HTTP 상태:",l.status),console.error("[Payment] 에러 코드:",d.code),console.error("[Payment] 에러 메시지:",d.message),console.error("[Payment] 전체 응답:",JSON.stringify(d,null,2)),e.json({success:!1,error:d.message||"결제 승인에 실패했습니다.",code:d.code},l.status);console.log("[Payment] ✅ 결제 승인 성공! paymentKey:",a),console.log("[Payment] ✅ 주문 번호:",n);try{await r.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a||null,n,o||null,d,c?1:0,u?1:0).run();return e.json({success:!0,data:{id:_.meta.last_row_id,message:d}})}catch(s){return console.error("Error sending chat message:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/chat/:liveStreamId/messages",O(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.query("since"),a=Number(e.req.query("limit"))||50;try{let n=`
      SELECT 
        id,
        user_id,
        user_name,
    ...
    `;const o=[t];s&&(n+=" AND id > ?",o.push(Number(s))),n+=" ORDER BY created_at DESC LIMIT ?",o.push(a);const c=(await r.prepare(n).bind(...o).all()).results.reverse();return e.json({success:!0,data:c})}catch(n){return console.error("Error fetching chat messages:",n),e.json({success:!1,error:n.message},500)}});p.delete("/api/chat/:liveStreamId/messages/:messageId",O(),async e=>{const{DB:r}=e.env,t=e.req.param("messageId");try{return await r.prepare(`
      UPDATE chat_messages
      SET is_deleted = 1
      WHERE id = ?
    `).bind(t).run(),e.json({success:!0,message:"Message deleted successfully"})}catch(s){return console.error("Error deleting chat message:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/chat/:liveStreamId/ban",O(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId");try{const s=await e.req.json(),{userId:a,bannedBy:n,reason:o,duration:i}=s;if(!a||!n)return e.json({success:!1,error:"userId and bannedBy are required"},400);let c=null;if(i){const u=new Date;u.setMinutes(u.getMinutes()+i),c=u.toISOString()}return await r.prepare(`
      INSERT INTO chat_bans (live_stream_id, user_id, banned_by, reason, expires_at)
      VALUES (?, ?, ?, ?, ?)
    `).bind(t,a,n,o||null,c).run(),e.json({success:!0,message:"User banned successfully"})}catch(s){return console.error("Error banning user:",s),e.json({success:!1,error:s.message},500)}});p.delete("/api/chat/:liveStreamId/ban/:userId",O(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.param("userId");try{return await r.prepare(`
      DELETE FROM chat_bans
      WHERE live_stream_id = ? AND user_id = ?
    `).bind(t,s).run(),e.json({success:!0,message:"Ban removed successfully"})}catch(a){return console.error("Error removing ban:",a),e.json({success:!1,error:a.message},500)}});p.get("/api/notifications",O(),async e=>{const{DB:r}=e.env,t=e.req.query("userId");if(!t)return e.json({success:!1,error:"userId is required"},400);try{const s=await r.prepare(`
      SELECT 
        id,
        type,
        title,
    ...
    `).bind(t).first();return e.json({success:!0,data:{notifications:s.results,unread_count:(a==null?void 0:a.count)||0}})}catch(s){return console.error("Error fetching notifications:",s),e.json({success:!1,error:s.message},500)}});p.put("/api/notifications/:id/read",O(),async e=>{const{DB:r}=e.env,t=e.req.param("id");try{return await r.prepare(`
      UPDATE notifications
      SET is_read = 1
      WHERE id = ?
    `).bind(t).run(),e.json({success:!0,message:"Notification marked as read"})}catch(s){return console.error("Error marking notification as read:",s),e.json({success:!1,error:s.message},500)}});p.put("/api/notifications/read-all",O(),async e=>{const{DB:r}=e.env,t=e.req.query("userId");if(!t)return e.json({success:!1,error:"userId is required"},400);try{return await r.prepare(`
      UPDATE notifications
      SET is_read = 1
      WHERE user_id = ? AND is_read = 0
    `).bind(t).run(),e.json({success:!0,message:"All notifications marked as read"})}catch(s){return console.error("Error marking all notifications as read:",s),e.json({success:!1,error:s.message},500)}});p.delete("/api/notifications/:id",O(),async e=>{const{DB:r}=e.env,t=e.req.param("id");try{return await r.prepare(`
      DELETE FROM notifications WHERE id = ?
    `).bind(t).run(),e.json({success:!0,message:"Notification deleted"})}catch(s){return console.error("Error deleting notification:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/payments/webhook",async e=>{const{DB:r}=e.env;try{const t=await e.req.json();switch(console.log("[Webhook] 토스페이먼츠 웹훅 수신:",{eventType:t.eventType,orderId:t.orderId,status:t.status,timestamp:new Date().toISOString()}),t.eventType){case"PAYMENT_STATUS_CHANGED":await Wr(r,t);break;case"VIRTUAL_ACCOUNT_ISSUED":await qr(r,t);break;default:console.log("[Webhook] 처리하지 않는 이벤트 타입:",t.eventType)}return e.json({success:!0})}catch(t){return console.error("[Webhook] ❌ 웹훅 처리 실패:",t.message),e.json({success:!1,error:t.message},500)}});async function Wr(e,r){const{orderId:t,status:s,paymentKey:a}=r;console.log("[Webhook] 결제 상태 변경:",{orderId:t,status:s}),await e.prepare(`
    UPDATE payments 
    SET status = ?, 
        updated_at = CURRENT_TIMESTAMP,
        pg_raw_data = ?
  ...
  `).bind(s,JSON.stringify(r),a).run(),(s==="DONE"||s==="completed")&&(await e.prepare(`
      ...
      SET payment_status = 'approved',
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE order_number = ?
    `).bind(t).run(),console.log("[Webhook] ✅ 가상계좌 입금 완료 처리:",t))}async function qr(e,r){const{orderId:t,virtualAccount:s}=r;console.log("[Webhook] 가상계좌 발급:",{orderId:t,bank:s==null?void 0:s.bank,accountNumber:s==null?void 0:s.accountNumber}),await e.prepare(`
    UPDATE payments 
  ...
  `).bind(s==null?void 0:s.bank,s==null?void 0:s.accountNumber,s==null?void 0:s.customerName,s==null?void 0:s.dueDate,JSON.stringify(r),t).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",t)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:r}=e.env;try{const t=e.req.param("paymentKey"),s=await e.req.json(),{cancelReason:a,cancelAmount:n}=s;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:t,cancelReason:a,cancelAmount:n}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const o=await r.prepare(`
    ...
    `).bind(t).first();if(!o)return e.json({success:!1,error:"결제 정보를 찾을 수 없습니다."},404);if(o.status==="CANCELED"||o.status==="cancelled")return e.json({success:!1,error:"이미 취소된 결제입니다."},400);const i=o.pg_provider||"tosspayments",c=e.env.TOSS_SECRET_KEY;if(!c)return e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);const u=xr(i,c),l=n&&n<o.amount,d=n||o.amount;console.log("[Payment] PG 결제 취소 요청 중...",{pgProvider:i,paymentKey:t,cancelAmount:d,isPartial:l});const _=await u.cancelPayment({paymentKey:t,cancelReason:a,cancelAmount:d});return _.success?(console.log("[Payment] ✅ PG 결제 취소 완료:",{paymentKey:t,cancelAmount:d,canceledAt:_.canceledAt}),await r.prepare(`
      UPDATE payments 
      SET status = ?,
          cancelled_at = ?,
          pg_raw_data = ?,
    ...
    `).bind(t).all();return e.json({success:!0,data:s.results||[]})}catch(t){return console.error("[Payment] ❌ 결제 목록 조회 실패:",t.message),e.json({success:!1,error:"결제 목록 조회 중 오류가 발생했습니다."},500)}});p.get("/api/seller/orders",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
    ...
    `).bind(t.sellerId).all(),a=await Promise.all(s.results.map(async n=>{const o=await r.prepare(`
        ...
        `).bind(s).first();if(c!=null&&c.buyer_business_number&&(c!=null&&c.buyer_business_name)){console.log(`[AUTO TAX INVOICE] 사업자 구매 확인: ${c.buyer_business_number}`);const u=await r.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(t.sellerId).first();if(!u)console.warn(`[AUTO TAX INVOICE] 판매자 사업자 정보 미승인: seller_id=${t.sellerId}`),await r.prepare(`
            ...
            `).bind(s,t.sellerId).run();else{console.log(`[AUTO TAX INVOICE] 발행 시작: orderNumber=${s}`);const l=await r.prepare(`
              ...
              LEFT JOIN products p ON oi.product_id = p.id
              WHERE oi.order_id = ?
            `).bind(c.id).all(),d=Number(c.total_amount),_=Math.floor(d/1.1),f=d-_,E=new Date().toISOString().split("T")[0].replace(/-/g,""),y=Math.random().toString(36).substring(2,8).toUpperCase(),h=`${E}-${y}`,b=(await r.prepare(`
            ...
            `).bind(t.sellerId,s,h,u.business_number,u.business_name,u.ceo_name,u.address||"",u.business_type||"",u.business_category||"",u.email||"",u.phone||"",c.buyer_business_number,c.buyer_business_name,c.buyer_ceo_name||"",c.buyer_business_address||"",c.buyer_business_type||"",c.buyer_business_category||"",c.buyer_email||"",c.buyer_phone||"",_,f,d,`AUTO-${Date.now()}-${y}`).run()).meta.last_row_id;for(const j of l.results){const D=Math.floor(Number(j.price)*Number(j.quantity)/1.1),w=Number(j.price)*Number(j.quantity)-D;await r.prepare(`
              ...
              `).bind(b,j.product_name||"상품명 없음",j.quantity,j.price,D,w,j.option_name||"").run()}await r.prepare(`
              INSERT INTO tax_invoice_auto_issue_log (order_number, seller_id, tax_invoice_id, status, created_at)
              VALUES (?, ?, ?, 'success', CURRENT_TIMESTAMP)
            `).bind(s,t.sellerId,b).run(),console.log(`[AUTO TAX INVOICE] ✅ 발행 완료: invoice_id=${b}, invoice_number=${h}`)}}else console.log(`[AUTO TAX INVOICE] 일반 구매 (사업자 정보 없음): ${s}`)}catch(c){console.error("[AUTO TAX INVOICE] 발행 실패:",c);try{await r.prepare(`
            INSERT INTO tax_invoice_auto_issue_log (order_number, seller_id, status, error_message, created_at)
            VALUES (?, ?, 'failed', ?, CURRENT_TIMESTAMP)
          `).bind(s,t.sellerId,c.message).run()}catch(u){console.error("[AUTO TAX INVOICE] 로그 기록 실패:",u)}}return e.json({success:!0})}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/seller/orders/:orderNumber/tracking",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("orderNumber"),{courier:a,tracking_number:n}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Courier and tracking number are required"},400);const o=await r.prepare("SELECT id FROM orders WHERE order_number = ?").bind(s).first();return o?await r.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,t.sellerId).first()?(await r.prepare(`
      UPDATE orders 
      SET courier = ?, 
          tracking_number = ?, 
          ...
          updated_at = CURRENT_TIMESTAMP 
      WHERE order_number = ?
    `).bind(a,n,s).run(),e.json({success:!0,message:"Tracking information updated"})):e.json({success:!1,error:"Unauthorized"},403):e.json({success:!1,error:"Order not found"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders/:orderNumber/refund",async e=>{const{DB:r}=e.env,t=e.req.param("orderNumber"),{reason:s}=await e.req.json();try{const a=await r.prepare("SELECT * FROM orders WHERE order_number = ?").bind(t).first();return a?["paid","preparing","shipped","delivered"].includes(a.status)?a.status==="refunded"||a.status==="cancelled"?e.json({success:!1,error:"이미 환불 또는 취소된 주문입니다."},400):(await r.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind("refunded",t).run(),e.json({success:!0,message:"환불 요청이 접수되었습니다. 고객센터(0507-0177-0432)에서 처리 예정입니다.",requiresManualProcessing:!0})):e.json({success:!1,error:"환불이 불가능한 주문 상태입니다."},400):e.json({success:!1,error:"Order not found"},404)}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/admin/orders",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
    ...
    `).all();return e.json({success:!0,data:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/sellers",async e=>{const{DB:r}=e.env,{limit:t="20",offset:s="0"}=e.req.query();try{const a=`
      ...
      ORDER BY created_at DESC
      LIMIT ? OFFSET ?
    `,{results:n}=await r.prepare(a).bind(parseInt(t),parseInt(s)).all();return e.json({success:!0,data:n})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});p.get("/api/admin/sellers",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
    ...
    `).bind(s,_,n,o,i||null,c,u||null,t.adminId).run();return e.json({success:!0,data:{id:f.meta.last_row_id,username:s,name:n,email:o,business_name:c}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/sellers/:id",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{name:a,email:n,phone:o,business_name:i,business_number:c,is_active:u,status:l}=await e.req.json();return await r.prepare("SELECT id FROM sellers WHERE id = ?").bind(s).first()?(await r.prepare(`
      UPDATE sellers 
      SET name = ?, email = ?, phone = ?, business_name = ?, business_number = ?, 
          is_active = ?, status = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(a,n,o||null,i,c||null,u,l,s).run(),e.json({success:!0})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.delete("/api/admin/sellers/:id",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),a=await r.prepare("SELECT id, username FROM sellers WHERE id = ?").bind(s).first();return a?(await r.prepare(`
      UPDATE sellers 
      SET is_active = 0, status = 'suspended', updated_at = datetime('now')
      WHERE id = ?
    `).bind(s).run(),await r.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(s).run(),e.json({success:!0,message:`판매자 '${a.username}'의 로그인 권한이 삭제되었습니다`})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/admin/sellers/:id/reset-password",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{new_password:a}=await e.req.json();if(!a||a.length<6)return e.json({success:!1,error:"비밀번호는 6자 이상이어야 합니다"},400);const n=await r.prepare("SELECT id, username FROM sellers WHERE id = ?").bind(s).first();if(!n)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const o=`$2a$10$placeholder_hash_for_${a}`;return await r.prepare(`
      UPDATE sellers 
      SET password_hash = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(o,s).run(),await r.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(s).run(),e.json({success:!0,message:`판매자 '${n.username}'의 비밀번호가 재설정되었습니다`})}catch(s){return e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/commission",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{commission_rate:a}=await e.req.json();if(a==null)return e.json({success:!1,error:"수수료율을 입력해주세요"},400);const n=parseFloat(a);if(isNaN(n)||n<0||n>100)return e.json({success:!1,error:"수수료율은 0에서 100 사이의 값이어야 합니다"},400);const o=await r.prepare("SELECT id, username, commission_rate FROM sellers WHERE id = ?").bind(s).first();if(!o)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const i=o.commission_rate||10;return await r.prepare(`
      UPDATE sellers 
      SET commission_rate = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(n,s).run(),console.log(`수수료율 변경: 판매자 ${o.username} (ID: ${s}), ${i}% → ${n}%`),e.json({success:!0,message:`판매자 '${o.username}'의 수수료율이 ${i}%에서 ${n}%로 변경되었습니다`,data:{seller_id:s,seller_username:o.username,old_commission_rate:i,new_commission_rate:n}})}catch(s){return console.error("수수료율 변경 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/approve",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),a=await r.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(s).first();return a?a.status==="approved"?e.json({success:!1,error:"이미 승인된 판매자입니다"},400):(await r.prepare(`
      UPDATE sellers 
      SET status = 'approved', 
          is_active = 1,
          approved_by = ?,
          ...
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(t.adminId,s).run(),console.log(`셀러 승인: ${a.username} (ID: ${s}) by Admin ID: ${t.adminId}`),e.json({success:!0,message:`판매자 '${a.name}'님이 승인되었습니다`,data:{seller_id:s,seller_username:a.username,seller_name:a.name,status:"approved",approved_at:new Date().toISOString()}})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return console.error("셀러 승인 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/reject",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{reason:a}=await e.req.json();if(!a)return e.json({success:!1,error:"거부 사유를 입력해주세요"},400);const n=await r.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(s).first();return n?n.status==="rejected"?e.json({success:!1,error:"이미 거부된 판매자입니다"},400):(await r.prepare(`
      UPDATE sellers 
      SET status = 'rejected', 
          is_active = 0,
          rejection_reason = ?,
          ...
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(a,t.adminId,s).run(),console.log(`셀러 거부: ${n.username} (ID: ${s}), 사유: ${a}`),e.json({success:!0,message:`판매자 '${n.name}'님의 승인이 거부되었습니다`,data:{seller_id:s,seller_username:n.username,seller_name:n.name,status:"rejected",rejection_reason:a,rejected_at:new Date().toISOString()}})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return console.error("셀러 거부 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/sellers/pending",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
      SELECT id, username, name, email, phone, business_name, business_number, 
             status, created_at
      FROM sellers
    ...
    `).bind(t).first();return s?e.json({success:!0,data:{seller_id:s.id}}):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(t){return console.error("셀러 조회 실패:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/admin/settlement/stats",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{period:s}=e.req.query();let a="";const n=new Date;switch(s){case"today":a=`AND DATE(o.created_at) = '${n.toISOString().split("T")[0]}'`;break;case"week":a=`AND DATE(o.created_at) >= '${new Date(n.getTime()-10080*60*1e3).toISOString().split("T")[0]}'`;break;case"month":a=`AND DATE(o.created_at) >= '${new Date(n.getTime()-720*60*60*1e3).toISOString().split("T")[0]}'`;break;default:a=""}const o=await r.prepare(`
      SELECT 
    ...
    `).all();return e.json({success:!0,data:{overview:o,sellers:i.results,period:s||"all"}})}catch(s){return console.error("정산 통계 조회 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlement/records",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{seller_id:s,period:a,status:n}=e.req.query();let o=["payment_status = 'completed'","is_cancelled = 0"];const i=[];s&&(o.push("o.seller_id = ?"),i.push(s)),n&&(o.push("o.settlement_status = ?"),i.push(n));const c=new Date;switch(a){case"today":const d=c.toISOString().split("T")[0];o.push(`DATE(o.created_at) = '${d}'`);break;case"week":const _=new Date(c.getTime()-10080*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${_}'`);break;case"month":const f=new Date(c.getTime()-720*60*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${f}'`);break}const u=o.length>0?`WHERE ${o.join(" AND ")}`:"",l=await r.prepare(`
      SELECT 
        o.id,
        o.order_number,
        o.seller_id,
      ...
      ORDER BY o.created_at DESC
      LIMIT 100
    `).bind(...i).all();return e.json({success:!0,data:l.results})}catch(s){return console.error("정산 내역 조회 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/settlement/:orderId/status",async e=>{const{DB:r}=e.env,t=await A(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("orderId"),{status:a}=await e.req.json();if(!["pending","completed"].includes(a))return e.json({success:!1,error:"유효하지 않은 정산 상태입니다"},400);const n=await r.prepare(`
...
`});const f="\uFEFF";return new Response(f+_,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(s){return console.error("CSV 내보내기 실패:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/orders/create",async e=>{const{DB:r}=e.env;try{const{userId:t,cartItems:s,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:u,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:t,cartItems:s==null?void 0:s.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const w=await r.prepare(`
      ...
      `).bind(n,t).first();if(!w)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);E=w}if(!t)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const y=t,h=Date.now(),g=Math.random().toString(36).substring(2,8).toUpperCase(),b=`ORDER_${h}_${g}`;for(const w of s){const x=await r.prepare(`
        SELECT stock FROM products WHERE id = ?
      `).bind(w.product_id).first();if(!x)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${w.product_id})`},400);if(x.stock<w.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${w.product_id})`},400)}const D=(await r.prepare(`
      INSERT INTO orders (
    ...
    `).bind(b,y,a,"pending",o||null,d,_,f,n||null,(E==null?void 0:E.recipient_name)||null,(E==null?void 0:E.phone)||null,E!=null&&E.address?`${E.address} ${E.address_detail}`:null,(E==null?void 0:E.postal_code)||null,i?1:0,c||null,u||null,l||null).run()).meta.last_row_id;for(const w of s)await r.prepare(`
        INSERT INTO order_items (order_id, product_id, option_id, quantity, price)
        VALUES (?, ?, ?, ?, ?)
      `).bind(D,w.product_id,w.option_id||null,w.quantity,w.price_snapshot||w.price).run(),await r.prepare(`
        UPDATE products SET stock = stock - ? WHERE id = ?
      `).bind(w.quantity,w.product_id).run();return console.log("주문 생성 완료:",{orderId:D,orderNumber:b}),e.json({success:!0,orderId:D,orderNumber:b,totalAmount:a})}catch(t){return console.error("주문 생성 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/:orderNumber/refund",O(),async e=>{const{DB:r}=e.env;try{const t=e.req.param("orderNumber"),{reason:s}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:t,reason:s});const a=await r.prepare(`
    ...
    `).bind(a.id).all();for(const o of n.results)await r.prepare(`
        ...
        SET stock = stock + ?,
            ...
            updated_at = datetime('now')
        WHERE id = ?
      `).bind(o.quantity,o.product_id).run(),console.log("[Order Refund] 재고 복구:",{productId:o.product_id,quantity:o.quantity});return console.log("[Order Refund] ✅ 환불 완료:",{orderNumber:t,reason:s}),e.json({success:!0,message:"주문이 취소되었습니다",data:{orderNumber:t,cancelDate:new Date().toISOString()}})}catch(t){return console.error("[Order Refund] Error:",t),e.json({success:!1,error:t.message||"주문 취소 중 오류가 발생했습니다"},500)}});p.get("/api/seller/sales",O(),async e=>{try{const{DB:r}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const s=await De(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(s.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=s.seller_id||s.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],c=o||new Date().toISOString().split("T")[0],u=await r.prepare(`
    ...
    `).bind(a,i,c).first(),d=await r.prepare(`
      ...
      ORDER BY o.created_at DESC
      LIMIT 100
    `).bind(a,i,c).all();return e.json({success:!0,data:{seller:u,stats:l,orders:(d==null?void 0:d.results)||[]}})}catch(r){return console.error("Seller sales query error:",r),e.json({success:!1,error:r.message},500)}});p.get("/api/seller/settlement-csv",O(),async e=>{try{const{DB:r}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const s=await De(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(s.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=s.seller_id||s.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],c=o||new Date().toISOString().split("T")[0],u=await r.prepare(`
      SELECT 
        o.order_number,
        o.total_amount,
        o.commission_amount,
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(r){return console.error("CSV download error:",r),e.json({success:!1,error:r.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{order_number:s}=await e.req.json();if(!s)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await r.prepare(`
    ...
    `).bind(t.sellerId).first();if(!n)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const o=await r.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),c=Math.floor(i/1.1),u=i-c,l=new Date().toISOString().split("T")[0],d=`${l}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,_=Nr(n,a,o.results);let f,E,y;try{f=await Dr(_),E=f.ntsConfirmNumber,y=f.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:E,invoiceKey:y,mockMode:ke()})}catch(b){console.error("바로빌 API 호출 실패:",b),E="FAILED",y=null}const g=(await r.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(t.sellerId,s,"tax",d,l,n.business_number,n.business_name,n.ceo_name,n.address,n.business_type,n.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,c,u,i,E==="FAILED"?"failed":"issued",ke()?"mock":"barobill",y,E).run()).meta.last_row_id;for(const b of o.results){const j=Math.floor(Number(b.price)*Number(b.quantity)/1.1),D=Number(b.price)*Number(b.quantity)-j;await r.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, order_item_id, product_name, quantity,
          unit_price, supply_price, tax_amount, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
      `).bind(g,b.id,b.product_name,b.quantity,b.price,j,D).run()}return e.json({success:!0,data:{invoice_id:g,invoice_number:d,issue_date:l,total_amount:i,supply_price:c,tax_amount:u,status:E==="FAILED"?"failed":"issued",nts_confirm_number:E,api_invoice_key:y,mock_mode:ke(),message:E==="FAILED"?"바로빌 API 호출 실패. 나중에 다시 시도해주세요.":ke()?"세금계산서가 발행되었습니다. (Mock Mode - 실제 발행 아님)":"세금계산서가 발행되었습니다."}})}catch(s){return console.error("세금계산서 발행 오류:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/seller/tax-invoices",async e=>{var s;const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{start_date:a,end_date:n,status:o}=e.req.query();let i=`
      SELECT * FROM tax_invoices
      WHERE seller_id = ?
    `;const c=[t.sellerId];a&&(i+=" AND issue_date >= ?",c.push(a)),n&&(i+=" AND issue_date <= ?",c.push(n)),o&&(i+=" AND status = ?",c.push(o)),i+=" ORDER BY created_at DESC";const u=await r.prepare(i).bind(...c).all();return e.json({success:!0,data:u.results||[],total:((s=u.results)==null?void 0:s.length)||0})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/tax-invoices/:id",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),a=await r.prepare(`
    ...
    `).bind(s).all();return e.json({success:!0,data:{...a,items:n.results||[]}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/:id/cancel",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{reason:a}=await e.req.json(),n=await r.prepare(`
      SELECT * FROM tax_invoices WHERE id = ? AND seller_id = ?
    `).bind(s,t.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!ke()){const u=await r.prepare(`
          SELECT business_number FROM seller_business_info WHERE seller_id = ?
        `).bind(t.sellerId).first();u&&u.business_number&&await jr(u.business_number,n.api_invoice_key,a||"판매자 요청")}}catch(u){console.error("바로빌 취소 API 호출 실패:",u)}return await r.prepare(`
      UPDATE tax_invoices
      SET status = 'cancelled', updated_at = datetime('now')
      WHERE id = ?
    `).bind(s).run(),e.json({success:!0,message:"세금계산서가 취소되었습니다."})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/seller/tax-invoices/auto-issue-logs",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{status:s,limit:a=50}=e.req.query();let n=`
      SELECT 
        log.*,
        o.total_amount,
        o.buyer_business_name
      ...
      WHERE log.seller_id = ?
    `;const o=[t.sellerId];s&&(n+=" AND log.status = ?",o.push(s)),n+=" ORDER BY log.created_at DESC LIMIT ?",o.push(Number(a));const i=await r.prepare(n).bind(...o).all();return e.json({success:!0,data:i.results})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/retry/:orderNumber",async e=>{const{DB:r}=e.env,t=await N(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("orderNumber");console.log(`[TAX INVOICE RETRY] 재시도 시작: ${s}`);const a=await r.prepare(`
    ...
    `).bind(t.sellerId,s,E,i.business_number,i.business_name,i.ceo_name,i.address||"",i.business_type||"",i.business_category||"",i.email||"",i.phone||"",o.buyer_business_number,o.buyer_business_name,o.buyer_ceo_name||"",o.buyer_business_address||"",o.buyer_business_type||"",o.buyer_business_category||"",o.buyer_email||"",o.buyer_phone||"",l,d,u,`RETRY-${Date.now()}-${f}`).run()).meta.last_row_id;for(const g of c.results){const b=Math.floor(Number(g.price)*Number(g.quantity)/1.1),j=Number(g.price)*Number(g.quantity)-b;await r.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, product_name, quantity, unit_price,
          supply_price, tax_amount, description, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
      `).bind(h,g.product_name||"상품명 없음",g.quantity,g.price,b,j,g.option_name||"").run()}return await r.prepare(`
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return Ws({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${t}`,htmlContent:u,textContent:l})}const Kr=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:Ws,sendLiveStreamCreatedEmail:Br},Symbol.toStringTag,{value:"Module"}));export{ds as default};
