var zs=Object.defineProperty;var cs=e=>{throw TypeError(e)};var Gs=(e,r,t)=>r in e?zs(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var S=(e,r,t)=>Gs(e,typeof r!="symbol"?r+"":r,t),Qe=(e,r,t)=>r.has(e)||cs("Cannot "+t);var m=(e,r,t)=>(Qe(e,r,"read from private field"),t?t.call(e):r.get(e)),R=(e,r,t)=>r.has(e)?cs("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,s)=>(Qe(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),O=(e,r,t)=>(Qe(e,r,"access private method"),t);var us=(e,r,t,s)=>({set _(a){T(e,r,a,t)},get _(){return m(e,r,s)}});var ls=(e,r,t)=>(s,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,u=!1,l;if(e[i]?(l=e[i][0][0],s.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{c=await l(s,()=>o(i+1))}catch(d){if(d instanceof Error&&r)s.error=d,c=await r(d,s),u=!0;else throw d}else s.finalized===!1&&t&&(c=await t(s));return c&&(s.finalized===!1||u)&&(s.res=c),s}},Xs=Symbol(),Qs=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,n=(e instanceof Rs?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Zs(e,{all:t,dot:s}):{}};async function Zs(e,r){const t=await e.formData();return t?er(t,r):{}}function er(e,r){const t=Object.create(null);return e.forEach((s,a)=>{r.all||a.endsWith("[]")?sr(t,a,s):t[a]=s}),r.dot&&Object.entries(t).forEach(([s,a])=>{s.includes(".")&&(rr(t,s,a),delete t[s])}),t}var sr=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},rr=(e,r,t)=>{let s=e;const a=r.split(".");a.forEach((n,o)=>{o===a.length-1?s[n]=t:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},bs=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},tr=e=>{const{groups:r,path:t}=ar(e),s=bs(t);return nr(s,r)},ar=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const a=`@${s}`;return r.push([a,t]),a}),{groups:r,path:e}},nr=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let a=e.length-1;a>=0;a--)if(e[a].includes(s)){e[a]=e[a].replace(s,r[t][1]);break}}return e},qe={},or=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return qe[s]||(t[2]?qe[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:qe[s]=[e,t[1],!0]),qe[s]}return null},ts=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},ir=e=>ts(e,decodeURI),ws=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const a=r.charCodeAt(s);if(a===37){const n=r.indexOf("?",s),o=r.slice(t,n===-1?void 0:n);return ir(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return r.slice(t,s)},cr=e=>{const r=ws(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},be=(e,r,...t)=>(t.length&&(r=be(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),Ts=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))s+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){t.length===0&&s===""?t.push("/"):t.push(s);const n=a.replace("?","");s+="/"+n,t.push(s)}else s+="/"+a}),t.filter((a,n,o)=>o.indexOf(a)===n)},Ze=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?ts(e,Is):e):e,Ss=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const c=o+r.length+2,u=e.indexOf("&",c);return Ze(e.slice(c,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const a={};s??(s=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(s&&(c=Ze(c)),n=o,c==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),s&&(u=Ze(u))),t?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(u)):a[c]??(a[c]=u)}return r?a[r]:a},ur=Ss,lr=(e,r)=>Ss(e,r,!0),Is=decodeURIComponent,ds=e=>ts(e,Is),Se,W,te,vs,Os,rs,ae,_s,Rs=(_s=class{constructor(e,r="/",t=[[]]){R(this,te);S(this,"raw");R(this,Se);R(this,W);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});R(this,ae,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,T(this,W,t),T(this,Se,{})}param(e){return e?O(this,te,vs).call(this,e):O(this,te,Os).call(this)}query(e){return ur(this.url,e)}queries(e){return lr(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await Qs(this,e))}json(){return m(this,ae).call(this,"text").then(e=>JSON.parse(e))}text(){return m(this,ae).call(this,"text")}arrayBuffer(){return m(this,ae).call(this,"arrayBuffer")}blob(){return m(this,ae).call(this,"blob")}formData(){return m(this,ae).call(this,"formData")}addValidatedData(e,r){m(this,Se)[e]=r}valid(e){return m(this,Se)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Xs](){return m(this,W)}get matchedRoutes(){return m(this,W)[0].map(([[,e]])=>e)}get routePath(){return m(this,W)[0].map(([[,e]])=>e)[this.routeIndex].path}},Se=new WeakMap,W=new WeakMap,te=new WeakSet,vs=function(e){const r=m(this,W)[0][this.routeIndex][1][e],t=O(this,te,rs).call(this,r);return t&&/\%/.test(t)?ds(t):t},Os=function(){const e={},r=Object.keys(m(this,W)[0][this.routeIndex][1]);for(const t of r){const s=O(this,te,rs).call(this,m(this,W)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?ds(s):s)}return e},rs=function(e){return m(this,W)[1]?m(this,W)[1][e]:e},ae=new WeakMap,_s),dr={Stringify:1},js=async(e,r,t,s,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:r,buffer:a,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(c=>js(c,r,!1,s,a))).then(()=>a[0]))):Promise.resolve(e)},pr="text/plain; charset=UTF-8",es=(e,r)=>({"Content-Type":e,...r}),Pe,Ue,Z,Ie,ee,B,xe,Re,ve,me,He,$e,ne,we,fs,mr=(fs=class{constructor(e,r){R(this,ne);R(this,Pe);R(this,Ue);S(this,"env",{});R(this,Z);S(this,"finalized",!1);S(this,"error");R(this,Ie);R(this,ee);R(this,B);R(this,xe);R(this,Re);R(this,ve);R(this,me);R(this,He);R(this,$e);S(this,"render",(...e)=>(m(this,Re)??T(this,Re,r=>this.html(r)),m(this,Re).call(this,...e)));S(this,"setLayout",e=>T(this,xe,e));S(this,"getLayout",()=>m(this,xe));S(this,"setRenderer",e=>{T(this,Re,e)});S(this,"header",(e,r,t)=>{this.finalized&&T(this,B,new Response(m(this,B).body,m(this,B)));const s=m(this,B)?m(this,B).headers:m(this,me)??T(this,me,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});S(this,"status",e=>{T(this,Ie,e)});S(this,"set",(e,r)=>{m(this,Z)??T(this,Z,new Map),m(this,Z).set(e,r)});S(this,"get",e=>m(this,Z)?m(this,Z).get(e):void 0);S(this,"newResponse",(...e)=>O(this,ne,we).call(this,...e));S(this,"body",(e,r,t)=>O(this,ne,we).call(this,e,r,t));S(this,"text",(e,r,t)=>!m(this,me)&&!m(this,Ie)&&!r&&!t&&!this.finalized?new Response(e):O(this,ne,we).call(this,e,r,es(pr,t)));S(this,"json",(e,r,t)=>O(this,ne,we).call(this,JSON.stringify(e),r,es("application/json",t)));S(this,"html",(e,r,t)=>{const s=a=>O(this,ne,we).call(this,a,r,es("text/html; charset=UTF-8",t));return typeof e=="object"?js(e,dr.Stringify,!1,{}).then(s):s(e)});S(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});S(this,"notFound",()=>(m(this,ve)??T(this,ve,()=>new Response),m(this,ve).call(this,this)));T(this,Pe,e),r&&(T(this,ee,r.executionCtx),this.env=r.env,T(this,ve,r.notFoundHandler),T(this,$e,r.path),T(this,He,r.matchResult))}get req(){return m(this,Ue)??T(this,Ue,new Rs(m(this,Pe),m(this,$e),m(this,He))),m(this,Ue)}get event(){if(m(this,ee)&&"respondWith"in m(this,ee))return m(this,ee);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,ee))return m(this,ee);throw Error("This context has no ExecutionContext")}get res(){return m(this,B)||T(this,B,new Response(null,{headers:m(this,me)??T(this,me,new Headers)}))}set res(e){if(m(this,B)&&e){e=new Response(e.body,e);for(const[r,t]of m(this,B).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=m(this,B).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of s)e.headers.append("set-cookie",a)}else e.headers.set(r,t)}T(this,B,e),this.finalized=!0}get var(){return m(this,Z)?Object.fromEntries(m(this,Z)):{}}},Pe=new WeakMap,Ue=new WeakMap,Z=new WeakMap,Ie=new WeakMap,ee=new WeakMap,B=new WeakMap,xe=new WeakMap,Re=new WeakMap,ve=new WeakMap,me=new WeakMap,He=new WeakMap,$e=new WeakMap,ne=new WeakSet,we=function(e,r,t){const s=m(this,B)?new Headers(m(this,B).headers):m(this,me)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[n,o]of Object.entries(t))if(typeof o=="string")s.set(n,o);else{s.delete(n);for(const i of o)s.append(n,i)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,Ie);return new Response(e,{status:a,headers:s})},fs),P="ALL",_r="all",fr=["get","post","put","delete","options","patch"],Ns="Can not add a route since the matcher is already built.",Ds=class extends Error{},Er="__COMPOSED_HANDLER",hr=e=>e.text("404 Not Found",404),ps=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},V,U,As,J,de,Be,We,Oe,yr=(Oe=class{constructor(r={}){R(this,U);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");R(this,V,"/");S(this,"routes",[]);R(this,J,hr);S(this,"errorHandler",ps);S(this,"onError",r=>(this.errorHandler=r,this));S(this,"notFound",r=>(T(this,J,r),this));S(this,"fetch",(r,...t)=>O(this,U,We).call(this,r,t[1],t[0],r.method));S(this,"request",(r,t,s,a)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${be("/",r)}`,t),s,a)));S(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(O(this,U,We).call(this,r.request,r,void 0,r.request.method))})});[...fr,_r].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?T(this,V,o):O(this,U,de).call(this,n,m(this,V),o),i.forEach(c=>{O(this,U,de).call(this,n,m(this,V),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){T(this,V,c);for(const u of[n].flat())i.map(l=>{O(this,U,de).call(this,u.toUpperCase(),m(this,V),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?T(this,V,n):(T(this,V,"*"),o.unshift(n)),o.forEach(i=>{O(this,U,de).call(this,P,m(this,V),i)}),this);const{strict:s,...a}=r;Object.assign(this,a),this.getPath=s??!0?r.getPath??ws:cr}route(r,t){const s=this.basePath(r);return t.routes.map(a=>{var o;let n;t.errorHandler===ps?n=a.handler:(n=async(i,c)=>(await ls([],t.errorHandler)(i,()=>a.handler(i,c))).res,n[Er]=a.handler),O(o=s,U,de).call(o,a.method,a.path,n)}),this}basePath(r){const t=O(this,U,As).call(this);return t._basePath=be(this._basePath,r),t}mount(r,t,s){let a,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?a=c=>c:a=s.replaceRequest));const o=n?c=>{const u=n(c);return Array.isArray(u)?u:[u]}:c=>{let u;try{u=c.executionCtx}catch{}return[c.env,u]};a||(a=(()=>{const c=be(this._basePath,r),u=c==="/"?0:c.length;return l=>{const d=new URL(l.url);return d.pathname=d.pathname.slice(u)||"/",new Request(d,l)}})());const i=async(c,u)=>{const l=await t(a(c.req.raw),...o(c));if(l)return l;await u()};return O(this,U,de).call(this,P,be(r,"*"),i),this}},V=new WeakMap,U=new WeakSet,As=function(){const r=new Oe({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,T(r,J,m(this,J)),r.routes=this.routes,r},J=new WeakMap,de=function(r,t,s){r=r.toUpperCase(),t=be(this._basePath,t);const a={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,a]),this.routes.push(a)},Be=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},We=function(r,t,s,a){if(a==="HEAD")return(async()=>new Response(null,await O(this,U,We).call(this,r,t,s,"GET")))();const n=this.getPath(r,{env:s}),o=this.router.match(a,n),i=new mr(r,{path:n,matchResult:o,env:s,executionCtx:t,notFoundHandler:m(this,J)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await m(this,J).call(this,i)})}catch(l){return O(this,U,Be).call(this,l,i)}return u instanceof Promise?u.then(l=>l||(i.finalized?i.res:m(this,J).call(this,i))).catch(l=>O(this,U,Be).call(this,l,i)):u??m(this,J).call(this,i)}const c=ls(o[0],this.errorHandler,m(this,J));return(async()=>{try{const u=await c(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return O(this,U,Be).call(this,u,i)}})()},Oe),ks=[];function gr(e,r){const t=this.buildAllMatchers(),s=((a,n)=>{const o=t[a]||t[P],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],ks];const u=c.indexOf("",1);return[o[1][u],c]});return this.match=s,s(e,r)}var Ve="[^/]+",Le=".*",Me="(?:|/.*)",Te=Symbol(),br=new Set(".\\+*[^]$()");function wr(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===Le||e===Me?1:r===Le||r===Me?-1:e===Ve?1:r===Ve?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var _e,fe,z,ye,Tr=(ye=class{constructor(){R(this,_e);R(this,fe);R(this,z,Object.create(null))}insert(r,t,s,a,n){if(r.length===0){if(m(this,_e)!==void 0)throw Te;if(n)return;T(this,_e,t);return}const[o,...i]=r,c=o==="*"?i.length===0?["","",Le]:["","",Ve]:o==="/*"?["","",Me]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(c){const l=c[1];let d=c[2]||Ve;if(l&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Te;if(u=m(this,z)[d],!u){if(Object.keys(m(this,z)).some(_=>_!==Le&&_!==Me))throw Te;if(n)return;u=m(this,z)[d]=new ye,l!==""&&T(u,fe,a.varIndex++)}!n&&l!==""&&s.push([l,m(u,fe)])}else if(u=m(this,z)[o],!u){if(Object.keys(m(this,z)).some(l=>l.length>1&&l!==Le&&l!==Me))throw Te;if(n)return;u=m(this,z)[o]=new ye}u.insert(i,t,s,a,n)}buildRegExpStr(){const t=Object.keys(m(this,z)).sort(wr).map(s=>{const a=m(this,z)[s];return(typeof m(a,fe)=="number"?`(${s})@${m(a,fe)}`:br.has(s)?`\\${s}`:s)+a.buildRegExpStr()});return typeof m(this,_e)=="number"&&t.unshift(`#${m(this,_e)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},_e=new WeakMap,fe=new WeakMap,z=new WeakMap,ye),ze,Fe,Es,Sr=(Es=class{constructor(){R(this,ze,{varIndex:0});R(this,Fe,new Tr)}insert(e,r,t){const s=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const u=`@\\${o}`;return a[o]=[u,c],o++,i=!0,u}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return m(this,Fe).insert(n,r,s,m(this,ze),t),s}buildRegExp(){let e=m(this,Fe).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(t[++r]=Number(n),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},ze=new WeakMap,Fe=new WeakMap,Es),Ir=[/^$/,[],Object.create(null)],Ye=Object.create(null);function Cs(e){return Ye[e]??(Ye[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function Rr(){Ye=Object.create(null)}function vr(e){var u;const r=new Sr,t=[];if(e.length===0)return Ir;const s=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,d],[_,E])=>l?1:_?-1:d.length-E.length),a=Object.create(null);for(let l=0,d=-1,_=s.length;l<_;l++){const[E,f,y]=s[l];E?a[f]=[y.map(([b])=>[b,Object.create(null)]),ks]:d++;let h;try{h=r.insert(f,d,E)}catch(b){throw b===Te?new Ds(f):b}E||(t[d]=y.map(([b,g])=>{const j=Object.create(null);for(g-=1;g>=0;g--){const[N,w]=h[g];j[N]=w}return[b,j]}))}const[n,o,i]=r.buildRegExp();for(let l=0,d=t.length;l<d;l++)for(let _=0,E=t[l].length;_<E;_++){const f=(u=t[l][_])==null?void 0:u[1];if(!f)continue;const y=Object.keys(f);for(let h=0,b=y.length;h<b;h++)f[y[h]]=i[f[y[h]]]}const c=[];for(const l in o)c[l]=t[o[l]];return[n,c,a]}function ge(e,r){if(e){for(const t of Object.keys(e).sort((s,a)=>a.length-s.length))if(Cs(t).test(r))return[...e[t]]}}var oe,ie,Ge,Ls,hs,Or=(hs=class{constructor(){R(this,Ge);S(this,"name","RegExpRouter");R(this,oe);R(this,ie);S(this,"match",gr);T(this,oe,{[P]:Object.create(null)}),T(this,ie,{[P]:Object.create(null)})}add(e,r,t){var i;const s=m(this,oe),a=m(this,ie);if(!s||!a)throw new Error(Ns);s[e]||[s,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[P]).forEach(u=>{c[e][u]=[...c[P][u]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const c=Cs(r);e===P?Object.keys(s).forEach(u=>{var l;(l=s[u])[r]||(l[r]=ge(s[u],r)||ge(s[P],r)||[])}):(i=s[e])[r]||(i[r]=ge(s[e],r)||ge(s[P],r)||[]),Object.keys(s).forEach(u=>{(e===P||e===u)&&Object.keys(s[u]).forEach(l=>{c.test(l)&&s[u][l].push([t,n])})}),Object.keys(a).forEach(u=>{(e===P||e===u)&&Object.keys(a[u]).forEach(l=>c.test(l)&&a[u][l].push([t,n]))});return}const o=Ts(r)||[r];for(let c=0,u=o.length;c<u;c++){const l=o[c];Object.keys(a).forEach(d=>{var _;(e===P||e===d)&&((_=a[d])[l]||(_[l]=[...ge(s[d],l)||ge(s[P],l)||[]]),a[d][l].push([t,n-u+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(m(this,ie)).concat(Object.keys(m(this,oe))).forEach(r=>{e[r]||(e[r]=O(this,Ge,Ls).call(this,r))}),T(this,oe,T(this,ie,void 0)),Rr(),e}},oe=new WeakMap,ie=new WeakMap,Ge=new WeakSet,Ls=function(e){const r=[];let t=e===P;return[m(this,oe),m(this,ie)].forEach(s=>{const a=s[e]?Object.keys(s[e]).map(n=>[n,s[e][n]]):[];a.length!==0?(t||(t=!0),r.push(...a)):e!==P&&r.push(...Object.keys(s[P]).map(n=>[n,s[P][n]]))}),t?vr(r):null},hs),ce,se,ys,jr=(ys=class{constructor(e){S(this,"name","SmartRouter");R(this,ce,[]);R(this,se,[]);T(this,ce,e.routers)}add(e,r,t){if(!m(this,se))throw new Error(Ns);m(this,se).push([e,r,t])}match(e,r){if(!m(this,se))throw new Error("Fatal error");const t=m(this,ce),s=m(this,se),a=t.length;let n=0,o;for(;n<a;n++){const i=t[n];try{for(let c=0,u=s.length;c<u;c++)i.add(...s[c]);o=i.match(e,r)}catch(c){if(c instanceof Ds)continue;throw c}this.match=i.match.bind(i),T(this,ce,[i]),T(this,se,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(m(this,se)||m(this,ce).length!==1)throw new Error("No active router has been determined yet.");return m(this,ce)[0]}},ce=new WeakMap,se=new WeakMap,ys),ke=Object.create(null),ue,F,Ee,je,x,re,pe,Ne,Nr=(Ne=class{constructor(r,t,s){R(this,re);R(this,ue);R(this,F);R(this,Ee);R(this,je,0);R(this,x,ke);if(T(this,F,s||Object.create(null)),T(this,ue,[]),r&&t){const a=Object.create(null);a[r]={handler:t,possibleKeys:[],score:0},T(this,ue,[a])}T(this,Ee,[])}insert(r,t,s){T(this,je,++us(this,je)._);let a=this;const n=tr(t),o=[];for(let i=0,c=n.length;i<c;i++){const u=n[i],l=n[i+1],d=or(u,l),_=Array.isArray(d)?d[0]:u;if(_ in m(a,F)){a=m(a,F)[_],d&&o.push(d[1]);continue}m(a,F)[_]=new Ne,d&&(m(a,Ee).push(d),o.push(d[1])),a=m(a,F)[_]}return m(a,ue).push({[r]:{handler:s,possibleKeys:o.filter((i,c,u)=>u.indexOf(i)===c),score:m(this,je)}}),a}search(r,t){var c;const s=[];T(this,x,ke);let n=[this];const o=bs(t),i=[];for(let u=0,l=o.length;u<l;u++){const d=o[u],_=u===l-1,E=[];for(let f=0,y=n.length;f<y;f++){const h=n[f],b=m(h,F)[d];b&&(T(b,x,m(h,x)),_?(m(b,F)["*"]&&s.push(...O(this,re,pe).call(this,m(b,F)["*"],r,m(h,x))),s.push(...O(this,re,pe).call(this,b,r,m(h,x)))):E.push(b));for(let g=0,j=m(h,Ee).length;g<j;g++){const N=m(h,Ee)[g],w=m(h,x)===ke?{}:{...m(h,x)};if(N==="*"){const L=m(h,F)["*"];L&&(s.push(...O(this,re,pe).call(this,L,r,m(h,x))),T(L,x,w),E.push(L));continue}const[k,C,I]=N;if(!d&&!(I instanceof RegExp))continue;const D=m(h,F)[k],H=o.slice(u).join("/");if(I instanceof RegExp){const L=I.exec(H);if(L){if(w[C]=L[0],s.push(...O(this,re,pe).call(this,D,r,m(h,x),w)),Object.keys(m(D,F)).length){T(D,x,w);const G=((c=L[0].match(/\//))==null?void 0:c.length)??0;(i[G]||(i[G]=[])).push(D)}continue}}(I===!0||I.test(d))&&(w[C]=d,_?(s.push(...O(this,re,pe).call(this,D,r,w,m(h,x))),m(D,F)["*"]&&s.push(...O(this,re,pe).call(this,m(D,F)["*"],r,w,m(h,x)))):(T(D,x,w),E.push(D)))}}n=E.concat(i.shift()??[])}return s.length>1&&s.sort((u,l)=>u.score-l.score),[s.map(({handler:u,params:l})=>[u,l])]}},ue=new WeakMap,F=new WeakMap,Ee=new WeakMap,je=new WeakMap,x=new WeakMap,re=new WeakSet,pe=function(r,t,s,a){const n=[];for(let o=0,i=m(r,ue).length;o<i;o++){const c=m(r,ue)[o],u=c[t]||c[P],l={};if(u!==void 0&&(u.params=Object.create(null),n.push(u),s!==ke||a&&a!==ke))for(let d=0,_=u.possibleKeys.length;d<_;d++){const E=u.possibleKeys[d],f=l[u.score];u.params[E]=a!=null&&a[E]&&!f?a[E]:s[E]??(a==null?void 0:a[E]),l[u.score]=!0}}return n},Ne),he,gs,Dr=(gs=class{constructor(){S(this,"name","TrieRouter");R(this,he);T(this,he,new Nr)}add(e,r,t){const s=Ts(r);if(s){for(let a=0,n=s.length;a<n;a++)m(this,he).insert(e,s[a],t);return}m(this,he).insert(e,r,t)}match(e,r){return m(this,he).search(e,r)}},he=new WeakMap,gs),Ms=class extends yr{constructor(e={}){super(e),this.router=e.router??new jr({routers:[new Or,new Dr]})}},A=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(t.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(t.allowMethods);return async function(o,i){var l;function c(d,_){o.res.headers.set(d,_)}const u=await s(o.req.header("origin")||"",o);if(u&&c("Access-Control-Allow-Origin",u),t.credentials&&c("Access-Control-Allow-Credentials","true"),(l=t.exposeHeaders)!=null&&l.length&&c("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&c("Vary","Origin"),t.maxAge!=null&&c("Access-Control-Max-Age",t.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&c("Access-Control-Allow-Methods",d.join(","));let _=t.allowHeaders;if(!(_!=null&&_.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(_=E.split(/\s*,\s*/))}return _!=null&&_.length&&(c("Access-Control-Allow-Headers",_.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Ar(e){const r=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],t=[];for(const s of r)e[s]||t.push(s);if(t.length>0)throw new Error(`Missing required environment variables: ${t.join(", ")}
...
`)}async function Mr(e){const r=await Cr(e),t=r.filter(n=>n.status==="pass").length,s=r.filter(n=>n.status==="warn").length,a=r.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:r.length,pass:t,warn:s,fail:a},results:r,formatted:Lr(r)}}const ss={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function Pr(){const e=ss.ENV==="production";return{baseUrl:ss.TEST_BASE_URL,apiKey:ss.TEST_API_KEY,isProduction:e}}async function Ps(e,r){const t=Pr(),s=`${t.baseUrl}${e}`;try{const a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify(r)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Ur(e){try{const r={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((s,a)=>({SerialNum:a+1,ItemName:s.name,Qty:s.quantity,UnitPrice:s.unitPrice,SupplyCost:s.supplyPrice,Tax:s.taxAmount,Remark:s.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},t=await Ps("/eTaxInvoice/RegistAndIssue",r);if(t.code!==1)throw new Error(`바로빌 발행 실패: ${t.message}`);return{success:!0,ntsConfirmNumber:t.ntsconfirmNum,invoiceKey:t.invoiceKey,message:t.message}}catch(r){throw console.error("바로빌 세금계산서 발행 실패:",r),r}}async function xr(e,r,t){try{const a=await Ps("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:r,Memo:t});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(s){throw console.error("바로빌 세금계산서 취소 실패:",s),s}}function Ce(){return!1}async function Hr(e){return await Ur(e)}function $r(e,r,t){const s=Number(r.total_amount),a=Math.floor(s/1.1),n=s-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:r.buyer_business_number,buyerBusinessName:r.buyer_business_name||r.user_name,buyerCEO:r.buyer_ceo_name,buyerAddress:r.shipping_address,buyerEmail:r.user_email,buyerTel:r.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:t.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),u=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:u,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:s,memo:`주문번호: ${r.order_number}`,orderNo:r.order_number}}class Y extends Error{constructor(r,t,s){super(r),this.statusCode=t,this.code=s,this.name="AuthError"}}function Fr(e){return`${crypto.randomUUID()}-${e}`}function Kr(e){var n,o,i,c,u,l,d;const r=e.id.toString(),t=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",s=((c=e.kakao_account)==null?void 0:c.email)||null,a=((u=e.properties)==null?void 0:u.profile_image)||((d=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:r,nickname:t,email:s,profileImage:a}}async function qr(e,r,t,s,a){try{const n=await e.prepare(`
    ...
    `).bind(r,t,s,a).first();if(!n)throw new Y("Failed to upsert user",500,"UPSERT_FAILED");return console.log("[Auth] ⚡ User upserted successfully (optimized):",n.id),n}catch(n){throw n instanceof Y?n:(console.error("[Auth] Database error during upsert:",n),new Y("Database error",500,"DB_ERROR"))}}async function Br(e){try{const r=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"}});if(!r.ok){const s=await r.text();throw console.error("[Kakao API] Failed to get user info:",s),new Y("Failed to get user info from Kakao",401,"KAKAO_USER_INFO_FAILED")}const t=await r.json();if(!t.id)throw new Y("Invalid user data from Kakao",500,"INVALID_KAKAO_DATA");return t}catch(r){throw r instanceof Y?r:(console.error("[Kakao API] Network error:",r),new Y("Failed to communicate with Kakao API",503,"KAKAO_API_ERROR"))}}async function Wr(e,r,t){try{const s=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"},body:new URLSearchParams({grant_type:"authorization_code",client_id:t,redirect_uri:r,code:e}).toString()});if(!s.ok){const n=await s.json();throw console.error("[Kakao OAuth] Token exchange failed:",n),new Y(`Failed to exchange code: ${n.error_description||n.error}`,401,n.error||"TOKEN_EXCHANGE_FAILED")}return(await s.json()).access_token}catch(s){throw s instanceof Y?s:(console.error("[Kakao OAuth] Network error:",s),new Y("Failed to communicate with Kakao OAuth server",503,"OAUTH_NETWORK_ERROR"))}}async function Us(e,r){const t=await Br(r),{kakaoId:s,nickname:a,email:n,profileImage:o}=Kr(t);console.log("[Auth] Processing login for Kakao user:",s);const i=await qr(e,s,a,n,o),c=Fr(i.id);return{user:i,sessionToken:c}}async function xs(e,r,t=30){try{const s=await e.get(r,"json");if(!s)return console.log(`[Cache MISS] ${r}`),null;const a=Date.now()-s.timestamp;return a>t*1e3?(console.log(`[Cache EXPIRED] ${r} (age: ${Math.round(a/1e3)}s)`),null):(console.log(`[Cache HIT] ${r} (age: ${Math.round(a/1e3)}s)`),s.data)}catch(s){return console.error(`[Cache] Get error for key "${r}":`,s),null}}async function Je(e,r,t,s=30){try{const a={data:t,timestamp:Date.now()};await e.put(r,JSON.stringify(a),{expirationTtl:s}),console.log(`[Cache SET] ${r} (TTL: ${s}s)`)}catch(a){console.error(`[Cache] Set error for key "${r}":`,a)}}function Yr(e){const r=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:r,message:"API Request",context:e,duration:e.duration}))}function Vr(e){return{name:"tosspayments",async confirmPayment(r){try{const t=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:r.paymentKey,orderId:r.orderId,amount:r.amount})}),s=await t.json();if(!t.ok)return{success:!1,orderId:r.orderId,paymentKey:r.paymentKey,method:"",totalAmount:r.amount,status:"FAILED",approvedAt:"",error:s.message||"결제 승인 실패",rawData:s};let a={};s.card&&(a={cardCompany:s.card.company,cardNumber:s.card.number,installmentMonths:s.card.installmentPlanMonths||0});let n={};return s.virtualAccount&&(n={virtualAccountBank:s.virtualAccount.bankCode,virtualAccountNumber:s.virtualAccount.accountNumber,virtualAccountHolder:s.virtualAccount.customerName,virtualAccountDueDate:s.virtualAccount.dueDate}),{success:!0,orderId:s.orderId,paymentKey:s.paymentKey,method:s.method,totalAmount:s.totalAmount,status:s.status,approvedAt:s.approvedAt,transactionId:s.transactionKey,...a,...n,rawData:s}}catch(t){return{success:!1,orderId:r.orderId,paymentKey:r.paymentKey,method:"",totalAmount:r.amount,status:"FAILED",approvedAt:"",error:t.message,rawData:null}}},async cancelPayment(r){try{const t={cancelReason:r.cancelReason};r.cancelAmount&&(t.cancelAmount=r.cancelAmount);const s=await fetch(`https://api.tosspayments.com/v1/payments/${r.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(t)}),a=await s.json();return s.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(t){return{success:!1,error:t.message}}},async getPayment(r){try{const t=await fetch(`https://api.tosspayments.com/v1/payments/${r}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),s=await t.json();if(!t.ok)throw new Error(s.message);return{success:!0,orderId:s.orderId,paymentKey:s.paymentKey,method:s.method,totalAmount:s.totalAmount,status:s.status,approvedAt:s.approvedAt,rawData:s}}catch(t){throw t}}}}function Jr(e,r){switch(e.toLowerCase()){case"tosspayments":return Vr(r);default:throw new Error(`Unknown payment provider: ${e}`)}}const p=new Ms;p.use("*",async(e,r)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{Ar(e.env),kr(e.env)}catch(s){console.error("[ENV] Validation failed:",s)}await r()});async function Hs(e,r){if(!r)return null;try{const t=await e.get(`session:${r}`);if(!t)return null;const s=JSON.parse(t);return s.expires_at&&Date.now()>s.expires_at?(await e.delete(`session:${r}`),null):{user_id:s.user_id,user_type:s.user_type||"user"}}catch(t){return console.error("[Auth] Session lookup error:",t),null}}async function K(e,r){var n;const{SESSION_KV:t}=e.env;let s=e.req.header("X-Session-Token");if(s||(s=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","")),!s){const o=e.req.header("Cookie");if(o){const i=o.match(/session=([^;]+)/);s=i?i[1]:void 0}}const a=await Hs(t,s);if(!a)return e.json({success:!1,error:"인증이 필요합니다. 로그인 해주세요."},401);try{if(s){const o=await t.get(`session:${s}`);if(o){const i=JSON.parse(o),c=i.expires_at-Date.now(),u=10080*60*1e3;if(c<u){const l=Date.now()+2592e6;await t.put(`session:${s}`,JSON.stringify({...i,expires_at:l}),{expirationTtl:720*60*60}),console.log("[Auth] ✅ Session auto-renewed for user:",a.user_id,"- New expiration:",new Date(l).toISOString())}}}}catch(o){console.error("[Auth] Session renewal error:",o)}e.set("userId",a.user_id),e.set("userType",a.user_type),await r()}async function as(e,r){try{const t=await e.get(r);return t?JSON.parse(t):null}catch(t){return console.error("[Cache] Read error:",t),null}}async function ns(e,r,t,s=60){try{await e.put(r,JSON.stringify(t),{expirationTtl:s})}catch(a){console.error("[Cache] Write error:",a)}}async function os(e,...r){try{await Promise.all(r.map(t=>e.delete(t)))}catch(t){console.error("[Cache] Delete error:",t)}}async function Ke(e,r,t,s,a,n,o){try{await e.prepare(`
      INSERT INTO notifications (user_id, user_type, type, title, message, link)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(r,t,s,a,n,o||null).run(),console.log(`[Notification] Created for ${t} ${r}: ${a}`)}catch(i){console.error("[Notification] Create error:",i)}}async function zr(e,r,t,s,a){await Ke(e,r,"seller","new_order","🛒 신규 주문이 접수되었습니다",`${s}님의 주문 (${t}) - ${Xr(a)}`,"/seller/orders")}async function $s(e,r,t,s,a,n){let o="",i="";switch(s){case"preparing":o="📦 상품 준비 중",i=`주문번호 ${t}의 상품을 준비하고 있습니다`;break;case"shipping":o="🚚 배송이 시작되었습니다",i=`주문번호 ${t}가 배송 중입니다`,a&&n&&(i+=` (${a}: ${n})`);break;case"delivered":o="✅ 배송 완료",i=`주문번호 ${t}가 배송 완료되었습니다`;break;default:return}await Ke(e,r,"user","shipping_status",o,i,"/my-orders")}async function Gr(e,r,t,s,a){await Ke(e,r,"seller","low_stock","⚠️ 재고 부족 알림",`${t}의 재고가 ${s}개로 부족합니다 (기준: ${a}개)`,"/seller/products")}function Xr(e){return new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW"}).format(e)}async function Qr(e,r,t){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const s=await fetch("https://www.googleapis.com/youtube/v3/liveBroadcasts?part=snippet,status,contentDetails",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:r,description:t,scheduledStartTime:new Date().toISOString()},status:{privacyStatus:"public",selfDeclaredMadeForKids:!1},contentDetails:{enableAutoStart:!0,enableAutoStop:!0}})});if(!s.ok){const d=await s.text();throw new Error(`YouTube Broadcast 생성 실패: ${d}`)}const n=(await s.json()).id,o=await fetch("https://www.googleapis.com/youtube/v3/liveStreams?part=snippet,cdn",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:`${r} - Stream`},cdn:{frameRate:"variable",ingestionType:"rtmp",resolution:"variable"}})});if(!o.ok){const d=await o.text();throw new Error(`YouTube Stream 생성 실패: ${d}`)}const i=await o.json(),c=i.id,u=i.cdn.ingestionInfo.streamName,l=i.cdn.ingestionInfo.ingestionAddress;return await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/bind?id=${n}&streamId=${c}&part=snippet`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}}),{broadcastId:n,streamId:c,streamKey:u,streamUrl:l}}catch(s){throw console.error("[YouTube API] Live broadcast creation failed:",s),s}}async function Zr(e,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const t=await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/transition?broadcastStatus=complete&id=${r}&part=status`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}});if(!t.ok){const s=await t.text();throw new Error(`YouTube 방송 종료 실패: ${s}`)}}catch(t){throw console.error("[YouTube API] Live broadcast end failed:",t),t}}async function et(e,r,t){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{let s=`https://www.googleapis.com/youtube/v3/liveChat/messages?liveChatId=${r}&part=snippet,authorDetails`;t&&(s+=`&pageToken=${t}`);const a=await fetch(s,{headers:{Authorization:`Bearer ${e.accessToken}`}});if(!a.ok){const o=await a.text();throw new Error(`YouTube 채팅 메시지 가져오기 실패: ${o}`)}const n=await a.json();return{messages:n.items||[],nextPageToken:n.nextPageToken,pollingIntervalMillis:n.pollingIntervalMillis||5e3}}catch(s){throw console.error("[YouTube API] Get chat messages failed:",s),s}}async function st(e,r){if(!e.apiKey&&!e.accessToken)throw new Error("YouTube API Key 또는 Access Token이 필요합니다");try{const t=e.accessToken?{Authorization:`Bearer ${e.accessToken}`}:{},s=e.accessToken?`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${r}`:`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${r}&key=${e.apiKey}`,a=await fetch(s,{headers:t});if(!a.ok){const u=await a.text();throw new Error(`YouTube 통계 가져오기 실패: ${u}`)}const n=await a.json();if(!n.items||n.items.length===0)throw new Error("Video not found");const o=n.items[0],i=o.statistics,c=o.liveStreamingDetails;return{viewCount:parseInt(i.viewCount||"0"),likeCount:parseInt(i.likeCount||"0"),commentCount:parseInt(i.commentCount||"0"),concurrentViewers:c!=null&&c.concurrentViewers?parseInt(c.concurrentViewers):void 0}}catch(t){throw console.error("[YouTube API] Get live stats failed:",t),t}}function Fs(e){try{if(!/^https?:\/\//.test(e)&&/^[\w-]{11}$/.test(e))return e;const r=new URL(e);if(r.hostname.includes("youtube.com")){const t=r.searchParams.get("v");if(t)return t;const s=r.pathname.match(/\/(embed|live|shorts)\/([a-zA-Z0-9_-]{11})/);if(s)return s[2]}if(r.hostname==="youtu.be"){const t=r.pathname.slice(1).split("?")[0];if(t&&t.length===11)return t}return null}catch{return null}}function Ks(e){try{const r=new URL(e);if(r.hostname.includes("tiktok.com")){const t=r.pathname.match(/\/video\/(\d+)/);if(t)return t[1];const s=r.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(s)return s[1]}return r.hostname.includes("vm.tiktok.com")||r.hostname.includes("vt.tiktok.com")?r.pathname.slice(1):null}catch{return null}}function rt(e){try{const r=new URL(e);if(r.hostname.includes("tiktok.com")){if(r.pathname.includes("/live"))return"live";if(r.pathname.includes("/video/"))return"video"}return null}catch{return null}}function qs(e){try{const r=new URL(e);if(r.hostname.includes("tiktok.com")){const t=r.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(t)return t[1]}return r.hostname.includes("vm.tiktok.com")||r.hostname.includes("vt.tiktok.com")?r.pathname.slice(1):null}catch{return null}}p.use("*",async(e,r)=>{await r(),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://t1.kakaocdn.net https://developers.kakao.com https://js.tosspayments.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net; img-src 'self' data: https: blob:; font-src 'self' data: https://cdn.jsdelivr.net; connect-src 'self' https://api.tosspayments.com https://kauth.kakao.com https://kapi.kakao.com https://www.youtube.com; frame-src 'self' https://www.youtube.com https://youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';");const t=new URL(e.req.url);t.hostname!=="localhost"&&t.protocol==="https:"&&e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("X-Frame-Options","SAMEORIGIN"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});p.use("/api/*",A());p.use("/api/*",async(e,r)=>{const t=Date.now(),s=e.req.method,a=e.req.path;await r();const n=Date.now()-t,o=e.res.status,i={method:s,path:a,status:o,duration:n},c=e.get("userId");c&&(i.userId=c),Yr(i)});p.use("/static/*",async(e,r)=>{await r(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});p.use("/images/*",async(e,r)=>{await r(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});async function Bs(e,r,t,s){const a=crypto.randomUUID(),n=Date.now()+1440*60*1e3,o={user_id:r,user_type:t,userData:s,expires_at:n};return await e.put(`session:${a}`,JSON.stringify(o),{expirationTtl:86400}),console.log(`[createSession] ✅ Session created for ${t} user ${r}`),a}async function De(e,r){const t=await e.get(`session:${r}`);if(!t)return null;const s=JSON.parse(t);return s.expires_at&&Date.now()>s.expires_at?(await e.delete(`session:${r}`),null):{session_token:r,[`${s.user_type}_id`]:s.user_id,user_type:s.user_type,...s.userData}}p.post("/api/auth/user/register",A(),async e=>{const{DB:r}=e.env;try{const{email:t,password:s,name:a,phone:n}=await e.req.json();if(!t||!s||!a)return e.json({success:!1,error:"이메일, 비밀번호, 이름은 필수입니다"},400);const o=`placeholder_hash_for_${s}`;try{const c=(await r.prepare(`
        INSERT INTO users (email, password_hash, name, phone, created_at, last_login_at)
        VALUES (?, ?, ?, ?, datetime('now'), datetime('now'))
      `).bind(t,o,a,n||null).run()).meta.last_row_id,u=`user_${c}_${Date.now()}_${Math.random().toString(36).substring(7)}`;return e.json({success:!0,data:{access_token:u,user:{id:c,email:t,name:a,phone:n}}})}catch(i){const c=i.message||"";if(c.includes("UNIQUE")||c.includes("unique"))return e.json({success:!1,error:"이미 가입된 이메일입니다"},400);throw i}}catch(t){return console.error("[User Register] Error:",t),e.json({success:!1,error:t.message||"회원가입 중 오류가 발생했습니다"},500)}});p.post("/api/auth/user/login",A(),async e=>{const{DB:r,SESSION_KV:t}=e.env;try{const{email:s,password:a}=await e.req.json();if(!s||!a)return e.json({success:!1,error:"이메일과 비밀번호를 입력해주세요"},400);const n=await r.prepare("SELECT * FROM users WHERE email = ?").bind(s).first();if(!n)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(n.password_hash&&n.password_hash.includes(`placeholder_hash_for_${a}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);await r.prepare("UPDATE users SET last_login_at = datetime('now') WHERE id = ?").bind(n.id).run();const i=crypto.randomUUID(),c=Date.now()+1440*60*1e3;return await t.put(`session:${i}`,JSON.stringify({user_id:n.id,user_type:"user",expires_at:c}),{expirationTtl:1440*60}),console.log("[User Login] Session created in SESSION_KV for user:",n.id),e.json({success:!0,data:{session_token:i,user:{id:n.id,email:n.email,name:n.name,phone:n.phone,profile_image:n.profile_image}}})}catch(s){return console.error("[User Login] Error:",s),e.json({success:!1,error:s.message||"로그인 중 오류가 발생했습니다"},500)}});p.post("/api/auth/login",A(),async e=>{const{DB:r}=e.env;try{const{username:t,password:s,userType:a}=await e.req.json();if(!t||!s||!a)return e.json({success:!1,error:"아이디와 비밀번호를 입력해주세요"},400);let n,o=a==="admin"?"admins":"sellers";if(n=await r.prepare(`SELECT * FROM ${o} WHERE username = ? OR email = ?`).bind(t,t).first(),!n)return e.json({success:!1,error:"아이디 또는 비밀번호가 일치하지 않습니다"},401);const i=a==="admin"&&(t==="admin"||t==="admin@example.com")&&s==="admin123",c=a==="seller"&&(t==="seller1"&&s==="seller123"||t==="seller2"&&s==="seller123"),u=n.password_hash&&n.password_hash.includes(`placeholder_hash_for_${s}`);if(!(i||c||u))return e.json({success:!1,error:"아이디 또는 비밀번호가 일치하지 않습니다"},401);if(!n.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);if(a==="seller"&&n.status!=="approved")return e.json({success:!1,error:"승인 대기 중인 계정입니다"},403);const d=await Bs(e.env.SESSION_KV,n.id,a,{username:n.username,name:n.name,email:n.email,businessName:n.business_name,role:n.role});return await r.prepare(`UPDATE ${o} SET last_login_at = datetime('now') WHERE id = ?`).bind(n.id).run(),e.json({success:!0,data:{sessionToken:d,user:{id:n.id,username:n.username,name:n.name,email:n.email,type:a,businessName:n.business_name,role:n.role}}})}catch(t){return console.error("Login error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/auth/logout",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");return t&&await e.env.SESSION_KV.delete(`session:${t}`),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/seller/register",A(),async e=>{const{DB:r}=e.env;try{const{email:t,password:s,name:a,phone:n,business_number:o,company_name:i}=await e.req.json();if(!t||!s||!a||!n)return e.json({success:!1,error:"필수 항목을 모두 입력해주세요"},400);if(s.length<6)return e.json({success:!1,error:"비밀번호는 6자 이상이어야 합니다"},400);const c=t.split("@")[0],u=`placeholder_hash_for_${s}`;try{const l=await r.prepare(`
        INSERT INTO sellers (
      ...
      `).bind(c,t,u,a,n,o||null,i||null).run();return e.json({success:!0,data:{sellerId:l.meta.last_row_id,message:"회원가입이 완료되었습니다. 관리자 승인 후 로그인할 수 있습니다."}})}catch(l){const d=l.message||"";if(d.includes("UNIQUE")||d.includes("unique"))return e.json({success:!1,error:"이미 가입된 이메일입니다"},400);throw l}}catch(t){return console.error("Seller registration error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/admin/login",A(),async e=>{const{DB:r}=e.env;try{const{email:t,password:s}=await e.req.json();if(!t||!s)return e.json({success:!1,error:"이메일과 비밀번호를 입력해주세요"},400);const a=await r.prepare("SELECT * FROM admins WHERE email = ?").bind(t).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(t==="admin@example.com"&&s==="admin123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${s}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);const i=await Bs(e.env.SESSION_KV,a.id,"admin",{username:a.username,email:a.email,name:a.name,role:a.role});return await r.prepare('UPDATE admins SET last_login_at = datetime("now") WHERE id = ?').bind(a.id).run(),e.json({success:!0,data:{token:i,admin:{id:a.id,username:a.username,email:a.email,name:a.name,role:a.role}}})}catch(t){return console.error("Admin login error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/auth/verify",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const s=await De(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=s.user_type==="admin"?"admins":"sellers",n=s.user_type==="admin"?s.admin_id:s.seller_id,o=await r.prepare(`SELECT * FROM ${a} WHERE id = ?`).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:s.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name,role:o.role}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/auth/kakao/sync/callback",async e=>{var t,s,a,n,o,i,c,u,l,d,_,E,f;const{DB:r}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!r);const y=e.req.query("code"),h=e.req.query("state")||"/",b=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!y,state:h,error:b}),b)return console.error("[Kakao Sync] OAuth error:",b),e.redirect(`${h}?error=kakao_oauth_${b}`);if(!y)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${h}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const g=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",j=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",g.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",j),console.log("[Kakao Sync] Step 1: Fetching access token...");const N=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:g,redirect_uri:j,code:y})});if(console.log("[Kakao Sync] Token response status:",N.status),console.log("[Kakao Sync] Token request details:",{client_id:g,redirect_uri:j,code_length:y.length,code_prefix:y.substring(0,20)}),!N.ok){const q=await N.text();return console.error("[Kakao Sync] Token request failed:",q),e.redirect(`${h}?error=token_request_failed&detail=${encodeURIComponent(q)}`)}const w=await N.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!w.access_token,error:w.error,errorDescription:w.error_description}),!w.access_token)return console.error("[Kakao Sync] Token error:",w),e.redirect(`${h}?error=token_failed&detail=${encodeURIComponent(w.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const k=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${w.access_token}`}});console.log("[Kakao Sync] User response status:",k.status);const C=await k.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!C.id,id:C.id,hasNickname:!!((t=C.properties)!=null&&t.nickname||(a=(s=C.kakao_account)==null?void 0:s.profile)!=null&&a.nickname)}),!C.id)return console.error("[Kakao Sync] Failed to get user info:",C),e.redirect(`${h}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const I=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${w.access_token}`}});console.log("[Kakao Sync] Terms response status:",I.status);let D=null;if(I.ok?(D=await I.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=D.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=D.allowed_service_terms)==null?void 0:o.map(q=>q.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!r)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${h}?error=db_not_available`);const H=C.id.toString(),L=((i=C.properties)==null?void 0:i.nickname)||((u=(c=C.kakao_account)==null?void 0:c.profile)==null?void 0:u.nickname)||"Kakao User",G=((l=C.kakao_account)==null?void 0:l.email)||"",X=((d=C.properties)==null?void 0:d.profile_image)||((E=(_=C.kakao_account)==null?void 0:_.profile)==null?void 0:E.profile_image_url)||"",Ae=w.access_token,$=((f=D==null?void 0:D.allowed_service_terms)==null?void 0:f.map(q=>q.tag))||[],le=JSON.stringify($);console.log("[Kakao Sync] User data:",{kakaoId:H,nickname:L,email:G?"exists":"none",serviceTerms:$});try{const q=await r.prepare("SELECT * FROM users WHERE kakao_id = ?").bind(H).first();console.log("[Kakao Sync] Existing user check:",!!q);let Q;q?(Q=q.id,await r.prepare(`
          UPDATE users 
          SET name = ?, 
              email = ?, 
              profile_image = ?,
          ...
          WHERE id = ?
        `).bind(L,G,X,Q).run(),console.log("[Kakao Sync] Updated user:",Q)):(Q=(await r.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
        ...
        `).bind(H,L,G||null,X||null).run()).meta.last_row_id,console.log("[Kakao Sync] Created user:",Q)),console.log("[Kakao Sync] User saved successfully, userId:",Q),console.log("[Kakao Sync] Step 4: Creating session...");const{SESSION_KV:Vs}=e.env,Xe=crypto.randomUUID(),Js=Date.now()+1440*60*1e3;await Vs.put(`session:${Xe}`,JSON.stringify({user_id:Q,user_type:"user",expires_at:Js}),{expirationTtl:1440*60}),console.log("[Kakao Sync] Session created successfully in SESSION_KV"),console.log("[Kakao Sync] Step 5: Redirecting...");const is=h.includes("?")?`${h}&login=success&session=${Xe}&userId=${Q}&userName=${encodeURIComponent(L)}`:`${h}?login=success&session=${Xe}&userId=${Q}&userName=${encodeURIComponent(L)}`;return console.log("[Kakao Sync] Redirect URL:",is),e.redirect(is)}catch(q){return console.error("[Kakao Sync] Database error:",q),console.error("[Kakao Sync] DB error details:",{message:q.message,name:q.name}),e.redirect(`${h}?error=database_error&detail=${encodeURIComponent(q.message)}`)}}catch(y){console.error("[Kakao Sync] Exception:",y),console.error("[Kakao Sync] Error details:",{message:y.message,stack:y.stack,name:y.name});const h=e.req.query("state")||"/",b=encodeURIComponent(y.message||"unknown");return e.redirect(`${h}?error=kakao_sync_failed&detail=${b}`)}});p.post("/api/auth/kakao/callback",A(),async e=>{const{DB:r}=e.env;try{const{code:t,redirect_uri:s}=await e.req.json();if(!t)return e.json({success:!1,error:"Authorization code is required"},400);if(!e.env.KAKAO_REST_API_KEY)return console.error("[Kakao Callback] KAKAO_REST_API_KEY not configured"),e.json({success:!1,error:"Server configuration error",code:"MISSING_API_KEY"},500);const a=s||"https://live.ur-team.com/auth/kakao/callback";console.log("[Kakao Callback] Starting OAuth flow");const n=await Wr(t,a,e.env.KAKAO_REST_API_KEY),{user:o,sessionToken:i}=await Us(r,n),c=Date.now()+720*60*60*1e3;return await e.env.SESSION_KV.put(`session:${i}`,JSON.stringify({user_id:o.id,user_type:"user",expires_at:c}),{expirationTtl:720*60*60}),console.log("[Kakao Callback] ✅ Session saved to SESSION_KV for user:",o.id,"- Expires:",new Date(c).toISOString()),e.json({success:!0,data:{session_token:i,user:{id:o.id,name:o.name,email:o.email,profile_image:o.profile_image}}})}catch(t){return console.error("[Kakao Callback] Error:",t),t instanceof Y?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t.message||"Internal server error",code:"UNKNOWN_ERROR"},500)}});p.post("/api/auth/kakao/sync",A(),async e=>{const{DB:r}=e.env;try{const{accessToken:t}=await e.req.json();if(!t)return e.json({success:!1,error:"Access token is required"},400);console.log("[Kakao Sync] Verifying access token");const{user:s,sessionToken:a}=await Us(r,t),n=Date.now()+720*60*60*1e3;return await e.env.SESSION_KV.put(`session:${a}`,JSON.stringify({user_id:s.id,user_type:"user",expires_at:n}),{expirationTtl:720*60*60}),console.log("[Kakao Sync] ✅ Session saved to SESSION_KV for user:",s.id,"- Expires:",new Date(n).toISOString()),console.log("[Kakao Sync] Login successful"),e.json({success:!0,data:{session_token:a,user:{id:s.id,name:s.name,email:s.email,profile_image:s.profile_image}}})}catch(t){return console.error("[Kakao Sync] Error:",t),t instanceof Y?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t instanceof Error?t.message:"Login failed",code:"UNKNOWN_ERROR"},500)}});p.get("/api/auth/validate",A(),async e=>{var t;const{SESSION_KV:r}=e.env;try{const s=e.req.header("X-Session-Token")||((t=e.req.header("Authorization"))==null?void 0:t.replace("Bearer ",""))||"";if(!s)return e.json({success:!1,error:"No session token provided",code:"NO_TOKEN"},401);const a=await Hs(r,s);return a?e.json({success:!0,data:{user_id:a.user_id,user_type:a.user_type,session_valid:!0}}):e.json({success:!1,error:"Session expired or invalid",code:"SESSION_EXPIRED"},401)}catch(s){return console.error("[Auth Validate] Error:",s),e.json({success:!1,error:"Validation failed",code:"VALIDATION_ERROR"},500)}});p.post("/api/auth/kakao/logout",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token")||"";return t&&(await r.prepare("DELETE FROM admin_sessions WHERE session_token = ?").bind(t).run(),console.log("[Kakao Sync] Session deleted")),e.json({success:!0})}catch(t){return console.error("[Kakao Sync] Logout error:",t),e.json({success:!1,error:"Logout failed"},500)}});p.post("/api/auth/kakao/unlink",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증이 필요합니다"},401);if(console.log("[Kakao Unlink] Starting unlink process..."),!await r.prepare(`
    ...
    `).run(),await r.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(n.id).run(),await r.prepare("DELETE FROM users WHERE id = ?").bind(n.id).run(),console.log("[Kakao Webhook] User data deleted successfully"),e.json({success:!0})):(console.log("[Kakao Webhook] User not found:",s),e.json({success:!0}))}catch(t){return console.error("[Kakao Webhook] Error:",t),e.json({success:!1,error:"Webhook processing failed"},500)}});p.get("/api/auth/user/verify",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const s=await De(e.env.SESSION_KV,t);if(!s||s.user_type!=="user")return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=parseInt(t.split("_")[1]),n=await r.prepare("SELECT * FROM users WHERE id = ?").bind(a).first();return n?e.json({success:!0,data:{user:{id:n.id,name:n.name,email:n.email,profileImage:n.profile_image,phone:n.phone}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/shipping-addresses",A(),K,async e=>{const{DB:r}=e.env,t=e.get("userId");try{const s=await r.prepare(`
      SELECT * FROM shipping_addresses WHERE user_id = ? ORDER BY is_default DESC, created_at DESC
    `).bind(t).all();return e.json({success:!0,data:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/shipping-addresses/:userId",A(),K,async e=>{const{DB:r}=e.env,t=e.get("userId"),s=parseInt(e.req.param("userId"));try{if(s!==t)return e.json({success:!1,error:"본인의 배송지만 조회할 수 있습니다."},403);const a=await r.prepare(`
      SELECT * FROM shipping_addresses WHERE user_id = ? ORDER BY is_default DESC, created_at DESC
    `).bind(t).all();return e.json({success:!0,data:a.results||[]})}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/shipping-addresses",A(),async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),s=t.user_id,a=t.recipient_name,n=t.phone,o=t.postal_code,i=t.address,c=t.address_detail,u=t.is_default;if(console.log("[POST /api/shipping-addresses] Received:",JSON.stringify(t)),!s||!a||!n||!i)return console.error("[POST /api/shipping-addresses] Missing required fields:",{userId:s,recipientName:a,phone:n,address:i}),e.json({success:!1,error:"필수 정보를 입력해주세요"},400);u&&await r.prepare("UPDATE shipping_addresses SET is_default = 0 WHERE user_id = ?").bind(s).run();const l=await r.prepare(`
    ...
    `;const i=[];t&&(o+=" AND ls.status = ?",i.push(t)),s&&(o+=" AND ls.seller_id = ?",i.push(s)),o+=' ORDER BY CASE ls.status WHEN "active" THEN 1 WHEN "scheduled" THEN 2 ELSE 3 END, ls.created_at DESC',o+=" LIMIT ? OFFSET ?",i.push(parseInt(a),parseInt(n));const{results:c}=await r.prepare(o).bind(...i).all();return e.json({success:!0,data:c})}catch(o){return console.error("[API] Live streams list error:",o),e.json({success:!1,error:`라이브 스트림 목록 조회 실패: ${o.message}`},500)}});p.get("/api/live-streams/:id",async e=>{const{DB:r}=e.env,t=e.req.param("id");try{const s=await r.prepare(`
      ...
      LEFT JOIN products p ON ls.current_product_id = p.id
      WHERE ls.id = ?
    `).bind(t).first();return s?e.json({success:!0,data:s}):e.json({success:!1,error:"Stream not found"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/products",async e=>{const{DB:r,CACHE_KV:t}=e.env;try{const s=e.req.query("featured"),a=parseInt(e.req.query("limit")||"20"),n=parseInt(e.req.query("offset")||"0"),o=`products:list:${s||"all"}:${a}:${n}`,i=await as(t,o);if(i)return e.json({success:!0,data:i,cached:!0});let c;s==="true"?c=`
        SELECT 
          p.id,
          p.name,
          p.description,
    ...
    `).bind(_,n,o||null,o||null).first();let y;if(f){const h=f.quantity+i;await r.prepare(`
        ...
        SET quantity = ?, 
            price_snapshot = ?
        WHERE id = ?
      `).bind(h,c,f.id).run(),y=f.id}else y=(await r.prepare(`
        INSERT INTO cart_items (user_id, product_id, option_id, quantity, price_snapshot, live_stream_id)
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(_,n,o||null,i,c,u||null).run()).meta.last_row_id;return e.json({success:!0,data:{id:y,isUpdate:!!f}})}catch(t){return console.error("[API /api/cart POST] Error:",t),console.error("[API /api/cart POST] Error message:",t.message),console.error("[API /api/cart POST] Error stack:",t.stack),e.json({success:!1,error:"Failed to add to cart: "+(t.message||"Unknown error")},500)}});p.delete("/api/cart/:cartItemId",async e=>{const{DB:r}=e.env,t=e.req.param("cartItemId");try{return await r.prepare("DELETE FROM cart_items WHERE id = ?").bind(t).run(),e.json({success:!0})}catch(s){return e.json({success:!1,error:s.message},500)}});p.delete("/api/cart/clear/:userId",async e=>{const{DB:r}=e.env,t=e.req.param("userId");try{return await r.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(t).run(),e.json({success:!0,message:"장바구니가 비워졌습니다."})}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/cart/:cartItemId",async e=>{const{DB:r}=e.env,t=e.req.param("cartItemId");try{const s=await e.req.json(),{quantity:a}=s;if(!a||a<1)return e.json({success:!1,error:"Invalid quantity"},400);const n=await r.prepare(`
      SELECT ci.product_id, p.stock
      FROM cart_items ci
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id = ?
    `).bind(t).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await r.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,t).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders",async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),{userId:s,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:u,recipientPhone:l,deliveryMemo:d,totalAmount:_,shippingFee:E,orderNumber:f,paymentKey:y,paymentMethod:h}=t;if(o&&o.length>0){const I=[];for(const $ of o){const le=await r.prepare(`
          SELECT id, name, price, stock 
          FROM products 
          WHERE id = ?
        `).bind($.productId).first();if(!le)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${$.productId})`},400);if(le.stock<$.quantity)return e.json({success:!1,error:`재고 부족: ${le.name} (남은 재고: ${le.stock}개)`},400);I.push({product_id:$.productId,option_id:$.optionId||null,quantity:$.quantity,price:$.price,product_name:le.name,product_stock:le.stock})}const D=Date.now(),H=Math.random().toString(36).substring(2,8).toUpperCase(),L=f||`ORDER_${D}_${H}`,G=c?`${i} ${c}`:i,Ae=(await r.prepare(`
        INSERT INTO orders (
      ...
      `).bind(L,s||null,_||0,"pending","pending",G||null,u||null,l||null,d||null,y||null).run()).meta.last_row_id;for(const $ of I)await r.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(Ae,$.product_id,$.option_id,$.quantity,$.price,$.product_name).run();return e.json({success:!0,data:{orderId:Ae,orderNumber:L,totalAmount:_}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const b=a.map(()=>"?").join(","),g=await r.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${b})
    `).bind(...a).all();if(g.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const I of g.results)if(I.product_stock<I.quantity)return e.json({success:!1,error:`Insufficient stock for ${I.product_name}`},400);const j=g.results.reduce((I,D)=>I+D.price_snapshot*D.quantity,0),N=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,k=(await r.prepare(`
      INSERT INTO orders (
        order_number, user_id, total_amount,
        shipping_address, shipping_name, shipping_phone
      ) VALUES (?, ?, ?, ?, ?, ?)
    `).bind(N,s,j,n.address,n.name,n.phone).run()).meta.last_row_id,C=[];for(const I of g.results){let D=!1,H="";for(let L=0;L<3;L++){if((await r.prepare(`
          UPDATE products 
          SET stock = stock - ?, 
              version = version + 1,
              updated_at = datetime('now')
          WHERE id = ? 
            AND stock >= ?
            AND is_active = 1
        `).bind(I.quantity,I.product_id,I.quantity).run()).meta.changes>0){D=!0;break}const X=await r.prepare(`
          SELECT stock FROM products WHERE id = ?
        `).bind(I.product_id).first();if(!X||X.stock<I.quantity){H=`재고 부족: ${I.product_name} (남은 재고: ${(X==null?void 0:X.stock)||0}개)`;break}L<2?await new Promise(Ae=>setTimeout(Ae,50*L)):H="주문 처리 중 오류 발생. 다시 시도해주세요. (동시성 충돌)"}if(!D)return e.json({success:!1,error:H||"주문 처리 중 오류가 발생했습니다."},H.includes("재고 부족")?400:409);C.push(r.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(k,I.product_id,I.option_id,I.quantity,I.price_snapshot,I.product_name))}C.push(r.prepare(`DELETE FROM cart_items WHERE id IN (${b})`).bind(...a)),await r.batch(C);try{const I=new Set;for(const D of g.results){const H=await r.prepare("SELECT seller_id FROM products WHERE id = ?").bind(D.product_id).first();H&&H.seller_id&&I.add(H.seller_id)}for(const D of I)await zr(r,D,N,buyerName||shippingName||"고객",j)}catch(I){console.error("[Order] Notification error:",I)}return e.json({success:!0,data:{orderId:k,orderNumber:N,totalAmount:j}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/current-product",async e=>{const{DB:r,LIVE_CACHE:t}=e.env,s=e.req.param("streamId");try{const a=`current-product:${s}`,n=await xs(t,a,3);if(n)return e.json({success:!0,data:n});const o=await r.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(s).first();if(!o||!o.current_product_id)return await Je(t,a,null,3),e.json({success:!0,data:null});const i=await r.prepare("SELECT * FROM products WHERE id = ?").bind(o.current_product_id).first(),c=await r.prepare("SELECT * FROM product_options WHERE product_id = ?").bind(o.current_product_id).all(),u={product:i,options:c.results};return await Je(t,a,u,3),e.json({success:!0,data:u})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/streams/:streamId/product-wait",async e=>{const{LIVE_CACHE:r}=e.env,t=e.req.param("streamId"),s=e.req.query("lastTimestamp")||"0";try{const a=`product-timestamp:${t}`,n=`current-product:${t}`,o=25e3,i=Date.now();for(;Date.now()-i<o;){const c=await r.get(a)||"0";if(c!==s){const u=await xs(r,n,30);return e.json({success:!0,timestamp:c,data:u,changed:!0})}await new Promise(u=>setTimeout(u,1e3))}return e.json({success:!0,timestamp:s,data:null,changed:!1})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/streams",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=t.sellerId,a=await r.prepare(`
      SELECT * FROM live_streams 
      WHERE seller_id = ?
      ORDER BY created_at DESC
    `).bind(s).all();return e.json({success:!0,data:a.results||[]})}catch(s){return console.error("Error loading seller streams:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/seller/streams",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{title:s,description:a,youtube_video_id:n,youtube_url:o,thumbnail_url:i,scheduled_at:c,status:u,seller_instagram:l,seller_youtube:d,seller_facebook:_}=await e.req.json();let E=n,f="youtube",y=null,h=null,b=i;if(o&&!E&&(E=Fs(o),!E))if(E=Ks(o),y=qs(o),h=rt(o),E)f="tiktok";else return e.json({success:!1,error:"Invalid URL. Please provide a valid YouTube or TikTok live stream URL."},400);if(!b&&E&&f==="youtube"&&(b=`https://img.youtube.com/vi/${E}/maxresdefault.jpg`),!s||!E)return e.json({success:!1,error:"Title and live stream URL are required"},400);const g=await r.prepare(`
    ...
    `).bind(t.sellerId).first();let E;return _?E=await r.prepare(`
        ...
        SET business_number = ?,
            ...
            updated_at = datetime('now')
        WHERE seller_id = ?
      `).bind(s,a,n,o,i,c,u,l,d,t.sellerId).run():E=await r.prepare(`
    ...
    `).bind(t.sellerId).first();return s?e.json({success:!0,data:s}):e.json({success:!1,error:"등록된 사업자 정보가 없습니다."},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/seller-business/:id/verify",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);const s=e.req.param("id"),{verified:a}=await e.req.json();try{return a?(await r.prepare(`
      ...
      `).bind(s).run(),e.json({success:!0,message:"사업자 정보가 승인되었습니다."})):(await r.prepare(`
        ...
        WHERE id = ?
      `).bind(s).run(),e.json({success:!0,message:"사업자 정보 승인이 취소되었습니다."}))}catch(n){return e.json({success:!1,error:n.message},500)}});p.get("/api/admin/seller-business",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
      SELECT 
        sbi.*,
        s.username,
    ...
    `).bind(s.id).all();return e.json({success:!0,data:{...s,items:a.results}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders/:orderId/cancel",async e=>{const{DB:r}=e.env,t=e.req.param("orderId");try{const a=(await e.req.json()).reason||"사유 없음",n=await r.prepare("SELECT * FROM orders WHERE id = ?").bind(t).first();if(!n)return e.json({success:!1,error:"Order not found"},404);if(n.status!=="pending")return e.json({success:!1,error:"결제 대기 중인 주문만 취소할 수 있습니다. 결제가 완료된 주문은 환불을 신청해주세요."},400);const o=await r.prepare("SELECT product_id, quantity FROM order_items WHERE order_id = ?").bind(t).all();for(const i of o.results)await r.prepare("UPDATE products SET stock = stock + ? WHERE id = ?").bind(i.quantity,i.product_id).run();return await r.prepare("UPDATE orders SET status = ?, cancellation_reason = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind("cancelled",a,t).run(),e.json({success:!0,message:"Order cancelled successfully",data:{orderId:t,reason:a,itemsRestored:o.results.length}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/streams/:streamId/viewer-count",async e=>{const{DB:r}=e.env;try{const t=e.req.param("streamId"),s=await r.prepare("SELECT viewer_count FROM live_streams WHERE id = ?").bind(t).first();return s?e.json({success:!0,data:{viewer_count:s.viewer_count||0}}):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/streams/:streamId/viewer-count",async e=>{const{DB:r}=e.env,t=await M(e),s=t.success?{success:!1}:await v(e);if(!t.success&&!s.success)return e.json({success:!1,error:"Unauthorized"},401);try{const a=e.req.param("streamId"),{viewer_count:n}=await e.req.json();return typeof n!="number"||n<0?e.json({success:!1,error:"Invalid viewer count"},400):s.success&&!await r.prepare("SELECT id FROM live_streams WHERE id = ? AND seller_id = ?").bind(a,s.sellerId).first()?e.json({success:!1,error:"Stream not found or unauthorized"},404):(await r.prepare("UPDATE live_streams SET viewer_count = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,a).run(),e.json({success:!0,data:{viewer_count:n}}))}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/streams/:streamId/view",async e=>{const{DB:r}=e.env;try{const t=e.req.param("streamId");await r.prepare("UPDATE live_streams SET viewer_count = viewer_count + 1, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(t).run();const s=await r.prepare("SELECT viewer_count FROM live_streams WHERE id = ?").bind(t).first();return e.json({success:!0,data:{viewer_count:(s==null?void 0:s.viewer_count)||0}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/payments/confirm",async e=>{var s;const{DB:r}=e.env;let t=null;try{t=await e.req.json();const{paymentKey:a,orderId:n,amount:o}=t;if(console.log("========================================"),console.log("[Payment] 🚀 결제 승인 API 호출됨"),console.log("========================================"),console.log("[Payment] 📋 요청 파라미터:"),console.log("  - orderId:",n),console.log("  - paymentKey:",a),console.log("  - amount:",o),console.log("  - timestamp:",new Date().toISOString()),!a||!n||!o)return console.error("[Payment] ❌ 필수 파라미터 누락!"),console.error("[Payment] paymentKey:",!!a),console.error("[Payment] orderId:",!!n),console.error("[Payment] amount:",!!o),e.json({success:!1,error:"필수 파라미터가 누락되었습니다.",details:{paymentKey:!!a,orderId:!!n,amount:!!o}},400);console.log("[Payment] ✅ 필수 파라미터 검증 통과");const i=await r.prepare("SELECT id, order_number, total_amount, status FROM orders WHERE order_number = ?").bind(n).first();if(!i)return console.error("[Payment] ❌ 주문을 찾을 수 없음:",n),e.json({success:!1,error:"주문을 찾을 수 없습니다. 주문이 생성되지 않았거나 이미 처리되었습니다.",orderId:n},404);if(console.log("[Payment] ✅ 주문 확인됨:",{id:i.id,order_number:i.order_number,total_amount:i.total_amount,status:i.status}),Number(o)!==Number(i.total_amount))return console.error("[Payment] ❌ 금액 불일치!",{requested:Number(o),expected:Number(i.total_amount)}),e.json({success:!1,error:"결제 금액이 주문 금액과 일치하지 않습니다.",requestedAmount:Number(o),expectedAmount:Number(i.total_amount)},400);const c=e.env.TOSS_SECRET_KEY;if(!c)return console.error("[Payment] ❌ TOSS_SECRET_KEY 환경 변수 없음"),console.error("[Payment] c.env:",Object.keys(e.env||{})),e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);console.log("[Payment] ✅ TOSS_SECRET_KEY 확인됨:",c.substring(0,20)+"..."),console.log("[Payment] 🌐 토스페이먼츠 API 호출 시작..."),console.log("[Payment] API URL: https://api.tosspayments.com/v1/payments/confirm"),console.log("[Payment] API 버전: 2022-11-16 (결제위젯 고정 버전)");const u="Basic "+btoa(c+":");console.log("[Payment] Authorization 헤더 생성 완료");const l={orderId:n,amount:Number(o),paymentKey:a};console.log("[Payment] 요청 본문:",JSON.stringify(l,null,2)),console.log("[Payment] 📊 amount 타입:",typeof l.amount),console.log("[Payment] 📊 amount 값:",l.amount);const d=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:u,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(l)}),_=await d.json();if(console.log("[Payment] 📡 토스페이먼츠 API 응답:"),console.log("  - HTTP 상태:",d.status),console.log("  - 응답 OK?:",d.ok),console.log("  - 응답 데이터 (일부):",JSON.stringify(_).substring(0,300)),!d.ok)return console.error("[Payment] ❌❌❌ 토스페이먼츠 승인 실패!"),console.error("[Payment] HTTP 상태:",d.status),console.error("[Payment] 에러 코드:",_.code),console.error("[Payment] 에러 메시지:",_.message),console.error("[Payment] 전체 응답:",JSON.stringify(_,null,2)),e.json({success:!1,error:_.message||"결제 승인에 실패했습니다.",code:_.code,tossError:_},d.status);console.log("[Payment] ✅ 결제 승인 성공! paymentKey:",a),console.log("[Payment] ✅ 주문 번호:",n);try{await r.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a||null,n,o||null,d,c?1:0,u?1:0).run();return e.json({success:!0,data:{id:_.meta.last_row_id,message:d}})}catch(s){return console.error("Error sending chat message:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/chat/:liveStreamId/messages",A(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.query("since"),a=Number(e.req.query("limit"))||50;try{let n=`
      SELECT 
        id,
        user_id,
        user_name,
    ...
    `;const o=[t];s&&(n+=" AND id > ?",o.push(Number(s))),n+=" ORDER BY created_at DESC LIMIT ?",o.push(a);const c=(await r.prepare(n).bind(...o).all()).results.reverse();return e.json({success:!0,data:c})}catch(n){return console.error("Error fetching chat messages:",n),e.json({success:!1,error:n.message},500)}});p.delete("/api/chat/:liveStreamId/messages/:messageId",A(),async e=>{const{DB:r}=e.env,t=e.req.param("messageId");try{return await r.prepare(`
      UPDATE chat_messages
      SET is_deleted = 1
      WHERE id = ?
    `).bind(t).run(),e.json({success:!0,message:"Message deleted successfully"})}catch(s){return console.error("Error deleting chat message:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/chat/:liveStreamId/ban",A(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId");try{const s=await e.req.json(),{userId:a,bannedBy:n,reason:o,duration:i}=s;if(!a||!n)return e.json({success:!1,error:"userId and bannedBy are required"},400);let c=null;if(i){const u=new Date;u.setMinutes(u.getMinutes()+i),c=u.toISOString()}return await r.prepare(`
      INSERT INTO chat_bans (live_stream_id, user_id, banned_by, reason, expires_at)
      VALUES (?, ?, ?, ?, ?)
    `).bind(t,a,n,o||null,c).run(),e.json({success:!0,message:"User banned successfully"})}catch(s){return console.error("Error banning user:",s),e.json({success:!1,error:s.message},500)}});p.delete("/api/chat/:liveStreamId/ban/:userId",A(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.param("userId");try{return await r.prepare(`
      DELETE FROM chat_bans
      WHERE live_stream_id = ? AND user_id = ?
    `).bind(t,s).run(),e.json({success:!0,message:"Ban removed successfully"})}catch(a){return console.error("Error removing ban:",a),e.json({success:!1,error:a.message},500)}});p.post("/api/payments/webhook",async e=>{const{DB:r}=e.env;try{const t=await e.req.json();switch(console.log("[Webhook] 토스페이먼츠 웹훅 수신:",{eventType:t.eventType,orderId:t.orderId,status:t.status,timestamp:new Date().toISOString()}),t.eventType){case"PAYMENT_STATUS_CHANGED":await tt(r,t);break;case"VIRTUAL_ACCOUNT_ISSUED":await at(r,t);break;default:console.log("[Webhook] 처리하지 않는 이벤트 타입:",t.eventType)}return e.json({success:!0})}catch(t){return console.error("[Webhook] ❌ 웹훅 처리 실패:",t.message),e.json({success:!1,error:t.message},500)}});async function tt(e,r){const{orderId:t,status:s,paymentKey:a}=r;console.log("[Webhook] 결제 상태 변경:",{orderId:t,status:s}),await e.prepare(`
    UPDATE payments 
    SET status = ?, 
        updated_at = CURRENT_TIMESTAMP,
        pg_raw_data = ?
  ...
  `).bind(s,JSON.stringify(r),a).run(),(s==="DONE"||s==="completed")&&(await e.prepare(`
      ...
      SET payment_status = 'approved',
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE order_number = ?
    `).bind(t).run(),console.log("[Webhook] ✅ 가상계좌 입금 완료 처리:",t))}async function at(e,r){const{orderId:t,virtualAccount:s}=r;console.log("[Webhook] 가상계좌 발급:",{orderId:t,bank:s==null?void 0:s.bank,accountNumber:s==null?void 0:s.accountNumber}),await e.prepare(`
    UPDATE payments 
  ...
  `).bind(s==null?void 0:s.bank,s==null?void 0:s.accountNumber,s==null?void 0:s.customerName,s==null?void 0:s.dueDate,JSON.stringify(r),t).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",t)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:r}=e.env;try{const t=e.req.param("paymentKey"),s=await e.req.json(),{cancelReason:a,cancelAmount:n}=s;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:t,cancelReason:a,cancelAmount:n}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const o=await r.prepare(`
    ...
    `).bind(t).first();if(!o)return e.json({success:!1,error:"결제 정보를 찾을 수 없습니다."},404);if(o.status==="CANCELED"||o.status==="cancelled")return e.json({success:!1,error:"이미 취소된 결제입니다."},400);const i=o.pg_provider||"tosspayments",c=e.env.TOSS_SECRET_KEY;if(!c)return e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);const u=Jr(i,c),l=n&&n<o.amount,d=n||o.amount;console.log("[Payment] PG 결제 취소 요청 중...",{pgProvider:i,paymentKey:t,cancelAmount:d,isPartial:l});const _=await u.cancelPayment({paymentKey:t,cancelReason:a,cancelAmount:d});return _.success?(console.log("[Payment] ✅ PG 결제 취소 완료:",{paymentKey:t,cancelAmount:d,canceledAt:_.canceledAt}),await r.prepare(`
      UPDATE payments 
      SET status = ?,
          cancelled_at = ?,
          pg_raw_data = ?,
    ...
    `).bind(t.sellerId).all(),a=await Promise.all(s.results.map(async n=>{const o=await r.prepare(`
        ...
        `).bind(s).first();if(c!=null&&c.buyer_business_number&&(c!=null&&c.buyer_business_name)){console.log(`[AUTO TAX INVOICE] 사업자 구매 확인: ${c.buyer_business_number}`);const u=await r.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(t.sellerId).first();if(!u)console.warn(`[AUTO TAX INVOICE] 판매자 사업자 정보 미승인: seller_id=${t.sellerId}`),await r.prepare(`
            ...
            `).bind(s,t.sellerId).run();else{console.log(`[AUTO TAX INVOICE] 발행 시작: orderNumber=${s}`);const l=await r.prepare(`
              ...
              LEFT JOIN products p ON oi.product_id = p.id
              WHERE oi.order_id = ?
            `).bind(c.id).all(),d=Number(c.total_amount),_=Math.floor(d/1.1),E=d-_,f=new Date().toISOString().split("T")[0].replace(/-/g,""),y=Math.random().toString(36).substring(2,8).toUpperCase(),h=`${f}-${y}`,g=(await r.prepare(`
            ...
            `).bind(t.sellerId,s,h,u.business_number,u.business_name,u.ceo_name,u.address||"",u.business_type||"",u.business_category||"",u.email||"",u.phone||"",c.buyer_business_number,c.buyer_business_name,c.buyer_ceo_name||"",c.buyer_business_address||"",c.buyer_business_type||"",c.buyer_business_category||"",c.buyer_email||"",c.buyer_phone||"",_,E,d,`AUTO-${Date.now()}-${y}`).run()).meta.last_row_id;for(const j of l.results){const N=Math.floor(Number(j.price)*Number(j.quantity)/1.1),w=Number(j.price)*Number(j.quantity)-N;await r.prepare(`
      ...
      SET courier = ?, 
          ...
          updated_at = CURRENT_TIMESTAMP 
      WHERE order_number = ?
    `).bind(a,n,s).run();try{const c=await r.prepare("SELECT user_id FROM orders WHERE order_number = ?").bind(s).first();c&&c.user_id&&await $s(r,c.user_id,s,"shipping",a,n)}catch(c){console.error("[Tracking] Notification error:",c)}return e.json({success:!0,message:"Tracking information updated"})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders/:orderNumber/refund",async e=>{const{DB:r}=e.env,t=e.req.param("orderNumber"),{reason:s}=await e.req.json();try{const a=await r.prepare("SELECT * FROM orders WHERE order_number = ?").bind(t).first();return a?["paid","preparing","shipped","delivered"].includes(a.status)?a.status==="refunded"||a.status==="cancelled"?e.json({success:!1,error:"이미 환불 또는 취소된 주문입니다."},400):(await r.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind("refunded",t).run(),e.json({success:!0,message:"환불 요청이 접수되었습니다. 고객센터(0507-0177-0432)에서 처리 예정입니다.",requiresManualProcessing:!0})):e.json({success:!1,error:"환불이 불가능한 주문 상태입니다."},400):e.json({success:!1,error:"Order not found"},404)}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/admin/orders",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
    ...
    `).all();return e.json({success:!0,data:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/sellers",async e=>{const{DB:r}=e.env,{limit:t="20",offset:s="0"}=e.req.query();try{const a=`
      ...
      ORDER BY created_at DESC
      LIMIT ? OFFSET ?
    `,{results:n}=await r.prepare(a).bind(parseInt(t),parseInt(s)).all();return e.json({success:!0,data:n})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});p.get("/api/admin/sellers",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
    ...
    `).bind(s,_,n,o,i||null,c,u||null,t.adminId).run();return e.json({success:!0,data:{id:E.meta.last_row_id,username:s,name:n,email:o,business_name:c}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.put("/api/admin/sellers/:id",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{name:a,email:n,phone:o,business_name:i,business_number:c,is_active:u,status:l}=await e.req.json();return await r.prepare("SELECT id FROM sellers WHERE id = ?").bind(s).first()?(await r.prepare(`
      UPDATE sellers 
      SET name = ?, email = ?, phone = ?, business_name = ?, business_number = ?, 
          is_active = ?, status = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(a,n,o||null,i,c||null,u,l,s).run(),e.json({success:!0})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.delete("/api/admin/sellers/:id",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),a=await r.prepare("SELECT id, username FROM sellers WHERE id = ?").bind(s).first();return a?(await r.prepare(`
      UPDATE sellers 
      SET is_active = 0, status = 'suspended', updated_at = datetime('now')
      WHERE id = ?
    `).bind(s).run(),await r.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(s).run(),e.json({success:!0,message:`판매자 '${a.username}'의 로그인 권한이 삭제되었습니다`})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/admin/sellers/:id/reset-password",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{new_password:a}=await e.req.json();if(!a||a.length<6)return e.json({success:!1,error:"비밀번호는 6자 이상이어야 합니다"},400);const n=await r.prepare("SELECT id, username FROM sellers WHERE id = ?").bind(s).first();if(!n)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const o=`$2a$10$placeholder_hash_for_${a}`;return await r.prepare(`
      UPDATE sellers 
      SET password_hash = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(o,s).run(),await r.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(s).run(),e.json({success:!0,message:`판매자 '${n.username}'의 비밀번호가 재설정되었습니다`})}catch(s){return e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/commission",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{commission_rate:a}=await e.req.json();if(a==null)return e.json({success:!1,error:"수수료율을 입력해주세요"},400);const n=parseFloat(a);if(isNaN(n)||n<0||n>100)return e.json({success:!1,error:"수수료율은 0에서 100 사이의 값이어야 합니다"},400);const o=await r.prepare("SELECT id, username, commission_rate FROM sellers WHERE id = ?").bind(s).first();if(!o)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const i=o.commission_rate||10;return await r.prepare(`
      UPDATE sellers 
      SET commission_rate = ?, updated_at = datetime('now')
      WHERE id = ?
    `).bind(n,s).run(),console.log(`수수료율 변경: 판매자 ${o.username} (ID: ${s}), ${i}% → ${n}%`),e.json({success:!0,message:`판매자 '${o.username}'의 수수료율이 ${i}%에서 ${n}%로 변경되었습니다`,data:{seller_id:s,seller_username:o.username,old_commission_rate:i,new_commission_rate:n}})}catch(s){return console.error("수수료율 변경 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/approve",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),a=await r.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(s).first();return a?a.status==="approved"?e.json({success:!1,error:"이미 승인된 판매자입니다"},400):(await r.prepare(`
      UPDATE sellers 
      SET status = 'approved', 
          is_active = 1,
          approved_by = ?,
          ...
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(t.adminId,s).run(),console.log(`셀러 승인: ${a.username} (ID: ${s}) by Admin ID: ${t.adminId}`),e.json({success:!0,message:`판매자 '${a.name}'님이 승인되었습니다`,data:{seller_id:s,seller_username:a.username,seller_name:a.name,status:"approved",approved_at:new Date().toISOString()}})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return console.error("셀러 승인 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/sellers/:id/reject",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{reason:a}=await e.req.json();if(!a)return e.json({success:!1,error:"거부 사유를 입력해주세요"},400);const n=await r.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(s).first();return n?n.status==="rejected"?e.json({success:!1,error:"이미 거부된 판매자입니다"},400):(await r.prepare(`
      UPDATE sellers 
      SET status = 'rejected', 
          is_active = 0,
          rejection_reason = ?,
          ...
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(a,t.adminId,s).run(),console.log(`셀러 거부: ${n.username} (ID: ${s}), 사유: ${a}`),e.json({success:!0,message:`판매자 '${n.name}'님의 승인이 거부되었습니다`,data:{seller_id:s,seller_username:n.username,seller_name:n.name,status:"rejected",rejection_reason:a,rejected_at:new Date().toISOString()}})):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(s){return console.error("셀러 거부 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/sellers/pending",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=await r.prepare(`
      SELECT id, username, name, email, phone, business_name, business_number, 
             status, created_at
      FROM sellers
      WHERE status = 'pending'
      ORDER BY created_at ASC
    `).all();return e.json({success:!0,data:s.results,count:s.results.length})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/public/seller/:sellerId",async e=>{const{DB:r,CACHE_KV:t}=e.env;try{const s=e.req.param("sellerId"),a=`public:seller:${s}`,n=await as(t,a);if(n)return e.json({success:!0,data:n,cached:!0});const o=await r.prepare(`
      SELECT 
    ...
    `).bind(s).all(),l=await r.prepare(`
      ...
      WHERE s.id = ?
    `).bind(s).first(),d={profile:o,live_streams:i.results,scheduled_streams:c.results,products:u.results,stats:l};return await ns(t,a,d,60),e.json({success:!0,data:d})}catch(s){return console.error("셀러 프로필 조회 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/public/seller/username/:username",async e=>{const{DB:r}=e.env;try{const t=e.req.param("username"),s=await r.prepare(`
      SELECT id FROM sellers 
      WHERE username = ? AND status = 'approved' AND is_active = 1
    `).bind(t).first();return s?e.json({success:!0,data:{seller_id:s.id}}):e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404)}catch(t){return console.error("셀러 조회 실패:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/admin/settlement/stats",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{period:s}=e.req.query();let a="";const n=new Date;switch(s){case"today":a=`AND DATE(o.created_at) = '${n.toISOString().split("T")[0]}'`;break;case"week":a=`AND DATE(o.created_at) >= '${new Date(n.getTime()-10080*60*1e3).toISOString().split("T")[0]}'`;break;case"month":a=`AND DATE(o.created_at) >= '${new Date(n.getTime()-720*60*60*1e3).toISOString().split("T")[0]}'`;break;default:a=""}const o=await r.prepare(`
      SELECT 
    ...
    `).all();return e.json({success:!0,data:{overview:o,sellers:i.results,period:s||"all"}})}catch(s){return console.error("정산 통계 조회 실패:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlement/records",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{seller_id:s,period:a,status:n}=e.req.query();let o=["payment_status = 'completed'","is_cancelled = 0"];const i=[];s&&(o.push("o.seller_id = ?"),i.push(s)),n&&(o.push("o.settlement_status = ?"),i.push(n));const c=new Date;switch(a){case"today":const d=c.toISOString().split("T")[0];o.push(`DATE(o.created_at) = '${d}'`);break;case"week":const _=new Date(c.getTime()-10080*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${_}'`);break;case"month":const E=new Date(c.getTime()-720*60*60*1e3).toISOString().split("T")[0];o.push(`DATE(o.created_at) >= '${E}'`);break}const u=o.length>0?`WHERE ${o.join(" AND ")}`:"",l=await r.prepare(`
      SELECT 
        o.id,
        o.order_number,
        o.seller_id,
      ...
      ORDER BY o.created_at DESC
      LIMIT 100
    `).bind(...i).all();return e.json({success:!0,data:l.results})}catch(s){return console.error("정산 내역 조회 실패:",s),e.json({success:!1,error:s.message},500)}});p.patch("/api/admin/settlement/:orderId/status",async e=>{const{DB:r}=e.env,t=await M(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("orderId"),{status:a}=await e.req.json();if(!["pending","completed"].includes(a))return e.json({success:!1,error:"유효하지 않은 정산 상태입니다"},400);const n=await r.prepare(`
...
`});const E="\uFEFF";return new Response(E+_,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(s){return console.error("CSV 내보내기 실패:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/orders/create",async e=>{const{DB:r}=e.env;try{const{userId:t,cartItems:s,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:u,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:t,cartItems:s==null?void 0:s.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const w=await r.prepare(`
      ...
      `).bind(n,t).first();if(!w)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);f=w}if(!t)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const y=t,h=Date.now(),b=Math.random().toString(36).substring(2,8).toUpperCase(),g=`ORDER_${h}_${b}`;for(const w of s){const k=await r.prepare(`
        SELECT stock FROM products WHERE id = ?
      `).bind(w.product_id).first();if(!k)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${w.product_id})`},400);if(k.stock<w.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${w.product_id})`},400)}const N=(await r.prepare(`
      INSERT INTO orders (
    ...
    `).bind(g,y,a,"pending",o||null,d,_,E,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,u||null,l||null).run()).meta.last_row_id;for(const w of s){await r.prepare(`
      ...
      `).bind(w.quantity,w.product_id).run();try{const k=await r.prepare(`
          SELECT id, name, stock, stock_alert_threshold, seller_id 
          FROM products 
          WHERE id = ?
        `).bind(w.product_id).first();if(k){const C=k.stock_alert_threshold||5,I=k.stock;I<=C&&k.seller_id&&(await Gr(r,k.seller_id,k.name,I,C),console.log(`[Low Stock Alert] ${k.name}: ${I} <= ${C}`))}}catch(k){console.error("[Low Stock Alert] Error:",k)}}return console.log("주문 생성 완료:",{orderId:N,orderNumber:g}),e.json({success:!0,orderId:N,orderNumber:g,totalAmount:a})}catch(t){return console.error("주문 생성 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/:orderNumber/refund",A(),async e=>{const{DB:r}=e.env;try{const t=e.req.param("orderNumber"),{reason:s}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:t,reason:s});const a=await r.prepare(`
    ...
    `).bind(a.id).all();for(const o of n.results)await r.prepare(`
        ...
        SET stock = stock + ?,
            ...
            updated_at = datetime('now')
        WHERE id = ?
      `).bind(o.quantity,o.product_id).run(),console.log("[Order Refund] 재고 복구:",{productId:o.product_id,quantity:o.quantity});return console.log("[Order Refund] ✅ 환불 완료:",{orderNumber:t,reason:s}),e.json({success:!0,message:"주문이 취소되었습니다",data:{orderNumber:t,cancelDate:new Date().toISOString()}})}catch(t){return console.error("[Order Refund] Error:",t),e.json({success:!1,error:t.message||"주문 취소 중 오류가 발생했습니다"},500)}});p.get("/api/seller/sales",A(),async e=>{try{const{DB:r}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const s=await De(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(s.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=s.seller_id||s.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],c=o||new Date().toISOString().split("T")[0],u=await r.prepare(`
    ...
    `).bind(a,i,c).first(),d=await r.prepare(`
      ...
      ORDER BY o.created_at DESC
      LIMIT 100
    `).bind(a,i,c).all();return e.json({success:!0,data:{seller:u,stats:l,orders:(d==null?void 0:d.results)||[]}})}catch(r){return console.error("Seller sales query error:",r),e.json({success:!1,error:r.message},500)}});p.get("/api/seller/settlement-csv",A(),async e=>{try{const{DB:r}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const s=await De(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(s.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=s.seller_id||s.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],c=o||new Date().toISOString().split("T")[0],u=await r.prepare(`
      SELECT 
        o.order_number,
        o.total_amount,
        o.commission_amount,
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(r){return console.error("CSV download error:",r),e.json({success:!1,error:r.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{order_number:s}=await e.req.json();if(!s)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await r.prepare(`
    ...
    `).bind(t.sellerId,s,"tax",d,l,n.business_number,n.business_name,n.ceo_name,n.address,n.business_type,n.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,c,u,i,f==="FAILED"?"failed":"issued",Ce()?"mock":"barobill",y,f).run()).meta.last_row_id;for(const g of o.results){const j=Math.floor(Number(g.price)*Number(g.quantity)/1.1),N=Number(g.price)*Number(g.quantity)-j;await r.prepare(`
        INSERT INTO tax_invoice_items (
          tax_invoice_id, order_item_id, product_name, quantity,
          unit_price, supply_price, tax_amount, created_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
      `).bind(b,g.id,g.product_name,g.quantity,g.price,j,N).run()}return e.json({success:!0,data:{invoice_id:b,invoice_number:d,issue_date:l,total_amount:i,supply_price:c,tax_amount:u,status:f==="FAILED"?"failed":"issued",nts_confirm_number:f,api_invoice_key:y,mock_mode:Ce(),message:f==="FAILED"?"바로빌 API 호출 실패. 나중에 다시 시도해주세요.":Ce()?"세금계산서가 발행되었습니다. (Mock Mode - 실제 발행 아님)":"세금계산서가 발행되었습니다."}})}catch(s){return console.error("세금계산서 발행 오류:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/seller/tax-invoices",async e=>{var s;const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const{start_date:a,end_date:n,status:o}=e.req.query();let i=`
    ...
    `).bind(s).all();return e.json({success:!0,data:{...a,items:n.results||[]}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/:id/cancel",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=e.req.param("id"),{reason:a}=await e.req.json(),n=await r.prepare(`
      SELECT * FROM tax_invoices WHERE id = ? AND seller_id = ?
    `).bind(s,t.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!Ce()){const u=await r.prepare(`
          SELECT business_number FROM seller_business_info WHERE seller_id = ?
        `).bind(t.sellerId).first();u&&u.business_number&&await xr(u.business_number,n.api_invoice_key,a||"판매자 요청")}}catch(u){console.error("바로빌 취소 API 호출 실패:",u)}return await r.prepare(`
      UPDATE tax_invoices
    ...
    `).bind(s).first();if(!o)return e.json({success:!1,error:"주문을 찾을 수 없습니다."},404);if(!o.buyer_business_number||!o.buyer_business_name)return e.json({success:!1,error:"주문에 사업자 정보가 없습니다."},400);const i=await r.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(t.sellerId).first();if(!i)return e.json({success:!1,error:"판매자 사업자 정보가 승인되지 않았습니다."},400);const c=await r.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(o.id).all(),u=Number(o.total_amount),l=Math.floor(u/1.1),d=u-l,_=new Date().toISOString().split("T")[0].replace(/-/g,""),E=Math.random().toString(36).substring(2,8).toUpperCase(),f=`${_}-${E}`,h=(await r.prepare(`
      INSERT INTO tax_invoices (
        seller_id, order_number, invoice_number, issue_date,
        supplier_business_number, supplier_business_name, supplier_ceo_name,
        supplier_address, supplier_business_type, supplier_business_category,
    ...
    `).bind(t,t).all();return e.json({success:!0,data:s.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/admin/banners",K,async e=>{const{DB:r}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const s=await r.prepare(`
      SELECT * FROM banners
      ORDER BY display_order ASC, created_at DESC
    `).all();return e.json({success:!0,data:s.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/admin/banners",K,async e=>{const{DB:r}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const{title:s,image_url:a,link_url:n,description:o,is_active:i,display_order:c,start_date:u,end_date:l}=await e.req.json();if(!s||!a)return e.json({success:!1,error:"제목과 이미지는 필수입니다."},400);const d=await r.prepare(`
      INSERT INTO banners (title, image_url, link_url, description, is_active, display_order, start_date, end_date)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(s,a,n||null,o||null,i!==!1?1:0,c||0,u||null,l||null).run();return e.json({success:!0,id:d.meta.last_row_id})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/admin/banners/:id",K,async e=>{const{DB:r}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const s=e.req.param("id"),{title:a,image_url:n,link_url:o,description:i,is_active:c,display_order:u,start_date:l,end_date:d}=await e.req.json();return await r.prepare(`
      UPDATE banners
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return Ys({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${t}`,htmlContent:u,textContent:l})}const it=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:Ys,sendLiveStreamCreatedEmail:ot},Symbol.toStringTag,{value:"Module"}));export{ms as default};
