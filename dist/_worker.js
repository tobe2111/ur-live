var Sr=Object.defineProperty;var Ds=e=>{throw TypeError(e)};var br=(e,s,r)=>s in e?Sr(e,s,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[s]=r;var T=(e,s,r)=>br(e,typeof s!="symbol"?s+"":s,r),ms=(e,s,r)=>s.has(e)||Ds("Cannot "+r);var _=(e,s,r)=>(ms(e,s,"read from private field"),r?r.call(e):s.get(e)),I=(e,s,r)=>s.has(e)?Ds("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,r),b=(e,s,r,t)=>(ms(e,s,"write to private field"),t?t.call(e,r):s.set(e,r),r),N=(e,s,r)=>(ms(e,s,"access private method"),r);var Ns=(e,s,r,t)=>({set _(a){b(e,s,a,r)},get _(){return _(e,s,t)}});var As=(e,s,r)=>(t,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,u=!1,l;if(e[i]?(l=e[i][0][0],t.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{c=await l(t,()=>o(i+1))}catch(p){if(p instanceof Error&&s)t.error=p,c=await s(p,t),u=!0;else throw p}else t.finalized===!1&&r&&(c=await r(t));return c&&(t.finalized===!1||u)&&(t.res=c),t}},Tr=Symbol(),Rr=async(e,s=Object.create(null))=>{const{all:r=!1,dot:t=!1}=s,n=(e instanceof Zs?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Ir(e,{all:r,dot:t}):{}};async function Ir(e,s){const r=await e.formData();return r?vr(r,s):{}}function vr(e,s){const r=Object.create(null);return e.forEach((t,a)=>{s.all||a.endsWith("[]")?Or(r,a,t):r[a]=t}),s.dot&&Object.entries(r).forEach(([t,a])=>{t.includes(".")&&(Dr(r,t,a),delete r[t])}),r}var Or=(e,s,r)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(r):e[s]=[e[s],r]:s.endsWith("[]")?e[s]=[r]:e[s]=r},Dr=(e,s,r)=>{let t=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?t[n]=r:((!t[n]||typeof t[n]!="object"||Array.isArray(t[n])||t[n]instanceof File)&&(t[n]=Object.create(null)),t=t[n])})},Js=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},Nr=e=>{const{groups:s,path:r}=Ar(e),t=Js(r);return kr(t,s)},Ar=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(r,t)=>{const a=`@${t}`;return s.push([a,r]),a}),{groups:s,path:e}},kr=(e,s)=>{for(let r=s.length-1;r>=0;r--){const[t]=s[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(t)){e[a]=e[a].replace(t,s[r][1]);break}}return e},as={},jr=(e,s)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const t=`${e}#${s}`;return as[t]||(r[2]?as[t]=s&&s[0]!==":"&&s[0]!=="*"?[t,r[1],new RegExp(`^${r[2]}(?=/${s})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:as[t]=[e,r[1],!0]),as[t]}return null},Ss=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return s(r)}catch{return r}})}},Cr=e=>Ss(e,decodeURI),zs=e=>{const s=e.url,r=s.indexOf("/",s.indexOf(":")+4);let t=r;for(;t<s.length;t++){const a=s.charCodeAt(t);if(a===37){const n=s.indexOf("?",t),o=s.indexOf("#",t),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(r,i);return Cr(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(r,t)},Lr=e=>{const s=zs(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},Le=(e,s,...r)=>(r.length&&(s=Le(s,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),Xs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),r=[];let t="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))t+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&t===""?r.push("/"):r.push(t);const n=a.replace("?","");t+="/"+n,r.push(t)}else t+="/"+a}),r.filter((a,n,o)=>o.indexOf(a)===n)},_s=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ss(e,Qs):e):e,Gs=(e,s,r)=>{let t;if(!r&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,u=e.indexOf("&",c);return _s(e.slice(c,u===-1?void 0:u))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(t=/[%+]/.test(e),!t)return}const a={};t??(t=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(t&&(c=_s(c)),n=o,c==="")continue;let u;i===-1?u="":(u=e.slice(i+1,o===-1?void 0:o),t&&(u=_s(u))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(u)):a[c]??(a[c]=u)}return s?a[s]:a},Mr=Gs,Ur=(e,s)=>Gs(e,s,!0),Qs=decodeURIComponent,ks=e=>Ss(e,Qs),Pe,Z,de,er,sr,ys,me,xs,Zs=(xs=class{constructor(e,s="/",r=[[]]){I(this,de);T(this,"raw");I(this,Pe);I(this,Z);T(this,"routeIndex",0);T(this,"path");T(this,"bodyCache",{});I(this,me,e=>{const{bodyCache:s,raw:r}=this,t=s[e];if(t)return t;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=r[e]()});this.raw=e,this.path=s,b(this,Z,r),b(this,Pe,{})}param(e){return e?N(this,de,er).call(this,e):N(this,de,sr).call(this)}query(e){return Mr(this.url,e)}queries(e){return Ur(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((r,t)=>{s[t]=r}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await Rr(this,e))}json(){return _(this,me).call(this,"text").then(e=>JSON.parse(e))}text(){return _(this,me).call(this,"text")}arrayBuffer(){return _(this,me).call(this,"arrayBuffer")}blob(){return _(this,me).call(this,"blob")}formData(){return _(this,me).call(this,"formData")}addValidatedData(e,s){_(this,Pe)[e]=s}valid(e){return _(this,Pe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Tr](){return _(this,Z)}get matchedRoutes(){return _(this,Z)[0].map(([[,e]])=>e)}get routePath(){return _(this,Z)[0].map(([[,e]])=>e)[this.routeIndex].path}},Pe=new WeakMap,Z=new WeakMap,de=new WeakSet,er=function(e){const s=_(this,Z)[0][this.routeIndex][1][e],r=N(this,de,ys).call(this,s);return r&&/\%/.test(r)?ks(r):r},sr=function(){const e={},s=Object.keys(_(this,Z)[0][this.routeIndex][1]);for(const r of s){const t=N(this,de,ys).call(this,_(this,Z)[0][this.routeIndex][1][r]);t!==void 0&&(e[r]=/\%/.test(t)?ks(t):t)}return e},ys=function(e){return _(this,Z)[1]?_(this,Z)[1][e]:e},me=new WeakMap,xs),Pr={Stringify:1},rr=async(e,s,r,t,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:t}))).then(i=>Promise.all(i.filter(Boolean).map(c=>rr(c,s,!1,t,a))).then(()=>a[0]))):Promise.resolve(e)},$r="text/plain; charset=UTF-8",fs=(e,s)=>({"Content-Type":e,...s}),je=(e,s)=>new Response(e,s),Ge,Qe,ie,$e,ce,G,Ze,qe,Fe,Te,es,ss,ae,Me,ws,Bs,qr=(Bs=class{constructor(e,s){I(this,ae);I(this,Ge);I(this,Qe);T(this,"env",{});I(this,ie);T(this,"finalized",!1);T(this,"error");I(this,$e);I(this,ce);I(this,G);I(this,Ze);I(this,qe);I(this,Fe);I(this,Te);I(this,es);I(this,ss);T(this,"render",(...e)=>(_(this,qe)??b(this,qe,s=>this.html(s)),_(this,qe).call(this,...e)));T(this,"setLayout",e=>b(this,Ze,e));T(this,"getLayout",()=>_(this,Ze));T(this,"setRenderer",e=>{b(this,qe,e)});T(this,"header",(e,s,r)=>{this.finalized&&b(this,G,je(_(this,G).body,_(this,G)));const t=_(this,G)?_(this,G).headers:_(this,Te)??b(this,Te,new Headers);s===void 0?t.delete(e):r!=null&&r.append?t.append(e,s):t.set(e,s)});T(this,"status",e=>{b(this,$e,e)});T(this,"set",(e,s)=>{_(this,ie)??b(this,ie,new Map),_(this,ie).set(e,s)});T(this,"get",e=>_(this,ie)?_(this,ie).get(e):void 0);T(this,"newResponse",(...e)=>N(this,ae,Me).call(this,...e));T(this,"body",(e,s,r)=>N(this,ae,Me).call(this,e,s,r));T(this,"text",(e,s,r)=>N(this,ae,ws).call(this)&&!s&&!r?je(e):N(this,ae,Me).call(this,e,s,fs($r,r)));T(this,"json",(e,s,r)=>N(this,ae,ws).call(this)&&!s&&!r?Response.json(e):N(this,ae,Me).call(this,JSON.stringify(e),s,fs("application/json",r)));T(this,"html",(e,s,r)=>{const t=a=>N(this,ae,Me).call(this,a,s,fs("text/html; charset=UTF-8",r));return typeof e=="object"?rr(e,Pr.Stringify,!1,{}).then(t):t(e)});T(this,"redirect",(e,s)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,s??302)});T(this,"notFound",()=>(_(this,Fe)??b(this,Fe,()=>je()),_(this,Fe).call(this,this)));b(this,Ge,e),s&&(b(this,ce,s.executionCtx),this.env=s.env,b(this,Fe,s.notFoundHandler),b(this,ss,s.path),b(this,es,s.matchResult))}get req(){return _(this,Qe)??b(this,Qe,new Zs(_(this,Ge),_(this,ss),_(this,es))),_(this,Qe)}get event(){if(_(this,ce)&&"respondWith"in _(this,ce))return _(this,ce);throw Error("This context has no FetchEvent")}get executionCtx(){if(_(this,ce))return _(this,ce);throw Error("This context has no ExecutionContext")}get res(){return _(this,G)||b(this,G,je(null,{headers:_(this,Te)??b(this,Te,new Headers)}))}set res(e){if(_(this,G)&&e){e=je(e.body,e);for(const[s,r]of _(this,G).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const t=_(this,G).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of t)e.headers.append("set-cookie",a)}else e.headers.set(s,r)}b(this,G,e),this.finalized=!0}get var(){return _(this,ie)?Object.fromEntries(_(this,ie)):{}}},Ge=new WeakMap,Qe=new WeakMap,ie=new WeakMap,$e=new WeakMap,ce=new WeakMap,G=new WeakMap,Ze=new WeakMap,qe=new WeakMap,Fe=new WeakMap,Te=new WeakMap,es=new WeakMap,ss=new WeakMap,ae=new WeakSet,Me=function(e,s,r){const t=_(this,G)?new Headers(_(this,G).headers):_(this,Te)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?t.append(o,i):t.set(o,i)}if(r)for(const[n,o]of Object.entries(r))if(typeof o=="string")t.set(n,o);else{t.delete(n);for(const i of o)t.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??_(this,$e);return je(e,{status:a,headers:t})},ws=function(){return!_(this,Te)&&!_(this,$e)&&!this.finalized},Bs),W="ALL",Fr="all",Hr=["get","post","put","delete","options","patch"],tr="Can not add a route since the matcher is already built.",ar=class extends Error{},xr="__COMPOSED_HANDLER",Br=e=>e.text("404 Not Found",404),js=(e,s)=>{if("getResponse"in e){const r=e.getResponse();return s.newResponse(r.body,r)}return console.error(e),s.text("Internal Server Error",500)},se,K,nr,re,Se,ns,os,He,Wr=(He=class{constructor(s={}){I(this,K);T(this,"get");T(this,"post");T(this,"put");T(this,"delete");T(this,"options");T(this,"patch");T(this,"all");T(this,"on");T(this,"use");T(this,"router");T(this,"getPath");T(this,"_basePath","/");I(this,se,"/");T(this,"routes",[]);I(this,re,Br);T(this,"errorHandler",js);T(this,"onError",s=>(this.errorHandler=s,this));T(this,"notFound",s=>(b(this,re,s),this));T(this,"fetch",(s,...r)=>N(this,K,os).call(this,s,r[1],r[0],s.method));T(this,"request",(s,r,t,a)=>s instanceof Request?this.fetch(r?new Request(s,r):s,t,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${Le("/",s)}`,r),t,a)));T(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(N(this,K,os).call(this,s.request,s,void 0,s.request.method))})});[...Hr,Fr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?b(this,se,o):N(this,K,Se).call(this,n,_(this,se),o),i.forEach(c=>{N(this,K,Se).call(this,n,_(this,se),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){b(this,se,c);for(const u of[n].flat())i.map(l=>{N(this,K,Se).call(this,u.toUpperCase(),_(this,se),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?b(this,se,n):(b(this,se,"*"),o.unshift(n)),o.forEach(i=>{N(this,K,Se).call(this,W,_(this,se),i)}),this);const{strict:t,...a}=s;Object.assign(this,a),this.getPath=t??!0?s.getPath??zs:Lr}route(s,r){const t=this.basePath(s);return r.routes.map(a=>{var o;let n;r.errorHandler===js?n=a.handler:(n=async(i,c)=>(await As([],r.errorHandler)(i,()=>a.handler(i,c))).res,n[xr]=a.handler),N(o=t,K,Se).call(o,a.method,a.path,n)}),this}basePath(s){const r=N(this,K,nr).call(this);return r._basePath=Le(this._basePath,s),r}mount(s,r,t){let a,n;t&&(typeof t=="function"?n=t:(n=t.optionHandler,t.replaceRequest===!1?a=c=>c:a=t.replaceRequest));const o=n?c=>{const u=n(c);return Array.isArray(u)?u:[u]}:c=>{let u;try{u=c.executionCtx}catch{}return[c.env,u]};a||(a=(()=>{const c=Le(this._basePath,s),u=c==="/"?0:c.length;return l=>{const p=new URL(l.url);return p.pathname=p.pathname.slice(u)||"/",new Request(p,l)}})());const i=async(c,u)=>{const l=await r(a(c.req.raw),...o(c));if(l)return l;await u()};return N(this,K,Se).call(this,W,Le(s,"*"),i),this}},se=new WeakMap,K=new WeakSet,nr=function(){const s=new He({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,b(s,re,_(this,re)),s.routes=this.routes,s},re=new WeakMap,Se=function(s,r,t){s=s.toUpperCase(),r=Le(this._basePath,r);const a={basePath:this._basePath,path:r,method:s,handler:t};this.router.add(s,r,[t,a]),this.routes.push(a)},ns=function(s,r){if(s instanceof Error)return this.errorHandler(s,r);throw s},os=function(s,r,t,a){if(a==="HEAD")return(async()=>new Response(null,await N(this,K,os).call(this,s,r,t,"GET")))();const n=this.getPath(s,{env:t}),o=this.router.match(a,n),i=new qr(s,{path:n,matchResult:o,env:t,executionCtx:r,notFoundHandler:_(this,re)});if(o[0].length===1){let u;try{u=o[0][0][0][0](i,async()=>{i.res=await _(this,re).call(this,i)})}catch(l){return N(this,K,ns).call(this,l,i)}return u instanceof Promise?u.then(l=>l||(i.finalized?i.res:_(this,re).call(this,i))).catch(l=>N(this,K,ns).call(this,l,i)):u??_(this,re).call(this,i)}const c=As(o[0],this.errorHandler,_(this,re));return(async()=>{try{const u=await c(i);if(!u.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return u.res}catch(u){return N(this,K,ns).call(this,u,i)}})()},He),or=[];function Kr(e,s){const r=this.buildAllMatchers(),t=((a,n)=>{const o=r[a]||r[W],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],or];const u=c.indexOf("",1);return[o[1][u],c]});return this.match=t,t(e,s)}var cs="[^/]+",Je=".*",ze="(?:|/.*)",Ue=Symbol(),Vr=new Set(".\\+*[^]$()");function Yr(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===Je||e===ze?1:s===Je||s===ze?-1:e===cs?1:s===cs?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var Re,Ie,te,De,Jr=(De=class{constructor(){I(this,Re);I(this,Ie);I(this,te,Object.create(null))}insert(s,r,t,a,n){if(s.length===0){if(_(this,Re)!==void 0)throw Ue;if(n)return;b(this,Re,r);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",Je]:["","",cs]:o==="/*"?["","",ze]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let u;if(c){const l=c[1];let p=c[2]||cs;if(l&&c[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Ue;if(u=_(this,te)[p],!u){if(Object.keys(_(this,te)).some(m=>m!==Je&&m!==ze))throw Ue;if(n)return;u=_(this,te)[p]=new De,l!==""&&b(u,Ie,a.varIndex++)}!n&&l!==""&&t.push([l,_(u,Ie)])}else if(u=_(this,te)[o],!u){if(Object.keys(_(this,te)).some(l=>l.length>1&&l!==Je&&l!==ze))throw Ue;if(n)return;u=_(this,te)[o]=new De}u.insert(i,r,t,a,n)}buildRegExpStr(){const r=Object.keys(_(this,te)).sort(Yr).map(t=>{const a=_(this,te)[t];return(typeof _(a,Ie)=="number"?`(${t})@${_(a,Ie)}`:Vr.has(t)?`\\${t}`:t)+a.buildRegExpStr()});return typeof _(this,Re)=="number"&&r.unshift(`#${_(this,Re)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Re=new WeakMap,Ie=new WeakMap,te=new WeakMap,De),ls,rs,Ws,zr=(Ws=class{constructor(){I(this,ls,{varIndex:0});I(this,rs,new Jr)}insert(e,s,r){const t=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const u=`@\\${o}`;return a[o]=[u,c],o++,i=!0,u}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return _(this,rs).insert(n,s,t,_(this,ls),r),t}buildRegExp(){let e=_(this,rs).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const r=[],t=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(r[++s]=Number(n),"$()"):(o!==void 0&&(t[Number(o)]=++s),"")),[new RegExp(`^${e}`),r,t]}},ls=new WeakMap,rs=new WeakMap,Ws),Xr=[/^$/,[],Object.create(null)],is=Object.create(null);function ir(e){return is[e]??(is[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function Gr(){is=Object.create(null)}function Qr(e){var u;const s=new zr,r=[];if(e.length===0)return Xr;const t=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,p],[m,E])=>l?1:m?-1:p.length-E.length),a=Object.create(null);for(let l=0,p=-1,m=t.length;l<m;l++){const[E,f,h]=t[l];E?a[f]=[h.map(([w])=>[w,Object.create(null)]),or]:p++;let g;try{g=s.insert(f,p,E)}catch(w){throw w===Ue?new ar(f):w}E||(r[p]=h.map(([w,y])=>{const k=Object.create(null);for(y-=1;y>=0;y--){const[O,L]=g[y];k[O]=L}return[w,k]}))}const[n,o,i]=s.buildRegExp();for(let l=0,p=r.length;l<p;l++)for(let m=0,E=r[l].length;m<E;m++){const f=(u=r[l][m])==null?void 0:u[1];if(!f)continue;const h=Object.keys(f);for(let g=0,w=h.length;g<w;g++)f[h[g]]=i[f[h[g]]]}const c=[];for(const l in o)c[l]=r[o[l]];return[n,c,a]}function Ce(e,s){if(e){for(const r of Object.keys(e).sort((t,a)=>a.length-t.length))if(ir(r).test(s))return[...e[r]]}}var _e,fe,ds,cr,Ks,Zr=(Ks=class{constructor(){I(this,ds);T(this,"name","RegExpRouter");I(this,_e);I(this,fe);T(this,"match",Kr);b(this,_e,{[W]:Object.create(null)}),b(this,fe,{[W]:Object.create(null)})}add(e,s,r){var i;const t=_(this,_e),a=_(this,fe);if(!t||!a)throw new Error(tr);t[e]||[t,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[W]).forEach(u=>{c[e][u]=[...c[W][u]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=ir(s);e===W?Object.keys(t).forEach(u=>{var l;(l=t[u])[s]||(l[s]=Ce(t[u],s)||Ce(t[W],s)||[])}):(i=t[e])[s]||(i[s]=Ce(t[e],s)||Ce(t[W],s)||[]),Object.keys(t).forEach(u=>{(e===W||e===u)&&Object.keys(t[u]).forEach(l=>{c.test(l)&&t[u][l].push([r,n])})}),Object.keys(a).forEach(u=>{(e===W||e===u)&&Object.keys(a[u]).forEach(l=>c.test(l)&&a[u][l].push([r,n]))});return}const o=Xs(s)||[s];for(let c=0,u=o.length;c<u;c++){const l=o[c];Object.keys(a).forEach(p=>{var m;(e===W||e===p)&&((m=a[p])[l]||(m[l]=[...Ce(t[p],l)||Ce(t[W],l)||[]]),a[p][l].push([r,n-u+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(_(this,fe)).concat(Object.keys(_(this,_e))).forEach(s=>{e[s]||(e[s]=N(this,ds,cr).call(this,s))}),b(this,_e,b(this,fe,void 0)),Gr(),e}},_e=new WeakMap,fe=new WeakMap,ds=new WeakSet,cr=function(e){const s=[];let r=e===W;return[_(this,_e),_(this,fe)].forEach(t=>{const a=t[e]?Object.keys(t[e]).map(n=>[n,t[e][n]]):[];a.length!==0?(r||(r=!0),s.push(...a)):e!==W&&s.push(...Object.keys(t[W]).map(n=>[n,t[W][n]]))}),r?Qr(s):null},Ks),Ee,ue,Vs,et=(Vs=class{constructor(e){T(this,"name","SmartRouter");I(this,Ee,[]);I(this,ue,[]);b(this,Ee,e.routers)}add(e,s,r){if(!_(this,ue))throw new Error(tr);_(this,ue).push([e,s,r])}match(e,s){if(!_(this,ue))throw new Error("Fatal error");const r=_(this,Ee),t=_(this,ue),a=r.length;let n=0,o;for(;n<a;n++){const i=r[n];try{for(let c=0,u=t.length;c<u;c++)i.add(...t[c]);o=i.match(e,s)}catch(c){if(c instanceof ar)continue;throw c}this.match=i.match.bind(i),b(this,Ee,[i]),b(this,ue,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(_(this,ue)||_(this,Ee).length!==1)throw new Error("No active router has been determined yet.");return _(this,Ee)[0]}},Ee=new WeakMap,ue=new WeakMap,Vs),Ve=Object.create(null),st=e=>{for(const s in e)return!0;return!1},he,X,ve,xe,J,le,be,Be,rt=(Be=class{constructor(s,r,t){I(this,le);I(this,he);I(this,X);I(this,ve);I(this,xe,0);I(this,J,Ve);if(b(this,X,t||Object.create(null)),b(this,he,[]),s&&r){const a=Object.create(null);a[s]={handler:r,possibleKeys:[],score:0},b(this,he,[a])}b(this,ve,[])}insert(s,r,t){b(this,xe,++Ns(this,xe)._);let a=this;const n=Nr(r),o=[];for(let i=0,c=n.length;i<c;i++){const u=n[i],l=n[i+1],p=jr(u,l),m=Array.isArray(p)?p[0]:u;if(m in _(a,X)){a=_(a,X)[m],p&&o.push(p[1]);continue}_(a,X)[m]=new Be,p&&(_(a,ve).push(p),o.push(p[1])),a=_(a,X)[m]}return _(a,he).push({[s]:{handler:t,possibleKeys:o.filter((i,c,u)=>u.indexOf(i)===c),score:_(this,xe)}}),a}search(s,r){var l;const t=[];b(this,J,Ve);let n=[this];const o=Js(r),i=[],c=o.length;let u=null;for(let p=0;p<c;p++){const m=o[p],E=p===c-1,f=[];for(let g=0,w=n.length;g<w;g++){const y=n[g],k=_(y,X)[m];k&&(b(k,J,_(y,J)),E?(_(k,X)["*"]&&N(this,le,be).call(this,t,_(k,X)["*"],s,_(y,J)),N(this,le,be).call(this,t,k,s,_(y,J))):f.push(k));for(let O=0,L=_(y,ve).length;O<L;O++){const P=_(y,ve)[O],j=_(y,J)===Ve?{}:{..._(y,J)};if(P==="*"){const q=_(y,X)["*"];q&&(N(this,le,be).call(this,t,q,s,_(y,J)),b(q,J,j),f.push(q));continue}const[D,M,$]=P;if(!m&&!($ instanceof RegExp))continue;const C=_(y,X)[D];if($ instanceof RegExp){if(u===null){u=new Array(c);let Q=r[0]==="/"?1:0;for(let R=0;R<c;R++)u[R]=Q,Q+=o[R].length+1}const q=r.substring(u[p]),V=$.exec(q);if(V){if(j[M]=V[0],N(this,le,be).call(this,t,C,s,_(y,J),j),st(_(C,X))){b(C,J,j);const Q=((l=V[0].match(/\//))==null?void 0:l.length)??0;(i[Q]||(i[Q]=[])).push(C)}continue}}($===!0||$.test(m))&&(j[M]=m,E?(N(this,le,be).call(this,t,C,s,j,_(y,J)),_(C,X)["*"]&&N(this,le,be).call(this,t,_(C,X)["*"],s,j,_(y,J))):(b(C,J,j),f.push(C)))}}const h=i.shift();n=h?f.concat(h):f}return t.length>1&&t.sort((p,m)=>p.score-m.score),[t.map(({handler:p,params:m})=>[p,m])]}},he=new WeakMap,X=new WeakMap,ve=new WeakMap,xe=new WeakMap,J=new WeakMap,le=new WeakSet,be=function(s,r,t,a,n){for(let o=0,i=_(r,he).length;o<i;o++){const c=_(r,he)[o],u=c[t]||c[W],l={};if(u!==void 0&&(u.params=Object.create(null),s.push(u),a!==Ve||n&&n!==Ve))for(let p=0,m=u.possibleKeys.length;p<m;p++){const E=u.possibleKeys[p],f=l[u.score];u.params[E]=n!=null&&n[E]&&!f?n[E]:a[E]??(n==null?void 0:n[E]),l[u.score]=!0}}},Be),Oe,Ys,tt=(Ys=class{constructor(){T(this,"name","TrieRouter");I(this,Oe);b(this,Oe,new rt)}add(e,s,r){const t=Xs(s);if(t){for(let a=0,n=t.length;a<n;a++)_(this,Oe).insert(e,t[a],r);return}_(this,Oe).insert(e,s,r)}match(e,s){return _(this,Oe).search(e,s)}},Oe=new WeakMap,Ys),ur=class extends Wr{constructor(e={}){super(e),this.router=e.router??new et({routers:[new Zr,new tt]})}},S=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},t=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(r.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(r.allowMethods);return async function(o,i){var l;function c(p,m){o.res.headers.set(p,m)}const u=await t(o.req.header("origin")||"",o);if(u&&c("Access-Control-Allow-Origin",u),r.credentials&&c("Access-Control-Allow-Credentials","true"),(l=r.exposeHeaders)!=null&&l.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const p=await a(o.req.header("origin")||"",o);p.length&&c("Access-Control-Allow-Methods",p.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(m=E.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function at(e){var a;const s=((a=e.split(".").pop())==null?void 0:a.toLowerCase())||"jpg",r=Date.now(),t=crypto.randomUUID().substring(0,8);return`upload_${r}_${t}.${s}`}async function nt(e){const s=new Uint8Array(e);return s[0]===255&&s[1]===216&&s[2]===255?{valid:!0,detectedType:"image/jpeg"}:s[0]===137&&s[1]===80&&s[2]===78&&s[3]===71?{valid:!0,detectedType:"image/png"}:s[0]===71&&s[1]===73&&s[2]===70&&s[3]===56?{valid:!0,detectedType:"image/gif"}:s[0]===82&&s[1]===73&&s[2]===70&&s[3]===70&&s[8]===87&&s[9]===69&&s[10]===66&&s[11]===80?{valid:!0,detectedType:"image/webp"}:{valid:!1}}if(typeof crypto>"u"||!crypto.subtle)throw new Error("SubtleCrypto not supported!");function ot(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],r=[];for(const t of s)e[t]||r.push(t);if(r.length>0)throw new Error(`Missing required environment variables: ${r.join(", ")}
...
`)}async function lt(e){const s=await ct(e),r=s.filter(n=>n.status==="pass").length,t=s.filter(n=>n.status==="warn").length,a=s.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:s.length,pass:r,warn:t,fail:a},results:s,formatted:ut(s)}}const Es={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function dt(){const e=Es.ENV==="production";return{baseUrl:Es.TEST_BASE_URL,apiKey:Es.TEST_API_KEY,isProduction:e}}async function lr(e,s){const r=dt(),t=`${r.baseUrl}${e}`;try{const a=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r.apiKey}`},body:JSON.stringify(s)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function pt(e){try{const s={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((t,a)=>({SerialNum:a+1,ItemName:t.name,Qty:t.quantity,UnitPrice:t.unitPrice,SupplyCost:t.supplyPrice,Tax:t.taxAmount,Remark:t.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},r=await lr("/eTaxInvoice/RegistAndIssue",s);if(r.code!==1)throw new Error(`바로빌 발행 실패: ${r.message}`);return{success:!0,ntsConfirmNumber:r.ntsconfirmNum,invoiceKey:r.invoiceKey,message:r.message}}catch(s){throw console.error("바로빌 세금계산서 발행 실패:",s),s}}async function mt(e,s,r){try{const a=await lr("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:s,Memo:r});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(t){throw console.error("바로빌 세금계산서 취소 실패:",t),t}}function Ye(){return!1}async function _t(e){return await pt(e)}function ft(e,s,r){const t=Number(s.total_amount),a=Math.floor(t/1.1),n=t-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:s.buyer_business_number,buyerBusinessName:s.buyer_business_name||s.user_name,buyerCEO:s.buyer_ceo_name,buyerAddress:s.shipping_address,buyerEmail:s.user_email,buyerTel:s.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:r.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),u=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:u,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:t,memo:`주문번호: ${s.order_number}`,orderNo:s.order_number}}class ee extends Error{constructor(s,r,t){super(s),this.statusCode=r,this.code=t,this.name="AuthError"}}function Et(e){return`${crypto.randomUUID()}-${e}`}function ht(e){var n,o,i,c,u,l,p;const s=e.id.toString(),r=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",t=((c=e.kakao_account)==null?void 0:c.email)||null,a=((u=e.properties)==null?void 0:u.profile_image)||((p=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:p.profile_image_url)||null;return{kakaoId:s,nickname:r,email:t,profileImage:a}}async function gt(e,s,r,t,a){try{const n=await e.prepare(`
  ...
  `).bind(s).first();return r||(console.warn(`No active alimtalk account for seller ${s}`),null)}async function Cs(e,s){await e.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
  `).bind(s.seller_id,s.template_code,s.recipient_phone,s.message,s.cost,s.status,s.order_id||null).run()}async function Pt(e,s,r){await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?
    WHERE seller_id = ?
  `).bind(r,s).run()}async function $t(e,s){try{const{order:r,products:t}=await Mt(e.DB,s),a=await Ut(e.DB,r.seller_id);if(!a)return console.warn(`Skipping alimtalk for order ${s}: no active account`),{success:!1,reason:"no_account"};const n=15;if(a.balance<n)return console.warn(`Skipping alimtalk for order ${s}: insufficient balance`),{success:!1,reason:"insufficient_balance"};const o=t.map(u=>`${u.name} ${u.quantity}개 (${u.price.toLocaleString()}원)`).join(`
`),i=`[주문 확인]
...
주문해 주셔서 감사합니다!`,c=await Rs(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:r.buyer_phone,message:i});return c.success?(await Pt(e.DB,r.seller_id,n),await Cs(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await Cs(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(r){return console.error(`Error sending order confirmation for order ${s}:`,r),{success:!1,error:r.message}}}function qt(e,s){let r=e;return Object.entries(s).forEach(([t,a])=>{const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}),r}function Ft(e,s){const t=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:t.length===0,missingVars:t}}async function Ht(e,s,r){const t=await e.prepare(`
...
`),c={orderNumber:n.order_number,orderDate:new Date(n.created_at).toLocaleString("ko-KR"),productList:i,totalAmount:n.total_amount.toLocaleString(),shippingAddress:n.shipping_address,shippingName:n.shipping_name,shippingPhone:n.shipping_phone,buyerName:n.buyer_name,customMessage:a||"감사합니다!"},u=[{phone:n.buyer_phone,name:n.buyer_name}];return Is(e,{accountId:s,templateId:r,recipients:u,variables:c})}async function Vt(e,s,r,t,a={}){const n=t.map(o=>({phone:o.phone,name:o.name,variables:Object.entries(o).filter(([i])=>i!=="phone"&&i!=="name").reduce((i,[c,u])=>({...i,[c]:u}),{})}));return Is(e,{accountId:s,templateId:r,recipients:n,variables:a})}function Yt(e,s=.1){return Math.floor(e*s)}function Jt(){const e=new Date,s=new Date(e.getFullYear(),e.getMonth()-1,1),r=s.getFullYear(),t=String(s.getMonth()+1).padStart(2,"0"),a=new Date(r,s.getMonth()+1,0).getDate();return{startDate:`${r}-${t}-01`,endDate:`${r}-${t}-${a}`}}async function zt(e,s,r){try{const t=await e.prepare(`
    ...
    `).bind(s,r.startDate,r.endDate).all();if(!a.results||a.results.length===0)return{seller_id:s,seller_name:t.business_name,total_sales:0,total_orders:0,platform_fee:0,shipping_fee:0,refund_amount:0,settlement_amount:0,orders:[]};const n=[];let o=0,i=0,c=0;for(const m of a.results){const E=m.total_amount-m.shipping_fee,f=Yt(E);n.push({order_id:m.id,order_number:m.order_number,order_date:m.created_at,product_name:m.product_names||"",quantity:m.total_quantity||1,price:E,shipping_fee:m.shipping_fee||0,platform_fee:f,status:m.status}),o+=E,i+=m.shipping_fee||0,c+=f}const u=await e.prepare(`
      ...
      WHERE seller_id = ?
        ...
        AND status = 'refunded'
    `).bind(s,r.startDate,r.endDate).first(),l=(u==null?void 0:u.refund_amount)||0,p=o-c-l+i;return{seller_id:s,seller_name:t.business_name,total_sales:o,total_orders:n.length,platform_fee:c,shipping_fee:i,refund_amount:l,settlement_amount:p,orders:n}}catch(t){return console.error(`Failed to calculate settlement for seller ${s}:`,t),null}}async function Xt(e,s){console.log(`[Settlement] Generating report for ${s.startDate} ~ ${s.endDate}`);const r=await e.prepare(`
    SELECT DISTINCT s.id
    FROM sellers s
    JOIN orders o ON s.id = o.seller_id
    WHERE DATE(o.created_at) BETWEEN ? AND ?
      AND o.status IN ('delivered', 'confirmed', 'refunded')
  `).bind(s.startDate,s.endDate).all(),t=[];let a=0,n=0,o=0;for(const c of r.results){const u=await zt(e,c.id,s);u&&(t.push(u),a+=u.total_sales,n+=u.platform_fee,o+=u.settlement_amount)}const i={period:s,generated_at:new Date().toISOString(),total_sales:a,total_platform_fee:n,total_settlement:o,sellers:t};return console.log(`[Settlement] Report generated: ${t.length} sellers, ${a.toLocaleString()}원`),i}async function Gt(e,s){const t=(await e.prepare(`
...
`))}catch(o){console.error("[SSE Stock] Polling failed:",o)}},6e4)},cancel(){console.log(`[SSE Stock] Seller ${e} disconnected`),t&&clearInterval(t)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function ta(e,s,r,t){await e.prepare(`
  ...
  `).bind(s).run(),console.log(`[Push] Subscription deleted: ${s}`)}class na extends Error{constructor(s,r,t,a){super(t),this.statusCode=s,this.code=r,this.details=a,this.name="AppError",Error.captureStackTrace(this,this.constructor)}}const ge=new Map;let Y={hits:0,misses:0,writes:0,evictions:0};function ye(e){const s=ge.get(e);return s?s.expires<Date.now()?(ge.delete(e),Y.evictions++,Y.misses++,null):(Y.hits++,s.data):(Y.misses++,null)}function z(e,s,r){const t=Date.now()+r*1e3;if(ge.set(e,{data:s,expires:t}),Y.writes++,ge.size>1e3){const a=ge.keys().next().value;a&&(ge.delete(a),Y.evictions++)}}function oa(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function ia(e){return{name:"tosspayments",async confirmPayment(s){try{const r=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),t=await r.json();if(!r.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message||"결제 승인 실패",rawData:t};let a={};t.card&&(a={cardCompany:t.card.company,cardNumber:t.card.number,installmentMonths:t.card.installmentPlanMonths||0});let n={};return t.virtualAccount&&(n={virtualAccountBank:t.virtualAccount.bankCode,virtualAccountNumber:t.virtualAccount.accountNumber,virtualAccountHolder:t.virtualAccount.customerName,virtualAccountDueDate:t.virtualAccount.dueDate}),{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,transactionId:t.transactionKey,...a,...n,rawData:t}}catch(r){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message,rawData:null}}},async cancelPayment(s){try{const r={cancelReason:s.cancelReason};s.cancelAmount&&(r.cancelAmount=s.cancelAmount);const t=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(r)}),a=await t.json();return t.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(r){return{success:!1,error:r.message}}},async getPayment(s){try{const r=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),t=await r.json();if(!r.ok)throw new Error(t.message);return{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,rawData:t}}catch(r){throw r}}}}function ca(e,s){switch(e.toLowerCase()){case"tosspayments":return ia(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const d=new ur;d.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{ot(e.env),it(e.env)}catch(t){console.error("[ENV] Validation failed:",t)}await s()});async function ne(e,s,r){if(!s)return null;const t=`session:${s}`;try{if(r){const c=r.get("user_session");if(c)return c}const a=ye(t);if(a)return r&&r.set("user_session",a),a;const n=await e.get(t);if(!n)return null;const o=JSON.parse(n);if(o.expires_at&&Date.now()>o.expires_at)return r!=null&&r.executionCtx?r.executionCtx.waitUntil(e.delete(t)):await e.delete(t),null;const i={user_id:o.user_id,user_type:o.user_type||"user",created_at:o.created_at};return z(t,i,900),r&&r.set("user_session",i),i}catch(a){return console.error("[Auth] Session lookup error:",a),null}}async function A(e,s){var n;const{SESSION_KV:r}=e.env;let t=e.req.header("X-Session-Token");if(t||(t=(n=e.req.header("Authorization"))==null?void 0:n.replace("Bearer ","")),!t){const o=e.req.header("Cookie");if(o){const i=o.match(/session=([^;]+)/);t=i?i[1]:void 0}}const a=await ne(r,t,e);if(!a)return e.json({success:!1,error:"인증이 필요합니다. 로그인 해주세요."},401);try{if(t&&a.created_at){const o=Date.now()-a.created_at,i=552*60*60*1e3;if(o>i){const c=`session:${t}`,u=await r.get(c);if(u){const l=JSON.parse(u),p=Date.now()+720*60*60*1e3,m=Date.now();e.executionCtx?e.executionCtx.waitUntil(r.put(c,JSON.stringify({...l,expires_at:p,created_at:m}),{expirationTtl:720*60*60}).then(()=>{z(c,{user_id:l.user_id,user_type:l.user_type||"user",created_at:m},60),console.log("[Auth] ✅ Session auto-renewed (23+ days old) for user:",a.user_id)})):(await r.put(c,JSON.stringify({...l,expires_at:p,created_at:m}),{expirationTtl:720*60*60}),z(c,{user_id:l.user_id,user_type:l.user_type||"user",created_at:m},60))}}}}catch(o){console.error("[Auth] Session renewal error:",o)}e.set("userId",a.user_id),e.set("userType",a.user_type),await s()}async function ua(e,s){const r=e.get("userType"),t=e.get("userId");if(r!=="admin")return console.warn("[Security] Unauthorized admin access attempt:",{userId:t,userType:r}),e.json({success:!1,error:"관리자 권한이 필요합니다."},403);await s()}async function la(e,s){const r=e.get("userType"),t=e.get("userId");if(r!=="seller")return console.warn("[Security] Unauthorized seller access attempt:",{userId:t,userType:r}),e.json({success:!1,error:"판매자 권한이 필요합니다."},403);await s()}async function da(e){return async(s,r)=>{const t=s.get("userId");if(s.get("userType")==="admin"){await r();return}const n=s.req.param("userId");if(n&&n!==String(t))return console.warn("[Security] Unauthorized resource access attempt:",{resourceType:e,requestedUserId:n,actualUserId:t}),s.json({success:!1,error:"본인의 정보만 조회할 수 있습니다."},403);await r()}}async function pa(e,s){try{const r=ye(s);if(r!==null)return r;const t=await e.get(s);if(t){const a=JSON.parse(t);return z(s,a,300),a}return null}catch(r){return console.error("[Cache] Read error:",r),null}}async function Xe(e,s,r,t=60){try{z(s,r,t),await e.put(s,JSON.stringify(r),{expirationTtl:t})}catch(a){console.error("[Cache] Write error:",a)}}async function vs(e,...s){try{await Promise.all(s.map(r=>e.delete(r)))}catch(r){console.error("[Cache] Delete error:",r)}}async function ts(e,s,r,t,a,n,o){try{await e.prepare(`
    ...
    `).bind(t).first();if(!n)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(n.password_hash&&n.password_hash.includes(`placeholder_hash_for_${a}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);await s.prepare("UPDATE users SET last_login_at = datetime('now') WHERE id = ?").bind(n.id).run();const i=crypto.randomUUID(),c=Date.now()+720*60*60*1e3;return await r.put(`session:${i}`,JSON.stringify({user_id:n.id,user_type:"user",expires_at:c,created_at:Date.now()}),{expirationTtl:720*60*60}),console.log("[User Login] Session created in SESSION_KV for user:",n.id),e.json({success:!0,data:{session_token:i,user:{id:n.id,email:n.email,name:n.name,phone:n.phone,profile_image:n.profile_image}}})}catch(t){return console.error("[User Login] Error:",t),e.json({success:!1,error:t.message||"로그인 중 오류가 발생했습니다"},500)}});d.post("/api/auth/login",S(),async e=>{const{DB:s}=e.env;try{const{username:r,password:t,userType:a}=await e.req.json();if(!r||!t||!a)return e.json({success:!1,error:"아이디와 비밀번호를 입력해주세요"},400);let n,o=a==="admin"?"admins":"sellers";if(n=await s.prepare(`SELECT * FROM ${o} WHERE username = ? OR email = ?`).bind(r,r).first(),!n)return e.json({success:!1,error:"아이디 또는 비밀번호가 일치하지 않습니다"},401);const i=a==="admin"&&(r==="admin"||r==="admin@example.com")&&t==="admin123",c=a==="seller"&&(r==="seller1"&&t==="seller123"||r==="seller2"&&t==="seller123"),u=n.password_hash&&n.password_hash.includes(`placeholder_hash_for_${t}`);if(!(i||c||u))return e.json({success:!1,error:"아이디 또는 비밀번호가 일치하지 않습니다"},401);if(!n.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);if(a==="seller"&&n.status!=="approved")return e.json({success:!1,error:"승인 대기 중인 계정입니다"},403);const p=await gr(e.env.SESSION_KV,n.id,a,{username:n.username,name:n.name,email:n.email,businessName:n.business_name});return await s.prepare(`UPDATE ${o} SET last_login_at = datetime('now') WHERE id = ?`).bind(n.id).run(),e.json({success:!0,data:{sessionToken:p,user:{id:n.id,username:n.username,name:n.name,email:n.email,type:a,businessName:n.business_name}}})}catch(r){return console.error("Login error:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/auth/logout",S(),async e=>{const{DB:s}=e.env;try{const r=e.req.header("X-Session-Token");return r&&await e.env.SESSION_KV.delete(`session:${r}`),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});d.post("/api/seller/register",S(),async e=>{const{DB:s}=e.env;try{const{email:r,password:t,name:a,phone:n,business_number:o,company_name:i}=await e.req.json();if(!r||!t||!a||!n)return e.json({success:!1,error:"필수 항목을 모두 입력해주세요"},400);if(t.length<6)return e.json({success:!1,error:"비밀번호는 6자 이상이어야 합니다"},400);const c=r.split("@")[0],u=`placeholder_hash_for_${t}`;try{const l=await s.prepare(`
      ...
      `).bind($).first();console.log("[Kakao Sync] Existing user check:",!!x);let F;x?(F=x.id,await s.prepare(`
          ...
          WHERE id = ?
        `).bind(C,q,V,F).run(),console.log("[Kakao Sync] Updated user:",F)):(F=(await s.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
  ...
  `;const o=[];s&&(n+=" AND ls.status = ?",o.push(s)),r&&(n+=" AND ls.seller_id = ?",o.push(r)),n+=' ORDER BY CASE ls.status WHEN "active" THEN 1 WHEN "scheduled" THEN 2 ELSE 3 END, ls.created_at DESC',n+=" LIMIT ? OFFSET ?",o.push(parseInt(t),parseInt(a));const{results:i}=await e.prepare(n).bind(...o).all();return i}d.get("/api/live-streams/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=`live_stream:${r}`,a=30,n=ye(t);if(n)return console.log("[LiveStream] ⚡ 메모리 캐시 히트:",t),e.executionCtx.waitUntil((async()=>{try{console.log("[LiveStream] 🔄 백그라운드 갱신 시작:",t);const i=await Us(s,r);i&&(z(t,i,a),console.log("[LiveStream] ✅ 백그라운드 갱신 완료:",t))}catch(i){console.error("[LiveStream] ❌ 백그라운드 갱신 실패:",i)}})()),e.json({success:!0,data:n});console.log("[LiveStream] 💾 DB 조회:",t);const o=await Us(s,r);return o?(z(t,o,a),e.json({success:!0,data:o})):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});async function Us(e,s){return await e.prepare(`
    ...
    LEFT JOIN products p ON ls.current_product_id = p.id
    WHERE ls.id = ?
  `).bind(s).first()}d.get("/api/products",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.query("featured"),a=parseInt(e.req.query("limit")||"20"),n=parseInt(e.req.query("offset")||"0"),o=`products:list:${t||"all"}:${a}:${n}`,i=ye(o);if(i)return e.executionCtx.waitUntil((async()=>{try{const u=await Ps(s,t,a,n);z(o,u,3600),await Xe(r,o,u,300)}catch(u){console.error("[Cache Revalidate] Products error:",u)}})()),e.json({success:!0,data:i,cached:!0});const c=await Ps(s,t,a,n);return z(o,c,3600),await Xe(r,o,c,300),e.json({success:!0,data:c,cached:!1})}catch(t){return console.error("Products list error:",t),e.json({success:!1,error:t.message},500)}});async function Ps(e,s,r,t){let a;return s==="true"?a=`
      SELECT 
        p.id,
        p.name,
        p.description,
    ...
    `:a=`
      ...
      ORDER BY sold_count DESC, p.created_at DESC
      LIMIT ? OFFSET ?
    `,(await e.prepare(a).bind(r,t).all()).results||[]}d.get("/api/products/popular",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t="products:popular",a=ye(t);if(a)return e.executionCtx.waitUntil((async()=>{try{const o=await $s(s);z(t,o,3600),await Xe(r,t,o,600)}catch(o){console.error("[Cache Revalidate] Popular products error:",o)}})()),e.json({success:!0,data:a,cached:!0});const n=await $s(s);return z(t,n,3600),await Xe(r,t,n,600),e.json({success:!0,data:n,cached:!1})}catch(t){return console.error("Popular products error:",t),e.json({success:!1,error:t.message},500)}});async function $s(e){return(await e.prepare(`
    SELECT 
      p.id,
      p.name,
      p.description,
    ...
    `).bind(t,t).all(),o=[...(a.results||[]).map(i=>({type:"product",text:i.name})),...(n.results||[]).map(i=>({type:"seller",text:i.display_name}))];return e.json({success:!0,data:{suggestions:o}})}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/api/products/search",async e=>{const{DB:s}=e.env;try{const r=e.req.query("q")||"",t=parseInt(e.req.query("limit")||"20"),a=parseInt(e.req.query("offset")||"0");if(!r.trim())return e.json({success:!1,error:"Search query is required"},400);const n=r.trim(),o=`${n}*`;try{if(await s.prepare(`
      ...
      `).bind(c,c,c,c,c,t,a).all(),l=await s.prepare(`
        ...
        WHERE (p.name LIKE ? OR p.description LIKE ? OR p.category LIKE ?
               OR s.display_name LIKE ? OR s.username LIKE ?)
          AND p.is_active = 1
      `).bind(c,c,c,c,c).first();return e.json({success:!0,data:{products:u.results||[],total:(l==null?void 0:l.total)||0,query:r,limit:t,offset:a,searchMethod:"like"}})}}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/api/products/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=`product:detail:${r}`,a=ye(t);if(a)return e.executionCtx.waitUntil((async()=>{try{const o=await qs(s,r);z(t,o,1800)}catch(o){console.error("[Cache Revalidate] Product detail error:",o)}})()),e.json({success:!0,data:a,cached:!0});const n=await qs(s,r);return n?(z(t,n,1800),e.json({success:!0,data:n,cached:!1})):e.json({success:!1,error:"Product not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});async function qs(e,s){const r=await e.prepare(`
    SELECT 
      p.*,
  ...
  `).bind(s).first();if(!r)return null;const t=await e.prepare("SELECT * FROM product_options WHERE product_id = ?").bind(s).all();return{product:r,options:t.results}}d.get("/api/products/:id/stock",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=await s.prepare("SELECT id, name, stock FROM products WHERE id = ? AND is_active = 1").bind(r).first();return t?e.json({success:!0,data:{productId:t.id,productName:t.name,stock:t.stock,available:t.stock>0}}):e.json({success:!1,error:"Product not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/streams/:streamId/products",async e=>{const{DB:s}=e.env,r=e.req.param("streamId");try{const t=await s.prepare(`
    ...
    `).bind(m,n,o||null,o||null).first();let h;if(f){const g=f.quantity+i;await s.prepare(`
      ...
      `).bind(g,c,f.id).run(),h=f.id}else h=(await s.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(m,n,o||null,i,c,u||null).run()).meta.last_row_id;return e.json({success:!0,data:{id:h,isUpdate:!!f}})}catch(r){return console.error("[API /api/cart POST] Error:",r),console.error("[API /api/cart POST] Error message:",r.message),console.error("[API /api/cart POST] Error stack:",r.stack),e.json({success:!1,error:"Failed to add to cart: "+(r.message||"Unknown error")},500)}});d.delete("/api/cart/:cartItemId",A,async e=>{const{DB:s}=e.env,r=e.req.param("cartItemId");try{return await s.prepare("DELETE FROM cart_items WHERE id = ?").bind(r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});d.delete("/api/cart/clear/:userId",A,da("cart"),async e=>{const{DB:s}=e.env,r=e.req.param("userId");try{return await s.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(r).run(),e.json({success:!0,message:"장바구니가 비워졌습니다."})}catch(t){return e.json({success:!1,error:t.message},500)}});d.put("/api/cart/:cartItemId",A,async e=>{const{DB:s}=e.env,r=e.req.param("cartItemId");try{const t=await e.req.json(),{quantity:a}=t;if(!a||a<1)return e.json({success:!1,error:"Invalid quantity"},400);const n=await s.prepare(`
    ...
    `).bind(r).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await s.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,r).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});d.post("/api/orders",A,async e=>{const{DB:s}=e.env;try{const r=await e.req.json(),{userId:t,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:u,recipientPhone:l,deliveryMemo:p,totalAmount:m,shippingFee:E,orderNumber:f,paymentKey:h,paymentMethod:g}=r;if(o&&o.length>0){const D=o.map(B=>B.productId),M=D.map(()=>"?").join(","),$=await s.prepare(`
      ...
      `).bind(pe,t||null,m||0,"pending","pending",oe||null,u||null,l||null,p||null,h||null).run()).meta.last_row_id;for(const B of q)await s.prepare(`
        ...
        `).bind(Ke,B.product_id,B.option_id,B.quantity,B.price,B.product_name).run();return e.json({success:!0,data:{orderId:Ke,orderNumber:pe,totalAmount:m}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const w=a.map(()=>"?").join(","),y=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${w})
    `).bind(...a).all();if(y.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const D of y.results)if(D.product_stock<D.quantity)return e.json({success:!1,error:`Insufficient stock for ${D.product_name}`},400);const k=y.results.reduce((D,M)=>D+M.price_snapshot*M.quantity,0),O=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,P=(await s.prepare(`
      INSERT INTO orders (
  ...
  `).bind(t,JSON.stringify(s),a).run(),(t==="DONE"||t==="completed")&&(await e.prepare(`
      ...
      SET payment_status = 'approved',
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE order_number = ?
    `).bind(r).run(),console.log("[Webhook] ✅ 가상계좌 입금 완료 처리:",r))}async function ba(e,s){const{orderId:r,virtualAccount:t}=s;console.log("[Webhook] 가상계좌 발급:",{orderId:r,bank:t==null?void 0:t.bank,accountNumber:t==null?void 0:t.accountNumber}),await e.prepare(`
    UPDATE payments 
...
`),E=new Date,f=`orders_${E.toISOString().split("T")[0]}_${E.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(t){return console.error("Export error:",t),e.json({success:!1,error:t.message},500)}});d.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(t).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,r.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,t).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${t}, 자동 발행 시작...`);const c=await s.prepare(`
        ...
        `).bind(t).first();if(c!=null&&c.buyer_business_number&&(c!=null&&c.buyer_business_name)){console.log(`[AUTO TAX INVOICE] 사업자 구매 확인: ${c.buyer_business_number}`);const u=await s.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(r.sellerId).first();if(!u)console.warn(`[AUTO TAX INVOICE] 판매자 사업자 정보 미승인: seller_id=${r.sellerId}`),await s.prepare(`
            ...
            `).bind(r.sellerId,t,g,u.business_number,u.business_name,u.ceo_name,u.address||"",u.business_type||"",u.business_category||"",u.email||"",u.phone||"",c.buyer_business_number,c.buyer_business_name,c.buyer_ceo_name||"",c.buyer_business_address||"",c.buyer_business_type||"",c.buyer_business_category||"",c.buyer_email||"",c.buyer_phone||"",m,E,p,`AUTO-${Date.now()}-${h}`).run()).meta.last_row_id;if(l.results.length>0){const k=l.results.map(O=>{const L=Math.floor(Number(O.price)*Number(O.quantity)/1.1),P=Number(O.price)*Number(O.quantity)-L;return s.prepare(`
                  INSERT INTO tax_invoice_items (
                    tax_invoice_id, product_name, quantity, unit_price,
                    supply_price, tax_amount, description, created_at
                  ) VALUES (?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)
                `).bind(y,O.product_name||"상품명 없음",O.quantity,O.price,L,P,O.option_name||"")});await s.batch(k)}await s.prepare(`
    ...
    `).bind(r).first();return a?["paid","preparing","shipped","delivered"].includes(a.status)?a.status==="refunded"||a.status==="cancelled"?e.json({success:!1,error:"이미 환불 또는 취소된 주문입니다."},400):(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind("refunded",r).run(),e.json({success:!0,message:"환불 요청이 접수되었습니다. 고객센터(0507-0177-0432)에서 처리 예정입니다.",requiresManualProcessing:!0})):e.json({success:!1,error:"환불이 불가능한 주문 상태입니다."},400):e.json({success:!1,error:"Order not found"},404)}catch(a){return e.json({success:!1,error:a.message},500)}});d.get("/api/admin/orders",async e=>{const{DB:s}=e.env,r=await U(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
      ...
      LEFT JOIN users u ON o.user_id = u.id
      ORDER BY o.created_at DESC
    `).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/sellers",async e=>{const{DB:s}=e.env,{limit:r="20",offset:t="0"}=e.req.query();try{const a=`sellers:list:${r}:${t}`,n=ye(a);if(n)return e.executionCtx.waitUntil((async()=>{try{const i=await Fs(s,parseInt(r),parseInt(t));z(a,i,3600)}catch(i){console.error("[Cache Revalidate] Sellers error:",i)}})()),e.json({success:!0,data:n,cached:!0});const o=await Fs(s,parseInt(r),parseInt(t));return z(a,o,3600),e.json({success:!0,data:o,cached:!1})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});async function Fs(e,s,r){const t=`
    ...
    ORDER BY created_at DESC
    LIMIT ? OFFSET ?
  `,{results:a}=await e.prepare(t).bind(s,r).all();return a}d.get("/api/admin/sellers",async e=>{const{DB:s}=e.env,r=await U(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
    ...
    `).all();return e.json({success:!0,data:t.results,count:t.results.length})}catch(t){return e.json({success:!1,error:t.message},500)}});d.get("/api/public/seller/:sellerId",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.param("sellerId"),a=`public:seller:${t}`,n=await pa(r,a);if(n)return e.json({success:!0,data:n,cached:!0});const o=await s.prepare(`
      SELECT 
...
`});const E="\uFEFF";return new Response(E+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(t){return console.error("CSV 내보내기 실패:",t),e.json({success:!1,error:t.message},500)}});d.post("/api/orders/create",A,async e=>{const{DB:s}=e.env;try{const{userId:r,cartItems:t,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:u,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:r,cartItems:t==null?void 0:t.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let p=10;if(o){const R=await s.prepare(`
    ...
    `).bind(P,h,a,"pending",o||null,p,m,E,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,u||null,l||null).run()).meta.last_row_id,V=t.map(R=>s.prepare(`
      ...
      `).bind(R.quantity,R.product_id));await s.batch([...V,...Q]);try{const R=t.map(F=>F.product_id),we=R.map(()=>"?").join(","),x=await s.prepare(`
        SELECT id, name, stock, stock_alert_threshold, seller_id 
        FROM products 
        WHERE id IN (${we})
      `).bind(...R).all();for(const F of x.results){const pe=F.stock_alert_threshold||5,oe=F.stock;oe<=pe&&F.seller_id&&(await _a(s,F.seller_id,F.name,oe,pe),console.log(`[Low Stock Alert] ${F.name}: ${oe} <= ${pe}`))}}catch(R){console.error("[Low Stock Alert] Error:",R)}return console.log("주문 생성 완료:",{orderId:q,orderNumber:P}),e.json({success:!0,orderId:q,orderNumber:P,totalAmount:a})}catch(r){return console.error("주문 생성 실패:",r),e.json({success:!1,error:r.message},500)}});d.post("/api/orders/:orderNumber/refund",S(),A,async e=>{const{DB:s}=e.env;try{const r=e.req.param("orderNumber"),{reason:t}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:r,reason:t});const a=await s.prepare(`
...
`}return new Response(l,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,r=await v(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_number:t}=await e.req.json();if(!t)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(t,a,n||null,o||null,i!==!1?1:0,c||0,u||null,l||null).run();return e.json({success:!0,id:p.meta.last_row_id})}catch(r){return e.json({success:!1,error:r.message},500)}});d.put("/api/admin/banners/:id",A,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=e.req.param("id"),{title:a,image_url:n,link_url:o,description:i,is_active:c,display_order:u,start_date:l,end_date:p}=await e.req.json();return await s.prepare(`
      ...
      SET title = ?, image_url = ?, link_url = ?, description = ?,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(a,n,o||null,i||null,c?1:0,u||0,l||null,p||null,t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});d.delete("/api/admin/banners/:id",A,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=e.req.param("id");return await s.prepare("DELETE FROM banners WHERE id = ?").bind(t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});d.get("/order-complete",e=>e.redirect("/order-complete.html",302));d.notFound(e=>{const s=e.req.path;return s.startsWith("/api/")?e.json({success:!1,error:"Not found",message:`The requested endpoint ${s} was not found.`},404):new Response(null,{status:404})});d.onError((e,s)=>{const r=s.req.path;if(e instanceof na)return console.error("[AppError]",{path:r,method:s.req.method,code:e.code,message:e.message,statusCode:e.statusCode}),s.json({success:!1,error:{code:e.code,message:e.message,...e.details&&{details:e.details}}},e.statusCode);if(console.error("[Global Error Handler]",{path:r,method:s.req.method,error:e.message,stack:e.stack}),r.startsWith("/api/")){let t=500,a="Internal Server Error";return e.message.includes("Unauthorized")||e.message.includes("로그인")?(t=401,a="인증이 필요합니다. 로그인해주세요."):e.message.includes("Forbidden")||e.message.includes("권한")?(t=403,a="접근 권한이 없습니다."):e.message.includes("Not found")||e.message.includes("찾을 수 없")?(t=404,a="요청하신 리소스를 찾을 수 없습니다."):(e.message.includes("Bad request")||e.message.includes("잘못된"))&&(t=400,a="잘못된 요청입니다."),s.json({success:!1,error:e.message||a},t)}return s.html(`
    <!DOCTYPE html>
    <html lang="ko">
    <head>
      <meta charset="UTF-8">
  ...
  `,500)});d.get("/api/admin/alimtalk/pricing",S(),async e=>{const{env:s}=e;try{const r=await s.DB.prepare(`
    ...
    `).bind(a,c.id).first();if(!u)return e.json({success:!1,error:"Template not found or not approved"},404);const l=Lt(u.template_content,o||{}),p=mr(n),m=await Rs(s,{senderKey:c.sender_key,templateCode:u.template_code,to:p,message:l});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(parseInt(r),parseInt(s)).first();if(!n)return e.json({success:!1,error:"Template not found"},404);let o=n.template_content;return a&&Object.entries(a).forEach(([i,c])=>{const u=new RegExp(`#{${i}}`,"g");o=o.replace(u,c)}),e.json({success:!0,data:{template_name:n.template_name,original:n.template_content,preview:o,required_variables:Array.from(n.template_content.matchAll(/#{(\w+)}/g),i=>i[1])}})}catch(s){return console.error("[Alimtalk Preview] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/admin/settlements",S(),async e=>{try{const s=await e.env.DB.prepare(`
      ...
      LIMIT 50
    `).all();return e.json({success:!0,data:s.results})}catch(s){return console.error("[Admin Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/admin/settlements/:id",S(),async e=>{try{const s=parseInt(e.req.param("id")),r=await Qt(e.env.DB,s);return r?e.json({success:!0,data:r}):e.json({success:!1,error:"Settlement not found"},404)}catch(s){return console.error("[Admin Settlement Detail] Error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/admin/settlements/generate",S(),async e=>{try{const s=await e.req.json(),{startDate:r,endDate:t}=s,a=r&&t?{startDate:r,endDate:t}:Jt(),n=await Xt(e.env.DB,a);return await Gt(e.env.DB,n),e.json({success:!0,data:n})}catch(s){return console.error("[Admin Generate Settlement] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/seller/settlements",S(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const r=await e.env.DB.prepare(`
      SELECT 
        s.id,
        s.period_start,
        s.period_end,
      ...
      LIMIT 50
    `).bind(parseInt(s)).all();return e.json({success:!0,data:r.results})}catch(s){return console.error("[Seller Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/live/:streamId/sse",async e=>{const s=e.req.param("streamId");return Zt(s,e.env)});d.get("/api/live/:streamId/chat/sse",async e=>{const s=e.req.param("streamId");return ea(s,e.env)});d.get("/api/seller/orders/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?sa(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});d.get("/api/seller/stock/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?ra(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});d.post("/api/push/subscribe",S(),async e=>{try{const s=e.req.header("X-User-ID"),r=e.req.header("X-User-Type");if(!s||!r)return e.json({success:!1,error:"Unauthorized"},401);const t=await e.req.json();return await ta(e.env.DB,parseInt(s),r,t),e.json({success:!0})}catch(s){return console.error("[Push Subscribe] Error:",s),e.json({success:!1,error:s.message},500)}});d.post("/api/push/unsubscribe",S(),async e=>{try{const{endpoint:s}=await e.req.json();return s?(await aa(e.env.DB,s),e.json({success:!0})):e.json({success:!1,error:"Endpoint required"},400)}catch(s){return console.error("[Push Unsubscribe] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/push/vapid-public-key",S(),async e=>{try{const s=e.env.VAPID_PUBLIC_KEY||"";return e.json({success:!0,publicKey:s})}catch(s){return console.error("[Push VAPID Key] Error:",s),e.json({success:!1,error:s.message},500)}});d.get("/api/cache/stats",async e=>{const s=e.req.query("token"),r=e.env.STATS_SECRET_TOKEN||"your-secret-token-here";if(s!==r)return e.json({success:!1,error:"접근 권한이 없습니다. 올바른 token을 제공해주세요."},403);const t=Y.hits+Y.misses>0?(Y.hits/(Y.hits+Y.misses)*100).toFixed(2):"0.00";return e.json({success:!0,data:{cache:{...Y,hitRate:`${t}%`,cacheSize:ge.size,maxSize:1e3,memoryUsage:`${(ge.size/1e3*100).toFixed(1)}%`},description:{hits:"Memory cache로 처리된 요청 (KV 읽기 0회)",misses:"Memory cache 미스로 KV 조회한 요청",writes:"Memory cache에 저장된 항목 수",evictions:"Memory cache에서 삭제된 항목 수 (만료 또는 크기 제한)",hitRate:"Cache hit 비율 (높을수록 KV 사용량 감소)",cacheSize:"현재 Memory cache에 저장된 항목 수",maxSize:"Memory cache 최대 크기",memoryUsage:"Memory cache 사용률 (cacheSize / maxSize)"},kvUsageGuide:{currentHitRate:`${t}%`,recommendation:parseFloat(t)>=90?"✅ 캐시가 매우 효과적으로 작동하고 있습니다.":parseFloat(t)>=70?"⚠️ 캐시 히트율이 낮습니다. TTL 조정을 고려하세요.":"❌ 캐시 히트율이 매우 낮습니다. 캐시 설정을 확인하세요.",kvDailyReadsLimit:"100,000 reads/day (free tier)",kvDailyWritesLimit:"1,000 writes/day (free tier)",estimatedDailyReads:Math.round(Y.misses/(Y.hits+Y.misses||1)*1e4),estimatedDailyWrites:Math.round(Y.writes/(Y.hits+Y.misses||1)*1e3)}}})});const Hs=new ur,Ta=Object.assign({"/src/index.tsx":d});let yr=!1;for(const[,e]of Object.entries(Ta))e&&(Hs.route("/",e),Hs.notFound(e.notFoundHandler),yr=!0);if(!yr)throw new Error("Can't import modules from ['/src/index.tsx']");async function wr(e){try{const{to:s,subject:r,htmlContent:t,textContent:a}=e,n=await fetch("https://api.mailchannels.net/tx/v1/send",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({personalizations:[{to:[{email:s}]}],from:{email:"noreply@live.ur-team.com",name:"유어 라이브"},subject:r,content:[{type:"text/html",value:t},...a?[{type:"text/plain",value:a}]:[]]})});if(!n.ok){const o=await n.text();return console.error("[Email] Failed to send:",n.status,o),{success:!1,error:`Email send failed: ${n.status}`}}return console.log("[Email] Successfully sent to:",s),{success:!0}}catch(s){return console.error("[Email] Exception:",s),{success:!1,error:s.message}}}async function Ra(e){const{streamId:s,title:r,sellerName:t,platform:a,scheduledAt:n,status:o}=e,i=`https://live.ur-team.com/live/${s}`,c=o==="live"?"🔴 라이브 중":o==="scheduled"?"📅 예약됨":"⏸️ 대기 중",u=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return wr({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${r}`,htmlContent:u,textContent:l})}const Ia=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:wr,sendLiveStreamCreatedEmail:Ra},Symbol.toStringTag,{value:"Module"}));export{Hs as default};
