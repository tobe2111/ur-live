var Ct=Object.defineProperty;var lr=e=>{throw TypeError(e)};var Nt=(e,s,r)=>s in e?Ct(e,s,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[s]=r;var A=(e,s,r)=>Nt(e,typeof s!="symbol"?s+"":s,r),Ps=(e,s,r)=>s.has(e)||lr("Cannot "+r);var E=(e,s,r)=>(Ps(e,s,"read from private field"),r?r.call(e):s.get(e)),O=(e,s,r)=>s.has(e)?lr("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,r),I=(e,s,r,t)=>(Ps(e,s,"write to private field"),t?t.call(e,r):s.set(e,r),r),N=(e,s,r)=>(Ps(e,s,"access private method"),r);var ur=(e,s,r,t)=>({set _(a){I(e,s,a,r)},get _(){return E(e,s,t)}});var dr=(e,s,r)=>(t,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let c,l=!1,u;if(e[i]?(u=e[i][0][0],t.req.routeIndex=i):u=i===e.length&&a||void 0,u)try{c=await u(t,()=>o(i+1))}catch(d){if(d instanceof Error&&s)t.error=d,c=await s(d,t),l=!0;else throw d}else t.finalized===!1&&r&&(c=await r(t));return c&&(t.finalized===!1||l)&&(t.res=c),t}},jt=Symbol(),Lt=async(e,s=Object.create(null))=>{const{all:r=!1,dot:t=!1}=s,n=(e instanceof Hr?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Mt(e,{all:r,dot:t}):{}};async function Mt(e,s){const r=await e.formData();return r?Ft(r,s):{}}function Ft(e,s){const r=Object.create(null);return e.forEach((t,a)=>{s.all||a.endsWith("[]")?$t(r,a,t):r[a]=t}),s.dot&&Object.entries(r).forEach(([t,a])=>{t.includes(".")&&(Ut(r,t,a),delete r[t])}),r}var $t=(e,s,r)=>{e[s]!==void 0?Array.isArray(e[s])?e[s].push(r):e[s]=[e[s],r]:s.endsWith("[]")?e[s]=[r]:e[s]=r},Ut=(e,s,r)=>{let t=e;const a=s.split(".");a.forEach((n,o)=>{o===a.length-1?t[n]=r:((!t[n]||typeof t[n]!="object"||Array.isArray(t[n])||t[n]instanceof File)&&(t[n]=Object.create(null)),t=t[n])})},Ur=e=>{const s=e.split("/");return s[0]===""&&s.shift(),s},Pt=e=>{const{groups:s,path:r}=xt(e),t=Ur(r);return Wt(t,s)},xt=e=>{const s=[];return e=e.replace(/\{[^}]+\}/g,(r,t)=>{const a=`@${t}`;return s.push([a,r]),a}),{groups:s,path:e}},Wt=(e,s)=>{for(let r=s.length-1;r>=0;r--){const[t]=s[r];for(let a=e.length-1;a>=0;a--)if(e[a].includes(t)){e[a]=e[a].replace(t,s[r][1]);break}}return e},Ss={},qt=(e,s)=>{if(e==="*")return"*";const r=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(r){const t=`${e}#${s}`;return Ss[t]||(r[2]?Ss[t]=s&&s[0]!==":"&&s[0]!=="*"?[t,r[1],new RegExp(`^${r[2]}(?=/${s})`)]:[e,r[1],new RegExp(`^${r[2]}$`)]:Ss[t]=[e,r[1],!0]),Ss[t]}return null},Xs=(e,s)=>{try{return s(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,r=>{try{return s(r)}catch{return r}})}},Ht=e=>Xs(e,decodeURI),Pr=e=>{const s=e.url,r=s.indexOf("/",s.indexOf(":")+4);let t=r;for(;t<s.length;t++){const a=s.charCodeAt(t);if(a===37){const n=s.indexOf("?",t),o=s.indexOf("#",t),i=n===-1?o===-1?void 0:o:o===-1?n:Math.min(n,o),c=s.slice(r,i);return Ht(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(a===63||a===35)break}return s.slice(r,t)},Bt=e=>{const s=Pr(e);return s.length>1&&s.at(-1)==="/"?s.slice(0,-1):s},Ke=(e,s,...r)=>(r.length&&(s=Ke(s,...r)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${s==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(s==null?void 0:s[0])==="/"?s.slice(1):s}`}`),xr=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const s=e.split("/"),r=[];let t="";return s.forEach(a=>{if(a!==""&&!/\:/.test(a))t+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){r.length===0&&t===""?r.push("/"):r.push(t);const n=a.replace("?","");t+="/"+n,r.push(t)}else t+="/"+a}),r.filter((a,n,o)=>o.indexOf(a)===n)},xs=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Xs(e,qr):e):e,Wr=(e,s,r)=>{let t;if(!r&&s&&!/[%+]/.test(s)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(s,o+1)||(o=e.indexOf(`&${s}`,o+1));o!==-1;){const i=e.charCodeAt(o+s.length+1);if(i===61){const c=o+s.length+2,l=e.indexOf("&",c);return xs(e.slice(c,l===-1?void 0:l))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${s}`,o+1)}if(t=/[%+]/.test(e),!t)return}const a={};t??(t=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let c=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(t&&(c=xs(c)),n=o,c==="")continue;let l;i===-1?l="":(l=e.slice(i+1,o===-1?void 0:o),t&&(l=xs(l))),r?(a[c]&&Array.isArray(a[c])||(a[c]=[]),a[c].push(l)):a[c]??(a[c]=l)}return s?a[s]:a},Kt=Wr,Jt=(e,s)=>Wr(e,s,!0),qr=decodeURIComponent,pr=e=>Xs(e,qr),ze,ae,ye,Br,Kr,Vs,be,Cr,Hr=(Cr=class{constructor(e,s="/",r=[[]]){O(this,ye);A(this,"raw");O(this,ze);O(this,ae);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});O(this,be,e=>{const{bodyCache:s,raw:r}=this,t=s[e];if(t)return t;const a=Object.keys(s)[0];return a?s[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):s[e]=r[e]()});this.raw=e,this.path=s,I(this,ae,r),I(this,ze,{})}param(e){return e?N(this,ye,Br).call(this,e):N(this,ye,Kr).call(this)}query(e){return Kt(this.url,e)}queries(e){return Jt(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const s={};return this.raw.headers.forEach((r,t)=>{s[t]=r}),s}async parseBody(e){var s;return(s=this.bodyCache).parsedBody??(s.parsedBody=await Lt(this,e))}json(){return E(this,be).call(this,"text").then(e=>JSON.parse(e))}text(){return E(this,be).call(this,"text")}arrayBuffer(){return E(this,be).call(this,"arrayBuffer")}blob(){return E(this,be).call(this,"blob")}formData(){return E(this,be).call(this,"formData")}addValidatedData(e,s){E(this,ze)[e]=s}valid(e){return E(this,ze)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[jt](){return E(this,ae)}get matchedRoutes(){return E(this,ae)[0].map(([[,e]])=>e)}get routePath(){return E(this,ae)[0].map(([[,e]])=>e)[this.routeIndex].path}},ze=new WeakMap,ae=new WeakMap,ye=new WeakSet,Br=function(e){const s=E(this,ae)[0][this.routeIndex][1][e],r=N(this,ye,Vs).call(this,s);return r&&/\%/.test(r)?pr(r):r},Kr=function(){const e={},s=Object.keys(E(this,ae)[0][this.routeIndex][1]);for(const r of s){const t=N(this,ye,Vs).call(this,E(this,ae)[0][this.routeIndex][1][r]);t!==void 0&&(e[r]=/\%/.test(t)?pr(t):t)}return e},Vs=function(e){return E(this,ae)[1]?E(this,ae)[1][e]:e},be=new WeakMap,Cr),Vt={Stringify:1},Jr=async(e,s,r,t,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:s,buffer:a,context:t}))).then(i=>Promise.all(i.filter(Boolean).map(c=>Jr(c,s,!1,t,a))).then(()=>a[0]))):Promise.resolve(e)},Yt="text/plain; charset=UTF-8",Ws=(e,s)=>({"Content-Type":e,...s}),We=(e,s)=>new Response(e,s),ms,_s,fe,Ge,Ee,ee,fs,Xe,Qe,ke,Es,hs,de,Je,Ys,Nr,zt=(Nr=class{constructor(e,s){O(this,de);O(this,ms);O(this,_s);A(this,"env",{});O(this,fe);A(this,"finalized",!1);A(this,"error");O(this,Ge);O(this,Ee);O(this,ee);O(this,fs);O(this,Xe);O(this,Qe);O(this,ke);O(this,Es);O(this,hs);A(this,"render",(...e)=>(E(this,Xe)??I(this,Xe,s=>this.html(s)),E(this,Xe).call(this,...e)));A(this,"setLayout",e=>I(this,fs,e));A(this,"getLayout",()=>E(this,fs));A(this,"setRenderer",e=>{I(this,Xe,e)});A(this,"header",(e,s,r)=>{this.finalized&&I(this,ee,We(E(this,ee).body,E(this,ee)));const t=E(this,ee)?E(this,ee).headers:E(this,ke)??I(this,ke,new Headers);s===void 0?t.delete(e):r!=null&&r.append?t.append(e,s):t.set(e,s)});A(this,"status",e=>{I(this,Ge,e)});A(this,"set",(e,s)=>{E(this,fe)??I(this,fe,new Map),E(this,fe).set(e,s)});A(this,"get",e=>E(this,fe)?E(this,fe).get(e):void 0);A(this,"newResponse",(...e)=>N(this,de,Je).call(this,...e));A(this,"body",(e,s,r)=>N(this,de,Je).call(this,e,s,r));A(this,"text",(e,s,r)=>N(this,de,Ys).call(this)&&!s&&!r?We(e):N(this,de,Je).call(this,e,s,Ws(Yt,r)));A(this,"json",(e,s,r)=>N(this,de,Ys).call(this)&&!s&&!r?Response.json(e):N(this,de,Je).call(this,JSON.stringify(e),s,Ws("application/json",r)));A(this,"html",(e,s,r)=>{const t=a=>N(this,de,Je).call(this,a,s,Ws("text/html; charset=UTF-8",r));return typeof e=="object"?Jr(e,Vt.Stringify,!1,{}).then(t):t(e)});A(this,"redirect",(e,s)=>{const r=String(e);return this.header("Location",/[^\x00-\xFF]/.test(r)?encodeURI(r):r),this.newResponse(null,s??302)});A(this,"notFound",()=>(E(this,Qe)??I(this,Qe,()=>We()),E(this,Qe).call(this,this)));I(this,ms,e),s&&(I(this,Ee,s.executionCtx),this.env=s.env,I(this,Qe,s.notFoundHandler),I(this,hs,s.path),I(this,Es,s.matchResult))}get req(){return E(this,_s)??I(this,_s,new Hr(E(this,ms),E(this,hs),E(this,Es))),E(this,_s)}get event(){if(E(this,Ee)&&"respondWith"in E(this,Ee))return E(this,Ee);throw Error("This context has no FetchEvent")}get executionCtx(){if(E(this,Ee))return E(this,Ee);throw Error("This context has no ExecutionContext")}get res(){return E(this,ee)||I(this,ee,We(null,{headers:E(this,ke)??I(this,ke,new Headers)}))}set res(e){if(E(this,ee)&&e){e=We(e.body,e);for(const[s,r]of E(this,ee).headers.entries())if(s!=="content-type")if(s==="set-cookie"){const t=E(this,ee).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of t)e.headers.append("set-cookie",a)}else e.headers.set(s,r)}I(this,ee,e),this.finalized=!0}get var(){return E(this,fe)?Object.fromEntries(E(this,fe)):{}}},ms=new WeakMap,_s=new WeakMap,fe=new WeakMap,Ge=new WeakMap,Ee=new WeakMap,ee=new WeakMap,fs=new WeakMap,Xe=new WeakMap,Qe=new WeakMap,ke=new WeakMap,Es=new WeakMap,hs=new WeakMap,de=new WeakSet,Je=function(e,s,r){const t=E(this,ee)?new Headers(E(this,ee).headers):E(this,ke)??new Headers;if(typeof s=="object"&&"headers"in s){const n=s.headers instanceof Headers?s.headers:new Headers(s.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?t.append(o,i):t.set(o,i)}if(r)for(const[n,o]of Object.entries(r))if(typeof o=="string")t.set(n,o);else{t.delete(n);for(const i of o)t.append(n,i)}const a=typeof s=="number"?s:(s==null?void 0:s.status)??E(this,Ge);return We(e,{status:a,headers:t})},Ys=function(){return!E(this,ke)&&!E(this,Ge)&&!this.finalized},Nr),K="ALL",Gt="all",Xt=["get","post","put","delete","options","patch"],Vr="Can not add a route since the matcher is already built.",Yr=class extends Error{},Qt="__COMPOSED_HANDLER",Zt=e=>e.text("404 Not Found",404),mr=(e,s)=>{if("getResponse"in e){const r=e.getResponse();return s.newResponse(r.body,r)}return console.error(e),s.text("Internal Server Error",500)},ce,J,zr,le,De,Is,vs,Ze,ea=(Ze=class{constructor(s={}){O(this,J);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");O(this,ce,"/");A(this,"routes",[]);O(this,le,Zt);A(this,"errorHandler",mr);A(this,"onError",s=>(this.errorHandler=s,this));A(this,"notFound",s=>(I(this,le,s),this));A(this,"fetch",(s,...r)=>N(this,J,vs).call(this,s,r[1],r[0],s.method));A(this,"request",(s,r,t,a)=>s instanceof Request?this.fetch(r?new Request(s,r):s,t,a):(s=s.toString(),this.fetch(new Request(/^https?:\/\//.test(s)?s:`http://localhost${Ke("/",s)}`,r),t,a)));A(this,"fire",()=>{addEventListener("fetch",s=>{s.respondWith(N(this,J,vs).call(this,s.request,s,void 0,s.request.method))})});[...Xt,Gt].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?I(this,ce,o):N(this,J,De).call(this,n,E(this,ce),o),i.forEach(c=>{N(this,J,De).call(this,n,E(this,ce),c)}),this)}),this.on=(n,o,...i)=>{for(const c of[o].flat()){I(this,ce,c);for(const l of[n].flat())i.map(u=>{N(this,J,De).call(this,l.toUpperCase(),E(this,ce),u)})}return this},this.use=(n,...o)=>(typeof n=="string"?I(this,ce,n):(I(this,ce,"*"),o.unshift(n)),o.forEach(i=>{N(this,J,De).call(this,K,E(this,ce),i)}),this);const{strict:t,...a}=s;Object.assign(this,a),this.getPath=t??!0?s.getPath??Pr:Bt}route(s,r){const t=this.basePath(s);return r.routes.map(a=>{var o;let n;r.errorHandler===mr?n=a.handler:(n=async(i,c)=>(await dr([],r.errorHandler)(i,()=>a.handler(i,c))).res,n[Qt]=a.handler),N(o=t,J,De).call(o,a.method,a.path,n)}),this}basePath(s){const r=N(this,J,zr).call(this);return r._basePath=Ke(this._basePath,s),r}mount(s,r,t){let a,n;t&&(typeof t=="function"?n=t:(n=t.optionHandler,t.replaceRequest===!1?a=c=>c:a=t.replaceRequest));const o=n?c=>{const l=n(c);return Array.isArray(l)?l:[l]}:c=>{let l;try{l=c.executionCtx}catch{}return[c.env,l]};a||(a=(()=>{const c=Ke(this._basePath,s),l=c==="/"?0:c.length;return u=>{const d=new URL(u.url);return d.pathname=d.pathname.slice(l)||"/",new Request(d,u)}})());const i=async(c,l)=>{const u=await r(a(c.req.raw),...o(c));if(u)return u;await l()};return N(this,J,De).call(this,K,Ke(s,"*"),i),this}},ce=new WeakMap,J=new WeakSet,zr=function(){const s=new Ze({router:this.router,getPath:this.getPath});return s.errorHandler=this.errorHandler,I(s,le,E(this,le)),s.routes=this.routes,s},le=new WeakMap,De=function(s,r,t){s=s.toUpperCase(),r=Ke(this._basePath,r);const a={basePath:this._basePath,path:r,method:s,handler:t};this.router.add(s,r,[t,a]),this.routes.push(a)},Is=function(s,r){if(s instanceof Error)return this.errorHandler(s,r);throw s},vs=function(s,r,t,a){if(a==="HEAD")return(async()=>new Response(null,await N(this,J,vs).call(this,s,r,t,"GET")))();const n=this.getPath(s,{env:t}),o=this.router.match(a,n),i=new zt(s,{path:n,matchResult:o,env:t,executionCtx:r,notFoundHandler:E(this,le)});if(o[0].length===1){let l;try{l=o[0][0][0][0](i,async()=>{i.res=await E(this,le).call(this,i)})}catch(u){return N(this,J,Is).call(this,u,i)}return l instanceof Promise?l.then(u=>u||(i.finalized?i.res:E(this,le).call(this,i))).catch(u=>N(this,J,Is).call(this,u,i)):l??E(this,le).call(this,i)}const c=dr(o[0],this.errorHandler,E(this,le));return(async()=>{try{const l=await c(i);if(!l.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return l.res}catch(l){return N(this,J,Is).call(this,l,i)}})()},Ze),Gr=[];function sa(e,s){const r=this.buildAllMatchers(),t=((a,n)=>{const o=r[a]||r[K],i=o[2][n];if(i)return i;const c=n.match(o[0]);if(!c)return[[],Gr];const l=c.indexOf("",1);return[o[1][l],c]});return this.match=t,t(e,s)}var Os="[^/]+",ls=".*",us="(?:|/.*)",Ve=Symbol(),ra=new Set(".\\+*[^]$()");function ta(e,s){return e.length===1?s.length===1?e<s?-1:1:-1:s.length===1||e===ls||e===us?1:s===ls||s===us?-1:e===Os?1:s===Os?-1:e.length===s.length?e<s?-1:1:s.length-e.length}var Ce,Ne,ue,Fe,aa=(Fe=class{constructor(){O(this,Ce);O(this,Ne);O(this,ue,Object.create(null))}insert(s,r,t,a,n){if(s.length===0){if(E(this,Ce)!==void 0)throw Ve;if(n)return;I(this,Ce,r);return}const[o,...i]=s,c=o==="*"?i.length===0?["","",ls]:["","",Os]:o==="/*"?["","",us]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let l;if(c){const u=c[1];let d=c[2]||Os;if(u&&c[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw Ve;if(l=E(this,ue)[d],!l){if(Object.keys(E(this,ue)).some(m=>m!==ls&&m!==us))throw Ve;if(n)return;l=E(this,ue)[d]=new Fe,u!==""&&I(l,Ne,a.varIndex++)}!n&&u!==""&&t.push([u,E(l,Ne)])}else if(l=E(this,ue)[o],!l){if(Object.keys(E(this,ue)).some(u=>u.length>1&&u!==ls&&u!==us))throw Ve;if(n)return;l=E(this,ue)[o]=new Fe}l.insert(i,r,t,a,n)}buildRegExpStr(){const r=Object.keys(E(this,ue)).sort(ta).map(t=>{const a=E(this,ue)[t];return(typeof E(a,Ne)=="number"?`(${t})@${E(a,Ne)}`:ra.has(t)?`\\${t}`:t)+a.buildRegExpStr()});return typeof E(this,Ce)=="number"&&r.unshift(`#${E(this,Ce)}`),r.length===0?"":r.length===1?r[0]:"(?:"+r.join("|")+")"}},Ce=new WeakMap,Ne=new WeakMap,ue=new WeakMap,Fe),js,gs,jr,na=(jr=class{constructor(){O(this,js,{varIndex:0});O(this,gs,new aa)}insert(e,s,r){const t=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,c=>{const l=`@\\${o}`;return a[o]=[l,c],o++,i=!0,l}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let c=n.length-1;c>=0;c--)if(n[c].indexOf(i)!==-1){n[c]=n[c].replace(i,a[o][1]);break}}return E(this,gs).insert(n,s,t,E(this,js),r),t}buildRegExp(){let e=E(this,gs).buildRegExpStr();if(e==="")return[/^$/,[],[]];let s=0;const r=[],t=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(r[++s]=Number(n),"$()"):(o!==void 0&&(t[Number(o)]=++s),"")),[new RegExp(`^${e}`),r,t]}},js=new WeakMap,gs=new WeakMap,jr),oa=[/^$/,[],Object.create(null)],As=Object.create(null);function Xr(e){return As[e]??(As[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(s,r)=>r?`\\${r}`:"(?:|/.*)")}$`))}function ia(){As=Object.create(null)}function ca(e){var l;const s=new na,r=[];if(e.length===0)return oa;const t=e.map(u=>[!/\*|\/:/.test(u[0]),...u]).sort(([u,d],[m,_])=>u?1:m?-1:d.length-_.length),a=Object.create(null);for(let u=0,d=-1,m=t.length;u<m;u++){const[_,f,h]=t[u];_?a[f]=[h.map(([b])=>[b,Object.create(null)]),Gr]:d++;let w;try{w=s.insert(f,d,_)}catch(b){throw b===Ve?new Yr(f):b}_||(r[d]=h.map(([b,g])=>{const T=Object.create(null);for(g-=1;g>=0;g--){const[y,R]=w[g];T[y]=R}return[b,T]}))}const[n,o,i]=s.buildRegExp();for(let u=0,d=r.length;u<d;u++)for(let m=0,_=r[u].length;m<_;m++){const f=(l=r[u][m])==null?void 0:l[1];if(!f)continue;const h=Object.keys(f);for(let w=0,b=h.length;w<b;w++)f[h[w]]=i[f[h[w]]]}const c=[];for(const u in o)c[u]=r[o[u]];return[n,c,a]}function qe(e,s){if(e){for(const r of Object.keys(e).sort((t,a)=>a.length-t.length))if(Xr(r).test(s))return[...e[r]]}}var we,Se,Ls,Qr,Lr,la=(Lr=class{constructor(){O(this,Ls);A(this,"name","RegExpRouter");O(this,we);O(this,Se);A(this,"match",sa);I(this,we,{[K]:Object.create(null)}),I(this,Se,{[K]:Object.create(null)})}add(e,s,r){var i;const t=E(this,we),a=E(this,Se);if(!t||!a)throw new Error(Vr);t[e]||[t,a].forEach(c=>{c[e]=Object.create(null),Object.keys(c[K]).forEach(l=>{c[e][l]=[...c[K][l]]})}),s==="/*"&&(s="*");const n=(s.match(/\/:/g)||[]).length;if(/\*$/.test(s)){const c=Xr(s);e===K?Object.keys(t).forEach(l=>{var u;(u=t[l])[s]||(u[s]=qe(t[l],s)||qe(t[K],s)||[])}):(i=t[e])[s]||(i[s]=qe(t[e],s)||qe(t[K],s)||[]),Object.keys(t).forEach(l=>{(e===K||e===l)&&Object.keys(t[l]).forEach(u=>{c.test(u)&&t[l][u].push([r,n])})}),Object.keys(a).forEach(l=>{(e===K||e===l)&&Object.keys(a[l]).forEach(u=>c.test(u)&&a[l][u].push([r,n]))});return}const o=xr(s)||[s];for(let c=0,l=o.length;c<l;c++){const u=o[c];Object.keys(a).forEach(d=>{var m;(e===K||e===d)&&((m=a[d])[u]||(m[u]=[...qe(t[d],u)||qe(t[K],u)||[]]),a[d][u].push([r,n-l+c+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(E(this,Se)).concat(Object.keys(E(this,we))).forEach(s=>{e[s]||(e[s]=N(this,Ls,Qr).call(this,s))}),I(this,we,I(this,Se,void 0)),ia(),e}},we=new WeakMap,Se=new WeakMap,Ls=new WeakSet,Qr=function(e){const s=[];let r=e===K;return[E(this,we),E(this,Se)].forEach(t=>{const a=t[e]?Object.keys(t[e]).map(n=>[n,t[e][n]]):[];a.length!==0?(r||(r=!0),s.push(...a)):e!==K&&s.push(...Object.keys(t[K]).map(n=>[n,t[K][n]]))}),r?ca(s):null},Lr),Te,he,Mr,ua=(Mr=class{constructor(e){A(this,"name","SmartRouter");O(this,Te,[]);O(this,he,[]);I(this,Te,e.routers)}add(e,s,r){if(!E(this,he))throw new Error(Vr);E(this,he).push([e,s,r])}match(e,s){if(!E(this,he))throw new Error("Fatal error");const r=E(this,Te),t=E(this,he),a=r.length;let n=0,o;for(;n<a;n++){const i=r[n];try{for(let c=0,l=t.length;c<l;c++)i.add(...t[c]);o=i.match(e,s)}catch(c){if(c instanceof Yr)continue;throw c}this.match=i.match.bind(i),I(this,Te,[i]),I(this,he,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(E(this,he)||E(this,Te).length!==1)throw new Error("No active router has been determined yet.");return E(this,Te)[0]}},Te=new WeakMap,he=new WeakMap,Mr),os=Object.create(null),da=e=>{for(const s in e)return!0;return!1},Re,Z,je,es,G,ge,Oe,ss,pa=(ss=class{constructor(s,r,t){O(this,ge);O(this,Re);O(this,Z);O(this,je);O(this,es,0);O(this,G,os);if(I(this,Z,t||Object.create(null)),I(this,Re,[]),s&&r){const a=Object.create(null);a[s]={handler:r,possibleKeys:[],score:0},I(this,Re,[a])}I(this,je,[])}insert(s,r,t){I(this,es,++ur(this,es)._);let a=this;const n=Pt(r),o=[];for(let i=0,c=n.length;i<c;i++){const l=n[i],u=n[i+1],d=qt(l,u),m=Array.isArray(d)?d[0]:l;if(m in E(a,Z)){a=E(a,Z)[m],d&&o.push(d[1]);continue}E(a,Z)[m]=new ss,d&&(E(a,je).push(d),o.push(d[1])),a=E(a,Z)[m]}return E(a,Re).push({[s]:{handler:t,possibleKeys:o.filter((i,c,l)=>l.indexOf(i)===c),score:E(this,es)}}),a}search(s,r){var u;const t=[];I(this,G,os);let n=[this];const o=Ur(r),i=[],c=o.length;let l=null;for(let d=0;d<c;d++){const m=o[d],_=d===c-1,f=[];for(let w=0,b=n.length;w<b;w++){const g=n[w],T=E(g,Z)[m];T&&(I(T,G,E(g,G)),_?(E(T,Z)["*"]&&N(this,ge,Oe).call(this,t,E(T,Z)["*"],s,E(g,G)),N(this,ge,Oe).call(this,t,T,s,E(g,G))):f.push(T));for(let y=0,R=E(g,je).length;y<R;y++){const L=E(g,je)[y],k=E(g,G)===os?{}:{...E(g,G)};if(L==="*"){const $=E(g,Z)["*"];$&&(N(this,ge,Oe).call(this,t,$,s,E(g,G)),I($,G,k),f.push($));continue}const[D,W,U]=L;if(!m&&!(U instanceof RegExp))continue;const M=E(g,Z)[D];if(U instanceof RegExp){if(l===null){l=new Array(c);let z=r[0]==="/"?1:0;for(let v=0;v<c;v++)l[v]=z,z+=o[v].length+1}const $=r.substring(l[d]),Q=U.exec($);if(Q){if(k[W]=Q[0],N(this,ge,Oe).call(this,t,M,s,E(g,G),k),da(E(M,Z))){I(M,G,k);const z=((u=Q[0].match(/\//))==null?void 0:u.length)??0;(i[z]||(i[z]=[])).push(M)}continue}}(U===!0||U.test(m))&&(k[W]=m,_?(N(this,ge,Oe).call(this,t,M,s,k,E(g,G)),E(M,Z)["*"]&&N(this,ge,Oe).call(this,t,E(M,Z)["*"],s,k,E(g,G))):(I(M,G,k),f.push(M)))}}const h=i.shift();n=h?f.concat(h):f}return t.length>1&&t.sort((d,m)=>d.score-m.score),[t.map(({handler:d,params:m})=>[d,m])]}},Re=new WeakMap,Z=new WeakMap,je=new WeakMap,es=new WeakMap,G=new WeakMap,ge=new WeakSet,Oe=function(s,r,t,a,n){for(let o=0,i=E(r,Re).length;o<i;o++){const c=E(r,Re)[o],l=c[t]||c[K],u={};if(l!==void 0&&(l.params=Object.create(null),s.push(l),a!==os||n&&n!==os))for(let d=0,m=l.possibleKeys.length;d<m;d++){const _=l.possibleKeys[d],f=u[l.score];l.params[_]=n!=null&&n[_]&&!f?n[_]:a[_]??(n==null?void 0:n[_]),u[l.score]=!0}}},ss),Le,Fr,ma=(Fr=class{constructor(){A(this,"name","TrieRouter");O(this,Le);I(this,Le,new pa)}add(e,s,r){const t=xr(s);if(t){for(let a=0,n=t.length;a<n;a++)E(this,Le).insert(e,t[a],r);return}E(this,Le).insert(e,s,r)}match(e,s){return E(this,Le).search(e,s)}},Le=new WeakMap,Fr),Zr=class extends ea{constructor(e={}){super(e),this.router=e.router??new ua({routers:[new la,new ma]})}},S=e=>{const r={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},t=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(r.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(r.allowMethods);return async function(o,i){var u;function c(d,m){o.res.headers.set(d,m)}const l=await t(o.req.header("origin")||"",o);if(l&&c("Access-Control-Allow-Origin",l),r.credentials&&c("Access-Control-Allow-Credentials","true"),(u=r.exposeHeaders)!=null&&u.length&&c("Access-Control-Expose-Headers",r.exposeHeaders.join(",")),o.req.method==="OPTIONS"){r.origin!=="*"&&c("Vary","Origin"),r.maxAge!=null&&c("Access-Control-Max-Age",r.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&c("Access-Control-Allow-Methods",d.join(","));let m=r.allowHeaders;if(!(m!=null&&m.length)){const _=o.req.header("Access-Control-Request-Headers");_&&(m=_.split(/\s*,\s*/))}return m!=null&&m.length&&(c("Access-Control-Allow-Headers",m.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),r.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function _a(e){var a;const s=((a=e.split(".").pop())==null?void 0:a.toLowerCase())||"jpg",r=Date.now(),t=crypto.randomUUID().substring(0,8);return`upload_${r}_${t}.${s}`}async function fa(e){const s=new Uint8Array(e);return s[0]===255&&s[1]===216&&s[2]===255?{valid:!0,detectedType:"image/jpeg"}:s[0]===137&&s[1]===80&&s[2]===78&&s[3]===71?{valid:!0,detectedType:"image/png"}:s[0]===71&&s[1]===73&&s[2]===70&&s[3]===56?{valid:!0,detectedType:"image/gif"}:s[0]===82&&s[1]===73&&s[2]===70&&s[3]===70&&s[8]===87&&s[9]===69&&s[10]===66&&s[11]===80?{valid:!0,detectedType:"image/webp"}:{valid:!1}}function Ea(e){const s=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],r=[];for(const t of s)e[t]||r.push(t);if(r.length>0)throw new Error(`Missing required environment variables: ${r.join(", ")}
...
`)}async function ba(e){const s=await ga(e),r=s.filter(n=>n.status==="pass").length,t=s.filter(n=>n.status==="warn").length,a=s.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:s.length,pass:r,warn:t,fail:a},results:s,formatted:ya(s)}}const qs={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function wa(){const e=qs.ENV==="production";return{baseUrl:qs.TEST_BASE_URL,apiKey:qs.TEST_API_KEY,isProduction:e}}async function et(e,s){const r=wa(),t=`${r.baseUrl}${e}`;try{const a=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r.apiKey}`},body:JSON.stringify(s)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Sa(e){try{const s={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((t,a)=>({SerialNum:a+1,ItemName:t.name,Qty:t.quantity,UnitPrice:t.unitPrice,SupplyCost:t.supplyPrice,Tax:t.taxAmount,Remark:t.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},r=await et("/eTaxInvoice/RegistAndIssue",s);if(r.code!==1)throw new Error(`바로빌 발행 실패: ${r.message}`);return{success:!0,ntsConfirmNumber:r.ntsconfirmNum,invoiceKey:r.invoiceKey,message:r.message}}catch(s){throw console.error("바로빌 세금계산서 발행 실패:",s),s}}async function Ta(e,s,r){try{const a=await et("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:s,Memo:r});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(t){throw console.error("바로빌 세금계산서 취소 실패:",t),t}}function cs(){return!1}async function Ra(e){return await Sa(e)}function Ia(e,s,r){const t=Number(s.total_amount),a=Math.floor(t/1.1),n=t-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:s.buyer_business_number,buyerBusinessName:s.buyer_business_name||s.user_name,buyerCEO:s.buyer_ceo_name,buyerAddress:s.shipping_address,buyerEmail:s.user_email,buyerTel:s.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:r.map(o=>{const i=Number(o.price)*Number(o.quantity),c=Math.floor(i/1.1),l=i-c;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:c,taxAmount:l,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:t,memo:`주문번호: ${s.order_number}`,orderNo:s.order_number}}class ne extends Error{constructor(s,r,t){super(s),this.statusCode=r,this.code=t,this.name="AuthError"}}function va(e){return`${crypto.randomUUID()}-${e}`}function Aa(e){var n,o,i,c,l,u,d;const s=e.id.toString(),r=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",t=((c=e.kakao_account)==null?void 0:c.email)||null,a=((l=e.properties)==null?void 0:l.profile_image)||((d=(u=e.kakao_account)==null?void 0:u.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:s,nickname:r,email:t,profileImage:a}}async function Da(e,s,r,t,a){try{const n=await e.prepare(`
    ...
    `).bind(s,r,t,a).first();if(!n)throw new ne("Failed to upsert user",500,"UPSERT_FAILED");return console.log("[Auth] ⚡ User upserted successfully (optimized):",n.id),n}catch(n){throw n instanceof ne?n:(console.error("[Auth] Database error during upsert:",n),new ne("Database error",500,"DB_ERROR"))}}async function Oa(e){try{const s=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${e}`,"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"}});if(!s.ok){const t=await s.text();throw console.error("[Kakao API] Failed to get user info:",t),new ne("Failed to get user info from Kakao",401,"KAKAO_USER_INFO_FAILED")}const r=await s.json();if(!r.id)throw new ne("Invalid user data from Kakao",500,"INVALID_KAKAO_DATA");return r}catch(s){throw s instanceof ne?s:(console.error("[Kakao API] Network error:",s),new ne("Failed to communicate with Kakao API",503,"KAKAO_API_ERROR"))}}async function ka(e,s,r){try{const t=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded;charset=utf-8"},body:new URLSearchParams({grant_type:"authorization_code",client_id:r,redirect_uri:s,code:e}).toString()});if(!t.ok){const n=await t.json();throw console.error("[Kakao OAuth] Token exchange failed:",n),new ne(`Failed to exchange code: ${n.error_description||n.error}`,401,n.error||"TOKEN_EXCHANGE_FAILED")}return(await t.json()).access_token}catch(t){throw t instanceof ne?t:(console.error("[Kakao OAuth] Network error:",t),new ne("Failed to communicate with Kakao OAuth server",503,"OAUTH_NETWORK_ERROR"))}}async function st(e,s){const r=await Oa(s),{kakaoId:t,nickname:a,email:n,profileImage:o}=Aa(r);console.log("[Auth] Processing login for Kakao user:",t);const i=await Da(e,t,a,n,o),c=va(i.id);return{user:i,sessionToken:c}}async function rt(e,s,r=30){try{const t=await e.get(s,"json");if(!t)return console.log(`[Cache MISS] ${s}`),null;const a=Date.now()-t.timestamp;return a>r*1e3?(console.log(`[Cache EXPIRED] ${s} (age: ${Math.round(a/1e3)}s)`),null):(console.log(`[Cache HIT] ${s} (age: ${Math.round(a/1e3)}s)`),t.data)}catch(t){return console.error(`[Cache] Get error for key "${s}":`,t),null}}async function ks(e,s,r,t=30){try{const a={data:r,timestamp:Date.now()};await e.put(s,JSON.stringify(a),{expirationTtl:t}),console.log(`[Cache SET] ${s} (TTL: ${t}s)`)}catch(a){console.error(`[Cache] Set error for key "${s}":`,a)}}function Ca(e){const s=e.req.header("CF-Connecting-IP");if(s)return s;const r=e.req.header("X-Forwarded-For");if(r)return r.split(",")[0].trim();const t=e.req.header("X-Real-IP");return t||"unknown"}function Na(e,s){return`ratelimit:${e}:${s}`}const Hs=new Map;async function ja(e,s,r){var m;const t=new URL(e.req.url).pathname,a=Na(s,t),n=Date.now(),o=r.windowMs*1e3,c=e.get("user")&&r.authenticatedMultiplier?r.maxRequests*r.authenticatedMultiplier:r.maxRequests;try{const _=(m=e.env)==null?void 0:m.RATE_LIMIT_KV;if(_){const f=await _.get(a);let h;f?(h=JSON.parse(f),n>h.resetTime?h={count:1,resetTime:n+o}:h.count++):h={count:1,resetTime:n+o};const w=Math.ceil(o/1e3);await _.put(a,JSON.stringify(h),{expirationTtl:w});const b=h.count<=c,g=Math.max(0,c-h.count);return{allowed:b,remaining:g,resetTime:h.resetTime}}}catch(_){console.error("KV Rate Limit Error:",_)}let l=Hs.get(a);l&&n>l.resetTime&&(Hs.delete(a),l=void 0),l?l.count++:l={count:1,resetTime:n+o},Hs.set(a,l);const u=l.count<=c,d=Math.max(0,c-l.count);return{allowed:u,remaining:d,resetTime:l.resetTime}}function $e(e){return async(s,r)=>{const t=Ca(s);if(e.skipIps&&e.skipIps.includes(t))return r();if(e.pathPattern){const n=new URL(s.req.url).pathname;if(!e.pathPattern.test(n))return r()}const a=await ja(s,t,e);if(s.header("X-RateLimit-Limit",e.maxRequests.toString()),s.header("X-RateLimit-Remaining",a.remaining.toString()),s.header("X-RateLimit-Reset",new Date(a.resetTime).toISOString()),!a.allowed){const n=Math.ceil((a.resetTime-Date.now())/1e3);return s.header("Retry-After",n.toString()),s.json({success:!1,error:e.message||"Too many requests. Please try again later.",retryAfter:n,resetTime:new Date(a.resetTime).toISOString()},429)}return r()}}const Ue={api:{windowMs:60,maxRequests:60,message:"API 요청 제한을 초과했습니다. 잠시 후 다시 시도해주세요.",authenticatedMultiplier:2},auth:{windowMs:60,maxRequests:5,message:"로그인 시도 횟수를 초과했습니다. 1분 후 다시 시도해주세요.",pathPattern:/^\/api\/auth\//},order:{windowMs:60,maxRequests:10,message:"주문 요청이 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/orders/,authenticatedMultiplier:2},cart:{windowMs:60,maxRequests:20,message:"장바구니 요청이 너무 많습니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/cart/,authenticatedMultiplier:2},refund:{windowMs:3600,maxRequests:3,message:"환불 요청 횟수를 초과했습니다. 1시간 후 다시 시도해주세요.",pathPattern:/^\/api\/orders\/.*\/refund/},alimtalk:{windowMs:60,maxRequests:10,message:"알림톡 발송 요청이 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/seller\/alimtalk\/send/},upload:{windowMs:60,maxRequests:5,message:"파일 업로드가 너무 빈번합니다. 잠시 후 다시 시도해주세요.",pathPattern:/^\/api\/.*\/upload/}};class B extends Error{constructor(s,r,t="VALIDATION_ERROR"){super(r),this.field=s,this.code=t,this.name="ValidationError"}}function La(e,s){const{field:r,required:t,type:a,min:n,max:o,pattern:i,enum:c,custom:l,message:u}=s;if(t&&(e==null||e===""))throw new B(r,u||`${r}은(는) 필수 항목입니다.`,"REQUIRED");if(!(e==null||e==="")){if(a)switch(a){case"string":if(typeof e!="string")throw new B(r,u||`${r}은(는) 문자열이어야 합니다.`,"INVALID_TYPE");break;case"number":const d=typeof e=="string"?Number(e):e;if(typeof d!="number"||isNaN(d))throw new B(r,u||`${r}은(는) 숫자여야 합니다.`,"INVALID_TYPE");break;case"boolean":if(typeof e!="boolean")throw new B(r,u||`${r}은(는) true/false 값이어야 합니다.`,"INVALID_TYPE");break;case"email":if(typeof e!="string"||!$a(e))throw new B(r,u||`${r}은(는) 유효한 이메일 주소여야 합니다.`,"INVALID_EMAIL");break;case"url":if(typeof e!="string"||!Ua(e))throw new B(r,u||`${r}은(는) 유효한 URL이어야 합니다.`,"INVALID_URL");break;case"phone":if(typeof e!="string"||!Pa(e))throw new B(r,u||`${r}은(는) 유효한 전화번호여야 합니다.`,"INVALID_PHONE");break;case"date":if(!(e instanceof Date)&&!xa(e))throw new B(r,u||`${r}은(는) 유효한 날짜여야 합니다.`,"INVALID_DATE");break;case"array":if(!Array.isArray(e))throw new B(r,u||`${r}은(는) 배열이어야 합니다.`,"INVALID_TYPE");break;case"object":if(typeof e!="object"||e===null||Array.isArray(e))throw new B(r,u||`${r}은(는) 객체여야 합니다.`,"INVALID_TYPE");break}if(typeof e=="string"){if(n!==void 0&&e.length<n)throw new B(r,u||`${r}은(는) 최소 ${n}자 이상이어야 합니다.`,"TOO_SHORT");if(o!==void 0&&e.length>o)throw new B(r,u||`${r}은(는) 최대 ${o}자 이하여야 합니다.`,"TOO_LONG")}if(typeof e=="number"){if(n!==void 0&&e<n)throw new B(r,u||`${r}은(는) 최소 ${n} 이상이어야 합니다.`,"TOO_SMALL");if(o!==void 0&&e>o)throw new B(r,u||`${r}은(는) 최대 ${o} 이하여야 합니다.`,"TOO_LARGE")}if(Array.isArray(e)){if(n!==void 0&&e.length<n)throw new B(r,u||`${r}은(는) 최소 ${n}개 이상이어야 합니다.`,"TOO_FEW");if(o!==void 0&&e.length>o)throw new B(r,u||`${r}은(는) 최대 ${o}개 이하여야 합니다.`,"TOO_MANY")}if(i&&typeof e=="string"&&!i.test(e))throw new B(r,u||`${r}의 형식이 올바르지 않습니다.`,"INVALID_FORMAT");if(c&&!c.includes(e))throw new B(r,u||`${r}은(는) 다음 중 하나여야 합니다: ${c.join(", ")}`,"INVALID_ENUM");if(l&&l(e)===!1)throw new B(r,u||`${r}의 값이 유효하지 않습니다.`,"CUSTOM_VALIDATION_FAILED")}}function Ma(e,s){for(const r of s){const t=e[r.field];La(t,r)}}function Fa(e){return async(s,r)=>{try{let t={};const a=s.req.header("content-type")||"";a.includes("application/json")?t=await s.req.json().catch(()=>({})):(a.includes("application/x-www-form-urlencoded")||a.includes("multipart/form-data"))&&(t=await s.req.parseBody().catch(()=>({})));const n=new URL(s.req.url);for(const[o,i]of n.searchParams.entries())o in t||(t[o]=i);Ma(t,e),s.set("validatedData",t),await r()}catch(t){if(t instanceof B)return s.json({success:!1,error:t.message,field:t.field,code:t.code},400);throw t}}}function $a(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)&&e.length<=255}function Ua(e){try{const s=new URL(e);return s.protocol==="http:"||s.protocol==="https:"}catch{return!1}}function Pa(e){return/^01([0|1|6|7|8|9])-?([0-9]{3,4})-?([0-9]{4})$/.test(e)}function xa(e){if(typeof e!="string")return!1;const s=new Date(e);return!isNaN(s.getTime())}const Wa=[{field:"email",required:!0,type:"email",max:255,message:"유효한 이메일 주소를 입력해주세요."},{field:"password",required:!0,type:"string",min:8,max:100,pattern:/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)/,message:"비밀번호는 최소 8자 이상, 대소문자와 숫자를 포함해야 합니다."},{field:"name",required:!0,type:"string",min:2,max:50,message:"이름은 2-50자 사이여야 합니다."},{field:"phone",required:!1,type:"phone",message:"유효한 전화번호를 입력해주세요. (예: 010-1234-5678)"}];function Ms(e){const s=new URLSearchParams;for(const[r,t]of Object.entries(e))t!=null&&s.append(r,String(t));return s}function Qs(e,s){if(e.result_code!=="1")throw new Error(`[Aligo ${s}] ${e.message} (code: ${e.result_code})`)}async function Zs(e){console.log("[Aligo] 토큰 생성 시작");const r=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/token/create/30/s/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ms({apikey:e.ALIGO_API_KEY,userid:e.ALIGO_USER_ID})})).json();return Qs(r,"Token Create"),console.log("[Aligo] ✅ 토큰 생성 성공:",r.token.substring(0,20)+"..."),{token:r.token,urtime:r.urtime}}async function qa(e,s){console.log("[Aligo] 카카오 채널 등록:",s.channelId);const{token:r}=await Zs(e),a=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/plus/add/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ms({token:r,userid:e.ALIGO_USER_ID,plusid:s.channelId,phonenumber:s.phoneNumber})})).json();return Qs(a,"Channel Register"),console.log("[Aligo] ✅ 카카오 채널 등록 성공, senderKey:",a.senderkey),{success:!0,senderKey:a.senderkey}}async function Ha(e,s,r){console.log("[Aligo] 템플릿 등록:",r.templateCode);const{token:t}=await Zs(e),n=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/template/add/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ms({token:t,userid:e.ALIGO_USER_ID,senderkey:s,tpl_name:r.name,tpl_content:r.content,tpl_code:r.templateCode})})).json();return Qs(n,"Template Register"),console.log("[Aligo] ✅ 템플릿 등록 성공:",n.tpl_code),{success:!0,templateCode:n.tpl_code}}async function er(e,s){console.log("[Aligo] 알림톡 발송:",s.to);try{const{token:r}=await Zs(e),t=s.buttons?JSON.stringify({button:s.buttons}):void 0,n=await(await fetch("https://smartsms.aligo.in/admin/api/akv10/alimtalk/send/",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:Ms({token:r,userid:e.ALIGO_USER_ID,senderkey:s.senderKey,tpl_code:s.templateCode,receiver_1:s.to,subject_1:"알림톡",message_1:s.message,button_1:t})})).json();return n.result_code!=="1"?(console.error("[Aligo] ❌ 알림톡 발송 실패:",n.message),{success:!1,error:n.message}):(console.log("[Aligo] ✅ 알림톡 발송 성공, messageId:",n.msg_id),{success:!0,messageId:n.msg_id})}catch(r){return console.error("[Aligo] ❌ 알림톡 발송 에러:",r.message),{success:!1,error:r.message}}}function Ba(e,s){let r=e;for(const[t,a]of Object.entries(s)){const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}return r}function tt(e){let s=e.replace(/-/g,"");if(!s.startsWith("010"))throw new Error("Invalid phone number format. Must start with 010");if(s.length!==11)throw new Error("Invalid phone number length. Must be 11 digits");return s}async function Ka(e,s){const r=await e.prepare(`
    SELECT 
      o.*,
  ...
  `).bind(s).first();if(!r)throw new Error(`Order not found: ${s}`);const t=await e.prepare(`
    ...
    WHERE oi.order_id = ?
  `).bind(s).all();return{order:r,products:t.results}}async function Ja(e,s){const r=await e.prepare(`
    SELECT 
  ...
  `).bind(s).first();return r||(console.warn(`No active alimtalk account for seller ${s}`),null)}async function _r(e,s){await e.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'))
  `).bind(s.seller_id,s.template_code,s.recipient_phone,s.message,s.cost,s.status,s.order_id||null).run()}async function Va(e,s,r){await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?
    WHERE seller_id = ?
  `).bind(r,s).run()}async function Ya(e,s){try{const{order:r,products:t}=await Ka(e.DB,s),a=await Ja(e.DB,r.seller_id);if(!a)return console.warn(`Skipping alimtalk for order ${s}: no active account`),{success:!1,reason:"no_account"};const n=15;if(a.balance<n)return console.warn(`Skipping alimtalk for order ${s}: insufficient balance`),{success:!1,reason:"insufficient_balance"};const o=t.map(l=>`${l.name} ${l.quantity}개 (${l.price.toLocaleString()}원)`).join(`
`),i=`[주문 확인]
...
주문해 주셔서 감사합니다!`,c=await er(e,{senderKey:a.sender_key,templateCode:"order_confirm",to:r.buyer_phone,message:i});return c.success?(await Va(e.DB,r.seller_id,n),await _r(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:n,status:"sent",order_id:s}),console.log(`Order confirmation sent for order ${s}`),{success:!0}):(await _r(e.DB,{seller_id:r.seller_id,template_code:"order_confirm",recipient_phone:r.buyer_phone,message:i,cost:0,status:"failed",order_id:s}),console.error(`Failed to send order confirmation for order ${s}:`,c.error),{success:!1,error:c.error})}catch(r){return console.error(`Error sending order confirmation for order ${s}:`,r),{success:!1,error:r.message}}}function za(e,s){let r=e;return Object.entries(s).forEach(([t,a])=>{const n=new RegExp(`#{${t}}`,"g");r=r.replace(n,a)}),r}function Ga(e,s){const t=Array.from(e.matchAll(/#{(\w+)}/g),a=>a[1]).filter(a=>!s[a]);return{valid:t.length===0,missingVars:t}}async function Xa(e,s,r){const t=await e.prepare(`
    SELECT balance FROM alimtalk_accounts WHERE id = ?
  `).bind(s).first();if(!t)throw new Error(`Account not found: ${s}`);return{sufficient:t.balance>=r,currentBalance:t.balance}}async function Qa(e,s,r){const t=await e.prepare(`
    UPDATE alimtalk_accounts
    SET balance = balance - ?,
        updated_at = datetime('now')
  ...
  `).bind(r,s,r).run();if(!t.success||t.meta.changes===0)throw new Error("Insufficient balance or account not found")}async function fr(e,s,r){await e.prepare(`
    ...
    SET balance = balance + ?,
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,s).run()}async function Bs(e,s){await e.prepare(`
    INSERT INTO alimtalk_messages 
  ...
  `).bind(s.accountId,s.templateId,s.orderId||null,s.recipientPhone,s.messageContent,s.status,s.cost,s.aligoMessageId||null,s.failedReason||null).run()}async function Za(e,s,r,t){await e.prepare(`
    UPDATE alimtalk_accounts
    SET total_sent = total_sent + ?,
        total_failed = total_failed + ?,
        updated_at = datetime('now')
    WHERE id = ?
  `).bind(r,t,s).run()}async function en(e,s,r,t,a,n,o,i,c){try{const l={...i,...o.variables},u=za(t,l),d=await er(e,{senderKey:a,templateCode:n,to:o.phone,message:u});return d.success?(await Bs(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:u,status:"sent",cost:c,aligoMessageId:d.messageId}),{phone:o.phone,status:"sent",messageId:d.messageId,cost:c}):(await Bs(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:u,status:"failed",cost:0,failedReason:d.error}),await fr(e.DB,s,c),{phone:o.phone,status:"failed",error:d.error,cost:0})}catch(l){return console.error(`Failed to send alimtalk to ${o.phone}:`,l),await Bs(e.DB,{accountId:s,templateId:r,recipientPhone:o.phone,messageContent:"",status:"failed",cost:0,failedReason:l.message}),await fr(e.DB,s,c),{phone:o.phone,status:"failed",error:l.message,cost:0}}}async function sr(e,s){const{accountId:r,templateId:t,recipients:a,variables:n}=s;console.log(`[Alimtalk] Starting bulk send: ${a.length} recipients`);try{const o=await e.DB.prepare(`
      SELECT 
        id,
        sender_key,
        balance,
    ...
    `).bind(t,r).first();if(!i)throw new Error("Template not found");if(i.status!=="approved")throw new Error("Template is not approved");const c=Ga(i.template_content,n);if(!c.valid)throw new Error(`Missing variables: ${c.missingVars.join(", ")}`);const l=15,u=a.length*l,d=await Xa(e.DB,r,u);if(!d.sufficient)throw new Error(`Insufficient balance. Required: ${u}, Current: ${d.currentBalance}`);await Qa(e.DB,r,u),console.log(`[Alimtalk] Deducted ${u} points from account ${r}`);const m=[];let _=0,f=0,h=0;for(const w of a){const b=await en(e,r,t,i.template_content,o.sender_key,i.template_code,w,n,l);m.push(b),b.status==="sent"?_++:(f++,h+=l),m.length%10===0&&await new Promise(g=>setTimeout(g,1e3))}return await Za(e.DB,r,_,f),console.log(`[Alimtalk] Completed: ${_} sent, ${f} failed, ${h} refunded`),{success:!0,totalRecipients:a.length,successCount:_,failedCount:f,refundedAmount:h,messages:m}}catch(o){return console.error("[Alimtalk] Bulk send failed:",o),{success:!1,totalRecipients:a.length,successCount:0,failedCount:a.length,refundedAmount:0,messages:[],error:o.message}}}async function sn(e,s,r,t,a){const n=await e.DB.prepare(`
    SELECT 
      o.*,
      u.name as buyer_name,
      u.phone as buyer_phone,
...
`),c={orderNumber:n.order_number,orderDate:new Date(n.created_at).toLocaleString("ko-KR"),productList:i,totalAmount:n.total_amount.toLocaleString(),shippingAddress:n.shipping_address,shippingName:n.shipping_name,shippingPhone:n.shipping_phone,buyerName:n.buyer_name,customMessage:a||"감사합니다!"},l=[{phone:n.buyer_phone,name:n.buyer_name}];return sr(e,{accountId:s,templateId:r,recipients:l,variables:c})}async function rn(e,s,r,t,a={}){const n=t.map(o=>({phone:o.phone,name:o.name,variables:Object.entries(o).filter(([i])=>i!=="phone"&&i!=="name").reduce((i,[c,l])=>({...i,[c]:l}),{})}));return sr(e,{accountId:s,templateId:r,recipients:n,variables:a})}function tn(e,s=.1){return Math.floor(e*s)}function an(){const e=new Date,s=new Date(e.getFullYear(),e.getMonth()-1,1),r=s.getFullYear(),t=String(s.getMonth()+1).padStart(2,"0"),a=new Date(r,s.getMonth()+1,0).getDate();return{startDate:`${r}-${t}-01`,endDate:`${r}-${t}-${a}`}}async function nn(e,s,r){try{const t=await e.prepare(`
    ...
    `).bind(s,r.startDate,r.endDate).all();if(!a.results||a.results.length===0)return{seller_id:s,seller_name:t.business_name,total_sales:0,total_orders:0,platform_fee:0,shipping_fee:0,refund_amount:0,settlement_amount:0,orders:[]};const n=[];let o=0,i=0,c=0;for(const m of a.results){const _=m.total_amount-m.shipping_fee,f=tn(_);n.push({order_id:m.id,order_number:m.order_number,order_date:m.created_at,product_name:m.product_names||"",quantity:m.total_quantity||1,price:_,shipping_fee:m.shipping_fee||0,platform_fee:f,status:m.status}),o+=_,i+=m.shipping_fee||0,c+=f}const l=await e.prepare(`
      SELECT COALESCE(SUM(total_amount), 0) as refund_amount
      FROM orders
      WHERE seller_id = ?
        AND DATE(created_at) BETWEEN ? AND ?
        AND status = 'refunded'
    `).bind(s,r.startDate,r.endDate).first(),u=(l==null?void 0:l.refund_amount)||0,d=o-c-u+i;return{seller_id:s,seller_name:t.business_name,total_sales:o,total_orders:n.length,platform_fee:c,shipping_fee:i,refund_amount:u,settlement_amount:d,orders:n}}catch(t){return console.error(`Failed to calculate settlement for seller ${s}:`,t),null}}async function on(e,s){console.log(`[Settlement] Generating report for ${s.startDate} ~ ${s.endDate}`);const r=await e.prepare(`
    SELECT DISTINCT s.id
    FROM sellers s
    JOIN orders o ON s.id = o.seller_id
    WHERE DATE(o.created_at) BETWEEN ? AND ?
      AND o.status IN ('delivered', 'confirmed', 'refunded')
  `).bind(s.startDate,s.endDate).all(),t=[];let a=0,n=0,o=0;for(const c of r.results){const l=await nn(e,c.id,s);l&&(t.push(l),a+=l.total_sales,n+=l.platform_fee,o+=l.settlement_amount)}const i={period:s,generated_at:new Date().toISOString(),total_sales:a,total_platform_fee:n,total_settlement:o,sellers:t};return console.log(`[Settlement] Report generated: ${t.length} sellers, ${a.toLocaleString()}원`),i}async function cn(e,s){const t=(await e.prepare(`
  ...
  `).bind(s.period.startDate,s.period.endDate,s.total_sales,s.total_platform_fee,s.total_settlement,s.generated_at).run()).meta.last_row_id;for(const a of s.sellers)await e.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a.seller_id,a.total_sales,a.total_orders,a.platform_fee,a.shipping_fee,a.refund_amount,a.settlement_amount).run();console.log(`[Settlement] Report saved: ID ${t}`)}async function ln(e,s){const r=await e.prepare(`
...
`))}catch(o){console.error("[SSE] Update failed:",o)}},3e4)},cancel(){console.log(`[SSE] Client disconnected from stream ${e}`),t&&clearInterval(t)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function dn(e,s){const r=new TextEncoder;let t=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Chat] Client connected to stream ${e}`);try{const i=await s.DB.prepare(`
          SELECT 
            id,
            user_id,
            user_name,
...
`))}catch(i){console.error("[SSE Chat] Polling failed:",i)}},5e3)},cancel(){console.log(`[SSE Chat] Client disconnected from stream ${e}`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function pn(e,s){const r=new TextEncoder;let t=0,a;const n=new ReadableStream({async start(o){console.log(`[SSE Orders] Seller ${e} connected`);try{const i=await s.DB.prepare(`
...
`))}catch(i){console.error("[SSE Orders] Polling failed:",i)}},1e4)},cancel(){console.log(`[SSE Orders] Seller ${e} disconnected`),a&&clearInterval(a)}});return new Response(n,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function mn(e,s){const r=new TextEncoder;let t;const a=new ReadableStream({async start(n){console.log(`[SSE Stock] Seller ${e} connected`),t=setInterval(async()=>{try{const o=await s.DB.prepare(`
            SELECT 
              id,
              name,
              stock,
...
`))}catch(o){console.error("[SSE Stock] Polling failed:",o)}},6e4)},cancel(){console.log(`[SSE Stock] Seller ${e} disconnected`),t&&clearInterval(t)}});return new Response(a,{headers:{"Content-Type":"text/event-stream","Cache-Control":"no-cache",Connection:"keep-alive","X-Accel-Buffering":"no"}})}async function _n(e,s,r,t){await e.prepare(`
    INSERT OR REPLACE INTO push_subscriptions 
    (user_id, user_type, endpoint, p256dh, auth, created_at, updated_at)
    VALUES (?, ?, ?, ?, ?, datetime('now'), datetime('now'))
  `).bind(s,r,t.endpoint,t.keys.p256dh,t.keys.auth).run(),console.log(`[Push] Subscription saved for ${r} ${s}`)}async function fn(e,s){await e.prepare(`
    DELETE FROM push_subscriptions WHERE endpoint = ?
  `).bind(s).run(),console.log(`[Push] Subscription deleted: ${s}`)}function En(e){if(e.req.method!=="GET")return!1;const s=e.req.header("Authorization"),r=e.req.header("X-Session-Token");if(s||r)return!1;const a=new URL(e.req.url).pathname;return!(a.includes("/api/products/")&&a.includes("/stock")||a.includes("/api/streams/")&&a.includes("/status")||a.includes("/current-product")||a.includes("/api/chat")||a.includes("/api/sse")||a.includes("/api/orders")||a.includes("/api/payment"))}function hn(e,s){return s||new URL(e.req.url).toString()}function gn(e){const s=[];return s.push("public"),s.push(`max-age=${e.ttl}`),e.sMaxAge!==void 0?s.push(`s-maxage=${e.sMaxAge}`):s.push(`s-maxage=${e.ttl}`),e.staleWhileRevalidate&&s.push(`stale-while-revalidate=${e.staleWhileRevalidate}`),s.join(", ")}function rr(e){return async(s,r)=>{var i;if(e.skipCache||!En(s))return r();const t=hn(s,e.cacheKey),a=caches.default;let n=await a.match(t);if(n){console.log(`[Cache HIT] ${t}`);const c=new Headers(n.headers);return c.set("X-Cache","HIT"),c.set("X-Cache-Key",t),new Response(n.body,{status:n.status,statusText:n.statusText,headers:c})}console.log(`[Cache MISS] ${t}`),await r();const o=s.res;if(o.status>=200&&o.status<300){const c=gn(e);o.headers.set("Cache-Control",c),o.headers.set("X-Cache","MISS"),o.headers.set("X-Cache-Key",t);const l=e.varyBy||["Accept-Encoding"];o.headers.set("Vary",l.join(", "));const u=o.clone();(i=s.executionCtx)==null||i.waitUntil(a.put(t,u))}}}const tr={products:{ttl:10,sMaxAge:60,staleWhileRevalidate:120},liveStreams:{ttl:5,sMaxAge:10,staleWhileRevalidate:30},microCache:{ttl:10,sMaxAge:10,staleWhileRevalidate:30}};class yn extends Error{constructor(s,r,t,a){super(t),this.statusCode=s,this.code=r,this.details=a,this.name="AppError",Error.captureStackTrace(this,this.constructor)}}async function bn(e,s,r,t){if(e)try{const a={title:`✅ ${s}`,description:r,color:3066993,fields:[],timestamp:new Date().toISOString(),footer:{text:"UR LIVE Monitor"}};if(t)for(const[n,o]of Object.entries(t))a.fields.push({name:n,value:String(o),inline:!0});await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({embeds:[a]})})}catch(a){console.error("[Discord] Failed to send success alert:",a)}}async function wn(e,s,r){if(e)try{const t=["📊 **KV 사용량 경고**","","현재 사용량:",`• 읽기: ${s.toFixed(1)}%`,`• 쓰기: ${r.toFixed(1)}%`,"","50% 이상 사용 중입니다. 유료 플랜 업그레이드를 고려하세요.","https://dash.cloudflare.com"].join(`
`);await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({content:t})})}catch(t){console.error("[Discord] Failed to send KV warning:",t)}}class Sn{constructor(s){this.accessToken=null,this.tokenExpiry=0,this.databaseURL=s.FIREBASE_DATABASE_URL,this.projectId=s.FIREBASE_PROJECT_ID,this.privateKey=s.FIREBASE_PRIVATE_KEY,this.clientEmail=s.FIREBASE_CLIENT_EMAIL,(!this.databaseURL||!this.projectId||!this.privateKey||!this.clientEmail)&&console.warn("⚠️ Firebase Admin credentials not configured, using unauthenticated mode")}async set(s,r){const t=`${this.databaseURL}/${s}.json`,a=await fetch(t,{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const n=await a.text();throw console.error(`❌ Firebase set failed for ${s}:`,n),new Error(`Firebase set failed: ${a.statusText}`)}console.log(`✅ Firebase: Set data at ${s}`)}async update(s,r){const t=`${this.databaseURL}/${s}.json`,a=await fetch(t,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(r)});if(!a.ok){const n=await a.text();throw console.error(`❌ Firebase update failed for ${s}:`,n),new Error(`Firebase update failed: ${a.statusText}`)}console.log(`✅ Firebase: Updated data at ${s}`)}async get(s){const r=`${this.databaseURL}/${s}.json`,t=await fetch(r,{method:"GET"});if(!t.ok)throw new Error(`Firebase get failed: ${t.statusText}`);return await t.json()}async delete(s){const r=`${this.databaseURL}/${s}.json`,t=await fetch(r,{method:"DELETE"});if(!t.ok)throw new Error(`Firebase delete failed: ${t.statusText}`);console.log(`✅ Firebase: Deleted data at ${s}`)}async updateStreamStatus(s,r){try{await this.update(`streams/stream${s}`,{...r,updated_at:Date.now()}),console.log(`✅ Firebase: Stream ${s} updated`,r)}catch(t){console.error(`❌ Firebase: Failed to update stream ${s}`,t)}}async updateProductStock(s,r,t){try{await this.update(`products/product${s}`,{id:s,stock:r,...t,updated_at:Date.now()}),console.log(`✅ Firebase: Product ${s} stock updated to ${r}`)}catch(a){console.error(`❌ Firebase: Failed to update product ${s}`,a)}}async changeCurrentProduct(s,r){try{await this.updateStreamStatus(s,{current_product_id:r}),console.log(`✅ Firebase: Stream ${s} current product changed to ${r}`)}catch(t){console.error(`❌ Firebase: Failed to change product for stream ${s}`,t)}}async sendLowStockAlert(s,r,t){try{const a=`chats/stream${s}`,n=Date.now();await this.set(`${a}/alert_${n}`,{username:"시스템",text:`⚠️ ${r}의 재고가 ${t}개 남았습니다!`,timestamp:n,isSystem:!0}),console.log(`✅ Firebase: Low stock alert sent for stream ${s}`)}catch(a){console.error("❌ Firebase: Failed to send low stock alert",a)}}async sendSoldOutAlert(s,r){try{const t=`chats/stream${s}`,a=Date.now();await this.set(`${t}/soldout_${a}`,{username:"시스템",text:`🔴 ${r}이(가) 품절되었습니다!`,timestamp:a,isSystem:!0}),console.log(`✅ Firebase: Sold out alert sent for stream ${s}`)}catch(t){console.error("❌ Firebase: Failed to send sold out alert",t)}}async createCustomToken(s,r){try{if(console.log(`[Firebase Custom Token] Creating for UID: ${s}`),console.log("[Firebase Custom Token] Claims:",JSON.stringify(r)),!this.privateKey||!this.clientEmail||!this.projectId){const b=[];throw this.privateKey||b.push("FIREBASE_PRIVATE_KEY"),this.clientEmail||b.push("FIREBASE_CLIENT_EMAIL"),this.projectId||b.push("FIREBASE_PROJECT_ID"),new Error(`Firebase credentials not configured: missing ${b.join(", ")}`)}console.log(`[Firebase Custom Token] Using project: ${this.projectId}`),console.log(`[Firebase Custom Token] Using service account: ${this.clientEmail}`);const t={alg:"RS256",typ:"JWT"},a=Math.floor(Date.now()/1e3),n={iss:this.clientEmail,sub:this.clientEmail,aud:"https://identitytoolkit.googleapis.com/google.identity.identitytoolkit.v1.IdentityToolkit",iat:a,exp:a+3600,uid:s,claims:r||{}},o=b=>{const g=JSON.stringify(b),T=new TextEncoder().encode(g);let y="";for(let L=0;L<T.length;L++)y+=String.fromCharCode(T[L]);return btoa(y).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,"")};console.log("[Firebase Custom Token] Encoding header and payload...");const i=o(t),c=o(n),l=`${i}.${c}`;console.log("[Firebase Custom Token] Parsing private key...");const u=this.privateKey.replace(/\\n/g,`
`);if(!u.includes("-----BEGIN PRIVATE KEY-----"))throw new Error("Invalid private key format: missing PEM header");if(!u.includes("-----END PRIVATE KEY-----"))throw new Error("Invalid private key format: missing PEM footer");console.log("[Firebase Custom Token] Converting PEM to DER...");const d=await this.pemToDer(u);console.log("[Firebase Custom Token] Importing crypto key...");const m=await crypto.subtle.importKey("pkcs8",d,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]);console.log("[Firebase Custom Token] Signing token...");const _=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",m,new TextEncoder().encode(l)),h=btoa(String.fromCharCode(...new Uint8Array(_))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=/g,""),w=`${l}.${h}`;return console.log("[Firebase Custom Token] ✅ Token created successfully"),w}catch(t){throw console.error("[Firebase Custom Token] ❌ Failed to create token:",t),console.error("[Firebase Custom Token] Error name:",t.name),console.error("[Firebase Custom Token] Error message:",t.message),console.error("[Firebase Custom Token] Error stack:",t.stack),new Error(`Failed to create Firebase custom token: ${t.message}`)}}async pemToDer(s){const a=s.substring("-----BEGIN PRIVATE KEY-----".length,s.length-"-----END PRIVATE KEY-----".length-1).trim(),n=atob(a),o=new Uint8Array(n.length);for(let i=0;i<n.length;i++)o[i]=n.charCodeAt(i);return o.buffer}}function Pe(e){return new Sn(e)}const ar=crypto,at=e=>e instanceof CryptoKey,Ts=new TextEncoder,Fs=new TextDecoder;function Tn(...e){const s=e.reduce((a,{length:n})=>a+n,0),r=new Uint8Array(s);let t=0;for(const a of e)r.set(a,t),t+=a.length;return r}const Rn=e=>{const s=atob(e),r=new Uint8Array(s.length);for(let t=0;t<s.length;t++)r[t]=s.charCodeAt(t);return r},Me=e=>{let s=e;s instanceof Uint8Array&&(s=Fs.decode(s)),s=s.replace(/-/g,"+").replace(/_/g,"/").replace(/\s/g,"");try{return Rn(s)}catch{throw new TypeError("The input to be decoded is not correctly encoded.")}};class X extends Error{constructor(s,r){var t;super(s,r),this.code="ERR_JOSE_GENERIC",this.name=this.constructor.name,(t=Error.captureStackTrace)==null||t.call(Error,this,this.constructor)}}X.code="ERR_JOSE_GENERIC";class ie extends X{constructor(s,r,t="unspecified",a="unspecified"){super(s,{cause:{claim:t,reason:a,payload:r}}),this.code="ERR_JWT_CLAIM_VALIDATION_FAILED",this.claim=t,this.reason=a,this.payload=r}}ie.code="ERR_JWT_CLAIM_VALIDATION_FAILED";class ds extends X{constructor(s,r,t="unspecified",a="unspecified"){super(s,{cause:{claim:t,reason:a,payload:r}}),this.code="ERR_JWT_EXPIRED",this.claim=t,this.reason=a,this.payload=r}}ds.code="ERR_JWT_EXPIRED";class nt extends X{constructor(){super(...arguments),this.code="ERR_JOSE_ALG_NOT_ALLOWED"}}nt.code="ERR_JOSE_ALG_NOT_ALLOWED";class me extends X{constructor(){super(...arguments),this.code="ERR_JOSE_NOT_SUPPORTED"}}me.code="ERR_JOSE_NOT_SUPPORTED";class In extends X{constructor(s="decryption operation failed",r){super(s,r),this.code="ERR_JWE_DECRYPTION_FAILED"}}In.code="ERR_JWE_DECRYPTION_FAILED";class vn extends X{constructor(){super(...arguments),this.code="ERR_JWE_INVALID"}}vn.code="ERR_JWE_INVALID";class V extends X{constructor(){super(...arguments),this.code="ERR_JWS_INVALID"}}V.code="ERR_JWS_INVALID";class ys extends X{constructor(){super(...arguments),this.code="ERR_JWT_INVALID"}}ys.code="ERR_JWT_INVALID";class An extends X{constructor(){super(...arguments),this.code="ERR_JWK_INVALID"}}An.code="ERR_JWK_INVALID";class nr extends X{constructor(){super(...arguments),this.code="ERR_JWKS_INVALID"}}nr.code="ERR_JWKS_INVALID";class or extends X{constructor(s="no applicable key found in the JSON Web Key Set",r){super(s,r),this.code="ERR_JWKS_NO_MATCHING_KEY"}}or.code="ERR_JWKS_NO_MATCHING_KEY";class ot extends X{constructor(s="multiple matching keys found in the JSON Web Key Set",r){super(s,r),this.code="ERR_JWKS_MULTIPLE_MATCHING_KEYS"}}ot.code="ERR_JWKS_MULTIPLE_MATCHING_KEYS";class it extends X{constructor(s="request timed out",r){super(s,r),this.code="ERR_JWKS_TIMEOUT"}}it.code="ERR_JWKS_TIMEOUT";class ct extends X{constructor(s="signature verification failed",r){super(s,r),this.code="ERR_JWS_SIGNATURE_VERIFICATION_FAILED"}}ct.code="ERR_JWS_SIGNATURE_VERIFICATION_FAILED";function pe(e,s="algorithm.name"){return new TypeError(`CryptoKey does not support this operation, its ${s} must be ${e}`)}function is(e,s){return e.name===s}function Ks(e){return parseInt(e.name.slice(4),10)}function Dn(e){switch(e){case"ES256":return"P-256";case"ES384":return"P-384";case"ES512":return"P-521";default:throw new Error("unreachable")}}function On(e,s){if(s.length&&!s.some(r=>e.usages.includes(r))){let r="CryptoKey does not support this operation, its usages must include ";if(s.length>2){const t=s.pop();r+=`one of ${s.join(", ")}, or ${t}.`}else s.length===2?r+=`one of ${s[0]} or ${s[1]}.`:r+=`${s[0]}.`;throw new TypeError(r)}}function kn(e,s,...r){switch(s){case"HS256":case"HS384":case"HS512":{if(!is(e.algorithm,"HMAC"))throw pe("HMAC");const t=parseInt(s.slice(2),10);if(Ks(e.algorithm.hash)!==t)throw pe(`SHA-${t}`,"algorithm.hash");break}case"RS256":case"RS384":case"RS512":{if(!is(e.algorithm,"RSASSA-PKCS1-v1_5"))throw pe("RSASSA-PKCS1-v1_5");const t=parseInt(s.slice(2),10);if(Ks(e.algorithm.hash)!==t)throw pe(`SHA-${t}`,"algorithm.hash");break}case"PS256":case"PS384":case"PS512":{if(!is(e.algorithm,"RSA-PSS"))throw pe("RSA-PSS");const t=parseInt(s.slice(2),10);if(Ks(e.algorithm.hash)!==t)throw pe(`SHA-${t}`,"algorithm.hash");break}case"EdDSA":{if(e.algorithm.name!=="Ed25519"&&e.algorithm.name!=="Ed448")throw pe("Ed25519 or Ed448");break}case"Ed25519":{if(!is(e.algorithm,"Ed25519"))throw pe("Ed25519");break}case"ES256":case"ES384":case"ES512":{if(!is(e.algorithm,"ECDSA"))throw pe("ECDSA");const t=Dn(s);if(e.algorithm.namedCurve!==t)throw pe(t,"algorithm.namedCurve");break}default:throw new TypeError("CryptoKey does not support this operation")}On(e,r)}function lt(e,s,...r){var t;if(r=r.filter(Boolean),r.length>2){const a=r.pop();e+=`one of type ${r.join(", ")}, or ${a}.`}else r.length===2?e+=`one of type ${r[0]} or ${r[1]}.`:e+=`of type ${r[0]}.`;return s==null?e+=` Received ${s}`:typeof s=="function"&&s.name?e+=` Received function ${s.name}`:typeof s=="object"&&s!=null&&(t=s.constructor)!=null&&t.name&&(e+=` Received an instance of ${s.constructor.name}`),e}const Er=(e,...s)=>lt("Key must be ",e,...s);function ut(e,s,...r){return lt(`Key for the ${e} algorithm must be `,s,...r)}const dt=e=>at(e)?!0:(e==null?void 0:e[Symbol.toStringTag])==="KeyObject",Cs=["CryptoKey"],Cn=(...e)=>{const s=e.filter(Boolean);if(s.length===0||s.length===1)return!0;let r;for(const t of s){const a=Object.keys(t);if(!r||r.size===0){r=new Set(a);continue}for(const n of a){if(r.has(n))return!1;r.add(n)}}return!0};function Nn(e){return typeof e=="object"&&e!==null}function Ie(e){if(!Nn(e)||Object.prototype.toString.call(e)!=="[object Object]")return!1;if(Object.getPrototypeOf(e)===null)return!0;let s=e;for(;Object.getPrototypeOf(s)!==null;)s=Object.getPrototypeOf(s);return Object.getPrototypeOf(e)===s}const jn=(e,s)=>{if(e.startsWith("RS")||e.startsWith("PS")){const{modulusLength:r}=s.algorithm;if(typeof r!="number"||r<2048)throw new TypeError(`${e} requires key modulusLength to be 2048 bits or larger`)}};function rs(e){return Ie(e)&&typeof e.kty=="string"}function Ln(e){return e.kty!=="oct"&&typeof e.d=="string"}function Mn(e){return e.kty!=="oct"&&typeof e.d>"u"}function Fn(e){return rs(e)&&e.kty==="oct"&&typeof e.k=="string"}function $n(e){let s,r;switch(e.kty){case"RSA":{switch(e.alg){case"PS256":case"PS384":case"PS512":s={name:"RSA-PSS",hash:`SHA-${e.alg.slice(-3)}`},r=e.d?["sign"]:["verify"];break;case"RS256":case"RS384":case"RS512":s={name:"RSASSA-PKCS1-v1_5",hash:`SHA-${e.alg.slice(-3)}`},r=e.d?["sign"]:["verify"];break;case"RSA-OAEP":case"RSA-OAEP-256":case"RSA-OAEP-384":case"RSA-OAEP-512":s={name:"RSA-OAEP",hash:`SHA-${parseInt(e.alg.slice(-3),10)||1}`},r=e.d?["decrypt","unwrapKey"]:["encrypt","wrapKey"];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}case"EC":{switch(e.alg){case"ES256":s={name:"ECDSA",namedCurve:"P-256"},r=e.d?["sign"]:["verify"];break;case"ES384":s={name:"ECDSA",namedCurve:"P-384"},r=e.d?["sign"]:["verify"];break;case"ES512":s={name:"ECDSA",namedCurve:"P-521"},r=e.d?["sign"]:["verify"];break;case"ECDH-ES":case"ECDH-ES+A128KW":case"ECDH-ES+A192KW":case"ECDH-ES+A256KW":s={name:"ECDH",namedCurve:e.crv},r=e.d?["deriveBits"]:[];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}case"OKP":{switch(e.alg){case"Ed25519":s={name:"Ed25519"},r=e.d?["sign"]:["verify"];break;case"EdDSA":s={name:e.crv},r=e.d?["sign"]:["verify"];break;case"ECDH-ES":case"ECDH-ES+A128KW":case"ECDH-ES+A192KW":case"ECDH-ES+A256KW":s={name:e.crv},r=e.d?["deriveBits"]:[];break;default:throw new me('Invalid or unsupported JWK "alg" (Algorithm) Parameter value')}break}default:throw new me('Invalid or unsupported JWK "kty" (Key Type) Parameter value')}return{algorithm:s,keyUsages:r}}const pt=async e=>{if(!e.alg)throw new TypeError('"alg" argument is required when "jwk.alg" is not present');const{algorithm:s,keyUsages:r}=$n(e),t=[s,e.ext??!1,e.key_ops??r],a={...e};return delete a.alg,delete a.use,ar.subtle.importKey("jwk",a,...t)},mt=e=>Me(e);let He,Be;const _t=e=>(e==null?void 0:e[Symbol.toStringTag])==="KeyObject",Ns=async(e,s,r,t,a=!1)=>{let n=e.get(s);if(n!=null&&n[t])return n[t];const o=await pt({...r,alg:t});return a&&Object.freeze(s),n?n[t]=o:e.set(s,{[t]:o}),o},Un=(e,s)=>{if(_t(e)){let r=e.export({format:"jwk"});return delete r.d,delete r.dp,delete r.dq,delete r.p,delete r.q,delete r.qi,r.k?mt(r.k):(Be||(Be=new WeakMap),Ns(Be,e,r,s))}return rs(e)?e.k?Me(e.k):(Be||(Be=new WeakMap),Ns(Be,e,e,s,!0)):e},Pn=(e,s)=>{if(_t(e)){let r=e.export({format:"jwk"});return r.k?mt(r.k):(He||(He=new WeakMap),Ns(He,e,r,s))}return rs(e)?e.k?Me(e.k):(He||(He=new WeakMap),Ns(He,e,e,s,!0)):e},xn={normalizePublicKey:Un,normalizePrivateKey:Pn};async function ft(e,s){if(!Ie(e))throw new TypeError("JWK must be an object");switch(s||(s=e.alg),e.kty){case"oct":if(typeof e.k!="string"||!e.k)throw new TypeError('missing "k" (Key Value) Parameter value');return Me(e.k);case"RSA":if("oth"in e&&e.oth!==void 0)throw new me('RSA JWK "oth" (Other Primes Info) Parameter value is not supported');case"EC":case"OKP":return pt({...e,alg:s});default:throw new me('Unsupported "kty" (Key Type) Parameter value')}}const Ye=e=>e==null?void 0:e[Symbol.toStringTag],zs=(e,s,r)=>{var t,a;if(s.use!==void 0&&s.use!=="sig")throw new TypeError("Invalid key for this operation, when present its use must be sig");if(s.key_ops!==void 0&&((a=(t=s.key_ops).includes)==null?void 0:a.call(t,r))!==!0)throw new TypeError(`Invalid key for this operation, when present its key_ops must include ${r}`);if(s.alg!==void 0&&s.alg!==e)throw new TypeError(`Invalid key for this operation, when present its alg must be ${e}`);return!0},Wn=(e,s,r,t)=>{if(!(s instanceof Uint8Array)){if(t&&rs(s)){if(Fn(s)&&zs(e,s,r))return;throw new TypeError('JSON Web Key for symmetric algorithms must have JWK "kty" (Key Type) equal to "oct" and the JWK "k" (Key Value) present')}if(!dt(s))throw new TypeError(ut(e,s,...Cs,"Uint8Array",t?"JSON Web Key":null));if(s.type!=="secret")throw new TypeError(`${Ye(s)} instances for symmetric algorithms must be of type "secret"`)}},qn=(e,s,r,t)=>{if(t&&rs(s))switch(r){case"sign":if(Ln(s)&&zs(e,s,r))return;throw new TypeError("JSON Web Key for this operation be a private JWK");case"verify":if(Mn(s)&&zs(e,s,r))return;throw new TypeError("JSON Web Key for this operation be a public JWK")}if(!dt(s))throw new TypeError(ut(e,s,...Cs,t?"JSON Web Key":null));if(s.type==="secret")throw new TypeError(`${Ye(s)} instances for asymmetric algorithms must not be of type "secret"`);if(r==="sign"&&s.type==="public")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm signing must be of type "private"`);if(r==="decrypt"&&s.type==="public")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm decryption must be of type "private"`);if(s.algorithm&&r==="verify"&&s.type==="private")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm verifying must be of type "public"`);if(s.algorithm&&r==="encrypt"&&s.type==="private")throw new TypeError(`${Ye(s)} instances for asymmetric algorithm encryption must be of type "public"`)};function Et(e,s,r,t){s.startsWith("HS")||s==="dir"||s.startsWith("PBES2")||/^A\d{3}(?:GCM)?KW$/.test(s)?Wn(s,r,t,e):qn(s,r,t,e)}Et.bind(void 0,!1);const hr=Et.bind(void 0,!0);function Hn(e,s,r,t,a){if(a.crit!==void 0&&(t==null?void 0:t.crit)===void 0)throw new e('"crit" (Critical) Header Parameter MUST be integrity protected');if(!t||t.crit===void 0)return new Set;if(!Array.isArray(t.crit)||t.crit.length===0||t.crit.some(o=>typeof o!="string"||o.length===0))throw new e('"crit" (Critical) Header Parameter MUST be an array of non-empty strings when present');let n;r!==void 0?n=new Map([...Object.entries(r),...s.entries()]):n=s;for(const o of t.crit){if(!n.has(o))throw new me(`Extension Header Parameter "${o}" is not recognized`);if(a[o]===void 0)throw new e(`Extension Header Parameter "${o}" is missing`);if(n.get(o)&&t[o]===void 0)throw new e(`Extension Header Parameter "${o}" MUST be integrity protected`)}return new Set(t.crit)}const Bn=(e,s)=>{if(s!==void 0&&(!Array.isArray(s)||s.some(r=>typeof r!="string")))throw new TypeError(`"${e}" option must be an array of strings`);if(s)return new Set(s)};function Kn(e,s){const r=`SHA-${e.slice(-3)}`;switch(e){case"HS256":case"HS384":case"HS512":return{hash:r,name:"HMAC"};case"PS256":case"PS384":case"PS512":return{hash:r,name:"RSA-PSS",saltLength:e.slice(-3)>>3};case"RS256":case"RS384":case"RS512":return{hash:r,name:"RSASSA-PKCS1-v1_5"};case"ES256":case"ES384":case"ES512":return{hash:r,name:"ECDSA",namedCurve:s.namedCurve};case"Ed25519":return{name:"Ed25519"};case"EdDSA":return{name:s.name};default:throw new me(`alg ${e} is not supported either by JOSE or your javascript runtime`)}}async function Jn(e,s,r){if(s=await xn.normalizePublicKey(s,e),at(s))return kn(s,e,r),s;if(s instanceof Uint8Array){if(!e.startsWith("HS"))throw new TypeError(Er(s,...Cs));return ar.subtle.importKey("raw",s,{hash:`SHA-${e.slice(-3)}`,name:"HMAC"},!1,[r])}throw new TypeError(Er(s,...Cs,"Uint8Array","JSON Web Key"))}const Vn=async(e,s,r,t)=>{const a=await Jn(e,s,"verify");jn(e,a);const n=Kn(e,a.algorithm);try{return await ar.subtle.verify(n,a,r,t)}catch{return!1}};async function Yn(e,s,r){if(!Ie(e))throw new V("Flattened JWS must be an object");if(e.protected===void 0&&e.header===void 0)throw new V('Flattened JWS must have either of the "protected" or "header" members');if(e.protected!==void 0&&typeof e.protected!="string")throw new V("JWS Protected Header incorrect type");if(e.payload===void 0)throw new V("JWS Payload missing");if(typeof e.signature!="string")throw new V("JWS Signature missing or incorrect type");if(e.header!==void 0&&!Ie(e.header))throw new V("JWS Unprotected Header incorrect type");let t={};if(e.protected)try{const h=Me(e.protected);t=JSON.parse(Fs.decode(h))}catch{throw new V("JWS Protected Header is invalid")}if(!Cn(t,e.header))throw new V("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");const a={...t,...e.header},n=Hn(V,new Map([["b64",!0]]),r==null?void 0:r.crit,t,a);let o=!0;if(n.has("b64")&&(o=t.b64,typeof o!="boolean"))throw new V('The "b64" (base64url-encode payload) Header Parameter must be a boolean');const{alg:i}=a;if(typeof i!="string"||!i)throw new V('JWS "alg" (Algorithm) Header Parameter missing or invalid');const c=r&&Bn("algorithms",r.algorithms);if(c&&!c.has(i))throw new nt('"alg" (Algorithm) Header Parameter value not allowed');if(o){if(typeof e.payload!="string")throw new V("JWS Payload must be a string")}else if(typeof e.payload!="string"&&!(e.payload instanceof Uint8Array))throw new V("JWS Payload must be a string or an Uint8Array instance");let l=!1;typeof s=="function"?(s=await s(t,e),l=!0,hr(i,s,"verify"),rs(s)&&(s=await ft(s,i))):hr(i,s,"verify");const u=Tn(Ts.encode(e.protected??""),Ts.encode("."),typeof e.payload=="string"?Ts.encode(e.payload):e.payload);let d;try{d=Me(e.signature)}catch{throw new V("Failed to base64url decode the signature")}if(!await Vn(i,s,d,u))throw new ct;let _;if(o)try{_=Me(e.payload)}catch{throw new V("Failed to base64url decode the payload")}else typeof e.payload=="string"?_=Ts.encode(e.payload):_=e.payload;const f={payload:_};return e.protected!==void 0&&(f.protectedHeader=t),e.header!==void 0&&(f.unprotectedHeader=e.header),l?{...f,key:s}:f}async function zn(e,s,r){if(e instanceof Uint8Array&&(e=Fs.decode(e)),typeof e!="string")throw new V("Compact JWS must be a string or Uint8Array");const{0:t,1:a,2:n,length:o}=e.split(".");if(o!==3)throw new V("Invalid Compact JWS");const i=await Yn({payload:a,protected:t,signature:n},s,r),c={payload:i.payload,protectedHeader:i.protectedHeader};return typeof s=="function"?{...c,key:i.key}:c}const Gn=e=>Math.floor(e.getTime()/1e3),ht=60,gt=ht*60,ir=gt*24,Xn=ir*7,Qn=ir*365.25,Zn=/^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i,gr=e=>{const s=Zn.exec(e);if(!s||s[4]&&s[1])throw new TypeError("Invalid time period format");const r=parseFloat(s[2]),t=s[3].toLowerCase();let a;switch(t){case"sec":case"secs":case"second":case"seconds":case"s":a=Math.round(r);break;case"minute":case"minutes":case"min":case"mins":case"m":a=Math.round(r*ht);break;case"hour":case"hours":case"hr":case"hrs":case"h":a=Math.round(r*gt);break;case"day":case"days":case"d":a=Math.round(r*ir);break;case"week":case"weeks":case"w":a=Math.round(r*Xn);break;default:a=Math.round(r*Qn);break}return s[1]==="-"||s[4]==="ago"?-a:a},yr=e=>e.toLowerCase().replace(/^application\//,""),eo=(e,s)=>typeof e=="string"?s.includes(e):Array.isArray(e)?s.some(Set.prototype.has.bind(new Set(e))):!1,so=(e,s,r={})=>{let t;try{t=JSON.parse(Fs.decode(s))}catch{}if(!Ie(t))throw new ys("JWT Claims Set must be a top-level JSON object");const{typ:a}=r;if(a&&(typeof e.typ!="string"||yr(e.typ)!==yr(a)))throw new ie('unexpected "typ" JWT header value',t,"typ","check_failed");const{requiredClaims:n=[],issuer:o,subject:i,audience:c,maxTokenAge:l}=r,u=[...n];l!==void 0&&u.push("iat"),c!==void 0&&u.push("aud"),i!==void 0&&u.push("sub"),o!==void 0&&u.push("iss");for(const f of new Set(u.reverse()))if(!(f in t))throw new ie(`missing required "${f}" claim`,t,f,"missing");if(o&&!(Array.isArray(o)?o:[o]).includes(t.iss))throw new ie('unexpected "iss" claim value',t,"iss","check_failed");if(i&&t.sub!==i)throw new ie('unexpected "sub" claim value',t,"sub","check_failed");if(c&&!eo(t.aud,typeof c=="string"?[c]:c))throw new ie('unexpected "aud" claim value',t,"aud","check_failed");let d;switch(typeof r.clockTolerance){case"string":d=gr(r.clockTolerance);break;case"number":d=r.clockTolerance;break;case"undefined":d=0;break;default:throw new TypeError("Invalid clockTolerance option type")}const{currentDate:m}=r,_=Gn(m||new Date);if((t.iat!==void 0||l)&&typeof t.iat!="number")throw new ie('"iat" claim must be a number',t,"iat","invalid");if(t.nbf!==void 0){if(typeof t.nbf!="number")throw new ie('"nbf" claim must be a number',t,"nbf","invalid");if(t.nbf>_+d)throw new ie('"nbf" claim timestamp check failed',t,"nbf","check_failed")}if(t.exp!==void 0){if(typeof t.exp!="number")throw new ie('"exp" claim must be a number',t,"exp","invalid");if(t.exp<=_-d)throw new ds('"exp" claim timestamp check failed',t,"exp","check_failed")}if(l){const f=_-t.iat,h=typeof l=="number"?l:gr(l);if(f-d>h)throw new ds('"iat" claim timestamp check failed (too far in the past)',t,"iat","check_failed");if(f<0-d)throw new ie('"iat" claim timestamp check failed (it should be in the past)',t,"iat","check_failed")}return t};async function ro(e,s,r){var o;const t=await zn(e,s,r);if((o=t.protectedHeader.crit)!=null&&o.includes("b64")&&t.protectedHeader.b64===!1)throw new ys("JWTs MUST NOT use unencoded payload");const n={payload:so(t.protectedHeader,t.payload,r),protectedHeader:t.protectedHeader};return typeof s=="function"?{...n,key:t.key}:n}function to(e){switch(typeof e=="string"&&e.slice(0,2)){case"RS":case"PS":return"RSA";case"ES":return"EC";case"Ed":return"OKP";default:throw new me('Unsupported "alg" value for a JSON Web Key Set')}}function ao(e){return e&&typeof e=="object"&&Array.isArray(e.keys)&&e.keys.every(no)}function no(e){return Ie(e)}function yt(e){return typeof structuredClone=="function"?structuredClone(e):JSON.parse(JSON.stringify(e))}class oo{constructor(s){if(this._cached=new WeakMap,!ao(s))throw new nr("JSON Web Key Set malformed");this._jwks=yt(s)}async getKey(s,r){const{alg:t,kid:a}={...s,...r==null?void 0:r.header},n=to(t),o=this._jwks.keys.filter(l=>{let u=n===l.kty;if(u&&typeof a=="string"&&(u=a===l.kid),u&&typeof l.alg=="string"&&(u=t===l.alg),u&&typeof l.use=="string"&&(u=l.use==="sig"),u&&Array.isArray(l.key_ops)&&(u=l.key_ops.includes("verify")),u)switch(t){case"ES256":u=l.crv==="P-256";break;case"ES256K":u=l.crv==="secp256k1";break;case"ES384":u=l.crv==="P-384";break;case"ES512":u=l.crv==="P-521";break;case"Ed25519":u=l.crv==="Ed25519";break;case"EdDSA":u=l.crv==="Ed25519"||l.crv==="Ed448";break}return u}),{0:i,length:c}=o;if(c===0)throw new or;if(c!==1){const l=new ot,{_cached:u}=this;throw l[Symbol.asyncIterator]=async function*(){for(const d of o)try{yield await br(u,d,t)}catch{}},l}return br(this._cached,i,t)}}async function br(e,s,r){const t=e.get(s)||e.set(s,{}).get(s);if(t[r]===void 0){const a=await ft({...s,ext:!0},r);if(a instanceof Uint8Array||a.type!=="public")throw new nr("JSON Web Key Set members must be public keys");t[r]=a}return t[r]}function wr(e){const s=new oo(e),r=async(t,a)=>s.getKey(t,a);return Object.defineProperties(r,{jwks:{value:()=>yt(s._jwks),enumerable:!0,configurable:!1,writable:!1}}),r}const io=async(e,s,r)=>{let t,a,n=!1;typeof AbortController=="function"&&(t=new AbortController,a=setTimeout(()=>{n=!0,t.abort()},s));const o=await fetch(e.href,{signal:t?t.signal:void 0,redirect:"manual",headers:r.headers}).catch(i=>{throw n?new it:i});if(a!==void 0&&clearTimeout(a),o.status!==200)throw new X("Expected 200 OK from the JSON Web Key Set HTTP response");try{return await o.json()}catch{throw new X("Failed to parse the JSON Web Key Set HTTP response as JSON")}};function co(){return typeof WebSocketPair<"u"||typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"||typeof EdgeRuntime<"u"&&EdgeRuntime==="vercel"}let Gs;var Rs,$r;(typeof navigator>"u"||!(($r=(Rs=navigator.userAgent)==null?void 0:Rs.startsWith)!=null&&$r.call(Rs,"Mozilla/5.0 ")))&&(Gs="jose/v5.10.0");const Js=Symbol();function lo(e,s){return!(typeof e!="object"||e===null||!("uat"in e)||typeof e.uat!="number"||Date.now()-e.uat>=s||!("jwks"in e)||!Ie(e.jwks)||!Array.isArray(e.jwks.keys)||!Array.prototype.every.call(e.jwks.keys,Ie))}class uo{constructor(s,r){if(!(s instanceof URL))throw new TypeError("url must be an instance of URL");this._url=new URL(s.href),this._options={agent:r==null?void 0:r.agent,headers:r==null?void 0:r.headers},this._timeoutDuration=typeof(r==null?void 0:r.timeoutDuration)=="number"?r==null?void 0:r.timeoutDuration:5e3,this._cooldownDuration=typeof(r==null?void 0:r.cooldownDuration)=="number"?r==null?void 0:r.cooldownDuration:3e4,this._cacheMaxAge=typeof(r==null?void 0:r.cacheMaxAge)=="number"?r==null?void 0:r.cacheMaxAge:6e5,(r==null?void 0:r[Js])!==void 0&&(this._cache=r==null?void 0:r[Js],lo(r==null?void 0:r[Js],this._cacheMaxAge)&&(this._jwksTimestamp=this._cache.uat,this._local=wr(this._cache.jwks)))}coolingDown(){return typeof this._jwksTimestamp=="number"?Date.now()<this._jwksTimestamp+this._cooldownDuration:!1}fresh(){return typeof this._jwksTimestamp=="number"?Date.now()<this._jwksTimestamp+this._cacheMaxAge:!1}async getKey(s,r){(!this._local||!this.fresh())&&await this.reload();try{return await this._local(s,r)}catch(t){if(t instanceof or&&this.coolingDown()===!1)return await this.reload(),this._local(s,r);throw t}}async reload(){this._pendingFetch&&co()&&(this._pendingFetch=void 0);const s=new Headers(this._options.headers);Gs&&!s.has("User-Agent")&&(s.set("User-Agent",Gs),this._options.headers=Object.fromEntries(s.entries())),this._pendingFetch||(this._pendingFetch=io(this._url,this._timeoutDuration,this._options).then(r=>{this._local=wr(r),this._cache&&(this._cache.uat=Date.now(),this._cache.jwks=r),this._jwksTimestamp=Date.now(),this._pendingFetch=void 0}).catch(r=>{throw this._pendingFetch=void 0,r})),await this._pendingFetch}}function po(e,s){const r=new uo(e,s),t=async(a,n)=>r.getKey(a,n);return Object.defineProperties(t,{coolingDown:{get:()=>r.coolingDown(),enumerable:!0,configurable:!1},fresh:{get:()=>r.fresh(),enumerable:!0,configurable:!1},reload:{value:()=>r.reload(),enumerable:!0,configurable:!1,writable:!1},reloading:{get:()=>!!r._pendingFetch,enumerable:!0,configurable:!1},jwks:{value:()=>{var a;return(a=r._local)==null?void 0:a.jwks()},enumerable:!0,configurable:!1,writable:!1}}),t}const mo="https://www.googleapis.com/service_accounts/v1/jwk/securetoken@system.gserviceaccount.com";let Ds=null;function _o(){return Ds||(Ds=po(new URL(mo)),console.log("[Firebase Token] ✅ JWKS cache initialized")),Ds}function fo(){Ds=null,console.warn("[Firebase Token] 🔄 JWKS cache invalidated")}async function bt(e,s){try{console.log("[Firebase Token] 🔍 Starting verification"),console.log("[Firebase Token] 📊 Token length:",e.length),console.log("[Firebase Token] 🏢 Project ID:",s);const r=_o(),{payload:t}=await ro(e,r,{issuer:`https://securetoken.google.com/${s}`,audience:s,algorithms:["RS256"]});if(console.log("[Firebase Token] ✅ JWT signature verified"),!t.sub)throw new Error("Token missing subject (uid)");const a=Math.floor(Date.now()/1e3);if(t.exp&&t.exp<a)throw console.error("[Firebase Token] ❌ Token expired:",{exp:t.exp,now:a,expiredBy:a-t.exp}),new ds("Token has expired");if(t.iat&&t.iat>a+300)throw console.error("[Firebase Token] ❌ Token issued in future:",{iat:t.iat,now:a,diff:t.iat-a}),new Error("Token not yet valid (issued in future)");console.log("[Firebase Token] ✅ Time validation passed:",{iat:t.iat,exp:t.exp,now:a});const n=t.sub,o=typeof t.role=="string"?t.role:void 0,i=typeof t.userId=="number"?t.userId:void 0,c=typeof t.userName=="string"?t.userName:void 0,l=typeof t.email=="string"?t.email:void 0;return console.log("[Firebase Token] ✅ Token verified successfully"),console.log("[Firebase Token] 👤 User:",{uid:n,role:o,userId:i,userName:c,email:l?"exists":"none"}),{...t,uid:n,role:o,userId:i,userName:c,email:l}}catch(r){throw console.error("[Firebase Token] ❌ Verification failed:",{error:r instanceof Error?r.message:"Unknown",name:r instanceof Error?r.name:void 0,tokenPreview:e.substring(0,30)+"..."}),r instanceof ys&&r.message.includes("kid")&&(fo(),console.warn("[Firebase Token] 🔄 JWKS cache invalidated → retry possible")),r}}function wt(e){if(e instanceof ds)return{code:"TOKEN_EXPIRED",message:"Token has expired. Please login again."};if(e instanceof ys){if(e.message.includes("issuer"))return{code:"INVALID_ISSUER",message:"Token issuer mismatch"};if(e.message.includes("audience"))return{code:"INVALID_AUDIENCE",message:"Token audience mismatch"};if(e.message.includes("signature"))return{code:"INVALID_SIGNATURE",message:"Invalid token signature"};if(e.message.includes("kid"))return{code:"INVALID_KID",message:"Public key not found for token"}}return e instanceof Error&&e.message.includes("not yet valid")?{code:"TOKEN_NOT_YET_VALID",message:"Token issued in the future"}:{code:"VERIFICATION_FAILED",message:e instanceof Error?e.message:"Token verification failed"}}const _e=new Map;let Y={hits:0,misses:0,writes:0,evictions:0};function ve(e){const s=_e.get(e);return s?s.expires<Date.now()?(_e.delete(e),Y.evictions++,Y.misses++,null):(Y.hits++,s.data):(Y.misses++,null)}function se(e,s,r){const t=Date.now()+r*1e3;if(_e.set(e,{data:s,expires:t}),Y.writes++,_e.size>1e3){const a=_e.keys().next().value;a&&(_e.delete(a),Y.evictions++)}}function Eo(e){let s=0;for(const r of _e.keys())r.includes(e)&&(_e.delete(r),s++);return s}async function ts(e,s){const r=Array.isArray(s)?s:[s];for(const t of r){const a=Eo(t);a>0&&console.log(`[Cache] 🧹 메모리 캐시 삭제: ${t} (${a}개)`);try{await e.CACHE_KV.delete(t),console.log(`[Cache] 🧹 KV 캐시 삭제: ${t}`)}catch(n){console.error(`[Cache] ❌ KV 캐시 삭제 실패: ${t}`,n)}}}const as={LIVE_STREAMS:["streams:live","streams:all","streams:scheduled","live_streams:live:all:20:0","live_streams:"],PRODUCTS:["products:","featured_products"],CART:e=>[`cart:${e}`],ORDERS:e=>[`orders:${e}`],ALL:["streams:","live_streams:","products:","cart:","orders:"]};function ho(e){const s=e.status>=500?"error":e.status>=400?"warn":"info";console.log(JSON.stringify({timestamp:new Date().toISOString(),level:s,message:"API Request",context:e,duration:e.duration}))}function go(e){return{name:"tosspayments",async confirmPayment(s){try{const r=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify({paymentKey:s.paymentKey,orderId:s.orderId,amount:s.amount})}),t=await r.json();if(!r.ok)return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:t.message||"결제 승인 실패",rawData:t};let a={};t.card&&(a={cardCompany:t.card.company,cardNumber:t.card.number,installmentMonths:t.card.installmentPlanMonths||0});let n={};return t.virtualAccount&&(n={virtualAccountBank:t.virtualAccount.bankCode,virtualAccountNumber:t.virtualAccount.accountNumber,virtualAccountHolder:t.virtualAccount.customerName,virtualAccountDueDate:t.virtualAccount.dueDate}),{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,transactionId:t.transactionKey,...a,...n,rawData:t}}catch(r){return{success:!1,orderId:s.orderId,paymentKey:s.paymentKey,method:"",totalAmount:s.amount,status:"FAILED",approvedAt:"",error:r.message,rawData:null}}},async cancelPayment(s){try{const r={cancelReason:s.cancelReason};s.cancelAmount&&(r.cancelAmount=s.cancelAmount);const t=await fetch(`https://api.tosspayments.com/v1/payments/${s.paymentKey}/cancel`,{method:"POST",headers:{Authorization:`Basic ${btoa(e+":")}`,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(r)}),a=await t.json();return t.ok?{success:!0,canceledAt:a.canceledAt||new Date().toISOString(),rawData:a}:{success:!1,error:a.message||"취소 실패"}}catch(r){return{success:!1,error:r.message}}},async getPayment(s){try{const r=await fetch(`https://api.tosspayments.com/v1/payments/${s}`,{method:"GET",headers:{Authorization:`Basic ${btoa(e+":")}`,"TossPayments-API-Version":"2022-11-16"}}),t=await r.json();if(!r.ok)throw new Error(t.message);return{success:!0,orderId:t.orderId,paymentKey:t.paymentKey,method:t.method,totalAmount:t.totalAmount,status:t.status,approvedAt:t.approvedAt,rawData:t}}catch(r){throw r}}}}function yo(e,s){switch(e.toLowerCase()){case"tosspayments":return go(s);default:throw new Error(`Unknown payment provider: ${e}`)}}const p=new Zr;p.use("*",async(e,s)=>{if(e.req.url.includes("localhost")||e.req.url.includes("127.0.0.1"))try{Ea(e.env),ha(e.env)}catch(t){console.error("[ENV] Validation failed:",t)}await s()});async function bo(e){try{const s=e.req.header("Authorization");console.log("[Firebase Auth] 🔍 Authorization header:",s?`Bearer ${s.substring(7,50)}...`:"MISSING");const r=(s==null?void 0:s.replace("Bearer ",""))||"";if(!r)return console.warn("[Firebase Auth] ❌ No token provided"),null;console.log("[Firebase Auth] 🔑 Token length:",r.length),console.log("[Firebase Auth] 🔑 Token preview:",r.substring(0,50)+"...");try{const t=r.split(".");if(t.length===3){const a=t[1],n=atob(a.replace(/-/g,"+").replace(/_/g,"/")),o=JSON.parse(n);if(console.log("[Firebase Auth] 🔍 Token Payload (BEFORE verification):",{iss:o.iss,aud:o.aud,sub:o.sub,exp:o.exp,iat:o.iat}),o.iss&&o.iss.includes("iam.gserviceaccount.com"))return console.error("[Firebase Auth] 🚨🚨🚨 CUSTOM TOKEN DETECTED! 🚨🚨🚨"),console.error("[Firebase Auth] ❌ This is a Custom Token, not an ID Token!"),console.error("[Firebase Auth] ❌ Custom Token should be exchanged for ID Token on client!"),{userId:0,userType:"",errorDetails:{code:"CUSTOM_TOKEN_DETECTED",message:"Custom Token should be exchanged for ID Token on client",tokenInfo:{iss:o.iss,aud:o.aud,sub:o.sub}}}}}catch(t){console.warn("[Firebase Auth] ⚠️ Could not decode token payload (might be corrupted):",t)}try{console.log("[Firebase Auth] 🔐 Verifying token with project:",e.env.FIREBASE_PROJECT_ID||"urteam-live-commerce-5b284");const t=await bt(r,e.env.FIREBASE_PROJECT_ID||"urteam-live-commerce-5b284");if(console.log("[Firebase Auth] ✅ Firebase token verified!"),console.log("[Firebase Auth] 📋 Token payload:",{uid:t.uid,iss:t.iss,aud:t.aud,exp:t.exp,iat:t.iat}),t.userId){console.log("[Firebase Auth] 🎯 Using userId from Custom Claims:",t.userId);const o=await e.env.DB.prepare(`
      ...
      `).bind(t.uid).first();if(!a&&t.uid.startsWith("kakao_")){const o=t.uid.replace("kakao_","");if(console.warn("[Firebase Auth] firebase_uid not found, trying kakao_id fallback:",o),a=await e.env.DB.prepare(`
        ...
        `).bind(o).first(),a){console.log("[Firebase Auth] ✅ Found user via kakao_id fallback:",a.id);try{await e.env.DB.prepare(`
              UPDATE users SET firebase_uid = ? WHERE id = ?
            `).bind(t.uid,a.id).run(),console.log("[Firebase Auth] ✅ firebase_uid updated for existing user:",a.id)}catch(i){console.error("[Firebase Auth] ❌ firebase_uid update failed:",i)}}}if(!a)return console.warn("[Firebase Auth] User not found for UID:",t.uid),{userId:0,userType:"",errorDetails:{code:"USER_NOT_FOUND",message:"User not found in database",tokenInfo:{uid:t.uid}}};const n=t.role||"user";return console.log("[Firebase Auth] ✅ User authenticated:",{userId:a.id,userType:n,email:a.email,firebaseUID:t.uid}),{userId:a.id,userType:n,email:a.email,firebaseUID:t.uid}}catch(t){console.error("[Firebase Auth] Token verification failed:",t);const a=wt(t);return{userId:0,userType:"",errorDetails:{code:a.code,message:a.message,tokenInfo:{length:r.length,preview:r.substring(0,30)+"..."}}}}}catch(s){return console.error("[Firebase Auth Error]",s),null}}async function xe(e,s,r){if(!s)return null;const t=`session:${s}`;try{const a=ve(t);if(a)return a;const n=await e.get(t);if(!n)return null;const o=JSON.parse(n);if(o.expires_at&&Date.now()>o.expires_at)return r!=null&&r.executionCtx||await e.delete(t),null;const i={user_id:o.user_id,user_type:o.user_type||"user",created_at:o.created_at};return se(t,i,900),i}catch(a){return console.error("[Auth] Session lookup error:",a),null}}async function j(e,s){const r=e.req.header("Authorization");if(console.log("[requireAuth] 🔍 Header check:",r?"EXISTS":"MISSING"),!r)return e.json({success:!1,error:"Missing Authorization header - Firebase ID Token required",code:"NO_AUTH_HEADER",debug:{headers:Object.fromEntries(e.req.raw.headers.entries())}},401);const t=await bo(e);if(!t||t.userId===0){const a=(t==null?void 0:t.errorDetails)||{code:"AUTH_FAILED",message:"Token verification failed - unknown reason"};return e.json({success:!1,error:a.message,code:a.code,debug:{tokenProvided:!!r,tokenLength:(r==null?void 0:r.replace("Bearer ","").length)||0,...a.tokenInfo}},401)}e.set("user",{userId:t.userId,userType:t.userType,email:t.email,firebaseUID:t.firebaseUID}),e.set("userId",t.userId),e.set("userType",t.userType),e.set("email",t.email),e.set("firebaseUID",t.firebaseUID),await s()}async function wo(e,s){const r=e.get("userType"),t=e.get("userId");if(r!=="admin")return console.warn("[Security] Unauthorized admin access attempt:",{userId:t,userType:r}),e.json({success:!1,error:"관리자 권한이 필요합니다."},403);await s()}async function So(e,s){const r=e.get("userType"),t=e.get("userId");if(r!=="seller")return console.warn("[Security] Unauthorized seller access attempt:",{userId:t,userType:r}),e.json({success:!1,error:"판매자 권한이 필요합니다."},403);await s()}async function To(e){return async(s,r)=>{const t=s.get("userId");if(s.get("userType")==="admin"){await r();return}const n=s.req.param("userId");if(n&&n!==String(t))return console.warn("[Security] Unauthorized resource access attempt:",{resourceType:e,requestedUserId:n,actualUserId:t}),s.json({success:!1,error:"본인의 정보만 조회할 수 있습니다."},403);await r()}}async function Ro(e,s){try{const r=ve(s);if(r!==null)return r;const t=await e.get(s);if(t){const a=JSON.parse(t);return se(s,a,300),a}return null}catch(r){return console.error("[Cache] Read error:",r),null}}async function ps(e,s,r,t=60,a=!1){try{se(s,r,t),a?(await e.put(s,JSON.stringify(r),{expirationTtl:t}),console.log(`[Cache] ✅ Saved to both Memory + KV: ${s}`)):console.log(`[Cache] ✅ Saved to Memory only (KV Write skipped): ${s}`)}catch(n){console.error("[Cache] Write error:",n)}}async function cr(e,...s){try{await Promise.all(s.map(r=>e.delete(r)))}catch(r){console.error("[Cache] Delete error:",r)}}async function bs(e,s,r,t,a,n,o){try{await e.prepare(`
      INSERT INTO notifications (user_id, user_type, type, title, message, link)
      VALUES (?, ?, ?, ?, ?, ?)
    `).bind(s,r,t,a,n,o||null).run(),console.log(`[Notification] Created for ${r} ${s}: ${a}`)}catch(i){console.error("[Notification] Create error:",i)}}async function Io(e,s,r,t,a){await bs(e,s,"seller","new_order","🛒 신규 주문이 접수되었습니다",`${t}님의 주문 (${r}) - ${vo(a)}`,"/seller/orders")}async function St(e,s,r,t,a,n){let o="",i="";switch(t){case"preparing":o="📦 상품 준비 중",i=`주문번호 ${r}의 상품을 준비하고 있습니다`;break;case"shipping":o="🚚 배송이 시작되었습니다",i=`주문번호 ${r}가 배송 중입니다`,a&&n&&(i+=` (${a}: ${n})`);break;case"delivered":o="✅ 배송 완료",i=`주문번호 ${r}가 배송 완료되었습니다`;break;default:return}await bs(e,s,"user","shipping_status",o,i,"/my-orders")}async function Tt(e,s,r,t,a){await bs(e,s,"seller","low_stock","⚠️ 재고 부족 알림",`${r}의 재고가 ${t}개로 부족합니다 (기준: ${a}개)`,"/seller/products")}function vo(e){return new Intl.NumberFormat("ko-KR",{style:"currency",currency:"KRW"}).format(e)}async function Ao(e,s,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const t=await fetch("https://www.googleapis.com/youtube/v3/liveBroadcasts?part=snippet,status,contentDetails",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:s,description:r,scheduledStartTime:new Date().toISOString()},status:{privacyStatus:"public",selfDeclaredMadeForKids:!1},contentDetails:{enableAutoStart:!0,enableAutoStop:!0}})});if(!t.ok){const d=await t.text();throw new Error(`YouTube Broadcast 생성 실패: ${d}`)}const n=(await t.json()).id,o=await fetch("https://www.googleapis.com/youtube/v3/liveStreams?part=snippet,cdn",{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`,"Content-Type":"application/json"},body:JSON.stringify({snippet:{title:`${s} - Stream`},cdn:{frameRate:"variable",ingestionType:"rtmp",resolution:"variable"}})});if(!o.ok){const d=await o.text();throw new Error(`YouTube Stream 생성 실패: ${d}`)}const i=await o.json(),c=i.id,l=i.cdn.ingestionInfo.streamName,u=i.cdn.ingestionInfo.ingestionAddress;return await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/bind?id=${n}&streamId=${c}&part=snippet`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}}),{broadcastId:n,streamId:c,streamKey:l,streamUrl:u}}catch(t){throw console.error("[YouTube API] Live broadcast creation failed:",t),t}}async function Do(e,s){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{const r=await fetch(`https://www.googleapis.com/youtube/v3/liveBroadcasts/transition?broadcastStatus=complete&id=${s}&part=status`,{method:"POST",headers:{Authorization:`Bearer ${e.accessToken}`}});if(!r.ok){const t=await r.text();throw new Error(`YouTube 방송 종료 실패: ${t}`)}}catch(r){throw console.error("[YouTube API] Live broadcast end failed:",r),r}}async function Oo(e,s,r){if(!e.accessToken)throw new Error("YouTube OAuth Access Token이 필요합니다");try{let t=`https://www.googleapis.com/youtube/v3/liveChat/messages?liveChatId=${s}&part=snippet,authorDetails`;r&&(t+=`&pageToken=${r}`);const a=await fetch(t,{headers:{Authorization:`Bearer ${e.accessToken}`}});if(!a.ok){const o=await a.text();throw new Error(`YouTube 채팅 메시지 가져오기 실패: ${o}`)}const n=await a.json();return{messages:n.items||[],nextPageToken:n.nextPageToken,pollingIntervalMillis:n.pollingIntervalMillis||5e3}}catch(t){throw console.error("[YouTube API] Get chat messages failed:",t),t}}async function ko(e,s){if(!e.apiKey&&!e.accessToken)throw new Error("YouTube API Key 또는 Access Token이 필요합니다");try{const r=e.accessToken?{Authorization:`Bearer ${e.accessToken}`}:{},t=e.accessToken?`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}`:`https://www.googleapis.com/youtube/v3/videos?part=statistics,liveStreamingDetails&id=${s}&key=${e.apiKey}`,a=await fetch(t,{headers:r});if(!a.ok){const l=await a.text();throw new Error(`YouTube 통계 가져오기 실패: ${l}`)}const n=await a.json();if(!n.items||n.items.length===0)throw new Error("Video not found");const o=n.items[0],i=o.statistics,c=o.liveStreamingDetails;return{viewCount:parseInt(i.viewCount||"0"),likeCount:parseInt(i.likeCount||"0"),commentCount:parseInt(i.commentCount||"0"),concurrentViewers:c!=null&&c.concurrentViewers?parseInt(c.concurrentViewers):void 0}}catch(r){throw console.error("[YouTube API] Get live stats failed:",r),r}}function Rt(e){try{if(!/^https?:\/\//.test(e)&&/^[\w-]{11}$/.test(e))return e;const s=new URL(e);if(s.hostname.includes("youtube.com")){const r=s.searchParams.get("v");if(r)return r;const t=s.pathname.match(/\/(embed|live|shorts)\/([a-zA-Z0-9_-]{11})/);if(t)return t[2]}if(s.hostname==="youtu.be"){const r=s.pathname.slice(1).split("?")[0];if(r&&r.length===11)return r}return null}catch{return null}}function It(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const r=s.pathname.match(/\/video\/(\d+)/);if(r)return r[1];const t=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(t)return t[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}function Co(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){if(s.pathname.includes("/live"))return"live";if(s.pathname.includes("/video/"))return"video"}return null}catch{return null}}function vt(e){try{const s=new URL(e);if(s.hostname.includes("tiktok.com")){const r=s.pathname.match(/\/@([a-zA-Z0-9_.]+)/);if(r)return r[1]}return s.hostname.includes("vm.tiktok.com")||s.hostname.includes("vt.tiktok.com")?s.pathname.slice(1):null}catch{return null}}p.use("*",async(e,s)=>{await s(),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://t1.kakaocdn.net https://developers.kakao.com https://js.tosspayments.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net; img-src 'self' data: https: blob:; font-src 'self' data: https://cdn.jsdelivr.net; connect-src 'self' https://api.tosspayments.com https://kauth.kakao.com https://kapi.kakao.com https://www.youtube.com; frame-src 'self' https://www.youtube.com https://youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';");const r=new URL(e.req.url);r.hostname!=="localhost"&&r.protocol==="https:"&&e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("X-Frame-Options","SAMEORIGIN"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});p.use("/api/*",S());p.use($e(Ue.auth));p.use($e(Ue.alimtalk));p.use($e(Ue.order));p.use($e(Ue.refund));p.use($e(Ue.cart));p.use($e(Ue.upload));p.use("/api/*",$e(Ue.api));p.use("*",async(e,s)=>{await s(),e.header("Strict-Transport-Security","max-age=31536000; includeSubDomains; preload"),e.header("Content-Security-Policy","default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://www.youtube.com https://s.ytimg.com; style-src 'self' 'unsafe-inline' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' https://cdn.jsdelivr.net https://fonts.gstatic.com; connect-src 'self' https:; frame-src 'self' https://www.youtube.com; media-src 'self' https:; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'none';"),e.header("X-Frame-Options","DENY"),e.header("X-Content-Type-Options","nosniff"),e.header("X-XSS-Protection","1; mode=block"),e.header("Referrer-Policy","strict-origin-when-cross-origin"),e.header("Permissions-Policy","geolocation=(), microphone=(), camera=(), payment=(self), usb=()")});p.use("/api/*",async(e,s)=>{const r=Date.now(),t=e.req.method,a=e.req.path;await s();const n=Date.now()-r,o=e.res.status,i={method:t,path:a,status:o,duration:n},c=e.get("userId");c&&(i.userId=c),ho(i)});p.use("/static/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});p.use("/images/*",async(e,s)=>{await s(),e.header("Cache-Control","public, max-age=31536000, immutable"),e.header("CDN-Cache-Control","public, max-age=31536000")});p.use("/api/admin*",async(e,s)=>{if(e.req.path==="/api/admin/login")return s();const r=await j(e,()=>Promise.resolve());if(r)return r;const t=await wo(e,()=>Promise.resolve());return t||s()});p.use("/api/seller*",async(e,s)=>{if(e.req.path==="/api/seller/register")return s();const r=await j(e,()=>Promise.resolve());if(r)return r;const t=await So(e,()=>Promise.resolve());return t||s()});async function ns(e,s){const r=await e.get(`session:${s}`);if(!r)return null;const t=JSON.parse(r);return t.expires_at&&Date.now()>t.expires_at?(await e.delete(`session:${s}`),null):{session_token:s,[`${t.user_type}_id`]:t.user_id,user_type:t.user_type,...t.userData}}p.post("/api/auth/user/register",S(),Fa(Wa),async e=>{const{DB:s}=e.env;try{const{email:r,password:t,name:a,phone:n}=e.get("validatedData"),o=`placeholder_hash_for_${t}`;try{const c=(await s.prepare(`
    ...
    `).bind(t).first();if(!n)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(n.password_hash&&n.password_hash.includes(`placeholder_hash_for_${a}`)||n.password&&n.password===a))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);await s.prepare("UPDATE users SET last_login_at = datetime('now') WHERE id = ?").bind(n.id).run();const i=crypto.randomUUID(),c=Date.now()+720*60*60*1e3;return await r.put(`session:${i}`,JSON.stringify({user_id:n.id,user_type:"user",expires_at:c,created_at:Date.now()}),{expirationTtl:720*60*60}),console.log("[User Login] Session created in SESSION_KV for user:",n.id),e.json({success:!0,data:{session_token:i,user:{id:n.id,email:n.email,name:n.name,phone:n.phone,profile_image:n.profile_image}}})}catch(t){return console.error("[User Login] Error:",t),e.json({success:!1,error:t.message||"로그인 중 오류가 발생했습니다"},500)}});p.post("/api/auth/login",S(),async e=>e.json({success:!1,error:"This endpoint is deprecated. Please use Firebase Authentication.",message:"Admin/Seller login should use /api/admin/login or /api/seller/login with Firebase Auth",code:"DEPRECATED_ENDPOINT"},410));p.post("/api/auth/logout",S(),async e=>{const{DB:s}=e.env;try{const r=e.req.header("X-Session-Token");return r&&await e.env.SESSION_KV.delete(`session:${r}`),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/auth/me",S(),j,async e=>{const{DB:s}=e.env,{userId:r,email:t,firebaseUID:a}=e.get("user");try{return console.log("[GET /api/auth/me] User info:",{userId:r,email:t,firebaseUID:a}),e.json({success:!0,user:{id:r,email:t,firebaseUID:a}})}catch(n){return console.error("[GET /api/auth/me] Error:",n),e.json({success:!1,error:n.message},500)}});p.post("/api/auth/email/register",S(),async e=>{var r,t,a;const{DB:s}=e.env;try{const{email:n,password:o,name:i}=await e.req.json();if(!n||!o||!i)return e.json({success:!1,error:"Email, password, and name are required"},400);console.log("[Email Register] Registering new user:",n);const l=`https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${e.env.FIREBASE_API_KEY||"AIzaSyBGfSLTtA6KTeTgOqfH3VCPmCHjHZvCc3U"}`,u=await fetch(l,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:n,password:o,returnSecureToken:!0})}),d=await u.json();if(!u.ok){console.error("[Email Register] Firebase signup failed:",d);let w="회원가입에 실패했습니다";return((r=d.error)==null?void 0:r.message)==="EMAIL_EXISTS"?w="이미 가입된 이메일입니다":((t=d.error)==null?void 0:t.message)==="WEAK_PASSWORD"?w="비밀번호가 너무 약합니다 (최소 6자)":(a=d.error)!=null&&a.message&&(w=d.error.message),e.json({success:!1,error:w},400)}const m=d.localId,_=d.idToken;console.log("[Email Register] ✅ Firebase user created:",m);try{await s.prepare(`
      ...
      FROM admins 
      WHERE email = ?
    `).bind(r).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(r==="admin@example.com"&&t==="admin123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${t}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);const i=Pe(e.env),c=`admin_${a.id}`;try{await i.auth.getUser(c).catch(async()=>{await i.auth.createUser({uid:c,email:a.email,displayName:a.name})}),await i.auth.setCustomUserClaims(c,{role:"admin",userId:a.id,userName:a.name||a.email,email:a.email});const l=await i.createCustomToken(c,{role:"admin",userId:a.id,userName:a.name||a.email,email:a.email});return await s.prepare(`
      ...
      FROM sellers 
      WHERE email = ?
    `).bind(r).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(r==="seller1@example.com"&&t==="seller123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${t}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);if(a.status!=="approved")return e.json({success:!1,error:"승인 대기 중인 계정입니다. 관리자 승인 후 로그인할 수 있습니다."},403);const i=Pe(e.env),c=`seller_${a.id}`;try{await i.auth.getUser(c).catch(async()=>{await i.auth.createUser({uid:c,email:a.email,displayName:a.name})}),await i.auth.setCustomUserClaims(c,{role:"seller",userId:a.id,userName:a.name||a.email,email:a.email});const l=await i.createCustomToken(c,{role:"seller",userId:a.id,userName:a.name||a.email,email:a.email});try{await s.prepare(`
    ...
    `).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:t.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/auth/kakao/sync/callback",async e=>{var r,t,a,n,o,i,c,l,u,d,m,_,f;const{DB:s}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!s);const h=e.req.query("code"),w=e.req.query("state")||"/",b=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!h,state:w,error:b}),b)return console.error("[Kakao Sync] OAuth error:",b),e.redirect(`${w}?error=kakao_oauth_${b}`);if(!h)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${w}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const g=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",T=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",g.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",T),console.log("[Kakao Sync] Step 1: Fetching access token...");const y=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:g,redirect_uri:T,code:h})});if(console.log("[Kakao Sync] Token response status:",y.status),console.log("[Kakao Sync] Token request details:",{client_id:g,redirect_uri:T,code_length:h.length,code_prefix:h.substring(0,20)}),!y.ok){const q=await y.text();return console.error("[Kakao Sync] Token request failed:",q),e.redirect(`${w}?error=token_request_failed&detail=${encodeURIComponent(q)}`)}const R=await y.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!R.access_token,error:R.error,errorDescription:R.error_description}),!R.access_token)return console.error("[Kakao Sync] Token error:",R),e.redirect(`${w}?error=token_failed&detail=${encodeURIComponent(R.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const L=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${R.access_token}`}});console.log("[Kakao Sync] User response status:",L.status);const k=await L.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!k.id,id:k.id,hasNickname:!!((r=k.properties)!=null&&r.nickname||(a=(t=k.kakao_account)==null?void 0:t.profile)!=null&&a.nickname)}),!k.id)return console.error("[Kakao Sync] Failed to get user info:",k),e.redirect(`${w}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const D=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${R.access_token}`}});console.log("[Kakao Sync] Terms response status:",D.status);let W=null;if(D.ok?(W=await D.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=W.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=W.allowed_service_terms)==null?void 0:o.map(q=>q.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!s)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${w}?error=db_not_available`);const U=k.id.toString(),M=((i=k.properties)==null?void 0:i.nickname)||((l=(c=k.kakao_account)==null?void 0:c.profile)==null?void 0:l.nickname)||"Kakao User",$=((u=k.kakao_account)==null?void 0:u.email)||"",Q=((d=k.properties)==null?void 0:d.profile_image)||((_=(m=k.kakao_account)==null?void 0:m.profile)==null?void 0:_.profile_image_url)||"",z=R.access_token,v=((f=W==null?void 0:W.allowed_service_terms)==null?void 0:f.map(q=>q.tag))||[],re=JSON.stringify(v);console.log("[Kakao Sync] User data:",{kakaoId:U,nickname:M,email:$?"exists":"none",serviceTerms:v});try{const q=await s.prepare(`
      ...
      `).bind(U).first();console.log("[Kakao Sync] Existing user check:",!!q);let P;q?(P=q.id,await s.prepare(`
          ...
          WHERE id = ?
        `).bind(M,$,Q,P).run(),console.log("[Kakao Sync] Updated user:",P)):(P=(await s.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results||[]})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/shipping-addresses/:userId",S(),j,async e=>{const{DB:s}=e.env,r=e.get("userId"),t=parseInt(e.req.param("userId"));try{if(t!==r)return e.json({success:!1,error:"본인의 배송지만 조회할 수 있습니다."},403);const a=await s.prepare(`
      SELECT 
        id, 
        user_id, 
        recipient_name, 
    ...
    `;t==="live"?o+=" WHERE ls.status = 'live'":t==="scheduled"?o+=" WHERE ls.status = 'scheduled'":t==="ended"?o+=" WHERE ls.status = 'ended'":o+=" WHERE ls.status IN ('live', 'scheduled')",o+=` ORDER BY 
      CASE ls.status 
        ...
        ELSE 3 
      END,
      ls.created_at DESC`;const i=await s.prepare(o).all();return await r.put(a,JSON.stringify(i.results),{expirationTtl:600}),e.json({success:!0,data:i.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=await s.prepare(`
      SELECT ls.*, 
      ...
      WHERE ls.id = ?
    `).bind(r).first();return t?e.json({success:!0,data:t}):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/live-streams",async e=>{const{DB:s}=e.env,{status:r,seller_id:t,limit:a="20",offset:n="0"}=e.req.query();try{const o=`live_streams:${r||"all"}:${t||"all"}:${a}:${n}`,i=60,c=ve(o);if(c)return console.log("[LiveStreams] ⚡ 메모리 캐시 히트:",o),e.executionCtx.waitUntil((async()=>{try{console.log("[LiveStreams] 🔄 백그라운드 갱신 시작:",o);const u=await Sr(s,r,t,a,n);se(o,u,i),console.log("[LiveStreams] ✅ 백그라운드 갱신 완료:",o)}catch(u){console.error("[LiveStreams] ❌ 백그라운드 갱신 실패:",u)}})()),e.json({success:!0,data:c});console.log("[LiveStreams] 💾 DB 조회:",o);const l=await Sr(s,r,t,a,n);return se(o,l,i),e.json({success:!0,data:l})}catch(o){return console.error("[API] Live streams list error:",o),e.json({success:!1,error:`라이브 스트림 목록 조회 실패: ${o.message}`},500)}});async function Sr(e,s,r,t,a){let n=`
    SELECT ls.*, 
           s.display_name as seller_name
    FROM live_streams ls
    LEFT JOIN sellers s ON ls.seller_id = s.id
    WHERE 1=1
  `;const o=[];s&&(n+=" AND ls.status = ?",o.push(s)),r&&(n+=" AND ls.seller_id = ?",o.push(r)),n+=' ORDER BY CASE ls.status WHEN "active" THEN 1 WHEN "scheduled" THEN 2 ELSE 3 END, ls.created_at DESC',n+=" LIMIT ? OFFSET ?",o.push(parseInt(t),parseInt(a));const{results:i}=await e.prepare(n).bind(...o).all();return i}p.get("/api/live-streams/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=`live_stream:${r}`,a=30,n=ve(t);if(n)return console.log("[LiveStream] ⚡ 메모리 캐시 히트:",t),e.executionCtx.waitUntil((async()=>{try{console.log("[LiveStream] 🔄 백그라운드 갱신 시작:",t);const i=await Tr(s,r);i&&(se(t,i,a),console.log("[LiveStream] ✅ 백그라운드 갱신 완료:",t))}catch(i){console.error("[LiveStream] ❌ 백그라운드 갱신 실패:",i)}})()),e.json({success:!0,data:n});console.log("[LiveStream] 💾 DB 조회:",t);const o=await Tr(s,r);return o?(se(t,o,a),e.json({success:!0,data:o})):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});async function Tr(e,s){return await e.prepare(`
    SELECT ls.*, 
           p.id as current_product_id, p.name as product_name, p.price, p.original_price, 
           p.discount_rate, p.image_url, p.stock, p.category, p.description as product_description
    FROM live_streams ls
    LEFT JOIN products p ON ls.current_product_id = p.id
    WHERE ls.id = ?
  `).bind(s).first()}p.get("/api/products",rr(tr.products),async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.query("featured"),a=parseInt(e.req.query("limit")||"20"),n=parseInt(e.req.query("offset")||"0"),o=`products:list:${t||"all"}:${a}:${n}`,i=ve(o);if(i)return e.executionCtx.waitUntil((async()=>{try{const l=await Rr(s,t,a,n);se(o,l,3600),await ps(r,o,l,300,!1)}catch(l){console.error("[Cache Revalidate] Products error:",l)}})()),e.json({success:!0,data:i,cached:!0});const c=await Rr(s,t,a,n);return se(o,c,3600),await ps(r,o,c,300,!1),e.json({success:!0,data:c,cached:!1})}catch(t){return console.error("Products list error:",t),e.json({success:!1,error:t.message},500)}});async function Rr(e,s,r,t){let a;return s==="true"?a=`
      SELECT 
        p.id,
        p.name,
        p.description,
    ...
    `:a=`
      ...
      ORDER BY sold_count DESC, p.created_at DESC
      LIMIT ? OFFSET ?
    `,(await e.prepare(a).bind(r,t).all()).results||[]}p.get("/api/products/popular",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t="products:popular",a=ve(t);if(a)return e.executionCtx.waitUntil((async()=>{try{const o=await Ir(s);se(t,o,3600),await ps(r,t,o,600,!1)}catch(o){console.error("[Cache Revalidate] Popular products error:",o)}})()),e.json({success:!0,data:a,cached:!0});const n=await Ir(s);return se(t,n,3600),await ps(r,t,n,600,!1),e.json({success:!0,data:n,cached:!1})}catch(t){return console.error("Popular products error:",t),e.json({success:!1,error:t.message},500)}});async function Ir(e){return(await e.prepare(`
    SELECT 
      p.id,
      p.name,
      p.description,
    ...
    `).bind(t,t).all(),o=[...(a.results||[]).map(i=>({type:"product",text:i.name})),...(n.results||[]).map(i=>({type:"seller",text:i.display_name}))];return e.json({success:!0,data:{suggestions:o}})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/products/search",async e=>{const{DB:s}=e.env;try{const r=e.req.query("q")||"",t=parseInt(e.req.query("limit")||"20"),a=parseInt(e.req.query("offset")||"0");if(!r.trim())return e.json({success:!1,error:"Search query is required"},400);const n=r.trim(),o=`${n}*`;try{if(await s.prepare(`
      ...
      `).bind(c,c,c,c,c,t,a).all(),u=await s.prepare(`
        ...
        WHERE (p.name LIKE ? OR p.description LIKE ? OR p.category LIKE ?
               OR s.display_name LIKE ? OR s.username LIKE ?)
          AND p.is_active = 1
      `).bind(c,c,c,c,c).first();return e.json({success:!0,data:{products:l.results||[],total:(u==null?void 0:u.total)||0,query:r,limit:t,offset:a,searchMethod:"like"}})}}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/products/:id",async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=`product:detail:${r}`,a=ve(t);if(a)return e.executionCtx.waitUntil((async()=>{try{const o=await vr(s,r);se(t,o,1800)}catch(o){console.error("[Cache Revalidate] Product detail error:",o)}})()),e.json({success:!0,data:a,cached:!0});const n=await vr(s,r);return n?(se(t,n,1800),e.json({success:!0,data:n,cached:!1})):e.json({success:!1,error:"Product not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});async function vr(e,s){const r=await e.prepare(`
    SELECT 
      p.*,
  ...
  `).bind(s).first();if(!r)return null;const t=await e.prepare("SELECT id, product_id, option_type, option_value, price_adjustment, stock, created_at FROM product_options WHERE product_id = ?").bind(s).all();return{product:r,options:t.results}}p.get("/api/products/:id/stock",rr(tr.microCache),async e=>{const{DB:s}=e.env,r=e.req.param("id");try{const t=await s.prepare("SELECT id, name, stock FROM products WHERE id = ? AND is_active = 1").bind(r).first();return t?e.json({success:!0,data:{productId:t.id,productName:t.name,stock:t.stock,available:t.stock>0}}):e.json({success:!1,error:"Product not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/products",async e=>{const{DB:s}=e.env,r=e.req.param("streamId");try{const t=await s.prepare(`
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/cart",j,async e=>{const{DB:s}=e.env,r=e.get("userId");try{const t=await s.prepare(`
      SELECT 
        ci.*,
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:`장바구니 조회 실패: ${t.message}`},500)}});p.get("/api/cart/:userId",j,async e=>{const{DB:s}=e.env,r=e.get("userId"),t=e.req.param("userId");try{let a=await s.prepare("SELECT id FROM users WHERE id = ?").bind(r).first();if(!a)return e.json({success:!1,error:"사용자를 찾을 수 없습니다."},404);const n=a.id;if(t!==String(n))return e.json({success:!1,error:"본인의 장바구니만 조회할 수 있습니다."},403);const o=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
        p.image_url as image_url,
    ...
    `).bind(l,a,n||null,n||null).first();let m;if(d){const _=d.quantity+o;await s.prepare(`
      ...
      `).bind(_,i,d.id).run(),m=d.id}else m=(await s.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?)
      `).bind(l,a,n||null,o,i,c||null).run()).meta.last_row_id;return e.json({success:!0,data:{id:m,isUpdate:!!d}})}catch(r){return console.error("[API /api/cart POST] Error:",r),console.error("[API /api/cart POST] Error message:",r.message),console.error("[API /api/cart POST] Error stack:",r.stack),e.json({success:!1,error:"Failed to add to cart: "+(r.message||"Unknown error")},500)}});p.delete("/api/cart/:cartItemId",j,async e=>{const{DB:s}=e.env,r=e.req.param("cartItemId");try{return await s.prepare("DELETE FROM cart_items WHERE id = ?").bind(r).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/cart/clear/:userId",j,To("cart"),async e=>{const{DB:s}=e.env,r=e.req.param("userId");try{return await s.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(r).run(),e.json({success:!0,message:"장바구니가 비워졌습니다."})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/cart/:cartItemId",j,async e=>{const{DB:s}=e.env,r=e.req.param("cartItemId");try{const t=await e.req.json(),{quantity:a}=t;if(!a||a<1)return e.json({success:!1,error:"Invalid quantity"},400);const n=await s.prepare(`
      SELECT ci.product_id, p.stock
      FROM cart_items ci
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id = ?
    `).bind(r).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await s.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,r).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/orders",j,async e=>{const{DB:s}=e.env;try{const r=await e.req.json(),{userId:t,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:c,recipientName:l,recipientPhone:u,deliveryMemo:d,totalAmount:m,shippingFee:_,orderNumber:f,paymentKey:h,paymentMethod:w}=r;if(o&&o.length>0){const D=o.map(F=>F.productId),W=D.map(()=>"?").join(","),U=await s.prepare(`
        SELECT id, name, price, stock 
        FROM products 
        WHERE id IN (${W})
      `).bind(...D).all(),M=new Map(U.results.map(F=>[F.id,F])),$=[],Q=[];try{for(const F of o){const oe=M.get(F.productId);if(!oe)throw new Error(`상품을 찾을 수 없습니다 (ID: ${F.productId})`);if(oe.stock-(oe.reserved_stock||0)<F.quantity)throw new Error(`죄송합니다. 방금 상품이 모두 판매되었습니다. (${oe.name})`);if((await s.prepare(`
            UPDATE products 
            SET reserved_stock = reserved_stock + ?
            WHERE id = ? AND (stock - reserved_stock) >= ?
          `).bind(F.quantity,F.productId,F.quantity).run()).meta.changes===0)throw new Error(`죄송합니다. 방금 상품이 모두 판매되었습니다. (${oe.name})`);console.log(`[Stock] ✅ 재고 예약 성공: ${oe.name} (${F.quantity}개)`),Q.push({product_id:F.productId,quantity:F.quantity}),$.push({product_id:F.productId,option_id:F.optionId||null,quantity:F.quantity,price:F.price,product_name:oe.name,product_stock:oe.stock})}}catch(F){if(console.error("[Stock] ❌ 재고 예약 실패:",F.message),Q.length>0){console.log(`[Stock] 🔄 ${Q.length}개 상품 예약 롤백 시작...`);for(const oe of Q)await s.prepare(`
              UPDATE products 
              SET reserved_stock = reserved_stock - ?
              WHERE id = ?
            `).bind(oe.quantity,oe.product_id).run();console.log("[Stock] ✅ 예약 롤백 완료")}return e.json({success:!1,error:F.message},400)}const z=new Date,v=z.getFullYear().toString().slice(-2),re=(z.getMonth()+1).toString().padStart(2,"0"),q=z.getDate().toString().padStart(2,"0"),P=`${v}${re}${q}`,H=Math.random().toString(36).substring(2,7).toUpperCase(),te=f||`ORD-${P}-${H}`,$s=c?`${i} ${c}`:i,Ae=new Date(Date.now()+600*1e3).toISOString(),ws=(await s.prepare(`
        INSERT INTO orders (
      ...
      `).bind(te,t||null,m||0,"pending","pending",$s||null,l||null,u||null,d||null,h||null,Ae).run()).meta.last_row_id;for(const F of $)await s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(ws,F.product_id,F.option_id,F.quantity,F.price,F.product_name).run();return console.log(`[Order] ✅ 주문 생성 완료: ${te} (예약 만료: ${Ae})`),e.json({success:!0,data:{orderId:ws,orderNumber:te,totalAmount:m}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const b=a.map(()=>"?").join(","),g=await s.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
    ...
    `).bind(y,t,T,n.address,n.name,n.phone).run()).meta.last_row_id,k=[];for(const D of g.results){let W=!1,U="";for(let M=0;M<3;M++){const $=await s.prepare(`
          SELECT stock, version FROM products WHERE id = ?
        `).bind(D.product_id).first();if(!$){U=`상품을 찾을 수 없습니다: ${D.product_name}`;break}const Q=$.stock,z=$.version;if(Q<D.quantity){U=`재고 부족: ${D.product_name} (남은 재고: ${Q}개)`;break}if((await s.prepare(`
          UPDATE products 
          SET stock = stock - ?, 
              version = version + 1,
              updated_at = datetime('now')
          WHERE id = ? 
            ...
            AND stock >= ?
            AND is_active = 1
        `).bind(D.quantity,D.product_id,z,D.quantity).run()).meta.changes>0){W=!0,console.log(`[재고] ✅ 재고 차감 성공: ${D.product_name} (수량: ${D.quantity}, 버전: ${z} → ${z+1})`);break}console.warn(`[재고] ⚠️ 버전 충돌 감지 (시도 ${M+1}/3): ${D.product_name}`),M<2?await new Promise(re=>setTimeout(re,50*(M+1))):U="주문 처리 중 오류 발생. 잠시 후 다시 시도해주세요. (동시 주문 처리 중)"}if(!W)return e.json({success:!1,error:U||"주문 처리 중 오류가 발생했습니다."},U.includes("재고 부족")?400:409);k.push(s.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(L,D.product_id,D.option_id,D.quantity,D.price_snapshot,D.product_name))}k.push(s.prepare(`DELETE FROM cart_items WHERE id IN (${b})`).bind(...a)),await s.batch(k);try{const D=g.results.map(M=>M.product_id),W=D.map(()=>"?").join(","),U=await s.prepare(`
        SELECT DISTINCT seller_id 
        FROM products 
        WHERE id IN (${W}) AND seller_id IS NOT NULL
      `).bind(...D).all();for(const M of U.results){const $=M.seller_id;await Io(s,$,y,buyerName||shippingName||"고객",T)}}catch(D){console.error("[Order] Notification error:",D)}return e.json({success:!0,data:{orderId:L,orderNumber:y,totalAmount:T}})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/streams/:streamId/current-product",async e=>{const{DB:s,LIVE_CACHE:r}=e.env,t=e.req.param("streamId");try{const a=`current-product:${t}`,n=await rt(r,a,3);if(n)return e.json({success:!0,data:n});const o=await s.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(t).first();if(!o||!o.current_product_id)return await ks(r,a,null,3),e.json({success:!0,data:null});const i=await s.prepare(`
      SELECT id, name, description, price, original_price, discount_rate,
             image_url, stock, category, seller_id, is_active
      FROM products 
      WHERE id = ?
    `).bind(o.current_product_id).first(),c=await s.prepare("SELECT id, product_id, option_type, option_value, price_adjustment, stock, created_at FROM product_options WHERE product_id = ?").bind(o.current_product_id).all(),l={product:i,options:c.results};return await ks(r,a,l,3),e.json({success:!0,data:l})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/streams/:streamId/product-wait",async e=>{const{LIVE_CACHE:s}=e.env,r=e.req.param("streamId"),t=e.req.query("lastTimestamp")||"0";try{const a=`product-timestamp:${r}`,n=`current-product:${r}`,o=25e3,i=Date.now();for(;Date.now()-i<o;){const c=await s.get(a)||"0";if(c!==t){const l=await rt(s,n,30);return e.json({success:!0,timestamp:c,data:l,changed:!0})}await new Promise(l=>setTimeout(l,1e3))}return e.json({success:!0,timestamp:t,data:null,changed:!1})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/dashboard/stats",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=r.sellerId,a=e.req.query("period")||"7d";let n=7;a==="30d"?n=30:a==="90d"&&(n=90);const o=await s.prepare(`
      SELECT 
    ...
    `).bind(t,`-${n} days`).first(),c=await s.prepare(`
      ...
      LIMIT 5
    `).bind(t,`-${n} days`).all();return e.json({success:!0,data:{period:a,daily:o.results||[],summary:i||{},topProducts:c.results||[]}})}catch(t){return console.error("Error loading seller dashboard stats:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/analytics/products",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=r.sellerId,a=await s.prepare(`
      SELECT 
        p.id,
        p.name,
        p.price,
    ...
    `).bind(t).all();return e.json({success:!0,data:a.results||[]})}catch(t){return console.error("Error loading seller streams:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/streams",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{title:t,description:a,youtube_video_id:n,youtube_url:o,thumbnail_url:i,scheduled_at:c,status:l,seller_instagram:u,seller_youtube:d,seller_facebook:m}=await e.req.json();let _=n,f="youtube",h=null,w=null,b=i;if(o&&!_&&(_=Rt(o),!_))if(_=It(o),h=vt(o),w=Co(o),_)f="tiktok";else return e.json({success:!1,error:"Invalid URL. Please provide a valid YouTube or TikTok live stream URL."},400);if(!b&&_&&f==="youtube"&&(b=`https://img.youtube.com/vi/${_}/maxresdefault.jpg`),!t||!_)return e.json({success:!1,error:"Title and live stream URL are required"},400);const g=await s.prepare(`
    ...
    `).bind(t,a||null,_,l||"scheduled",c||null,r.sellerId,u||null,d||null,m||null,f,h,w,b||null).run(),T=await s.prepare(`
      ...
      FROM live_streams 
      WHERE id = ?
    `).bind(g.meta.last_row_id).first(),y=await s.prepare("SELECT display_name, username FROM sellers WHERE id = ?").bind(r.sellerId).first();try{const{sendLiveStreamCreatedEmail:R}=await Promise.resolve().then(()=>Uo);R({streamId:g.meta.last_row_id,title:t,sellerName:(y==null?void 0:y.display_name)||(y==null?void 0:y.username)||"알 수 없음",platform:f,scheduledAt:c,status:l||"scheduled"}).then(L=>{L.success?console.log(`[Email] Live stream notification sent for stream #${L.meta.last_row_id}`):console.error("[Email] Failed to send notification:",L.error)}).catch(L=>{console.error("[Email] Exception while sending notification:",L)})}catch(R){console.error("[Email] Failed to send live stream notification:",R)}return await ts(e.env,as.LIVE_STREAMS),e.json({success:!0,data:T})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/seller/streams/:id",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id");if(!await s.prepare("SELECT id FROM live_streams WHERE id = ? AND seller_id = ?").bind(t,r.sellerId).first())return e.json({success:!1,error:"Stream not found or unauthorized"},404);const{title:n,description:o,youtube_video_id:i,youtube_url:c,scheduled_at:l,status:u,seller_instagram:d,seller_youtube:m,seller_facebook:_}=await e.req.json(),f=[],h=[];if(n!==void 0&&(f.push("title = ?"),h.push(n)),o!==void 0&&(f.push("description = ?"),h.push(o)),c!==void 0||i!==void 0){let w=i,b="youtube",g=null;if(c&&(w=Rt(c),!w))if(w=It(c),g=vt(c),w)b="tiktok";else return e.json({success:!1,error:"Invalid URL. Please provide a valid YouTube or TikTok video URL."},400);w!==void 0&&(f.push("youtube_video_id = ?"),h.push(w),f.push("platform = ?"),h.push(b),b==="tiktok"&&g&&(f.push("tiktok_username = ?"),h.push(g)))}return u!==void 0&&(f.push("status = ?"),h.push(u)),l!==void 0&&(f.push("scheduled_at = ?"),h.push(l)),d!==void 0&&(f.push("seller_instagram = ?"),h.push(d)),m!==void 0&&(f.push("seller_youtube = ?"),h.push(m)),_!==void 0&&(f.push("seller_facebook = ?"),h.push(_)),f.length===0?e.json({success:!1,error:"No fields to update"},400):(f.push("updated_at = datetime('now')"),await s.prepare(`
      UPDATE live_streams SET ${f.join(", ")} WHERE id = ?
    `).bind(...h,t).run(),await ts(e.env,as.LIVE_STREAMS),e.json({success:!0}))}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/seller/streams/:id",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id");return await s.prepare("SELECT id FROM live_streams WHERE id = ? AND seller_id = ?").bind(t,r.sellerId).first()?(await s.prepare("DELETE FROM live_streams WHERE id = ?").bind(t).run(),await ts(e.env,as.LIVE_STREAMS),e.json({success:!0})):e.json({success:!1,error:"Stream not found or unauthorized"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/seller/youtube/create-live",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{title:t,description:a,scheduled_at:n}=await e.req.json();if(!t)return e.json({success:!1,error:"라이브 방송 제목은 필수입니다"},400);const o=e.env.YOUTUBE_ACCESS_TOKEN;if(!o)return e.json({success:!1,error:"YouTube OAuth Access Token이 설정되지 않았습니다. 환경 변수를 설정해주세요.",help:"wrangler secret put YOUTUBE_ACCESS_TOKEN"},400);const i=await Ao({accessToken:o},t,a||""),l=(await s.prepare(`
      INSERT INTO live_streams (
    ...
    `).bind(t,a||null,i.broadcastId,n||null,r.sellerId,i.broadcastId,i.streamKey).run()).meta.last_row_id;return await bs(s,r.sellerId,"seller","live_created","📺 YouTube 라이브 방송이 생성되었습니다",`${t} - 스트림 키와 URL을 확인하세요`,`/seller/live-control?streamId=${l}`),e.json({success:!0,data:{streamId:l,broadcastId:i.broadcastId,youtubeVideoId:i.broadcastId,streamKey:i.streamKey,streamUrl:i.streamUrl,watchUrl:`https://www.youtube.com/watch?v=${i.broadcastId}`}})}catch(t){return console.error("[YouTube Live] Create broadcast error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/seller/youtube/end-live/:streamId",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("streamId"),a=await s.prepare("SELECT id, seller_id FROM live_streams WHERE id = ? AND seller_id = ?").bind(t,r.sellerId).first();if(!a)return e.json({success:!1,error:"라이브 방송을 찾을 수 없습니다"},404);const n=e.env.YOUTUBE_ACCESS_TOKEN;if(!n)return e.json({success:!1,error:"YouTube OAuth Access Token이 설정되지 않았습니다."},400);const o=a.youtube_broadcast_id||a.youtube_video_id;return o?(await Do({accessToken:n},o),await s.prepare(`
      UPDATE live_streams 
      SET status = 'ended', updated_at = datetime('now')
      WHERE id = ?
    `).bind(t).run(),await bs(s,r.sellerId,"seller","live_ended","✅ YouTube 라이브 방송이 종료되었습니다",`${a.title} 방송이 종료되었습니다`,"/seller/streams"),e.json({success:!0,message:"라이브 방송이 종료되었습니다"})):e.json({success:!1,error:"YouTube Broadcast ID가 없습니다. 수동으로 생성된 라이브입니다."},400)}catch(t){return console.error("[YouTube Live] End broadcast error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/youtube/stats/:streamId",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("streamId"),a=await s.prepare("SELECT id, seller_id FROM live_streams WHERE id = ? AND seller_id = ?").bind(t,r.sellerId).first();if(!a)return e.json({success:!1,error:"라이브 방송을 찾을 수 없습니다"},404);const n=a.youtube_video_id;if(!n)return e.json({success:!1,error:"YouTube Video ID가 없습니다"},400);const o=e.env.YOUTUBE_API_KEY,i=e.env.YOUTUBE_ACCESS_TOKEN;if(!o&&!i)return e.json({success:!1,error:"YouTube API Key 또는 Access Token이 설정되지 않았습니다"},400);const c=await ko({apiKey:o,accessToken:i},n);return e.json({success:!0,data:{streamId:t,videoId:n,stats:c}})}catch(t){return console.error("[YouTube Live] Get stats error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/youtube/chat/:streamId",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("streamId"),a=e.req.query("pageToken"),n=await s.prepare("SELECT id, seller_id FROM live_streams WHERE id = ? AND seller_id = ?").bind(t,r.sellerId).first();if(!n)return e.json({success:!1,error:"라이브 방송을 찾을 수 없습니다"},404);const o=n.youtube_live_chat_id;if(!o)return e.json({success:!1,error:"Live Chat ID가 없습니다. 라이브 방송이 시작되지 않았습니다."},400);const i=e.env.YOUTUBE_ACCESS_TOKEN;if(!i)return e.json({success:!1,error:"YouTube OAuth Access Token이 설정되지 않았습니다"},400);const c=await Oo({accessToken:i},o,a);return e.json({success:!0,data:c})}catch(t){return console.error("[YouTube Live] Get chat messages error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/admin/streams",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{title:t,description:a,youtube_video_id:n,platform:o,tiktok_username:i,status:c}=await e.req.json();if(!t)return e.json({success:!1,error:"제목은 필수입니다"},400);const l=o||"youtube";if(l==="youtube"&&!n)return e.json({success:!1,error:"YouTube 플랫폼은 영상 ID가 필수입니다"},400);if(l==="tiktok"&&!i)return e.json({success:!1,error:"TikTok 플랫폼은 사용자명이 필수입니다"},400);const u=await s.prepare(`
      INSERT INTO live_streams (
    ...
    `).bind(t.sellerId).first(),d=await s.prepare(`
      ...
      FROM live_streams 
      WHERE seller_id = ? AND status = 'live'
    `).bind(t.sellerId).first(),m=(d==null?void 0:d.total)||0,_={totalProducts:o.count||0,activeProducts:i.count||0,totalStock:c.total||0,totalOrders:l.count||0,totalRevenue:l.total||0,activeStreams:u.count||0,totalViewers:m};return await r.put(a,JSON.stringify(_),{expirationTtl:60}),e.json({success:!0,data:_})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/stats/sales",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.query("period")||"daily";let a,n,o;switch(t){case"weekly":a="%Y-W%W",n="week",o=28;break;case"monthly":a="%Y-%m",n="month",o=180;break;default:a="%Y-%m-%d",n="day",o=30}const i=await s.prepare(`
      SELECT 
      ...
      GROUP BY period
      ORDER BY period ASC
    `).bind(r.sellerId).all();return e.json({success:!0,data:{period:t,sales:i.results}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/seller/stats/products",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=parseInt(e.req.query("limit")||"10"),a=parseInt(e.req.query("days")||"30"),n=await s.prepare(`
      SELECT 
        p.id,
        p.name,
        p.price,
      ...
      ORDER BY total_revenue DESC
      LIMIT ?
    `).bind(r.sellerId,t).all();return e.json({success:!0,data:{products:n.results,period_days:a}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/seller/business-info",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{business_number:t,business_name:a,ceo_name:n,business_type:o,business_category:i,postal_code:c,address:l,phone:u,email:d}=await e.req.json();if(!t||!a||!n)return e.json({success:!1,error:"사업자등록번호, 상호명, 대표자명은 필수입니다."},400);const m=await s.prepare(`
    ...
    `).bind(r.sellerId).first();let _;return m?_=await s.prepare(`
      ...
      `).bind(r.sellerId,t,a,n,o,i,c,l,u,d).run(),e.json({success:!0,data:{id:m?m.id:_.meta.last_row_id,seller_id:r.sellerId,business_number:t,is_verified:!1,message:"사업자 정보가 등록되었습니다. 관리자 승인 대기 중입니다."}})}catch(t){return console.error("사업자 정보 등록 오류:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/business-info",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
    ...
    `).all();return e.json({success:!0,data:t.results||[]})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/orders",j,async e=>{const{DB:s}=e.env,r=e.get("userId");try{const t=await s.prepare(`
      SELECT 
        o.*,
        oi.id as item_id,
        oi.product_id,
  ...
  `).bind(t,JSON.stringify(s),a).run(),(t==="DONE"||t==="completed")&&(await e.prepare(`
      ...
      SET payment_status = 'approved',
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE order_number = ?
    `).bind(r).run(),console.log("[Webhook] ✅ 가상계좌 입금 완료 처리:",r))}async function Lo(e,s){const{orderId:r,virtualAccount:t}=s;console.log("[Webhook] 가상계좌 발급:",{orderId:r,bank:t==null?void 0:t.bank,accountNumber:t==null?void 0:t.accountNumber}),await e.prepare(`
    UPDATE payments 
  ...
  `).bind(t==null?void 0:t.bank,t==null?void 0:t.accountNumber,t==null?void 0:t.customerName,t==null?void 0:t.dueDate,JSON.stringify(s),r).run(),console.log("[Webhook] ✅ 가상계좌 정보 저장 완료:",r)}p.post("/api/payments/:paymentKey/cancel",async e=>{const{DB:s}=e.env;try{const r=e.req.param("paymentKey"),t=await e.req.json(),{cancelReason:a,cancelAmount:n}=t;if(console.log("[Payment] 결제 취소 요청:",{paymentKey:r,cancelReason:a,cancelAmount:n}),!a)return e.json({success:!1,error:"취소 사유를 입력해주세요."},400);const o=await s.prepare(`
    ...
    `).bind(r).first();return t?e.json({success:!0,data:t}):e.json({success:!1,error:"결제 정보를 찾을 수 없습니다."},404)}catch(r){return console.error("[Payment] ❌ 결제 조회 실패:",r.message),e.json({success:!1,error:"결제 조회 중 오류가 발생했습니다."},500)}});p.get("/api/payments/order/:orderId",async e=>{const{DB:s}=e.env;try{const r=e.req.param("orderId"),t=await s.prepare(`
      ...
      WHERE order_id = ? 
      ORDER BY created_at DESC
    `).bind(r).all();return e.json({success:!0,data:t.results||[]})}catch(r){return console.error("[Payment] ❌ 결제 목록 조회 실패:",r.message),e.json({success:!1,error:"결제 목록 조회 중 오류가 발생했습니다."},500)}});p.get("/api/seller/orders",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.query("status"),a=e.req.query("start_date"),n=e.req.query("end_date"),o=e.req.query("min_amount"),i=e.req.query("max_amount"),c=parseInt(e.req.query("page")||"1"),l=parseInt(e.req.query("limit")||"50"),u=(c-1)*l,d=["oi.seller_id = ?"],m=[r.sellerId];t&&(d.push("o.status = ?"),m.push(t)),a&&(d.push("DATE(o.created_at) >= ?"),m.push(a)),n&&(d.push("DATE(o.created_at) <= ?"),m.push(n)),o&&(d.push("o.total_amount >= ?"),m.push(parseInt(o))),i&&(d.push("o.total_amount <= ?"),m.push(parseInt(i)));const _=d.join(" AND "),f=await s.prepare(`
      SELECT 
        o.*,
        u.name as user_name,
        oi.id as item_id,
...
`),_=new Date,f=`orders_${_.toISOString().split("T")[0]}_${_.getTime()}.csv`;return new Response(m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${encodeURIComponent(f)}"`,"Cache-Control":"no-cache"}})}else return e.json({success:!1,error:"Unsupported format"},400)}catch(t){return console.error("Export error:",t),e.json({success:!1,error:t.message},500)}});p.patch("/api/seller/orders/:orderNumber/status",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber"),{status:a}=await e.req.json();if(!["PAY_COMPLETE","PREPARING","SHIPPING","DELIVERED","CANCELLED"].includes(a))return e.json({success:!1,error:"Invalid status"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(t).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,r.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);if(await s.prepare("UPDATE orders SET status = ?, updated_at = CURRENT_TIMESTAMP WHERE order_number = ?").bind(a,t).run(),a==="DELIVERED")try{console.log(`[AUTO TAX INVOICE] 배송완료 감지: ${t}, 자동 발행 시작...`);const c=await s.prepare(`
        ...
        `).bind(t).first();if(c!=null&&c.buyer_business_number&&(c!=null&&c.buyer_business_name)){console.log(`[AUTO TAX INVOICE] 사업자 구매 확인: ${c.buyer_business_number}`);const l=await s.prepare("SELECT * FROM seller_business_info WHERE seller_id = ? AND is_verified = 1").bind(r.sellerId).first();if(!l)console.warn(`[AUTO TAX INVOICE] 판매자 사업자 정보 미승인: seller_id=${r.sellerId}`),await s.prepare(`
          ...
          `).bind(t,r.sellerId,c.message).run()}catch(l){console.error("[AUTO TAX INVOICE] 로그 기록 실패:",l)}}try{const c=await s.prepare("SELECT id, user_id FROM orders WHERE order_number = ?").bind(t).first();if(c&&c.user_id){const u={PREPARING:"preparing",SHIPPING:"shipping",DELIVERED:"delivered"}[a];u&&await St(s,c.user_id,t,u)}}catch(c){console.error("[Order Status] Notification error:",c)}return e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/seller/orders/:orderNumber/tracking",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber"),{courier:a,tracking_number:n}=await e.req.json();if(!a||!n)return e.json({success:!1,error:"Courier and tracking number are required"},400);const o=await s.prepare("SELECT id FROM orders WHERE order_number = ?").bind(t).first();if(!o)return e.json({success:!1,error:"Order not found"},404);if(!await s.prepare("SELECT id FROM order_items WHERE order_id = ? AND seller_id = ?").bind(o.id,r.sellerId).first())return e.json({success:!1,error:"Unauthorized"},403);await s.prepare(`
      UPDATE orders 
      SET courier = ?, 
          tracking_number = ?, 
          ...
          updated_at = CURRENT_TIMESTAMP 
      WHERE order_number = ?
    `).bind(a,n,t).run();try{const c=await s.prepare("SELECT user_id FROM orders WHERE order_number = ?").bind(t).first();c&&c.user_id&&await St(s,c.user_id,t,"shipping",a,n)}catch(c){console.error("[Tracking] Notification error:",c)}return e.json({success:!0,message:"Tracking information updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/admin/orders",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
      SELECT o.*, u.name as user_name, u.email as user_email
      FROM orders o
      LEFT JOIN users u ON o.user_id = u.id
      ORDER BY o.created_at DESC
    `).all();return e.json({success:!0,data:t.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/sellers",async e=>{const{DB:s}=e.env,{limit:r="20",offset:t="0"}=e.req.query();try{const a=`sellers:list:${r}:${t}`,n=ve(a);if(n)return e.executionCtx.waitUntil((async()=>{try{const i=await Ar(s,parseInt(r),parseInt(t));se(a,i,3600)}catch(i){console.error("[Cache Revalidate] Sellers error:",i)}})()),e.json({success:!0,data:n,cached:!0});const o=await Ar(s,parseInt(r),parseInt(t));return se(a,o,3600),e.json({success:!0,data:o,cached:!1})}catch(a){return console.error("[API] Sellers list error:",a),e.json({success:!1,error:`셀러 목록 조회 실패: ${a.message}`},500)}});async function Ar(e,s,r){const t=`
  ...
  `,{results:a}=await e.prepare(t).bind(s,r).all();return a}p.get("/api/admin/sellers",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=await s.prepare(`
    ...
    `).bind(o,t).run(),await s.prepare("DELETE FROM admin_sessions WHERE seller_id = ?").bind(t).run(),e.json({success:!0,message:`판매자 '${n.username}'의 비밀번호가 재설정되었습니다`})}catch(t){return e.json({success:!1,error:t.message},500)}});p.patch("/api/admin/sellers/:id/commission",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id"),{commission_rate:a}=await e.req.json();if(a==null)return e.json({success:!1,error:"수수료율을 입력해주세요"},400);const n=parseFloat(a);if(isNaN(n)||n<0||n>100)return e.json({success:!1,error:"수수료율은 0에서 100 사이의 값이어야 합니다"},400);const o=await s.prepare("SELECT id, username, commission_rate FROM sellers WHERE id = ?").bind(t).first();if(!o)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);const i=o.commission_rate||10;return await s.prepare(`
      ...
      WHERE id = ?
    `).bind(n,t).run(),console.log(`수수료율 변경: 판매자 ${o.username} (ID: ${t}), ${i}% → ${n}%`),e.json({success:!0,message:`판매자 '${o.username}'의 수수료율이 ${i}%에서 ${n}%로 변경되었습니다`,data:{seller_id:t,seller_username:o.username,old_commission_rate:i,new_commission_rate:n}})}catch(t){return console.error("수수료율 변경 실패:",t),e.json({success:!1,error:t.message},500)}});p.patch("/api/admin/sellers/:id/approve",async e=>{const{DB:s}=e.env,r=await x(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id"),a=await s.prepare("SELECT id, username, email, name, status FROM sellers WHERE id = ?").bind(t).first();if(!a)return e.json({success:!1,error:"판매자를 찾을 수 없습니다"},404);if(a.status==="approved")return e.json({success:!1,error:"이미 승인된 판매자입니다"},400);if(await s.prepare(`
      UPDATE sellers 
      SET status = 'approved', 
          is_active = 1,
          approved_by = ?,
    ...
    `).bind(l).first(),d=(u==null?void 0:u.count)||0,m=await s.prepare(`
      ...
      FROM live_streams
      WHERE status = 'live'
    `).first(),_=(m==null?void 0:m.count)||0;return e.json({success:!0,stats:{todaySales:o,todayOrders:c,currentVisitors:d,liveStreams:_},timestamp:new Date().toISOString()})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/public/seller/:sellerId",async e=>{const{DB:s,CACHE_KV:r}=e.env;try{const t=e.req.param("sellerId"),a=`public:seller:${t}`,n=await Ro(r,a);if(n)return e.json({success:!0,data:n,cached:!0});const o=await s.prepare(`
      SELECT 
...
`});const _="\uFEFF";return new Response(_+m,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(t){return console.error("CSV 내보내기 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/create",j,async e=>{const{DB:s}=e.env;try{const{userId:r,cartItems:t,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:c,buyerBusinessName:l,buyerCeoName:u}=await e.req.json();console.log("[DEPRECATED /api/orders/create] 주문 생성 요청:",{userId:r,cartItems:t==null?void 0:t.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const v=await s.prepare(`
      ...
      `).bind(o).first();v&&v.commission_rate!==null&&(d=v.commission_rate)}console.log("수수료율:",{sellerId:o,commissionRate:d});const m=Math.floor(a*(d/100)),_=a-m;let f=null;if(n){const v=await s.prepare(`
        ...
        FROM shipping_addresses 
        WHERE id = ? AND user_id = ?
      `).bind(n,r).first();if(!v)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);f=v}if(!r)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const h=r,w=new Date,b=w.getFullYear().toString().slice(-2),g=(w.getMonth()+1).toString().padStart(2,"0"),T=w.getDate().toString().padStart(2,"0"),y=`${b}${g}${T}`,R=Math.random().toString(36).substring(2,7).toUpperCase(),L=`ORD-${y}-${R}`,k=t.map(v=>v.product_id),D=k.map(()=>"?").join(","),W=await s.prepare(`
      SELECT id, stock FROM products WHERE id IN (${D})
    `).bind(...k).all(),U=new Map(W.results.map(v=>[v.id,v.stock]));for(const v of t){const re=U.get(v.product_id);if(re===void 0)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${v.product_id})`},400);if(re<v.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${v.product_id})`},400)}const $=(await s.prepare(`
      INSERT INTO orders (
    ...
    `).bind(L,h,a,"pending",o||null,d,m,_,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,c||null,l||null,u||null).run()).meta.last_row_id,Q=t.map(v=>s.prepare(`
      ...
      `).bind(v.quantity,v.product_id));await s.batch([...Q,...z]);try{const v=Pe(e.env),re=t.map(H=>H.product_id),q=re.map(()=>"?").join(","),P=await s.prepare(`
...
`}return new Response(u,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${i}_${c}.csv"`}})}catch(s){return console.error("CSV download error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/seller/tax-invoices/issue",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{order_number:t}=await e.req.json();if(!t)return e.json({success:!1,error:"주문번호는 필수입니다."},400);const a=await s.prepare(`
    ...
    `).bind(r.sellerId).first();if(!n)return e.json({success:!1,error:"승인된 사업자 정보가 없습니다. 관리자 승인을 기다려주세요."},400);const o=await s.prepare(`
      ...
      LEFT JOIN products p ON oi.product_id = p.id
      WHERE oi.order_id = ?
    `).bind(a.id).all(),i=Number(a.total_amount),c=Math.floor(i/1.1),l=i-c,u=new Date().toISOString().split("T")[0],d=`${u}-${Math.random().toString(36).substring(2,8).toUpperCase()}`,m=Ia(n,a,o.results);let _,f,h;try{_=await Ra(m),f=_.ntsConfirmNumber,h=_.invoiceKey,console.log("바로빌 발행 성공:",{ntsConfirmNumber:f,invoiceKey:h,mockMode:cs()})}catch(g){console.error("바로빌 API 호출 실패:",g),f="FAILED",h=null}const b=(await s.prepare(`
      INSERT INTO tax_invoices (
    ...
    `).bind(r.sellerId,t,"tax",d,u,n.business_number,n.business_name,n.ceo_name,n.address,n.business_type,n.business_category,a.buyer_business_number,a.buyer_business_name,a.buyer_ceo_name,c,l,i,f==="FAILED"?"failed":"issued",cs()?"mock":"barobill",h,f).run()).meta.last_row_id;for(const g of o.results){const T=Math.floor(Number(g.price)*Number(g.quantity)/1.1),y=Number(g.price)*Number(g.quantity)-T;await s.prepare(`
      ...
      `).bind(b,g.id,g.product_name,g.quantity,g.price,T,y).run()}return e.json({success:!0,data:{invoice_id:b,invoice_number:d,issue_date:u,total_amount:i,supply_price:c,tax_amount:l,status:f==="FAILED"?"failed":"issued",nts_confirm_number:f,api_invoice_key:h,mock_mode:cs(),message:f==="FAILED"?"바로빌 API 호출 실패. 나중에 다시 시도해주세요.":cs()?"세금계산서가 발행되었습니다. (Mock Mode - 실제 발행 아님)":"세금계산서가 발행되었습니다."}})}catch(t){return console.error("세금계산서 발행 오류:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/tax-invoices",async e=>{var t;const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{start_date:a,end_date:n,status:o}=e.req.query();let i=`
      SELECT * FROM tax_invoices
      WHERE seller_id = ?
    `;const c=[r.sellerId];a&&(i+=" AND issue_date >= ?",c.push(a)),n&&(i+=" AND issue_date <= ?",c.push(n)),o&&(i+=" AND status = ?",c.push(o)),i+=" ORDER BY created_at DESC";const l=await s.prepare(i).bind(...c).all();return e.json({success:!0,data:l.results||[],total:((t=l.results)==null?void 0:t.length)||0})}catch(a){return e.json({success:!1,error:a.message},500)}});p.get("/api/seller/tax-invoices/:id",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id"),a=await s.prepare(`
    ...
    `).bind(t).all();return e.json({success:!0,data:{...a,items:n.results||[]}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/seller/tax-invoices/:id/cancel",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("id"),{reason:a}=await e.req.json(),n=await s.prepare(`
      SELECT * FROM tax_invoices WHERE id = ? AND seller_id = ?
    `).bind(t,r.sellerId).first();if(!n)return e.json({success:!1,error:"세금계산서를 찾을 수 없습니다."},404);const o=new Date(n.issue_date),i=new Date(o);if(i.setDate(i.getDate()+1),new Date>i)return e.json({success:!1,error:"발행일 익일까지만 취소 가능합니다."},400);try{if(n.api_invoice_key&&!cs()){const l=await s.prepare(`
        ...
        `).bind(r.sellerId).first();l&&l.business_number&&await Ta(l.business_number,n.api_invoice_key,a||"판매자 요청")}}catch(l){console.error("바로빌 취소 API 호출 실패:",l)}return await s.prepare(`
      UPDATE tax_invoices
      SET status = 'cancelled', updated_at = datetime('now')
      WHERE id = ?
    `).bind(t).run(),e.json({success:!0,message:"세금계산서가 취소되었습니다."})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/seller/tax-invoices/auto-issue-logs",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const{status:t,limit:a=50}=e.req.query();let n=`
      SELECT 
        log.*,
        o.total_amount,
        o.buyer_business_name
      ...
      WHERE log.seller_id = ?
    `;const o=[r.sellerId];t&&(n+=" AND log.status = ?",o.push(t)),n+=" ORDER BY log.created_at DESC LIMIT ?",o.push(Number(a));const i=await s.prepare(n).bind(...o).all();return e.json({success:!0,data:i.results})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/seller/tax-invoices/retry/:orderNumber",async e=>{const{DB:s}=e.env,r=await C(e);if(!r.success)return e.json({success:!1,error:r.error},401);try{const t=e.req.param("orderNumber");console.log(`[TAX INVOICE RETRY] 재시도 시작: ${t}`);const a=await s.prepare(`
    ...
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return console.error("라이브 목록 조회 실패:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/seller/:sellerId/products-public",async e=>{const{DB:s}=e.env,r=e.req.param("sellerId");try{const t=await s.prepare(`
      ...
      ORDER BY created_at DESC
      LIMIT 100
    `).bind(r).all();return e.json({success:!0,data:t.results})}catch(t){return console.error("상품 목록 조회 실패:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/notifications",j,async e=>{const{DB:s}=e.env;try{const r=e.get("userId"),t=e.get("userType"),a=parseInt(e.req.query("limit")||"50"),n=e.req.query("unread_only")==="true";let o=`
      SELECT * FROM notifications
      WHERE user_id = ? AND user_type = ?
    `;n&&(o+=" AND is_read = 0"),o+=" ORDER BY created_at DESC LIMIT ?";const i=await s.prepare(o).bind(r,t,a).all();return e.json({success:!0,data:i.results})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/notifications/unread-count",j,async e=>{const{DB:s}=e.env;try{const r=e.get("userId"),t=e.get("userType"),a=await s.prepare(`
      SELECT COUNT(*) as count
      FROM notifications
      WHERE user_id = ? AND user_type = ? AND is_read = 0
    `).bind(r,t).first();return e.json({success:!0,count:(a==null?void 0:a.count)||0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.put("/api/notifications/:id/read",j,async e=>{const{DB:s}=e.env;try{const r=e.req.param("id"),t=e.get("userId"),a=e.get("userType");return await s.prepare("SELECT user_id, user_type FROM notifications WHERE id = ? AND user_id = ? AND user_type = ?").bind(r,t,a).first()?(await s.prepare("UPDATE notifications SET is_read = 1 WHERE id = ?").bind(r).run(),e.json({success:!0})):e.json({success:!1,error:"Notification not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.put("/api/notifications/read-all",j,async e=>{const{DB:s}=e.env;try{const r=e.get("userId"),t=e.get("userType");return await s.prepare(`
      UPDATE notifications 
      SET is_read = 1 
      WHERE user_id = ? AND user_type = ? AND is_read = 0
    `).bind(r,t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.delete("/api/notifications/:id",j,async e=>{const{DB:s}=e.env;try{const r=e.req.param("id"),t=e.get("userId"),a=e.get("userType");return await s.prepare("SELECT user_id, user_type FROM notifications WHERE id = ? AND user_id = ? AND user_type = ?").bind(r,t,a).first()?(await s.prepare("DELETE FROM notifications WHERE id = ?").bind(r).run(),e.json({success:!0})):e.json({success:!1,error:"Notification not found"},404)}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/banners",async e=>{const{DB:s}=e.env;try{const r=new Date().toISOString(),t=await s.prepare(`
      SELECT * FROM banners
      WHERE is_active = 1
        AND (start_date IS NULL OR start_date <= ?)
        AND (end_date IS NULL OR end_date >= ?)
      ORDER BY display_order ASC, created_at DESC
    `).bind(r,r).all();return e.json({success:!0,data:t.results})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/api/admin/banners",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=await s.prepare(`
      SELECT * FROM banners
      ORDER BY display_order ASC, created_at DESC
    `).all();return e.json({success:!0,data:t.results})}catch(r){return e.json({success:!1,error:r.message},500)}});p.post("/api/admin/banners",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const{title:t,image_url:a,link_url:n,description:o,is_active:i,display_order:c,start_date:l,end_date:u}=await e.req.json();if(!t||!a)return e.json({success:!1,error:"제목과 이미지는 필수입니다."},400);const d=await s.prepare(`
      INSERT INTO banners (title, image_url, link_url, description, is_active, display_order, start_date, end_date)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a,n||null,o||null,i!==!1?1:0,c||0,l||null,u||null).run();return e.json({success:!0,id:d.meta.last_row_id})}catch(r){return e.json({success:!1,error:r.message},500)}});p.put("/api/admin/banners/:id",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=e.req.param("id"),{title:a,image_url:n,link_url:o,description:i,is_active:c,display_order:l,start_date:u,end_date:d}=await e.req.json();return await s.prepare(`
      UPDATE banners
      SET title = ?, image_url = ?, link_url = ?, description = ?,
          is_active = ?, display_order = ?, start_date = ?, end_date = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = ?
    `).bind(a,n,o||null,i||null,c?1:0,l||0,u||null,d||null,t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.delete("/api/admin/banners/:id",j,async e=>{const{DB:s}=e.env;try{if(e.get("userType")!=="admin")return e.json({success:!1,error:"관리자 권한이 필요합니다."},403);const t=e.req.param("id");return await s.prepare("DELETE FROM banners WHERE id = ?").bind(t).run(),e.json({success:!0})}catch(r){return e.json({success:!1,error:r.message},500)}});p.get("/order-complete",e=>e.redirect("/order-complete.html",302));p.notFound(e=>{const s=e.req.path;return s.startsWith("/api/")?e.json({success:!1,error:"Not found",message:`The requested endpoint ${s} was not found.`},404):new Response(null,{status:404})});p.onError((e,s)=>{const r=s.req.path;if(e instanceof yn)return console.error("[AppError]",{path:r,method:s.req.method,code:e.code,message:e.message,statusCode:e.statusCode}),s.json({success:!1,error:{code:e.code,message:e.message,...e.details&&{details:e.details}}},e.statusCode);if(console.error("[Global Error Handler]",{path:r,method:s.req.method,error:e.message,stack:e.stack}),r.startsWith("/api/")){let t=500,a="Internal Server Error";return e.message.includes("Unauthorized")||e.message.includes("로그인")?(t=401,a="인증이 필요합니다. 로그인해주세요."):e.message.includes("Forbidden")||e.message.includes("권한")?(t=403,a="접근 권한이 없습니다."):e.message.includes("Not found")||e.message.includes("찾을 수 없")?(t=404,a="요청하신 리소스를 찾을 수 없습니다."):(e.message.includes("Bad request")||e.message.includes("잘못된"))&&(t=400,a="잘못된 요청입니다."),s.json({success:!1,error:e.message||a},t)}return s.html(`
    <!DOCTYPE html>
    <html lang="ko">
    <head>
      <meta charset="UTF-8">
  ...
  `,500)});p.get("/api/admin/alimtalk/pricing",S(),async e=>{const{env:s}=e;try{const r=await s.DB.prepare(`
    ...
    `).bind(t.user_id).first();if(!c)return e.json({success:!1,error:"Active alimtalk account not found"},404);if(!(await Ha(s,c.sender_key,{name:n,content:o,templateCode:a})).success)return e.json({success:!1,error:"Failed to register template"},500);const u=await s.DB.prepare(`
    ...
    `).bind(a,c.id).first();if(!l)return e.json({success:!1,error:"Template not found or not approved"},404);const u=Ba(l.template_content,o||{}),d=tt(n),m=await er(s,{senderKey:c.sender_key,templateCode:l.template_code,to:d,message:u});if(!m.success)return await s.DB.prepare(`
        INSERT INTO alimtalk_messages 
    ...
    `).bind(parseInt(r),parseInt(s)).first();if(!n)return e.json({success:!1,error:"Template not found"},404);let o=n.template_content;return a&&Object.entries(a).forEach(([i,c])=>{const l=new RegExp(`#{${i}}`,"g");o=o.replace(l,c)}),e.json({success:!0,data:{template_name:n.template_name,original:n.template_content,preview:o,required_variables:Array.from(n.template_content.matchAll(/#{(\w+)}/g),i=>i[1])}})}catch(s){return console.error("[Alimtalk Preview] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlements",S(),async e=>{try{const s=await e.env.DB.prepare(`
      ...
      LIMIT 50
    `).all();return e.json({success:!0,data:s.results})}catch(s){return console.error("[Admin Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/admin/settlements/:id",S(),async e=>{try{const s=parseInt(e.req.param("id")),r=await ln(e.env.DB,s);return r?e.json({success:!0,data:r}):e.json({success:!1,error:"Settlement not found"},404)}catch(s){return console.error("[Admin Settlement Detail] Error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/admin/settlements/generate",S(),async e=>{try{const s=await e.req.json(),{startDate:r,endDate:t}=s,a=r&&t?{startDate:r,endDate:t}:an(),n=await on(e.env.DB,a);return await cn(e.env.DB,n),e.json({success:!0,data:n})}catch(s){return console.error("[Admin Generate Settlement] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/seller/settlements",S(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const r=await e.env.DB.prepare(`
      SELECT 
        s.id,
        s.period_start,
        s.period_end,
...
`),L=`my_settlement_${c}_${l}.csv`;return e.text(R,200,{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="${L}"`})}return e.json({success:!0,data:T})}catch(n){return console.error("[My Settlement] Error:",n),e.json({success:!1,error:n.message},500)}});p.get("/api/seller/settlements",S(),async e=>{try{const s=e.req.header("X-Seller-ID");if(!s)return e.json({success:!1,error:"Unauthorized"},401);const r=await e.env.DB.prepare(`
      ...
      ORDER BY s.period_start DESC
      LIMIT 50
    `).bind(parseInt(s)).all();return e.json({success:!0,data:r.results})}catch(s){return console.error("[Seller Settlements] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/live/:streamId/sse",async e=>{const s=e.req.param("streamId");return un(s,e.env)});p.get("/api/live/:streamId/chat/sse",async e=>{const s=e.req.param("streamId");return dn(s,e.env)});p.get("/api/seller/orders/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?pn(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});p.get("/api/seller/stock/sse",async e=>{const s=e.req.header("X-Seller-ID");return s?mn(s,e.env):e.json({success:!1,error:"Unauthorized"},401)});p.post("/api/push/subscribe",S(),async e=>{try{const s=e.req.header("X-User-ID"),r=e.req.header("X-User-Type");if(!s||!r)return e.json({success:!1,error:"Unauthorized"},401);const t=await e.req.json();return await _n(e.env.DB,parseInt(s),r,t),e.json({success:!0})}catch(s){return console.error("[Push Subscribe] Error:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/push/unsubscribe",S(),async e=>{try{const{endpoint:s}=await e.req.json();return s?(await fn(e.env.DB,s),e.json({success:!0})):e.json({success:!1,error:"Endpoint required"},400)}catch(s){return console.error("[Push Unsubscribe] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/push/vapid-public-key",S(),async e=>{try{const s=e.env.VAPID_PUBLIC_KEY||"";return e.json({success:!0,publicKey:s})}catch(s){return console.error("[Push VAPID Key] Error:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/cache/stats",async e=>{const s=e.req.query("token"),r=e.env.STATS_SECRET_TOKEN||"your-secret-token-here";if(s!==r)return e.json({success:!1,error:"접근 권한이 없습니다. 올바른 token을 제공해주세요."},403);const t=Y.hits+Y.misses>0?(Y.hits/(Y.hits+Y.misses)*100).toFixed(2):"0.00";return e.json({success:!0,data:{cache:{...Y,hitRate:`${t}%`,cacheSize:_e.size,maxSize:1e3,memoryUsage:`${(_e.size/1e3*100).toFixed(1)}%`},description:{hits:"Memory cache로 처리된 요청 (KV 읽기 0회)",misses:"Memory cache 미스로 KV 조회한 요청",writes:"Memory cache에 저장된 항목 수",evictions:"Memory cache에서 삭제된 항목 수 (만료 또는 크기 제한)",hitRate:"Cache hit 비율 (높을수록 KV 사용량 감소)",cacheSize:"현재 Memory cache에 저장된 항목 수",maxSize:"Memory cache 최대 크기",memoryUsage:"Memory cache 사용률 (cacheSize / maxSize)"},kvUsageGuide:{currentHitRate:`${t}%`,recommendation:parseFloat(t)>=90?"✅ 캐시가 매우 효과적으로 작동하고 있습니다.":parseFloat(t)>=70?"⚠️ 캐시 히트율이 낮습니다. TTL 조정을 고려하세요.":"❌ 캐시 히트율이 매우 낮습니다. 캐시 설정을 확인하세요.",kvDailyReadsLimit:"100,000 reads/day (free tier)",kvDailyWritesLimit:"1,000 writes/day (free tier)",estimatedDailyReads:Math.round(Y.misses/(Y.hits+Y.misses||1)*1e4),estimatedDailyWrites:Math.round(Y.writes/(Y.hits+Y.misses||1)*1e3)}}})});let Dr={},Or={};p.get("/api/debug/kv-usage",S(),async e=>{try{const s=Object.entries(Dr).sort((i,c)=>c[1]-i[1]).slice(0,20),r=Object.entries(Or).sort((i,c)=>c[1]-i[1]).slice(0,20),t=Object.values(Dr).reduce((i,c)=>i+c,0),a=Object.values(Or).reduce((i,c)=>i+c,0),n=t/1e3*100,o=a/1e5*100;if((n>=50||o>=50)&&e.env.DISCORD_WEBHOOK_URL)try{await wn(e.env.DISCORD_WEBHOOK_URL,o,n)}catch(i){console.error("[Discord] KV 경고 전송 실패:",i)}return e.json({success:!0,stats:{total_writes:t,total_reads:a,daily_write_limit:1e3,daily_read_limit:1e5,write_usage_percent:n.toFixed(2)+"%",read_usage_percent:o.toFixed(2)+"%",top_writes:s,top_reads:r},recommendations:t>500?["⚠️ KV Write 사용량이 높습니다!","1. 세션 갱신 주기를 늘리세요 (현재 29일)","2. 캐시를 메모리에만 저장하세요 (forceKvWrite: false)","3. JWT 인증으로 전환하세요 (KV 사용량 90% 감소)"]:["✅ KV 사용량이 정상 범위입니다."]})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/debug/user/:email",S(),async e=>{const{DB:s}=e.env,r=e.req.param("email");try{const t=await s.prepare(`
