var Vs=Object.defineProperty;var is=e=>{throw TypeError(e)};var Js=(e,r,t)=>r in e?Vs(e,r,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[r]=t;var S=(e,r,t)=>Js(e,typeof r!="symbol"?r+"":r,t),Xe=(e,r,t)=>r.has(e)||is("Cannot "+t);var m=(e,r,t)=>(Xe(e,r,"read from private field"),t?t.call(e):r.get(e)),R=(e,r,t)=>r.has(e)?is("Cannot add the same private member more than once"):r instanceof WeakSet?r.add(e):r.set(e,t),T=(e,r,t,s)=>(Xe(e,r,"write to private field"),s?s.call(e,t):r.set(e,t),t),O=(e,r,t)=>(Xe(e,r,"access private method"),t);var us=(e,r,t,s)=>({set _(a){T(e,r,a,t)},get _(){return m(e,r,s)}});var cs=(e,r,t)=>(s,a)=>{let n=-1;return o(0);async function o(i){if(i<=n)throw new Error("next() called multiple times");n=i;let u,c=!1,l;if(e[i]?(l=e[i][0][0],s.req.routeIndex=i):l=i===e.length&&a||void 0,l)try{u=await l(s,()=>o(i+1))}catch(d){if(d instanceof Error&&r)s.error=d,u=await r(d,s),c=!0;else throw d}else s.finalized===!1&&t&&(u=await t(s));return u&&(s.finalized===!1||c)&&(s.res=u),s}},zs=Symbol(),Gs=async(e,r=Object.create(null))=>{const{all:t=!1,dot:s=!1}=r,n=(e instanceof Is?e.raw.headers:e.headers).get("Content-Type");return n!=null&&n.startsWith("multipart/form-data")||n!=null&&n.startsWith("application/x-www-form-urlencoded")?Xs(e,{all:t,dot:s}):{}};async function Xs(e,r){const t=await e.formData();return t?Qs(t,r):{}}function Qs(e,r){const t=Object.create(null);return e.forEach((s,a)=>{r.all||a.endsWith("[]")?Zs(t,a,s):t[a]=s}),r.dot&&Object.entries(t).forEach(([s,a])=>{s.includes(".")&&(er(t,s,a),delete t[s])}),t}var Zs=(e,r,t)=>{e[r]!==void 0?Array.isArray(e[r])?e[r].push(t):e[r]=[e[r],t]:r.endsWith("[]")?e[r]=[t]:e[r]=t},er=(e,r,t)=>{let s=e;const a=r.split(".");a.forEach((n,o)=>{o===a.length-1?s[n]=t:((!s[n]||typeof s[n]!="object"||Array.isArray(s[n])||s[n]instanceof File)&&(s[n]=Object.create(null)),s=s[n])})},gs=e=>{const r=e.split("/");return r[0]===""&&r.shift(),r},sr=e=>{const{groups:r,path:t}=rr(e),s=gs(t);return tr(s,r)},rr=e=>{const r=[];return e=e.replace(/\{[^}]+\}/g,(t,s)=>{const a=`@${s}`;return r.push([a,t]),a}),{groups:r,path:e}},tr=(e,r)=>{for(let t=r.length-1;t>=0;t--){const[s]=r[t];for(let a=e.length-1;a>=0;a--)if(e[a].includes(s)){e[a]=e[a].replace(s,r[t][1]);break}}return e},Ke={},ar=(e,r)=>{if(e==="*")return"*";const t=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const s=`${e}#${r}`;return Ke[s]||(t[2]?Ke[s]=r&&r[0]!==":"&&r[0]!=="*"?[s,t[1],new RegExp(`^${t[2]}(?=/${r})`)]:[e,t[1],new RegExp(`^${t[2]}$`)]:Ke[s]=[e,t[1],!0]),Ke[s]}return null},rs=(e,r)=>{try{return r(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return r(t)}catch{return t}})}},nr=e=>rs(e,decodeURI),bs=e=>{const r=e.url,t=r.indexOf("/",r.indexOf(":")+4);let s=t;for(;s<r.length;s++){const a=r.charCodeAt(s);if(a===37){const n=r.indexOf("?",s),o=r.slice(t,n===-1?void 0:n);return nr(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return r.slice(t,s)},or=e=>{const r=bs(e);return r.length>1&&r.at(-1)==="/"?r.slice(0,-1):r},ge=(e,r,...t)=>(t.length&&(r=ge(r,...t)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${r==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(r==null?void 0:r[0])==="/"?r.slice(1):r}`}`),ws=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const r=e.split("/"),t=[];let s="";return r.forEach(a=>{if(a!==""&&!/\:/.test(a))s+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){t.length===0&&s===""?t.push("/"):t.push(s);const n=a.replace("?","");s+="/"+n,t.push(s)}else s+="/"+a}),t.filter((a,n,o)=>o.indexOf(a)===n)},Qe=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?rs(e,Ss):e):e,Ts=(e,r,t)=>{let s;if(!t&&r&&!/[%+]/.test(r)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(r,o+1)||(o=e.indexOf(`&${r}`,o+1));o!==-1;){const i=e.charCodeAt(o+r.length+1);if(i===61){const u=o+r.length+2,c=e.indexOf("&",u);return Qe(e.slice(u,c===-1?void 0:c))}else if(i==38||isNaN(i))return"";o=e.indexOf(`&${r}`,o+1)}if(s=/[%+]/.test(e),!s)return}const a={};s??(s=/[%+]/.test(e));let n=e.indexOf("?",8);for(;n!==-1;){const o=e.indexOf("&",n+1);let i=e.indexOf("=",n);i>o&&o!==-1&&(i=-1);let u=e.slice(n+1,i===-1?o===-1?void 0:o:i);if(s&&(u=Qe(u)),n=o,u==="")continue;let c;i===-1?c="":(c=e.slice(i+1,o===-1?void 0:o),s&&(c=Qe(c))),t?(a[u]&&Array.isArray(a[u])||(a[u]=[]),a[u].push(c)):a[u]??(a[u]=c)}return r?a[r]:a},ir=Ts,ur=(e,r)=>Ts(e,r,!0),Ss=decodeURIComponent,ls=e=>rs(e,Ss),Te,B,re,Rs,vs,ss,te,ms,Is=(ms=class{constructor(e,r="/",t=[[]]){R(this,re);S(this,"raw");R(this,Te);R(this,B);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});R(this,te,e=>{const{bodyCache:r,raw:t}=this,s=r[e];if(s)return s;const a=Object.keys(r)[0];return a?r[a].then(n=>(a==="json"&&(n=JSON.stringify(n)),new Response(n)[e]())):r[e]=t[e]()});this.raw=e,this.path=r,T(this,B,t),T(this,Te,{})}param(e){return e?O(this,re,Rs).call(this,e):O(this,re,vs).call(this)}query(e){return ir(this.url,e)}queries(e){return ur(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const r={};return this.raw.headers.forEach((t,s)=>{r[s]=t}),r}async parseBody(e){var r;return(r=this.bodyCache).parsedBody??(r.parsedBody=await Gs(this,e))}json(){return m(this,te).call(this,"text").then(e=>JSON.parse(e))}text(){return m(this,te).call(this,"text")}arrayBuffer(){return m(this,te).call(this,"arrayBuffer")}blob(){return m(this,te).call(this,"blob")}formData(){return m(this,te).call(this,"formData")}addValidatedData(e,r){m(this,Te)[e]=r}valid(e){return m(this,Te)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[zs](){return m(this,B)}get matchedRoutes(){return m(this,B)[0].map(([[,e]])=>e)}get routePath(){return m(this,B)[0].map(([[,e]])=>e)[this.routeIndex].path}},Te=new WeakMap,B=new WeakMap,re=new WeakSet,Rs=function(e){const r=m(this,B)[0][this.routeIndex][1][e],t=O(this,re,ss).call(this,r);return t&&/\%/.test(t)?ls(t):t},vs=function(){const e={},r=Object.keys(m(this,B)[0][this.routeIndex][1]);for(const t of r){const s=O(this,re,ss).call(this,m(this,B)[0][this.routeIndex][1][t]);s!==void 0&&(e[t]=/\%/.test(s)?ls(s):s)}return e},ss=function(e){return m(this,B)[1]?m(this,B)[1][e]:e},te=new WeakMap,ms),cr={Stringify:1},Os=async(e,r,t,s,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const n=e.callbacks;return n!=null&&n.length?(a?a[0]+=e:a=[e],Promise.all(n.map(i=>i({phase:r,buffer:a,context:s}))).then(i=>Promise.all(i.filter(Boolean).map(u=>Os(u,r,!1,s,a))).then(()=>a[0]))):Promise.resolve(e)},lr="text/plain; charset=UTF-8",Ze=(e,r)=>({"Content-Type":e,...r}),Le,Me,Q,Se,Z,q,Pe,Ie,Re,pe,xe,Ue,ae,be,_s,dr=(_s=class{constructor(e,r){R(this,ae);R(this,Le);R(this,Me);S(this,"env",{});R(this,Q);S(this,"finalized",!1);S(this,"error");R(this,Se);R(this,Z);R(this,q);R(this,Pe);R(this,Ie);R(this,Re);R(this,pe);R(this,xe);R(this,Ue);S(this,"render",(...e)=>(m(this,Ie)??T(this,Ie,r=>this.html(r)),m(this,Ie).call(this,...e)));S(this,"setLayout",e=>T(this,Pe,e));S(this,"getLayout",()=>m(this,Pe));S(this,"setRenderer",e=>{T(this,Ie,e)});S(this,"header",(e,r,t)=>{this.finalized&&T(this,q,new Response(m(this,q).body,m(this,q)));const s=m(this,q)?m(this,q).headers:m(this,pe)??T(this,pe,new Headers);r===void 0?s.delete(e):t!=null&&t.append?s.append(e,r):s.set(e,r)});S(this,"status",e=>{T(this,Se,e)});S(this,"set",(e,r)=>{m(this,Q)??T(this,Q,new Map),m(this,Q).set(e,r)});S(this,"get",e=>m(this,Q)?m(this,Q).get(e):void 0);S(this,"newResponse",(...e)=>O(this,ae,be).call(this,...e));S(this,"body",(e,r,t)=>O(this,ae,be).call(this,e,r,t));S(this,"text",(e,r,t)=>!m(this,pe)&&!m(this,Se)&&!r&&!t&&!this.finalized?new Response(e):O(this,ae,be).call(this,e,r,Ze(lr,t)));S(this,"json",(e,r,t)=>O(this,ae,be).call(this,JSON.stringify(e),r,Ze("application/json",t)));S(this,"html",(e,r,t)=>{const s=a=>O(this,ae,be).call(this,a,r,Ze("text/html; charset=UTF-8",t));return typeof e=="object"?Os(e,cr.Stringify,!1,{}).then(s):s(e)});S(this,"redirect",(e,r)=>{const t=String(e);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,r??302)});S(this,"notFound",()=>(m(this,Re)??T(this,Re,()=>new Response),m(this,Re).call(this,this)));T(this,Le,e),r&&(T(this,Z,r.executionCtx),this.env=r.env,T(this,Re,r.notFoundHandler),T(this,Ue,r.path),T(this,xe,r.matchResult))}get req(){return m(this,Me)??T(this,Me,new Is(m(this,Le),m(this,Ue),m(this,xe))),m(this,Me)}get event(){if(m(this,Z)&&"respondWith"in m(this,Z))return m(this,Z);throw Error("This context has no FetchEvent")}get executionCtx(){if(m(this,Z))return m(this,Z);throw Error("This context has no ExecutionContext")}get res(){return m(this,q)||T(this,q,new Response(null,{headers:m(this,pe)??T(this,pe,new Headers)}))}set res(e){if(m(this,q)&&e){e=new Response(e.body,e);for(const[r,t]of m(this,q).headers.entries())if(r!=="content-type")if(r==="set-cookie"){const s=m(this,q).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of s)e.headers.append("set-cookie",a)}else e.headers.set(r,t)}T(this,q,e),this.finalized=!0}get var(){return m(this,Q)?Object.fromEntries(m(this,Q)):{}}},Le=new WeakMap,Me=new WeakMap,Q=new WeakMap,Se=new WeakMap,Z=new WeakMap,q=new WeakMap,Pe=new WeakMap,Ie=new WeakMap,Re=new WeakMap,pe=new WeakMap,xe=new WeakMap,Ue=new WeakMap,ae=new WeakSet,be=function(e,r,t){const s=m(this,q)?new Headers(m(this,q).headers):m(this,pe)??new Headers;if(typeof r=="object"&&"headers"in r){const n=r.headers instanceof Headers?r.headers:new Headers(r.headers);for(const[o,i]of n)o.toLowerCase()==="set-cookie"?s.append(o,i):s.set(o,i)}if(t)for(const[n,o]of Object.entries(t))if(typeof o=="string")s.set(n,o);else{s.delete(n);for(const i of o)s.append(n,i)}const a=typeof r=="number"?r:(r==null?void 0:r.status)??m(this,Se);return new Response(e,{status:a,headers:s})},_s),M="ALL",pr="all",mr=["get","post","put","delete","options","patch"],js="Can not add a route since the matcher is already built.",Ns=class extends Error{},_r="__COMPOSED_HANDLER",fr=e=>e.text("404 Not Found",404),ds=(e,r)=>{if("getResponse"in e){const t=e.getResponse();return r.newResponse(t.body,t)}return console.error(e),r.text("Internal Server Error",500)},V,P,Ds,J,le,We,qe,ve,Er=(ve=class{constructor(r={}){R(this,P);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");R(this,V,"/");S(this,"routes",[]);R(this,J,fr);S(this,"errorHandler",ds);S(this,"onError",r=>(this.errorHandler=r,this));S(this,"notFound",r=>(T(this,J,r),this));S(this,"fetch",(r,...t)=>O(this,P,qe).call(this,r,t[1],t[0],r.method));S(this,"request",(r,t,s,a)=>r instanceof Request?this.fetch(t?new Request(r,t):r,s,a):(r=r.toString(),this.fetch(new Request(/^https?:\/\//.test(r)?r:`http://localhost${ge("/",r)}`,t),s,a)));S(this,"fire",()=>{addEventListener("fetch",r=>{r.respondWith(O(this,P,qe).call(this,r.request,r,void 0,r.request.method))})});[...mr,pr].forEach(n=>{this[n]=(o,...i)=>(typeof o=="string"?T(this,V,o):O(this,P,le).call(this,n,m(this,V),o),i.forEach(u=>{O(this,P,le).call(this,n,m(this,V),u)}),this)}),this.on=(n,o,...i)=>{for(const u of[o].flat()){T(this,V,u);for(const c of[n].flat())i.map(l=>{O(this,P,le).call(this,c.toUpperCase(),m(this,V),l)})}return this},this.use=(n,...o)=>(typeof n=="string"?T(this,V,n):(T(this,V,"*"),o.unshift(n)),o.forEach(i=>{O(this,P,le).call(this,M,m(this,V),i)}),this);const{strict:s,...a}=r;Object.assign(this,a),this.getPath=s??!0?r.getPath??bs:or}route(r,t){const s=this.basePath(r);return t.routes.map(a=>{var o;let n;t.errorHandler===ds?n=a.handler:(n=async(i,u)=>(await cs([],t.errorHandler)(i,()=>a.handler(i,u))).res,n[_r]=a.handler),O(o=s,P,le).call(o,a.method,a.path,n)}),this}basePath(r){const t=O(this,P,Ds).call(this);return t._basePath=ge(this._basePath,r),t}mount(r,t,s){let a,n;s&&(typeof s=="function"?n=s:(n=s.optionHandler,s.replaceRequest===!1?a=u=>u:a=s.replaceRequest));const o=n?u=>{const c=n(u);return Array.isArray(c)?c:[c]}:u=>{let c;try{c=u.executionCtx}catch{}return[u.env,c]};a||(a=(()=>{const u=ge(this._basePath,r),c=u==="/"?0:u.length;return l=>{const d=new URL(l.url);return d.pathname=d.pathname.slice(c)||"/",new Request(d,l)}})());const i=async(u,c)=>{const l=await t(a(u.req.raw),...o(u));if(l)return l;await c()};return O(this,P,le).call(this,M,ge(r,"*"),i),this}},V=new WeakMap,P=new WeakSet,Ds=function(){const r=new ve({router:this.router,getPath:this.getPath});return r.errorHandler=this.errorHandler,T(r,J,m(this,J)),r.routes=this.routes,r},J=new WeakMap,le=function(r,t,s){r=r.toUpperCase(),t=ge(this._basePath,t);const a={basePath:this._basePath,path:t,method:r,handler:s};this.router.add(r,t,[s,a]),this.routes.push(a)},We=function(r,t){if(r instanceof Error)return this.errorHandler(r,t);throw r},qe=function(r,t,s,a){if(a==="HEAD")return(async()=>new Response(null,await O(this,P,qe).call(this,r,t,s,"GET")))();const n=this.getPath(r,{env:s}),o=this.router.match(a,n),i=new dr(r,{path:n,matchResult:o,env:s,executionCtx:t,notFoundHandler:m(this,J)});if(o[0].length===1){let c;try{c=o[0][0][0][0](i,async()=>{i.res=await m(this,J).call(this,i)})}catch(l){return O(this,P,We).call(this,l,i)}return c instanceof Promise?c.then(l=>l||(i.finalized?i.res:m(this,J).call(this,i))).catch(l=>O(this,P,We).call(this,l,i)):c??m(this,J).call(this,i)}const u=cs(o[0],this.errorHandler,m(this,J));return(async()=>{try{const c=await u(i);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return O(this,P,We).call(this,c,i)}})()},ve),As=[];function hr(e,r){const t=this.buildAllMatchers(),s=((a,n)=>{const o=t[a]||t[M],i=o[2][n];if(i)return i;const u=n.match(o[0]);if(!u)return[[],As];const c=u.indexOf("",1);return[o[1][c],u]});return this.match=s,s(e,r)}var Ye="[^/]+",ke=".*",Ce="(?:|/.*)",we=Symbol(),yr=new Set(".\\+*[^]$()");function gr(e,r){return e.length===1?r.length===1?e<r?-1:1:-1:r.length===1||e===ke||e===Ce?1:r===ke||r===Ce?-1:e===Ye?1:r===Ye?-1:e.length===r.length?e<r?-1:1:r.length-e.length}var me,_e,z,he,br=(he=class{constructor(){R(this,me);R(this,_e);R(this,z,Object.create(null))}insert(r,t,s,a,n){if(r.length===0){if(m(this,me)!==void 0)throw we;if(n)return;T(this,me,t);return}const[o,...i]=r,u=o==="*"?i.length===0?["","",ke]:["","",Ye]:o==="/*"?["","",Ce]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(u){const l=u[1];let d=u[2]||Ye;if(l&&u[2]&&(d===".*"||(d=d.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(d))))throw we;if(c=m(this,z)[d],!c){if(Object.keys(m(this,z)).some(_=>_!==ke&&_!==Ce))throw we;if(n)return;c=m(this,z)[d]=new he,l!==""&&T(c,_e,a.varIndex++)}!n&&l!==""&&s.push([l,m(c,_e)])}else if(c=m(this,z)[o],!c){if(Object.keys(m(this,z)).some(l=>l.length>1&&l!==ke&&l!==Ce))throw we;if(n)return;c=m(this,z)[o]=new he}c.insert(i,t,s,a,n)}buildRegExpStr(){const t=Object.keys(m(this,z)).sort(gr).map(s=>{const a=m(this,z)[s];return(typeof m(a,_e)=="number"?`(${s})@${m(a,_e)}`:yr.has(s)?`\\${s}`:s)+a.buildRegExpStr()});return typeof m(this,me)=="number"&&t.unshift(`#${m(this,me)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},me=new WeakMap,_e=new WeakMap,z=new WeakMap,he),Ve,He,fs,wr=(fs=class{constructor(){R(this,Ve,{varIndex:0});R(this,He,new br)}insert(e,r,t){const s=[],a=[];for(let o=0;;){let i=!1;if(e=e.replace(/\{[^}]+\}/g,u=>{const c=`@\\${o}`;return a[o]=[c,u],o++,i=!0,c}),!i)break}const n=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[i]=a[o];for(let u=n.length-1;u>=0;u--)if(n[u].indexOf(i)!==-1){n[u]=n[u].replace(i,a[o][1]);break}}return m(this,He).insert(n,r,s,m(this,Ve),t),s}buildRegExp(){let e=m(this,He).buildRegExpStr();if(e==="")return[/^$/,[],[]];let r=0;const t=[],s=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,n,o)=>n!==void 0?(t[++r]=Number(n),"$()"):(o!==void 0&&(s[Number(o)]=++r),"")),[new RegExp(`^${e}`),t,s]}},Ve=new WeakMap,He=new WeakMap,fs),Tr=[/^$/,[],Object.create(null)],Be=Object.create(null);function ks(e){return Be[e]??(Be[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(r,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function Sr(){Be=Object.create(null)}function Ir(e){var c;const r=new wr,t=[];if(e.length===0)return Tr;const s=e.map(l=>[!/\*|\/:/.test(l[0]),...l]).sort(([l,d],[_,E])=>l?1:_?-1:d.length-E.length),a=Object.create(null);for(let l=0,d=-1,_=s.length;l<_;l++){const[E,f,y]=s[l];E?a[f]=[y.map(([b])=>[b,Object.create(null)]),As]:d++;let h;try{h=r.insert(f,d,E)}catch(b){throw b===we?new Ns(f):b}E||(t[d]=y.map(([b,g])=>{const j=Object.create(null);for(g-=1;g>=0;g--){const[N,w]=h[g];j[N]=w}return[b,j]}))}const[n,o,i]=r.buildRegExp();for(let l=0,d=t.length;l<d;l++)for(let _=0,E=t[l].length;_<E;_++){const f=(c=t[l][_])==null?void 0:c[1];if(!f)continue;const y=Object.keys(f);for(let h=0,b=y.length;h<b;h++)f[y[h]]=i[f[y[h]]]}const u=[];for(const l in o)u[l]=t[o[l]];return[n,u,a]}function ye(e,r){if(e){for(const t of Object.keys(e).sort((s,a)=>a.length-s.length))if(ks(t).test(r))return[...e[t]]}}var ne,oe,Je,Cs,Es,Rr=(Es=class{constructor(){R(this,Je);S(this,"name","RegExpRouter");R(this,ne);R(this,oe);S(this,"match",hr);T(this,ne,{[M]:Object.create(null)}),T(this,oe,{[M]:Object.create(null)})}add(e,r,t){var i;const s=m(this,ne),a=m(this,oe);if(!s||!a)throw new Error(js);s[e]||[s,a].forEach(u=>{u[e]=Object.create(null),Object.keys(u[M]).forEach(c=>{u[e][c]=[...u[M][c]]})}),r==="/*"&&(r="*");const n=(r.match(/\/:/g)||[]).length;if(/\*$/.test(r)){const u=ks(r);e===M?Object.keys(s).forEach(c=>{var l;(l=s[c])[r]||(l[r]=ye(s[c],r)||ye(s[M],r)||[])}):(i=s[e])[r]||(i[r]=ye(s[e],r)||ye(s[M],r)||[]),Object.keys(s).forEach(c=>{(e===M||e===c)&&Object.keys(s[c]).forEach(l=>{u.test(l)&&s[c][l].push([t,n])})}),Object.keys(a).forEach(c=>{(e===M||e===c)&&Object.keys(a[c]).forEach(l=>u.test(l)&&a[c][l].push([t,n]))});return}const o=ws(r)||[r];for(let u=0,c=o.length;u<c;u++){const l=o[u];Object.keys(a).forEach(d=>{var _;(e===M||e===d)&&((_=a[d])[l]||(_[l]=[...ye(s[d],l)||ye(s[M],l)||[]]),a[d][l].push([t,n-c+u+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(m(this,oe)).concat(Object.keys(m(this,ne))).forEach(r=>{e[r]||(e[r]=O(this,Je,Cs).call(this,r))}),T(this,ne,T(this,oe,void 0)),Sr(),e}},ne=new WeakMap,oe=new WeakMap,Je=new WeakSet,Cs=function(e){const r=[];let t=e===M;return[m(this,ne),m(this,oe)].forEach(s=>{const a=s[e]?Object.keys(s[e]).map(n=>[n,s[e][n]]):[];a.length!==0?(t||(t=!0),r.push(...a)):e!==M&&r.push(...Object.keys(s[M]).map(n=>[n,s[M][n]]))}),t?Ir(r):null},Es),ie,ee,hs,vr=(hs=class{constructor(e){S(this,"name","SmartRouter");R(this,ie,[]);R(this,ee,[]);T(this,ie,e.routers)}add(e,r,t){if(!m(this,ee))throw new Error(js);m(this,ee).push([e,r,t])}match(e,r){if(!m(this,ee))throw new Error("Fatal error");const t=m(this,ie),s=m(this,ee),a=t.length;let n=0,o;for(;n<a;n++){const i=t[n];try{for(let u=0,c=s.length;u<c;u++)i.add(...s[u]);o=i.match(e,r)}catch(u){if(u instanceof Ns)continue;throw u}this.match=i.match.bind(i),T(this,ie,[i]),T(this,ee,void 0);break}if(n===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(m(this,ee)||m(this,ie).length!==1)throw new Error("No active router has been determined yet.");return m(this,ie)[0]}},ie=new WeakMap,ee=new WeakMap,hs),De=Object.create(null),ue,F,fe,Oe,H,se,de,je,Or=(je=class{constructor(r,t,s){R(this,se);R(this,ue);R(this,F);R(this,fe);R(this,Oe,0);R(this,H,De);if(T(this,F,s||Object.create(null)),T(this,ue,[]),r&&t){const a=Object.create(null);a[r]={handler:t,possibleKeys:[],score:0},T(this,ue,[a])}T(this,fe,[])}insert(r,t,s){T(this,Oe,++us(this,Oe)._);let a=this;const n=sr(t),o=[];for(let i=0,u=n.length;i<u;i++){const c=n[i],l=n[i+1],d=ar(c,l),_=Array.isArray(d)?d[0]:c;if(_ in m(a,F)){a=m(a,F)[_],d&&o.push(d[1]);continue}m(a,F)[_]=new je,d&&(m(a,fe).push(d),o.push(d[1])),a=m(a,F)[_]}return m(a,ue).push({[r]:{handler:s,possibleKeys:o.filter((i,u,c)=>c.indexOf(i)===u),score:m(this,Oe)}}),a}search(r,t){var u;const s=[];T(this,H,De);let n=[this];const o=gs(t),i=[];for(let c=0,l=o.length;c<l;c++){const d=o[c],_=c===l-1,E=[];for(let f=0,y=n.length;f<y;f++){const h=n[f],b=m(h,F)[d];b&&(T(b,H,m(h,H)),_?(m(b,F)["*"]&&s.push(...O(this,se,de).call(this,m(b,F)["*"],r,m(h,H))),s.push(...O(this,se,de).call(this,b,r,m(h,H)))):E.push(b));for(let g=0,j=m(h,fe).length;g<j;g++){const N=m(h,fe)[g],w=m(h,H)===De?{}:{...m(h,H)};if(N==="*"){const x=m(h,F)["*"];x&&(s.push(...O(this,se,de).call(this,x,r,m(h,H))),T(x,H,w),E.push(x));continue}const[A,C,I]=N;if(!d&&!(I instanceof RegExp))continue;const k=m(h,F)[A],U=o.slice(c).join("/");if(I instanceof RegExp){const x=I.exec(U);if(x){if(w[C]=x[0],s.push(...O(this,se,de).call(this,k,r,m(h,H),w)),Object.keys(m(k,F)).length){T(k,H,w);const G=((u=x[0].match(/\//))==null?void 0:u.length)??0;(i[G]||(i[G]=[])).push(k)}continue}}(I===!0||I.test(d))&&(w[C]=d,_?(s.push(...O(this,se,de).call(this,k,r,w,m(h,H))),m(k,F)["*"]&&s.push(...O(this,se,de).call(this,m(k,F)["*"],r,w,m(h,H)))):(T(k,H,w),E.push(k)))}}n=E.concat(i.shift()??[])}return s.length>1&&s.sort((c,l)=>c.score-l.score),[s.map(({handler:c,params:l})=>[c,l])]}},ue=new WeakMap,F=new WeakMap,fe=new WeakMap,Oe=new WeakMap,H=new WeakMap,se=new WeakSet,de=function(r,t,s,a){const n=[];for(let o=0,i=m(r,ue).length;o<i;o++){const u=m(r,ue)[o],c=u[t]||u[M],l={};if(c!==void 0&&(c.params=Object.create(null),n.push(c),s!==De||a&&a!==De))for(let d=0,_=c.possibleKeys.length;d<_;d++){const E=c.possibleKeys[d],f=l[c.score];c.params[E]=a!=null&&a[E]&&!f?a[E]:s[E]??(a==null?void 0:a[E]),l[c.score]=!0}}return n},je),Ee,ys,jr=(ys=class{constructor(){S(this,"name","TrieRouter");R(this,Ee);T(this,Ee,new Or)}add(e,r,t){const s=ws(r);if(s){for(let a=0,n=s.length;a<n;a++)m(this,Ee).insert(e,s[a],t);return}m(this,Ee).insert(e,r,t)}match(e,r){return m(this,Ee).search(e,r)}},Ee=new WeakMap,ys),Ls=class extends Er{constructor(e={}){super(e),this.router=e.router??new vr({routers:[new Rr,new jr]})}},D=e=>{const t={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},s=(n=>typeof n=="string"?n==="*"?()=>n:o=>n===o?o:null:typeof n=="function"?n:o=>n.includes(o)?o:null)(t.origin),a=(n=>typeof n=="function"?n:Array.isArray(n)?()=>n:()=>[])(t.allowMethods);return async function(o,i){var l;function u(d,_){o.res.headers.set(d,_)}const c=await s(o.req.header("origin")||"",o);if(c&&u("Access-Control-Allow-Origin",c),t.credentials&&u("Access-Control-Allow-Credentials","true"),(l=t.exposeHeaders)!=null&&l.length&&u("Access-Control-Expose-Headers",t.exposeHeaders.join(",")),o.req.method==="OPTIONS"){t.origin!=="*"&&u("Vary","Origin"),t.maxAge!=null&&u("Access-Control-Max-Age",t.maxAge.toString());const d=await a(o.req.header("origin")||"",o);d.length&&u("Access-Control-Allow-Methods",d.join(","));let _=t.allowHeaders;if(!(_!=null&&_.length)){const E=o.req.header("Access-Control-Request-Headers");E&&(_=E.split(/\s*,\s*/))}return _!=null&&_.length&&(u("Access-Control-Allow-Headers",_.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await i(),t.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Nr(e){const r=["DB","SESSION_KV","CACHE_KV","TOSS_SECRET_KEY","TOSS_CLIENT_KEY"],t=[];for(const s of r)e[s]||t.push(s);if(t.length>0)throw new Error(`Missing required environment variables: ${t.join(", ")}
...
`)}async function Cr(e){const r=await Ar(e),t=r.filter(n=>n.status==="pass").length,s=r.filter(n=>n.status==="warn").length,a=r.filter(n=>n.status==="fail").length;return{success:a===0,summary:{total:r.length,pass:t,warn:s,fail:a},results:r,formatted:kr(r)}}const es={ENV:"test",TEST_API_KEY:"03148F80-9525-4A00-83B4-1AE55DFFA2DF",TEST_BASE_URL:"https://testapi.barobill.co.kr"};function Lr(){const e=es.ENV==="production";return{baseUrl:es.TEST_BASE_URL,apiKey:es.TEST_API_KEY,isProduction:e}}async function Ms(e,r){const t=Lr(),s=`${t.baseUrl}${e}`;try{const a=await fetch(s,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify(r)});if(!a.ok)throw new Error(`바로빌 API 오류: ${a.status} ${a.statusText}`);return await a.json()}catch(a){throw console.error("바로빌 API 호출 실패:",a),a}}async function Mr(e){try{const r={CorpNum:e.supplierBusinessNumber,InvoicerCorpNum:e.supplierBusinessNumber,InvoicerCorpName:e.supplierBusinessName,InvoicerCEOName:e.supplierCEO,InvoicerAddr:e.supplierAddress,InvoicerBizType:e.supplierBusinessType,InvoicerBizClass:e.supplierBusinessCategory,InvoicerContactName:e.supplierCEO,InvoicerEmail:e.supplierEmail,InvoicerTEL:e.supplierTel,InvoiceeType:e.buyerBusinessNumber?"사업자":"개인",InvoiceeCorpNum:e.buyerBusinessNumber,InvoiceeCorpName:e.buyerBusinessName,InvoiceeCEOName:e.buyerCEO,InvoiceeAddr:e.buyerAddress,InvoiceeEmail:e.buyerEmail,InvoiceeTEL:e.buyerTel,WriteDate:e.writeDate,PurposeType:e.purposeType,TaxType:e.taxType,DetailList:e.items.map((s,a)=>({SerialNum:a+1,ItemName:s.name,Qty:s.quantity,UnitPrice:s.unitPrice,SupplyCost:s.supplyPrice,Tax:s.taxAmount,Remark:s.description||""})),SupplyCostTotal:e.totalSupplyPrice.toString(),TaxTotal:e.totalTaxAmount.toString(),TotalAmount:e.totalAmount.toString(),Remark1:e.memo||"",Remark2:e.orderNo||"",SendSMS:!1,AutoAccept:!1},t=await Ms("/eTaxInvoice/RegistAndIssue",r);if(t.code!==1)throw new Error(`바로빌 발행 실패: ${t.message}`);return{success:!0,ntsConfirmNumber:t.ntsconfirmNum,invoiceKey:t.invoiceKey,message:t.message}}catch(r){throw console.error("바로빌 세금계산서 발행 실패:",r),r}}async function Pr(e,r,t){try{const a=await Ms("/eTaxInvoice/Delete",{CorpNum:e,InvoiceKey:r,Memo:t});if(a.code!==1)throw new Error(`바로빌 취소 실패: ${a.message}`);return{success:!0,message:a.message}}catch(s){throw console.error("바로빌 세금계산서 취소 실패:",s),s}}function Ae(){return!1}async function xr(e){return await Mr(e)}function Ur(e,r,t){const s=Number(r.total_amount),a=Math.floor(s/1.1),n=s-a;return{supplierBusinessNumber:e.business_number,supplierBusinessName:e.business_name,supplierCEO:e.ceo_name,supplierAddress:e.address,supplierBusinessType:e.business_type,supplierBusinessCategory:e.business_category,supplierEmail:e.email,supplierTel:e.phone,buyerBusinessNumber:r.buyer_business_number,buyerBusinessName:r.buyer_business_name||r.user_name,buyerCEO:r.buyer_ceo_name,buyerAddress:r.shipping_address,buyerEmail:r.user_email,buyerTel:r.shipping_phone,writeDate:new Date().toISOString().split("T")[0],purposeType:"01",taxType:"01",items:t.map(o=>{const i=Number(o.price)*Number(o.quantity),u=Math.floor(i/1.1),c=i-u;return{name:o.product_name,quantity:Number(o.quantity),unitPrice:Number(o.price),supplyPrice:u,taxAmount:c,description:o.option_name||""}}),totalSupplyPrice:a,totalTaxAmount:n,totalAmount:s,memo:`주문번호: ${r.order_number}`,orderNo:r.order_number}}class Y extends Error{constructor(r,t,s){super(r),this.statusCode=t,this.code=s,this.name="AuthError"}}function Hr(e){return`${crypto.randomUUID()}-${e}`}function $r(e){var n,o,i,u,c,l,d;const r=e.id.toString(),t=((n=e.properties)==null?void 0:n.nickname)||((i=(o=e.kakao_account)==null?void 0:o.profile)==null?void 0:i.nickname)||"Kakao User",s=((u=e.kakao_account)==null?void 0:u.email)||null,a=((c=e.properties)==null?void 0:c.profile_image)||((d=(l=e.kakao_account)==null?void 0:l.profile)==null?void 0:d.profile_image_url)||null;return{kakaoId:r,nickname:t,email:s,profileImage:a}}async function Fr(e,r,t,s,a){try{const n=await e.prepare(`
    ...
    `).bind(c,t,l,a,n,o||null,i||null).run();return e.json({success:!0,data:{sellerId:d.meta.last_row_id,message:"회원가입이 완료되었습니다. 관리자 승인 후 로그인할 수 있습니다."}})}catch(t){return console.error("Seller registration error:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/admin/login",D(),async e=>{const{DB:r}=e.env;try{const{email:t,password:s}=await e.req.json();if(!t||!s)return e.json({success:!1,error:"이메일과 비밀번호를 입력해주세요"},400);const a=await r.prepare("SELECT * FROM admins WHERE email = ?").bind(t).first();if(!a)return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!(t==="admin@example.com"&&s==="admin123"||a.password_hash&&a.password_hash.includes(`placeholder_hash_for_${s}`)))return e.json({success:!1,error:"이메일 또는 비밀번호가 일치하지 않습니다"},401);if(!a.is_active)return e.json({success:!1,error:"비활성화된 계정입니다"},403);const i=await Ks(e.env.SESSION_KV,a.id,"admin",{username:a.username,email:a.email,name:a.name,role:a.role});return await r.prepare('UPDATE admins SET last_login_at = datetime("now") WHERE id = ?').bind(a.id).run(),e.json({success:!0,data:{token:i,admin:{id:a.id,username:a.username,email:a.email,name:a.name,role:a.role}}})}catch(t){return console.error("Admin login error:",t),e.json({success:!1,error:t.message},500)}});p.get("/api/auth/verify",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const s=await Ne(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=s.user_type==="admin"?"admins":"sellers",n=s.user_type==="admin"?s.admin_id:s.seller_id,o=await r.prepare(`SELECT * FROM ${a} WHERE id = ?`).bind(n).first();return o?e.json({success:!0,data:{user:{id:o.id,type:s.user_type,username:o.username,name:o.name,email:o.email,businessName:o.business_name,role:o.role}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/auth/kakao/sync/callback",async e=>{var t,s,a,n,o,i,u,c,l,d,_,E,f;const{DB:r}=e.env;try{console.log("[Kakao Sync] Callback started"),console.log("[Kakao Sync] DB available:",!!r);const y=e.req.query("code"),h=e.req.query("state")||"/",b=e.req.query("error");if(console.log("[Kakao Sync] Query params:",{hasCode:!!y,state:h,error:b}),b)return console.error("[Kakao Sync] OAuth error:",b),e.redirect(`${h}?error=kakao_oauth_${b}`);if(!y)return console.error("[Kakao Sync] No authorization code"),e.redirect(`${h}?error=no_code`);console.log("[Kakao Sync] Authorization code received");const g=e.env.KAKAO_REST_API_KEY||"5dd74bccb797640b0efd070467f3bafd",j=`${new URL(e.req.url).origin}/auth/kakao/sync/callback`;console.log("[Kakao Sync] Exchanging code for token..."),console.log("  - REST_API_KEY:",g.substring(0,10)+"..."),console.log("  - REDIRECT_URI:",j),console.log("[Kakao Sync] Step 1: Fetching access token...");const N=await fetch("https://kauth.kakao.com/oauth/token",{method:"POST",headers:{"Content-Type":"application/x-www-form-urlencoded"},body:new URLSearchParams({grant_type:"authorization_code",client_id:g,redirect_uri:j,code:y})});if(console.log("[Kakao Sync] Token response status:",N.status),console.log("[Kakao Sync] Token request details:",{client_id:g,redirect_uri:j,code_length:y.length,code_prefix:y.substring(0,20)}),!N.ok){const W=await N.text();return console.error("[Kakao Sync] Token request failed:",W),e.redirect(`${h}?error=token_request_failed&detail=${encodeURIComponent(W)}`)}const w=await N.json();if(console.log("[Kakao Sync] Token data received:",{hasAccessToken:!!w.access_token,error:w.error,errorDescription:w.error_description}),!w.access_token)return console.error("[Kakao Sync] Token error:",w),e.redirect(`${h}?error=token_failed&detail=${encodeURIComponent(w.error||"unknown")}`);console.log("[Kakao Sync] Access token obtained successfully"),console.log("[Kakao Sync] Step 2: Fetching user info...");const A=await fetch("https://kapi.kakao.com/v2/user/me",{headers:{Authorization:`Bearer ${w.access_token}`}});console.log("[Kakao Sync] User response status:",A.status);const C=await A.json();if(console.log("[Kakao Sync] User data received:",{hasId:!!C.id,id:C.id,hasNickname:!!((t=C.properties)!=null&&t.nickname||(a=(s=C.kakao_account)==null?void 0:s.profile)!=null&&a.nickname)}),!C.id)return console.error("[Kakao Sync] Failed to get user info:",C),e.redirect(`${h}?error=user_info_failed`);console.log("[Kakao Sync] User info obtained successfully"),console.log("[Kakao Sync] Step 2.5: Fetching service terms...");const I=await fetch("https://kapi.kakao.com/v2/user/service_terms",{headers:{Authorization:`Bearer ${w.access_token}`}});console.log("[Kakao Sync] Terms response status:",I.status);let k=null;if(I.ok?(k=await I.json(),console.log("[Kakao Sync] Service terms received:",{allowedServiceTerms:((n=k.allowed_service_terms)==null?void 0:n.length)||0,tags:(o=k.allowed_service_terms)==null?void 0:o.map(W=>W.tag)})):console.warn("[Kakao Sync] Failed to fetch service terms (non-critical)"),console.log("[Kakao Sync] Step 3: Saving user to database..."),!r)return console.error("[Kakao Sync] DB is not available!"),e.redirect(`${h}?error=db_not_available`);const U=C.id.toString(),x=((i=C.properties)==null?void 0:i.nickname)||((c=(u=C.kakao_account)==null?void 0:u.profile)==null?void 0:c.nickname)||"Kakao User",G=((l=C.kakao_account)==null?void 0:l.email)||"",Fe=((d=C.properties)==null?void 0:d.profile_image)||((E=(_=C.kakao_account)==null?void 0:_.profile)==null?void 0:E.profile_image_url)||"",ze=w.access_token,$=((f=k==null?void 0:k.allowed_service_terms)==null?void 0:f.map(W=>W.tag))||[],ce=JSON.stringify($);console.log("[Kakao Sync] User data:",{kakaoId:U,nickname:x,email:G?"exists":"none",serviceTerms:$});try{const W=await r.prepare("SELECT * FROM users WHERE kakao_id = ?").bind(U).first();console.log("[Kakao Sync] Existing user check:",!!W);let X;W?(X=W.id,await r.prepare(`
          ...
          WHERE id = ?
        `).bind(x,G,Fe,X).run(),console.log("[Kakao Sync] Updated user:",X)):(X=(await r.prepare(`
          INSERT INTO users (
            kakao_id, 
            name, 
            email, 
        ...
        `).bind(U,x,G||null,Fe||null).run()).meta.last_row_id,console.log("[Kakao Sync] Created user:",X)),console.log("[Kakao Sync] User saved successfully, userId:",X),console.log("[Kakao Sync] Step 4: Creating session...");const{SESSION_KV:Bs}=e.env,Ge=crypto.randomUUID(),Ys=Date.now()+1440*60*1e3;await Bs.put(`session:${Ge}`,JSON.stringify({user_id:X,user_type:"user",expires_at:Ys}),{expirationTtl:1440*60}),console.log("[Kakao Sync] Session created successfully in SESSION_KV"),console.log("[Kakao Sync] Step 5: Redirecting...");const os=h.includes("?")?`${h}&login=success&session=${Ge}&userId=${X}&userName=${encodeURIComponent(x)}`:`${h}?login=success&session=${Ge}&userId=${X}&userName=${encodeURIComponent(x)}`;return console.log("[Kakao Sync] Redirect URL:",os),e.redirect(os)}catch(W){return console.error("[Kakao Sync] Database error:",W),console.error("[Kakao Sync] DB error details:",{message:W.message,name:W.name}),e.redirect(`${h}?error=database_error&detail=${encodeURIComponent(W.message)}`)}}catch(y){console.error("[Kakao Sync] Exception:",y),console.error("[Kakao Sync] Error details:",{message:y.message,stack:y.stack,name:y.name});const h=e.req.query("state")||"/",b=encodeURIComponent(y.message||"unknown");return e.redirect(`${h}?error=kakao_sync_failed&detail=${b}`)}});p.post("/api/auth/kakao/callback",D(),async e=>{const{DB:r}=e.env;try{const{code:t,redirect_uri:s}=await e.req.json();if(!t)return e.json({success:!1,error:"Authorization code is required"},400);if(!e.env.KAKAO_REST_API_KEY)return console.error("[Kakao Callback] KAKAO_REST_API_KEY not configured"),e.json({success:!1,error:"Server configuration error",code:"MISSING_API_KEY"},500);const a=s||"https://live.ur-team.com/auth/kakao/callback";console.log("[Kakao Callback] Starting OAuth flow");const n=await Wr(t,a,e.env.KAKAO_REST_API_KEY),{user:o,sessionToken:i}=await Ps(r,n),u=Date.now()+720*60*60*1e3;return await e.env.SESSION_KV.put(`session:${i}`,JSON.stringify({user_id:o.id,user_type:"user",expires_at:u}),{expirationTtl:720*60*60}),console.log("[Kakao Callback] ✅ Session saved to SESSION_KV for user:",o.id,"- Expires:",new Date(u).toISOString()),e.json({success:!0,data:{session_token:i,user:{id:o.id,name:o.name,email:o.email,profile_image:o.profile_image}}})}catch(t){return console.error("[Kakao Callback] Error:",t),t instanceof Y?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t.message||"Internal server error",code:"UNKNOWN_ERROR"},500)}});p.post("/api/auth/kakao/sync",D(),async e=>{const{DB:r}=e.env;try{const{accessToken:t}=await e.req.json();if(!t)return e.json({success:!1,error:"Access token is required"},400);console.log("[Kakao Sync] Verifying access token");const{user:s,sessionToken:a}=await Ps(r,t),n=Date.now()+720*60*60*1e3;return await e.env.SESSION_KV.put(`session:${a}`,JSON.stringify({user_id:s.id,user_type:"user",expires_at:n}),{expirationTtl:720*60*60}),console.log("[Kakao Sync] ✅ Session saved to SESSION_KV for user:",s.id,"- Expires:",new Date(n).toISOString()),console.log("[Kakao Sync] Login successful"),e.json({success:!0,data:{session_token:a,user:{id:s.id,name:s.name,email:s.email,profile_image:s.profile_image}}})}catch(t){return console.error("[Kakao Sync] Error:",t),t instanceof Y?e.json({success:!1,error:t.message,code:t.code},t.statusCode):e.json({success:!1,error:t instanceof Error?t.message:"Login failed",code:"UNKNOWN_ERROR"},500)}});p.get("/api/auth/validate",D(),async e=>{var t;const{SESSION_KV:r}=e.env;try{const s=e.req.header("X-Session-Token")||((t=e.req.header("Authorization"))==null?void 0:t.replace("Bearer ",""))||"";if(!s)return e.json({success:!1,error:"No session token provided",code:"NO_TOKEN"},401);const a=await xs(r,s);return a?e.json({success:!0,data:{user_id:a.user_id,user_type:a.user_type,session_valid:!0}}):e.json({success:!1,error:"Session expired or invalid",code:"SESSION_EXPIRED"},401)}catch(s){return console.error("[Auth Validate] Error:",s),e.json({success:!1,error:"Validation failed",code:"VALIDATION_ERROR"},500)}});p.post("/api/auth/kakao/logout",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token")||"";return t&&(await r.prepare("DELETE FROM admin_sessions WHERE session_token = ?").bind(t).run(),console.log("[Kakao Sync] Session deleted")),e.json({success:!0})}catch(t){return console.error("[Kakao Sync] Logout error:",t),e.json({success:!1,error:"Logout failed"},500)}});p.post("/api/auth/kakao/unlink",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증이 필요합니다"},401);if(console.log("[Kakao Unlink] Starting unlink process..."),!await r.prepare(`
    ...
    `).run(),await r.prepare("DELETE FROM cart_items WHERE user_id = ?").bind(n.id).run(),await r.prepare("DELETE FROM users WHERE id = ?").bind(n.id).run(),console.log("[Kakao Webhook] User data deleted successfully"),e.json({success:!0})):(console.log("[Kakao Webhook] User not found:",s),e.json({success:!0}))}catch(t){return console.error("[Kakao Webhook] Error:",t),e.json({success:!1,error:"Webhook processing failed"},500)}});p.get("/api/auth/user/verify",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다"},401);const s=await Ne(e.env.SESSION_KV,t);if(!s||s.user_type!=="user")return e.json({success:!1,error:"유효하지 않은 세션입니다"},401);const a=parseInt(t.split("_")[1]),n=await r.prepare("SELECT * FROM users WHERE id = ?").bind(a).first();return n?e.json({success:!0,data:{user:{id:n.id,name:n.name,email:n.email,profileImage:n.profile_image,phone:n.phone}}}):e.json({success:!1,error:"사용자를 찾을 수 없습니다"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/shipping-addresses",D(),K,async e=>{const{DB:r}=e.env,t=e.get("userId");try{const s=await r.prepare(`
      SELECT * FROM shipping_addresses WHERE user_id = ? ORDER BY is_default DESC, created_at DESC
    `).bind(t).all();return e.json({success:!0,data:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/shipping-addresses/:userId",D(),K,async e=>{const{DB:r}=e.env,t=e.get("userId"),s=parseInt(e.req.param("userId"));try{if(s!==t)return e.json({success:!1,error:"본인의 배송지만 조회할 수 있습니다."},403);const a=await r.prepare(`
      SELECT * FROM shipping_addresses WHERE user_id = ? ORDER BY is_default DESC, created_at DESC
    `).bind(t).all();return e.json({success:!0,data:a.results||[]})}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/shipping-addresses",D(),async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),s=t.user_id,a=t.recipient_name,n=t.phone,o=t.postal_code,i=t.address,u=t.address_detail,c=t.is_default;if(console.log("[POST /api/shipping-addresses] Received:",JSON.stringify(t)),!s||!a||!n||!i)return console.error("[POST /api/shipping-addresses] Missing required fields:",{userId:s,recipientName:a,phone:n,address:i}),e.json({success:!1,error:"필수 정보를 입력해주세요"},400);c&&await r.prepare("UPDATE shipping_addresses SET is_default = 0 WHERE user_id = ?").bind(s).run();const l=await r.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, datetime('now'), datetime('now'))
    `).bind(s,a,n,o||"",i,u||"",c?1:0).run();return console.log("[POST /api/shipping-addresses] Success:",{id:l.meta.last_row_id}),e.json({success:!0,data:{id:l.meta.last_row_id}})}catch(t){return console.error("[POST /api/shipping-addresses] Error:",t),e.json({success:!1,error:t.message},500)}});p.put("/api/shipping-addresses/:id",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.param("id"),s=await e.req.json(),a=s.user_id,n=s.recipient_name,o=s.phone,i=s.postal_code,u=s.address,c=s.address_detail,l=s.is_default;return l&&await r.prepare("UPDATE shipping_addresses SET is_default = 0 WHERE user_id = ?").bind(a).run(),await r.prepare(`
      UPDATE shipping_addresses
      SET recipient_name = ?, phone = ?, postal_code = ?, address = ?, address_detail = ?, is_default = ?, updated_at = datetime('now')
      WHERE id = ? AND user_id = ?
    `).bind(n,o,i||"",u,c||"",l?1:0,t,a).run(),e.json({success:!0})}catch(t){return e.json({success:!1,error:t.message},500)}});p.delete("/api/shipping-addresses/:id",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.param("id"),s=e.req.query("userId");return await r.prepare(`
    ...
    `).bind(t).first();return n?n.stock<a?e.json({success:!1,error:"Insufficient stock"},400):(await r.prepare("UPDATE cart_items SET quantity = ? WHERE id = ?").bind(a,t).run(),e.json({success:!0})):e.json({success:!1,error:"Cart item not found"},404)}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders",async e=>{const{DB:r}=e.env;try{const t=await e.req.json(),{userId:s,cartItemIds:a,shippingInfo:n,items:o,shippingAddress:i,shippingAddressDetail:u,recipientName:c,recipientPhone:l,deliveryMemo:d,totalAmount:_,shippingFee:E,orderNumber:f,paymentKey:y,paymentMethod:h}=t;if(o&&o.length>0){const I=[];for(const $ of o){const ce=await r.prepare(`
      ...
      `).bind(x,s||null,_||0,"pending","pending",G||null,c||null,l||null,d||null,y||null).run()).meta.last_row_id;for(const $ of I)await r.prepare(`
          INSERT INTO order_items (
            order_id, product_id, option_id, quantity, price, product_name
          ) VALUES (?, ?, ?, ?, ?, ?)
        `).bind(ze,$.product_id,$.option_id,$.quantity,$.price,$.product_name).run();return e.json({success:!0,data:{orderId:ze,orderNumber:x,totalAmount:_}})}if(!a||a.length===0)return e.json({success:!1,error:"No items provided"},400);const b=a.map(()=>"?").join(","),g=await r.prepare(`
      SELECT 
        ci.*,
        p.name as product_name,
      ...
      JOIN products p ON ci.product_id = p.id
      WHERE ci.id IN (${b})
    `).bind(...a).all();if(g.results.length===0)return e.json({success:!1,error:"No items found"},400);for(const I of g.results)if(I.product_stock<I.quantity)return e.json({success:!1,error:`Insufficient stock for ${I.product_name}`},400);const j=g.results.reduce((I,k)=>I+k.price_snapshot*k.quantity,0),N=`ORD${Date.now()}${Math.floor(Math.random()*1e3)}`,A=(await r.prepare(`
      INSERT INTO orders (
        order_number, user_id, total_amount,
        shipping_address, shipping_name, shipping_phone
      ) VALUES (?, ?, ?, ?, ?, ?)
    `).bind(N,s,j,n.address,n.name,n.phone).run()).meta.last_row_id,C=[];for(const I of g.results){if((await r.prepare(`
        UPDATE products 
        SET stock = stock - ?, 
            version = version + 1,
            updated_at = datetime('now')
        WHERE id = ? 
          AND stock >= ?
          AND is_active = 1
      `).bind(I.quantity,I.product_id,I.quantity).run()).meta.changes===0){const U=await r.prepare(`
          SELECT stock FROM products WHERE id = ?
        `).bind(I.product_id).first();if(!U||U.stock<I.quantity)return e.json({success:!1,error:`재고 부족: ${I.product_name} (남은 재고: ${(U==null?void 0:U.stock)||0}개)`},400);if((await r.prepare(`
            UPDATE products 
            SET stock = stock - ?, 
                version = version + 1,
                updated_at = datetime('now')
        ...
        `).bind(A,I.product_id,I.option_id,I.quantity,I.price_snapshot,I.product_name))}C.push(r.prepare(`DELETE FROM cart_items WHERE id IN (${b})`).bind(...a)),await r.batch(C);try{const I=new Set;for(const k of g.results){const U=await r.prepare("SELECT seller_id FROM products WHERE id = ?").bind(k.product_id).first();U&&U.seller_id&&I.add(U.seller_id)}for(const k of I)await Vr(r,k,N,buyerName||shippingName||"고객",j)}catch(I){console.error("[Order] Notification error:",I)}return e.json({success:!0,data:{orderId:A,orderNumber:N,totalAmount:j}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.get("/api/streams/:streamId/current-product",async e=>{const{DB:r}=e.env,t=e.req.param("streamId");try{const s=await r.prepare("SELECT current_product_id FROM live_streams WHERE id = ?").bind(t).first();if(!s||!s.current_product_id)return e.json({success:!0,data:null});const a=await r.prepare("SELECT * FROM products WHERE id = ?").bind(s.current_product_id).first(),n=await r.prepare("SELECT * FROM product_options WHERE product_id = ?").bind(s.current_product_id).all();return e.json({success:!0,data:{product:a,options:n.results}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/seller/streams",async e=>{const{DB:r}=e.env,t=await v(e);if(!t.success)return e.json({success:!1,error:t.error},401);try{const s=t.sellerId,a=await r.prepare(`
    ...
    `).bind(s.id).all();return e.json({success:!0,data:{...s,items:a.results}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.post("/api/orders/:orderId/cancel",async e=>{const{DB:r}=e.env,t=e.req.param("orderId");try{const a=(await e.req.json()).reason||"사유 없음",n=await r.prepare("SELECT * FROM orders WHERE id = ?").bind(t).first();if(!n)return e.json({success:!1,error:"Order not found"},404);if(n.status!=="pending")return e.json({success:!1,error:"결제 대기 중인 주문만 취소할 수 있습니다. 결제가 완료된 주문은 환불을 신청해주세요."},400);const o=await r.prepare("SELECT product_id, quantity FROM order_items WHERE order_id = ?").bind(t).all();for(const i of o.results)await r.prepare("UPDATE products SET stock = stock + ? WHERE id = ?").bind(i.quantity,i.product_id).run();return await r.prepare("UPDATE orders SET status = ?, cancellation_reason = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind("cancelled",a,t).run(),e.json({success:!0,message:"Order cancelled successfully",data:{orderId:t,reason:a,itemsRestored:o.results.length}})}catch(s){return e.json({success:!1,error:s.message},500)}});p.get("/api/streams/:streamId/viewer-count",async e=>{const{DB:r}=e.env;try{const t=e.req.param("streamId"),s=await r.prepare("SELECT viewer_count FROM live_streams WHERE id = ?").bind(t).first();return s?e.json({success:!0,data:{viewer_count:s.viewer_count||0}}):e.json({success:!1,error:"Stream not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});p.put("/api/streams/:streamId/viewer-count",async e=>{const{DB:r}=e.env,t=await L(e),s=t.success?{success:!1}:await v(e);if(!t.success&&!s.success)return e.json({success:!1,error:"Unauthorized"},401);try{const a=e.req.param("streamId"),{viewer_count:n}=await e.req.json();return typeof n!="number"||n<0?e.json({success:!1,error:"Invalid viewer count"},400):s.success&&!await r.prepare("SELECT id FROM live_streams WHERE id = ? AND seller_id = ?").bind(a,s.sellerId).first()?e.json({success:!1,error:"Stream not found or unauthorized"},404):(await r.prepare("UPDATE live_streams SET viewer_count = ?, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(n,a).run(),e.json({success:!0,data:{viewer_count:n}}))}catch(a){return e.json({success:!1,error:a.message},500)}});p.post("/api/streams/:streamId/view",async e=>{const{DB:r}=e.env;try{const t=e.req.param("streamId");await r.prepare("UPDATE live_streams SET viewer_count = viewer_count + 1, updated_at = CURRENT_TIMESTAMP WHERE id = ?").bind(t).run();const s=await r.prepare("SELECT viewer_count FROM live_streams WHERE id = ?").bind(t).first();return e.json({success:!0,data:{viewer_count:(s==null?void 0:s.viewer_count)||0}})}catch(t){return e.json({success:!1,error:t.message},500)}});p.post("/api/payments/confirm",async e=>{var s;const{DB:r}=e.env;let t=null;try{t=await e.req.json();const{paymentKey:a,orderId:n,amount:o}=t;if(console.log("========================================"),console.log("[Payment] 🚀 결제 승인 API 호출됨"),console.log("========================================"),console.log("[Payment] 📋 요청 파라미터:"),console.log("  - orderId:",n),console.log("  - paymentKey:",a),console.log("  - amount:",o),console.log("  - timestamp:",new Date().toISOString()),!a||!n||!o)return console.error("[Payment] ❌ 필수 파라미터 누락!"),console.error("[Payment] paymentKey:",!!a),console.error("[Payment] orderId:",!!n),console.error("[Payment] amount:",!!o),e.json({success:!1,error:"필수 파라미터가 누락되었습니다.",details:{paymentKey:!!a,orderId:!!n,amount:!!o}},400);console.log("[Payment] ✅ 필수 파라미터 검증 통과");const i=await r.prepare("SELECT id, order_number, total_amount, status FROM orders WHERE order_number = ?").bind(n).first();if(!i)return console.error("[Payment] ❌ 주문을 찾을 수 없음:",n),e.json({success:!1,error:"주문을 찾을 수 없습니다. 주문이 생성되지 않았거나 이미 처리되었습니다.",orderId:n},404);if(console.log("[Payment] ✅ 주문 확인됨:",{id:i.id,order_number:i.order_number,total_amount:i.total_amount,status:i.status}),Number(o)!==Number(i.total_amount))return console.error("[Payment] ❌ 금액 불일치!",{requested:Number(o),expected:Number(i.total_amount)}),e.json({success:!1,error:"결제 금액이 주문 금액과 일치하지 않습니다.",requestedAmount:Number(o),expectedAmount:Number(i.total_amount)},400);const u=e.env.TOSS_SECRET_KEY;if(!u)return console.error("[Payment] ❌ TOSS_SECRET_KEY 환경 변수 없음"),console.error("[Payment] c.env:",Object.keys(e.env||{})),e.json({success:!1,error:"결제 시스템 설정이 올바르지 않습니다."},500);console.log("[Payment] ✅ TOSS_SECRET_KEY 확인됨:",u.substring(0,20)+"..."),console.log("[Payment] 🌐 토스페이먼츠 API 호출 시작..."),console.log("[Payment] API URL: https://api.tosspayments.com/v1/payments/confirm"),console.log("[Payment] API 버전: 2022-11-16 (결제위젯 고정 버전)");const c="Basic "+btoa(u+":");console.log("[Payment] Authorization 헤더 생성 완료");const l={orderId:n,amount:Number(o),paymentKey:a};console.log("[Payment] 요청 본문:",JSON.stringify(l,null,2)),console.log("[Payment] 📊 amount 타입:",typeof l.amount),console.log("[Payment] 📊 amount 값:",l.amount);const d=await fetch("https://api.tosspayments.com/v1/payments/confirm",{method:"POST",headers:{Authorization:c,"Content-Type":"application/json","TossPayments-API-Version":"2022-11-16"},body:JSON.stringify(l)}),_=await d.json();if(console.log("[Payment] 📡 토스페이먼츠 API 응답:"),console.log("  - HTTP 상태:",d.status),console.log("  - 응답 OK?:",d.ok),console.log("  - 응답 데이터 (일부):",JSON.stringify(_).substring(0,300)),!d.ok)return console.error("[Payment] ❌❌❌ 토스페이먼츠 승인 실패!"),console.error("[Payment] HTTP 상태:",d.status),console.error("[Payment] 에러 코드:",_.code),console.error("[Payment] 에러 메시지:",_.message),console.error("[Payment] 전체 응답:",JSON.stringify(_,null,2)),e.json({success:!1,error:_.message||"결제 승인에 실패했습니다.",code:_.code,tossError:_},d.status);console.log("[Payment] ✅ 결제 승인 성공! paymentKey:",a),console.log("[Payment] ✅ 주문 번호:",n);try{await r.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?)
    `).bind(t,a||null,n,o||null,d,u?1:0,c?1:0).run();return e.json({success:!0,data:{id:_.meta.last_row_id,message:d}})}catch(s){return console.error("Error sending chat message:",s),e.json({success:!1,error:s.message},500)}});p.get("/api/chat/:liveStreamId/messages",D(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.query("since"),a=Number(e.req.query("limit"))||50;try{let n=`
      SELECT 
        id,
        user_id,
        user_name,
    ...
    `;const o=[t];s&&(n+=" AND id > ?",o.push(Number(s))),n+=" ORDER BY created_at DESC LIMIT ?",o.push(a);const u=(await r.prepare(n).bind(...o).all()).results.reverse();return e.json({success:!0,data:u})}catch(n){return console.error("Error fetching chat messages:",n),e.json({success:!1,error:n.message},500)}});p.delete("/api/chat/:liveStreamId/messages/:messageId",D(),async e=>{const{DB:r}=e.env,t=e.req.param("messageId");try{return await r.prepare(`
      UPDATE chat_messages
      SET is_deleted = 1
      WHERE id = ?
    `).bind(t).run(),e.json({success:!0,message:"Message deleted successfully"})}catch(s){return console.error("Error deleting chat message:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/chat/:liveStreamId/ban",D(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId");try{const s=await e.req.json(),{userId:a,bannedBy:n,reason:o,duration:i}=s;if(!a||!n)return e.json({success:!1,error:"userId and bannedBy are required"},400);let u=null;if(i){const c=new Date;c.setMinutes(c.getMinutes()+i),u=c.toISOString()}return await r.prepare(`
      INSERT INTO chat_bans (live_stream_id, user_id, banned_by, reason, expires_at)
      VALUES (?, ?, ?, ?, ?)
    `).bind(t,a,n,o||null,u).run(),e.json({success:!0,message:"User banned successfully"})}catch(s){return console.error("Error banning user:",s),e.json({success:!1,error:s.message},500)}});p.delete("/api/chat/:liveStreamId/ban/:userId",D(),async e=>{const{DB:r}=e.env,t=e.req.param("liveStreamId"),s=e.req.param("userId");try{return await r.prepare(`
...
`});const E="\uFEFF";return new Response(E+_,{headers:{"Content-Type":"text/csv; charset=utf-8","Content-Disposition":`attachment; filename="settlement_${a||"all"}_${Date.now()}.csv"`}})}catch(s){return console.error("CSV 내보내기 실패:",s),e.json({success:!1,error:s.message},500)}});p.post("/api/orders/create",async e=>{const{DB:r}=e.env;try{const{userId:t,cartItems:s,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i,buyerBusinessNumber:u,buyerBusinessName:c,buyerCeoName:l}=await e.req.json();console.log("주문 생성 요청:",{userId:t,cartItems:s==null?void 0:s.length,totalAmount:a,shippingAddressId:n,sellerId:o,issueTaxInvoice:i});let d=10;if(o){const w=await r.prepare(`
      ...
      `).bind(n,t).first();if(!w)return e.json({success:!1,error:"배송지 정보를 찾을 수 없습니다"},400);f=w}if(!t)return e.json({success:!1,error:"User ID is required. Please login with Kakao first."},401);const y=t,h=Date.now(),b=Math.random().toString(36).substring(2,8).toUpperCase(),g=`ORDER_${h}_${b}`;for(const w of s){const A=await r.prepare(`
        SELECT stock FROM products WHERE id = ?
      `).bind(w.product_id).first();if(!A)return e.json({success:!1,error:`상품을 찾을 수 없습니다 (ID: ${w.product_id})`},400);if(A.stock<w.quantity)return e.json({success:!1,error:`재고가 부족합니다 (상품 ID: ${w.product_id})`},400)}const N=(await r.prepare(`
      INSERT INTO orders (
    ...
    `).bind(g,y,a,"pending",o||null,d,_,E,n||null,(f==null?void 0:f.recipient_name)||null,(f==null?void 0:f.phone)||null,f!=null&&f.address?`${f.address} ${f.address_detail}`:null,(f==null?void 0:f.postal_code)||null,i?1:0,u||null,c||null,l||null).run()).meta.last_row_id;for(const w of s){await r.prepare(`
      ...
      `).bind(w.quantity,w.product_id).run();try{const A=await r.prepare(`
          SELECT id, name, stock, stock_alert_threshold, seller_id 
          FROM products 
          WHERE id = ?
        `).bind(w.product_id).first();if(A){const C=A.stock_alert_threshold||5,I=A.stock;I<=C&&A.seller_id&&(await Jr(r,A.seller_id,A.name,I,C),console.log(`[Low Stock Alert] ${A.name}: ${I} <= ${C}`))}}catch(A){console.error("[Low Stock Alert] Error:",A)}}return console.log("주문 생성 완료:",{orderId:N,orderNumber:g}),e.json({success:!0,orderId:N,orderNumber:g,totalAmount:a})}catch(t){return console.error("주문 생성 실패:",t),e.json({success:!1,error:t.message},500)}});p.post("/api/orders/:orderNumber/refund",D(),async e=>{const{DB:r}=e.env;try{const t=e.req.param("orderNumber"),{reason:s}=await e.req.json();console.log("[Order Refund] 환불 요청:",{orderNumber:t,reason:s});const a=await r.prepare(`
    ...
    `).bind(a.id).all();for(const o of n.results)await r.prepare(`
        ...
        SET stock = stock + ?,
            ...
            updated_at = datetime('now')
        WHERE id = ?
      `).bind(o.quantity,o.product_id).run(),console.log("[Order Refund] 재고 복구:",{productId:o.product_id,quantity:o.quantity});return console.log("[Order Refund] ✅ 환불 완료:",{orderNumber:t,reason:s}),e.json({success:!0,message:"주문이 취소되었습니다",data:{orderNumber:t,cancelDate:new Date().toISOString()}})}catch(t){return console.error("[Order Refund] Error:",t),e.json({success:!1,error:t.message||"주문 취소 중 오류가 발생했습니다"},500)}});p.get("/api/seller/sales",D(),async e=>{try{const{DB:r}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const s=await Ne(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(s.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=s.seller_id||s.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],u=o||new Date().toISOString().split("T")[0],c=await r.prepare(`
    ...
    `).bind(a,i,u).first(),d=await r.prepare(`
      ...
      ORDER BY o.created_at DESC
      LIMIT 100
    `).bind(a,i,u).all();return e.json({success:!0,data:{seller:c,stats:l,orders:(d==null?void 0:d.results)||[]}})}catch(r){return console.error("Seller sales query error:",r),e.json({success:!1,error:r.message},500)}});p.get("/api/seller/settlement-csv",D(),async e=>{try{const{DB:r}=e.env,t=e.req.header("X-Session-Token");if(!t)return e.json({success:!1,error:"인증 토큰이 없습니다."},401);const s=await Ne(e.env.SESSION_KV,t);if(!s)return e.json({success:!1,error:"유효하지 않은 세션입니다."},401);if(s.user_type!=="seller")return e.json({success:!1,error:"셀러만 접근 가능합니다."},403);const a=s.seller_id||s.user_id,{startDate:n,endDate:o}=e.req.query(),i=n||new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],u=o||new Date().toISOString().split("T")[0],c=await r.prepare(`
      SELECT 
        o.order_number,
        o.total_amount,
        o.commission_amount,
...
대표전화: 0507-0177-0432 | 이메일: jiwon@ur-team.com
  `;return qs({to:"jiwon@ur-team.com",subject:`[유어 라이브] 🎉 새 라이브 스트림 생성: ${t}`,htmlContent:c,textContent:l})}const nt=Object.freeze(Object.defineProperty({__proto__:null,sendEmail:qs,sendLiveStreamCreatedEmail:at},Symbol.toStringTag,{value:"Module"}));export{ps as default};
