...
--
-- 🚨 ⚠️ DO NOT RUN MORE THAN ONCE ⚠️ 🚨
-- 🛡️ 2026-04-22: 이 스크립트는 NON-IDEMPOTENT.
--   - DELETE 는 조건부 (seller_id=1 모든 상품) — 정상 데이터 삭제 위험
--   - INSERT 는 ID 자동증가 — 재실행 시 중복 상품 생성됨
--   - UPDATE live_streams 는 idempotent OK
--   재실행 금지. 신규 상품 추가는 어드민 UI 사용.
-- ============================================================
