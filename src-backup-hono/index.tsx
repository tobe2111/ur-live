...
app.get('/', (c) => {
  return c.html(`
    ...
    <head>
        ...
        <title>유어 라이브 - 지금 당장 만나는 라이브 쇼핑</title>
        <script src="https://cdn.tailwindcss.com"></script>
        ...
        <style>
          * { 
          ...
          @media (max-width: 768px) {
            .toss-h1 { font-size: 48px; }
            .toss-h2 { font-size: 36px; }
            .toss-h3 { font-size: 24px; }
          }
        </style>
    </head>
    <body>
        <!-- 네비게이션 -->
        <nav class="nav-blur sticky top-0 z-50 border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <div style="width: 36px; height: 36px; background: var(--toss-blue); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                        <i class="fas fa-tv text-white text-lg"></i>
                    </div>
                    <span style="font-size: 20px; font-weight: 800; color: var(--toss-black); letter-spacing: -0.02em;">유어 라이브</span>
                </div>
                <div class="flex items-center gap-4">
                    <a href="/my-orders" style="color: var(--toss-gray-700); font-size: 15px; font-weight: 600; text-decoration: none; transition: color 0.2s;">
                        <i class="fas fa-shopping-bag mr-1"></i>
                        주문내역
                    </a>
                    <a href="/seller-login" class="toss-btn toss-btn-primary" style="padding: 10px 20px; font-size: 15px;">
        ...
        <!-- Hero 섹션 -->
        <section style="padding: 80px 24px; text-align: center; background: linear-gradient(180deg, #FAFAFA 0%, #FFFFFF 100%);">
            <div class="hero-content" style="max-width: 900px; margin: 0 auto;">
                <div style="display: inline-block; padding: 8px 20px; background: rgba(49, 130, 246, 0.1); border-radius: 20px; margin-bottom: 24px;">
                    <span style="color: var(--toss-blue); font-weight: 700; font-size: 15px;">🔥 지금 라이브 중</span>
                </div>
                <h1 class="toss-h1" style="color: var(--toss-black); margin-bottom: 24px;">
                    보는 순간<br/>바로 산다
                </h1>
                <p class="toss-body-1" style="color: var(--toss-gray-700); margin-bottom: 48px; max-width: 600px; margin-left: auto; margin-right: auto;">
                    실시간 라이브 쇼핑으로 빠르고 재미있게 쇼핑하세요
                </p>
                <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
                    <button onclick="document.getElementById('live-streams-section').scrollIntoView({behavior: 'smooth'})" class="toss-btn toss-btn-primary" style="padding: 18px 32px; font-size: 18px;">
                        <i class="fas fa-play-circle mr-2"></i>
                        라이브 보러가기
                    </button>
                    <a href="/seller-login" class="toss-btn toss-btn-secondary" style="padding: 18px 32px; font-size: 18px;">
        ...
        <!-- 라이브 스트림 섹션 -->
        <section id="live-streams-section" style="padding: 80px 24px; max-width: 1280px; margin: 0 auto;">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 48px;">
                <div>
                    <h2 class="toss-h2" style="color: var(--toss-black); margin-bottom: 12px;">
                        지금 라이브 중 🔥
                    </h2>
                    <p class="toss-body-2" style="color: var(--toss-gray-700);">
                        실시간으로 진행되는 라이브 쇼핑
                    </p>
                </div>
                <button onclick="loadLiveStreams()" class="toss-btn toss-btn-secondary" style="padding: 12px 20px;">
            ...
            <!-- Empty State -->
            <div id="empty-state" class="hidden" style="text-align: center; padding: 100px 24px;">
                <div style="width: 120px; height: 120px; background: var(--toss-gray-50); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 32px;">
                    <i class="fas fa-video-slash" style="font-size: 48px; color: var(--toss-gray-400);"></i>
                </div>
                <h3 class="toss-h3" style="color: var(--toss-gray-900); margin-bottom: 16px;">
                    현재 진행 중인 라이브가 없어요
                </h3>
                <p class="toss-body-1" style="color: var(--toss-gray-700); margin-bottom: 40px;">
                    곧 새로운 라이브가 시작될 예정입니다
                </p>
                <a href="/seller-login" class="toss-btn toss-btn-primary" style="padding: 18px 32px; font-size: 18px;">
        ...
        <section style="padding: 100px 24px; background: white;">
            <div style="max-width: 1280px; margin: 0 auto;">
                <div style="text-align: center; margin-bottom: 80px;">
                    <h2 class="toss-h2" style="color: var(--toss-black); margin-bottom: 20px;">
                        더 쉽고 빠르게
                    </h2>
                    <p class="toss-body-1" style="color: var(--toss-gray-700);">
                        유어 라이브만의 특별한 경험
                    </p>
                </div>
                ...
                <div class="grid md:grid-cols-3 gap-12">
                    <div style="text-align: center;">
                        <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px; box-shadow: 0 20px 40px rgba(102, 126, 234, 0.3);">
                            <i class="fas fa-bolt" style="font-size: 36px; color: white;"></i>
                        </div>
                        <h3 class="toss-h3" style="color: var(--toss-gray-900); margin-bottom: 16px; font-size: 24px;">
                            원클릭 구매
                        </h3>
                        <p class="toss-body-2" style="color: var(--toss-gray-700); line-height: 1.8;">
                            복잡한 절차 없이 클릭 한 번으로<br/>장바구니 담고 바로 결제
                        </p>
                    </div>

                    <div style="text-align: center;">
                        <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px; box-shadow: 0 20px 40px rgba(240, 147, 251, 0.3);">
                        ...
                        <p class="toss-body-2" style="color: var(--toss-gray-700); line-height: 1.8;">
                            나이스페이먼츠 연동으로<br/>안전하고 편리한 결제 경험
                        </p>
                    </div>

                    <div style="text-align: center;">
                        <div style="width: 80px; height: 80px; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 24px; box-shadow: 0 20px 40px rgba(79, 172, 254, 0.3);">
                            <i class="fas fa-comments" style="font-size: 36px; color: white;"></i>
                        </div>
                        <h3 class="toss-h3" style="color: var(--toss-gray-900); margin-bottom: 16px; font-size: 24px;">
                            실시간 소통
                        </h3>
                        <p class="toss-body-2" style="color: var(--toss-gray-700); line-height: 1.8;">
                            채팅으로 다른 구매자들과<br/>실시간으로 소통하며 쇼핑
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Footer -->
        <footer style="background: var(--toss-black); padding: 60px 24px; color: white;">
            <div style="max-width: 1280px; margin: 0 auto;">
                <div style="display: flex; flex-wrap: wrap; justify-content: space-between; gap: 48px; margin-bottom: 40px;">
                    <div>
                        <div style="font-size: 24px; font-weight: 800; margin-bottom: 12px;">유어 라이브</div>
                        <p style="color: var(--toss-gray-400); font-size: 15px;">
                            실시간 라이브 쇼핑의 새로운 경험
                        </p>
                    </div>
                    <div style="display: flex; gap: 48px;">
                        <div>
                            <div style="font-weight: 700; margin-bottom: 16px; font-size: 15px;">서비스</div>
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                <a href="/live/1" style="color: var(--toss-gray-400); text-decoration: none; font-size: 14px; transition: color 0.2s;">라이브 보기</a>
                                <a href="/my-orders" style="color: var(--toss-gray-400); text-decoration: none; font-size: 14px; transition: color 0.2s;">주문 내역</a>
                            </div>
                        </div>
                        <div>
                            <div style="font-weight: 700; margin-bottom: 16px; font-size: 15px;">판매자</div>
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                <a href="/seller-login" style="color: var(--toss-gray-400); text-decoration: none; font-size: 14px; transition: color 0.2s;">셀러 로그인</a>
                                <a href="/seller" style="color: var(--toss-gray-400); text-decoration: none; font-size: 14px; transition: color 0.2s;">대시보드</a>
                                <a href="/admin" style="color: var(--toss-gray-400); text-decoration: none; font-size: 14px; transition: color 0.2s;">관리자</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div style="padding-top: 24px; border-top: 1px solid rgba(255, 255, 255, 0.1);">
                    <p style="color: var(--toss-gray-400); font-size: 13px; text-align: center;">
        ...
        <script>
          ...
          function renderStreams() {
            ...
            streamsEl.innerHTML = liveStreams.map(stream => \`
              <div class="toss-card" onclick="location.href='/live/\${stream.id}'" style="height: auto;">
                <div style="position: relative; overflow: hidden; border-radius: 24px 24px 0 0;">
                  <img src="https://img.youtube.com/vi/\${stream.youtube_video_id}/maxresdefault.jpg" 
                       ...
                       onerror="this.src='https://via.placeholder.com/1280x720/667eea/ffffff?text=Your+Live'">
                  <div class="live-badge" style="position: absolute; top: 16px; left: 16px;">
                    <div class="live-dot"></div>
                    LIVE
                  </div>
                  \${stream.viewer_count ? \`
                    <div style="position: absolute; top: 16px; right: 16px; background: rgba(0, 0, 0, 0.7); backdrop-filter: blur(10px); padding: 8px 12px; border-radius: 20px; color: white; font-size: 13px; font-weight: 600;">
                ...
                <div style="padding: 24px;">
                  <h3 style="font-size: 20px; font-weight: 700; color: var(--toss-black); margin-bottom: 12px; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                    \${stream.title}
                  </h3>
                  <p style="font-size: 14px; color: var(--toss-gray-700); margin-bottom: 20px; line-height: 1.6; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                  ...
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div style="display: flex; align-items: center; gap: 8px;">
                      \${stream.seller_name ? \`
                        ...
                        <span style="font-size: 14px; font-weight: 600; color: var(--toss-gray-900);">\${stream.seller_name}</span>
                      \` : \`
                        <span style="font-size: 14px; font-weight: 600; color: var(--toss-gray-900);">유어 라이브</span>
                      \`}
                    </div>
                    <div style="display: flex; align-items: center; gap: 4px; color: var(--toss-blue); font-size: 14px; font-weight: 700;">
                      입장하기
  ...
  return c.html(`
    ...
    <body>
        <div class="login-card">
            <h1 class="text-3xl font-bold mb-2">유어 라이브 커머스</h1>
        ...
        <script>
            ...
            async function processPayment() {
                ...
                try {
                    ...
                    // localStorage에서 seller_id 가져오기
                    const sellerId = localStorage.getItem('seller_id') ? parseInt(localStorage.getItem('seller_id')) : null;
                    ...
                    const orderName = data.data.orderName || \`주문 #\${order.order_number}\`;
                    const ediDate = data.data.ediDate; // 전문 생성 일시

                    // 나이스페이 결제 Form 생성
                    const form = document.createElement('form');
                    form.method = 'POST';
                    form.action = 'https://pay.nicepay.co.kr/v1/js/';
                    ...
                    const params = {
                        ...
                        BuyerTel: order.shipping_phone || '01012345678',
                        ReturnURL: window.location.origin + '/api/payments/nicepay/return',
                        VbankExpDate: '',
                        EdiDate: ediDate,
                        SignData: data.data.signData,
                        CharSet: 'utf-8'
                    };
            ...
            function nicepayStart() {
                goPay(document.forms[document.forms.length - 1]);
            }
        </script>
    </body>
    </html>
...
app.get('/admin/login', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>어드민 로그인 - 유어 라이브 커머스</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <style>
            :root {
    ...
    <body>
        <div class="login-container">
            <div class="logo">
                ...
                <p style="font-size: 14px; color: var(--toss-gray-600); margin-top: 8px;">유어 라이브 커머스 관리자</p>
            </div>
...
app.get('/seller/login', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>판매자 로그인 - 유어 라이브 커머스</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <style>
            :root {
    ...
    <body>
        <div class="login-container">
            <div class="logo">
                ...
                <p style="font-size: 14px; color: var(--toss-gray-600); margin-top: 8px;">유어 라이브 커머스 판매자</p>
            </div>
...
app.get('/admin', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>관리자 대시보드 - 유어 라이브 커머스</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <style>
            :root {
            ...
            <div class="modal-content">
                ...
                <form id="sellerForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="sellerBusinessName" class="form-input" placeholder="주식회사 유어" required>
                    </div>
...
app.get('/seller', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>판매자 대시보드 - 유어 라이브 커머스</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <style>
            :root {
...
app.get('/my-orders', (c) => {
  return c.html(`
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>내 주문 내역 - 유어 라이브 커머스</title>
        <script src="https://cdn.tailwindcss.com"></script>
        <link href="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.4.0/css/all.min.css" rel="stylesheet">
        <style>
            :root {
